...
main(int argc, char **argv) {
        ...
        Widget toplevel, mainWindow, spinContainer, comboContainer,
            menuContainer;
        ...
        n++;
        XtSetArg(args[n], XmNspacing, 40);
        n++;
        mainWindow = XmCreateWorkArea(toplevel, "mainWindow", args, n);
        XtManageChild(mainWindow);

        n = 0;
        XtSetArg(args[n], XmNspacing, 20);
        n++;
        ...
        n++;
        comboContainer =
            XmCreateWorkArea(mainWindow, "comboContainer", args, n);
...
static void CreateSpinBoxes(Widget parent) {
        ...
        valueXmstrings =
            (XmString *)XtMalloc(numValueStrings * sizeof(XmString *));
        ...
        n = 0;
        XtSetArg(args[n], XmNvalues, valueXmstrings);
        n++;
        XtSetArg(args[n], XmNnumValues, numValueStrings);
        n++;
        ...
        n = 0;
        XtSetArg(args[n], XmNspinBoxChildType, XmNUMERIC);
        n++;
        XtSetArg(args[n], XmNminimumValue, 1000);
        n++;
        XtSetArg(args[n], XmNmaximumValue, 100000);
        n++;
        XtSetArg(args[n], XmNincrementValue, 1000);
        n++;
        XtSetArg(args[n], XmNdecimalPoints, 3);
        n++;
        XtSetArg(args[n], XmNposition, 1000);
        n++;
        XtSetArg(args[n], XmNarrowLayout, XmARROWS_SPLIT);
        n++;
        XtSetArg(args[n], XmNcolumns, 10);
        n++;
        ...
        XtSetArg(args[n], XmNspinBoxChildType, XmNUMERIC);
        n++;
        XtSetArg(args[n], XmNminimumValue, 1500);
        n++;
        XtSetArg(args[n], XmNmaximumValue, 60500);
        n++;
        XtSetArg(args[n], XmNincrementValue, 1500);
        n++;
        XtSetArg(args[n], XmNdecimalPoints, 2);
        n++;
        XtSetArg(args[n], XmNposition, 7500);
        n++;
        XtSetArg(args[n], XmNarrowLayout, XmARROWS_FLAT_BEGINNING);
        n++;
        XtSetArg(args[n], XmNcolumns, 10);
        n++;
        ...
        XtSetArg(args[n], XmNnumValues, numValueStrings);
        n++;
        XtSetArg(args[n], XmNarrowLayout, XmARROWS_BEGINNING);
        n++;
        XtSetArg(args[n], XmNcolumns, 10);
        n++;
        ...
        XtSetArg(args[n], XmNposition, 1000);
        n++;
        XtSetArg(args[n], XmNarrowLayout, XmARROWS_FLAT_END);
        n++;
        XtSetArg(args[n], XmNcolumns, 10);
        n++;
...
static void ModifyVerifyCb(Widget w, XtPointer cd, XtPointer cb) {
        ...
        if (allowChange == False) {
                printf(
                    "XmSpinBox: XmNmodifyVerifyCallback. Change disallowed.\n");
                XBell(XtDisplay(w), 0);
        }
...
static void CreateComboBoxes(Widget parent) {
        ...
        colorXmstrings =
            (XmString *)XtMalloc(numColorStrings * sizeof(XmString *));
        ...
        n++;
        XtSetArg(args[n], DtNitems, colorXmstrings);
        n++;
        XtSetArg(args[n], DtNitemCount, numColorStrings);
        n++;
        XtSetArg(args[n], DtNvisibleItemCount, 5);
        n++;
        XtSetArg(args[n], DtNcolumns, 10);
        n++;
        ...
        XtSetArg(args[n], DtNcomboBoxType, DtDROP_DOWN_COMBO_BOX);
        n++;
        XtSetArg(args[n], DtNorientation, DtLEFT);
        n++;
        XtSetArg(args[n], DtNcolumns, 10);
        n++;
        ...
        XtSetArg(args[n], DtNorientation, DtLEFT);
        n++;
        XtSetArg(args[n], DtNitems, valueXmstrings);
        n++;
        XtSetArg(args[n], DtNitemCount, numValueStrings);
        n++;
        XtSetArg(args[n], DtNvisibleItemCount, 8);
        n++;
        ...
        n = 0;
        XtSetArg(args[n], DtNorientation, DtRIGHT);
        n++;
        XtSetArg(args[n], DtNvisibleItemCount, 8);
        n++;
...
static unsigned char menu_glyph_bits[] = {
    ...
    0x7f, 0x81, 0x7f, 0xff, 0x7f, 0xff, 0x40, 0xff, 0x40, 0xfe, 0x20,
    0xfe, 0x20, 0xfc, 0x10, 0xf8, 0x0c, 0xe0, 0x03, 0x00, 0x00};
...
static void CreateMenuButtons(Widget parent) {
        ...
        XtVaGetValues(menuButton, XmNforeground, &fg, XmNbackground, &bg,
                      XmNdepth, &depth, NULL);

        cascadePixmap = XCreatePixmapFromBitmapData(
            XtDisplay(menuButton), DefaultRootWindow(XtDisplay(menuButton)),
            (char *)menu_glyph_bits, menu_glyph_width, menu_glyph_height, fg,
            bg, depth);
