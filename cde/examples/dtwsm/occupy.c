...
char **argv;
{
        ...
        n++;
        toplevel = XtAppInitialize(&app_context, "Dtoccupy", NULL, 0, &argc,
                                   argv, NULL, args, n);
 ...
 */
static void SetupWorkspaceButtons(form, top) Widget form;
Widget top;
{
        Window root;
 ...
 */
static void showCB(w, client_data,
                   call_data) Widget w; /*  widget id		*/
XtPointer client_data;                  /*  data from application   */
XtPointer call_data;                    /*  data from widget class  */
{ ShowWorkspaceOccupancy(); }
 ...
 */
static void setCB(w, client_data,
                  call_data) Widget w; /*  widget id		*/
XtPointer client_data;                 /*  data from application   */
XtPointer call_data;                   /*  data from widget class  */
{
 ...
 */
static void wsCB(w, client_data, call_data) Widget w; /*  widget id
                                                       */
XtPointer client_data; /*  data from application   */
XtPointer call_data;   /*  data from widget class  */
{
 ...
 */
static void allWsCB(w, client_data,
                    call_data) Widget w; /*  widget id		*/
XtPointer client_data;                   /*  data from application   */
XtPointer call_data;                     /*  data from widget class  */
