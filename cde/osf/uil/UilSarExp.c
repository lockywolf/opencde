...
#ifndef lint
static char rcsid[] =
    "$XConsortium: UilSarExp.c /main/11 1995/07/14 09:37:03 drk $"
#endif
#endif
...
#include "UilDefI.h"
    ...
    **
    **      This function processes a binary arithmetic operator in an
    *expression
    **
    **  FORMAL PARAMETERS:
    **
...

{
        ...
        _assert(operator_frame->b_tag == sar_k_token_frame, "operator missing");

        res_entry = (sym_value_entry_type *)sem_allocate_node(
