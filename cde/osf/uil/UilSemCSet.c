...
#ifndef lint
static char rcsid[] =
    "$TOG: UilSemCSet.c /main/10 1997/03/12 15:21:53 dbl $"
#endif
#endif
...
#include "UilDefI.h"
    ...
    **/
    ...
    char *
    sem_charset_name(l_charset, az_charset_entry) int l_charset;
...

{
        ...
        case sym_k_userdefined_charset:
                /*
                 ** If the charset is user-defined, then fetch info from the
                 *symbol
                 ** table entry for it.
                 */
                _assert(az_charset_entry != NULL,
                        "null userdefined charset entry");
...
void sem_charset_info(l_charset, az_charset_entry, write_direction,
                      parse_direction, sixteen_bit)
...
int sem_charset_lang_name(lang_charset) char *lang_charset;
