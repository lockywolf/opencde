...
#ifndef lint
static char rcsid[] =
    "$XConsortium: wmlsynbld.c /main/9 1995/08/29 11:11:12 drk $"
#endif
#endif
/*
...
void wmlCreateClass(name, ctype) char *name;
int ctype;
...
void wmlCreateResource(name, rtype) char *name;
int rtype;
...
void wmlCreateDatatype(name) char *name;
...
void wmlCreateChild(name, class) char *name;
char *class;
{
...
void wmlCreateOrAppendCtrlList(name) char *name;

{
        ...
        if (idx < 0) {
                ...
                /*
                 * Initialize the new CtrlList descriptor. Enter it in the
                 * object list. Set the current object global to the descriptor.
                 */
...
void wmlCreateEnumSet(name, dtype) char *name;
char *dtype;
...
/*
 * Routine to create an enumeration value descriptor. The result is placed in
 *both wml_cur_obj and wml_synobj.
 *
 *	name		the enumeration value name
 */

void wmlCreateEnumValue(name) char *name;
...
void wmlCreateCharset(name) char *name;
...
void wmlAddClassAttribute(attrid, val) int attrid;
char *val;
...
void wmlAddClassControl(name) char *name;
...
void wmlAddClassResource(name) char *name;
...
void wmlAddClassChild(name) char *name;
 ...
 */
void wmlAddClassResourceAttribute(attrid, val) int attrid;
char *val;

{
        ...
        if (rdesc->validation != WmlClassResDefValid) {
                printf("\nwmlAddClassResourceAttribute: %d not a class "
                       "resource descriptor",
                       rdesc->validation);
                return;
        }
        ...
        case EXCLUDE:
                ...
                case ATTRFALSE:
                        ...
                        break;
                default:
                        printf("\nwmlAddClassResourceAttribute: bad EXCLUDE "
                               "value %d",
                               excval);
                        return;
                        break;
                ...
                break;
        default:
                printf("\nwmlAddClassResourceAttribute: unknown attrid %d",
                       attrid);
                return;
                break;
        }
...
void wmlAddResourceAttribute(attrid, val) int attrid;
char *val;

{
        ...
        case ALIAS:
                if (rdesc->alias_cnt == 0)
                        ...
                        synlist = (char **)realloc(rdesc->alias_list,
                                                   (rdesc->alias_cnt + 1) *
                                                       sizeof(char **));
...
void wmlAddDatatypeAttribute(attrid, val) int attrid;
char *val;

{
        ...
        case XRMRESOURCE:
                ...
                case ATTRFALSE:
                        ...
                        break;
                default:
                        printf("\nwmlAddDatatypeAttribute: bad XRMRESOURCE "
                               "value %d",
                               xrmval);
                        return;
                        break;
...
void wmlAddCtrlListControl(name) char *name;

{
        ...
        if (cdesc->validation != WmlCtrlListDefValid) {
                printf("\nwmlAddCtrlListControl: %d not a controls list "
                       "descriptor",
                       cdesc->validation);
                return;
        }
 ...
 */
void wmlAddEnumSetValue(name) char *name;

{
        ...
        if (esdesc->validation != WmlEnumSetDefValid) {
                printf("\nwmlAddEnumSetValue: %d not an enumeration set "
                       "descriptor",
                       esdesc->validation);
                return;
        }
 ...
 *	val		value of the attribute, usually a string
 */
void wmlAddEnumValueAttribute(attrid, val) int attrid;
char *val;

{
        ...
        if (evdesc->validation != WmlEnumValueDefValid) {
                printf("\nwmlAddEnumValueAttribute: %d not an enumeration "
                       "value descriptor",
                       evdesc->validation);
                return;
        }
...
void wmlAddCharsetAttribute(attrid, val) int attrid;
char *val;

{
        ...
        case ALIAS:
                if (ddesc->alias_cnt == 0)
                        ...
                        synlist = (char **)realloc(ddesc->alias_list,
                                                   (ddesc->alias_cnt + 1) *
                                                       sizeof(char **));
        ...
        case PARSEDIRECTION:
                ...
                case RIGHTTOLEFT:
                        ...
                        break;
                default:
                        printf("\nwmlAddCharsetAttribute: bad PARSEDIRECTION "
                               "value %d",
                               atrval);
                        return;
                        break;
        ...
        case CHARACTERSIZE:
                ...
                case MIXED1_2BYTE:
                        ...
                        break;
                default:
                        printf("\nwmlAddCharsetAttribute: bad CHARACTERSIZE "
                               "value %d",
                               atrval);
                        return;
                        break;
...
void LexIssueError(tkn) int tkn;

{
        ...
        case RBRACE:
                ...
                break;
        case 0:
                printf("\nSyntax error: Couldn't recognize a section name, "
                       "probably fatal");
                break;
        }
        printf("\n\tnear name='%s', value='%s', line %d", yynameval,
               yystringval, wml_line_count);
