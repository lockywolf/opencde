...
void create_ui_components() {
        ...
        base_frame =
            XtVaCreateManagedWidget("base_frame", xmMainWindowWidgetClass,
                                    toplevel, XmNwidth, 269, XmNheight, 104, 0);
        ...
        slabel = XtVaCreateManagedWidget("Send:", xmLabelWidgetClass, controls,
                                         XmNx, 51, XmNy, 16, 0);
        slider = XtVaCreateManagedWidget(
            "slider", xmScaleWidgetClass, controls, XmNleftAttachment,
            XmATTACH_WIDGET, XmNleftWidget, slabel, XmNtopAttachment,
            XmATTACH_OPPOSITE_WIDGET, XmNtopWidget, slabel, XmNscaleWidth, 120,
            XmNscaleHeight, 18, XmNminimum, 0, XmNmaximum, 100, XmNorientation,
            XmHORIZONTAL, 0);

        glabel = XtVaCreateManagedWidget("Received:", xmLabelWidgetClass,
                                         controls, XmNx, 23, XmNy, 42, 0);
        gauge = XtVaCreateManagedWidget(
            "gauge", xmScaleWidgetClass, controls, XmNleftAttachment,
            XmATTACH_WIDGET, XmNleftWidget, glabel, XmNtopAttachment,
            XmATTACH_OPPOSITE_WIDGET, XmNtopWidget, glabel, XmNorientation,
            XmHORIZONTAL, XmNscaleWidth, 125, XmNscaleHeight, 18, XmNminimum, 0,
            XmNmaximum, 100, XmNshowValue, TRUE, 0);

        label = XmStringCreateSimple("Broadcast");
        button = XtVaCreateManagedWidget(
            "button", xmPushButtonWidgetClass, controls, XmNx, 96, XmNy, 78,
            XmNwidth, 76, XmNheight, 19, XmNlabelString, label, 0);
        XmStringFree(label);
