...
void _isdln_base_insert(base, l, e) register char *base;
register struct dlink *l, *e;
{
        ...
        ((struct dlink *)(base + e->dln_forward))->dln_backward =
            (char *)e - base;
}

/* _isdln_base_append () - Append element to list (at the end) -------------*/
void _isdln_base_append(base, l, e) register char *base;
register struct dlink *l, *e;
{
        ...
        ((struct dlink *)(base + e->dln_backward))->dln_forward =
            (char *)e - base;
}

/* _isdln_base_remove () - Remove element from list -------------------------*/
void _isdln_base_remove(base, e) register char *base;
...
struct dlink *_isdln_base_first(base, l) register char *base;
