...
#define MAXFCB_UNIXFD                                                          \
        30 /* Maximum number of UNIX fd                                        \
...
#define ISTCP_RETRY_SLEEP                                                      \
        5 /* time between tries to                                             \
...
#define PHYS_ORDER                                                             \
        (-1) /* value for keyid when physical                                  \
              order is used*/
 ...
 */
#define GETBASE(p, s, e)                                                       \
        ((struct s *)((char *)(p) - (char *)&((struct s *)0)->e))
...
#define ROOT_OPT_SIZE                                                          \
        240 /* List of hosts for which root access                             \
...
extern struct dlink *_isdln_base_prev(), *_isdln_base_next(),
    *_isdln_base_first();
...
Cause a compiler error
    here.There is not enought space in the control page to hold MAXNKEYS.
#endif
...
#define ISMAXDOUBLE                                                            \
        { 0x7f, 0xf0, 0, /* rest is 0 */ }
#define ISMINDOUBLE                                                            \
        { 0xff, 0xf0, 0, /* rest is 0 */ }

#define ISMAXFLOAT                                                             \
        { 0x7f, 0x80, 0, /* rest is 0 */ }
#define ISMINFLOAT                                                             \
        { 0xff, 0x80, 0, /* rest is 0 */ }
