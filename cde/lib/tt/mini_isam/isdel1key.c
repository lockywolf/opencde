...
void _del1key(fcb, pkeydesc2, record, recnum) Fcb *fcb;
Keydesc2 *pkeydesc2;
char *record;
Recno recnum;
{
        ...
        if (ALLOWS_DUPS2(pkeydesc2)) {
                 ...
                 * matching recno. We are positioned just before the first
                 * duplicate. Remember that the duplicates are ordered by their
                 * serial number.
                 *
