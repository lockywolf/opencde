...
int stlong(val, p) register long val;
register char *p;
{
        int i;
        p += LONGSIZE;
...
u_short ldunshort(p) register char *p;
{
        register unsigned int val;
...
int stint(val, p) register short val;
register char *p;
{
        p += SHORTSIZE;
        *--p = val & 255;
...
int ldchar(src, len, dst) char *src;
register char *dst;
int len;
{
        register char *p;
...
int stchar(src, dst, len) register char *src;
register char *dst;
register int len;
{
        register char c;
...
int ldchar2(src, len, dst) char *src;
register char *dst;
int len;
{
        register char *p;
...
int stchar2(src, dst, len) register char *src;
register char *dst;
register int len;
{
        register char c;
...
float ldfloat(p) register char *p;
{
        union {
                float fval;
                int ival;
...
int stfloat(f, p) float f; /* Bug - it is passed as double */
register char *p;
{
...
double lddbl(p) register char *p;
{
        double val;
