...
int isrename(oldname, newname) char *oldname, *newname;
{
        Isfd isfd, isfd2;
        Fab *fab;
...
Static void _removelast2(path) char *path;
{
        register char *p;
...
static int _amrename(isfhandle, newname, errcode) Bytearray *isfhandle;
char *newname;
...
Static void _rename_datfile(isfname, newname) char *isfname;
...
Static void _rename_indfile(isfname, newname) char *isfname;
char *newname; /* with no prefix */
{
        char namebuf[MAXPATHLEN];
        char newbuf[MAXPATHLEN];
...
Static void _rename_varfile(isfname, newname) char *isfname;
char *newname; /* with no prefix */
{
        char namebuf[MAXPATHLEN];
        char newbuf[MAXPATHLEN];
