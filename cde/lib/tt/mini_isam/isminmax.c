...
void _iskey_fillmax(pkeydesc2, keybuf) struct keydesc2 *pkeydesc2;
register char *keybuf;
{
        ...
        for (i = 0; i < nparts + 1; i++) { /* +1 is for recnum part */
                ...
                case BINTYPE:
                        ...
                        break;
                case LONGTYPE:
                        memcpy(keybuf + ppart->kp2_offset, (char *)ismaxlong,
                               LONGSIZE);
                        break;
                case SHORTTYPE:
                        memcpy(keybuf + ppart->kp2_offset, (char *)ismaxshort,
                               SHORTSIZE);
                        break;
                case FLOATTYPE:
                        memcpy(keybuf + ppart->kp2_offset, (char *)ismaxfloat,
                               FLOATSIZE);
                        break;
                case DOUBLETYPE:
                        memcpy(keybuf + ppart->kp2_offset, (char *)ismaxdouble,
                               DOUBLESIZE);
                        break;
                ...
                case LONGTYPE + ISDESC:
                        memcpy(keybuf + ppart->kp2_offset, (char *)isminlong,
                               LONGSIZE);
                        break;
                case SHORTTYPE + ISDESC:
                        memcpy(keybuf + ppart->kp2_offset, (char *)isminshort,
                               SHORTSIZE);
                        break;
                case FLOATTYPE + ISDESC:
                        memcpy(keybuf + ppart->kp2_offset, (char *)isminfloat,
                               FLOATSIZE);
                        break;
                case DOUBLETYPE + ISDESC:
                        memcpy(keybuf + ppart->kp2_offset, (char *)ismindouble,
                               DOUBLESIZE);
                        break;
                default:
...
void _iskey_fillmin(pkeydesc2, keybuf) struct keydesc2 *pkeydesc2;
register char *keybuf;
{
        register int i;
        register struct keypart2 *ppart;
