 ...
 *
 * This file contains the declaration for the class _TT_types_table which
 * implements a hash table of otype and ptype descriptors.
 *
 */
...
enum _Tt_parse_status { _TT_PARSE_OK, _TT_PARSE_ERROR };
