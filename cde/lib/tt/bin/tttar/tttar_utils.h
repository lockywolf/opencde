...
#define note_err(expression)                                                   \
        ((TT_OK == (err_noted = expression))                                   \
             ? TT_OK                                                           \
             : note_error(err_noted, stringify(expression), __FILE__,          \
                          __LINE__))
...
#define note_ptr_err(expression)                                               \
        ((TT_OK == (err_noted = tt_pointer_error(ptr_returned = expression)))  \
             ? TT_OK                                                           \
             : note_error(err_noted, stringify(expression), __FILE__,          \
                          __LINE__))
...
#define note_int_err(expression)                                               \
        ((TT_OK == (err_noted = tt_int_error(int_returned = expression)))      \
             ? TT_OK                                                           \
             : note_error(err_noted, stringify(expression), __FILE__,          \
                          __LINE__))
...
#define note_msg_err(expression)                                               \
        ((TT_OK == (err_noted = tt_pointer_error(msg_returned = expression)))  \
             ? TT_OK                                                           \
             : note_error(err_noted, stringify(expression), __FILE__,          \
                          __LINE__))
...
#define note_voidptr_err(expression)                                           \
        ((TT_OK ==                                                             \
          (err_noted = tt_pointer_error(voidptr_returned = expression)))       \
             ? TT_OK                                                           \
             : note_error(err_noted, stringify(expression), __FILE__,          \
                          __LINE__))
...
Tt_status note_error(Tt_status error, char *expression, char *file, int line);
