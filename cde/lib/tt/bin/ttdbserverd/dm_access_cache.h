...
class _Tt_oid_access : public _Tt_object {
      public:
        ...
        int reclen() const {
                return OID_KEY_LENGTH + sizeof(uid_t) + sizeof(gid_t) +
                       sizeof(mode_t);
        }
        char *rec();
