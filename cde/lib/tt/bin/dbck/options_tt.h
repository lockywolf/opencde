...
class Dbck_specoptions : public Dbck_options {
      ...
      public:
        ...
        virtual int repairing_p() const {
                return Dbck_options::repairing_p() | _repair_filename_p;
        };
        int repair_filename_p() const { return _repair_filename_p; };
        const _Tt_string &repair_filename() const { return _repair_filename; };

        virtual char *type_string() const { return "Dbck_specoptions"; };
