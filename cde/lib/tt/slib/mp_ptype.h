...
class _Tt_ptype : public _Tt_object {
      public:
        ...
        int getprop(_Tt_string propname, _Tt_string &value);
        Tt_status start(_Tt_s_message_ptr &m, const _Tt_msg_trace &trace);
        void set_ptid(_Tt_string ptid);
        void append_osigs(_Tt_signature_list_ptr &sigs);
        void append_hsigs(_Tt_signature_list_ptr &sigs, Tt_category category);
        void append_osig(_Tt_signature_ptr sig);
        void append_hsig(_Tt_signature_ptr sig, Tt_category category);
      ...
      private:
        ...
        Tt_status launch(_Tt_s_message_ptr &m, const _Tt_msg_trace &trace);
        int _launching;
        pid_t _start_pid;
        _Tt_string _ptid;
