...
bool_t tt_s_xdr_add_pattern_args(XDR *xdrs, _Tt_s_add_pattern_args *args);
bool_t tt_s_xdr_del_pattern_args(XDR *xdrs, _Tt_s_del_pattern_args *args);
bool_t tt_s_xdr_update_args(XDR *xdrs, _Tt_s_update_args *args);
