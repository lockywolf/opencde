...
class _Tt_self_procid : public _Tt_s_procid {
      public:
        ...
        handle_Session_Trace(const _Tt_message_ptr &msg, void *self_proc);
        static Tt_callback_action observe_Saved(const _Tt_message_ptr &msg,
                                                void *self_proc);
        //
      ...
      private:
        Tt_status _process_msg(const _Tt_message_ptr &msg);
        //
        // Server-side equivalent of tt_message_reply(), tt_message_fail()
        //
        Tt_status _reply(const _Tt_message_ptr &msg);
        Tt_status _fail(const _Tt_message_ptr &msg, int status);
        virtual Tt_status update_message(const _Tt_message_ptr &msg,
                                         Tt_state new_state);
        //
        // Custom callbacks for doing things ttsession likes to do
        //
        Tt_callback_action _handle_Session_Trace(const _Tt_message_ptr &msg);
        Tt_callback_action _observe_Saved(const _Tt_message_ptr &msg);
};
