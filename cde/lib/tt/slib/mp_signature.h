...
class _Tt_signature : public _Tt_object {
      public:
        ...
        int match(Tt_scope s, Tt_class c, const _Tt_string &op,
                  const _Tt_arg_list_ptr &args, const _Tt_string &otype,
                  const _Tt_context_list_ptr &contexts,
                  const _Tt_msg_trace *trace, int &was_exact) const;
        int match(const _Tt_string &op, const _Tt_arg_list_ptr &args,
                  const _Tt_context_list_ptr &contexts, _Tt_string &reason,
                  int &was_exact) const;
        ...
        static void pretty_print_(const _Tt_ostream &os, const _Tt_object *obj);
        ...
        void set_timestamp(unsigned int stamp) { _timestamp = stamp; }
        int xdr_version_required() const;
        static int xdr_version_required_(const _Tt_signature_list_ptr &sigs);
