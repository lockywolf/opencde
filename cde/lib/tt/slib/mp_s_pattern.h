...
class _Tt_s_pattern : public _Tt_pattern {
      public:
        ...
        int match(const _Tt_s_message &m, const _Tt_msg_trace &trace) const;
      ...
      protected:
        ...
        // messages.
        int match_field(int val, const _Tt_int_rec_list_ptr &pvals, int &tm,
                        const _Tt_msg_trace &trace,
                        const char *failure_note) const;
        int match_field(const _Tt_string &val, const _Tt_string_list_ptr &pvals,
                        int &tm, const _Tt_msg_trace &trace,
                        const char *failure_note) const;
        int match_scopes(const _Tt_message &m, int &tm,
                         const _Tt_msg_trace &trace) const;
        int match_args(const _Tt_message &m, int &tm,
                       const _Tt_msg_trace &trace) const;
        int match_contexts(const _Tt_message &m, int &tm,
                           const _Tt_msg_trace &trace) const;
