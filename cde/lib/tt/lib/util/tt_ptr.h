        ...
        class ptr_to(TYPE) : public _Tt_new_ptr {                              \
              public:                                                          \
                ...
                ptr_to(TYPE) &operator=(TYPE *x) {                             \
                        return (ptr_to(TYPE) &)_Tt_new_ptr::operator=(         \
                            (_Tt_object *)x);                                  \
                }                                                              \
...
#define implement_ptr_to(TYPE)                                                 \
        ...
        ptr_to(TYPE)::ptr_to(TYPE)() {}                                        \
                                                                               \
        TYPE *constructor_of(TYPE)() { return new TYPE; }                      \
                                                                               \
        bool_t xdrfn_of(TYPE)(XDR * xdrs, _Tt_object * p) {                    \
                return ((TYPE *)p)->xdr(xdrs);                                 \
        }                                                                      \
                                                                               \
        bool_t ptr_to(TYPE)::xdr(XDR *xdrs) {                                  \
                return _Tt_new_ptr::xdr(xdrs, (_Tt_new_xdrfn)xdrfn_of(TYPE),   \
                                        (_Tt_object * (*)())                   \
                                            constructor_of(TYPE));             \
        }
