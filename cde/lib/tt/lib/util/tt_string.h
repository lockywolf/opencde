...
declare_list_of(_Tt_string_buf) class _Tt_string_buf : public _Tt_object {
      ...
      public:
        ...
        // _Tt_string_user_width: use $TT_ARG_TRACE_WIDTH or
      ...
      public:
        ...
        int operator==(const _Tt_string &s) const {
                return (
                    ...
                    0 == memcmp((*this)->content, s->content, (*this)->length));
        }
        ...
        void print(const _Tt_ostream &os, int max_print_width = 80000,
                   int quote_it = 0) const;
        int cmp(const _Tt_string &s) const {
                return cmp(s->content, s->length);
        }
...
void _tt_print_escaped_string(const _Tt_ostream &os, const char *s, int length,
                              int max_print_width = 8000, int quote_it = 0);
