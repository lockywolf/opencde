...
char *_tt_catgets(int set_num, int msg_num, const char *default_string);
...
inline char *catgets(int, // pass _ttcatd in here
                     int set_num, int msg_num, const char *default_string) {
