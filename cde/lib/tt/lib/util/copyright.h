...
#define _TT_COPYRIGHT                                                          \
        ...
        "event the source is deemed a published work. "

#define _TT_COPYRIGHT2                                                         \
        "Dissassembly, decompilation, or other means of reducing the object "  \
        "code to human readable form is prohibited by the license agreement "  \
        "under which this code is provided to the user or company in "         \
...
#define _TT_PRINT_VERSIONS(progname)                                           \
        printf("%s version: %s\nToolTalk library version: %s\n", progname,     \
               TT_VERSION_STRING, _tt_lib_version);
#endif
