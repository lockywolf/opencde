...
typedef Tt_filter_action (*_Tt_file_callback)(Tt_filter_function fn,
                                              _Tt_string nodeid, void *context,
                                              void *accumulator);
...
class _Tt_file : public _Tt_db_file {
      public:
        ...
        Tt_status query(_Tt_file_callback fn, Tt_filter_function filter,
                        void *context, void *accumulator);
        static _Tt_string networkPath_(_Tt_object_ptr &obj);
};
