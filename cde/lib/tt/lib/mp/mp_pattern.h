...
typedef Tt_callback_action (*_Tt_server_callback)(const _Tt_message_ptr &msg,
                                                  void *server_data);

enum _Tt_pattern_flags { _TT_PATTERN_IS_REGISTERED, _TT_PATTERN_IN_SESSION };
...
class _Tt_pattern : public _Tt_object {
      public:
        ...
        Tt_status add_netfile(const _Tt_string &file,
        ...
        Tt_status add_context(const _Tt_pat_context_ptr &context);
        bool_t xdr(XDR *xdrs);
      ...
      protected:
        ...
        void add_field(int val, _Tt_int_rec_list_ptr &vlist);
        void add_field(const _Tt_string &val, _Tt_string_list_ptr &vlist);
