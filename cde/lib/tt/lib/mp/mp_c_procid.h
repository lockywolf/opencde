...
class _Tt_c_procid : public _Tt_procid {
      public:
        ...
        _Tt_string &default_file() { return _default_file; }
        _Tt_string &default_ptype() { return _default_ptype; }
        ...
        Tt_status update_message(const _Tt_c_message_ptr &msg,
                                 Tt_state newstate);
        _Tt_typecb_table_ptr &ptype_callbacks() { return _ptype_callbacks; }
        _Tt_typecb_table_ptr &otype_callbacks() { return _otype_callbacks; }
