...
bool_t tt_xdr_declare_ptype_args(XDR *xdrs, _Tt_declare_ptype_args *args);
...
bool_t tt_xdr_add_pattern_args(XDR *xdrs, _Tt_add_pattern_args *args);
bool_t tt_xdr_del_pattern_args(XDR *xdrs, _Tt_del_pattern_args *args);
...
bool_t tt_xdr_next_message_args(XDR *xdrs, _Tt_next_message_args *args);
bool_t tt_xdr_dispatch_reply_args(XDR *xdrs, _Tt_dispatch_reply_args *args);
bool_t tt_xdr_load_types_args(XDR *xdrs, _Tt_load_types_args *args);
