...
extern "C" {
void _tt_svc_freeargs(SVCXPRT *, xdrproc_t, char *);
}
extern "C" {
int _tt_svc_getargs(SVCXPRT *, xdrproc_t, char *);
}

#ifdef OPT_TLI
extern "C" {
int _tt_bind_endpoint(int, char *, char *);
}
extern "C" {
int _tt_tli_set_nodelay(int fd);
}
#endif /* OPT_TLI */
