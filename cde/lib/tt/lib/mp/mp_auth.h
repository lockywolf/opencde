...
class _Tt_auth : public _Tt_object {
      public:
        ...
        _Tt_auth_level auth_level() { return _auth_level; }
        const _Tt_string &auth_cookie() const { return _auth_cookie; }
        Tt_status generate_auth_cookie();
        Tt_status retrieve_auth_cookie();
        Tt_status set_auth_level(_Tt_auth_level auth_level);
        Tt_status set_sessionid(int rpc_program, _Tt_auth_level auth_level,
                                _Tt_string hostaddr, int rpc_version);
      ...
      private:
        ...
        Tt_status read_auth_entries(FILE *, _tt_AuthFileEntryList **);
};
