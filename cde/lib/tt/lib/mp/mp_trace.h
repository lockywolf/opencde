...
class _Tt_msg_trace : public _Tt_trace {
      public:
        _Tt_msg_trace(){};
        _Tt_msg_trace(_Tt_message &msg, _Tt_dispatch_reason reason);
        _Tt_msg_trace(_Tt_message &msg, const _Tt_procid &recipient);
        _Tt_msg_trace(_Tt_message &msg, Tt_state old_state);
        ~_Tt_msg_trace();
};
