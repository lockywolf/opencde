...
void _ttDtPrint(const char *whence, const char *msg);
void _ttDtPrintStatus(const char *whence, const char *expr, Tt_status err);
void _ttDtPrintInt(const char *whence, const char *msg, int n);
void _ttDtPError(const char *whence, const char *msg);
const char *_ttDtOp(Tttk_op op);
Tt_callback_action _ttDtCallbackAction(Tt_message msg);
