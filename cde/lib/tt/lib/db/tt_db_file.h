...
class _Tt_db_file : public _Tt_object {
      public:
        ...
        // Removes the file and all of its objects from the database.  Once this
        // is called this particular object instantiation is useless until
        // "setFile" has been called.
        ...
        // Gets the local path of the file.  Regardless of what path was
        // specified in the object constructor, getLocalPath always returns the
        // real path (the result of _tt_realpath).
        const _Tt_string &getLocalPath() const { return dbFile; }
        ...
        //               hostname:/path
        //
        const _Tt_string &getNetworkPath() const { return dbFileNetworkPath; }
