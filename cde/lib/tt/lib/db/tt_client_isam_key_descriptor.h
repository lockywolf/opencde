...
/*%%  $XConsortium: tt_client_isam_key_descriptor.h /main/3 1995/10/23 09:59:50
 * rswiston $ 			 				 */
/*
...
class _Tt_client_isam_key_descriptor : public _Tt_object {
      public:
        ...
        short getKeyPart(short index, short &start, short &length,
                         short &type) const;

        short getNumberOfParts() const { return keyDescriptor.k_nparts; }

        keydesc *getKeyDescriptor() { return &keyDescriptor; }
