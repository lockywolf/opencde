...
const int TT_OLD_DB_PROPERTY_VALUE_OFFSET =
    TT_OLD_DB_KEY_LENGTH + TT_OLD_DB_MAX_PROPERTY_NAME_LENGTH;
const int TT_OLD_DB_ACCESS_USER_OFFSET = TT_OLD_DB_KEY_LENGTH;
const int TT_OLD_DB_ACCESS_GROUP_OFFSET =
    TT_OLD_DB_KEY_LENGTH + TT_OLD_DB_SHORT_SIZE;
const int TT_OLD_DB_ACCESS_MODE_OFFSET =
    TT_OLD_DB_KEY_LENGTH + 2 * TT_OLD_DB_SHORT_SIZE;
