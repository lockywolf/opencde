...
class _Tt_old_db : public _Tt_object {
      public:
        ...
        _Tt_old_db(const _Tt_string &, const _Tt_db_client_ptr &);
        ~_Tt_old_db();
      ...
      private:
        ...
        _Tt_db_results verifyAccess(const _Tt_string &,
                                    const _Tt_db_access_ptr &, bool_t = FALSE,
                                    bool_t = FALSE);
        _Tt_string getObjectKey(const _Tt_string &);

        _Tt_db_results setProperty(const _Tt_string &,
        ...
        _Tt_db_results addProperty(const _Tt_string &,
                                   const _Tt_db_property_ptr &, bool_t);
        _Tt_db_results deleteProperty(const _Tt_string &,
                                      const _Tt_db_property_ptr &);
        _Tt_db_results deleteProperties(const _Tt_string &, bool_t = FALSE);
        _Tt_db_results getProperty(const _Tt_string &, const _Tt_string &,
                                   _Tt_db_property_ptr &);
        ...
        _Tt_db_results addPropertyValue(const _Tt_string &, const _Tt_string &,
                                        const _Tt_string &);
};
