 ...
 * $ 			 				 */
/*
 * tt_client_isam_record.h - Defines the TT ISAM record class.  This class
 * simplifies putting data in a record.  To get an empty record ready to be
 * filled with data, call the
 * _Tt_client_isam_file::getEmptyRecord.
 *
...
class _Tt_client_isam_record : public _Tt_object {
      public:
        ...
        // Real constructor
        _Tt_client_isam_record(
            const _Tt_client_isam_key_descriptor_list_ptr &key_descriptor_list,
            int max_record_length, int min_record_length);
        ~_Tt_client_isam_record();
        ...
        void setLength(int length) { currentLength = length; }
        ...
        const _Tt_string &getRecord() const { return buffer; }
