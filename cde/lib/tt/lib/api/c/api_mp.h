...
Tt_status _tt_file_objects_query(const char *filepath,
                                 Tt_filter_function filter, void *context,
                                 void *accumulator);
...
Tt_status _tt_file_move(const char *oldfilepath, const char *newfilepath);
Tt_status _tt_file_copy(const char *oldfilepath, const char *newfilepath);

Tt_status _tt_filelist_objects_query(const char **filepathlist,
                                     Tt_filter_function filter, void *context,
                                     void *accumulator);
Tt_status _tt_message_accept(Tt_message m);
Tt_status _tt_message_arg_add(Tt_message m, Tt_mode n, const char *vtype,
                              const char *value);
char *_tt_message_arg_val(Tt_message m, int n);
Tt_status _tt_message_arg_val_set(Tt_message m, int n, const char *value);
Tt_status _tt_message_barg_add(Tt_message m, Tt_mode n, const char *vtype,
                               const unsigned char *value, int len);
Tt_status _tt_message_arg_bval(Tt_message m, int n, unsigned char **value,
                               int *len);
Tt_status _tt_message_arg_bval_set(Tt_message m, int n,
                                   const unsigned char *value, int len);
Tt_status _tt_message_iarg_add(Tt_message m, Tt_mode n, const char *vtype,
                               int value);
...
Tt_status _tt_message_callback_add(Tt_message m, Tt_message_callback f);
...
int _tt_otype_is_derived(const char *derivedotype, const char *baseotype);
...
Tt_mode _tt_otype_osig_arg_mode(const char *otype, int sig, int arg);
Tt_mode _tt_otype_hsig_arg_mode(const char *otype, int sig, int arg);
char *_tt_otype_osig_arg_type(const char *otype, int sig, int arg);
char *_tt_otype_hsig_arg_type(const char *otype, int sig, int arg);
...
Tt_status _tt_spec_prop_add(const char *nodeid, const char *propname,
                            const char *value);
int _tt_spec_prop_count(const char *nodeid, const char *propname);
Tt_status _tt_spec_prop_set(const char *nodeid, const char *propname,
                            const char *value);
...
Tt_status _tt_pattern_arg_add(Tt_pattern p, Tt_mode n, const char *vtype,
                              const char *value);
Tt_status _tt_pattern_barg_add(Tt_pattern p, Tt_mode n, const char *vtype,
                               const unsigned char *value, int len);
Tt_status _tt_pattern_iarg_add(Tt_pattern p, Tt_mode n, const char *vtype,
                               int value);

Tt_status _tt_pattern_callback_add(Tt_pattern m, Tt_message_callback f);
...
char *_tt_session_prop(const char *sessid, const char *propname, int i);
Tt_status _tt_session_prop_add(const char *sessid, const char *propname,
                               const char *value);
int _tt_session_prop_count(const char *sessid, const char *propname);
Tt_status _tt_session_prop_set(const char *sessid, const char *propname,
                               const char *value);
Tt_status _tt_session_bprop(const char *sessid, const char *propname, int i,
                            unsigned char **value, int *length);
