...
declare_list_of(_Tt_api_handle) declare_list_of(_Tt_api_userdata)
...
class _Tt_api_handle_table : public _Tt_object {
      public:
        ...
        Tt_status store(Tt_message h, int key, void *userdata);
        Tt_status store(Tt_pattern h, int key, void *userdata);
        void *fetch(Tt_message h, int key);
        void *fetch(Tt_pattern h, int key);
        Tt_status add_callback(Tt_message h, Tt_message_callback f);
        Tt_status add_callback(Tt_pattern h, Tt_message_callback f);
        Tt_callback_action run_message_callbacks(Tt_message h, Tt_pattern ph);
        Tt_callback_action run_pattern_callbacks(Tt_pattern h, Tt_message mh);
        void print(FILE *fs = stdout) const;
