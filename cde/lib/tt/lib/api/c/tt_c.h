...
#define _TT_EXTERN_FUNC(type, name, list)                                      \
        type;                                                                  \
        name;                                                                  \
        list
#else
...
typedef Tt_filter_action (*Tt_filter_function)(_TT_CONST char *nodeid,
                                               void *context,
                                               void *accumulator);
typedef Tt_callback_action (*Tt_message_callback)(Tt_message m, Tt_pattern p);
#else
...
_TT_EXTERN_FUNC(Tt_status, tt_file_objects_query,
                (_TT_CONST char *filepath, Tt_filter_function filter,
...
_TT_EXTERN_FUNC(Tt_status, tt_message_context_bval,
                (Tt_message m, _TT_CONST char *slotname, unsigned char **value,
                 int *len))
_TT_EXTERN_FUNC(Tt_status, tt_message_context_xval,
                (Tt_message m, _TT_CONST char *slotname, xdrproc_t xdr_proc,
                 void *value))
_TT_EXTERN_FUNC(Tt_status, tt_message_context_set,
                (Tt_message m, _TT_CONST char *slotname, _TT_CONST char *value))
...
_TT_EXTERN_FUNC(Tt_status, tt_bcontext_join,
                (_TT_CONST char *slotname, _TT_CONST unsigned char *value,
                 int len))
_TT_EXTERN_FUNC(Tt_status, tt_xcontext_join,
                (_TT_CONST char *slotname, xdrproc_t xdr_proc, void *value))
...
_TT_EXTERN_FUNC(char *, tt_message_context_slotname, (Tt_message m, int i))
...
_TT_EXTERN_FUNC(Tt_status, tt_message_user_set,
                (Tt_message m, int key, void *v))
...
_TT_EXTERN_FUNC(Tt_status, tt_message_class_set, (Tt_message m, Tt_class c))
...
_TT_EXTERN_FUNC(Tt_status, tt_message_address_set, (Tt_message m, Tt_address p))
...
_TT_EXTERN_FUNC(Tt_mode, tt_otype_osig_arg_mode,
                (_TT_CONST char *otype, int sig, int arg))
_TT_EXTERN_FUNC(Tt_mode, tt_otype_hsig_arg_mode,
                (_TT_CONST char *otype, int sig, int arg))
_TT_EXTERN_FUNC(char *, tt_otype_osig_arg_type,
                (_TT_CONST char *otype, int sig, int arg))
_TT_EXTERN_FUNC(char *, tt_otype_hsig_arg_type,
                (_TT_CONST char *otype, int sig, int arg))
...
_TT_EXTERN_FUNC(Tt_status, tt_pattern_user_set,
                (Tt_pattern p, int key, void *v))
...
_TT_EXTERN_FUNC(Tt_status, tt_pattern_class_add, (Tt_pattern p, Tt_class c))
...
_TT_EXTERN_FUNC(Tt_status, tt_pattern_address_add, (Tt_pattern p, Tt_address d))
...
_TT_EXTERN_FUNC(Tt_status, tt_pattern_context_add,
                (Tt_pattern p, _TT_CONST char *slotname, _TT_CONST char *value))
_TT_EXTERN_FUNC(Tt_status, tt_pattern_icontext_add,
                (Tt_pattern p, _TT_CONST char *slotname, int value))
...
_TT_EXTERN_FUNC(Tt_status, tt_pattern_xcontext_add,
                (Tt_pattern p, _TT_CONST char *slotname, xdrproc_t xdr_proc,
                 void *value))
...
_TT_EXTERN_FUNC(char *, tt_host_file_netfile,
                (const char *host, const char *filename))
_TT_EXTERN_FUNC(char *, tt_host_netfile_file,
                (const char *host, const char *netfilename))
