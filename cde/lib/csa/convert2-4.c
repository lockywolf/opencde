...
extern Access_Status_4 _DtCm_accstat2_to_accstat4(Access_Status_2 s) {
        switch (s) {
        case access_ok_2:
                return (access_ok_4);
        case access_added_2:
...
extern Table_Res_4 *_DtCm_tableres2_to_tableres4(Table_Res_2 *r2) {
        Table_Res_4 *r4;
...
extern Access_Args_4 *_DtCm_accargs2_to_accargs4(Access_Args_2 *a2) {
        Access_Args_4 *a4;
...
extern Table_Args_4 *_DtCm_tableargs2_to_tableargs4(Table_Args_2 *a2) {
        Table_Args_4 *a4;
...
extern Table_Args_4 *_DtCm_tabledelargs2_to_tabledelargs4(Table_Args_2 *a2,
                                                          Options_4 opt) {
        Table_Args_4 *a4;
...
extern Registration_4 *_DtCm_reg2_to_reg4(Registration_2 *r2) {
...
extern Table_Status_4 _DtCm_tablestat2_to_tablestat4(Table_Status_2 s) {
        switch (s) {
        case ok_2:
                return (ok_4);
        case duplicate_2:
...
static void tablereslist2_to_tablereslist4(Table_Res_List_2 *from,
        ...
        case AP_2:
                to->Table_Res_List_4_u.a =
                    appt2_to_appt4(from->Table_Res_List_2_u.a);
                break;
        case RM_2:
                to->Table_Res_List_4_u.r =
                    reminder2_to_reminder4(from->Table_Res_List_2_u.r);
                break;
        case AB_2:
                to->Table_Res_List_4_u.b =
                    abb2_to_abb4(from->Table_Res_List_2_u.b);
                break;
        case ID_2:
                to->Table_Res_List_4_u.i =
                    uid2_to_uid4(from->Table_Res_List_2_u.i);
                break;
        default:
                return;
        }
...
static void args2_to_args4(Args_2 *from, Args_4 *to) {
        ...
        case APPTID_2:
                ...
                apptid2_to_apptid4(&(from->Args_2_u.apptid),
                                   &(to->Args_4_u.apptid));
                break;
        case UID_2:
