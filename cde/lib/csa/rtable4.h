...
enum Options_4 { do_all_4 = 0, do_one_4 = 1, do_forward_4 = 2 };
...
enum Privacy_Level_4 { public_4 = 0, private_4 = 1, semiprivate_4 = 2 };
...
enum Table_Res_Type_4 { AP_4 = 0, RM_4 = 1, AB_4 = 2, ID_4 = 3 };
...
extern Table_Res_4 *_DtCm_rtable_lookup_next_larger_4(Table_Args_4 *,
                                                      _DtCm_Connection *);
extern Table_Res_4 *_DtCm_rtable_lookup_next_larger_4_svc(Table_Args_4 *,
                                                          struct svc_req *);
#define rtable_lookup_next_smaller ((unsigned long)(3))
extern Table_Res_4 *_DtCm_rtable_lookup_next_smaller_4(Table_Args_4 *,
                                                       _DtCm_Connection *);
extern Table_Res_4 *_DtCm_rtable_lookup_next_smaller_4_svc(Table_Args_4 *,
                                                           struct svc_req *);
#define rtable_lookup_range ((unsigned long)(4))
extern Table_Res_4 *_DtCm_rtable_lookup_range_4(Table_Args_4 *,
                                                _DtCm_Connection *);
extern Table_Res_4 *_DtCm_rtable_lookup_range_4_svc(Table_Args_4 *,
                                                    struct svc_req *);
#define rtable_abbreviated_lookup_range ((unsigned long)(5))
extern Table_Res_4 *_DtCm_rtable_abbreviated_lookup_range_4(Table_Args_4 *,
                                                            _DtCm_Connection *);
extern Table_Res_4 *
_DtCm_rtable_abbreviated_lookup_range_4_svc(Table_Args_4 *, struct svc_req *);
...
extern Table_Res_4 *_DtCm_rtable_delete_instance_4(Table_Args_4 *,
                                                   _DtCm_Connection *);
extern Table_Res_4 *_DtCm_rtable_delete_instance_4_svc(Table_Args_4 *,
                                                       struct svc_req *);
...
extern Table_Res_4 *_DtCm_rtable_change_instance_4(Table_Args_4 *,
                                                   _DtCm_Connection *);
extern Table_Res_4 *_DtCm_rtable_change_instance_4_svc(Table_Args_4 *,
                                                       struct svc_req *);
#define rtable_lookup_next_reminder ((unsigned long)(11))
extern Table_Res_4 *_DtCm_rtable_lookup_next_reminder_4(Table_Args_4 *,
                                                        _DtCm_Connection *);
extern Table_Res_4 *_DtCm_rtable_lookup_next_reminder_4_svc(Table_Args_4 *,
                                                            struct svc_req *);
#define rtable_check ((unsigned long)(12))
extern Table_Status_4 *_DtCm_rtable_check_4(Table_Args_4 *, _DtCm_Connection *);
extern Table_Status_4 *_DtCm_rtable_check_4_svc(Table_Args_4 *,
                                                struct svc_req *);
#define rtable_flush_table ((unsigned long)(13))
extern Table_Status_4 *_DtCm_rtable_flush_table_4(Table_Args_4 *,
                                                  _DtCm_Connection *);
extern Table_Status_4 *_DtCm_rtable_flush_table_4_svc(Table_Args_4 *,
                                                      struct svc_req *);
...
extern Registration_Status_4 *_DtCm_register_callback_4(Registration_4 *,
                                                        _DtCm_Connection *);
extern Registration_Status_4 *_DtCm_register_callback_4_svc(Registration_4 *,
                                                            struct svc_req *);
#define deregister_callback ((unsigned long)(16))
extern Registration_Status_4 *_DtCm_deregister_callback_4(Registration_4 *,
                                                          _DtCm_Connection *);
extern Registration_Status_4 *_DtCm_deregister_callback_4_svc(Registration_4 *,
                                                              struct svc_req *);
#define rtable_set_access ((unsigned long)(17))
extern Access_Status_4 *_DtCm_rtable_set_access_4(Access_Args_4 *,
                                                  _DtCm_Connection *);
extern Access_Status_4 *_DtCm_rtable_set_access_4_svc(Access_Args_4 *,
                                                      struct svc_req *);
#define rtable_get_access ((unsigned long)(18))
extern Access_Args_4 *_DtCm_rtable_get_access_4(Access_Args_4 *,
                                                _DtCm_Connection *);
extern Access_Args_4 *_DtCm_rtable_get_access_4_svc(Access_Args_4 *,
                                                    struct svc_req *);
#define rtable_abbreviated_lookup_key_range ((unsigned long)(19))
extern Table_Res_4 *
_DtCm_rtable_abbreviated_lookup_key_range_4(Table_Args_4 *, _DtCm_Connection *);
extern Table_Res_4 *
_DtCm_rtable_abbreviated_lookup_key_range_4_svc(Table_Args_4 *,
                                                struct svc_req *);
...
extern Table_Status_4 *_DtCm_rtable_create_4(Table_Op_Args_4 *,
                                             _DtCm_Connection *);
extern Table_Status_4 *_DtCm_rtable_create_4_svc(Table_Op_Args_4 *,
                                                 struct svc_req *);
#define rtable_remove ((unsigned long)(22))
extern Table_Status_4 *_DtCm_rtable_remove_4(Table_Op_Args_4 *,
                                             _DtCm_Connection *);
extern Table_Status_4 *_DtCm_rtable_remove_4_svc(Table_Op_Args_4 *,
                                                 struct svc_req *);
#define rtable_rename ((unsigned long)(23))
extern Table_Status_4 *_DtCm_rtable_rename_4(Table_Op_Args_4 *,
                                             _DtCm_Connection *);
extern Table_Status_4 *_DtCm_rtable_rename_4_svc(Table_Op_Args_4 *,
                                                 struct svc_req *);
