...
**  rtable2.h
**
**  static char sccsid[] = "@(#)rtable2.h 1.1 94/09/05 Copyr 1991 Sun
*Microsystems, Inc.";
**
...
enum Transaction_2 { add_2 = 0, cm_remove_2 = 1 };
...
enum Tag_2 { appointment_2 = 0, reminder_2 = 1, otherTag_2 = 2 };
...
enum Table_Res_Type_2 { AP_2 = 0, RM_2 = 1, AB_2 = 2, ID_2 = 3 };
...
extern Table_Res_2 *_DtCm_rtable_lookup_next_larger_2(Table_Args_2 *,
                                                      _DtCm_Connection *);
extern Table_Res_2 *_DtCm_rtable_lookup_next_larger_2_svc(Table_Args_2 *,
                                                          struct svc_req *);
#define rtable_lookup_next_smaller ((unsigned long)(3))
extern Table_Res_2 *_DtCm_rtable_lookup_next_smaller_2(Table_Args_2 *,
                                                       _DtCm_Connection *);
extern Table_Res_2 *_DtCm_rtable_lookup_next_smaller_2_svc(Table_Args_2 *,
                                                           struct svc_req *);
#define rtable_lookup_range ((unsigned long)(4))
extern Table_Res_2 *_DtCm_rtable_lookup_range_2(Table_Args_2 *,
                                                _DtCm_Connection *);
extern Table_Res_2 *_DtCm_rtable_lookup_range_2_svc(Table_Args_2 *,
                                                    struct svc_req *);
#define rtable_abbreviated_lookup_range ((unsigned long)(5))
extern Table_Res_2 *_DtCm_rtable_abbreviated_lookup_range_2(Table_Args_2 *,
                                                            _DtCm_Connection *);
extern Table_Res_2 *
_DtCm_rtable_abbreviated_lookup_range_2_svc(Table_Args_2 *, struct svc_req *);
...
extern Table_Res_2 *_DtCm_rtable_delete_instance_2(Table_Args_2 *,
                                                   _DtCm_Connection *);
extern Table_Res_2 *_DtCm_rtable_delete_instance_2_svc(Table_Args_2 *,
                                                       struct svc_req *);
...
extern Table_Res_2 *_DtCm_rtable_change_instance_2(Table_Args_2 *,
                                                   _DtCm_Connection *);
extern Table_Res_2 *_DtCm_rtable_change_instance_2_svc(Table_Args_2 *,
                                                       struct svc_req *);
#define rtable_lookup_next_reminder ((unsigned long)(11))
extern Table_Res_2 *_DtCm_rtable_lookup_next_reminder_2(Table_Args_2 *,
                                                        _DtCm_Connection *);
extern Table_Res_2 *_DtCm_rtable_lookup_next_reminder_2_svc(Table_Args_2 *,
                                                            struct svc_req *);
#define rtable_check ((unsigned long)(12))
extern Table_Status_2 *_DtCm_rtable_check_2(Table_Args_2 *, _DtCm_Connection *);
extern Table_Status_2 *_DtCm_rtable_check_2_svc(Table_Args_2 *,
                                                struct svc_req *);
#define rtable_flush_table ((unsigned long)(13))
extern Table_Status_2 *_DtCm_rtable_flush_table_2(Table_Args_2 *,
                                                  _DtCm_Connection *);
extern Table_Status_2 *_DtCm_rtable_flush_table_2_svc(Table_Args_2 *,
                                                      struct svc_req *);
...
extern Registration_Status_2 *_DtCm_register_callback_2(Registration_2 *,
                                                        _DtCm_Connection *);
extern Registration_Status_2 *_DtCm_register_callback_2_svc(Registration_2 *,
                                                            struct svc_req *);
#define deregister_callback ((unsigned long)(16))
extern Registration_Status_2 *_DtCm_deregister_callback_2(Registration_2 *,
                                                          _DtCm_Connection *);
extern Registration_Status_2 *_DtCm_deregister_callback_2_svc(Registration_2 *,
                                                              struct svc_req *);
#define rtable_set_access ((unsigned long)(17))
extern Access_Status_2 *_DtCm_rtable_set_access_2(Access_Args_2 *,
                                                  _DtCm_Connection *);
extern Access_Status_2 *_DtCm_rtable_set_access_2_svc(Access_Args_2 *,
                                                      struct svc_req *);
#define rtable_get_access ((unsigned long)(18))
extern Access_Args_2 *_DtCm_rtable_get_access_2(Access_Args_2 *,
                                                _DtCm_Connection *);
extern Access_Args_2 *_DtCm_rtable_get_access_2_svc(Access_Args_2 *,
                                                    struct svc_req *);
