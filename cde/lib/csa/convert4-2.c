...
extern void _DtCm_id4_to_id2(Id_4 *from, Id_2 *to) {
...
extern Uid_2 *_DtCm_uid4_to_uid2(Uid_4 *ui4) {
        Uid_2 *ui2, *head, *prev;
...
extern Appt_2 *_DtCm_appt4_to_appt2(Appt_4 *a4) {
        Appt_2 *a2, *head, *prev;
                ...
                */
                ...
                while (item != NULL) {
                        if (strcmp(item->attr, "ml") == 0) {
                                a2->mailto =
                                    buffer4_to_buffer2(item->clientdata);
                                break;
                        }
                        item = item->next;
                }
...
extern Access_Status_2 _DtCm_accstat4_to_accstat2(Access_Status_4 s) {
        switch (s) {
        case access_ok_4:
                return (access_ok_2);
        case access_added_4:
...
extern Table_Res_2 *_DtCm_tableres4_to_tableres2(Table_Res_4 *r4) {
        Table_Res_2 *r2;

        if (r4 == NULL)
                return ((Table_Res_2 *)NULL);
...
extern Access_Entry_2 *_DtCm_acclist4_to_acclist2(Access_Entry_4 *l4) {
...
extern Access_Args_2 *_DtCm_accargs4_to_accargs2(Access_Args_4 *a4) {
        Access_Args_2 *a2;

        if (a4 == NULL)
                return ((Access_Args_2 *)NULL);
...
extern Range_2 *_DtCm_range4_to_range2(Range_4 *r4) {
...
extern Table_Status_2 _DtCm_tablestat4_to_tablestat2(Table_Status_4 s) {
        switch (s) {
        case ok_4:
                return (ok_2);
        case duplicate_4:
...
extern Uid_2 *_DtCm_uidopt4_to_uid2(Uidopt_4 *uidopt) {
...
static void apptid4_to_apptid2(Apptid_4 *from, Apptid_2 *to) {
        if (from == NULL || to == NULL)
                return;
...
static void tablereslist4_to_tablereslist2(Table_Res_List_4 *from,
        ...
        switch (from->tag) {
        case AP_4:
                to->Table_Res_List_2_u.a =
                    _DtCm_appt4_to_appt2(from->Table_Res_List_4_u.a);
                break;
        case RM_4:
                to->Table_Res_List_2_u.r =
                    reminder4_to_reminder2(from->Table_Res_List_4_u.r);
                break;
        case AB_4:
                to->Table_Res_List_2_u.b =
                    abb4_to_abb2(from->Table_Res_List_4_u.b);
                break;
        case ID_4:
                to->Table_Res_List_2_u.i =
                    _DtCm_uid4_to_uid2(from->Table_Res_List_4_u.i);
        default:
                return;
        }
}
...
static void args4_to_args2(Args_4 *from, Args_2 *to) {
        ...
        case APPTID_4:
                ...
                apptid4_to_apptid2(&(from->Args_4_u.apptid),
                                   &(to->Args_2_u.apptid));
                break;
        case UID_4:
        ...
        case RANGE_4:
                to->Args_2_u.range =
                    _DtCm_range4_to_range2(from->Args_4_u.range);
                break;
        default:
                break;
        }
