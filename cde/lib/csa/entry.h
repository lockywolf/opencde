...
extern CSA_return_code _DtCm_make_libentry P((cms_entry * cmsentry,
                                              _DtCm_libentry **entry_r));

extern CSA_return_code _DtCm_get_entry_detail P((_DtCm_libentry * entry));

extern CSA_return_code _DtCm_get_entry_attr_names P((_DtCm_libentry * entry,
                                                     CSA_uint32 *num_names_r,
                                                     char **names_r[]));

extern CSA_return_code _DtCm_get_entry_attrs_by_name
    P((_DtCm_libentry * entry, CSA_uint32 num_names,
       CSA_attribute_reference *names, CSA_uint32 *num_attrs,
       CSA_attribute **attrs));

extern CSA_return_code _DtCm_get_all_entry_attrs P((_DtCm_libentry * entry,
                                                    CSA_uint32 *num_attrs,
                                                    CSA_attribute **attrs));

extern CSA_return_code _DtCm_libentry_to_entryh
    P((_DtCm_libentry * elist, CSA_uint32 *size, CSA_entry_handle **entries_r));

extern CSA_return_code _DtCmCmsentriesToLibentries
    P((_DtCmNameTable * *tbl, cms_entry *entries, _DtCm_libentry **libentries));

extern CSA_return_code _DtCm_appt4_to_libentries
    P((char *calname, Appt_4 *appt4, _DtCm_libentry **libentries));

extern CSA_return_code _DtCm_libentries_to_appt4 P((_DtCm_libentry * libentries,
                                                    Appt_4 **appt4));

extern CSA_return_code _DtCm_reminder4_to_csareminder
    P((Reminder_4 * r4, CSA_uint32 *num_rems, CSA_reminder_reference **rems));

extern _DtCm_libentry *_DtCm_convert_entry_wheader P((_DtCm_libentry * entry));

extern void _DtCm_free_libentries_from_list P((_DtCm_libentry * head,
                                               _DtCm_libentry *tail));

extern void _DtCm_free_libentries P((_DtCm_libentry * entries));

extern void _DtCm_free_entry_handles P((uint num_entries,
                                        CSA_entry_handle *entries));

extern void _DtCm_free_reminder_references P((uint num_rems,
...
extern CSA_return_code _DtCm_cms2csa_reminder_ref
    P((cms_reminder_ref * cmsrems, CSA_uint32 *num_rems,
