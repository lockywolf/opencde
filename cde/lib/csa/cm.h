...
extern cms_list_calendars_res *cms_list_calendars_5_svc(void *,
                                                        struct svc_req *);
...
extern CSA_return_code *cms_create_calendar_5(cms_create_args *,
                                              _DtCm_Connection *);
extern CSA_return_code *cms_create_calendar_5_svc(cms_create_args *,
                                                  struct svc_req *);
#define CMS_REMOVE_CALENDAR ((unsigned long)(4))
extern CSA_return_code *cms_remove_calendar_5(cms_remove_args *,
                                              _DtCm_Connection *);
extern CSA_return_code *cms_remove_calendar_5_svc(cms_remove_args *,
                                                  struct svc_req *);
#define CMS_REGISTER ((unsigned long)(5))
extern CSA_return_code *cms_register_5(cms_register_args *, _DtCm_Connection *);
extern CSA_return_code *cms_register_5_svc(cms_register_args *,
                                           struct svc_req *);
#define CMS_UNREGISTER ((unsigned long)(6))
extern CSA_return_code *cms_unregister_5(cms_register_args *,
                                         _DtCm_Connection *);
extern CSA_return_code *cms_unregister_5_svc(cms_register_args *,
                                             struct svc_req *);
#define CMS_ENUMERATE_CALENDAR_ATTR ((unsigned long)(7))
extern cms_enumerate_calendar_attr_res *
cms_enumerate_calendar_attr_5(cms_name *, _DtCm_Connection *);
extern cms_enumerate_calendar_attr_res *
cms_enumerate_calendar_attr_5_svc(cms_name *, struct svc_req *);
#define CMS_GET_CALENDAR_ATTR ((unsigned long)(8))
extern cms_get_cal_attr_res *cms_get_calendar_attr_5(cms_get_cal_attr_args *,
                                                     _DtCm_Connection *);
extern cms_get_cal_attr_res *
cms_get_calendar_attr_5_svc(cms_get_cal_attr_args *, struct svc_req *);
#define CMS_SET_CALENDAR_ATTR ((unsigned long)(9))
extern CSA_return_code *cms_set_calendar_attr_5(cms_set_cal_attr_args *,
                                                _DtCm_Connection *);
extern CSA_return_code *cms_set_calendar_attr_5_svc(cms_set_cal_attr_args *,
                                                    struct svc_req *);
...
extern cms_reminder_res *cms_lookup_reminder_5(cms_reminder_args *,
                                               _DtCm_Connection *);
extern cms_reminder_res *cms_lookup_reminder_5_svc(cms_reminder_args *,
                                                   struct svc_req *);
#define CMS_LOOKUP_ENTRIES ((unsigned long)(13))
extern cms_entries_res *cms_lookup_entries_5(cms_lookup_entries_args *,
                                             _DtCm_Connection *);
extern cms_entries_res *cms_lookup_entries_5_svc(cms_lookup_entries_args *,
                                                 struct svc_req *);
#define CMS_ENUMERATE_SEQUENCE ((unsigned long)(14))
extern cms_entries_res *cms_enumerate_sequence_5(cms_enumerate_args *,
                                                 _DtCm_Connection *);
extern cms_entries_res *cms_enumerate_sequence_5_svc(cms_enumerate_args *,
                                                     struct svc_req *);
#define CMS_GET_ENTRY_ATTR ((unsigned long)(15))
extern cms_get_entry_attr_res *cms_get_entry_attr_5(cms_get_entry_attr_args *,
                                                    _DtCm_Connection *);
extern cms_get_entry_attr_res *
cms_get_entry_attr_5_svc(cms_get_entry_attr_args *, struct svc_req *);
#define CMS_INSERT_ENTRY ((unsigned long)(16))
extern cms_entry_res *cms_insert_entry_5(cms_insert_args *, _DtCm_Connection *);
extern cms_entry_res *cms_insert_entry_5_svc(cms_insert_args *,
                                             struct svc_req *);
#define CMS_UPDATE_ENTRY ((unsigned long)(17))
extern cms_entry_res *cms_update_entry_5(cms_update_args *, _DtCm_Connection *);
extern cms_entry_res *cms_update_entry_5_svc(cms_update_args *,
                                             struct svc_req *);
#define CMS_DELETE_ENTRY ((unsigned long)(18))
extern CSA_return_code *cms_delete_entry_5(cms_delete_args *,
                                           _DtCm_Connection *);
extern CSA_return_code *cms_delete_entry_5_svc(cms_delete_args *,
                                               struct svc_req *);
...
extern bool_t
xdr_cms_enumerate_calendar_attr_res(XDR *, cms_enumerate_calendar_attr_res *);
...
extern bool_t xdr_cms_get_entry_attr_res_item(XDR *,
                                              cms_get_entry_attr_res_item *);
