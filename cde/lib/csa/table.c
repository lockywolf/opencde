 ...
 *****************************************************************************/
static CSA_return_code tablestat_to_dtcmstat(Table_Status_4 stat,
...
extern CSA_return_code _DtCm_table_get_access(Calendar *cal,
        ...
        *alist = NULL;
        ...
        case TABLEVERS_2:
                ...
                if (res2 != NULL)
                        xdr_free((xdrproc_t)_DtCm_xdr_Access_Args_2,
                                 (char *)res2);
                break;
        case TABLEVERS_3:
                a3.target = cal->name;
                ...
                if (res3 != NULL)
                        xdr_free((xdrproc_t)_DtCm_xdr_Access_Args_3,
                                 (char *)res3);
                break;
        case TABLEVERS_4:
                a4.target = cal->name;
        ...
        if (res != NULL) {
                stat = _DtCm_accessentry4_to_cmsaccesslist(res->access_list,
                                                           alist);
...
extern CSA_return_code _DtCm_table_set_access(Calendar *cal,
        ...
        case TABLEVERS_2:
                ...
                if (a2.access_list != NULL)
                        _DtCm_free_access_list4(
                            (Access_Entry_4 *)a2.access_list);
                break;
        case TABLEVERS_3:
                a3.target = cal->name;
...
extern CSA_return_code _DtCm_table_lookup(Calendar *cal,
        ...
        case TABLEVERS_2:
                ...
                if (res2 != NULL)
                        xdr_free((xdrproc_t)_DtCm_xdr_Table_Res_2,
                                 (char *)res2);
                break;
        case TABLEVERS_3:
                a3.target = cal->name;
                ...
                if (res3 != NULL)
                        xdr_free((xdrproc_t)_DtCm_xdr_Table_Res_3,
                                 (char *)res3);
                break;
        case TABLEVERS_4:
                a4.target = cal->name;
...
_DtCm_table_lookup_range(Calendar *cal, long start1, long start2,
                         boolean_t no_end_time_range, long end1, long end2,
                         long id, uint num_attrs, cms_attribute *attrs,
                         CSA_enum *ops, _DtCm_libentry **entries) {
        CSA_return_code stat = CSA_SUCCESS;
        Table_Res_4 *res = NULL;
        _DtCm_Connection *conn;
        ...
        *entries = NULL;
        ...
        do {
                ...
                case TABLEVERS_2:
                        a2.target = cal->name;
                        a2.args.tag = RANGE_2;
                        a2.args.Args_2_u.range =
                            _DtCm_range4_to_range2(&new_range);
                ...
                case TABLEVERS_3:
                        a3.target = cal->name;
                        a3.args.tag = RANGE_3;
                        a3.args.Args_3_u.range =
                            _DtCm_range4_to_range3(&new_range);
                        a3.pid = getpid();
 ...
 */
extern CSA_return_code _DtCm_table_lookup_key_range(Calendar *cal,
                                                    _DtCm_libentry *entry,
                                                    long id, time_t start,
                                                    time_t end, cms_key *key,
        ...
        case TABLEVERS_3:
                ...
                a3.args.Args_3_u.keyrange =
                    _DtCm_keyrange4_to_keyrange3(&keyrange);
                a3.pid = getpid();
        ...
        if (res != NULL) {
                ...
                case access_failed_4:
                        ...
                        head = prev = NULL;
                        while (abbs != NULL) {
                                if ((stat = _DtCm_make_libentry(
                                         entry->e, &eptr)) != CSA_SUCCESS)
                                        break;
                                ...
                                _csa_tick_to_iso8601(
                                    eptr->e->key.time,
                                    eptr->e->attrs[CSA_ENTRY_ATTR_START_DATE_I]
                ...
                default:
                        /* remote system error */
                        DP((errfmt, "_DtCm_table_lookup_key_range",
                            res->status));
                        stat = CSA_E_FAILURE;
                        break;
                }
...
extern CSA_return_code _DtCm_table_insert(Calendar *cal, uint num_attrs,
                                          CSA_attribute *attrs,
        ...
        if (res != NULL) {
                ...
                case access_ok_4:
                        if (res->res.Table_Res_List_4_u.a) {
                                stat = _DtCm_appt4_to_libentries(
                                    cal->name, res->res.Table_Res_List_4_u.a,
                                    entry_r);
                        }
                        break;
                case access_failed_4:
...
extern CSA_return_code _DtCm_table_update(Calendar *cal, _DtCm_libentry *oentry,
                                          uint num_attrs, CSA_attribute *attrs,
                                          CSA_enum scope,
...
extern CSA_return_code _DtCm_table_delete(Calendar *cal, _DtCm_libentry *entry,
                                          CSA_enum scope) {
        CSA_return_code stat = CSA_SUCCESS;
        Table_Res_4 *res = NULL;
        _DtCm_Connection *conn;
...
extern CSA_return_code _DtCm_table_size(Calendar *cal, int *size) {
        int *res;
        CSA_return_code stat = CSA_SUCCESS;
        _DtCm_Connection *conn;
...
extern CSA_return_code
_DtCm_table_lookup_reminder(Calendar *cal, CSA_uint32 num_names,
        ...
        if (res != NULL) {
                ...
                case access_ok_4:
                         ...
                         */
                        rptr =
                            _DtCm_copy_reminder4(res->res.Table_Res_List_4_u.r);
                        xdr_free((xdrproc_t)_DtCm_xdr_Table_Res_4, (char *)res);
                ...
                default:
                        /* remote system error */
                        DP((errfmt, "_DtCm_table_lookup_reminder",
                            res->status));
                        stat = CSA_E_FAILURE;
                        break;
                }
...
extern CSA_return_code _DtCm_table_unregister_target(_DtCm_Connection *conn,
                                                     char *calendar) {
        CSA_return_code stat;
...
extern CSA_return_code _DtCm_table_register_target(_DtCm_Connection *conn,
                                                   char *calendar) {
        CSA_return_code stat;
        Registration_Status_4 res;
        boolean_t nullreturned = B_FALSE;
