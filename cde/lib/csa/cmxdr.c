...
bool_t xdr_cms_name(register XDR *xdrs, cms_name *objp) {
...
bool_t xdr_cms_access_entry(register XDR *xdrs, cms_access_entry *objp) {
...
bool_t xdr_cms_key(register XDR *xdrs, cms_key *objp) {
...
bool_t xdr_CSA_opaque_data(register XDR *xdrs, CSA_opaque_data *objp) {
        if (!xdr_bytes(xdrs, (char **)&objp->data, (u_int *)&objp->size, ~0))
                return (FALSE);
        return (TRUE);
}

bool_t xdr_CSA_reminder(register XDR *xdrs, CSA_reminder *objp) {
...
bool_t xdr_CSA_date_time_entry(register XDR *xdrs, CSA_date_time_entry *objp) {
...
bool_t xdr_cms_attribute_value(register XDR *xdrs, cms_attribute_value *objp) {
...
bool_t xdr_cms_attr_name(register XDR *xdrs, cms_attr_name *objp) {
...
bool_t xdr_cms_attribute(register XDR *xdrs, cms_attribute *objp) {
        if (!xdr_cms_attr_name(xdrs, &objp->name))
                return (FALSE);
        if (!xdr_pointer(xdrs, (char **)&objp->value,
                         sizeof(CSA_attribute_value),
...
bool_t xdr_cms_entry(register XDR *xdrs, cms_entry *objp) {
...
bool_t
xdr_cms_enumerate_calendar_attr_res(register XDR *xdrs,
...
bool_t xdr_cms_list_calendars_res(register XDR *xdrs,
                                  cms_list_calendars_res *objp) {
        if (!xdr_u_long(xdrs, &objp->stat))
                return (FALSE);
        if (!xdr_array(xdrs, (char **)&objp->names, (u_int *)&objp->num_names,
...
bool_t xdr_cms_open_args(register XDR *xdrs, cms_open_args *objp) {
...
bool_t xdr_cms_open_res(register XDR *xdrs, cms_open_res *objp) {
        if (!xdr_u_long(xdrs, &objp->stat))
                return (FALSE);
...
bool_t xdr_cms_create_args(register XDR *xdrs, cms_create_args *objp) {
        if (!xdr_string(xdrs, &objp->cal, ~0))
                return (FALSE);
...
bool_t xdr_cms_remove_args(register XDR *xdrs, cms_remove_args *objp) {
        if (!xdr_string(xdrs, &objp->cal, ~0))
                return (FALSE);
        if (!xdr_int(xdrs, &objp->pid))
                return (FALSE);
...
bool_t xdr_cms_register_args(register XDR *xdrs, cms_register_args *objp) {
        if (!xdr_string(xdrs, &objp->cal, ~0))
                return (FALSE);
...
bool_t xdr_cms_get_cal_attr_res(register XDR *xdrs,
                                cms_get_cal_attr_res *objp) {
        if (!xdr_u_long(xdrs, &objp->stat))
                return (FALSE);
        if (!xdr_array(xdrs, (char **)&objp->attrs, (u_int *)&objp->num_attrs,
                       ~0, sizeof(cms_attribute), (xdrproc_t)xdr_cms_attribute))
...
bool_t xdr_cms_get_cal_attr_args(register XDR *xdrs,
                                 cms_get_cal_attr_args *objp) {
        if (!xdr_string(xdrs, &objp->cal, ~0))
                return (FALSE);
        if (!xdr_array(xdrs, (char **)&objp->names, (u_int *)&objp->num_names,
                       ~0, sizeof(cms_attr_name), (xdrproc_t)xdr_cms_attr_name))
...
bool_t xdr_cms_set_cal_attr_args(register XDR *xdrs,
                                 cms_set_cal_attr_args *objp) {
        if (!xdr_string(xdrs, &objp->cal, ~0))
                return (FALSE);
        if (!xdr_int(xdrs, &objp->pid))
                return (FALSE);
...
bool_t xdr_cms_archive_res(register XDR *xdrs, cms_archive_res *objp) {
        if (!xdr_u_long(xdrs, &objp->stat))
                return (FALSE);
...
bool_t xdr_cms_archive_args(register XDR *xdrs, cms_archive_args *objp) {
        if (!xdr_string(xdrs, &objp->cal, ~0))
                return (FALSE);
...
bool_t xdr_cms_restore_args(register XDR *xdrs, cms_restore_args *objp) {
        if (!xdr_string(xdrs, &objp->cal, ~0))
                return (FALSE);
        if (!xdr_string(xdrs, &objp->data, ~0))
                return (FALSE);
...
bool_t xdr_cms_reminder_ref(register XDR *xdrs, cms_reminder_ref *objp) {
...
bool_t xdr_cms_reminder_res(register XDR *xdrs, cms_reminder_res *objp) {
        if (!xdr_u_long(xdrs, &objp->stat))
                return (FALSE);
...
bool_t xdr_cms_reminder_args(register XDR *xdrs, cms_reminder_args *objp) {
        if (!xdr_string(xdrs, &objp->cal, ~0))
                return (FALSE);
...
bool_t xdr_cms_entries_res(register XDR *xdrs, cms_entries_res *objp) {
        if (!xdr_u_long(xdrs, &objp->stat))
                return (FALSE);
...
bool_t xdr_cms_lookup_entries_args(register XDR *xdrs,
                                   cms_lookup_entries_args *objp) {
        if (!xdr_string(xdrs, &objp->cal, ~0))
                return (FALSE);
        if (!xdr_string(xdrs, &objp->char_set, ~0))
                return (FALSE);
...
bool_t xdr_cms_enumerate_args(register XDR *xdrs, cms_enumerate_args *objp) {
        if (!xdr_string(xdrs, &objp->cal, ~0))
                return (FALSE);
        if (!xdr_long(xdrs, &objp->id))
                return (FALSE);
...
bool_t xdr_cms_get_entry_attr_res_item(register XDR *xdrs,
...
bool_t xdr_cms_get_entry_attr_res(register XDR *xdrs,
                                  cms_get_entry_attr_res *objp) {
        if (!xdr_u_long(xdrs, &objp->stat))
                return (FALSE);
...
bool_t xdr_cms_get_entry_attr_args(register XDR *xdrs,
                                   cms_get_entry_attr_args *objp) {
        if (!xdr_string(xdrs, &objp->cal, ~0))
                return (FALSE);
...
bool_t xdr_cms_entry_res(register XDR *xdrs, cms_entry_res *objp) {
        if (!xdr_u_long(xdrs, &objp->stat))
                return (FALSE);
...
bool_t xdr_cms_insert_args(register XDR *xdrs, cms_insert_args *objp) {
        if (!xdr_string(xdrs, &objp->cal, ~0))
                return (FALSE);
        if (!xdr_int(xdrs, &objp->pid))
                return (FALSE);
...
bool_t xdr_cms_update_args(register XDR *xdrs, cms_update_args *objp) {
        if (!xdr_string(xdrs, &objp->cal, ~0))
                return (FALSE);
        if (!xdr_int(xdrs, &objp->pid))
                return (FALSE);
...
bool_t xdr_cms_delete_args(register XDR *xdrs, cms_delete_args *objp) {
        if (!xdr_string(xdrs, &objp->cal, ~0))
                return (FALSE);
        if (!xdr_int(xdrs, &objp->pid))
                return (FALSE);
