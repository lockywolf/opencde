...
extern Appt_4 *_DtCm_copy_appt4(Appt_4 *a4) {
        ...
        while (a4 != NULL) {
                ...
                if (a4->client_data) {
                        if ((a->client_data = strdup(a4->client_data)) ==
                            NULL) {
                                _DtCm_free_appt4(a);
                                cleanup = B_TRUE;
                                break;
                ...
                } else if ((a->tag = (Tag_4 *)calloc(1, sizeof(Tag_4))) ==
                           NULL) {
                        free(a);
                        cleanup = B_TRUE;
                        break;
...
extern Appt_4 *_DtCm_copy_semiprivate_appt4(Appt_4 *original) {
        ...
        if (original != NULL) {
                ...
                if ((copy = _DtCm_copy_appt4(original)) != NULL) {
                        if (copy->what != NULL)
                                free(copy->what);
                        if ((copy->what = (char *)strdup(FAUX_STRING)) ==
                            NULL) {
...
extern void _DtCm_free_access_list4(Access_Entry_4 *e) {
        Access_Entry_4 *ptr;
