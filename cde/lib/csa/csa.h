...
typedef void (*CSA_callback)(CSA_session_handle session, CSA_flags reason,
...
CSA_return_code csa_look_up(CSA_session_handle session,
                            CSA_calendar_user *users, CSA_flags look_up_flags,
...
CSA_return_code csa_restore(CSA_session_handle session, CSA_string archive_name,
                            CSA_uint32 number_attributes,
                            CSA_attribute *attributes, CSA_enum *operators,
                            CSA_extension *restore_extensions);

/* SAVE */ /* NOT IMPLEMENTED IN THIS RELEASE */
CSA_return_code csa_save(CSA_session_handle session, CSA_string archive_name,
                         CSA_uint32 number_attributes,
                         CSA_attribute *attributes, CSA_enum *operators,
...
CSA_return_code csa_read_calendar_attributes(
    CSA_session_handle session, CSA_uint32 number_names,
    CSA_attribute_reference *attribte_names, CSA_uint32 *number_attributes,
    CSA_attribute **calendar_attributes,
...
CSA_return_code csa_update_calendar_attributes(
    CSA_session_handle session, CSA_uint32 number_attributes,
    CSA_attribute *calendar_attributes,
...
CSA_return_code csa_delete_entry(CSA_session_handle session,
                                 CSA_entry_handle entry, CSA_enum delete_scope,
                                 CSA_extension *delete_entry_extensions);

/* FREE TIME SEARCH */ /* NOT IMPLEMENTED IN THIS RELEASE */
CSA_return_code csa_free_time_search(
    CSA_session_handle session, CSA_date_time_range date_time_range,
    CSA_time_duration time_duration, CSA_uint32 number_users,
    CSA_calendar_user *calendar_users, CSA_free_time **free_time,
...
CSA_return_code
csa_list_entry_attributes(CSA_session_handle session, CSA_entry_handle entry,
                          CSA_uint32 *number_names,
...
/* LIST ENTRY SEQUENCE */
CSA_return_code
csa_list_entry_sequence(CSA_session_handle session, CSA_entry_handle entry,
...
CSA_return_code csa_read_entry_attributes(
    CSA_session_handle session, CSA_entry_handle entry, CSA_uint32 number_names,
...
CSA_return_code csa_update_entry_attributes(
    CSA_session_handle session, CSA_entry_handle entry, CSA_enum update_scope,
    CSA_boolean update_propagation, CSA_uint32 number_attributes,
    CSA_attribute *entry_attributes, CSA_entry_handle *new_entry,
    CSA_extension *update_entry_attributes_extensions);

/* STRING BASED FUNCTIONS */

/* ADD EVENT */ /* NOT IMPLEMENTED IN THIS RELEASE */
CSA_return_code csa_add_event(
...
#define CSA_X_DT_CSA_RETURN_CODE(c) ((CSA_return_code)((c)&CSA_ERROR_RSV_MASK))
...
#define CSA_ENTRY_ATTR_TYPE _CSA_entry_attribute_names[CSA_ENTRY_ATTR_TYPE_I]
...
#define CSA_SUBTYPE_CLASS _CSA_entry_subtype_values[CSA_SUBTYPE_CLASS_I]
/* "-//XAPIA/CSA/SUBTYPE//NONSGML Subtype Class//EN" */

#define CSA_SUBTYPE_HOLIDAY_I 2
#define CSA_SUBTYPE_HOLIDAY _CSA_entry_subtype_values[CSA_SUBTYPE_HOLIDAY_I]
/* "-//XAPIA/CSA/SUBTYPE//NONSGML Subtype Holiday//EN" */

#define CSA_SUBTYPE_MEETING_I 3
#define CSA_SUBTYPE_MEETING _CSA_entry_subtype_values[CSA_SUBTYPE_MEETING_I]
...
#define CSA_SUBTYPE_SICK_DAY _CSA_entry_subtype_values[CSA_SUBTYPE_SICK_DAY_I]
...
#define CSA_SUBTYPE_TRAVEL _CSA_entry_subtype_values[CSA_SUBTYPE_TRAVEL_I]
/* "-//XAPIA/CSA/SUBTYPE//NONSGML Subtype Travel//EN" */

#define CSA_SUBTYPE_VACATION_I 9
#define CSA_SUBTYPE_VACATION _CSA_entry_subtype_values[CSA_SUBTYPE_VACATION_I]
