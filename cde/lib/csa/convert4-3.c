...
extern void _DtCm_id4_to_id3(Id_4 *from, Id_3 *to) {
...
extern Uid_3 *_DtCm_uid4_to_uid3(Uid_4 *ui4) {
        Uid_3 *ui3, *head, *prev;
...
extern Appt_3 *_DtCm_appt4_to_appt3(Appt_4 *a4) {
        Appt_3 *a3, *head, *prev;
...
extern void _DtCm_free_appt3(Appt_3 *a) {
        Appt_3 *ptr;
...
static void tablereslist4_to_tablereslist3(Table_Res_List_4 *from,
        ...
        switch (from->tag) {
        case AP_4:
                to->Table_Res_List_3_u.a =
                    _DtCm_appt4_to_appt3(from->Table_Res_List_4_u.a);
                break;
        case RM_4:
                to->Table_Res_List_3_u.r =
                    reminder4_to_reminder3(from->Table_Res_List_4_u.r);
                break;
        case AB_4:
                to->Table_Res_List_3_u.b =
                    abb4_to_abb3(from->Table_Res_List_4_u.b);
                break;
        case ID_4:
                to->Table_Res_List_3_u.i =
                    _DtCm_uid4_to_uid3(from->Table_Res_List_4_u.i);
        default:
                return;
        }
}

extern Access_Status_3 _DtCm_accstat4_to_accstat3(Access_Status_4 s) {
        switch (s) {
        case access_ok_4:
                return (access_ok_3);
        case access_added_4:
...
extern Table_Res_3 *_DtCm_tableres4_to_tableres3(Table_Res_4 *r4) {
        Table_Res_3 *r3;

        if (r4 == NULL)
                return ((Table_Res_3 *)NULL);
...
extern Access_Entry_3 *_DtCm_acclist4_to_acclist3(Access_Entry_4 *l4) {
...
extern Access_Args_3 *_DtCm_accargs4_to_accargs3(Access_Args_4 *a4) {
        Access_Args_3 *a3;

        if (a4 == NULL)
                return ((Access_Args_3 *)NULL);
...
extern Range_3 *_DtCm_range4_to_range3(Range_4 *r4) {
...
extern Keyrange_3 *_DtCm_keyrange4_to_keyrange3(Keyrange_4 *r4) {
...
extern Table_Status_3 _DtCm_tablestat4_to_tablestat3(Table_Status_4 s) {
        switch (s) {
        case ok_4:
                return (ok_3);
        case duplicate_4:
...
extern Uid_3 *_DtCm_uidopt4_to_uid3(Uidopt_4 *uidopt) {
...
static void args4_to_args3(Args_4 *from, Args_3 *to) {
        ...
        case APPTID_4:
                ...
                apptid4_to_apptid3(&(from->Args_4_u.apptid),
                                   &(to->Args_3_u.apptid));
                break;
        case UID_4:
        ...
        case RANGE_4:
                to->Args_3_u.range =
                    _DtCm_range4_to_range3(from->Args_4_u.range);
                break;
        case KEYRANGE_4:
                to->Args_3_u.keyrange =
                    _DtCm_keyrange4_to_keyrange3(from->Args_4_u.keyrange);
        default:
                break;
        }
}
