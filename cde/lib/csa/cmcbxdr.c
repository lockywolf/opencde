...
bool_t xdr_cmcb_cal_attr_data(register XDR *xdrs, cmcb_cal_attr_data *objp) {
...
bool_t xdr_cmcb_add_entry_data(register XDR *xdrs, cmcb_add_entry_data *objp) {
...
bool_t xdr_cmcb_delete_entry_data(register XDR *xdrs,
                                  cmcb_delete_entry_data *objp) {
        if (!xdr_string(xdrs, &objp->id, ~0))
                return (FALSE);
...
bool_t xdr_cmcb_update_entry_data(register XDR *xdrs,
                                  cmcb_update_entry_data *objp) {
...
bool_t xdr_cmcb_update_data(register XDR *xdrs, cmcb_update_data *objp) {
...
bool_t xdr_cmcb_update_callback_args(register XDR *xdrs,
                                     cmcb_update_callback_args *objp) {
