...
extern Access_Status_4 _DtCm_accstat3_to_accstat4(Access_Status_3 s) {
        switch (s) {
        case access_ok_3:
                return (access_ok_4);
        case access_added_3:
...
extern Table_Res_4 *_DtCm_tableres3_to_tableres4(Table_Res_3 *r3) {
        Table_Res_4 *r4;

        if (r3 == NULL)
                return ((Table_Res_4 *)NULL);
...
extern Access_Args_4 *_DtCm_accargs3_to_accargs4(Access_Args_3 *a3) {
        Access_Args_4 *a4;

        if (a3 == NULL)
                return ((Access_Args_4 *)NULL);
...
extern Table_Args_4 *_DtCm_tableargs3_to_tableargs4(Table_Args_3 *a3) {
        Table_Args_4 *a4;
...
extern Table_Args_4 *_DtCm_tabledelargs3_to_tabledelargs4(Table_Args_3 *a3,
                                                          Options_4 opt) {
        Table_Args_4 *a4;
...
extern Registration_4 *_DtCm_reg3_to_reg4(Registration_3 *r3) {
...
extern Table_Status_4 _DtCm_tablestat3_to_tablestat4(Table_Status_3 s) {
        switch (s) {
        case ok_3:
                return (ok_4);
        case duplicate_3:
...
static void tablereslist3_to_tablereslist4(Table_Res_List_3 *from,
        ...
        switch (from->tag) {
        case AP_3:
                to->Table_Res_List_4_u.a =
                    appt3_to_appt4(from->Table_Res_List_3_u.a);
                break;
        case RM_3:
                to->Table_Res_List_4_u.r =
                    reminder3_to_reminder4(from->Table_Res_List_3_u.r);
                break;
        case AB_3:
                to->Table_Res_List_4_u.b =
                    abb3_to_abb4(from->Table_Res_List_3_u.b);
                break;
        case ID_3:
                to->Table_Res_List_4_u.i =
                    uid3_to_uid4(from->Table_Res_List_3_u.i);
                break;
        default:
                return;
        }
...
static void args3_to_args4(Args_3 *from, Args_4 *to) {
        ...
        case APPTID_3:
                ...
                apptid3_to_apptid4(&(from->Args_3_u.apptid),
                                   &(to->Args_4_u.apptid));
                break;
        case UID_3:
        ...
        case RANGE_3:
                ...
                break;
        case KEYRANGE_3:
                to->Args_4_u.keyrange =
                    keyrange3_to_keyrange4(from->Args_3_u.keyrange);
        default:
                break;
        }
}
