 ...
 */
#define WARN_WORK_AREA_LOCATION                                                \
        DTPRINT_GETMESSAGE(MS_PrintSetupBox, PSUB_WARN_WA_LOCATION,            \
                           _DtPrMsgPrintSetupBox_0000)
#define SELECT_PRINTER_LABEL                                                   \
        DTPRINT_GETMESSAGE(MS_PrintSetupBox, PSUB_SELECT_PRINTER,              \
                           _DtPrMsgPrintSetupBox_0001)
#define PRINT_TO_FILE_LABEL                                                    \
        DTPRINT_GETMESSAGE(MS_PrintSetupBox, PSUB_PRINT_TO_FILE,               \
                           _DtPrMsgPrintSetupBox_0002)
#define SELECT_FILE_LABEL                                                      \
        DTPRINT_GETMESSAGE(MS_PrintSetupBox, PSUB_SELECT_FILE,                 \
                           _DtPrMsgPrintSetupBox_0003)
#define CANCEL_LABEL                                                           \
        DTPRINT_GETMESSAGE(MS_PrintSetupBox, PSUB_CANCEL,                      \
                           _DtPrMsgPrintSetupBox_0004)
#define COPIES_LABEL                                                           \
        DTPRINT_GETMESSAGE(MS_PrintSetupBox, PSUB_COPIES,                      \
                           _DtPrMsgPrintSetupBox_0005)
#define HELP_LABEL                                                             \
        DTPRINT_GETMESSAGE(MS_PrintSetupBox, PSUB_HELP,                        \
                           _DtPrMsgPrintSetupBox_0006)
#define PRINT_LABEL                                                            \
        DTPRINT_GETMESSAGE(MS_PrintSetupBox, PSUB_PRINT,                       \
                           _DtPrMsgPrintSetupBox_0007)
#define PRINTER_NAME_LABEL                                                     \
        DTPRINT_GETMESSAGE(MS_PrintSetupBox, PSUB_PRINTER_NAME,                \
                           _DtPrMsgPrintSetupBox_0008)
#define SETUP_LABEL                                                            \
        DTPRINT_GETMESSAGE(MS_PrintSetupBox, PSUB_SETUP,                       \
                           _DtPrMsgPrintSetupBox_0009)
#define DESCRIPTION_LABEL                                                      \
        DTPRINT_GETMESSAGE(MS_PrintSetupBox, PSUB_DESCRIPTION,                 \
                           _DtPrMsgPrintSetupBox_0010)
#define WARN_COPY_COUNT                                                        \
        DTPRINT_GETMESSAGE(MS_PrintSetupBox, PSUB_WARN_COPY_COUNT,             \
                           _DtPrMsgPrintSetupBox_0011)
#define WARN_SETUP_MODE                                                        \
        DTPRINT_GETMESSAGE(MS_PrintSetupBox, PSUB_WARN_SETUP_MODE,             \
                           _DtPrMsgPrintSetupBox_0012)
#define WARN_SETUP_MODE_CHANGE                                                 \
        DTPRINT_GETMESSAGE(MS_PrintSetupBox, PSUB_WARN_SETUP_MODE_CHANGE,      \
                           _DtPrMsgPrintSetupBox_0013)
#define PRINTER_INFO_LABEL                                                     \
        DTPRINT_GETMESSAGE(MS_PrintSetupBox, PSUB_PRINTER_INFO,                \
                           _DtPrMsgPrintSetupBox_0014)
#define INVALID_PRINTER_TITLE                                                  \
        DTPRINT_GETMESSAGE(MS_PrintSetupBox, PSUB_INVALID_PRINTER_TITLE,       \
                           _DtPrMsgPrintSetupBox_0015)
#define INVALID_PRINTER_MESSAGE                                                \
        DTPRINT_GETMESSAGE(MS_PrintSetupBox, PSUB_INVALID_PRINTER_MESSAGE,     \
                           _DtPrMsgPrintSetupBox_0016)
#define INVALID_DISPLAY_MESSAGE                                                \
        DTPRINT_GETMESSAGE(MS_PrintSetupBox, PSUB_INVALID_DISPLAY_MESSAGE,     \
                           _DtPrMsgPrintSetupBox_0017)
#define NOT_XP_DISPLAY_MESSAGE                                                 \
        DTPRINT_GETMESSAGE(MS_PrintSetupBox, PSUB_NOT_XP_DISPLAY_MESSAGE,      \
                           _DtPrMsgPrintSetupBox_0018)
#define NO_DEFAULT_MESSAGE                                                     \
        DTPRINT_GETMESSAGE(MS_PrintSetupBox, PSUB_NO_DEFAULT_MESSAGE,          \
                           _DtPrMsgPrintSetupBox_0019)
#define NO_DEFAULT_DISPLAY_MESSAGE                                             \
        DTPRINT_GETMESSAGE(MS_PrintSetupBox, PSUB_NO_DEFAULT_DISPLAY_MESSAGE,  \
                           _DtPrMsgPrintSetupBox_0020)
#define PRINTER_MISSING_MESSAGE                                                \
        DTPRINT_GETMESSAGE(MS_PrintSetupBox, PSUB_PRINTER_MISSING_MESSAGE,     \
                           _DtPrMsgPrintSetupBox_0021)
#define WARN_PRINT_DESTINATION                                                 \
        DTPRINT_GETMESSAGE(MS_PrintSetupBox, PSUB_WARN_PRINT_DESTINATION,      \
                           _DtPrMsgPrintSetupBox_0022)
#define WARN_CT_CONVERSION                                                     \
        DTPRINT_GETMESSAGE(MS_PrintSetupBox, PSUB_WARN_CT_CONVERSION,          \
                           _DtPrMsgPrintSetupBox_0023)
#define WARN_CONVERSION_ARGS                                                   \
        DTPRINT_GETMESSAGE(MS_PrintSetupBox, PSUB_WARN_CONVERSION_ARGS,        \
                           _DtPrMsgPrintSetupBox_0024)
#define PRLIST_ERROR_TITLE                                                     \
        DTPRINT_GETMESSAGE(MS_PrintSetupBox, PSUB_PRLIST_ERROR_TITLE,          \
                           _DtPrMsgPrintSetupBox_0025)
#define NO_PRINTERS_MESSAGE                                                    \
        DTPRINT_GETMESSAGE(MS_PrintSetupBox, PSUB_NO_PRINTERS_MESSAGE,         \
                           _DtPrMsgPrintSetupBox_0026)
#define DESC_UNAVAILABLE                                                       \
        DTPRINT_GETMESSAGE(MS_PrintSetupBox, PSUB_DESC_UNAVAILABLE,            \
                           _DtPrMsgPrintSetupBox_0027)
#define SELECT_FILE_TITLE                                                      \
        DTPRINT_GETMESSAGE(MS_PrintSetupBox, PSUB_SELECT_FILE_TITLE,           \
                           _DtPrMsgPrintSetupBox_0028)
#define PRINTER_INFO_TITLE                                                     \
        DTPRINT_GETMESSAGE(MS_PrintSetupBox, PSUB_PRINTER_INFO_TITLE,          \
                           _DtPrMsgPrintSetupBox_0029)
#define FORMAT_LABEL                                                           \
        DTPRINT_GETMESSAGE(MS_PrintSetupBox, PSUB_FORMAT_LABEL,                \
                           _DtPrMsgPrintSetupBox_0030)
#define MODEL_LABEL                                                            \
        DTPRINT_GETMESSAGE(MS_PrintSetupBox, PSUB_MODEL_LABEL,                 \
                           _DtPrMsgPrintSetupBox_0031)
#define PRINTER_LIST_LABEL                                                     \
        DTPRINT_GETMESSAGE(MS_PrintSetupBox, PSUB_PRINTER_LIST_LABEL,          \
                           _DtPrMsgPrintSetupBox_0032)
#define MORE_PRINTERS_TITLE                                                    \
        DTPRINT_GETMESSAGE(MS_PrintSetupBox, PSUB_MORE_PRINTERS_TITLE,         \
                           _DtPrMsgPrintSetupBox_0033)
#define PRINT_TO_PRINTER_LABEL                                                 \
        DTPRINT_GETMESSAGE(MS_PrintSetupBox, PSUB_PRINT_TO_PRINTER,            \
                           _DtPrMsgPrintSetupBox_0034)
#define FILE_NAME_LABEL                                                        \
        DTPRINT_GETMESSAGE(MS_PrintSetupBox, PSUB_FILE_NAME,                   \
                           _DtPrMsgPrintSetupBox_0035)
#define HELP_DLG_TITLE                                                         \
        DTPRINT_GETMESSAGE(MS_PrintSetupBox, PSUB_HELP_DLG_TITLE,              \
                           _DtPrMsgPrintSetupBox_0036)
#
/*
...
#endif /* PRINTING_SUPPORTED */
#define PSUB_Copies(w) (((DtPrintSetupBoxWidget)(w))->print_setup_box.copies)
...
#define PSUB_Options(w) (((DtPrintSetupBoxWidget)(w))->print_setup_box.options)
...
#define PSUB_Shell(w) (((DtPrintSetupBoxWidget)(w))->bulletin_board.shell)
#define PSUB_StringDirection(w)                                                \
        (((DtPrintSetupBoxWidget)(w))->manager.string_direction)
#define PSUB_Text(w) (((DtPrintSetupBoxWidget)(w))->print_setup_box.text)
 ...
 */
extern void _DtPrintSetupBoxCreateButtonSeparator(DtPrintSetupBoxWidget psub);
extern void _DtPrintSetupBoxCreateBottomSeparator(DtPrintSetupBoxWidget psub);
extern void _DtPrintSetupBoxCreateCancelButton(DtPrintSetupBoxWidget psub);
extern void _DtPrintSetupBoxCreateCopiesControl(DtPrintSetupBoxWidget psub);
extern void _DtPrintSetupBoxCreateDescription(DtPrintSetupBoxWidget psub);
extern void _DtPrintSetupBoxCreateDescriptionLabel(DtPrintSetupBoxWidget psub);
extern void
_DtPrintSetupBoxCreateDestinationRadioBox(DtPrintSetupBoxWidget psub);
extern void _DtPrintSetupBoxCreateFileNameLabel(DtPrintSetupBoxWidget psub);
extern void _DtPrintSetupBoxCreateFileNameText(DtPrintSetupBoxWidget psub);
extern void _DtPrintSetupBoxCreateHelpButton(DtPrintSetupBoxWidget psub);
extern void _DtPrintSetupBoxCreatePrintButton(DtPrintSetupBoxWidget psub);
extern void _DtPrintSetupBoxCreatePrinterInfoButton(DtPrintSetupBoxWidget psub);
extern void _DtPrintSetupBoxCreatePrinterNameLabel(DtPrintSetupBoxWidget psub);
extern void _DtPrintSetupBoxCreatePrinterNameCombo(DtPrintSetupBoxWidget psub);
extern void _DtPrintSetupBoxCreateSelectFileButton(DtPrintSetupBoxWidget psub);
extern void
_DtPrintSetupBoxCreateSelectPrinterButton(DtPrintSetupBoxWidget psub);
extern void _DtPrintSetupBoxCreateSetupButton(DtPrintSetupBoxWidget psub);
extern void _DtPrintSetupBoxCreateTopSeparator(DtPrintSetupBoxWidget psub);
/*
 * Synthetic resource internal->external conversion functions
 */
extern void _DtPrintSetupBoxGetCopies(Widget wid, int resource_offset,
                                      XtArgVal *value);
extern void _DtPrintSetupBoxGetDescription(Widget wid, int resource_offset,
                                           XtArgVal *value);
extern void _DtPrintSetupBoxGetFileName(Widget wid, int resource_offset,
                                        XtArgVal *value);
extern void _DtPrintSetupBoxGetPrinterName(Widget wid, int resource_offset,
                                           XtArgVal *value);
/*
 * Geometry Management
 */
extern XmGeoMatrix _DtPrintSetupBoxGeoMatrixCreate(Widget wid,
                                                   Widget instigator,
                                                   XtWidgetGeometry *desired);
extern Boolean _DtPrintSetupBoxNoGeoRequest(XmGeoMatrix geoSpec);
