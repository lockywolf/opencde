...
const char _DtPrMsgPrintSetupBox_0001[] = "More Printers...";
const char _DtPrMsgPrintSetupBox_0002[] = "Print to File";
const char _DtPrMsgPrintSetupBox_0003[] = "Select File...";
const char _DtPrMsgPrintSetupBox_0004[] = "Cancel";
const char _DtPrMsgPrintSetupBox_0005[] = "Copies:";
const char _DtPrMsgPrintSetupBox_0006[] = "Help";
const char _DtPrMsgPrintSetupBox_0007[] = "Print";
const char _DtPrMsgPrintSetupBox_0008[] = "Printer Name:";
const char _DtPrMsgPrintSetupBox_0009[] = "Setup...";
const char _DtPrMsgPrintSetupBox_0010[] = "Printer Description:";
const char _DtPrMsgPrintSetupBox_0011[] = "Copy count out of range.";
const char _DtPrMsgPrintSetupBox_0012[] = "Invalid print setup mode.";
const char _DtPrMsgPrintSetupBox_0013[] = "Print setup mode cannot be changed.";
const char _DtPrMsgPrintSetupBox_0014[] = "Printer Info...";
const char _DtPrMsgPrintSetupBox_0015[] = "Invalid Printer";
...
const char _DtPrMsgPrintSetupBox_0022[] = "Invalid print destination.";
...
const char _DtPrMsgPrintSetupBox_0025[] = "Select Printer Error";
const char _DtPrMsgPrintSetupBox_0026[] = "Unable to find any printers.";
const char _DtPrMsgPrintSetupBox_0027[] = "description unavailable";
const char _DtPrMsgPrintSetupBox_0028[] = "Select File";
const char _DtPrMsgPrintSetupBox_0029[] = "Printer Information";
const char _DtPrMsgPrintSetupBox_0030[] = "Format:";
const char _DtPrMsgPrintSetupBox_0031[] = "Printer Model:";
const char _DtPrMsgPrintSetupBox_0032[] = "Printers:";
const char _DtPrMsgPrintSetupBox_0033[] = "More Printers";
const char _DtPrMsgPrintSetupBox_0034[] = "Print to Printer";
const char _DtPrMsgPrintSetupBox_0035[] = "File Name:";
const char _DtPrMsgPrintSetupBox_0036[] = "Print Setup - Help";
...
#define INITIAL_NSETS 50
        ...
        if (NULL == cached_msgs) {
                ...
                for (multiplier = 2; setIdx > multiplier * nsets;
                     multiplier++) {
                }
                size = sizeof(char **) * nsets;
                cached_msgs =
                    (char ***)XtRealloc((char *)cached_msgs, multiplier * size);
        ...
        if (NULL == cached_msgs[setIdx]) {
                ...
                for (multiplier = 2; numIdx > multiplier * nsets;
                     multiplier++) {
                }
                size = sizeof(char *) * nmsgs_per_set;
                ...
                for (i = 0; i < nmsgs_per_set; i++) {
                        if (NULL != cached_msgs[i]) {
                                cached_msgs[i] = (char **)XtRealloc(
                                    (char *)cached_msgs[i], multiplier * size);
                                memset((char *)(cached_msgs[i] + size), 0,
                                       multiplier * size);
                        }
                }
 ...
 */
char *_DtPrintGetMessage(int set, int n, char *s) {
        char *msg;
        nl_catd catopen();
        char *catgets();
        static int first = 1;
