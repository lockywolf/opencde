...
extern TermBuffer _DtTermBufferCreateBuffer(const Widget w, const short rows,
                                            const short cols,
                                            const short sizeOfBuffer,
                                            const short sizeOfLine,
                                            const short sizeOfEnh);

extern void _DtTermBufferFreeBuffer(const TermBuffer tb);
...
*/
void _DtTermBufferDelete(TermBuffer tb, short *row, short *col, short *width);

extern void _DtTermBufferErase(TermBuffer tb, short row, short col, short count,
