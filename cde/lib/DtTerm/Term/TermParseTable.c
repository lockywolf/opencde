 ...
 */
static StateEntryRec pre_parse_table[] = {
...
*/
static StateEntryRec start_table[] = {
...
*/
static StateEntryRec escape_table[] = {
    {
        '[',
        '[',
        &_DtTermStateLeftBracket,
    ...
    },
    {
        '(',
        '(',
        &_DtTermStateLeftParen,
        _DtTermPrimParserNextState,
    },
    {
        ')',
        ')',
        &_DtTermStateRightParen,
        _DtTermPrimParserNextState,
    },
    {
        '*',
        '*',
        &_DtTermStateAsterisk,
        _DtTermPrimParserNextState,
    },
    {
        '+',
    ...
    {' ', ' ', &_DtTermStateC1, _DtTermPrimParserNextState,
     /* set C1 control*/},
    {0x00, 0xFF, &stateStart, _DtTermPrimParserNextState /* end of table */},
};
...
*/
static StateEntryRec set_c1_table[] = {
...
*/
static StateEntryRec pound_table[] = {
    {
        '3',
        '3',
        &stateStart,
...
** this is the table used when an escape ( has been seen
*/
static StateEntryRec left_paren_table[] = {
    {0x00, 0xFF, &stateStart, _DtTermParseFontG0 /* end of table */},
};
StateTableRec _DtTermStateLeftParen = {False, left_paren_table,
                                       pre_parse_table};

/*
** this is the table used when an escape ) a has been seen
*/
static StateEntryRec right_paren_table[] = {
    {0x00, 0xFF, &stateStart, _DtTermParseFontG1 /* end of table */},
};
StateTableRec _DtTermStateRightParen = {False, right_paren_table,
                                        pre_parse_table};

/*
** this is table used when ESC * has been seen
*/
static StateEntryRec esc_asterisk_table[] = {
    {0x00, 0xFF, &stateStart, _DtTermParseFontG2 /* end of table */},
};
StateTableRec _DtTermStateAsterisk = {False, esc_asterisk_table,
                                      pre_parse_table};

/*
** this is table used when Esc + has been seen
*/
static StateEntryRec plus_table[] = {
...
*/
static StateEntryRec get_titleBS_table[] = {
    {
        '\\',
        '\\',
        &stateStart,
        _DtTermParserSunWindowTitle,
    },
    {
        0x00,
        0xFF,
        &_DtTermStateGetTitle,
        _DtTermSaveChar,
    },
};
...
*/
static StateEntryRec get_title_table[] = {
    {
        0x1B,
        0x1B,
        &_DtTermStateGetTitleBS,
        _DtTermPrimParserNextState,
    },
    {
        0x00,
...
** this is table used when "Esc ] L<string>Esc"  has been seen
*/
static StateEntryRec get_iconBS_table[] = {
    {
        '\\',
        '\\',
        &stateStart,
        _DtTermParserSunWindowIcon,
    },
    {
        0x00,
        0xFF,
...
** this is table used when "Esc ] L"  has been seen
*/
static StateEntryRec get_icon_table[] = {
    {
        0x1B,
        0x1B,
        &_DtTermStateGetIconBS,
        _DtTermPrimParserNextState,
    },
    {
        0x00,
...
*/
static StateEntryRec get_fileBS_table[] = {
    {
        '\\',
        '\\',
        &stateStart,
        _DtTermParserSunIconFile,
    },
    {
        0x00,
        0xFF,
        &_DtTermStateGetIconFile,
        _DtTermSaveChar,
    },
};
...
*/
static StateEntryRec get_file_table[] = {
    {
        0x1B,
        0x1B,
        &_DtTermStateGetIconFileBS,
        _DtTermPrimParserNextState,
    },
    {
        0x00,
...
*/
static StateEntryRec get_stringBS_table[] = {
...
*/
static StateEntryRec get_string_table[] = {
    {0x07, 0x07, &stateStart, _DtTermChangeTextParam, /*new Icon,Title,etc*/},
    {
        0x1B,
        0x1B,
        &_DtTermStateGetStringBS,
        _DtTermPrimParserNextState,
    },
    {0x00, 0xFF, &_DtTermStateGetString, _DtTermSaveChar, /* text*/},
};
...
** this is table used when esc ] has been seen
*/
static StateEntryRec right_bracket_table[] = {
    {';', ';', &_DtTermStateGetString, _DtTermParsePushNum,
     /* increment count */},
...
*/
static StateEntryRec left_bracket_table_no_Q[] = {
    {
        ';',
        ';',
        &_DtTermStateLeftBracketNotQ,
        _DtTermParsePushNum,
    },
    {
        '0',
    ...
    {'"', '"', &_DtTermStateDECSCA, _DtTermPrimParserNextState,
     /* sel erase */},
    {'!', '!', &_DtTermStateSoftReset, _DtTermPrimParserNextState,
     /* set erase attr */},
    {0x00, 0xFF, &stateStart, _DtTermPrintState /* end of table */},
};
StateTableRec _DtTermStateLeftBracketNotQ = {False, left_bracket_table_no_Q,
                                             pre_parse_table};

/*
** this is table used when esc [ has been seen
*/
static StateEntryRec left_bracket_table[] = {
    {'?', '?', &_DtTermStateEscQuestion, _DtTermPrimParserNextState,
     /*DECSET*/},
    {
        ';',
        ';',
...
StateTableRec _DtTermStateLeftBracket = {False, left_bracket_table,
                                         pre_parse_table};

/*
** this is table used when esc [ ! has been seen
*/
static StateEntryRec soft_reset_table[] = {
    {'p', 'p', &stateStart, _DtTermSoftReset, /* End of text */},
    {0x00, 0xFF, &stateStart, _DtTermPrintState /* end of table*/},
};
StateTableRec _DtTermStateSoftReset = {False, soft_reset_table,
                                       pre_parse_table};

/*
** this is table used when CSI " has been seen
*/
static StateEntryRec set_erase_table[] = {
...
*/
static StateEntryRec up_backslash_table[] = {
...
** this is table used when esc ^ has been seen
*/
static StateEntryRec uparrow_table[] = {
...
*/
static StateEntryRec under_backslash_table[] = {
    {'\\', '\\', &stateStart, _DtTermPrimParserNextState, /* End of text */},
    {0x00, 0xFF, &_DtTermStateUnderscore,
     _DtTermPrimParserNextState /* Go back to Underscore*/},
};
...
*/
static StateEntryRec underscore_table[] = {
...
*/
static StateEntryRec esc_question_table[] = {
    {
        '0',
        '9',
        &_DtTermStateEscQuestion,
        _DtTermEnterNum,
    },
...
StateTableRec _DtTermStateEscQuestion = {False, esc_question_table,
                                         pre_parse_table};

/*
** this is the table used when an Esc ~ has been seen
*/
static StateEntryRec tilda_table[] = {
 ...
 */
static StateEntryRec sk_backslash_table[] = {
...
*/
static StateEntryRec user_key_string_table[] = {
...
*/
static StateEntryRec softkey_table[] = {
    {'0', '9', &_DtTermStateUserKey, _DtTermEnterNum, /* enter number */},
    {'/', '/', &_DtTermStateUserKeyString, _DtTermPrimParserNextState,
     /*store key*/},
    {0x1B, 0x1B, &_DtTermStateIsNextBS_SK, _DtTermPrimParserNextState, /*Esc*/},
    {0x9C, 0x9C, &stateStart, _DtTermParseUserKeyLoadLast, /* ST */},
    {0x00, 0xFF, &stateStart, _DtTermPrintState /* end of table */},
 ...
 */
static StateEntryRec dl_backslash_table[] = {
...
*/
static StateEntryRec dl_char_table[] = {
    {'\\', '\\', &stateStart, _DtTermLoadCharSet, /* ST  */},
    {0x20, 0x7E, &_DtTermStateDLCharSet, _DtTermPrimParserNextState,
     /* text */},
    {0x1B, 0x1B, &_DtTermStateIsNextBS_DL, _DtTermPrimParserNextState,
     /*end?*/},
...
*/
static StateEntryRec esc_P_table[] = {
...
*/
static StateEntryRec error_table[] = {
