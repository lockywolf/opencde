...
extern void _DtTermPrimRenderText(Widget w, TermFont font, Pixel fg, Pixel bg,
                                  unsigned long flags, int x, int y,
                                  unsigned char *string, int len);

extern void _DtTermPrimDestroyFont(Widget w, TermFont font);

extern void _DtTermPrimBell(Widget w);
extern void _termSetRenderFont(Widget w, TermFont *termFont);
extern void _termSetBufferSize(Widget w, int width, int height, int xOffset,
                               int yOffset);
extern void _termFreeBuffer(Widget w);
extern void _DtTermPrimRefreshText(Widget w, short startColumn, short startRow,
...
extern void _DtTermPrimRefreshTextWc(Widget w, short startColumn,
                                     short startRow, short endColumn,
                                     short endRow);

extern Boolean _DtTermPrimParseInput(Widget w, unsigned char *buffer, int len,
