...
#define NUM_FONTS 4
#define KEYBOARD_LOCKED(kbdLocked)                                             \
        ((kbdLocked).escape || (kbdLocked).xferPending || (kbdLocked).error || \
         (kbdLocked).record)
...
typedef struct termData {
        ...
        ** Memory lock status...
        */
        enum { SCROLL_LOCKoff = 0,
               SCROLL_LOCKon,
               SCROLL_LOCKprotect } scrollLockMode; /* memory lock mode */
...
#define MEMORY_LOCKprotect SCROLL_LOCKprotect
        ...
        enum { CURSORon,
               CURSORoff,
               CURSORblink } cursorState; /* state of cursor		*/
        ...
        union {
                ...
                struct {
                        short
                            pendingScrollLines; /* number of lines in pending
                                                 */
                        short
                            pendingScrollTopRow; /* top row of pending scroll
                                                  */
                        short pendingScrollBottomRow;
                        /* bottom row of pending scroll	*/
                        Boolean
                            pendingScroll; /* True if scroll queued up	*/
                } nojump;
        } scroll;
        ...
        */
        ...
        enum { userMessage, memoryFull } warningDialogType;
        ...
        enum { utmpIdInvalid = 0,
               utmpIdValidNotClear,
               utmpIdValid,
               utmpIdError } utmpIdState;
