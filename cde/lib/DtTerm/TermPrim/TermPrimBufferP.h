...
typedef struct _TermLinePart {
        ...
        TermLineSelectionRec inSelection;
...
extern short _DtTermPrimBufferInsertWc(const TermBuffer tb, const short row,
                                       const short col, wchar_t *newChars,
                                       short numChars, Boolean insertFlag,
                                       termChar **returnChars,
                                       short *returnLength);

extern Boolean _DtTermPrimBufferClearLineWc(const TermBuffer tb,
