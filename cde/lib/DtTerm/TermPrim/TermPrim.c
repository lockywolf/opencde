...
static char rcs_id[] =
    "$TOG: TermPrim.c /main/15 1999/10/14 16:35:04 mgreess $";
...
static void readPty(XtPointer client_data, int *source, XtInputId *id);
...
static void PreeditDraw(XIC xic, XPointer client_data,
                        XIMPreeditDrawCallbackStruct *call_data);

static void PreeditCaret(XIC xic, XPointer client_data,
...
static XtResource resources[] = {
    {DtNcharCursorStyle, DtCCharCursorStyle, DtRDtTermCharCursorStyle,
     ...
     XtOffsetOf(struct _DtTermPrimitiveRec, term.charCursorStyle), XmRImmediate,
     (XtPointer)DtTERM_CHAR_CURSOR_BOX},
    {DtNconsoleMode, DtCConsoleMode, XmRBoolean, sizeof(Boolean),
     XtOffsetOf(struct _DtTermPrimitiveRec, term.consoleMode), XmRImmediate,
     (XtPointer)False},
    {DtNblinkRate, DtCBlinkRate, XmRInt, sizeof(int),
     XtOffsetOf(struct _DtTermPrimitiveRec, term.blinkRate), XmRImmediate,
     (XtPointer)250},
    {DtNbaseWidth, DtCBaseWidth, XmRInt, sizeof(int),
     XtOffsetOf(struct _DtTermPrimitiveRec, term.baseWidth), XmRImmediate,
     (XtPointer)0},
    {DtNbaseHeight, DtCBaseHeight, XmRInt, sizeof(int),
     XtOffsetOf(struct _DtTermPrimitiveRec, term.baseHeight), XmRImmediate,
     (XtPointer)0},
    {DtNwidthInc, DtCWidthInc, XmRInt, sizeof(int),
     XtOffsetOf(struct _DtTermPrimitiveRec, term.widthInc), XmRImmediate,
     (XtPointer)0},
    {DtNheightInc, DtCHeightInc, XmRInt, sizeof(int),
     XtOffsetOf(struct _DtTermPrimitiveRec, term.heightInc), XmRImmediate,
     (XtPointer)0},
    {DtNtermDevice, DtCTermDevice, XmRInt, sizeof(int),
     XtOffsetOf(struct _DtTermPrimitiveRec, term.pty), XmRImmediate,
     (XtPointer)-1},
    {DtNtermDeviceAllocate, DtCTermDeviceAllocate, XmRBoolean, sizeof(Boolean),
     XtOffsetOf(struct _DtTermPrimitiveRec, term.ptyAllocate), XmRImmediate,
     (XtPointer)True},
    {DtNtermSlaveName, DtCTermSlaveName, XmRString, sizeof(char *),
     XtOffsetOf(struct _DtTermPrimitiveRec, term.ptySlaveName), XmRImmediate,
     (XtPointer)NULL},
    {DtNsaveLines, DtCSaveLines, XmRString, sizeof(char *),
     XtOffsetOf(struct _DtTermPrimitiveRec, term.saveLines), XmRImmediate,
     (XtPointer) "4s"},
    {DtNrows, DtCRows, XmRShort, sizeof(short),
     XtOffsetOf(struct _DtTermPrimitiveRec, term.rows), XmRImmediate,
     (XtPointer)defaultRows},
    {DtNcolumns, DtCColumns, XmRShort, sizeof(short),
     XtOffsetOf(struct _DtTermPrimitiveRec, term.columns), XmRImmediate,
     (XtPointer)defaultColumns},
#ifdef HPVUE
    {DtNbackgroundIsSelect, DtCBackgroundIsSelect, XmRBoolean, sizeof(Boolean),
    ...
    {DtNshadowType, DtCShadowType, XmRShadowType, sizeof(unsigned char),
     XtOffsetOf(struct _DtTermPrimitiveRec, term.shadowType), XmRImmediate,
     (XtPointer)DtSHADOW_IN},
    ...
    {DtNmarginWidth, DtCMarginWidth, XmRHorizontalDimension, sizeof(Dimension),
     XtOffsetOf(struct _DtTermPrimitiveRec, term.marginWidth), XmRImmediate,
     (XtPointer)2},
    {DtNmarginHeight, DtCMarginHeight, XmRVerticalDimension, sizeof(Dimension),
     XtOffsetOf(struct _DtTermPrimitiveRec, term.marginHeight), XmRImmediate,
     (XtPointer)2},
    {DtNuserBoldFont, DtCUserBoldFont, XmRFontList, sizeof(XmFontList),
     XtOffsetOf(struct _DtTermPrimitiveRec, term.boldFontList), XmRImmediate,
     (XtPointer)NULL},
    {DtNuserFont, DtCUserFont, XmRFontList, sizeof(XmFontList),
     XtOffsetOf(struct _DtTermPrimitiveRec, term.fontList), XmRImmediate,
     (XtPointer)NULL},
    ...
    {DtNvisualBell, DtCVisualBell, XmRBoolean, sizeof(Boolean),
     XtOffsetOf(struct _DtTermPrimitiveRec, term.visualBell), XtRImmediate,
     (XtPointer)False},
    {DtNmarginBell, DtCMarginBell, XmRBoolean, sizeof(Boolean),
     XtOffsetOf(struct _DtTermPrimitiveRec, term.marginBell), XtRImmediate,
     (XtPointer)False},
    {DtNnMarginBell, DtCNMarginBell, XmRInt, sizeof(int),
     XtOffsetOf(struct _DtTermPrimitiveRec, term.nMarginBell), XtRImmediate,
     (XtPointer)8},
    {DtNjumpScroll, DtCJumpScroll, XmRBoolean, sizeof(Boolean),
     XtOffsetOf(struct _DtTermPrimitiveRec, term.jumpScroll), XtRImmediate,
     (XtPointer)True},
    ...
    {DtNstatusChangeCallback, DtCCallback, XmRCallback, sizeof(XtCallbackList),
     XtOffsetOf(struct _DtTermPrimitiveRec, term.statusChangeCallback),
     XmRPointer, (XtPointer)NULL},
    {DtNoutputLogCallback, DtCCallback, XmRCallback, sizeof(XtCallbackList),
     XtOffsetOf(struct _DtTermPrimitiveRec, term.outputLogCallback), XmRPointer,
     (XtPointer)NULL},
    {DtNinputVerifyCallback, DtCCallback, XmRCallback, sizeof(XtCallbackList),
    ...
    {DtNsubprocessPid, DtCSubprocessPid, XmRInt, sizeof(int),
     XtOffsetOf(struct _DtTermPrimitiveRec, term.subprocessPid), XtRImmediate,
     (XtPointer)-1},
    {DtNsubprocessExec, DtCSubprocessExec, XmRBoolean, sizeof(Boolean),
     XtOffsetOf(struct _DtTermPrimitiveRec, term.subprocessExec), XmRImmediate,
     (XtPointer)True},
    {DtNsubprocessTerminationCatch, DtCSubprocessTerminationCatch, XmRBoolean,
     sizeof(Boolean),
    ...
    {DtNsubprocessCmd, DtCSubprocessCmd, XmRString, sizeof(char *),
     XtOffsetOf(struct _DtTermPrimitiveRec, term.subprocessCmd), XtRImmediate,
     (XtPointer)NULL},
    {DtNsubprocessArgv, DtCSubprocessArgv, XtRStringArray, sizeof(String *),
     XtOffsetOf(struct _DtTermPrimitiveRec, term.subprocessArgv), XmRImmediate,
     (XtPointer)NULL},
    {DtNemulationId, DtCEmulationId, XmRString, sizeof(char *),
     XtOffsetOf(struct _DtTermPrimitiveRec, term.emulationId), XtRImmediate,
     (XtPointer) "DtTermPrimitiveWidget"},
    {DtNtermId, DtCTermId, XmRString, sizeof(char *),
     XtOffsetOf(struct _DtTermPrimitiveRec, term.termId), XtRImmediate,
     (XtPointer) "dumb"},
    {DtNtermName, DtCTermName, XmRString, sizeof(char *),
     XtOffsetOf(struct _DtTermPrimitiveRec, term.termName), XtRImmediate,
     (XtPointer) "dumb"},
    {DtNttyModes, DtCTtyModes, XmRString, sizeof(char *),
     XtOffsetOf(struct _DtTermPrimitiveRec, term.ttyModes), XtRImmediate,
     (XtPointer)NULL},
    {DtNcsWidth, DtCCsWidth, XmRString, sizeof(char *),
     XtOffsetOf(struct _DtTermPrimitiveRec, term.csWidth), XtRImmediate,
     (XtPointer)NULL},
    {DtNkshMode, DtCKshMode, XmRBoolean, sizeof(Boolean),
     XtOffsetOf(struct _DtTermPrimitiveRec, term.kshMode), XtRImmediate,
     (XtPointer)False},
    {DtNpointerBlank, DtCPointerBlank, XmRBoolean, sizeof(Boolean),
     XtOffsetOf(struct _DtTermPrimitiveRec, term.pointerBlank), XtRImmediate,
     (XtPointer)False},
    ...
    {DtNpointerShape, DtCCursor, XtRCursor, sizeof(Cursor),
     XtOffsetOf(struct _DtTermPrimitiveRec, term.pointerShape), XtRString,
     (XtPointer) "xterm"},
    {DtNpointerColor, DtCForeground, XtRPixel, sizeof(Pixel),
     XtOffsetOf(struct _DtTermPrimitiveRec, term.pointerColor), XtRString,
    ...
    {DtNmapOnOutput, DtCMapOnOutput, XmRBoolean, sizeof(Boolean),
     XtOffsetOf(struct _DtTermPrimitiveRec, term.mapOnOutput), XtRImmediate,
     (XtPointer)False},
    ...
    {DtNlogging, DtCLogging, XmRBoolean, sizeof(Boolean),
     XtOffsetOf(struct _DtTermPrimitiveRec, term.logging), XtRImmediate,
     (XtPointer)False},
    {DtNlogFile, DtCLogFile, XmRString, sizeof(char *),
     XtOffsetOf(struct _DtTermPrimitiveRec, term.logFile), XtRImmediate,
     (XtPointer)NULL},
    {DtNlogInhibit, DtCLogInhibit, XmRBoolean, sizeof(Boolean),
     XtOffsetOf(struct _DtTermPrimitiveRec, term.logInhibit), XtRImmediate,
     (XtPointer)False},
    {DtNreverseVideo, DtCReverseVideo, XmRBoolean, sizeof(Boolean),
     XtOffsetOf(struct _DtTermPrimitiveRec, term.reverseVideo), XtRImmediate,
     (XtPointer)False},
    {DtNallowSendEvents, DtCAllowSendEvents, XmRBoolean, sizeof(Boolean),
     XtOffsetOf(struct _DtTermPrimitiveRec, term.allowSendEvents), XtRImmediate,
     (XtPointer)False}};
...
*/
static void initializeOTS(DtTermPrimData tpd) {
...
void _DtTermPrimGetFontSet(Widget w, XmFontList fontList, XFontSet *fontSet,
                           XFontStruct **font) {
        ...
        *font = (XFontStruct *)0;
        ...
        while ((fontListEntry = XmFontListNextEntry(fontContext))) {
                ...
                if (fontType == XmFONT_IS_FONTSET) {
                        ...
                        Debug('f',
                              fprintf(stderr,
                                      ">>fontType == XmFONT_IS_FONTSET\n"));
                        *fontSet = (XFontSet)pointer;
                        num_fonts =
                            XFontsOfFontSet(*fontSet, &fonts, &fontNames);
        ...
        if (!*fontSet) {
                ...
                *fontSet =
                    XCreateFontSet(XtDisplay(w), fontName, &missingCharsetList,
                                   &missingCharsetCount, (char **)0);
...
static TermFont CreateRenderFont(Widget w, XmFontList fontList,
                                 XFontSet *retFontSet, XFontStruct **retFont) {
        TermFont termFont;
...
static void AdjustWindowUnits(Widget w) {
        ...
        if (tw->term.fontSet) {
                ...
                num_fonts =
                    XFontsOfFontSet(tw->term.fontSet, &fonts, &fontNames);
                ...
                if (i >= num_fonts) {
                        /* look for the multi-bypte font that includes the
                ...
                tw->term.heightInc =
                    tw->term.font->ascent + tw->term.font->descent;
                /* why are there two "ascents"? TMH   */
...
static KeyCode *GetCapsLockKeyCodes(XModifierKeymap *modifierMapping,
        ...
        *numCapsLockKeyCodes = 0;
         ...
         * the max)...
         */
        capsLockKeyCodes = (KeyCode *)XtMalloc(modifierMapping->max_keypermod *
                                               sizeof(KeyCode));

        /* copy them over...  */
        for (i1 = 0; i1 < modifierMapping->max_keypermod; i1++) {
                capsLockKeyCodes[*numCapsLockKeyCodes] =
                    modifierMapping->modifiermap
                        [LockMapIndex * modifierMapping->max_keypermod + i1];
...
static unsigned int GetMetaMask(XModifierKeymap *modifierMapping,
                                KeySym *keyboardMapping, int keysymsPerKeycode,
                                int minKeycodes, int maxKeycodes) {
        unsigned int i1;
        ...
        for (match = False, metaMask = Mod1Mask, mapIndex = Mod1MapIndex;
             (mapIndex <= Mod5MapIndex) && !match; metaMask <<= 1, mapIndex++) {
                for (i1 = 0; i1 < modifierMapping->max_keypermod; i1++) {
                        thisKeyCode =
                            modifierMapping->modifiermap
                                [mapIndex * modifierMapping->max_keypermod +
                                 i1];
                        if (thisKeyCode < minKeycodes)
                                break;
                        thisKeySym =
                            keyboardMapping[(thisKeyCode - minKeycodes) *
                                            keysymsPerKeycode];
                        if ((thisKeySym == XK_Meta_L) ||
                            (thisKeySym == XK_Meta_R)) {
...
/*ARGSUSED*/
static void Initialize(Widget ref_w, Widget w, Arg *args, Cardinal *num_args) {
        DtTermPrimitiveWidget tw = (DtTermPrimitiveWidget)w;
        DtTermPrimData tpd;
        XmFontContext fontContext;
        XmFontListEntry fontListEntry;
        ...
        */
        ...
        if (!tw->term.fontList) {
                tw->term.fontList =
                    XmeGetDefaultRenderTable(w, XmTEXT_FONTLIST);
        }
        ...
        if (tw->term.boldFontList) {
                tpd->boldTermFont =
                    CreateRenderFont(w, tw->term.boldFontList,
                                     &tw->term.boldFontSet, &tw->term.boldFont);
        } else {
                /* let's try and build a bold fontlist off of the base
                 * fontlist... */
                if (tw->term.fontSet) {
                        int num_fonts;
                        XFontStruct **fonts;
                        ...
                        for (i1 = 0, c2 = boldFontNames; i1 < num_fonts; i1++) {
                                ...
                                /* make boldFont bold by swapping the bold in
                                 * for the weight...
                                 */
                        ...
                        *c2 = '\0';
                        ...
                        tw->term.boldFontSet = XCreateFontSet(
                            XtDisplay(w), boldFontNames, &missingCharsetList,
                            &missingCharsetCount, (char **)0);
                        if (missingCharsetCount > 0) {
                                int i;
                                ...
                                if (tw->term.boldFontSet) {
                                        (void)XFreeFontSet(
                                            XtDisplay(w), tw->term.boldFontSet);
                                        tw->term.boldFontSet = (XFontSet)0;
                                }
                        }
                        ...
                        if (XGetFontProperty(tw->term.font, XA_FONT, &ret)) {
                                ...
                                *c2 = '\0';
                                ...
                                tw->term.boldFont =
                                    XLoadQueryFont(XtDisplay(w), boldFontName);
                                /* create a bold render font... */
                                if (tw->term.boldFont) {
                                        tpd->boldTermFont =
        ...
        tpd->capsLockKeyCodes =
            GetCapsLockKeyCodes(modifierMapping, &tpd->numCapsLockKeyCodes);

        /* get the modifier bit that corresponds to meta.
         * If there is none, use mod1...
         */
        tpd->metaMask =
            GetMetaMask(modifierMapping, keyboardMapping, keysymsPerKeycode,
                        minKeycodes, maxKeycodes);
        if (!tpd->metaMask) {
                /* default to mod1... */
        ...
        (void)XtAddEventHandler(w, (EventMask)KeyPressMask | KeyReleaseMask,
                                False, handleKeyEvents, (Opaque)NULL);
        (void)XtAddEventHandler(w,
                                (EventMask)ButtonPressMask | ButtonReleaseMask,
                                False, handleButtonEvents, (Opaque)NULL);
        (void)XtAddEventHandler(w, (EventMask)0, True, handleNonMaskableEvents,
                                (Opaque)NULL);
        {
                Widget sw;
                ...
                (void)XtAddEventHandler(
                    sw, (EventMask)StructureNotifyMask, False,
                    handleProcessStructureNotifyEvent, (Opaque)w);
                (void)XtAddEventHandler(sw, (EventMask)PropertyChangeMask,
                                        False, handlePropertyChangeEvents,
                                        (Opaque)w);
        }
...
static void InitializeVerticalScrollBar(Widget w, Boolean initCallbacks) {
        ...
        /* set up the scrollbar callbacks... */
                ...
                (void)XtAddCallback(tw->term.verticalScrollBar,
                                    XmNtoTopCallback, VerticalScrollBarCallback,
                                    (XtPointer)w);
                (void)XtAddCallback(tw->term.verticalScrollBar,
                                    XmNtoBottomCallback,
                                    VerticalScrollBarCallback, (XtPointer)w);
...
#define NO_SCROLL_REGION_HISTORY_SCROLL
                        ...
                        tw->term.verticalScrollBarMaximum =
                            tw->term.rows + tpd->lastUsedHistoryRow;
#endif /* NO_SCROLL_REGION_HISTORY_SCROLL */
                } else {
                        tw->term.verticalScrollBarMaximum =
                            tpd->lastUsedRow + tpd->scrollLockTopRow -
                            (tw->term.rows - 1 - tpd->scrollLockBottomRow);

                        /* add in any non-existent rows below the last used
                         * row...
                         */
                        if (tpd->allowScrollBelowBuffer) {
                                /* add in a full screen (less one line and
                                 * protected areas) below the last used row...
                                 */
                                tw->term.verticalScrollBarMaximum +=
                                    tw->term.rows - 1 - tpd->scrollLockTopRow -
                                    (tw->term.rows - 1 -
                                     tpd->scrollLockBottomRow);
                        }
                }
...
#else  /* NO_SCROLL_REGION_HISTORY_SCROLL */
                tw->term.verticalScrollBarValue =
                    tpd->topRow + tpd->lastUsedHistoryRow;
#endif /* NO_SCROLL_REGION_HISTORY_SCROLL */

                i = 0;
                (void)XtSetArg(arglist[i], XmNincrement, 1);
                i++;
                (void)XtSetArg(arglist[i], XmNminimum, 0);
                i++;
                ...
                Debug('b', fprintf(stderr,
                                   "InitializeVerticalScrollBar: sb size=%d  "
                                   "min=%d  max=%d  value=%d  pginc=%d\n",
                                   tw->term.verticalScrollBarSliderSize, 0,
                                   tw->term.verticalScrollBarMaximum,
                                   tw->term.verticalScrollBarValue,
                                   tw->term.verticalScrollBarPageIncrement));
...
static void InitOrResizeTermBuffer(Widget w) {
        DtTermPrimitiveWidget tw = (DtTermPrimitiveWidget)w;
        DtTermPrimData tpd = tw->term.tpd;
        DtTermPrimitiveClassPart *termClassPart =
            &(((DtTermPrimitiveClassRec *)(tw->core.widget_class))
                  ->term_primitive_class);
        long lines;
        char *c;
        short newColumns;
        short newRows;
        ...
        newColumns = MAX(
            1, ((int)(tw->core.width - (2 * (tw->primitive.shadow_thickness +
                                             tw->primitive.highlight_thickness +
                                             tw->term.marginWidth)))) /
                   tw->term.widthInc);
        newRows = MAX(1, ((int)(tw->core.height -
                                (2 * (tw->primitive.shadow_thickness +
                                      tw->primitive.highlight_thickness +
                                      tw->term.marginHeight)))) /
                             tw->term.heightInc);
        ...
        if (tpd->termBuffer) {
                ...
                if (tpd->useHistoryBuffer) {
                        if ((100 * (tpd->bufferRows + tpd->historyBufferRows) /
                             newRows) < ((75 * tpd->bufferRowRatio) / 100)) {
                                newBufferRows =
                                    (tpd->bufferRowRatio * newRows) / 100;
                                newHistoryBufferRows = newBufferRows - newRows;
                                newBufferRows = newRows;
                        } else {
                                /* the buffer needs to be the length of the
                                 * window... */
                                newBufferRows = newRows;
                        }
                } else {
                ...
                if (tpd->useHistoryBuffer && tpd->historyBufferRows > 0) {
                        ...
                        */
                         ...
                         * data from the active buffer into it (if necessary)
                        ...
                        if ((newHistoryBufferRows > tpd->historyBufferRows) ||
                            (newColumns != tw->term.columns)) {
                                ...
                                _DtTermPrimBufferResizeBuffer(
                                    &tpd->historyBuffer, &reqRows, &reqColumns);

                                if ((reqColumns < newColumns) ||
                                    (reqRows < newHistoryBufferRows)) {
                                        /*
                                        ** we ran out of memory when we tried to
                                        *resize the
                                        ** history buffer, make the necessary
                                        *adjustments
                                        */
                                        ...
                                        /*
                                        ** we ran out of memory, no need try and
                                        *resize the
                                        ** term buffer
                                        */
                        ...
                        if (resizeTermBuffer) {
                                if (newBufferRows < tpd->bufferRows) {
                                        /* we are shrinking the window.  The
                                         * first choice is to move lines above
                                         * the cursor into the history buffer so
                                         * that we don't loose any lines in the
                                         * window.  If there are not enough
                                         * lines above the cursor, we will drop
                                         * some of the lines off the bottom of
                                         * the window...
                                         */
                                        linesNeeded =
                                            tpd->bufferRows - newBufferRows;

                                        /* clip this by the number of lines
                                         * above the cursor... */
                                        ...
                                        historyLinesNeeded =
                                            linesNeeded -
                                            (newHistoryBufferRows -
                                             tpd->lastUsedHistoryRow);

                                        if (historyLinesNeeded > 0) {
                                                /* take them from the top of the
                                                 * history buffer... */
                                                (void)
                                ...
                                if ((newBufferRows != tpd->bufferRows) ||
                                    (newColumns != tw->term.columns)) {
                                        ...
                                        _DtTermPrimBufferResizeBuffer(
                                            &tpd->termBuffer, &reqRows,
                                            &reqColumns);
                                        if ((reqColumns < newColumns) ||
                                            (reqRows < newBufferRows)) {
                                                /*
                                                ** we ran out of memory, resize
                                                *the history buffer
                        ...
                        */
                        _DtTermPrimBufferResizeBuffer(
                            &tpd->termBuffer, &newBufferRows, &newColumns);
                        tpd->bufferRows = newBufferRows;
                }
                ...
                */
                ...
                /*
                ** if we added rows, then malloc a new set of
                *scrollRefreshRows...
                */
                if (newBufferRows > tw->term.rows) {
                        (void)XtFree(tpd->scrollRefreshRows);
                        tpd->scrollRefreshRows = (Boolean *)XtMalloc(
                            newBufferRows * sizeof(Boolean));
                        (void)memset(tpd->scrollRefreshRows, '\0',
                                     newBufferRows * sizeof(Boolean));
                }
                 ...
                 */
                if ((tw->term.rows != newRows) ||
                    (tw->term.columns != newColumns)) {
                        updateWindowSize = True;
                }
#else  /* SET_WINDOW_SIZE_ONLY_IF_CHANGED */
                /* we always need to update the winsize structure since it will
                 * not be done for us via $LINES and $COLUMNS...
                 */
                updateWindowSize = True;
                ...
                /* this is the first time and we need to figure out our ratio
                 * for future resizing...
                 */
                ...
                if (tpd->useHistoryBuffer) {
                        /* split up the buffer between the active and history
                         * buffers...
                         */
                        tpd->historyBufferRows =
                ...
                tpd->termBuffer = (*(termClassPart->buffer_create_proc))(
                    w, tpd->bufferRows, tw->term.columns,
                    termClassPart->sizeOfBuffer, termClassPart->sizeOfLine,
                    termClassPart->sizeOfEnh);
                if (tpd->useHistoryBuffer) {
                        tpd->historyBuffer =
                            (*(termClassPart->buffer_create_proc))(
                                w, tpd->historyBufferRows, tw->term.columns,
                                termClassPart->sizeOfBuffer,
                                termClassPart->sizeOfLine,
                                termClassPart->sizeOfEnh);
                        (void)_DtTermPrimBufferSetLinks(
                            tpd->termBuffer, tpd->historyBuffer, NULL);
                ...
                tpd->scrollRefreshRows =
                    (Boolean *)XtMalloc(tw->term.rows * sizeof(Boolean));
                (void)memset(tpd->scrollRefreshRows, '\0',
                             tw->term.rows * sizeof(Boolean));

                /* now that we have a term buffer, we can set up our input
                 * selector on our input source (pty or whatever)...
                 */
        ...
        */
        ...
        if ((tw->term.pty >= 0) && (updateWindowSize)) {
                (void)_DtTermPrimPtySetWindowSize(
                    tw->term.pty,
...
static void Resize(Widget w) {
        ...
        if (XtIsRealized(w)) {
                /* the first time through, if our size is changed during
                 * interactive placement, we will be called before redisplay and
                 * we will be initializing the buffer.  If we are sized to our
                 * requested size, the resize function will not be called...
                 */
...
static void Redisplay(Widget w, XEvent *event, Region region) {
        ...
        if (XtIsRealized(w)) {
                ...
                Debug('e',
                      fprintf(stderr,
                              ">>Redisplay()  expose.x=%d  .y=%d  .width=%d  "
                              ".height=%d\n",
                ...
                (void)_DtTermPrimExposeText(
                    w, event->xexpose.x, event->xexpose.y, event->xexpose.width,
                    event->xexpose.height, True);
...
static void handlePropertyChangeEvents(Widget w, XtPointer eventData,
        ...
        if (((XPropertyEvent *)event)->atom == xa_WM_STATE) {
                /* if we have not yet initialized the buffer (and started
                 * listening to the pty), then let's see if we are iconfied and
                 * do so...
                 */
                if (!tw->term.tpd->termBuffer) {
                        if (Success ==
                            XGetWindowProperty(
                                ...
                                ((XPropertyEvent *)event)->window, xa_WM_STATE,
                                0, (sizeof(struct _wmStateStruct) + 3) / 4,
...
/*ARGSUSED*/
static void InvokeTerminationCallback(Widget w, pid_t pid, int *stat_loc) {
        DtTermPrimitiveWidget tw = (DtTermPrimitiveWidget)w;
        ...
        if (tw->term.subprocessTerminationCallback) {
                (void)XtCallCallbackList(
                    w, tw->term.subprocessTerminationCallback, (XtPointer)&cb);
        }
}
 ...
 */
/*ARGSUSED*/
static Boolean SetValues(Widget cur_w, Widget ref_w, Widget w, ArgList args,
                         Cardinal *num_args) {
        ...
        if (cur_tw->term.subprocessPid != tw->term.subprocessPid) {
                ...
                if (tw->term.subprocessPid) {
                        /* add it old handler... */
                        tw->term.subprocessId = _DtTermPrimAddSubproc(
                            w, tw->term.subprocessPid,
                            InvokeTerminationCallback, NULL);

                        /* now that we have a handler, we may need to invoke
                         * it... */
        ...
        if ((cur_tw->term.rows != tw->term.rows) ||
            (cur_tw->term.columns != tw->term.columns)) {
                ...
                if (XtIsRealized(w)) {
                        /* Let's set the columns and rows back at this point.
                         * They will be set for real when and if the
                         * XtMakeGeometryRequest is honoured...
                         */
        ...
        if (cur_tw->term.fontList != tw->term.fontList) {
                 ...
                 */
                tw->term.tpd->termFont = CreateRenderFont(
                    w, tw->term.fontList, &tw->term.fontSet, &tw->term.font);
                ...
                (void)XmImVaSetValues(w, XmNfontList, tw->term.fontList, NULL);
        ...
        if (cur_tw->term.boldFontList != tw->term.boldFontList) {
                ...
                tw->term.tpd->boldTermFont = CreateRenderFont(
                    w, tw->term.boldFontList, (XFontSet *)0, (XFontStruct **)0);
        }
...
*/
static char **_mergeEnv(char **oldEnv, char **mergeEnv) {
        char **newEnv;
        char **ppChar;
                ...
                if (numReplace < numMerge) {
                        for (i1 = 0; i1 < numMerge; i1++) {
                                if (mergeIdx[i1] == -1) {
                                        ...
                                        if (strncmp(
                                                mergeEnv[i1], oldEnv[numOld],
                                                idx - mergeEnv[i1] + 1) == 0) {
                                                /*
                                                ** we have a match, remember the
                                                *index of
...
static void Realize(Widget w, XtValueMask *p_valueMask,
         ...
         */
        tw->term.columns =
            ((int)(tw->core.width - (2 * (tw->primitive.shadow_thickness +
                                          tw->primitive.highlight_thickness +
                                          tw->term.marginWidth)))) /
            tw->term.widthInc;
        tw->term.rows =
            ((int)(tw->core.height - (2 * (tw->primitive.shadow_thickness +
                                           tw->primitive.highlight_thickness +
                                           tw->term.marginHeight)))) /
            tw->term.heightInc;
        ...
        n = 0;
        XtSetArg(args[n], XmNspotLocation, &imPoint);
        n++;
        XtSetArg(args[n], XmNfontList, tw->term.fontList);
        n++;
        XtSetArg(args[n], XmNbackground, tw->core.background_pixel);
        n++;
        XtSetArg(args[n], XmNforeground, tw->primitive.foreground);
        n++;
        XtSetArg(args[n], XmNbackgroundPixmap, tw->core.background_pixmap);
        n++;
        XtSetArg(args[n], XmNlineSpace, tw->term.heightInc);
        n++;
        ...
        XtSetArg(args[n], XmNpreeditStartCallback, &xim_cb[0]);
        n++;
        XtSetArg(args[n], XmNpreeditDoneCallback, &xim_cb[1]);
        n++;
        XtSetArg(args[n], XmNpreeditDrawCallback, &xim_cb[2]);
        n++;
        XtSetArg(args[n], XmNpreeditCaretCallback, &xim_cb[3]);
        n++;
        ...
        if (tw->term.ptyAllocate) {
                ...
                tw->term.pty =
                    _DtTermPrimGetPty(&tw->term.ptySlaveName, &ptyMasterName);
                /* turn off suid root...  */
                ...
                if (fcntl(tw->term.pty, F_SETFL,
                          O_NONBLOCK | fcntl(tw->term.pty, F_GETFL, 0)) == -1) {
                        XmeWarning(w, "unable to set non-blocking on pty");

                        /* popup a warning dialog... */
                        (void)_DtTermPrimWarningDialog(
                            w, "unable to set non-blocking on pty");
                }
        ...
        if (tw->term.pty >= 0) {
                tw->term.tpd->utmpId =
                    _DtTermPrimUtmpGetUtLine(-1, tw->term.ptySlaveName);
        }
        ...
        */
        if (tw->term.pointerBlank) {
                (void)_DtTermPrimPointerOn((Widget)tw);
        } else
                XDefineCursor(XtDisplay(tw), XtWindow(tw),
                              tw->term.pointerShape);
        ...
        if (tw->term.subprocessExec && (tw->term.pty >= 0)) {
                ...
                if (tw->term.termName && *tw->term.termName) {
                        ...
                        int str_size =
                            strlen(tw->term.termName) + strlen(fmt) + 1;
                        newEnvStrings[i1] = XtMalloc(str_size);
                        (void)snprintf(newEnvStrings[i1], str_size, fmt,
                                       tw->term.termName);
                        i1++;
                }
                ...
                tw->term.subprocessPid = _DtTermPrimSubprocExec(
                    w, tw->term.ptySlaveName, tw->term.consoleMode,
                    tw->term.subprocessCWD, tw->term.subprocessCmd,
                    tw->term.subprocessArgv, tw->term.subprocessLoginShell);
        ...
        if (tw->term.subprocessPid >= 0) {
                tw->term.subprocessId = _DtTermPrimAddSubproc(
                    w, tw->term.subprocessPid, InvokeTerminationCallback, NULL);
                if (tw->term.subprocessTerminationCatch) {
                        (void)_DtTermPrimSetChildSignalHandler();
                }
        }
        ...
        */
        ...
        if (tw->term.tpd) {
                ...
                if (tw->term.tpd->renderReverseGC.gc) {
                        (void)XFreeGC(XtDisplay(w),
                                      tw->term.tpd->renderReverseGC.gc);
 ...
 */
void _DtTermPrimActionEnter(Widget w, XEvent *event, String *params,
                            Cardinal *num_params) {
        DtTermPrimitiveWidget tw = (DtTermPrimitiveWidget)w;
        ...
        (void)CapsLockUpdate(w, (event->xcrossing.state & LockMask) != 0);
 ...
 */
void _DtTermPrimActionLeave(Widget w, XEvent *event, String *params,
                            Cardinal *num_params) {
        DtTermPrimitiveWidget tw = (DtTermPrimitiveWidget)w;
...
static void readPty(XtPointer client_data, int *source, XtInputId *id) {
        ...
        if (TextIsPending(tpd->pendingRead)) {
                /* take text from the pendingRead buffer instead of doing a
                 * read...
                 */
...
#pragma BBA_IGNORE
                        ...
                        (void)fprintf(stderr, ">>readPty() read %d bytes", len);
                        if (len > 0) {
                                for (i1 = 0; i1 < len; i1++) {
                                        if (!(i1 % 20))
                                                fputs("\n    ", stderr);
        ...
        if (len > 0) {
                ...
                if (tw->term.outputLogCallback) {
                        ...
                        (void)XtCallCallbackList(
                            (Widget)tw, tw->term.outputLogCallback, &cb);
                }
                ...
                if (!_DtTermPrimParseInput((Widget)tw, buffer, len,
                         ...
                         */
                        if (chunk) {
                                /* we didn't finish up the pending text chunk we
                                 * were working on, so update the pointers and
                                 * continue...
                                 */
                                (void)_DtTermPrimPendingTextReplace(
                                    chunk, dangleBuffer, dangleBufferLen);
                        } else {
                                (void)_DtTermPrimPendingTextAppend(
                                    tpd->pendingRead, dangleBuffer,
                                    dangleBufferLen);
                        }
                        (void)XtFree((char *)dangleBuffer);
                } else if (chunk) {
                        /* we finished a pending chunk, so let's move on... */
                        _DtTermPrimPendingTextRemoveChunk(tpd->pendingRead,
                                                          chunk);
                }
                if (!tpd->ptyInputId) {
                         ...
                         */
                        /* we know we have more input, so we don't need to turn
                         * on the cursor...
                         */
        ...
        if (!moreInput(tw->term.pty)) {
                ...
                if (TextIsPending(tpd->pendingRead)) {
                        (void)XtAppAddTimeOut(
                            XtWidgetToApplicationContext((Widget)tw), 0,
                            _DtTermPrimForcePtyRead, (XtPointer)tw);
                } else {
                        /* turn the cursor back on... */
...
/*ARGSUSED*/
void _DtTermPrimForcePtyRead(XtPointer client_data, XtIntervalId *id) {
        DtTermPrimitiveWidget tw = (DtTermPrimitiveWidget)client_data;
        DtTermPrimData tpd = tw->term.tpd;
        int fd = tw->term.pty;
...
void _DtTermPrimLoopBackData(Widget w, char *data, int dataLength) {
        DtTermPrimitiveWidget tw = (DtTermPrimitiveWidget)w;
        DtTermPrimData tpd = tw->term.tpd;
        int fd = tw->term.pty;
...
void DtTermDisplaySend(Widget w, unsigned char *buffer, int length) {
...
/*ARGSUSED*/
static void writePty(XtPointer client_data, int *source, XtInputId *id) {
        DtTermPrimitiveWidget tw = (DtTermPrimitiveWidget)client_data;
        DtTermPrimData tpd = tw->term.tpd;
...
/*ARGSUSED*/
void _DtTermPrimActionKeyRelease(Widget w, XEvent *event, String *params,
                                 Cardinal *num_params) {
        DtTermPrimitiveWidget tw = (DtTermPrimitiveWidget)w;
        DtTermPrimData tpd = tw->term.tpd;
        ...
        Debug('i',
              fprintf(stderr, ">>_DtTermPrimActionKeyRelease() starting\n"));
...
/*ARGSUSED*/
void _DtTermPrimActionKeyInput(Widget w, XEvent *event, String *params,
                               Cardinal *num_params) {
        DtTermPrimitiveWidget tw = (DtTermPrimitiveWidget)w;
        DtTermPrimData tpd = tw->term.tpd;
        XKeyEvent *keyEvent = (XKeyEvent *)event;
        ...
        if (keyEvent->type != KeyPress) {
                (void)fprintf(
                    stderr,
                    "_DtTermPrimActionKeyInput: incorrect event type %d\n",
                    keyEvent->type);
                return;
        }
         ...
         */
        if ((keyEvent->state & (LockMask | ShiftMask)) ==
            (LockMask | ShiftMask)) {
                for (i = 0; i < nbytes; i++) {
                        if (isupper(string[i])) {
        ...
        if (nbytes > 0) {
                ...
                if (synEscape && *string != '\r' && *string != 0x0B)
                        (void)_DtTermPrimSendInput(w, (unsigned char *)"\033",
                                                   1);
...
void _DtTermPrimSendInput(Widget w, unsigned char *buffer, int length) {
        DtTermPrimitiveWidget tw = (DtTermPrimitiveWidget)w;
        DtTermPrimData tpd = tw->term.tpd;

        if (length > 0) {
                (void)_DtTermPrimPendingTextAppend(tpd->pendingWrite, buffer,
                                                   length);
...
void DtTermSubprocSend(Widget w, unsigned char *buffer, int length) {
        DtTermPrimitiveWidget tw = (DtTermPrimitiveWidget)w;
        DtTermPrimData tpd = tw->term.tpd;
        _DtTermWidgetToAppContext(w);
...
/*ARGSUSED*/
void _DtTermPrimActionFocusIn(Widget w, XEvent *event, String *params,
                              Cardinal *num_params) {
        DtTermPrimitiveWidget tw = (DtTermPrimitiveWidget)w;
        ...
        Debug('F',
              fprintf(stderr, ">>  event: window=0x%lx\n  mode=%d  detail=%d\n",
                      event->xfocus.window, event->xfocus.mode,
                      event->xfocus.detail));
#endif /* NOTDEF */
        Debug('F', _DtTermPrimDebugDumpEvent(stderr, w, event));
...
/*ARGSUSED*/
void _DtTermPrimActionFocusOut(Widget w, XEvent *event, String *params,
                               Cardinal *num_params) {
        DtTermPrimitiveWidget tw = (DtTermPrimitiveWidget)w;
...
static void KeyTranslator(Display *display, KeyCode keyCode,
                          Modifiers modifiers, Modifiers *modifiersReturn,
                          KeySym *keysymReturn) {
...
void _DtTermPrimInsertCharUpdate(Widget w,
...
/*ARGSUSED*/
void _DtTermPrimActionStop(Widget w, XEvent *event, String *params,
                           Cardinal *num_params) {
        DtTermPrimitiveWidget tw = (DtTermPrimitiveWidget)w;
        DtTermPrimData tpd = tw->term.tpd;
...
void _DtTermPrimInvokeStatusChangeCallback(Widget w) {
        DtTermPrimitiveWidget tw = (DtTermPrimitiveWidget)w;
        DtTermPrimData tpd = tw->term.tpd;
        DtTermStatusChangeCallbackStruct cb;
...
void _DtTermPrimDrawShadow(Widget w) {
        DtTermPrimitiveWidget tw = (DtTermPrimitiveWidget)w;

        if (XtIsRealized(w)) {
                XmeDrawShadows(
                    XtDisplay(w), XtWindow(w), tw->primitive.top_shadow_GC,
                    ...
                    tw->primitive.shadow_thickness, tw->term.shadowType);
        }
}

Widget DtCreateTermPrimitive(Widget parent, char *name, ArgList arglist,
                             Cardinal argcount) {
        Widget w;
...
void _DtTermPrimStartOrStopPtyInput(Widget w) {
        DtTermPrimitiveWidget tw = (DtTermPrimitiveWidget)w;
        DtTermPrimData tpd = tw->term.tpd;
        ...
        if (inputOn && !tpd->ptyInputId && (tw->term.pty >= 0)) {
                /* turn it on... */
                tpd->ptyInputId = XtAppAddInput(
                    XtWidgetToApplicationContext((Widget)tw), tw->term.pty,
                    (XtPointer)XtInputReadMask, readPty, (Widget)tw);
...
void _DtTermPrimStartOrStopPtyOutput(Widget w) {
        DtTermPrimitiveWidget tw = (DtTermPrimitiveWidget)w;
        DtTermPrimData tpd = tw->term.tpd;
        ...
        */
        if (TextIsPending(tpd->pendingWrite)) {
                if (tpd->ptyOutputId == 0) {
                        ...
                        ** turn it on...
                        */
                        tpd->ptyOutputId = XtAppAddInput(
                            XtWidgetToApplicationContext(w), tw->term.pty,
                            (XtPointer)XtInputWriteMask, writePty, w);

                        Debug('o',
                              fprintf(stderr, "    adding pty write select\n"));
                }
...
static void VerticalScrollBarCallback(Widget wid, XtPointer client_data,
        ...
        (void)_DtTermPrimScrollTextTo(
            (Widget)tw, cb->value - (tw->term.tpd->useHistoryBuffer
                                         ? tw->term.tpd->lastUsedHistoryRow
                                         : 0));
...
void _DtTermPrimWarningDialog(Widget w, char *msg) {
        ...
        if (!tpd->warningDialog) {
                ...
                i++;
                titleString = XmStringGenerate(
                    GETMESSAGE(NL_SETN_Prim, 2, "Terminal - Warning"),
                    XmFONTLIST_DEFAULT_TAG, XmCHARSET_TEXT, NULL);
                (void)XtSetArg(arglist[i], XmNdialogTitle, titleString);
                i++;
                tpd->warningDialog =
                    XmCreateWarningDialog(w, "termWarning", arglist, i);
                (void)XmStringFree(titleString);

                (void)XtAddCallback(tpd->warningDialog, XmNokCallback,
                                    WarningDialogOkCallback, (XtPointer)w);
                ...
                for (parent = tpd->warningDialog; !XtIsShell(parent);
                     parent = XtParent(parent))
                        ;
                (void)_DtTermPrimAddDeleteWindowCallback(
                    parent, WarningDialogWMDestroyCallback, (XtPointer)w);
        }

        i = 0;
        msgString =
            XmStringGenerate(msg, XmFONTLIST_DEFAULT_TAG, XmCHARSET_TEXT, NULL);
        (void)XtSetArg(arglist[i], XmNmessageString, msgString);
        i++;
        ...
        if (!XtIsRealized(tpd->warningDialog)) {
                ...
                (void)XtUnmanageChild(XmMessageBoxGetChild(
                    tpd->warningDialog, XmDIALOG_CANCEL_BUTTON));
                (void)XtUnmanageChild(XmMessageBoxGetChild(
                    tpd->warningDialog, XmDIALOG_HELP_BUTTON));
        }

        /* limit wm functions to move, decorations to menu, border and title...
         */
        i = 0;
        (void)XtSetArg(arglist[i], XmNmwmFunctions, MWM_FUNC_MOVE);
        i++;
...
static void ManagerConstraintInitializePatch(Widget request, Widget new_w,
                                             ArgList args, Cardinal *num_args) {
        if (!XtIsSubclass(new_w, dtTermPrimitiveWidgetClass)) {
                (*managerConstraintInitializeProc)(request, new_w, args,
                                                   num_args);
        }
}
...
void DtTermInitialize() {
        ...
        if (core->core_class.class_inited) {
                (void)XtWarning("DtTermInitialize was not called before "
...
void _DtTermPrimPutEnv(char *c1, char *c2) {
        char buffer[BUFSIZ];
        char *c;
        int c_size;
...
char *_DtTermPrimGetMessage(char *filename, int set, int n, char *s) {
        char *msg;
        char *lang;
        static int first = 1;
...
static void PreeditDone(XIC xic, XPointer client_data, XPointer call_data) {
        ...
        _DtTermPrimRefreshText((Widget)tw, PreColumn(tw), PreRow(tw),
                               tw->term.columns, PreRow(tw));
        PreUnder(tw) = False;
        PreLen(tw) = 0L;
}

static void PreeditDelete(DtTermPrimitiveWidget tw,
                          XIMPreeditDrawCallbackStruct *call_data) {
...
static void PreeditHighlight(DtTermPrimitiveWidget tw,
                             XIMPreeditDrawCallbackStruct *call_data) {
        ...
        if (call_data->text->feedback) {
                ...
                case XIMTertiary:
                        ...
                        _DtTermPrimRenderRefreshTextLinear(
                            (Widget)tw, selectInfo->begin, selectInfo->end - 1);
                        selectInfo->ownPrimary = True;
                        selectInfo->begin =
                            rowColToPos(tw, PreRow(tw), PreColumn(tw));
