...
typedef void (*TermFontRenderFunction)(Widget w, TermFont font, Pixel fg,
                                       Pixel bg, unsigned long flags, int x,
                                       int y, unsigned char *string, int len);

typedef void (*TermFontDestroyFunction)(Widget w, TermFont font);

typedef void (*TermFontExtentsFunction)(Widget w, TermFont font,
