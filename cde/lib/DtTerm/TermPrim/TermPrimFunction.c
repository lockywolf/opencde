...
static char rcs_id[] =
    "$XConsortium: TermPrimFunction.c /main/1 1996/04/21 19:17:27 drk $";
...
void _DtTermPrimFuncLF(Widget w, int count, FunctionSource functionSource) {
...
void _DtTermPrimFuncBackspace(Widget w, int count,
...
void _DtTermPrimFuncCR(Widget w, int count, FunctionSource functionSource) {
        DtTermPrimitiveWidget tw = (DtTermPrimitiveWidget)w;
        struct termData *tpd = tw->term.tpd;
...
void _DtTermPrimFuncNextLine(Widget w, int count,
                             FunctionSource functionSource) {
        DtTermPrimitiveWidget tw = (DtTermPrimitiveWidget)w;
        struct termData *tpd = tw->term.tpd;
...
void _DtTermPrimFuncPreviousLine(Widget w, int count,
                                 FunctionSource functionSource) {
        DtTermPrimitiveWidget tw = (DtTermPrimitiveWidget)w;
        struct termData *tpd = tw->term.tpd;
...
void _DtTermPrimFuncBackwardCharacter(Widget w, int count,
                                      FunctionSource functionSource) {
        DtTermPrimitiveWidget tw = (DtTermPrimitiveWidget)w;
        struct termData *tpd = tw->term.tpd;
        ...
        while (count-- > 0) {
                if (tpd->cursorColumn > 0) {
                        ...
                        if (tpd->cursorRow > 0) {
                                ...
                                /* past first line -- wrap to bottom of
                                 * screen... */
                                tpd->cursorRow = tw->term.rows - 1;
                        }
                }
...
void _DtTermPrimFuncForwardCharacter(Widget w, int count,
                                     FunctionSource functionSource) {
        DtTermPrimitiveWidget tw = (DtTermPrimitiveWidget)w;
        struct termData *tpd = tw->term.tpd;
...
void _DtTermPrimFuncReturn(Widget w, int count, FunctionSource functionSource) {
        Debug('i', fprintf(stderr,
                           ">>_DtTermPrimFuncReturn: not yet implemented\n"));
}

void _DtTermPrimFuncTab(Widget w, int count, FunctionSource functionSource) {
        DtTermPrimitiveWidget tw = (DtTermPrimitiveWidget)w;
        struct termData *tpd = tw->term.tpd;
        ...
        if (tpd->cursorColumn < tpd->leftMargin) {
                 ...
                 * positions.  It needs to be worked on to support the
                 * margins/tabs buffer...
                 */
                nextTab =
                    _DtTermPrimBufferGetNextTab(tBuffer, tpd->cursorColumn);
                ...
                if ((nextTab <= 0) || (nextTab >= tpd->rightMargin)) {
                        ...
                        /* check to see if we scrolled off the bottom of the
                         * screen... */
                        if (++tpd->cursorRow >= tw->term.rows) {
                                /* scroll one line...
                                 */
...
void _DtTermPrimFuncTabSet(Widget w, int count, FunctionSource functionSource) {
        DtTermPrimitiveWidget tw = (DtTermPrimitiveWidget)w;
        struct termData *tpd = tw->term.tpd;
...
void _DtTermPrimFuncTabClear(Widget w, int count,
                             FunctionSource functionSource) {
        DtTermPrimitiveWidget tw = (DtTermPrimitiveWidget)w;
        struct termData *tpd = tw->term.tpd;
...
void _DtTermPrimFuncTabClearAll(Widget w, int count,
                                FunctionSource functionSource) {
        DtTermPrimitiveWidget tw = (DtTermPrimitiveWidget)w;
        struct termData *tpd = tw->term.tpd;
 ...
 *  #        ####   #    #   ####      #       #     ####   #    #   ####
 */
void _DtTermPrimFuncMarginSetLeft(Widget w, int count,
                                  FunctionSource functionSource) {
        DtTermPrimitiveWidget tw = (DtTermPrimitiveWidget)w;
        struct termData *tpd = tw->term.tpd;
...
void _DtTermPrimFuncMarginSetRight(Widget w, int count,
                                   FunctionSource functionSource) {
        DtTermPrimitiveWidget tw = (DtTermPrimitiveWidget)w;
        struct termData *tpd = tw->term.tpd;
...
void _DtTermPrimFuncMarginClear(Widget w, int count,
                                FunctionSource functionSource) {
        DtTermPrimitiveWidget tw = (DtTermPrimitiveWidget)w;
        struct termData *tpd = tw->term.tpd;
...
void _DtTermPrimFuncRedrawDisplay(Widget w, int count,
                                  FunctionSource functionSource) {
        DtTermPrimitiveWidget tw = (DtTermPrimitiveWidget)w;
        struct termData *tpd = tw->term.tpd;
