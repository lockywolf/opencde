...
static char rcs_id[] =
    "$XConsortium: TermPrimAction.c /main/1 1996/04/21 19:16:44 drk $";
...
static void invokeAction(Widget w, char *transmitString, TermFunction function,
                         int count) {
...
void _DtTermPrimActionInsert(Widget w, XEvent *event, String *params,
                             Cardinal *num_params) {
...
void _DtTermPrimActionRedrawDisplay(Widget w, XEvent *event, String *params,
                                    Cardinal *num_params) {
        (void)invokeAction(w, NULL, _DtTermPrimFuncRedrawDisplay, 1);
        return;
}

void _DtTermPrimActionReturn(Widget w, XEvent *event, String *params,
                             Cardinal *num_params) {
        Debug('i', fprintf(stderr,
...
void _DtTermPrimActionTab(Widget w, XEvent *event, String *params,
                          Cardinal *num_params) {
        DtTermPrimitiveWidget tw = (DtTermPrimitiveWidget)w;
        struct termData *tpd = tw->term.tpd;
...
void _DtTermPrimActionString(Widget w, XEvent *event, String *params,
                             Cardinal *num_params) {
        unsigned char *c;
        ...
        if (((*params)[0] == '0') &&
            ...
            ((*params)[2] != '\0')) {
                ...
                (void)_DtTermPrimSendInput(w, (unsigned char *)*params,
                                           strlen(*params));
        }
        return;
}
...
void _DtTermPrimActionKeymap(Widget w, XEvent *event, String *params,
                             Cardinal *num_params) {
        ...
        XtGetSubresources(w, (XtPointer)&keymap, mapName, mapClass,
                          key_resources, XtNumber(key_resources), NULL,
                          (Cardinal)0);
