...
extern void _DtTermViewLineupListAddItem(_DtTermViewLineupList *list,
                                         Widget left, Widget right,
                                         Dimension correction);
extern void _DtTermViewLineupListLineup(_DtTermViewLineupList *list);

extern void _DtTermViewLineupListFree(_DtTermViewLineupList *list);
extern Widget _DtTermViewCreatePulldown(Widget parent, char *name);
extern Widget _DtTermViewCreateOptionMenu(Widget parent, Widget submenu,
                                          char *label, KeySym mnemonic,
                                          Arg al[], int ac);
extern void _DtTermViewEqualizeHeights(Widget label, Widget text);
