...
static char rcs_id[] =
    "$XConsortium: TermViewTerminalDialog.c /main/2 1996/08/28 16:50:55 drk $";
...
static void UpdateTerminalOptionsDialog(TerminalOptionsDialogType *options) {
        Boolean cursorMode;
        Boolean keypadMode;
        Boolean autoWrap;
        Boolean reverseWrap;
        ...
        ac = 0;
        (void)XtSetArg(
            al[ac], XmNmenuHistory,
            (cursorMode) ? options->keyboard_control.cursor_key_mode.application
                         : options->keyboard_control.cursor_key_mode.normal);
        ac++;
        (void)XtSetValues(options->keyboard_control.cursor_key_mode.option, al,
                          ac);
        ...
        ac++;
        (void)XtSetValues(options->keyboard_control.newline_sequence.option, al,
                          ac);

        /* set the 132 mode... */
        ac = 0;
        (void)XtSetArg(al[ac], XmNmenuHistory,
                       (c132) ? options->screen_control.columns.enabled
        ...
        ac = 0;
        (void)XtSetArg(al[ac], XmNmenuHistory,
                       (autoWrap) ? options->screen_control.autowrap.enabled
...
static void ApplyTerminalOptionsDialogCallback(Widget w, XtPointer clientData,
                                               XtPointer callData) {
        TerminalOptionsDialogType *options =
            (TerminalOptionsDialogType *)clientData;
        Widget menuHistory;
        Arg al[20];
        int ac;
        Arg al2;
        ...
        (void)XtGetValues(options->keyboard_control.cursor_key_mode.option,
                          &al2, 1);
        ...
        (void)XtSetArg(al2, XmNmenuHistory, &menuHistory);
        (void)XtGetValues(options->keyboard_control.keypad_mode.option, &al2,
                          1);
        (void)XtSetArg(
            al[ac], DtNappKeypadDefault,
        ...
        _DtTermSetUserKeyLock(
            options->dtterm,
            (menuHistory == options->keyboard_control.key_lock.locked));

        /* set the auto line feed mode... */
        (void)XtSetArg(al2, XmNmenuHistory, &menuHistory);
        (void)XtGetValues(options->keyboard_control.newline_sequence.option,
                          &al2, 1);
        _DtTermSetAutoLineFeed(
            options->dtterm,
            (menuHistory ==
             options->keyboard_control.newline_sequence.return_lf));
...
static void OkTerminalOptionsDialogCallback(Widget w, XtPointer clientData,
                                            XtPointer callData) {
        TerminalOptionsDialogType *options =
            (TerminalOptionsDialogType *)clientData;
...
static void CancelTerminalOptionsDialogCallback(Widget w, XtPointer clientData,
                                                XtPointer callData) {
        TerminalOptionsDialogType *options =
            (TerminalOptionsDialogType *)clientData;
...
static void MapTerminalOptionsDialogCallback(Widget w, XtPointer clientData,
                                             XtPointer callData) {
        TerminalOptionsDialogType *options =
            (TerminalOptionsDialogType *)clientData;
...
Widget _DtTermViewCreateTerminalOptionsDialog(Widget parent) {
        TerminalOptionsDialogType *options;
        ...
        options = (TerminalOptionsDialogType *)XtMalloc(
            sizeof(TerminalOptionsDialogType));
        ...
        string = XmStringCreateLocalized((GETMESSAGE(
            NL_SETN_ViewTerminalDialog, 26, "Terminal - Terminal Options")));
        okString = XmStringCreateLocalized(
            (GETMESSAGE(NL_SETN_ViewTerminalDialog, 2, "OK")));
        cancelString = XmStringCreateLocalized(
            (GETMESSAGE(NL_SETN_ViewTerminalDialog, 3, "Cancel")));
        helpString = XmStringCreateLocalized(
            (GETMESSAGE(NL_SETN_ViewTerminalDialog, 4, "Help")));
        resetString = XmStringCreateLocalized(
            (GETMESSAGE(NL_SETN_ViewTerminalDialog, 25, "Reset")));
        ...
        ac++;
        (void)XtSetArg(al[ac], XmNmarginWidth, 5);
        ac++;
        (void)XtSetArg(al[ac], XmNmarginHeight, 5);
        ac++;
        KbdControlFrame =
            XmCreateFrame(options->form, "KbdControlFrame", al, ac);
        (void)XtManageChild(KbdControlFrame);

        ac = 0;
        string = XmStringCreateLocalized(
            (GETMESSAGE(NL_SETN_ViewTerminalDialog, 5, "Keyboard Control")));
        ...
        ac++;
        label = XmCreateLabelGadget(KbdControlFrame, "KbdControlFrameLabel", al,
                                    ac);
        ...
        ac = 0;
        KbdControlForm =
            XmCreateForm(KbdControlFrame, "KbdControlForm", al, ac);
...
#ifdef CALLBACKS
        (void)XtAddCallback(pulldown, XmNentryCallback, CursorKeyModeCallback,
                            (XtPointer)options);
#endif
        options->keyboard_control.cursor_key_mode.normal =
            _DtTermViewCreatePushButton(
                pulldown, (GETMESSAGE(NL_SETN_ViewTerminalDialog, 6, "Normal")),
                NoSymbol, NULL, NULL, NULL, NULL);
        options->keyboard_control.cursor_key_mode.application =
            _DtTermViewCreatePushButton(
                pulldown,
                (GETMESSAGE(NL_SETN_ViewTerminalDialog, 7, "Application")),
                NoSymbol, NULL, NULL, NULL, NULL);
        ...
        tmp = _DtTermViewCreateOptionMenu(
            KbdControlForm, pulldown,
            (GETMESSAGE(NL_SETN_ViewTerminalDialog, 8, "Cursor Key Mode ")),
            NoSymbol, al, ac);
...
#ifdef CALLBACKS
        (void)XtAddCallback(pulldown, XmNentryCallback, KeyPadModeCallback,
                            (XtPointer)options);
#endif
        options->keyboard_control.keypad_mode.numeric =
            _DtTermViewCreatePushButton(
                pulldown,
                (GETMESSAGE(NL_SETN_ViewTerminalDialog, 9, "Numeric")),
                NoSymbol, NULL, NULL, NULL, NULL);
        options->keyboard_control.keypad_mode.application =
            _DtTermViewCreatePushButton(
                pulldown,
                (GETMESSAGE(NL_SETN_ViewTerminalDialog, 10, "Application")),
                NoSymbol, NULL, NULL, NULL, NULL);
        ...
        tmp = _DtTermViewCreateOptionMenu(
            KbdControlForm, pulldown,
            (GETMESSAGE(NL_SETN_ViewTerminalDialog, 11, "Keypad Mode ")),
            NoSymbol, al, ac);
...
#ifdef CALLBACKS
        (void)XtAddCallback(pulldown, XmNentryCallback, NewlineSequenceCallback,
                            (XtPointer)options);
#endif
        options->keyboard_control.newline_sequence.cr_return =
            _DtTermViewCreatePushButton(
                pulldown,
                (GETMESSAGE(NL_SETN_ViewTerminalDialog, 12, "Return Only")),
                NoSymbol, NULL, NULL, NULL, NULL);
        options->keyboard_control.newline_sequence.return_lf =
            _DtTermViewCreatePushButton(pulldown,
                                        (GETMESSAGE(NL_SETN_ViewTerminalDialog,
                                                    13, "Return/Line Feed")),
                                        NoSymbol, NULL, NULL, NULL, NULL);
        ...
        tmp = _DtTermViewCreateOptionMenu(
            KbdControlForm, pulldown,
            (GETMESSAGE(NL_SETN_ViewTerminalDialog, 14, "Newline Sequence ")),
            NoSymbol, al, ac);
         ...
         */
        pulldown = _DtTermViewCreatePulldown(KbdControlForm, "KeyLockPulldown");
#ifdef CALLBACKS
        (void)XtAddCallback(pulldown, XmNentryCallback, FunctionKeyLockCallback,
                            (XtPointer)options);
#endif
        options->keyboard_control.key_lock.locked = _DtTermViewCreatePushButton(
            pulldown, (GETMESSAGE(NL_SETN_ViewTerminalDialog, 15, "Locked")),
            NoSymbol, NULL, NULL, NULL, NULL);
        options->keyboard_control.key_lock.unlocked =
            _DtTermViewCreatePushButton(
                pulldown,
                (GETMESSAGE(NL_SETN_ViewTerminalDialog, 16, "Unlocked")),
                NoSymbol, NULL, NULL, NULL, NULL);
        ...
        tmp = _DtTermViewCreateOptionMenu(
            KbdControlForm, pulldown,
            (GETMESSAGE(NL_SETN_ViewTerminalDialog, 17, "User Function Keys ")),
            NoSymbol, al, ac);
        ...
        (void)_DtTermViewLineupListAddItem(
            ...
            options->keyboard_control.key_lock.option, CORRECTION_OPTION_MENU);
        ...
        (void)XtSetArg(al[ac], XmNtopAttachment, XmATTACH_WIDGET);
        ac++;
        (void)XtSetArg(al[ac], XmNtopWidget, KbdControlFrame);
        ac++;
        ...
        ac++;
        ScreenControlFrame =
            XmCreateFrame(options->form, "ScreenControlFrame", al, ac);
        (void)XtManageChild(ScreenControlFrame);

        ac = 0;
        string = XmStringCreateLocalized(
            (GETMESSAGE(NL_SETN_ViewTerminalDialog, 18, "Screen Control")));
        (void)XtSetArg(al[ac], XmNlabelString, string);
        ac++;
        (void)XtSetArg(al[ac], XmNchildType, XmFRAME_TITLE_CHILD);
        ac++;
        (void)XtSetArg(al[ac], XmNtraversalOn, False);
        ac++;
        label = XmCreateLabelGadget(ScreenControlFrame,
                                    "ScreenControlFrameLabel", al, ac);
        (void)XmStringFree(string);
        (void)XtManageChild(label);

        ac = 0;
        ScreenControlForm =
            XmCreateForm(ScreenControlFrame, "ScreenControlForm", al, ac);
...
#ifdef CALLBACKS
        (void)XtAddCallback(pulldown, XmNentryCallback, ColumnSwitchCallback,
                            (XtPointer)options);
#endif
        options->screen_control.columns.enabled = _DtTermViewCreatePushButton(
            pulldown, (GETMESSAGE(NL_SETN_ViewTerminalDialog, 19, "Enabled")),
            NoSymbol, NULL, NULL, NULL, NULL);
        options->screen_control.columns.disabled = _DtTermViewCreatePushButton(
            pulldown, (GETMESSAGE(NL_SETN_ViewTerminalDialog, 20, "Disabled")),
            NoSymbol, NULL, NULL, NULL, NULL);
        ...
        ac++;
        tmp = _DtTermViewCreateOptionMenu(
            ScreenControlForm, pulldown,
            (GETMESSAGE(NL_SETN_ViewTerminalDialog, 21,
        ...
        (void)_DtTermViewLineupListAddItem(
            ...
            options->screen_control.columns.option, CORRECTION_OPTION_MENU);
...
#ifdef CALLBACKS
        (void)XtAddCallback(pulldown, XmNentryCallback, AutoWrapCallback,
                            (XtPointer)options);
#endif
        options->screen_control.autowrap.enabled = _DtTermViewCreatePushButton(
            pulldown, (GETMESSAGE(NL_SETN_ViewTerminalDialog, 19, "Enabled")),
            NoSymbol, NULL, NULL, NULL, NULL);
        options->screen_control.autowrap.disabled = _DtTermViewCreatePushButton(
            pulldown, (GETMESSAGE(NL_SETN_ViewTerminalDialog, 20, "Disabled")),
            NoSymbol, NULL, NULL, NULL, NULL);
        ...
        tmp = _DtTermViewCreateOptionMenu(
            ScreenControlForm, pulldown,
            (GETMESSAGE(NL_SETN_ViewTerminalDialog, 22,
        ...
        (void)_DtTermViewLineupListAddItem(
            ...
            options->screen_control.autowrap.option, CORRECTION_OPTION_MENU);
...
#ifdef CALLBACKS
        (void)XtAddCallback(pulldown, XmNentryCallback, ReverseWrapCallback,
                            (XtPointer)options);
#endif
        options->screen_control.reversewrap.enabled =
            _DtTermViewCreatePushButton(
                pulldown,
                (GETMESSAGE(NL_SETN_ViewTerminalDialog, 19, "Enabled")),
                NoSymbol, NULL, NULL, NULL, NULL);
        options->screen_control.reversewrap.disabled =
            _DtTermViewCreatePushButton(
                pulldown,
                (GETMESSAGE(NL_SETN_ViewTerminalDialog, 20, "Disabled")),
                NoSymbol, NULL, NULL, NULL, NULL);
        ...
        tmp = _DtTermViewCreateOptionMenu(
            ScreenControlForm, pulldown,
            (GETMESSAGE(NL_SETN_ViewTerminalDialog, 23,
        ...
        (void)_DtTermViewLineupListAddItem(
            ...
            options->screen_control.reversewrap.option, CORRECTION_OPTION_MENU);
        ...
        ac = 0;
        string = XmStringCreateLocalized(
            (GETMESSAGE(NL_SETN_ViewTerminalDialog, 24, "Apply")));
        (void)XtSetArg(al[ac], XmNlabelString, string);
        ac++;
