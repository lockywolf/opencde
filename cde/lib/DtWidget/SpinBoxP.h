...
#define SB_ARROW_SENSITIVE                                                     \
        DTWIDGET_GETMESSAGE(MS_SpinBox, SPIN_ARROW_SENSITIVE,                  \
                            _DtMsgSpinBox_0000)

#define SB_ALIGNMENT                                                           \
        DTWIDGET_GETMESSAGE(MS_SpinBox, SPIN_ALIGNMENT, _DtMsgSpinBox_0001)

#define SB_INIT_DELAY                                                          \
        DTWIDGET_GETMESSAGE(MS_SpinBox, SPIN_INIT_DELAY, _DtMsgSpinBox_0002)

#define SB_MARGIN_HEIGHT                                                       \
        DTWIDGET_GETMESSAGE(MS_SpinBox, SPIN_MARGIN_HEIGHT, _DtMsgSpinBox_0003)

#define SB_MARGIN_WIDTH                                                        \
        DTWIDGET_GETMESSAGE(MS_SpinBox, SPIN_MARGIN_WIDTH, _DtMsgSpinBox_0004)

#define SB_ARROW_LAYOUT                                                        \
        DTWIDGET_GETMESSAGE(MS_SpinBox, SPIN_ARROW_LAYOUT, _DtMsgSpinBox_0005)

#define SB_REPEAT_DELAY                                                        \
        DTWIDGET_GETMESSAGE(MS_SpinBox, SPIN_REPEAT_DELAY, _DtMsgSpinBox_0006)

#define SB_ITEM_COUNT                                                          \
        DTWIDGET_GETMESSAGE(MS_SpinBox, SPIN_ITEM_COUNT, _DtMsgSpinBox_0007)

#define SB_POSITION_STRING                                                     \
        DTWIDGET_GETMESSAGE(MS_SpinBox, SPIN_POSITION_STRING,                  \
                            _DtMsgSpinBox_0008)

#define SB_POSITION_NUMERIC                                                    \
        DTWIDGET_GETMESSAGE(MS_SpinBox, SPIN_POSITION_NUMERIC,                 \
                            _DtMsgSpinBox_0009)

#define SB_DECIMAL_POINTS                                                      \
        DTWIDGET_GETMESSAGE(MS_SpinBox, SPIN_DECIMAL_POINTS, _DtMsgSpinBox_0010)

#define SB_MIN_MAX                                                             \
        DTWIDGET_GETMESSAGE(MS_SpinBox, SPIN_MIN_MAX, _DtMsgSpinBox_0011)

#define SB_TEXT DTWIDGET_GETMESSAGE(MS_SpinBox, SPIN_TEXT, _DtMsgSpinBox_0012)

#define SB_SET_ITEM                                                            \
        DTWIDGET_GETMESSAGE(MS_SpinBox, SPIN_SET_ITEM, _DtMsgSpinBox_0013)

#define SB_LABEL DTWIDGET_GETMESSAGE(MS_SpinBox, SPIN_LABEL, _DtMsgSpinBox_0014)
/*
 * Class Records
 */
typedef struct {
