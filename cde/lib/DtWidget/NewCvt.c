...
static Boolean _StringsAreEqual(String in_str, String test_str);
static void _DtCvtStringToBehavior(XrmValuePtr args, Cardinal *num_args,
                                   XrmValue *from_val, XrmValue *to_val);
static void _DtCvtStringToChildType(XrmValuePtr args, Cardinal *num_args,
                                    XrmValue *from_val, XrmValue *to_val);
static void _DtCvtStringToFillMode(XrmValuePtr args, Cardinal *num_args,
                                   XrmValue *from_val, XrmValue *to_val);
static void _DtCvtStringToPixmapPosition(XrmValuePtr args, Cardinal *num_args,
                                         XrmValue *from_val, XrmValue *to_val);
static void _DtCvtStringToStringPosition(XrmValuePtr args, Cardinal *num_args,
                                         XrmValue *from_val, XrmValue *to_val);
static void _DtCvtStringToTitlePosition(XrmValuePtr args, Cardinal *num_args,
                                        XrmValue *from_val, XrmValue *to_val);
...
*/
void _DtRegisterNewConverters(void) {
...
static void _DtCvtStringToBehavior(XrmValuePtr args, Cardinal *num_args,
        ...
        if (_StringsAreEqual(string, STR_ICON_LABEL))
                ...
                to_val->size = 0;
                to_val->addr = NULL;
                XtStringConversionWarning((String)from_val->addr, XmRBehavior);
        }
}
...
static void _DtCvtStringToChildType(XrmValuePtr args, Cardinal *num_args,
        ...
        if (_StringsAreEqual(string, STR_WORK_AREA))
                ...
                to_val->size = 0;
                to_val->addr = NULL;
                XtStringConversionWarning((String)from_val->addr, XmRChildType);
        }
}
...
static void _DtCvtStringToFillMode(XrmValuePtr args, Cardinal *num_args,
        ...
        if (_StringsAreEqual(string, STR_FILL_NONE))
                ...
                to_val->size = 0;
                to_val->addr = NULL;
                XtStringConversionWarning((String)from_val->addr, XmRFillMode);
        }
}
