...
CONST char _DtMsgCommon_0000[] = "Close";
CONST char _DtMsgCommon_0001[] = "Help";

/*** ComboBox.c ***/
CONST char _DtMsgComboBox_0000[] = "DtComboBoxWidget: Invalid alignment "
                                   "resource (defaulting to "
                                   "DtALIGNMENT_CENTER).";
...
CONST char _DtMsgComboBox_0012[] = "ComboBox";

CONST char _DtMsgComboBox_0013[] = "cvtStringToType: wrongParameters, String "
                                   "to XmRType conversion needs no extra "
                                   "arguments";
...
CONST char _DtMsgDialogBox_0000[] = "Incorrect child type.";

/*** DialogBox.c ***/
CONST char _DtMsgDialogBox_0001[] = "Invalid button position.";

/*** Editor.c & SearchDlg.c ***/
/* Default value for DtNformatSettingsDialogTitle */
CONST char _DtMsgEditor_0000[] = "Format Settings";

/* Default values for DtNleftMarginFieldLabel and DtNrightMarginFieldLabel */
CONST char _DtMsgEditor_0001[] = "Right Margin:";

CONST char _DtMsgEditor_0002[] = "Left Margin:";

/* Default values for DtNleftAlignToggleLabel, DtNrightAlignToggleLabel, */
/* DtNjustifyToggleLabel, and DtNcenterToggleLabel */
CONST char _DtMsgEditor_0003[] = "Left Align";

CONST char _DtMsgEditor_0004[] = "Right Align";

CONST char _DtMsgEditor_0005[] = "Justify";

CONST char _DtMsgEditor_0006[] = "Center";

/* Default values for DtNformatParagraphButtonLabel and */
/* DtNformatAllButtonLabel */
CONST char _DtMsgEditor_0007[] = "Paragraph";

CONST char _DtMsgEditor_0008[] = "All";

/* Default value for DtNspellDialogTitle resource */
CONST char _DtMsgEditor_0009[] = "Spell";

/* Default value for DtNfindChangeDialogTitle resource */
CONST char _DtMsgEditor_0010[] = "Find/Change";

/* Default value for DtNmisspelledListLabel resource */
CONST char _DtMsgEditor_0011[] = "Misspelled Words:";

/* Default value for DtNfindFieldLabel resource */
CONST char _DtMsgEditor_0012[] = "Find:";

/* Default value for DtNchangeFieldLabel resource */
CONST char _DtMsgEditor_0013[] = "Change To:";

/* Default value for DtNfindButtonLabel, DtNchangeButtonLabel, and */
/*  DtNchangeAllButtonLabel resources */
CONST char _DtMsgEditor_0014[] = "Find";

CONST char _DtMsgEditor_0015[] = "Change";

CONST char _DtMsgEditor_0016[] = "Change All";
...
CONST char _DtMsgEditor_0018[] = "Information";

/* Default values for DtNcurrentLineLabel, DtNtotalLineCountLabel,
 * DtNoverstrikeLabel, and DtNinsertLabel resources */
CONST char _DtMsgEditor_0019[] = "Line:";

CONST char _DtMsgEditor_0020[] = "Total:";

CONST char _DtMsgEditor_0021[] = "Overstrike";

CONST char _DtMsgEditor_0022[] = " ";

/* Default values for messages and title when spell filter is
 * not executable or not found */
CONST char _DtMsgEditor_0023[] = "Error executing spell filter.";

CONST char _DtMsgEditor_0024[] =
    "Check to see if filter, %s, is installed and in the path.";

CONST char _DtMsgEditor_0025[] = "Editor Error";

/*** Icon.c ***/
CONST char _DtMsgIcon_0000[] = "Incorrect alignment.";

CONST char _DtMsgIcon_0001[] = "Incorrect behavior.";

CONST char _DtMsgIcon_0002[] = "Incorrect fill mode.";

CONST char _DtMsgIcon_0003[] = "Incorrect string or pixmap position.";

CONST char _DtMsgIcon_0004[] = "Incorrect margin width or height.";

/*** Icon.c TitleBox.c ***/
CONST char _DtMsgIcon_0005[] = "Incorrect shadow type.";

/*** Indicator.c ***/
#ifdef _SUN_OS
CONST char _DtMsgIndicator_0000[] = "/usr/spool/mail/";
#else
CONST char _DtMsgIndicator_0000[] = "/usr/mail/";
#endif

/*** MenuButton.c ***/
CONST char _DtMsgMenuButton_0000[] = "XmNmenuPost has illegal value.";

CONST char _DtMsgMenuButton_0001[] = "DtMenuButtonWidget: Invalid Parent.";

CONST char _DtMsgMenuButton_0002[] = "DtMenuButtonWidget: Invalid Submenu.";

/*** SpinBox.c ***/
CONST char _DtMsgSpinBox_0000[] = "DtSpinBoxWidget: Invalid arrowSensitivity "
                                  "resource (defaulting to "
                                  "DtARROWS_SENSITIVE).";

CONST char _DtMsgSpinBox_0001[] = "DtSpinBoxWidget: Invalid alignment resource "
                                  "(defaulting to DtALIGNMENT_CENTER).";
...
CONST char _DtMsgSpinBox_0005[] = "DtSpinBoxWidget: Invalid arrowLayout "
                                  "resource (defaulting to "
                                  "DtARROWS_BEGINNING).";
...
CONST char _DtMsgSpinBox_0014[] = "SpinBox";

/*** TitleBox.c ***/
CONST char _DtMsgTitleBox_0000[] = "Incorrect title position.";

CONST char _DtMsgTitleBox_0001[] = "Incorrect title alignment.";

CONST char _DtMsgTitleBox_0002[] =
    "Only one child should be inserted in a frame.";

CONST char _DtMsgTitleBox_0003[] = "Invalid margin width.";

CONST char _DtMsgTitleBox_0004[] = "Invalid margin height.";
...
char *_DtWidgetGetMessage(int set, int n, char *s) {
        char *msg;
        nl_catd catopen();
        char *catgets();
        static int first = 1;
