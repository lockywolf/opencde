...
#define CB_ALIGNMENT                                                           \
        DTWIDGET_GETMESSAGE(MS_ComboBox, COMBO_ALIGNMENT, _DtMsgComboBox_0000)

#define CB_MARGIN_HEIGHT                                                       \
        DTWIDGET_GETMESSAGE(MS_ComboBox, COMBO_MARGIN_HEIGHT,                  \
                            _DtMsgComboBox_0001)

#define CB_MARGIN_WIDTH                                                        \
        DTWIDGET_GETMESSAGE(MS_ComboBox, COMBO_MARGIN_WIDTH,                   \
                            _DtMsgComboBox_0002)

#define CB_HORIZONTAL_SPACING                                                  \
        DTWIDGET_GETMESSAGE(MS_ComboBox, COMBO_HORIZONTAL_SPACING,             \
                            _DtMsgComboBox_0003)

#define CB_VERTICAL_SPACING                                                    \
        DTWIDGET_GETMESSAGE(MS_ComboBox, COMBO_VERTICAL_SPACING,               \
                            _DtMsgComboBox_0004)

#define CB_ORIENTATION                                                         \
        DTWIDGET_GETMESSAGE(MS_ComboBox, COMBO_ORIENTATION, _DtMsgComboBox_0005)

#define CB_ITEM_COUNT                                                          \
        DTWIDGET_GETMESSAGE(MS_ComboBox, COMBO_ITEM_COUNT, _DtMsgComboBox_0006)

#define CB_VISIBLE_ITEM                                                        \
        DTWIDGET_GETMESSAGE(MS_ComboBox, COMBO_VISIBLE_ITEM,                   \
                            _DtMsgComboBox_0007)

#define CB_TEXT                                                                \
        DTWIDGET_GETMESSAGE(MS_ComboBox, COMBO_TEXT, _DtMsgComboBox_0008)

#define CB_SET_ITEM                                                            \
        DTWIDGET_GETMESSAGE(MS_ComboBox, COMBO_SET_ITEM, _DtMsgComboBox_0009)

#define CB_SELECT_ITEM                                                         \
        DTWIDGET_GETMESSAGE(MS_ComboBox, COMBO_SELECT_ITEM, _DtMsgComboBox_0010)

#define CB_RESIZE                                                              \
        DTWIDGET_GETMESSAGE(MS_ComboBox, COMBO_RESIZE, _DtMsgComboBox_0011)

#define CB_LABEL                                                               \
        DTWIDGET_GETMESSAGE(MS_ComboBox, COMBO_LABEL, _DtMsgComboBox_0012)

#define CB_CVTSTRING                                                           \
        DTWIDGET_GETMESSAGE(MS_ComboBox, COMBO_CVTSTRING, _DtMsgComboBox_0013)

#define CB_DEL_POS                                                             \
        DTWIDGET_GETMESSAGE(MS_ComboBox, COMBO_DEL_POS, _DtMsgComboBox_0014)
/*
 * Class Records
 */
typedef struct {
