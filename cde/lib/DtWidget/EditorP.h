...
#define CLOSE_BUTTON                                                           \
        DTWIDGET_GETMESSAGE(MS_Common, MSG_CLOSE, _DtMsgCommon_0000)

#define HELP_BUTTON DTWIDGET_GETMESSAGE(MS_Common, MSG_HELP, _DtMsgCommon_0001)

#define FORMAT_SETTINGS                                                        \
        DTWIDGET_GETMESSAGE(MS_Editor, EDITOR_FORMAT_SETTINGS,                 \
                            _DtMsgEditor_0000)

#define RIGHT_MARGIN                                                           \
        DTWIDGET_GETMESSAGE(MS_Editor, EDITOR_RIGHT_MARGIN, _DtMsgEditor_0001)

#define LEFT_MARGIN                                                            \
        DTWIDGET_GETMESSAGE(MS_Editor, EDITOR_LEFT_MARGIN, _DtMsgEditor_0002)

#define LEFT_ALIGN                                                             \
        DTWIDGET_GETMESSAGE(MS_Editor, EDITOR_LEFT_ALIGN, _DtMsgEditor_0003)

#define RIGHT_ALIGN                                                            \
        DTWIDGET_GETMESSAGE(MS_Editor, EDITOR_RIGHT_ALIGN, _DtMsgEditor_0004)

#define JUSTIFY                                                                \
        DTWIDGET_GETMESSAGE(MS_Editor, EDITOR_JUSTIFY, _DtMsgEditor_0005)

#define CENTER DTWIDGET_GETMESSAGE(MS_Editor, EDITOR_CENTER, _DtMsgEditor_0006)

#define PARAGRAPH                                                              \
        DTWIDGET_GETMESSAGE(MS_Editor, EDITOR_PARAGRAPH, _DtMsgEditor_0007)

#define ALL DTWIDGET_GETMESSAGE(MS_Editor, EDITOR_ALL, _DtMsgEditor_0008)

#define SPELL_TITLE                                                            \
        DTWIDGET_GETMESSAGE(MS_Editor, EDITOR_SPELL_TITLE, _DtMsgEditor_0009)

#define FIND_TITLE                                                             \
        DTWIDGET_GETMESSAGE(MS_Editor, EDITOR_FIND_TITLE, _DtMsgEditor_0010)

#define MISSPELLED                                                             \
        DTWIDGET_GETMESSAGE(MS_Editor, EDITOR_MISSPELLED, _DtMsgEditor_0011)

#define FIND_LABEL                                                             \
        DTWIDGET_GETMESSAGE(MS_Editor, EDITOR_FIND_LABEL, _DtMsgEditor_0012)

#define CHANGE_LABEL                                                           \
        DTWIDGET_GETMESSAGE(MS_Editor, EDITOR_CHANGE_LABEL, _DtMsgEditor_0013)

#define FIND_BUTTON                                                            \
        DTWIDGET_GETMESSAGE(MS_Editor, EDITOR_FIND_BUTTON, _DtMsgEditor_0014)

#define CHANGE_BUTTON                                                          \
        DTWIDGET_GETMESSAGE(MS_Editor, EDITOR_CHANGE_BUTTON, _DtMsgEditor_0015)

#define CHNG_ALL_BUTTON                                                        \
        DTWIDGET_GETMESSAGE(MS_Editor, EDITOR_CHNG_ALL_BUTTON,                 \
                            _DtMsgEditor_0016)

#define NO_FIND                                                                \
        DTWIDGET_GETMESSAGE(MS_Editor, EDITOR_NO_FIND, _DtMsgEditor_0017)

#define INFO_TITLE                                                             \
        DTWIDGET_GETMESSAGE(MS_Editor, EDITOR_INFO_TITLE, _DtMsgEditor_0018)

#define LINE DTWIDGET_GETMESSAGE(MS_Editor, EDITOR_LINE, _DtMsgEditor_0019)

#define TOTAL DTWIDGET_GETMESSAGE(MS_Editor, EDITOR_TOTAL, _DtMsgEditor_0020)

#define OVR DTWIDGET_GETMESSAGE(MS_Editor, EDITOR_OVR, _DtMsgEditor_0021)

#define INS DTWIDGET_GETMESSAGE(MS_Editor, EDITOR_INS, _DtMsgEditor_0022)

#define BAD_FILTER                                                             \
        DTWIDGET_GETMESSAGE(MS_Editor, EDITOR_FILTER_ERROR, _DtMsgEditor_0023)

#define BAD_FILTER2                                                            \
        DTWIDGET_GETMESSAGE(MS_Editor, EDITOR_FILTER_ERROR2, _DtMsgEditor_0024)

#define ERROR_TITLE                                                            \
        DTWIDGET_GETMESSAGE(MS_Editor, EDITOR_ERROR_TITLE, _DtMsgEditor_0025)
...
typedef struct _DtEditorEditStuff {
        int blinkRate, maxLength;
        short columns, rows;
        XmTextPosition cursorPos, topCharacter;
        Boolean autoShowCursorPos, cursorPosVisible, editable, overstrikeMode,
            scrollHorizontal, scrollLeft, scrollTop, scrollVertical, wordWrap;
...
typedef struct _DtEditorSearchWidgets {
        Widget formDlg, listLbl, spellList, findLbl, findText, replaceLbl,
            replaceText, separator, findBtn, replaceBtn, replaceAllBtn,
            closeBtn, helpBtn;
...
typedef struct _DtEditorSearchStuff {
        ...
        XmString spellTitle, fndChngTitle, changeAllButtonLabel,
            changeButtonLabel, changeFieldLabel, findButtonLabel,
            findFieldLabel, misspelledListLabel;
} DtEditorSearchStuff;
...
typedef struct _DtEditorFormatWidgets {
        Widget format_dialog, right_label, left_label,
            rightMargField,       /* format right margin text field */
            leftMargField,        /* format left margin text field */
            radio_box, left_just, /* format type toggle button */
            right_just,           /* format type toggle button */
            both_just,            /* format type toggle button */
            center,               /* format type toggle button */
            separator, paragraph, all, close, help;
} DtEditorFormatWidgets;

typedef struct _DtEditorFormatStuff {
        DtEditorFormatWidgets widgets;
        XmString centerToggleLabel, formatAllButtonLabel, formatParaButtonLabel,
            formatDialogTitle, justifyToggleLabel, leftAlignToggleLabel,
            leftMarginFieldLabel, rightAlignToggleLabel, rightMarginFieldLabel;
} DtEditorFormatStuff;
...
typedef struct _status {
        ...
        XmString ovr, ins, currentLineLabel, totalLineLabel;
        Widget statusArea, lineLabel, lineText, totalLabel, totalText,
            overstrikeLabel, messageText;
} DtEditorStatusStuff;
...
#define M_search_replaceAllBtn(m) (m->editor.searchStuff.widgets.replaceAllBtn)
...
#define M_format_leftMarginField(m)                                            \
        (m->editor.formatStuff.widgets.leftMargField)
...
#define M_format_rightMarginField(m)                                           \
        (m->editor.formatStuff.widgets.rightMargField)
...
extern void _DtEditorResetUndo(DtEditorWidget editor);
extern void _DtEditorUpdateLineDisplay(DtEditorWidget editor, int currentLine,
                                       Boolean forceUpdate);
extern int _DtEditorGetLineIndex(XmTextWidget tw, XmTextPosition pos);
extern void _DtEditorWarning(DtEditorWidget pPriv, char *mess,
                             unsigned char dialogType);
extern DtEditorErrorCode _DtEditorValidateFileAccess(char *fileName,
                                                     int accessType);
extern void _DtEditorHelpSearchCB(Widget w, caddr_t client_data,
                                  caddr_t call_data);
extern void _DtEditorHelpSearchSpellCB(Widget w, caddr_t client_data,
                                       caddr_t call_data);
extern void _DtEditorHelpSearchFindCB(Widget w, caddr_t client_data,
                                      caddr_t call_data);
extern void _DtEditorHelpSearchChangeCB(Widget w, caddr_t client_data,
                                        caddr_t call_data);

/*** library-private functions in EditAreaData.c ***/

extern char *_DtEditorGetPointer(char *pString, int startChar);

/*** library-private functions in EditorCalls.c ***/

extern void _DtEditorModifyVerifyCB(Widget w, caddr_t client_data,
                                    caddr_t call_data);

/*** library-private functions in SearchCalls.c ***/

extern void _DtEditorSearchMapCB(Widget w, caddr_t client_data,
                                 caddr_t call_data);
extern int _DtEditor_CountCharacters(char *str, int num_count_bytes);
extern void _DtEditorDialogSearchCB(Widget w, caddr_t client_data,
                                    caddr_t call_data);
extern void _DtEditorDialogReplaceCB(Widget w, caddr_t client_data,
                                     caddr_t call_data);
extern void _DtEditorDialogReplaceAllCB(Widget w, caddr_t client_data,
                                        caddr_t call_data);
extern void _DtEditorDialogFindCancelCB(Widget w, caddr_t client_data,
                                        caddr_t call_data);
extern void _DtEditorMisspelledSelectCB(Widget w, caddr_t client_data,
                                        caddr_t call_data);
extern void _DtEditorMisspelledDblClickCB(Widget w, caddr_t client_data,
                                          caddr_t call_data);
extern void _DtEditorFindTextChangedCB(Widget w, caddr_t client_data,
                                       caddr_t call_data);
extern void _DtEditorReplaceTextChangedCB(Widget w, caddr_t client_data,
                                          caddr_t call_data);
extern void _DtEditorSetFindSensitivity(DtEditorWidget pPriv,
                                        Boolean sensitivity);
extern void _DtEditorSetReplaceSensitivity(DtEditorWidget pPriv,
                                           Boolean sensitivity);
extern void _DtEditorSetReplaceAllSensitivity(DtEditorWidget pPriv,
                                              Boolean sensitivity);

/*** library-private functions in SearchDlg.c ***/
extern void _DtEditorSearch(DtEditorWidget pPriv, Boolean spell,
                            Boolean createonly);
