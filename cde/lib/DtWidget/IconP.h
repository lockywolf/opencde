...
typedef void (*GetPositionProc)(DtIconGadget, Position, Position, Dimension,
                                Dimension, Position *, Position *, Position *,
                                Position *);
typedef void (*GetSizeProc)(DtIconGadget, Dimension *, Dimension *);
typedef void (*DrawProc)(DtIconGadget, Drawable, Position, Position, Dimension,
                         Dimension, Dimension, Dimension, unsigned char,
                         unsigned char);
typedef void (*CallCallbackProc)(DtIconGadget, XtCallbackList, int, XEvent *);
typedef void (*UpdateGCsProc)(DtIconGadget);
/*-------------------------------------------------------------
**	Class Structure
*/
...
#define C_GetSize(wc) (((DtIconGadgetClass)(wc))->icon_class.get_size)
#define C_GetPositions(wc) (((DtIconGadgetClass)(wc))->icon_class.get_positions)
#define C_Draw(wc) (((DtIconGadgetClass)(wc))->icon_class.draw)
#define C_CallCallback(wc) (((DtIconGadgetClass)(wc))->icon_class.call_callback)
#define C_OptimizeRedraw(wc)                                                   \
        (((DtIconGadgetClass)(wc))->icon_class.optimize_redraw)
#define C_UpdateGCs(wc) (((DtIconGadgetClass)(wc))->icon_class.update_gcs)
...
#define G_GetPositions(g, w, h, h_t, s_t, p_x, p_y, s_x, s_y)                  \
        (((DtIconClassRec *)g->object.widget_class)                            \
             ->icon_class.get_positions)(g, w, h, h_t, s_t, p_x, p_y, s_x,     \
                                         s_y)
...
#define G_CallCallback(g, cb, r, e)                                            \
        (((DtIconClassRec *)g->object.widget_class)                            \
             ->icon_class.call_callback)(g, cb, r, e)
#define G_UpdateGCs(g)                                                         \
        (((DtIconClassRec *)g->object.widget_class)->icon_class.update_gcs)(g)

/*	Cached Instance Field Macros
 */
#define G_CachePixmapPosition(co)                                              \
        (((DtIconCacheObject)(co))->icon_cache.pixmap_position)
#define G_FillOnArm(g) (((DtIconGadget)(g))->icon.cache->fill_on_arm)
#define G_RecomputeSize(g) (((DtIconGadget)(g))->icon.cache->recompute_size)
#define G_DrawShadow(g) (((DtIconGadget)(g))->icon.cache->draw_shadow)
#define G_PixmapPosition(g) (((DtIconGadget)(g))->icon.cache->pixmap_position)
#define G_StringPosition(g) (((DtIconGadget)(g))->icon.cache->string_position)
#define G_Alignment(g) (((DtIconGadget)(g))->icon.cache->alignment)
#define G_Behavior(g) (((DtIconGadget)(g))->icon.cache->behavior)
#define G_FillMode(g) (((DtIconGadget)(g))->icon.cache->fill_mode)
#define G_MarginWidth(g) (((DtIconGadget)(g))->icon.cache->margin_width)
#define G_MarginHeight(g) (((DtIconGadget)(g))->icon.cache->margin_height)
#define G_StringHeight(g) (((DtIconGadget)(g))->icon.cache->string_height)
#define G_Spacing(g) (((DtIconGadget)(g))->icon.cache->spacing)
#define G_Foreground(g) (((DtIconGadget)(g))->icon.cache->foreground)
#define G_Background(g) (((DtIconGadget)(g))->icon.cache->background)
#define G_ArmColor(g) (((DtIconGadget)(g))->icon.cache->arm_color)
...
#define Icon_Cache(w) (((DtIconGadget)(w))->icon.cache)
