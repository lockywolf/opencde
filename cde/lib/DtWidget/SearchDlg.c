...
static void ManageFind(DtEditorWidget pPriv);
static void UnmanageFind(DtEditorWidget pPriv);
static void CreateSearchDialog(DtEditorWidget pPriv);
...
static void ManageFind(DtEditorWidget pPriv) {
        ...
        ac++;
        XtSetArg(al[ac], XmNtopWidget, M_findText(pPriv));
        ac++;
...
static void UnmanageFind(DtEditorWidget pPriv) {
        ...
        XtSetArg(al[ac], XmNtopAttachment, XmATTACH_WIDGET);
        ac++;
        XtSetArg(al[ac], XmNtopWidget, M_search_spellList(pPriv));
        ac++;
        XtSetArg(al[ac], XmNtopOffset, 10);
        ac++;
        XtSetValues(M_search_replaceLbl(pPriv), al, ac);
...
void _DtEditorSearch(DtEditorWidget pPriv, Boolean spell, Boolean createonly) {
        Arg al[10];      /* arg list */
        ...
        if (!createonly) {
                ...
                if (spell) {
                        ...
                        if (E_dialogTitle(pPriv) != (XmString)NULL) {
                                ...
                                XmString titleStr = XmStringConcat(
                                    E_dialogTitle(pPriv), M_spellTitle(pPriv));
                        ...
                        ac++;
                        XtSetValues(XtParent(M_search_spellList(pPriv)), al,
                                    ac);
                        XtManageChild(M_search_listLbl(pPriv));
                        XtManageChild(XtParent(M_search_spellList(pPriv)));

                        /*
                         * Select first item in list which will cause its
                         * selectCB to sensitize the Find button and clear the
                         * Change To field.
                         */
                        ...
                        ac++;
                        XtGetValues(XtParent(M_search_spellList(pPriv)), al,
                                    ac);
                        ac = 0;
                        XtSetArg(al[ac], XmNheight, &formHeight);
                        ac++;
                        XtGetValues(M_search_dialog(pPriv), al, ac);
                        ac = 0;
                        XtSetArg(al[ac], XmNbottomAttachment, XmATTACH_FORM);
                        ac++;
                        XtSetArg(al[ac], XmNbottomOffset,
                                 formHeight - (y + height));
                        ac++;
                        XtSetValues(XtParent(M_search_spellList(pPriv)), al,
                                    ac);
                        ...
                        if (E_dialogTitle(pPriv) != (XmString)NULL) {
                                XmString titleStr =
                                    XmStringConcat(E_dialogTitle(pPriv),
                        ...
                        /*
                         * Seed the Find field with the last string we searched
                         * for and select it.  This will cause
                         * _DtEditorFindTextChangedCB to enable the Find &
                         * Change All buttons.
                         */

                        if (M_search_string(pPriv)) {
                                XmTextFieldSetString(M_findText(pPriv),
                                                     M_search_string(pPriv));
                                event.xkey.time =
                                    XtLastTimestampProcessed(M_display(pPriv));
                                XtCallActionProc((Widget)M_findText(pPriv),
                                                 "select-all", &event,
                                                 (String *)NULL, 0);
                        } else
                                XmTextFieldSetString(M_findText(pPriv),
                        ...
                        /*
                         * Seed the Change To field with the last replacement
                         * string.
                         */
...
static void CreateSearchDialog(DtEditorWidget pPriv) {
        ...
        M_search_dialog(pPriv) =
            XmCreateFormDialog(M_topLevelShell(pPriv), "findDlg", al, ac);
        ac = 0;
        ...
        XtSetArg(al[ac], XmNlabelString, tmpStr1);
        ac++;
        XtSetArg(al[ac], XmNleftAttachment, XmATTACH_FORM);
        ac++;
        XtSetArg(al[ac], XmNtopAttachment, XmATTACH_FORM);
        ac++;
        XtSetArg(al[ac], XmNfontList, E_labelFontList(pPriv));
        ac++;
        M_search_listLbl(pPriv) =
            XmCreateLabelGadget(M_search_dialog(pPriv), "listLbl", al, ac);
        ...
        XtSetArg(al[ac], XmNtopAttachment, XmATTACH_WIDGET);
        ac++;
        XtSetArg(al[ac], XmNtopWidget, M_search_listLbl(pPriv));
        ac++;
        XtSetArg(al[ac], XmNscrollingPolicy, XmAUTOMATIC);
        ac++;
        XtSetArg(al[ac], XmNfontList, E_textFontList(pPriv));
        ac++;
        M_search_spellList(pPriv) =
            XmCreateScrolledList(M_search_dialog(pPriv), "spellList", al, ac);
        ...
        XtSetArg(al[ac], XmNfontList, E_labelFontList(pPriv));
        ac++;
        M_search_findLbl(pPriv) =
            XmCreateLabelGadget(M_search_dialog(pPriv), "findLbl", al, ac);
        XmStringFree(tmpStr1);
        ...
        XtSetArg(al[ac], XmNtopAttachment, XmATTACH_WIDGET);
        ac++;
        XtSetArg(al[ac], XmNtopWidget, M_search_findLbl(pPriv));
        ac++;
        ...
        ac++;
        M_findText(pPriv) =
            XmCreateTextField(M_search_dialog(pPriv), "findTxt", al, ac);
        ...
        XtSetArg(al[ac], XmNfontList, E_labelFontList(pPriv));
        ac++;
        M_search_replaceLbl(pPriv) =
            XmCreateLabelGadget(M_search_dialog(pPriv), "repLbl", al, ac);
        XmStringFree(tmpStr1);
        ...
        XtSetArg(al[ac], XmNtopAttachment, XmATTACH_WIDGET);
        ac++;
        XtSetArg(al[ac], XmNtopWidget, M_search_replaceLbl(pPriv));
        ac++;
        XtSetArg(al[ac], XmNtopOffset, 5);
        ac++;
        XtSetArg(al[ac], XmNfontList, E_textFontList(pPriv));
        ac++;
        M_replaceText(pPriv) =
            XmCreateTextField(M_search_dialog(pPriv), "repTxt", al, ac);
        ...
        XtSetArg(al[ac], XmNtopAttachment, XmATTACH_WIDGET);
        ac++;
        XtSetArg(al[ac], XmNtopWidget, M_replaceText(pPriv));
        ac++;
        XtSetArg(al[ac], XmNtopOffset, 5);
        ac++;
        M_search_separator(pPriv) =
            XmCreateSeparator(M_search_dialog(pPriv), "separator", al, ac);
        ...
        ac++;
        XtSetArg(al[ac], XmNrightPosition, 33);
        ac++;
        XtSetArg(al[ac], XmNtopAttachment, XmATTACH_WIDGET);
        ac++;
        XtSetArg(al[ac], XmNtopWidget, M_search_separator(pPriv));
        ac++;
        XtSetArg(al[ac], XmNtopOffset, 7);
        ac++;
        XtSetArg(al[ac], XmNfontList, E_buttonFontList(pPriv));
        ac++;
        M_search_findBtn(pPriv) =
            XmCreatePushButtonGadget(M_search_dialog(pPriv), "findBtn", al, ac);
        XmStringFree(tmpStr1);
        ...
        XtSetArg(al[ac], XmNleftAttachment, XmATTACH_POSITION);
        ac++;
        XtSetArg(al[ac], XmNleftPosition, 35);
        ac++;
        XtSetArg(al[ac], XmNrightAttachment, XmATTACH_POSITION);
        ac++;
        XtSetArg(al[ac], XmNrightPosition, 66);
        ac++;
        XtSetArg(al[ac], XmNtopAttachment, XmATTACH_WIDGET);
        ac++;
        XtSetArg(al[ac], XmNtopWidget, M_search_separator(pPriv));
        ...
        XtSetArg(al[ac], XmNfontList, E_buttonFontList(pPriv));
        ac++;
        M_search_replaceBtn(pPriv) =
            XmCreatePushButtonGadget(M_search_dialog(pPriv), "replBtn", al, ac);
        XmStringFree(tmpStr1);
        ...
        XtSetArg(al[ac], XmNleftAttachment, XmATTACH_POSITION);
        ac++;
        XtSetArg(al[ac], XmNleftPosition, 68);
        ac++;
        XtSetArg(al[ac], XmNrightAttachment, XmATTACH_POSITION);
        ac++;
        ...
        M_search_replaceAllBtn(pPriv) = XmCreatePushButtonGadget(
            M_search_dialog(pPriv), "replAllBtn", al, ac);
        XmStringFree(tmpStr1);
        ...
        XtSetArg(al[ac], XmNleftAttachment, XmATTACH_POSITION);
        ac++;
        XtSetArg(al[ac], XmNleftPosition, 13);
        ac++;
        XtSetArg(al[ac], XmNrightAttachment, XmATTACH_POSITION);
        ac++;
        XtSetArg(al[ac], XmNrightPosition, 43);
        ac++;
        XtSetArg(al[ac], XmNtopAttachment, XmATTACH_WIDGET);
        ac++;
        XtSetArg(al[ac], XmNtopWidget, M_search_findBtn(pPriv));
        ac++;
        XtSetArg(al[ac], XmNtopOffset, 2);
        ac++;
        XtSetArg(al[ac], XmNfontList, E_buttonFontList(pPriv));
        ac++;
        M_search_closeBtn(pPriv) = XmCreatePushButtonGadget(
            M_search_dialog(pPriv), "closeBtn", al, ac);
        XmStringFree(tmpStr1);
        ...
        XtSetArg(al[ac], XmNleftAttachment, XmATTACH_POSITION);
        ac++;
        XtSetArg(al[ac], XmNleftPosition, 56);
        ac++;
        XtSetArg(al[ac], XmNrightAttachment, XmATTACH_POSITION);
        ac++;
        XtSetArg(al[ac], XmNrightPosition, 86);
        ac++;
        XtSetArg(al[ac], XmNtopAttachment, XmATTACH_WIDGET);
        ac++;
        XtSetArg(al[ac], XmNtopWidget, M_search_findBtn(pPriv));
        ...
        XtSetArg(al[ac], XmNfontList, E_buttonFontList(pPriv));
        ac++;
        M_search_helpBtn(pPriv) =
            XmCreatePushButtonGadget(M_search_dialog(pPriv), "helpBtn", al, ac);
        XmStringFree(tmpStr1);
        XtManageChild(M_search_helpBtn(pPriv));

        XtRemoveAllCallbacks(M_search_spellList(pPriv),
        ...
        ac = 0;
        XtSetArg(al[ac], XmNvisibleItemCount, 4);
        ac++;
        XtSetValues(M_search_spellList(pPriv), al, ac);

        ac = 0;
        XtSetArg(al[ac], XmNheight, &M_search_buttonHeight(pPriv));
        ac++;
        ...
        ac++;
        XtSetArg(al[ac], XmNbottomOffset,
                 2 * M_search_buttonHeight(pPriv) + 35);
        ac++;
