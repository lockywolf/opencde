...
#define MB_POST                                                                \
        DTWIDGET_GETMESSAGE(MS_MenuButton, MENU_POST, _DtMsgMenuButton_0000)

#define MB_PARENT                                                              \
        DTWIDGET_GETMESSAGE(MS_MenuButton, MENU_PARENT, _DtMsgMenuButton_0001)

#define MB_SUBMENU                                                             \
        DTWIDGET_GETMESSAGE(MS_MenuButton, MENU_SUBMENU, _DtMsgMenuButton_0002)
