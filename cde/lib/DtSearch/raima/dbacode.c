 ...
 */
int d_decode_dba(dba, file, slot) DB_ADDR dba; /* database address */
 ...
 */
int d_encode_dba(file, slot, dba) int file; /* returned file number */
 ...
 * -f/usr/users/master/config/nonwin dbacode.c */
