...
/* csmset.c */
int EXTERNAL_DBN dt_csmwrite(P1(int) Pi(long) Pi(CONST char FAR *)
                                 TASK_Di DBN_Dn); /* csmwrite.c */
...
/* csoset.c */
int EXTERNAL_DBN dt_csowrite(P1(int) Pi(long) Pi(CONST char FAR *)
                                 TASK_Di DBN_Dn); /* csowrite.c */
#ifndef NO_TIMESTAMP
...
int EXTERNAL_FIXED dt_mapchar(P1(unsigned char) Pi(unsigned char)
                                  Pi(CONST char FAR *) Pi(unsigned char)
                                      TASK_Di);
/* mapchar.c */
