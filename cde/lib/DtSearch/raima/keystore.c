 ...
 */
int d_keystore(field TASK_PARM DBN_PARM) long field; /* key field constant */
TASK_DECL
DBN_DECL /* database number */
{
        ...
        /* read current record */
        if ((stat = dio_read(curr_rec, (char FAR *FAR *)&rptr, PGHOLD)) ==
            S_OKAY) {
 ...
 * -f/usr/users/master/config/nonwin keystore.c */
