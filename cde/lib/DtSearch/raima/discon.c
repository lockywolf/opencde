 ...
 */
int d_discon(nset TASK_PARM DBN_PARM) int nset; /* set number */
TASK_DECL
DBN_DECL /* database number */
{
        ...
        char FAR *nprec =
            NULL;      /* ptr to next or prev record contents in cache */
        ...
        if (cmmp.next == NULL_DBA)
                ...
                npdba = cmmp.next;
                if ((dio_read(npdba, (char FAR *FAR *)&nprec, NOPGHOLD) !=
                     S_OKAY) ||
 ...
 * -f/usr/users/master/config/nonwin discon.c */
