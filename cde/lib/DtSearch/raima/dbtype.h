...
typedef struct {
        struct NODE_PATH_S FAR *ptr;
        LOCK_DESC
} NODE_PATH_P;
#ifndef SINGLE_USER
typedef struct {
        struct lock_descr FAR *ptr;
        LOCK_DESC
} LOCK_DESCR_P;
typedef struct {
        struct LM_LOCK_S FAR *ptr;
        LOCK_DESC
} LM_LOCK_P;
typedef struct {
        struct LM_FREE_S FAR *ptr;
        LOCK_DESC
} LM_FREE_P;
typedef struct {
        struct LM_DBOPEN_S FAR *ptr;
        LOCK_DESC
} LM_DBOPEN_P;
typedef struct {
        struct LM_DBCLOSE_S FAR *ptr;
        LOCK_DESC
} LM_DBCLOSE_P;
typedef struct {
        struct LR_DBOPEN_S FAR *ptr;
        LOCK_DESC
} LR_DBOPEN_P;
#endif
typedef struct {
        struct KEY_INFO_S FAR *ptr;
        LOCK_DESC
} KEY_INFO_P;
typedef struct {
        struct ren_entry FAR *ptr;
        LOCK_DESC
} REN_ENTRY_P;
typedef struct {
        struct RN_ENTRY_S FAR *ptr;
        LOCK_DESC
} RN_ENTRY_P;
typedef struct {
        struct LOOKUP_ENTRY_S FAR *ptr;
        LOCK_DESC
} LOOKUP_ENTRY_P;
typedef struct {
        struct page_entry FAR *ptr;
        LOCK_DESC
} PAGE_ENTRY_P;
typedef struct {
        struct DB_ENTRY_S FAR *ptr;
        LOCK_DESC
} DB_ENTRY_P;
typedef struct {
        struct FILE_ENTRY_S FAR *ptr;
        LOCK_DESC
} FILE_ENTRY_P;
typedef struct {
        struct RECORD_ENTRY_S FAR *ptr;
        LOCK_DESC
} RECORD_ENTRY_P;
typedef struct {
        struct SET_ENTRY_S FAR *ptr;
        LOCK_DESC
} SET_ENTRY_P;
typedef struct {
        struct MEMBER_ENTRY_S FAR *ptr;
        LOCK_DESC
} MEMBER_ENTRY_P;
typedef struct {
        struct SORT_ENTRY_S FAR *ptr;
        LOCK_DESC
} SORT_ENTRY_P;
typedef struct {
        struct FIELD_ENTRY_S FAR *ptr;
        LOCK_DESC
} FIELD_ENTRY_P;
typedef struct {
        struct KEY_ENTRY_S FAR *ptr;
        LOCK_DESC
} KEY_ENTRY_P;
typedef struct {
        struct PGZERO_S FAR *ptr;
        LOCK_DESC
} PGZERO_P;
typedef struct {
        struct RI_ENTRY_S FAR *ptr;
        LOCK_DESC
} RI_ENTRY_P;
typedef struct {
        ULONG FAR *ptr;
...
#define DB_ENTER(TDTL_PARAM)                                                   \
        if (startup(TDTL_PARAM) != S_OKAY) {                                   \
                return (db_status);                                            \
        } else
