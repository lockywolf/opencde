 ...
 */
int d_fillnew(nrec, recval TASK_PARM DBN_PARM) int nrec; /* record number */
...
DBN_DECL /* database number */
{
        ...
        bytecpy(ptr + rec_ptr->rt_data, recval,
 ...
 * -f/usr/users/master/config/nonwin fillnew.c */
