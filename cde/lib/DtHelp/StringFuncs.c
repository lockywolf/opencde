 ...
 *****************************************************************************/
int _DtHelpCeStrcspn(const char *s1, const char *s2, int max_len,
                     int *ret_len) {
        int len;
        int len2;
        const char *p1;
 ...
 *       1  If found the null byte character.
 *****************************************************************************/
int _DtHelpCeStrspn(char *s1, char *s2, int max_len, int *ret_len) {
        int len;
        int len2;
        char *p1;
        char *p2;
 ...
 *****************************************************************************/
int _DtHelpCeStrchr(const char *s1, const char *value, int max_len,
                    char **ret_ptr) {
        int len;
        int valLen;
        const char *p1;
 ...
 *	    'ret_ptr' will also be null in this case.
 *****************************************************************************/
int _DtHelpCeStrrchr(const char *s1, const char *value, int max_len,
                     char **ret_ptr) {
        int len;
        int valLen;
        const char *p1;
 ...
 *       0  If successful.
 *****************************************************************************/
int _DtHelpCeCountChars(char *s1, int max_len, int *ret_len) {
        int len;
 ...
 *
 *****************************************************************************/
void _DtHelpCeUpperCase(char *string) {
        int len;
 ...
 *
 ************************************************************************/
int _DtHelpCeStrHashToKey(const char *str) {
        register char c;
 ...
 *
 *****************************************************************************/
char *_DtHelpCeStripSpaces(char *string) {
        int i;
 ...
 *
 *****************************************************************************/
void _DtHelpCeCompressSpace(char *string)
 ...
 *                  to be supported.  Below are several different
 *implementations of _DtHelpCeIconvStr, each using what is available on
 *different platforms.  If no code is #ifdef'd, the XPG4 code
 *defaults.
 *****************************************************************************/

int _DtHelpCeIconvStr1Step(const char *fromCode, /* codeset name */
...

{
        ...
        if (0 == ret)
                ret = _DtHelpCeIconvStr(iconvContext, fromStr, ret_toStr, NULL,
                                        NULL, 0);
 ...
 *****************************************************************************/
int _DtHelpCeIconvOpen(_DtHelpCeIconvContext *ret_iconvContext, /* iconv */
 ...
 *              platforms.  If no code is #ifdef'd, the XPG4 code defaults.
 *****************************************************************************/
int _DtHelpCeIconvStr(_DtHelpCeIconvContext iconvContext, /* iconv */
                      const char *fromStr,  /* string to convert */
                      char **ret_toStr,     /* converted str */
                ...
                if (iconv(iconvContext->cd, (ICONV_INBUF_TYPE)&inChar,
                        ...
                        case E2BIG: /* no room in toStr */
                                ...
                                if (outBytesLeft < sizeof(wchar_t)) {
                                        ...
                                        toStrSize += MEM_INC;
                                        toStr = realloc(
                                            toStr, toStrSize * sizeof(char));
                                        if (NULL == toStr) {
                                                inBytesLeft =
                                                    0; /* end the translation */
                                                err = -3;
                                                break; /* BREAK */
                                        }
                                        outChar =
...
void _DtHelpCeIconvClose(
    _DtHelpCeIconvContext
        *io_iconvContext) { /* XPG4-compliant code (args dflt1 & dflt2 are
                               ignored in this code) */
        _DtHelpCeIconvContextRec *ic;

        if (!io_iconvContext || NULL == *io_iconvContext)
                return;
        ic = *io_iconvContext;
 ...
 *              the same conversion.
 *****************************************************************************/
int _DtHelpCeIconvContextSuitable(_DtHelpCeIconvContext iconvContext,
                                  const char *fromCode, const char *toCode) {
        if (!iconvContext || !iconvContext->fromCodeset ||
            !iconvContext->toCodeset || !fromCode || !toCode)
                return False;
 ...
 *          place.
 *****************************************************************************/
int _DtHelpCeStrCaseCmp(const char *s1, const char *s2) {
 ...
 *
 ******************************************************************************/
int _DtHelpCeFreeStringArray(char **array) {
        char **next;
 ...
 *
 ****************************************************************************/
void **_DtHelpCeAddPtrToArray(void **array, void *ptr) {
 ...
 *          to screw it up.
 *****************************************************************************/
int _DtHelpCeStrCaseCmpLatin1(const char *s1, const char *s2) {
 ...
 *          to screw it up.
 *****************************************************************************/
int _DtHelpCeStrNCaseCmpLatin1(const char *s1, const char *s2, size_t n) {
