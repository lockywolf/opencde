...
static void ProcessEvents(DtHelpDispAreaStruct *pDAS, pid_t child_pid,
                          Boolean child_flag);
 ...
 *
 *********************************************************************/
void _DtHelpExecProcedure(XtPointer client_data, char *cmd) {
        pid_t pid;
 ...
 *
 *********************************************************************/
void _DtHelpProcessHyperSelection(XtPointer client_data, int downX, int downY,
                                  XEvent *event) {
        ...
        if (pDAS->neededFlags & _DT_HELP_FOCUS_FLAG) {
                ...
                _DtCanvasMoveTraversal(
                    ...
                    (XtIsRealized(pDAS->dispWid) ? True : False), NULL, NULL,
                    NULL, NULL, NULL);
        }

        if (_DtCvSTATUS_OK == _DtCanvasGetPosLink(pDAS->canvas, downX, downY,
                                                  upX, upY, &ceHyper)) {
                /*
                ...
                if (pDAS->neededFlags & _DT_HELP_FOCUS_FLAG) {
                        ...
                        _DtCanvasMoveTraversal(
                            ...
                            ceHyper.specification, NULL, NULL, NULL, NULL);
                }
