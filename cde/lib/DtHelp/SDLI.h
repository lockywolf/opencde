...
enum SdlAttrDataType {
        ...
        /* valid data types */
        SdlAttrDataTypeId,
        SdlAttrDataTypeNumber,
        SdlAttrDataTypeCdata,
        SdlAttrDataTypeFont,
        SdlAttrDataTypeEnum
};
...
#define SDLIsAttrSet(pa, attr)                                                 \
        (((((attr)&VALUE_MASK) == ENUM_VALUE)                                  \
              ? ((pa).enum_values & attr)                                      \
              : ((((attr)&VALUE_MASK) == NUMBER_VALUE)                         \
                     ? ((pa).num_values & attr)                                \
                     : ((((attr)&VALUE_MASK) == STRING1_VALUE)                 \
                            ? ((pa).str1_values & attr)                        \
                            : ((pa).str2_values & attr)))) &                   \
...
#define SDLInitMask(value)                                                     \
        { SDLMaskValue1(value), SDLMaskValue2(value), }
...
#define SDLInitMaskThree(value1, value2, value3)                               \
        {                                                                      \
                SDLMaskValue1(value1) | SDLMaskValue1(value2) |                \
                    SDLMaskValue1(value3),                                     \
                    SDLMaskValue2(value1) | SDLMaskValue2(value2) |            \
                        SDLMaskValue2(value3),                                 \
        }
...
#define SDLInitMaskFive(value1, value2, value3, value4, value5)                \
        {                                                                      \
                SDLMaskValue1(value1) | SDLMaskValue1(value2) |                \
                    SDLMaskValue1(value3) | SDLMaskValue1(value4) |            \
                    SDLMaskValue1(value5),                                     \
                    SDLMaskValue2(value1) | SDLMaskValue2(value2) |            \
                        SDLMaskValue2(value3) | SDLMaskValue2(value4) |        \
                        SDLMaskValue2(value5),                                 \
        }
...
#define SDLInitMaskSeven(value1, value2, value3, value4, value5, value6,       \
                         value7)                                               \
        {                                                                      \
                SDLMaskValue1(value1) | SDLMaskValue1(value2) |                \
                    SDLMaskValue1(value3) | SDLMaskValue1(value4) |            \
...
#define SDLInitMaskEight(value1, value2, value3, value4, value5, value6,       \
                         value7, value8)                                       \
        {                                                                      \
                SDLMaskValue1(value1) | SDLMaskValue1(value2) |                \
                    SDLMaskValue1(value3) | SDLMaskValue1(value4) |            \
...
#define SDLInitMaskNine(value1, value2, value3, value4, value5, value6,        \
...
#define SDLInitMaskEleven(value1, value2, value3, value4, value5, value6,      \
...
#define SDLInitMaskTwelve(value1, value2, value3, value4, value5, value6,      \
...
#define SDLInitMaskThirteen(value1, value2, value3, value4, value5, value6,    \
                            value7, value8, value9, value10, value11, value12, \
                            value13)                                           \
        {                                                                      \
                SDLMaskValue1(value1) | SDLMaskValue1(value2) |                \
...
#define SDLInitMaskFourteen(value1, value2, value3, value4, value5, value6,    \
                            value7, value8, value9, value10, value11, value12, \
                            value13, value14)                                  \
        {                                                                      \
                SDLMaskValue1(value1) | SDLMaskValue1(value2) |                \
...
#define _SdlIsTossStyle(x)                                                     \
        (SdlElementKeyStyle == (x) || SdlElementHeadStyle == (x) ||            \
         SdlElementFormStyle == (x) || SdlElementFrmtStyle == (x) ||           \
