...
void _DtHelpFreeSegments(_DtCvSegment *seg_list, _DtCvStatus unresolved,
                         void (*destroy_region)(), _DtCvPointer client_data) {
        int i;
        char dupFlag;
        char **strs;
                ...
                case _DtCvTABLE:
                        ...
                        while (NULL != tableSeg && NULL != *tableSeg) {
                                ...
                                _DtHelpFreeSegments(
                                    ...
                                    unresolved, destroy_region, client_data);
                                tableSeg++;
                        }
                        ...
                        for (i = 0; NULL != strs &&
                                    i < _DtCvNumColsOfTableSeg(seg_list);
                             i++, strs++)
                                free((void *)*strs);
 ...
 * Purpose:	Free all memory associated with an SDL list.
 *****************************************************************************/
void _DtHelpDestroyTopicData(_DtCvTopicInfo *topic, void (*destroy_region)(),
