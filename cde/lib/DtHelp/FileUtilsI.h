...
extern void _DtHelpFileGetSearchPaths(char *paths[], Boolean searchHomeDir);
extern char *_DtHelpFileLocate(char *type, char *base, const char *suffixList[],
                               Boolean searchCurDir, int accessMode);
extern Boolean _DtHelpFileTraceLinks(char **pPathName);
extern Boolean _DtHelpFileTraceToFile(char **pPathName, int accessMode,
                                      char **pFoundPath);
