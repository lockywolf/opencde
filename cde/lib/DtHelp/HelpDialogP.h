...
typedef struct _DtHelpPrintStuff {
        ...
        Widget
            paperTopicsSeparator;   /* hidden sep btwn paper size & topic sel */
...
extern XmGeoMatrix
_DtHelpDialogWidgetGeoMatrixCreate(Widget wid, Widget instigator,
                                   XtWidgetGeometry *desired);
extern Boolean _DtHelpDialogWidgetNoGeoRequest(XmGeoMatrix geoSpec);
