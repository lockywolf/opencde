...
/********    Semi-Public Enums    ********/
enum _dtLinkType { _DtLinkTypeNone, _DtLinkTypeLink, _DtLinkTypeSwitch };
...
extern int _DtLinkDbGetHint(_DtCvLinkDb link_data, int link_index);
extern int _DtLinkDbGetLinkInfo(_DtCvLinkDb link_data, int link_index,
                                int (*filter)(), void *client_data,
                                _DtCvLinkInfo *ret_info);
extern char *_DtLinkDbGetLinkSpec(_DtCvLinkDb link_data, int link_index);
extern int _DtLinkDbGetLinkType(_DtCvLinkDb link_data, int link_index);
