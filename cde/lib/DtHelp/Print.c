...
/****** Protos ******/
static void ClosePrintCB(Widget w, XtPointer clientData, XtPointer callData);
static void StartPrintingCB(Widget w, XtPointer clientData, XtPointer callData);
static void CreatePrintDialog(Widget widget, _DtHelpPrintStuff *print,
                              _DtHelpDisplayWidgetStuff *display,
                              _DtHelpCommonHelpStuff *help);
 ...
 ************************************************************************/
static _DtHelpPrintCBRec *CreatePrintCBRec(Widget widget,
                                           _DtHelpDisplayWidgetStuff *display,
                                           _DtHelpCommonHelpStuff *help,
                                           _DtHelpPrintStuff *print) {
 ...
 *
 ************************************************************************/
void _DtHelpInitPrintStuff(_DtHelpPrintStuff *print) {
 ...
 *
 ************************************************************************/
void _DtHelpFreePrintStuff(_DtHelpPrintStuff *print, int cleanUpKind) {
 ...
 *
 ************************************************************************/
static void DestroyDialogCB(Widget w, XtPointer clientData,
                            XtPointer callData) {
        _DtHelpPrintCBRec *printrec = (_DtHelpPrintCBRec *)clientData;
 ...
 *
 ************************************************************************/
static void CheckCopiesCB(Widget w, XtPointer clientData, XtPointer callData) {
        /*   _DtHelpPrintCBRec * printrec = (_DtHelpPrintCBRec *) clientData; */
}
 ...
 *
 ************************************************************************/
static void CheckPrinterCB(Widget w, XtPointer clientData, XtPointer callData) {
        /*   _DtHelpPrintCBRec * printrec = (_DtHelpPrintCBRec *) clientData; */
}
 ...
 *
 ************************************************************************/
static void StartPrintingCB(Widget w, XtPointer clientData,
                            XtPointer callData) {
        _DtHelpPrintCBRec *printrec = (_DtHelpPrintCBRec *)clientData;
        int printType = 0;
        ...
        if (XmToggleButtonGetState(printrec->print->allTopicsBtn)) {
                ...
                printAll = True;
        } else if (XmToggleButtonGetState(printrec->print->tocBtn)) {
                printType = _DtPRINT_TOC;
                printTopic = NULL;
                printTocIndex = True;
        } else if (XmToggleButtonGetState(printrec->print->subTopicsBtn)) {
                printType = _DtPRINT_SUB;
                printTopic = printrec->display->locationId;
                printSub = True;
        } else if (XmToggleButtonGetState(printrec->print->curTopicBtn)) {
        ...
        if (titleLbl != NULL) {
                ...
                if (XmStringInitContext(&theContext, titleLbl) == True) {
                        while (XmStringGetNextSegment(theContext, &newTxt,
                                                      &theSet, &theDir,
                                                      &theSep) == True) {
                                len = strlen(newTxt);
                                if (len > 0) {
                                        topicTitle =
                                            XtRealloc(topicTitle, len + 1);
                                        if (topicTitle != NULL) {
                                                strlcpy(&topicTitle[newLen],
                                                        newTxt, len + 1);
                                                newLen += len;
                                        }
                                }
        ...
        copyCnt = 1;
        if (NULL == copies || (copies && copies[0] == EOS) ||
            (copies && sscanf(copies, "%d", &copyCnt) != 1) ||
            (copyCnt < 0 || copyCnt > 500)) {
                XtFree(copies);
                copies = XtNewString("1");
        }
        ...
        if (printType != 0) {
                ...
                _DtHelpPrintJob(printrec->widget, printrec->print->helpPrint,
                                printer, paperSize, copies,
                                printrec->print->printVolume,
                                printrec->display->helpType, printTopic,
...
void _DtHelpUpdatePrintDialog(_DtHelpPrintStuff *print,
        ...
        if (setDefaults) {
                ...
                if (print->subTopicsBtn)
                        XmToggleButtonSetState(print->subTopicsBtn, False,
                                               False);
                if (print->tocBtn)
                        XmToggleButtonSetState(print->tocBtn, False, False);
                if (print->allTopicsBtn)
                        XmToggleButtonSetState(print->allTopicsBtn, False,
                                               False);
        }
        ...
        case DtHELP_TYPE_TOPIC:
                ...
                _DtHelpFormatVolumeTitle(help->pDisplayArea,
                                         display->volumeHandle, &volumeString,
                                         &fontList, &mod);

                /* if volumeString caused a font list change, add it back */
                if (mod) { /* Add the title's font to the label */
                        XtSetArg(args[0], XmNfontList, fontList);
        ...
        case DtHELP_TYPE_MAN_PAGE:
                ...
                snprintf(buf, 400, "%s%s",
                         _DTGETMESSAGE(PRSET, 53, "Manual Page: "),
                         display->manPage);
                titleStr = buf;
                break;
        default:
...
static void CreatePrintDialog(Widget widget, _DtHelpPrintStuff *print,
        ...
        n = 0;
        XtSetArg(args[n], XmNtitle, chrStr);
        n++;
        ...
        XtAddCallback(printShell, XmNdestroyCallback, DestroyDialogCB,
   ...
   XtSetArg (args[n], XmNrightOffset, 10);                               n++;
        ...
        labelString = XmStringCreateLocalized(
            ((char *)_DTGETMESSAGE(PRSET, 10, "Printer:")));
        n = 0;
        XtSetArg(args[n], XmNlabelString, labelString);
        n++;
        XtSetArg(args[n], XmNtopAttachment, XmATTACH_WIDGET);
        n++;
        XtSetArg(args[n], XmNtopWidget, print->subject);
        n++;
        ...
        if (print->printer != NULL && print->printer[0] != EOS)
                ...
                chrStr = (char *)_DTGETMESSAGE(PRSET, 60,
                                               ""); /* dflt printer value */
        XtSetArg(args[n], XmNvalue, chrStr);
        n++;
        XtSetArg(args[n], XmNcursorPosition, strlen(chrStr));
        n++;
        XtSetArg(args[n], XmNtopAttachment, XmATTACH_WIDGET);
        n++;
        XtSetArg(args[n], XmNtopWidget, print->subject);
        ...
        n++;
        XtSetArg(args[n], XmNleftWidget, printerLabel);
        n++;
        ...
        XtAddCallback(print->printerField, XmNactivateCallback, CheckPrinterCB,
                      (XtPointer)printCBRec);
        ...
        /* create copies label */
        labelString = XmStringCreateLocalized(
            ((char *)_DTGETMESSAGE(PRSET, 11, "Copies:")));
        n = 0;
        XtSetArg(args[n], XmNlabelString, labelString);
        n++;
        XtSetArg(args[n], XmNtopAttachment, XmATTACH_WIDGET);
        ...
        n++;
        XtSetArg(args[n], XmNleftWidget, print->printerField);
        n++;
        XtSetArg(args[n], XmNalignment, XmALIGNMENT_BEGINNING);
        n++;
        ...
        n = 0;
        XtSetArg(args[n], XmNvalue, (char *)_DTGETMESSAGE(PRSET, 61, "1"));
        n++;                                     /*dflt copy cnt*/
        XtSetArg(args[n], XmNcursorPosition, 1); /* 1=strlen("1") */
        n++;
        XtSetArg(args[n], XmNtopAttachment, XmATTACH_WIDGET);
        n++;
        XtSetArg(args[n], XmNtopWidget, print->subject);
        ...
        XtSetArg(args[n], XmNleftAttachment, XmATTACH_WIDGET);
        n++;
        XtSetArg(args[n], XmNleftWidget, copiesLabel);
        n++;
        ...
        XtAddCallback(print->copiesField, XmNactivateCallback, CheckCopiesCB,
                      (XtPointer)printCBRec);
        ...
        /* Letter button */
        labelString = XmStringCreateLocalized(
            ((char *)_DTGETMESSAGE(PRSET, 21, "Letter 8.5 x 11 in")));
        n = 0;
        XtSetArg(args[n], XmNlabelString, labelString);
        n++;
        print->letterBtn =
            XmCreatePushButtonGadget(menupane, "letter", args, n);
        XtManageChild(print->letterBtn);
        XmStringFree(labelString);

        /* Legal button */
        labelString = XmStringCreateLocalized(
            ((char *)_DTGETMESSAGE(PRSET, 22, "Legal 8.5 x 14 in")));
        n = 0;
        XtSetArg(args[n], XmNlabelString, labelString);
        n++;
        ...
        /* Executive button */
        labelString = XmStringCreateLocalized(
            ((char *)_DTGETMESSAGE(PRSET, 23, "Executive 7.25 x 10.5 in")));
        n = 0;
        XtSetArg(args[n], XmNlabelString, labelString);
        n++;
        print->execBtn =
            XmCreatePushButtonGadget(menupane, "executive", args, n);
        XtManageChild(print->execBtn);
        XmStringFree(labelString);

        /* A4 button */
        labelString = XmStringCreateLocalized(
            ((char *)_DTGETMESSAGE(PRSET, 24, "A4 210 x 297 mm")));
        n = 0;
        XtSetArg(args[n], XmNlabelString, labelString);
        n++;
        ...
        /* B5 button */
        labelString = XmStringCreateLocalized(
            ((char *)_DTGETMESSAGE(PRSET, 25, "B5 182 x 257 mm")));
        n = 0;
        XtSetArg(args[n], XmNlabelString, labelString);
        n++;
        ...
        /* Option Menu */
        labelString = XmStringCreateLocalized(
            ((char *)_DTGETMESSAGE(PRSET, 20, "Paper Size:")));
        n = 0;
        XtSetArg(args[n], XmNlabelString, labelString);
        n++;
        ...
        XtSetArg(args[n], XmNtopAttachment, XmATTACH_WIDGET);
        n++;
        XtSetArg(args[n], XmNtopWidget, printerLabel);
        n++;
        XtSetArg(args[n], XmNtopOffset, 15);
        n++;
        XtSetArg(args[n], XmNrightAttachment, XmATTACH_FORM);
        ...
        n++;
        print->paperSizeOptMenu =
            XmCreateOptionMenu(printForm, "paperSizeOptionMenu", args, n);
        ...
        /*  Create a separator between the paper size and topic range
         * selection/buttons  */
        n = 0;
        XtSetArg(args[n], XmNleftAttachment, XmATTACH_FORM);
        n++;
        ...
        XtSetArg(args[n], XmNtopAttachment, XmATTACH_WIDGET);
        n++;
        XtSetArg(args[n], XmNtopWidget, print->paperSizeOptMenu);
        n++;
        ...
        XtSetArg(args[n], XmNtopAttachment, XmATTACH_WIDGET);
        n++;
        XtSetArg(args[n], XmNtopWidget, print->paperTopicsSeparator);
        n++;
        ...
        XtSetArg(args[n], XmNalignment, XmALIGNMENT_BEGINNING);
        n++; /*EXP*/
        print->topicsFrame = XmCreateFrame(printForm, "topicsFrame", args, n);
        ...
        topicsForm = XmCreateForm(print->topicsFrame, "topicsForm", NULL, 0);
        XtManageChild(topicsForm);

        /* create the frame title */
        labelString = XmStringCreateLocalized(
            (_DTGETMESSAGE(PRSET, 30, "Topics To Print")));
        n = 0;
        XtSetArg(args[n], XmNlabelString, labelString);
        n++;
        ...
        n++;
        frameTitle = XmCreateLabelGadget(print->topicsFrame, "topicsFrameTitle",
                                         args, n);
        ...
        labelString = XmStringCreateLocalized(
            ((char *)_DTGETMESSAGE(PRSET, 31, "Current Topic")));
        n = 0;
        XtSetArg(args[n], XmNlabelString, labelString);
        n++;
        print->curTopicBtn =
        ...
        labelString = XmStringCreateLocalized(
            ((char *)_DTGETMESSAGE(PRSET, 32, "Current and Subtopics")));
        n = 0;
        XtSetArg(args[n], XmNlabelString, labelString);
        n++;
        print->subTopicsBtn =
        ...
        labelString = XmStringCreateLocalized(
            ((char *)_DTGETMESSAGE(PRSET, 33, "Table of Contents and Index")));
        n = 0;
        XtSetArg(args[n], XmNlabelString, labelString);
        n++;
        print->tocBtn =
            XmCreateToggleButtonGadget(radioBox, "printTocBtn", args, n);
        XtManageChild(print->tocBtn);
        XmStringFree(labelString);

        /* Create the print all topics buttion */
        labelString = XmStringCreateLocalized(
            ((char *)_DTGETMESSAGE(PRSET, 34, "Entire Volume")));
        n = 0;
        XtSetArg(args[n], XmNlabelString, labelString);
        n++;
        print->allTopicsBtn =
            XmCreateToggleButtonGadget(radioBox, "printAllTopicsBtn", args, n);
        ...
        XtSetArg(args[n], XmNtopAttachment, XmATTACH_WIDGET);
        n++;
        XtSetArg(args[n], XmNtopWidget, print->topicsFrame);
        n++;
        XtSetArg(args[n], XmNtopOffset, 10);
        n++;
        ...
        labelString = XmStringCreateLocalized(
            ((char *)_DTGETMESSAGE(PRSET, 40, "Print")));
        n = 0;
        XtSetArg(args[n], XmNlabelString, labelString);
        n++;
   ...
   XtSetArg (args[n], XmNbottomAttachment, XmATTACH_FORM);		n++;
        ...
        labelString = XmStringCreateLocalized(
            ((char *)_DTGETMESSAGE(PRSET, 41, "Cancel")));
        n = 0;
        XtSetArg(args[n], XmNlabelString, labelString);
        n++;
        XtSetArg(args[n], XmNleftAttachment, XmATTACH_POSITION);
        ...
        XtSetArg(args[n], XmNrightAttachment, XmATTACH_POSITION);
        n++;
        XtSetArg(args[n], XmNrightPosition, 64);
        n++;
        XtSetArg(args[n], XmNtopAttachment, XmATTACH_WIDGET);
        n++;
        XtSetArg(args[n], XmNtopWidget, separator);
        ...
        labelString =
            XmStringCreateLocalized(((char *)_DTGETMESSAGE(PRSET, 42, "Help")));
        n = 0;
        XtSetArg(args[n], XmNlabelString, labelString);
        n++;
        XtSetArg(args[n], XmNleftAttachment, XmATTACH_POSITION);
        ...
        XtSetArg(args[n], XmNrightAttachment, XmATTACH_POSITION);
        n++;
        XtSetArg(args[n], XmNrightPosition, 97);
        n++;
        XtSetArg(args[n], XmNtopAttachment, XmATTACH_WIDGET);
        n++;
        XtSetArg(args[n], XmNtopWidget, separator);
        ...
        pHelpInfo = _DtHelpListAdd(DtHELP_printHelpBtn_STR, widget, help,
                                   &help->pHelpListHead);
        XtAddCallback(helpBtn, XmNactivateCallback, _DtHelpCB,
                      (XtPointer)pHelpInfo);
        XmStringFree(labelString);
        ...
        n++;
        XtSetArg(args[n], XmNinitialFocus, print->printerField);
        n++;
        ...
        XtAddCallback(printShell, XmNpopupCallback,
                      (XtCallbackProc)_DtHelpMapCB,
                      (XtPointer)XtParent(widget));

        /* Add the proper help callback to the print dialog shell "F1" support
         */
        pHelpInfo = _DtHelpListAdd(DtHELP_printShell_STR, widget, help,
                                   &help->pHelpListHead);
        XtAddCallback(printForm, XmNhelpCallback, _DtHelpCB,
                      (XtPointer)pHelpInfo);
...
void _DtHelpPrintJob(Widget widget, char *printExec, char *printer,
                     ...
                     Boolean printSub, Boolean printTocIndex,
                     char *topicTitle) {
        char *argv[40];
        char *quotes = "''";
        int i;
        ...
        if (paperSize >= _DtHelpPaperSizeNamesCnt)
                paperSize = 0;
        argv[i++] = "-paperSize";
