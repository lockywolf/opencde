 ...
 ******************************************************************************/
static int AddRowToTable(FormatStruct *my_struct, SDLMask *element_types,
                         enum SdlElement sig_element, SDLMask *exceptions,
                         SDLMask *process_mask);
static int AllocateBlock(FormatStruct *my_struct, SDLMask *element_types,
                         enum SdlElement sig_element, SDLMask *exceptions,
                         SDLMask *process_mask);
static int Cdata(FormatStruct *my_struct, SDLMask *element_types,
                 enum SdlElement sig_element, SDLMask *exceptions,
                 SDLMask *process_mask);
static int CheckForSnb(FormatStruct *my_struct, SDLMask *element_types,
                       enum SdlElement sig_element, SDLMask *exceptions,
                       SDLMask *process_mask);
static int CheckType(FormatStruct *my_struct, SDLMask *element_types,
                     enum SdlElement sig_element, SDLMask *exceptions,
                     SDLMask *process_mask);
static int CleanUpBlock(FormatStruct *my_struct, SDLMask *element_types,
                        enum SdlElement sig_element, SDLMask *exceptions,
                        SDLMask *process_mask);
static int ClearAndCheckSnref(FormatStruct *my_struct, SDLMask *element_types,
                              enum SdlElement sig_element, SDLMask *exceptions,
                              SDLMask *process_mask);
static int ColInfoToTableInfo(FormatStruct *my_struct, SDLMask *element_types,
                              enum SdlElement sig_element, SDLMask *exceptions,
                              SDLMask *process_mask);
static int CopyAnchorId(FormatStruct *my_struct, SDLMask *element_types,
                        enum SdlElement sig_element, SDLMask *exceptions,
                        SDLMask *process_mask);
static int CopyDocInfo(FormatStruct *my_struct, SDLMask *element_types,
                       enum SdlElement sig_element, SDLMask *exceptions,
                       SDLMask *process_mask);
static int CopyIdInfo(FormatStruct *my_struct, SDLMask *element_types,
                      enum SdlElement sig_element, SDLMask *exceptions,
                      SDLMask *process_mask);
static int ResolveSpcInfo(FormatStruct *my_struct, SDLMask *element_types,
                          enum SdlElement sig_element, SDLMask *exceptions,
                          SDLMask *process_mask);
static int CopyEntryInfo(FormatStruct *my_struct, SDLMask *element_types,
                         enum SdlElement sig_element, SDLMask *exceptions,
                         SDLMask *process_mask);
static int CopyTossInfo(FormatStruct *my_struct, SDLMask *element_types,
                        enum SdlElement sig_element, SDLMask *exceptions,
                        SDLMask *process_mask);
static int FakeEnd(FormatStruct *my_struct, SDLMask *element_types,
                   enum SdlElement sig_element, SDLMask *exceptions,
                   SDLMask *process_mask);
static _DtCvSegment *FindSnbEntry(_DtCvSegment *snb, char *target);
static char *GetInterpCmd(SdlOption interp_type);
static int IfInfo(FormatStruct *my_struct, SDLMask *element_types,
                  enum SdlElement sig_element, SDLMask *exceptions,
                  SDLMask *process_mask);
static int InitLast(FormatStruct *my_struct, SDLMask *element_types,
                    enum SdlElement sig_element, SDLMask *exceptions,
                    SDLMask *process_mask);
static int LoadGraphic(FormatStruct *my_struct, SDLMask *element_types,
                       enum SdlElement sig_element, SDLMask *exceptions,
                       SDLMask *process_mask);
static int MarkFound(FormatStruct *my_struct, SDLMask *element_types,
                     enum SdlElement sig_element, SDLMask *exceptions,
                     SDLMask *process_mask);
static int OnlyOne(FormatStruct *my_struct, SDLMask *element_types,
                   enum SdlElement sig_element, SDLMask *exceptions,
                   SDLMask *process_mask);
static int OnlyOneEach(FormatStruct *my_struct, SDLMask *element_types,
                       enum SdlElement sig_element, SDLMask *exceptions,
                       SDLMask *process_mask);
static int OneToN(FormatStruct *my_struct, SDLMask *element_types,
                  enum SdlElement sig_element, SDLMask *exceptions,
                  SDLMask *process_mask);
static int ParseSDL(FormatStruct *my_struct, enum SdlElement cur_element,
                    enum SdlElement sig_element, SDLMask *cur_except,
                    SDLMask *process_mask);
static int ProcessEnterAttr(FormatStruct *my_struct, SDLMask *element_types,
                            enum SdlElement sig_element, SDLMask *cur_except,
                            SDLMask *process_mask);
static int ProcessExitAttr(FormatStruct *my_struct, SDLMask *element_types,
                           enum SdlElement sig_element, SDLMask *cur_except,
                           SDLMask *process_mask);
static int ProcessSDLMarkup(FormatStruct *my_struct,
                            ...
                            enum SdlElement sig_element, SDLMask *cur_except,
                            SDLMask *process_mask);
static int RegisterLink(FormatStruct *my_struct, SDLMask *element_types,
                        enum SdlElement sig_element, SDLMask *exceptions,
                        SDLMask *process_mask);
static int RegisterSnbLink(FormatStruct *my_struct, SDLMask *element_types,
                           enum SdlElement sig_element, SDLMask *exceptions,
                           SDLMask *process_mask);
static int RegisterSwitch(FormatStruct *my_struct, SDLMask *element_types,
                          enum SdlElement sig_element, SDLMask *exceptions,
                          SDLMask *process_mask);
static int ResolveIf(FormatStruct *my_struct, _DtCvSegment *prev_data);
static int SaveItemInfo(FormatStruct *my_struct, SDLMask *element_types,
                        enum SdlElement sig_element, SDLMask *exceptions,
                        SDLMask *process_mask);
static int SaveLangCharSet(FormatStruct *my_struct, SDLMask *element_types,
                           enum SdlElement sig_element, SDLMask *exceptions,
                           SDLMask *process_mask);
static int SetSaveSnref(FormatStruct *my_struct, SDLMask *element_types,
                        enum SdlElement sig_element, SDLMask *exceptions,
                        SDLMask *process_mask);
static int SetTransit(FormatStruct *my_struct, SDLMask *element_types,
                      enum SdlElement sig_element, SDLMask *exceptions,
                      SDLMask *process_mask);
static int SetType(FormatStruct *my_struct, SDLMask *element_types,
                   enum SdlElement sig_element, SDLMask *exceptions,
                   SDLMask *process_mask);
static int ZeroOrOne(FormatStruct *my_struct, SDLMask *element_types,
                     enum SdlElement sig_element, SDLMask *exceptions,
                     SDLMask *process_mask);
static int ZeroToN(FormatStruct *my_struct, SDLMask *element_types,
                   enum SdlElement sig_element, SDLMask *exceptions,
                   SDLMask *process_mask);
...
#define MySaveString(seg_list, my_struct, string, cur_link, multi_len,         \
        ...
        _DtHelpCeSaveString(my_struct->ui_info->client_data, seg_list,         \
                            &(my_struct->last_seg), &(my_struct->prev_data),   \
                            string, my_struct->my_fonts, cur_link, multi_len,  \
...
#define SDL_ENTITY_SYSTEM_NOTATIONS                                            \
        SDLInitMaskTwelve(                                                     \
            SdlElementGraphic, SdlElementText, SdlElementAudio,                \
...
#define SDL_ENTITY_CLASSK                                                      \
        {"acro", SdlClassAcro}, {"book", SdlClassBook},                        \
            {"emph", SdlClassEmph}, {"jargon", SdlClassJargon},                \
            {"l10n", SdlClassL10n}, {NameStr, SdlClassName},                   \
            {"quote", SdlClassQuote}, {ProductStr, SdlClassProduct},           \
            {"termdef", SdlClassTermdef}, {"term", SdlClassTerm},              \
            {"mach-in", SdlClassMachIn}, {"mach-out", SdlClassMachOut},        \
            {"mach-cont", SdlClassMachCont}, {"pub-lit", SdlClassPubLit}, {    \
...
#define SDL_ENTITY_CLASSF                                                      \
        {"table", SdlClassTable}, {"cell", SdlClassCell},                      \
            {"list", SdlClassList}, {"item", SdlClassItem},                    \
...
static _CEInterpData InterpData[] = {
    ...
    {SdlInterpTcl, "tcl"}, {SdlOptionBad, NULL},
};
...
static OptionList apps[] = {{AllStr, SdlAppAll},          {"help", SdlAppHelp},
                            {"tutorial", SdlAppTutorial}, {"ref", SdlAppRef},
                            {"sys", SdlAppSys},           {NULL, SdlOptionBad}};
...
static OptionList idTypes[] = {
    ...
    {(CallbackStr + 1), SdlIdCallback}, {NULL, SdlOptionBad},
};
...
static OptionList interpreters[] = {
    ...
    {"sh", SdlInterpSh},   {NULL, SdlOptionBad},
};
        ...
        if (NULL != seg) {
                ...
                if (1 == _DtCvNumColsOfTableSeg(seg) &&
                    (NULL == rowIds || NULL == *rowIds || NULL == rowIds[1])) {
                        ...
                        /*
                         * now find the correct segment. Start out with a null
                         * return.
                         */
                        retSeg = NULL;
                        if (NULL != rowIds && NULL != *rowIds) {
                                ...
                                /*
                                 * look through the table's list for the one
                                 * segment to fill the one column/row table.
                                 */
                                while (NULL != tableSegs &&
                                       NULL != *tableSegs &&
                                       _DtCvStrCaseCmpLatin1(
                                           *rowIds,
                                           _DtCvContainerIdOfSeg(*tableSegs))) {
                                        prevSeg = *tableSegs;
                                        tableSegs++;
                                }
                                ...
                                if (NULL != tableSegs && NULL != *tableSegs) {
                                         ...
                                         */
                                        if (_DtCvINHERIT ==
                                                _DtCvContainerJustifyOfSeg(
                                                    retSeg) &&
                                            NULL !=
                                                _DtCvColJustifyOfTableSeg(seg))
                                                _DtCvContainerJustifyOfSeg(
                                                    retSeg) =
                                                    *(_DtCvColJustifyOfTableSeg(
                                                        seg));

                                        /*
                                         * now move up any other table segments,
                                         * whereby eliminating this segment from
                                         * the list so it won't be freed via
                                         * _DtHelpFreeSegments().
                                         */
                                        while (NULL != *tableSegs) {
                            ...
                            SDLIsAttrSet(*cur_info, myList->sdl_attr_define)) {
                                ...
                                if (attrib->struct_type == SdlFontSpecific ||
                                    attrib->struct_type == SdlElementSpecific) {
                                        if (attrib->struct_type ==
                                            SdlFontSpecific)
                                                varOffset =
                                                    ((char *)font_specs);
                                        else if (attrib->struct_type ==
                                                 SdlElementSpecific)
                                                varOffset = ((char *)cur_info);

                                        varOffset =
                                            varOffset + attrib->field_ptr;
...
static _DtCvSegment *DuplicateElement(
    ...
    _DtCvSegment **prev_data, _DtCvSegment **last_seg, void (*load_font)(),
    _DtCvValue (*resolve_spc)(), _DtCvUnit line_height, int ave_char,
    _DtHelpFontHints srcFonts, int link_idx, _DtCvValue vis_link) {
        ...
        while (src_seg != NULL) {
                ...
                *newSeg = *src_seg;
                ...
                /*
                 * set the duplicate on the source seg. That way, allocated
                 * memory now belongs to the new segment.
                 */
                SetDupFlag(src_seg);
                ...
                if (link_idx != -1) {
                        if (vis_link == True)
                                newSeg->type =
                                    _DtCvSetTypeToHyperText(newSeg->type);
                        else
                                newSeg->type =
                                    _DtCvSetTypeToGhostLink(newSeg->type);
                }
                ...
                case _DtCvCONTAINER:
                                ...
                                if (NULL != toss) {
                                        _DtHelpCeMergeSdlAttribInfo(
                                            _DtHelpCeMatchSemanticStyle(
                                                toss, match->clan, match->level,
                                                match->ssi),
                                            newSeg, &curFonts, NULL, NULL,
                                            NULL);
                                        /*
                                         * set the margins to absolute values
                                         */
                                        if (ave_char > 0) {
                                                _DtCvContainerLMarginOfSeg(
                                                    newSeg) =
                                                    _DtCvContainerLMarginOfSeg(
                                                        newSeg) *
                                                    ave_char;
                        ...
                        _DtCvContainerListOfSeg(newSeg) = DuplicateElement(
                            client_data, toss, _DtCvContainerListOfSeg(src_seg),
                            &prevData, &lastSeg, load_font, resolve_spc,
                            line_height, ave_char, curFonts, link_idx,
                            vis_link);
                ...
                case _DtCvREGION:
                        region =
                            (_DtHelpDARegion *)_DtCvInfoOfRegionSeg(src_seg);
                        if (False == region->inited) {
                                _DtHelpDASpcInfo *spcInfo =
                                    (_DtHelpDASpcInfo *)region->handle;

                                (resolve_spc)(
                                    client_data, _DtHelpFontHintsLang(curFonts),
                                    _DtHelpFontHintsCharSet(curFonts), curFonts,
                                    spcInfo->name,
                         ...
                         */
                        if (NULL != match && (SdlClassInLine == match->clan ||
                                              SdlClassButton == match->clan ||
                                              SdlClassIcon == match->clan))
                                newSeg->type =
                                    _DtCvSetTypeToInLine(newSeg->type);
...
static _DtCvSegment *ResolveSnref(FormatStruct *my_struct, _DtCvSegment *snref,
        ...
        if (NULL != my_struct->snb) {
                ...
                if (True == found) {
                        /*
                         * an refitem can be a region (graphic, audio, video,
                         * animate), text or a script. If a script, need to
                        ...
                        if (SdlElementScript == priv->sdl_el_type) {
                                ...
                                char *newData = NULL;
                                char *interpStr =
                                    GetInterpCmd((SdlOption)(priv->interp));
                                ...
                                if (NULL != match && NULL != my_struct->toss)
                                        _DtHelpCeMergeSdlAttribInfo(
                                            _DtHelpCeMatchSemanticStyle(
                                                my_struct->toss, match->clan,
                                                match->level, match->ssi),
                                            newSeg, my_struct->my_fonts, NULL,
                                            NULL, NULL);

                                if (0 != MySaveString(&newSeg, my_struct,
                                                      newData,
                                                      my_struct->cur_link,
                                ...
                                /*
                                 * strip the container wrapper from the snbEntry
                                 * before duplication.
                                 *
                                 * Also, include the toss match data for this
                                 * segment in the snbEntry.
                                 */
                                snbEntry = _DtCvContainerListOfSeg(snbEntry);
                                if (NULL != snbEntry) {
                                        SegMatchData(snbEntry) =
                                            SegMatchData(refItem);

                                        newSeg = DuplicateElement(
                                            my_struct->ui_info->client_data,
                                            my_struct->toss, snbEntry,
                                        ...
                                        /*
                                         * if the only item in the list for the
                                         * snb entry is a region, then assume it
                                         * is a graphic, video, etc. Check to
                                         * see if the region is in-line or a
                                         * figure. If in-line, ignore any heads
                                         * with the refitem. If a figure,
                                         * include them (they may be a caption
                                         * to the region).
                                         */
                                        if (_DtCvIsSegRegion(newSeg) &&
                                            NULL == _DtCvNextSeg(newSeg)) {
                                                SdlMatchData *info =
                                                    SegMatchDataPtr(refItem);
                 ...
                 */
                else if (NULL != altText &&
                         NULL != _DtCvContainerListOfSeg(altText)) {
                        /*
                ...
                if (NULL == my_struct->un_snrefs)
                        my_struct->un_snrefs =
                            (UnresSnref *)malloc(sizeof(UnresSnref));
                else
                ...
                if (NULL != my_struct->un_snrefs) {
                        ...
                        my_struct->un_snrefs[count].cur_link =
                            my_struct->cur_link;
                        my_struct->un_snrefs[count].fonts =
                            *(my_struct->my_fonts);

                        my_struct->snref_cnt++;

                        /*
                         * return the snref segment as our new segment to act as
                         * a place holder, otherwise it gets squeezed out.
                         */
                        newSeg = snref;
...
static int ResolveAsyncBlock(FormatStruct *my_struct, _DtCvSegment *table_seg) {
        ...
        while (NULL != rowIds && NULL != *rowIds) {
                ...
                while (NULL != next && '\0' != *next) {
                        ...
                        if (start != next) {
                                /*
                                 * save and replace the last character with a
                                 * null byte.
                                 */
                                c = *next;
                                *next = '\0';
                                ...
                                /*
                                 * the id did not match any of the cells in the
                                 * table Look in the async list.
                                 */
                                if (False == found) {
                                        ...
                                        if (True == found) {
                                                ...
                                                /*
                                                 * break the link to the next
                                                 * segment or we'll copy this
                                                 * segment and all the next
                                                 * segments.
                                                 */
                                                _DtCvSegment *nextSeg =
                                                    _DtCvNextSeg(asyncSegs);
                                                _DtCvNextSeg(asyncSegs) = NULL;

                                                /*
                                                 * allocate a new segment for
                                                 * this async block.
                                                 */
                                                newSeg = DuplicateElement(
                                                    my_struct->ui_info
                                                        ->client_data,
                                                    my_struct->toss, asyncSegs,
                                                    &lastSrc, &lastNext,
                                                    my_struct->ui_info
                                                        ->load_font,
                                                    my_struct->ui_info
                                                    ...
                                                    my_struct->ui_info
                                                        ->avg_char,
                                                    *(my_struct->my_fonts), -1,
                                                    False);

                                                /*
                                                 * restore the async seg linked
                                                 * list
                                                 */
                                                _DtCvNextSeg(asyncSegs) =
                                                    nextSeg;
                                                ...
                                                /*
                                                 * check to see if anything was
                                                 * copied
                                                 */
                                                if (NULL == newSeg)
                                                        return -1;
                                                /*
                                                 * now place this segment in the
                                                 * list.
                                                 */
                                                _DtCvCellsOfTableSeg(
                                                    table_seg) = (_DtCvSegment *
                                                                      *)
                                                    _DtCvAddPtrToArray(
                                                        (void **)
                                                            _DtCvCellsOfTableSeg(
...
static _DtCvSegment *FindSnbEntry(_DtCvSegment *snb, char *target) {
        ...
        if (NULL != snb) {
                ...
                while (NULL != retEntry) {
                        ...
                        if (NULL != id &&
                            _DtCvStrCaseCmpLatin1(target, id) == 0)
                                return retEntry;
...
static void CompressLinkSeg(_DtCvSegment *p_seg) {
        ...
        if (_DtCvIsSegString(p_seg)) {
                 ...
                 */
                if (NULL == _DtCvNextDisp(p_seg) &&
                    1 <= _DtCvStrLen(pChar, wcFlag))
                        return;
                ...
                if ((_DtCvIsSegWideChar(p_seg) && ' ' == *((wchar_t *)pChar)) ||
                    (_DtCvIsSegRegChar(p_seg) && ' ' == *((char *)pChar))) {
                         ...
                         *
                         * is this a single byte string? If so, use strcpy to
                         * move the string.
                         */
                ...
                while (option != NULL && option->string != NULL &&
                       (check == True || cmpFnd == False)) {
                         ...
                         */
                                 ...
                                 lowerChar ==
                                     _DtHelpCeToLower(*(option->string)) &&
                                 _DtCvStrCaseCmpLatin1(option->string, attr) ==
                                     0) {
                                cmpFnd = True;
...
static int TestLookAhead(FormatStruct *my_struct, enum SdlElement token_value,
        ...
        if (my_struct->parsed == token_value &&
            my_struct->end_flag == end_flag) {
                if (remove_flag == True) {
...
static int MatchSDLElement(FormatStruct *my_struct, const char *sdl_string,
        ...
        return (_DtHelpCeMatchSdlElement(my_struct->my_file, sdl_string,
                                         sig_chars));
}
                            ...
                            SDLIsAttrSet(*element_info,
                                ...
                                if (pAttr->data_type == SdlAttrDataTypeNumber) {
                                        ...
                                        *numPtr1 = ((SDLNumber)atoi(
                                        ...
                                        if ((attr_list->sdl_attr_define &
                                             SDL_ATTR_CLASS & ~(VALUE_MASK)) &&
                                            ElInfoClan(element_info) != defNum)
                                                SetAttributeFlag(
                                                    element_info,
                                                    attr_list->sdl_attr_define);
                                        *enumPtr1 = defNum;
                                } else if (SDLIsString1(
                                               pAttr->sdl_attr_define) ||
                                           SDLIsString2(
                                               pAttr->sdl_attr_define)) {
                                        strPtr1 = (char **)varOffset1;
                                        *strPtr1 =
                                            (char *)attr_list->def_string;
                                }
                        }
                }
                attr_list++;
...
static int ProcessSDLAttribute(FormatStruct *my_struct, _DtCvSegment *p_seg,
        ...
        if (pAttr->data_type != SdlAttrDataTypeInvalid) {
                ...
                case SdlAttrDataTypeId:
                        result =
                            _DtHelpCeGetSdlId(my_struct->my_file, &attrValue);
                        break;

                case SdlAttrDataTypeNumber:
                        result =
                            _DtHelpCeGetSdlNumber(my_struct->my_file, numBuf);
                        break;

                case SdlAttrDataTypeCdata:
                        result = _DtHelpCeGetSdlAttributeCdata(
                            my_struct->my_file, False, &attrValue);
                        break;
                ...
                case SdlAttrDataTypeFont:
                        ...
                        if (result != -1)
                                result =
                                    CheckFontList(attr_list->sdl_attr_define,
                                                  attrValue, &fontNum);
                        break;
                ...
                case SdlAttrDataTypeEnum:
                        result = _DtHelpCeGetSdlAttributeCdata(
                            my_struct->my_file, False, &attrValue);
                        if (result != -1)
                                result = CheckOptionList(
                                    attr_list->sdl_attr_define, attrValue,
                                    False, SdlOptionBad, &attrNum);
                        break;
                ...
                if (result == 0) {
                        if (pAttr->struct_type != SdlIgnore) {
                                ...
                                if (pAttr->struct_type == SdlFontSpecific)
                                        ...
                                        fprintf(
                                            stderr,
                                            "DtHelp: couldn't determine which "
                                            "structure the "
                                            "information goes in, aborting");
                                        exit(1);
                                }
...
static void MergeTossInfo(FormatStruct *my_struct, _DtCvSegment *cur_contain,
        ...
        tossSeg =
            _DtHelpCeMatchSemanticStyle(my_struct->toss, ElClan(my_struct),
                ...
                if (element.formatting) {
                        ...
                        if (element.sdl_element == SdlElementHead ||
                            SdlElementSubHead == element.sdl_element)
                                segPtr->type =
                                    _DtCvSetTypeToController(segPtr->type);
...
static int ParseElementAttr(FormatStruct *my_struct,
        ...
        InitAttributes(mySeg, my_struct->my_fonts, &(my_struct->el_info),
                       attribs);
        ...
        /*
         * force the default of subheading orientation to heads as below the
         * head.
         */
        ...
        do {
                result = _DtHelpCeGetSdlAttribute(
                    my_struct->my_file, MAX_ATTRIBUTE_LENGTH, attribName);
                if (result == 0)
                        result = ProcessSDLAttribute(
                            my_struct, mySeg, my_struct->my_fonts,
        ...
        if (result != -1) {
                ...
                if (NULL != mySeg && _DtCvIsSegContainer(mySeg)) {
                         ...
                         */
                        if (_DtCvBORDER_NONE !=
                            _DtCvContainerBorderOfSeg(mySeg))
...
static int ParseElementEnd(FormatStruct *my_struct, _DtCvSegment *if_prev,
        ...
        if (MatchSDLElement(my_struct, element.element_end_str,
                            element.sdl_element, element.end_sig_chars,
                            True) != 0 ||
            (end_flag == False &&
        ...
        if (process_flag == True) {
                ...
                if (_SdlFontModeResolve != my_struct->resolve_font &&
                    (SDLIsAttrSet(my_struct->el_info, SDL_ATTR_CLASS) ||
                     ...
                     SDLIsAttrSet(my_struct->el_info, SDL_ATTR_LEVEL))) {
                         ...
                         * around the segment list so the correct font
                         * inheritance occurs. Later, this special segment will
                         * have to be stripped out when the async blocks or
                         * snref item is resolved.
                         */
                        if (NULL == pElement) {
                                if (_DtHelpCeAllocSegment(1, NULL, NULL,
                                                          &pElement) != 0)
                                        return -1;

                                pElement->type =
                                    _DtCvSetTypeToContainer(pElement->type);
                                pElement->type = SetSdlWrapper(pElement->type);
                                _DtCvContainerListOfSeg(pElement) =
                                    my_struct->seg_list;
                                my_struct->seg_list = pElement;
                        }

                        /*
                         * has match data already been allocated for this
                         * element?
                         */
                        match = SegMatchDataPtr(pElement);
                        if (NULL == match) {
                                match = (SdlMatchData *)malloc(
                                    sizeof(SdlMatchData));
                                if (NULL == match)
                                        return -1;
                        }
                 ...
                 * If not, can it (the element) be eleminated and free up
                 * memory?
                 */
                if (NULL != pElement && my_struct->seg_list == NULL &&
                    element.elim_flag == True &&
                    ElType(my_struct) != SdlElementKey &&
                    TMarginOfSeg(pElement) == 0 &&
                    BMarginOfSeg(pElement) == 0) {
                        ...
                        case SdlElementHead:
                        case SdlElementSubHead:
                                if (SDLIsAttrSet(my_struct->el_info,
                                                 SDL_ATTR_ABBREV) &&
                                    ElAbbrev(my_struct) != NULL &&
                                    strlen(ElAbbrev(my_struct))) {
                                        AbbrevOfSeg(my_struct->add_seg) =
                                            (void *)ElAbbrev(my_struct);
                                        ClearAttrFlag(my_struct->el_info,
                                                      SDL_ATTR_ABBREV);
                                }
                                break;

                        case SdlElementFdata:
                                ElTableList(my_struct) =
                                    ConvertToList(my_struct->seg_list);
                                break;
                        ...
                        case SdlElementForm:
                                ...
                                /*
                                 * add the table segment to the form's container
                                 * list taking into account any heads for the
                                 * form.
                                 */
                                _DtCvNextSeg(newSeg) =
                                    _DtCvContainerListOfSeg(pElement);
                        ...
                        case SdlElementSnRef:
                                ...
                                if (newSeg != pElement) {
                                        /*
                                         * remember the segment list that we
                                         * want to free. This includes the
                                         * snref.
                                         */
                                        segList = pElement;

                                        /*
                                         * if this <snref> had an id with it,
                                         * then expand the <snref> to a marker
                                         * segment (with the id) and a resolved
                                         * refitem.
                                         *
                                        ...
                                        if (NULL != id) {
                                                /*
                                                 * remember the segment list of
                                                 * the container. Since we are
                                                 * re-using the snref segment,
                                                 * we want to eliminate just the
                                                 * refitems of the snref and not
                                                 * the actual snref.
                                                 */
                                                segList =
                                                    _DtCvContainerListOfSeg(
                                                ...
                                                /*
                                                 * Move the refitem to be a
                                                 * sibling of the container.
                                                 */
                                                _DtCvNextSeg(pElement) = newSeg;

                                                /*
                                                 * transfer the container id to
                                                 * a marker id and change the
                                                 * container into a marker.
                                                 */
                                                _DtCvIdOfMarkerSeg(pElement) =
                                                    _DtCvContainerIdOfSeg(
                                                        pElement);
                                                pElement->type =
                                                    _DtCvSetTypeToMarker(
                                                        pElement->type);
                                                newSeg = pElement;
                                        }
...
static int FindAndFix(FormatStruct *my_struct) {
        ...
        if (0 < my_struct->snref_cnt) {
                ...
                while (my_struct->snref_cnt) {
                         ...
                         */
                        _DtHelpFreeSegments(_DtCvContainerListOfSeg(snref->seg),
                                            _DtCvFALSE,
                                            my_struct->ui_info->destroy_region,
                                            my_struct->ui_info->client_data);

                        /*
                         * find the end of the new segment's and have it point
                         * to the next segments that the old segment points to.
                         */
                        if (NULL != newSeg) {
                                tmpSeg = newSeg;
                                ...
                                _DtCvNextDisp(tmpSeg) =
                                    _DtCvNextDisp(snref->seg);
                        }
                        ...
                        if (NULL != snref->id) {
                                /*
                                 * re-use the old snref, turning it into a
                                 * marker
                                 */
                                _DtCvIdOfMarkerSeg(snref->seg) = snref->id;
                                snref->seg->type =
                                    _DtCvSetTypeToMarker(snref->seg->type);
                        ...
                        /*
                         * else move the resolved segment on top of the old
                         * snref.
                         */
                        else if (NULL != newSeg) {
                                /*
                                 * free the private information. No longer
                                 * needed.
                                 */
                        ...
                        /*
                         * else there was no resolution, leave this segment as a
                         * NOOP.
                         */
...
static int CheckForSnb(FormatStruct *my_struct, SDLMask *element_types,
        ...
        if (my_struct->snref_used == True) {
                ...
                result =
                    ProcessSDLMarkup(my_struct, SdlElementSnb, SdlElementNone,
                ...
                if (pSeg != NULL && _DtCvIsSegString(pSeg) &&
                    _DtCvIsSegRegChar(pSeg) && !(_DtCvIsSegNewLine(pSeg))) {
                        ...
                        strPtr = (char *)_DtCvStrPtr(
                            _DtCvStringOfStringSeg(pSeg), 0, len);
                        *strPtr++ = ' ';
                        *strPtr = '\0';
...
static int RegisterLink(FormatStruct *my_struct, SDLMask *element_types,
        ...
        my_struct->cur_link =
            _DtLinkDbAddLink(my_struct->my_links, NULL, rid,
...
static int ResolveIf(FormatStruct *my_struct, _DtCvSegment *prev_data) {
        ...
        if (_DtCvRunInterp(my_struct->ui_info->exec_filter,
                ...
                if (atoi(ifData) != 0) {
                        ...
                        if (elseSeg != NULL) {
                                /*
                                 * if the next displayable segment is in the
                                 * 'else' list, null out the next displayable
                                 * segement since there isn't anything in the
                                 * 'then' list.
                                 */
                                if (my_struct->then_prev ==
                                    my_struct->else_prev)
                                        nextDisp = NULL;
                                else
                                        /*
                                         * terminate the displayable segment
                                         * list before the 'else' list.
                                         */
            ...
            SDLSearchMask(element_types, my_struct->parsed) == True) {
                ...
                if (my_struct->parsed != SdlElementCdata ||
                    SDLSearchMask(element_types, SdlPcDataFollows) == False)
                        result =
                            ParseSDL(my_struct, my_struct->parsed, sig_element,
                                     exceptions, process_mask);
...
static int ZeroToN(FormatStruct *my_struct, SDLMask *element_types,
        ...
        while (result == 0 && !done) {
                ...
                if (result == 0 && my_struct->end_flag == False &&
                    SDLSearchMask(element_types, my_struct->parsed) == True) {
                        /*
                         * check to make sure this is *not* Cdata or if it is
                         * that the PcDataFollows flag is *not* set.
                         */
                        if (my_struct->parsed != SdlElementCdata ||
                            SDLSearchMask(element_types, SdlPcDataFollows) ==
                                False)
                                result = ParseSDL(my_struct, my_struct->parsed,
                                                  sig_element, exceptions,
                                                  process_mask);
                        else
                                done = True;
                } else {
 ...
 *
 ******************************************************************************/
static int Cdata(FormatStruct *my_struct, SDLMask *cur_element,
                 enum SdlElement sig_element, SDLMask *exceptions,
                 SDLMask *process_mask) {
        int i;
        int reason;
                ...
                while (string[i] != '\0' && i < myLen) {
                        ...
                        if (curLen == 1) {
                                ...
                                if (string[i] == '&') {
                                        ...
                                        /*
                                         * is this an SGML numeric character
                                         * reference entity?  if so, it should
                                         * have the format
                                         * '&#d[d[d]][;]' where 'ddd' represent
                                         * characters of '0' to '9'.  The
                                         * semi-colon is required iff the next
                                         * character is a numeric character of
                                         * '0' to '9'.  Otherwise it is
                                         * optional.
                                         */
                                        if (string[i] == '#') {
                                                int j;
...
#define ESC_STRING_LEN 4
                                                ...
                                                /*
                                                 * Is there enough to room to
                                                 * process three digits and a
                                                 * possible semi-colon?
                                                 */
                                                if (myLen - i <
                                                    ESC_STRING_LEN) {
                                                ...
                                                /*
                                                 * now make sure that the entire
                                                 * numeric entity exists in the
                                                 * string.
                                                 */
                                                j = i;
                                                while ('0' <= string[i] &&
                                                ...
                                                /*
                                                 * run into the end of string
                                                 * before running into a
                                                 * delimiter? Fill out the
                                                 * escaped numeric character.
                                                 */
                                                if (string[i] == '\0') {
                                                        do {
                                                                string[i] = BufFileGet(
                                        ...
                                        if (string[i] == '\n') {
                                                if (ProcessString(
                                                        my_struct, True, True,
                                                        True, True, processFlag,
                                                        string, saveLen,
                                                        &i) != 0)
                                                        return -1;
                                        } else if (string[i] == ' ') {
                                                if (ProcessNonBreakChar(
                                                        my_struct, processFlag,
                                                        spaceStr, string,
                                                        saveLen, &i) != 0)
                                                        return -1;
                                        } else if (string[i] == '-') {
                                        ...
                                        if (type == SdlTypeCdata)
                                                i++;
                                                 ...
                                                 type ==
                                                     SdlTypeUnlinedLiteral) {
                                                if (my_struct->last_was_space ==
                                                    False)
                                ...
                                if (my_struct->last_was_nl == True) {
                                        if (nlToSpace == True ||
                                            my_struct->last_was_mb == False) {
                                                if (MoveString(&string, &myLen,
                                                               &i) == -1)
                                                        return -1;

                                                string[i++] = ' ';
                                        } else /* the last was a multibyte
                                                  character, tighten up */
                                        {
                                                i--;
                                                strmove(&string[i],
                                                        &string[i + 1]);
        ...
        do {
                ...
                if (string != NULL && *string != '\0') {
                         ...
                         */
                        if (1 == reason &&
                            (SdlTypeLiteral == type || SdlTypeLined == type)) {
                                my_struct->last_was_space = True;
                                my_struct->last_was_nl = False;
                        }
                ...
                if (2 == reason && True == processFlag) {
                         ...
                         */
                        my_struct->flags =
                            _DtCvSetTypeToNonBreak(my_struct->flags);
                        if (MySaveString(&(my_struct->seg_list), my_struct,
                                         string, my_struct->cur_link, saveLen,
                                         False) != 0) {
                                MyFree(string);
                        ...
                        /*
                         * indicate that the non-breaking character is
 ...
 *
 ******************************************************************************/
static int ProcessEnterAttr(FormatStruct *my_struct, SDLMask *cur_element,
                            enum SdlElement sig_element, SDLMask *exceptions,
                            SDLMask *process_mask) {
        /*
 ...
 *
 ******************************************************************************/
static int ProcessExitAttr(FormatStruct *my_struct, SDLMask *cur_element,
                           enum SdlElement sig_element, SDLMask *exceptions,
                           SDLMask *process_mask) {
        /*
 ...
 *
 ******************************************************************************/
static int FakeEnd(FormatStruct *my_struct, SDLMask *cur_element,
                   enum SdlElement sig_element, SDLMask *exceptions,
                   SDLMask *process_mask) {
 ...
 *
 ******************************************************************************/
static int AddRowToTable(FormatStruct *my_struct, SDLMask *cur_element,
                         enum SdlElement sig_element, SDLMask *exceptions,
                         SDLMask *process_mask) {
 ...
 *
 ******************************************************************************/
static int SaveLangCharSet(FormatStruct *my_struct, SDLMask *cur_element,
                           enum SdlElement sig_element, SDLMask *exceptions,
                           SDLMask *process_mask) {
        char **info;
 ...
 *
 ******************************************************************************/
static int CopyDocInfo(FormatStruct *my_struct, SDLMask *cur_element,
                       enum SdlElement sig_element, SDLMask *exceptions,
                       SDLMask *process_mask) {
        SDLDocInfo *docInfo;
 ...
 *
 ******************************************************************************/
static int CopyAnchorId(FormatStruct *my_struct, SDLMask *cur_element,
                        enum SdlElement sig_element, SDLMask *exceptions,
                        SDLMask *process_mask) {
 ...
 *
 ******************************************************************************/
static int LoadGraphic(FormatStruct *my_struct, SDLMask *cur_element,
                       enum SdlElement sig_element, SDLMask *exceptions,
                       SDLMask *process_mask) {
        int result = 0;
        ...
        if (SDLSearchMask(process_mask, SdlElementGraphic) != False) {
                ...
                if (_DtHelpCeAllocSegment(1, NULL, NULL, &cvRegion) == 0) {
                        /*
                         * got memory for a region, now fill out the
                         * information.
                         *
                        ...
                        if (NULL != my_struct->ui_info->load_graphic &&
                            (*(my_struct->ui_info->load_graphic))(
                                my_struct->ui_info->client_data,
                                my_struct->vol_name, my_struct->id_string,
                                ElSnbXid(my_struct), ElSnbFormat(my_struct),
                                 ...
                                 */
                                cvRegion->type =
                                    _DtCvSetTypeToRegion(cvRegion->type);
 ...
 *
 ******************************************************************************/
static int ColInfoToTableInfo(FormatStruct *my_struct, SDLMask *cur_element,
                              enum SdlElement sig_element, SDLMask *exceptions,
                              SDLMask *process_mask) {
        if (SDLSearchMask(process_mask, SdlElementForm) != False) {
                ...
                colJust =
                    (_DtCvFrmtOption *)malloc(sizeof(_DtCvFrmtOption) * mySize);
 ...
 *
 ******************************************************************************/
static int CopyIdInfo(FormatStruct *my_struct, SDLMask *cur_element,
                      enum SdlElement sig_element, SDLMask *exceptions,
                      SDLMask *process_mask) {
        SDLIdInfo *idInfo;
 ...
 *
 ******************************************************************************/
static int RegisterSnbLink(FormatStruct *my_struct, SDLMask *cur_element,
                           enum SdlElement sig_element, SDLMask *exceptions,
                           SDLMask *process_mask) {
        int linkType;
        int len = 0;
        ...
        if (0 > _DtLinkDbAddLink(my_struct->my_links,
                                 ...
                                 fileSpec, linkType, _DtCvWindowHint_Original,
                                 NULL))
                return -1;
 ...
 *
 ******************************************************************************/
static int RegisterSwitch(FormatStruct *my_struct, SDLMask *cur_element,
                          enum SdlElement sig_element, SDLMask *exceptions,
                          SDLMask *process_mask) {
        int result = -1;
        char *interpStr;
 ...
 *
 ******************************************************************************/
static int ResolveSpcInfo(FormatStruct *my_struct, SDLMask *cur_element,
                          enum SdlElement sig_element, SDLMask *exceptions,
                          SDLMask *process_mask) {
        _DtCvSegment *mySeg = my_struct->add_seg;
        ...
        if (SDLSearchMask(process_mask, ElType(my_struct)) != False) {
                ...
                if (_SdlFontModeResolve == my_struct->resolve_font)
                        (*(my_struct->ui_info->resolve_spc))(
                            my_struct->ui_info->client_data,
                            ElLanguage(my_struct), ElCharSet(my_struct),
                            *(my_struct->my_fonts), ElSpcName(my_struct),
                         ...
                         */
                        pReg =
                            (_DtHelpDARegion *)malloc(sizeof(_DtHelpDARegion));
                        if (NULL == pReg)
                                return -1;

                        /*
                         * malloc the structure to hold the information needed
                         * to create the spc later.
                         */
                        spcInfo = (_DtHelpDASpcInfo *)calloc(
                            1, sizeof(_DtHelpDASpcInfo));
                        if (NULL == spcInfo) {
                                free(pReg);
                                return -1;
                        }
                        ...
                        if (_SdlFontModeSave == my_struct->resolve_font) {
                                ...
                                if (-1 ==
                                    _DtHelpDupFontHints(&(spcInfo->spc_fonts)))
                                        return -1;
                        }
 ...
 *
 ******************************************************************************/
static int CopyTossInfo(FormatStruct *my_struct, SDLMask *cur_element,
                        enum SdlElement sig_element, SDLMask *exceptions,
                        SDLMask *process_mask) {
 ...
 *
 ******************************************************************************/
static int CopyEntryInfo(FormatStruct *my_struct, SDLMask *cur_element,
                         enum SdlElement sig_element, SDLMask *exceptions,
                         SDLMask *process_mask) {
 ...
 *
 ******************************************************************************/
static int InitLast(FormatStruct *my_struct, SDLMask *cur_element,
                    enum SdlElement sig_element, SDLMask *exceptions,
                    SDLMask *process_mask) {
        /*
 ...
 *
 ******************************************************************************/
static int SetTransit(FormatStruct *my_struct, SDLMask *cur_element,
                      enum SdlElement sig_element, SDLMask *exceptions,
                      SDLMask *process_mask) {
        if (ElTiming(my_struct) == SdlTimingAsync)
                my_struct->resolve_font = _SdlFontModeNone;
...
static int ParseSDL(FormatStruct *my_struct, enum SdlElement cur_element,
         ...
         */
        while (i < MaxSDLElements &&
               SdlElementList[i].sdl_element != cur_element)
                i++;
         ...
         */
        if (cur_element != SdlElementCdata) {
                if (ParseElementStart(my_struct, SdlElementList[i],
                                      processFlag) != 0 ||
                    ParseElementAttr(
                        my_struct, cur_element, SdlElementList[i].attrib_list,
        ...
        while (result == 0 && content != NULL &&
               SDLSearchMask(content->mask, SdlElementNone) == False) {
                result =
                    (*(content->model))(my_struct, content->mask, sig_element,
        ...
        if (cur_element != SdlElementCdata) {
                if (result == 0 && SdlElementList[i].element_end_str != NULL)
                        ...
                        if (SdlElementList[i].new_fonts &&
                            FreeFontInfo(my_struct) == -1)
                                result = -1;
                }
                ...
                if (result == 0 && my_struct->add_seg != NULL)
                        _DtHelpCeAddSegToList(my_struct->add_seg,
                                              &(my_struct->seg_list),
                                              &(my_struct->last_seg));
...
static int FormatSDLTitle(char *filename, int offset, int fd,
        ...
        */
        ...
        if (result != -1) {
                result =
                    ProcessSDLMarkup(my_struct, SdlElementTitle, SdlElementNone,
                                     startExcept, processMask);
                _DtHelpCeBufFileClose(my_struct->my_file,
                                      (fd == -1 ? True : False));
        }
        ...
        while (segments != NULL) {
                if (!(_DtCvIsSegContainer(segments))) {
                        if (_DtCvIsSegHyperText(segments)) {
                                _DtLinkDbRemoveLink(link_data,
                                                    segments->link_idx);
                                segments->type = ClearSegLinks(segments);
                        }

                        segments->type =
                            _DtCvSetTypeToGhostLink(segments->type);
                        segments->link_idx = link_idx;
                } else /* if (_DtCvIsSegContainer(segments)) */
                        SetGhostLink(link_data,
                                     _DtCvContainerListOfSeg(segments),
                                     link_idx);
        ...
        while (p_seg != NULL) {
                ...
                if (_DtCvIsSegString(p_seg)) {
                        ...
                        if (_DtCvIsSegWideChar(p_seg))
                                ...
                                strlcpy(&((*ret_string)[len]),
                                        _DtCvStringOfStringSeg(p_seg), newLen);

                        *nl_flag = False;
                        if (p_seg->next_disp == NULL)
                                *nl_flag = True;
                } else if (_DtCvIsSegContainer(p_seg) &&
                           !(_DtCvIsSegController(p_seg)))
                        CreateAsciiString(_DtCvContainerListOfSeg(p_seg), snb,
                                          nl_flag, ret_string);
...
static void CleanUpToc(FormatStruct *my_struct, _DtCvSegment *p_seg, int level,
        ...
        while (p_seg != NULL) {
                ...
                if (_DtCvIsSegContainer(p_seg)) {
                        ...
                        _DtCvContainerOrientOfSeg(p_seg) =
                        ...
                        _DtHelpFontPtrWeight(font_specs) =
                        ...
                        int result;
                        _DtHelpDARegion *pReg =
                            (_DtHelpDARegion *)_DtCvInfoOfRegionSeg(p_seg);

                        if (_DtHelpDASpc == pReg->type) {
                                _DtHelpDASpcInfo *pSpc =
                                    (_DtHelpDASpcInfo *)pReg->handle;
        ...
        if (result != -1) {
                ...
                if (headEl == NULL) {
                        ...
                        if (MySaveString(&(addSeg), my_struct,
                                         _DtCvContainerIdOfSeg(info_seg), -1,
                                         my_struct->mb_len, False) != 0) {
                                /*
                                 * free the segments
                                 */
                                _DtHelpFreeSegments(
                                    my_struct->seg_list, _DtCvTRUE,
                                    my_struct->ui_info->destroy_region,
                                    my_struct->ui_info->client_data);
                                my_struct->seg_list = NULL;
                        ...
                        if (NULL != my_struct->seg_list) {
                                ...
                                /*
                                 * set the container flag and initialize its
                                 * formatting information to the default.
                                 */
                                my_struct->seg_list->type =
                                    _DtCvSetTypeToContainer(
                                        my_struct->seg_list->type);
                                _DtCvContainerOfSeg(my_struct->seg_list) =
                                    DefFrmtSpecs;
                                _DtCvContainerLeadingOfSeg(
                                    my_struct->seg_list) =
                                    my_struct->ui_info->leading;
                        }
                 ...
                 */
                        ...
                        if (MySaveString(&(_DtCvContainerListOfSeg(headEl)),
                                         my_struct, myPtr, -1,
                                         my_struct->mb_len, False) != 0) {
                                /*
                                 * free the segments
                 ...
                 * first make sure that the segment list is not the head
                 * already.
                 */
                if (headEl != my_struct->seg_list) {
                        ...
                        if (prevSeg != headEl) {
                                /*
                                 * search for the previous segment before the
                                 * head.
                                 */
                        ...
                        /*
                         * free the segments before the head and virpage
                         * container.
                         */
...
static int ExpandToc(FormatStruct *my_struct, _DtHelpVolumeHdl volume, int fd,
         ...
         */
        while ((*id_seg) != NULL &&
               _SdlSegToSdlIdInfoType(*id_seg) != SdlIdVirpage &&
        ...
        while ((*id_seg) != NULL && done == False && result == 0) {
                ...
                if (_SdlSegToSdlIdInfoType(pEl) == SdlIdVirpage) {
                        if (segLev == level) {
                                /*
                                 * If the virpage in the path list has not been
                                 * found, test the next virpage. Otherwise skip.
                                 */
                                if (found == False && *path_list != NULL &&
                                    _DtCvContainerIdOfSeg(pEl) != NULL)
                                        tst = _DtCvStrCaseCmpLatin1(
                                            *path_list,
                                            _DtCvContainerIdOfSeg(pEl));

                                /*
                                 * the only time tst == 0 is when the next item
                                 * in the path_list matches this element. Check
                                 * to see if the next item in the path_list is
                                 * null. If so, that means this is the location
                                 * the user has desired.
                                 */
                                result = AddEntryToToc(
                                    my_struct, volume, fd, segLev, lang,
                                    char_set, toss, pEl,
                                    (tst == 0 && path_list[1] == NULL ? True
                                                                      : False),
                                    ret_snb, seg_list, prev_list);

                                /*
                                 * increment the segment pointer to the next
                                 * item
                                 */
                                *id_seg = _DtCvNextSeg((*id_seg));

                                /*
                                 * The only time tst is zero is if the current
                                 * virpage matches the next item in the list.
                                 * Expand it's children. and set tst to non-zero
                                 * so that AddEntryToToc does not special case
                                 * the siblings following this one.
                                 */
                                if (tst == 0) {
                                        result = ExpandToc(
                                            my_struct, volume, fd, lang,
                                            char_set, toss, segLev + 1,
                                            &path_list[1], id_seg, ret_snb,
                                            seg_list, prev_list);
                                        found = True;
                                        tst = 1;
                                }
 ...
 *
 ******************************************************************************/
static int CreateTitleChunks(_DtCvSegment *toss, _DtCvSegment *p_seg,
                             _DtCvSegment *snb, SDLMask *stop_mask,
                             const char *lang, const char *char_set,
                             _DtCvValue (*resolve_spc)(),
                             _DtCvPointer client_data, int *ret_cnt,
                             void ***ret_chunks) {
        long type;
        int cnt;
        int result = 0;
        ...
        while (result != -1 && p_seg != NULL) {
                ...
                if (_DtCvIsSegString(p_seg)) {
                        ...
                        *ret_cnt = *ret_cnt + 3;
                        if (*ret_chunks == NULL)
                                *ret_chunks = (void **)malloc(sizeof(void *) *
                                                              (*ret_cnt));
                        else
                                *ret_chunks = (void **)realloc(
                                    *ret_chunks, sizeof(void *) * (*ret_cnt));
                        if (*ret_chunks == NULL)
                                return -1;
                        ...
                        if (_DtCvIsSegWideChar(p_seg)) {
                                int len =
                                    _DtCvStrLen(_DtCvStringOfStringSeg(p_seg),
                                                1) *
                                        MB_CUR_MAX +
                                    1;
                                ...
                                if (NULL != ptr)
                                        wcstombs(
                                            (char *)ptr,
                                            (wchar_t *)_DtCvStringOfStringSeg(
                                                p_seg),
                                            len);
                        } else
                        ...
                        if (_DtHelpDASpc == daRegion->type) {
                                if (False == daRegion->inited) {
                                        ...
                                        result = (*(resolve_spc))(
                                            client_data,
                                            _DtHelpFontHintsLang(
                                                pSpc->spc_fonts),
                                            _DtHelpFontHintsCharSet(
                                                pSpc->spc_fonts),
                                            pSpc->spc_fonts, pSpc->name,
                                            &(_DtCvInfoOfRegionSeg(p_seg)),
                                            &(_DtCvWidthOfRegionSeg(p_seg)),
                        ...
                        result = 0;
                           ...
                           !(_DtCvIsSegController(p_seg)))
                        result = CreateTitleChunks(
                            toss, _DtCvContainerListOfSeg(p_seg), snb,
                            stop_mask, myLang, mySet, resolve_spc, client_data,
                            ret_cnt, ret_chunks);
 ...
 *
 ******************************************************************************/
static int ProcessSegmentsToChunks(_DtCvSegment *toss, _DtCvSegment *head_el,
                                   _DtCvSegment *snb_el, SDLMask *stop_mask,
                                   const char *lang, const char *char_set,
                                   _DtCvValue (*resolve_spc)(),
        ...
        result = CreateTitleChunks(toss, _DtCvContainerListOfSeg(head_el),
                                   ...
                                   resolve_spc, client_data, &cnt, ret_chunks);
...
static int GetDocumentTitle(_DtHelpVolumeHdl volume, _FrmtUiInfo *ui_info,
        ...
        if (sdlVol->title_processed == False) {
                ...
                if (SetUp(volume, NULL, &frmtStruct, toss, ui_info, -1, True,
                          False) != 0)
                        return -1;
                 ...
                 * now get the title.
                 */
                if (_DtHelpCeFileOpenAndSeek(_DtHelpCeGetVolumeName(volume), 0,
                                             -1, &(frmtStruct.my_file),
                                             NULL) != -1) {
                        if (ProcessContent(&frmtStruct, SDLDocumentContent,
                                           SdlElementNone, startExcept,
                                           skipMask) != -1 &&
                            ...
                            ProcessContent(&frmtStruct, HeadAndSnb,
                                ...
                                _DtHelpFreeSegments(frmtStruct.seg_list,
                                                    _DtCvFALSE,
                                                    ui_info->destroy_region,
                                                    ui_info->client_data);
...
int _DtHelpCeFrmtSdlPathAndChildren(_DtHelpVolumeHdl volume,
        ...
        *ret_handle = NULL;
        ...
        if (_SdlIdInfoPtrRlevel(info) > 0) {
                ...
                result = AddEntryToToc(
                    &frmtStruct, volume, fd, _SdlIdInfoPtrRlevel(info), lang,
                    charSet, _DtHelpCeGetSdlVolToss(volume, fd), loids,
                    (topicMap[1] == NULL ? True : False), &snb, &mySegList,
                    &myPrevSeg);
                /*
                 * format the children.
                 */
                if (result != -1 && _DtCvNextSeg(loids) != NULL) {
                        ...
                        result = ExpandToc(
                            &frmtStruct, volume, fd, lang, charSet,
...
int _DtHelpCeFrmtSdlVolumeInfo(char *filename, _DtHelpVolumeHdl volume,
        ...
        if (SetUp(volume, &sdlVol, &frmtStruct, NULL, &DefUiInfo, -1, True,
                  False) != 0)
                return -1;
        ...
        if (result == 0) {
                result = _DtHelpCeFileOpenAndSeek(
                    filename, 0, -1, &(frmtStruct.my_file), ret_time);
                if (result != -1) {
                ...
                if (result != -1) {
                         ...
                         */
                        sdlVol->sdl_info =
                            (SDLDocInfo *)FrmtPrivInfoPtr(frmtStruct.seg_list)
                                ->doc_info;
...
int _DtHelpCeFrmtSDLTitleToAscii(_DtHelpVolumeHdl volume, int offset,
        ...
        if (SetUp(volume, NULL, &frmtStruct, NULL, &DefUiInfo, -1, True,
                  False) != 0)
                return -1;
        ...
        *ret_title = NULL;
        ...
        if (frmtStruct.seg_list != NULL)
                _DtHelpFreeSegments(frmtStruct.seg_list, _DtCvFALSE, NULL,
                                    NULL);
...
char *_DtHelpCeFrmtSdlVolumeAbstractToAscii(_DtHelpVolumeHdl volume) {
        ...
        if (_DtHelpCeFindSdlId(volume, "_abstract", lockInfo.fd, NULL,
                               &offset) == True) {
                int result = 0;
                SDLMask startExcept[SDL_MASK_LEN] = SDLInitMask(SdlElementNone);
                SDLMask processMask[SDL_MASK_LEN] = SDLSetAllBits;
                 ...
                 */
                result = _DtHelpCeFileOpenAndSeek(
                    _DtHelpCeGetVolumeName(volume), offset, lockInfo.fd,
                    &(frmtStruct.my_file), NULL);
                if (result != -1) {
                        result = ProcessSDLMarkup(
                            &frmtStruct, SdlElementVirpage, SdlElementNone,
                            startExcept, processMask);
                ...
                if (result != -1) {
                        ...
                        _DtHelpFreeSegments(frmtStruct.seg_list, _DtCvFALSE,
                                            NULL, NULL);
                        _DtHelpFreeSegments(frmtStruct.snb, _DtCvFALSE, NULL,
                                            NULL);
                }
...
int _DtHelpCeFrmtSDLVolTitleToAscii(_DtHelpVolumeHdl volume,
        ...
        *ret_title = NULL;
        ...
        result = GetDocumentTitle(volume, ui_info, _SdlFontModeNone, False,
                                  &pHeadSeg);
        _DtHelpCeUnlockVolume(lockInfo);
        ...
        if (result == 0) {
                ...
                /*
                 * if there wasn't an abbreviation, use the head itself,
                 * stripping all special items and graphics.
                 */
        ...
        if (-2 == result) {
                ...
                if (_DtHelpGetTopicTitle(volume, "_title", ret_title) != 0)
                        result = _DtHelpGetTopicTitle(volume, "_hometopic",
                                                      ret_title);
        }
...
int _DtHelpCeGetSdlTitleChunks(_DtHelpVolumeHdl volume, char *loc_id,
        ...
        *ret_chunks = NULL;
        ...
        if (SetUp(volume, &sdlVol, &frmtStruct, NULL, ui_info, -1, True,
                  True) != 0)
                return -1;
                ...
                if (NULL != headEl && _DtCvIsSegContainer(headEl) &&
                    _DtCvIsSegController(headEl)) {
                        result = ProcessSegmentsToChunks(
                            ...
                            ui_info->resolve_spc, ui_info->client_data,
                            ret_chunks);
                }
        } else
                result = -1;
...
int _DtHelpCeGetSdlVolTitleChunks(_DtHelpVolumeHdl volume_handle,
        ...
        if (result != 0) {
                result = _DtHelpCeGetSdlTitleChunks(volume_handle, "_title",
                                                    ui_info, ret_chunks);
                if (result != 0)
                        result = _DtHelpCeGetSdlTitleChunks(
                            volume_handle, "_hometopic", ui_info, ret_chunks);
        }
...
_DtCvSegment *_DtHelpCeGetSdlVolToss(_DtHelpVolumeHdl volume, int fd) {
        ...
        if (sdlVol->toss == NULL &&
            SetUp(volume, NULL, &frmtStruct, NULL, &DefUiInfo, fd, True,
                  False) == 0 &&
...
int _DtHelpCeGetSdlVolIds(_DtHelpVolumeHdl volume, int fd,
        ...
        *ret_ids = NULL;
        ...
        if (sdlVol->loids == NULL) {
                result = -1;
                if (SetUp(NULL, NULL, &frmtStruct, NULL, &DefUiInfo, -1, False,
                          False) != -1 &&
                    _DtHelpCeFileOpenAndSeek(_DtHelpCeGetVolumeName(volume), 0,
                                             fd, &(frmtStruct.my_file),
                                             NULL) != -1) {
                        if (ProcessContent(&frmtStruct, SDLDocumentContent,
                                           SdlElementNone, startExcept,
                                           skipMask) != -1) {
                                if (ProcessSDLMarkup(
                                        &frmtStruct, SdlElementVStruct,
                                        SdlElementLoids, startExcept,
                                        skipMask) != -1) {
...
int _DtHelpCeParseSdlTopic(_DtHelpVolumeHdl volume, _FrmtUiInfo *ui_info,
        ...
        *ret_handle = NULL;
        ...
        if (SetUp(volume, &sdlVol, &frmtStruct, NULL, ui_info, fd, True,
                  rich_text) != 0)
                return -1;
        ...
        result =
            _DtHelpCeFileOpenAndSeek(_DtHelpCeGetVolumeName(volume), offset, fd,
                                     &(frmtStruct.my_file), NULL);
        if (result != -1) {
                result =
                    ProcessSDLMarkup(&frmtStruct, SdlElementVirpage,
