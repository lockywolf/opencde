 ...
 */
{
        ...
        for (ci = 0, compptr = cinfo->comp_info; ci < cinfo->num_components;
             ci++, compptr++) {
                 ...
                 * later (see set_wraparound_pointers, below).  Initially we
                 * want the "above" pointers to duplicate the first actual data
                 * line.  This only needs to happen in xbuffer[0].
                 */
                for (i = 0; i < rgroup; i++) {
 ...
 */
{
        ...
        for (ci = 0, compptr = cinfo->comp_info; ci < cinfo->num_components;
             ci++, compptr++) {
                 ...
                 * out the last partial rowgroup and ensures at least one full
                 * rowgroup of context.
                 */
