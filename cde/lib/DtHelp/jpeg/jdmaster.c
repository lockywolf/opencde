...
/* Do computations that are needed before master selection phase */
{
         ...
         * upsampling. This saves time if the upsampler gets to use 1:1 scaling.
...
master_selection(j_decompress_ptr cinfo) {
        ...
        if (cinfo->quantize_colors) {
                 ...
                 * active; this is necessary for starting with quantization to
                 * an external map.
                 */
        }
...
prepare_for_output_pass(j_decompress_ptr cinfo) {
        ...
        if (cinfo->progress != NULL) {
                 ...
                 * not yet reached, but no more passes if EOI has been reached.
                 */
