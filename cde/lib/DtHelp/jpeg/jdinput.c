...
/* Called once, when first SOS marker is reached */
{
        ...
        for (ci = 0, compptr = cinfo->comp_info; ci < cinfo->num_components;
             ci++, compptr++) {
                 ...
                 * overridden by jdmaster.c if we are doing full decompression.
                 * The transcoder library doesn't use these values, but the
                 * calling application might.
                 */
                /* Size in samples */
...
/* cinfo->comps_in_scan and cinfo->cur_comp_info[] were set from SOS marker */
{
        ...
        if (cinfo->comps_in_scan == 1) {
                 ...
                 * last_row_height as the number of block rows present in the
                 * last iMCU row.
                 */
...
consume_markers(j_decompress_ptr cinfo) {
        ...
        case JPEG_REACHED_EOI: /* Found EOI */
                ...
                if (inputctl
                         ...
                         * routine if user set output_scan_number larger than
                         * number of scans.
                         */
                        if (cinfo->output_scan_number >
