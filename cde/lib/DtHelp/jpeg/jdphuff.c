                ...
                if (is_DC_band) {
                        if (cinfo->Ah == 0) { /* DC refinement needs no table */
                                ...
                                jpeg_make_d_derived_tbl(
                                    cinfo, cinfo->dc_huff_tbl_ptrs[tbl],
...
decode_mcu_DC_first(j_decompress_ptr cinfo, JBLOCKROW *MCU_data) {
        ...
        for (blkn = 0; blkn < cinfo->blocks_in_MCU; blkn++) {
                ...
                /* Scale and output the DC coefficient (assumes
...
decode_mcu_AC_first(j_decompress_ptr cinfo, JBLOCKROW *MCU_data) {
         ...
         */
        EOBRUN =
            entropy->saved.EOBRUN; /* only part of saved state we care about */
        ...
        if (EOBRUN > 0)   /* if it's a band of zeroes... */
                ...
                for (k = cinfo->Ss; k <= Se; k++) {
                        ...
                        if (s) {
                                ...
                                } else { /* EOBr, run length is 2^r + appended
                                            bits */
                                        EOBRUN = 1 << r;
                                        if (r) { /* EOBr, r > 0 */
                                                CHECK_BIT_BUFFER(br_state, r,
                                                                 return FALSE);
                                                r = GET_BITS(r);
                                                EOBRUN += r;
                                        }
                                        EOBRUN--; /* this band is processed at
                                                     this moment */
        ...
        entropy->saved.EOBRUN =
            EOBRUN; /* only part of saved state we care about */
...
decode_mcu_AC_refine(j_decompress_ptr cinfo, JBLOCKROW *MCU_data) {
         ...
         * instead, we can test the current bit position to see if we already
         * did it.
         */
        num_newnz = 0;
                ...
                for (; k <= Se; k++) {
                        ...
                        if (s) {
                                ...
                                if (r != 15) {
                                        ...
                                        break; /* rest of block is handled by
                                                  EOB logic */
                                }
                        ...
                        if (s) {
                                ...
                                (*block)[pos] = (JCOEF)s;
                                /* Remember its position in case we have to
                                 * suspend */
