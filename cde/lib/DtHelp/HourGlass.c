...
static unsigned char noenter16_bits[] = {
    0x00, 0x00, 0xc0, 0x03, 0xf0, 0x0f, 0xf8, 0x1f, 0xfc, 0x3f, 0xfc,
    0x3f, 0xfe, 0x7f, 0x02, 0x40, 0x02, 0x40, 0xfe, 0x7f, 0xfc, 0x3f,
    0xfc, 0x3f, 0xf8, 0x1f, 0xf0, 0x0f, 0xc0, 0x03, 0x00, 0x00};

static unsigned char noenter16m_bits[] = {
    0xc0, 0x03, 0xf0, 0x0f, 0xf8, 0x1f, 0xfc, 0x3f, 0xfe, 0x7f, 0xfe,
    0x7f, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xfe, 0x7f,
    0xfe, 0x7f, 0xfc, 0x3f, 0xf8, 0x1f, 0xf0, 0x0f, 0xc0, 0x03};
 ...
 *
 *************************************<->***********************************/
static Cursor GetNoEnterCursor(Display *dpy) {
        char *bits;
        char *maskBits;
        unsigned int width;
        unsigned int height;
 ...
 *
 *************************************<->***********************************/
Cursor _DtHelpGetHourGlassCursor(Display *dpy) {
        char *bits;
        char *maskBits;
        unsigned int width;
        unsigned int height;
...
void _DtHelpTurnOnHourGlass(Widget w) {
        Cursor cursor;
...
void _DtHelpTurnOffHourGlass(Widget w) {
...
void _DtHelpTurnOnNoEnter(Widget w) {
        Cursor cursor;
...
void _DtHelpTurnOffNoEnter(Widget w) {
