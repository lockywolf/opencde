...
FUNC(xpmCreateImage, int,
     (ilObject object, xpmInternAttrib *attrib, ilClientImage *image_return,
      ilClientImage *shapeimage_return, XpmAttributes *attributes));

FUNC(xpmParseData, int,
     (xpmData * data, xpmInternAttrib *attrib_return,
...
FUNC(xpmSetAttributes, int,
     (xpmInternAttrib * attrib, XpmAttributes *attributes));

FUNC(xpmGetAttributes, int,
     (XpmAttributes * attributes, xpmInternAttrib *attrib));
