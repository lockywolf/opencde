...
/*  Standard image descriptors and formats, referenced by #defines in
 * /ilinc/il.h
 */
const ilImageDes ilBitonal0WhiteImageDes =
    {/* IL_DES_BITONAL */
     /* type             */ IL_BITONAL,
...
const ilImageDes ilGray256ImageDes =
    {/* IL_DES_GRAY */
     /* type             */ IL_GRAY,
     /* compression      */ IL_UNCOMPRESSED,
     /* blackIsZero      */ TRUE,
...
const ilImageDes ilRGB256ImageDes =
    {/*  IL_DES_RGB */
     /* type             */ IL_RGB,
     /* compression      */ IL_UNCOMPRESSED,
     /* blackIsZero      */ FALSE,
...
const ilImageDes ilYCbCrImageDes =
    {/*  IL_DES_YCBCR */
     /* type             */ IL_YCBCR,
     /* compression      */ IL_UNCOMPRESSED,
     /* blackIsZero      */ FALSE,
     ...
     /* flags            */ 0,
     /* typeInfo.YCbCr   */
     {{{{0, 255, 1, 1}, {128, 255, 1, 1}, {128, 255, 1, 1}},
       2990,
       5870,
       1140,
       0}},
...
const ilImageDes ilYCbCr2ImageDes =
    {/*  IL_DES_YCBCR_2 */
     /* type             */ IL_YCBCR,
     /* compression      */ IL_UNCOMPRESSED,
     /* blackIsZero      */ FALSE,
     ...
     /* flags            */ 0,
     /* typeInfo.YCbCr   */
     {{{{0, 255, 1, 1}, {128, 255, 2, 2}, {128, 255, 2, 2}},
       2990,
       5870,
       1140,
       0}},
...
const ilImageDes ilPaletteImageDes =
    {/* IL_DES_PALETTE */
     /* type             */ IL_PALETTE,
     /* compression      */ IL_UNCOMPRESSED,
     /* blackIsZero      */ FALSE,
