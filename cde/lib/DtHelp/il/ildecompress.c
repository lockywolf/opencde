...
IL_PRIVATE void _ilDecompress(ilPipe pipe) {
        unsigned int state;
        ilPipeInfo info;
        ilImageDes imdes;
        ilImageFormat imformat;

        /* Get ptr to pipe info and check state.  We should NOT FORCE
         * decompression */
        ...
        switch (imdes.compression) {
                /* Image is already decompressed!  Continue, this is NOT an
                 * error! */
