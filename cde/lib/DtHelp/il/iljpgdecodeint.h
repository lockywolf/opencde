...
iljpgError _iljpgDehuffExecute(iljpgDecodePrivPtr pPriv,
                               ILJPG_DECODE_STREAM stream, int comp, int *pOut,
...
ILJPG_PRIVATE_EXTERN
void _iljpgDeDCTFull(int *pSrc, long nBytesPerRow, iljpgPtr ix, /* RETURNED */
                     float *pRevScale);

ILJPG_PRIVATE_EXTERN
void _iljpgDeDCT4x4(int *pSrc, long nBytesPerRow, iljpgPtr ix, /* RETURNED */
                    float *pRevScale);
