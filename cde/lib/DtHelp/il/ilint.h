...
IL_EXTERN ilObjectPtr _ilCreateObject(
    ...
    /* Use the portable(correct) type for sizeof() operator, bug report
       OSF_QAR#32082 */
...
*/
IL_EXTERN ilError _ilValidateDesFormat(ilBool allowPrivateTypes,
...
*/
IL_EXTERN void _ilIntersectRect(ilRect *pSrcRect, ilRect *pDstRect);
