...
/*  Convert from source type (pDes->type) == RGB to Palette.
    ...
    to the dst format. *pDes ->the src (pipe) des; on return *pDes is the new
   des.
*/
IL_EXTERN ilBool _ilConvertRGBToPalette(ilPipe pipe, ilPipeInfo *pInfo,
                                        register ilImageDes *pDes,
                                        ilImageFormat *pFormat, int option,
...
/*  In /ilc/ilpalette.c :
    ...
    Input image:   uncompressed IL_PALETTE, any # of levels,
   IL_FORMAT_3BYTE_PIXEL. Output image:  IL_DES_GRAY, IL_FORMAT_BYTE.
*/
...
*/
IL_EXTERN ilBool _ilAddLevelConversionFilter(ilPipe pipe, ilPipeInfo *pInfo,
                                             ilImageDes *pPipeDes,
...
*/
IL_EXTERN ilBool _ilAddInvertFilter(ilPipe pipe, ilImageDes *pPipedes,
                                    ilPipeInfo *pInfo);
...
/*  Attempt to upsample and scale based on "scaleFactor" (0 = no scaling; 1 =
   ...
   0).  Pipe image must be decompressed before calling this function.
*/
IL_EXTERN ilBool _ilFastUpsample(ilPipe pipe, ilPipeInfo *pInfo,
...
*/
IL_EXTERN ilBool _ilUpsampleYCbCr(ilPipe pipe, ilPipeInfo *pInfo,
                                  ilImageDes *pDes, ilImageFormat *pFormat,
...
/*  Subsample the pipe image which must be a fully upsampled YCbCr image.
   ...
   values.
*/
IL_EXTERN ilBool _ilSubsampleYCbCr(ilPipe pipe, ilPipeInfo *pInfo,
                                   ilImageDes *pDes, ilImageFormat *pFormat);
...
/*   Convert from source type (pDes->type) == IL_YCBCR to RBB.
     ...
     to the dst format, *pDes to the dst descriptor.
 */
IL_EXTERN ilBool _ilConvertYCbCrToRGB(ilPipe pipe, ilPipeInfo *pInfo,
                                      ilImageDes *pDes, ilImageFormat *pFormat);
...
*/
IL_EXTERN ilBool _ilConvertRGBToYCbCr(ilPipe pipe, ilPipeInfo *pInfo,
                                      ilImageDes *pDes,
...
*/
IL_EXTERN ilBool _ilDitherYCbCr(ilPipe pipe, ilPipeInfo *pInfo,
                                ilImageDes *pDes, ilImageFormat *pFormat,
