...
*/
ILJPG_PRIVATE iljpgError _iljpgEnDCTScale(iljpgPtr pSrc, float *pDst) {
...
*/
ILJPG_PRIVATE _iljpgEnDCT(int *pSrc, float *pScale) {
        ...
        *oxptr -= 8192; /* for JPEG shift by -128 */
        ...
        /* scale and quantize DC value. JPEG expects rounding during this
         * process */
        ...
        *ixptr = value;
        ...
        /* scale and quantize AC values. JPEG expects rounding during this
         * process */
