...
*/
IL_EXTERN ilBool _ilAddProducerImage(ilPipe pipe, register ilImagePtr pImage,
...
*/
IL_EXTERN ilBool _ilSetFeedPipeData(ilPipe pipe, long start, long nLines,
                                    long nCompBytes);
...
*/
IL_EXTERN void _ilSetPipeDesFormat(ilPipe pipe, ilImageDes *pDes,
...
/*  Add the given object to a list of objects to be destroyed when this pipe
   ...
   code or success.
*/
IL_EXTERN ilBool _ilAddPipeDestroyObject(ilPipe pipe, ilObject object);
...
*/
IL_EXTERN ilBool _ilInsertCopyFilter(ilPipe pipe, long height);

/*  Insert a "filter" which copies the compressed pipe image to the dest image.
    This is the equivalent to ilInsertCopyFilter(), except for compressed
   images.
*/
IL_EXTERN ilBool _ilInsertCompressedCopyFilter(ilPipe pipe);
...
*/
IL_EXTERN ilBool _ilAddThrottlePipeElement(ilPipe pipe, long stripHeight,
