...
typedef struct {
        ...
        short nExtensions;
        char extensions[IL_EFS_MAX_EXTENSIONS][IL_EFS_MAX_EXTENSION_CHARS];
...
extern ilEFSFile ilEFSOpen(
    ...
    ilContext context, char *fileName, unsigned int openMode,
    unsigned long searchOptions, char *typeName, void *pOptions
#endif
);

extern ilBool ilEFSGetFileInfo(
#if NeedFunctionPrototypes
    ilEFSFile file, ilEFSFileInfo *pInfo /* RETURNED */
#endif
);

extern ilBool ilEFSSeek(
#if NeedFunctionPrototypes
    ilEFSFile file, long page, void *pOptions
#endif
);

extern ilBool ilEFSGetPageInfo(
#if NeedFunctionPrototypes
    ilEFSFile file, ilEFSPageInfo *pInfo /* RETURNED */
#endif
);

extern ilBool ilEFSReadImage(
#if NeedFunctionPrototypes
    ilPipe pipe, ilEFSFile file, unsigned int readMode, long width, long height,
    void *pOptions
#endif
);
...
#if NeedFunctionPrototypes
    ilPipe pipe, ilEFSFile file, long xRes, long yRes, ilClientImage maskImage,
    void *pOptions
#endif
);
...
#if NeedFunctionPrototypes
    ilContext context, int *pNFileTypes, /* RETURNED */
...
#if NeedFunctionPrototypes
    ilEFSFileType fileType, ilEFSFileTypeInfo *pInfo /* RETURNED */
#endif
);

extern ilEFSFileType ilEFSAddFileType(
#if NeedFunctionPrototypes
    ilContext context, ilEFSFileTypeInfo *pInfo, void *pOptions
#endif
);
