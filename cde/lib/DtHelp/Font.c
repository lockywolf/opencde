...
static const char *FontResources[] = {
    ...
    /* for ISO-8859-2 */
    "*.6.*.*.*.*.ISO-8859-2:  -dt-interface "
    "user-medium-r-normal-xs*-*-*-*-*-*-*-*-*:",
    "*.8.*.*.*.*.ISO-8859-2:  -dt-interface "
    "user-medium-r-normal-s*-*-*-*-*-*-*-*-*:",
    "*.10.*.*.*.*.ISO-8859-2: -dt-interface "
    "user-medium-r-normal-m*-*-*-*-*-*-*-*-*:",
    "*.12.*.*.*.*.ISO-8859-2: -dt-interface "
    "user-medium-r-normal-l*-*-*-*-*-*-*-*-*:",
    "*.14.*.*.*.*.ISO-8859-2: -dt-interface "
    "user-medium-r-normal-xl*-*-*-*-*-*-*-*-*:",
    /* for ISO-8859-5 */
    "*.6.*.*.*.*.ISO-8859-5:  -dt-interface "
    "user-medium-r-normal-xs*-*-*-*-*-*-*-*-*:",
    "*.8.*.*.*.*.ISO-8859-5:  -dt-interface "
    "user-medium-r-normal-s*-*-*-*-*-*-*-*-*:",
    "*.10.*.*.*.*.ISO-8859-5: -dt-interface "
    "user-medium-r-normal-m*-*-*-*-*-*-*-*-*:",
    "*.12.*.*.*.*.ISO-8859-5: -dt-interface "
    "user-medium-r-normal-l*-*-*-*-*-*-*-*-*:",
    "*.14.*.*.*.*.ISO-8859-5: -dt-interface "
    "user-medium-r-normal-xl*-*-*-*-*-*-*-*-*:",
    /* for ISO-8859-6 */
    "*.6.*.*.*.*.ISO-8859-6:  -dt-interface "
    "user-medium-r-normal-xs*-*-*-*-*-*-*-*-*:",
    "*.8.*.*.*.*.ISO-8859-6:  -dt-interface "
    "user-medium-r-normal-s*-*-*-*-*-*-*-*-*:",
    "*.10.*.*.*.*.ISO-8859-6: -dt-interface "
    "user-medium-r-normal-m*-*-*-*-*-*-*-*-*:",
    "*.12.*.*.*.*.ISO-8859-6: -dt-interface "
    "user-medium-r-normal-l*-*-*-*-*-*-*-*-*:",
    "*.14.*.*.*.*.ISO-8859-6: -dt-interface "
    "user-medium-r-normal-xl*-*-*-*-*-*-*-*-*:",
    /* for ISO-8859-7 */
    "*.6.*.*.*.*.ISO-8859-7:  -dt-interface "
    "user-medium-r-normal-xs*-*-*-*-*-*-*-*-*:",
    "*.8.*.*.*.*.ISO-8859-7:  -dt-interface "
    "user-medium-r-normal-s*-*-*-*-*-*-*-*-*:",
    "*.10.*.*.*.*.ISO-8859-7: -dt-interface "
    "user-medium-r-normal-m*-*-*-*-*-*-*-*-*:",
    "*.12.*.*.*.*.ISO-8859-7: -dt-interface "
    "user-medium-r-normal-l*-*-*-*-*-*-*-*-*:",
    "*.14.*.*.*.*.ISO-8859-7: -dt-interface "
    "user-medium-r-normal-xl*-*-*-*-*-*-*-*-*:",
    /* for ISO-8859-8 */
    "*.6.*.*.*.*.ISO-8859-8:  -dt-interface "
    "user-medium-r-normal-xs*-*-*-*-*-*-*-*-*:",
    "*.8.*.*.*.*.ISO-8859-8:  -dt-interface "
    "user-medium-r-normal-s*-*-*-*-*-*-*-*-*:",
    "*.10.*.*.*.*.ISO-8859-8: -dt-interface "
    "user-medium-r-normal-m*-*-*-*-*-*-*-*-*:",
    "*.12.*.*.*.*.ISO-8859-8: -dt-interface "
    "user-medium-r-normal-l*-*-*-*-*-*-*-*-*:",
    "*.14.*.*.*.*.ISO-8859-8: -dt-interface "
    "user-medium-r-normal-xl*-*-*-*-*-*-*-*-*:",
    /* for ISO-8859-9 */
    "*.6.*.*.*.*.ISO-8859-9:  -dt-interface "
    "user-medium-r-normal-xs*-*-*-*-*-*-*-*-*:",
    "*.8.*.*.*.*.ISO-8859-9:  -dt-interface "
    "user-medium-r-normal-s*-*-*-*-*-*-*-*-*:",
    "*.10.*.*.*.*.ISO-8859-9: -dt-interface "
    "user-medium-r-normal-m*-*-*-*-*-*-*-*-*:",
    "*.12.*.*.*.*.ISO-8859-9: -dt-interface "
    "user-medium-r-normal-l*-*-*-*-*-*-*-*-*:",
    "*.14.*.*.*.*.ISO-8859-9: -dt-interface "
    "user-medium-r-normal-xl*-*-*-*-*-*-*-*-*:",
    /* for EUC-KR */
    "*.6.*.*.*.*.EUC-KR:  -dt-interface "
    "user-medium-r-normal-xs*-*-*-*-*-*-*-*-*:",
    "*.8.*.*.*.*.EUC-KR:  -dt-interface "
    "user-medium-r-normal-s*-*-*-*-*-*-*-*-*:",
    "*.10.*.*.*.*.EUC-KR: -dt-interface "
    "user-medium-r-normal-m*-*-*-*-*-*-*-*-*:",
    "*.12.*.*.*.*.EUC-KR: -dt-interface "
    "user-medium-r-normal-l*-*-*-*-*-*-*-*-*:",
    "*.14.*.*.*.*.EUC-KR: -dt-interface "
    "user-medium-r-normal-xl*-*-*-*-*-*-*-*-*:",
    /* for EUC-JP */
    "*.6.*.*.*.*.EUC-JP:  -dt-interface "
    "user-medium-r-normal-xs*-*-*-*-*-*-*-*-*:",
    "*.8.*.*.*.*.EUC-JP:  -dt-interface "
    "user-medium-r-normal-s*-*-*-*-*-*-*-*-*:",
    "*.10.*.*.*.*.EUC-JP: -dt-interface "
    "user-medium-r-normal-m*-*-*-*-*-*-*-*-*:",
    "*.12.*.*.*.*.EUC-JP: -dt-interface "
    "user-medium-r-normal-l*-*-*-*-*-*-*-*-*:",
    "*.14.*.*.*.*.EUC-JP: -dt-interface "
    "user-medium-r-normal-xl*-*-*-*-*-*-*-*-*:",
    /* for EUC-TW */
    "*.6.*.*.*.*.EUC-TW:  -dt-interface "
    "user-medium-r-normal-xs*-*-*-*-*-*-*-*-*:",
    "*.8.*.*.*.*.EUC-TW:  -dt-interface "
    "user-medium-r-normal-s*-*-*-*-*-*-*-*-*:",
    "*.10.*.*.*.*.EUC-TW: -dt-interface "
    "user-medium-r-normal-m*-*-*-*-*-*-*-*-*:",
    "*.12.*.*.*.*.EUC-TW: -dt-interface "
    "user-medium-r-normal-l*-*-*-*-*-*-*-*-*:",
    "*.14.*.*.*.*.EUC-TW: -dt-interface "
    "user-medium-r-normal-xl*-*-*-*-*-*-*-*-*:",
    /* for EUC-CN */
    "*.6.*.*.*.*.EUC-CN:  -dt-interface "
    "user-medium-r-normal-xs*-*-*-*-*-*-*-*-*:",
    "*.8.*.*.*.*.EUC-CN:  -dt-interface "
    "user-medium-r-normal-s*-*-*-*-*-*-*-*-*:",
    "*.10.*.*.*.*.EUC-CN: -dt-interface "
    "user-medium-r-normal-m*-*-*-*-*-*-*-*-*:",
    "*.12.*.*.*.*.EUC-CN: -dt-interface "
    "user-medium-r-normal-l*-*-*-*-*-*-*-*-*:",
    "*.14.*.*.*.*.EUC-CN: -dt-interface "
    "user-medium-r-normal-xl*-*-*-*-*-*-*-*-*:",
    /* for IBM-437 */
    "*.6.*.*.*.*.IBM-437:  -dt-interface "
    "user-medium-r-normal-xs*-*-*-*-*-*-*-*-*:",
    "*.8.*.*.*.*.IBM-437:  -dt-interface "
    "user-medium-r-normal-s*-*-*-*-*-*-*-*-*:",
    "*.10.*.*.*.*.IBM-437: -dt-interface "
    "user-medium-r-normal-m*-*-*-*-*-*-*-*-*:",
    "*.12.*.*.*.*.IBM-437: -dt-interface "
    "user-medium-r-normal-l*-*-*-*-*-*-*-*-*:",
    "*.14.*.*.*.*.IBM-437: -dt-interface "
    "user-medium-r-normal-xl*-*-*-*-*-*-*-*-*:",
    /* for IBM-850 */
    "*.6.*.*.*.*.IBM-850:  -dt-interface "
    "user-medium-r-normal-xs*-*-*-*-*-*-*-*-*:",
    "*.8.*.*.*.*.IBM-850:  -dt-interface "
    "user-medium-r-normal-s*-*-*-*-*-*-*-*-*:",
    "*.10.*.*.*.*.IBM-850: -dt-interface "
    "user-medium-r-normal-m*-*-*-*-*-*-*-*-*:",
    "*.12.*.*.*.*.IBM-850: -dt-interface "
    "user-medium-r-normal-l*-*-*-*-*-*-*-*-*:",
    "*.14.*.*.*.*.IBM-850: -dt-interface "
    "user-medium-r-normal-xl*-*-*-*-*-*-*-*-*:",
    /* for IBM-856 */
    "*.6.*.*.*.*.IBM-856:  -dt-interface "
    "user-medium-r-normal-xs*-*-*-*-*-*-*-*-*:",
    "*.8.*.*.*.*.IBM-856:  -dt-interface "
    "user-medium-r-normal-s*-*-*-*-*-*-*-*-*:",
    "*.10.*.*.*.*.IBM-856: -dt-interface "
    "user-medium-r-normal-m*-*-*-*-*-*-*-*-*:",
    "*.12.*.*.*.*.IBM-856: -dt-interface "
    "user-medium-r-normal-l*-*-*-*-*-*-*-*-*:",
    "*.14.*.*.*.*.IBM-856: -dt-interface "
    "user-medium-r-normal-xl*-*-*-*-*-*-*-*-*:",
    /* for IBM-932 */
    "*.6.*.*.*.*.IBM-932:  -dt-interface "
    "user-medium-r-normal-xs*-*-*-*-*-*-*-*-*:",
    "*.8.*.*.*.*.IBM-932:  -dt-interface "
    "user-medium-r-normal-s*-*-*-*-*-*-*-*-*:",
    "*.10.*.*.*.*.IBM-932: -dt-interface "
    "user-medium-r-normal-m*-*-*-*-*-*-*-*-*:",
    "*.12.*.*.*.*.IBM-932: -dt-interface "
    "user-medium-r-normal-l*-*-*-*-*-*-*-*-*:",
    "*.14.*.*.*.*.IBM-932: -dt-interface "
    "user-medium-r-normal-xl*-*-*-*-*-*-*-*-*:",
    /* for IBM-1046 */
    "*.6.*.*.*.*.IBM-1046:  -dt-interface "
    "user-medium-r-normal-xs*-*-*-*-*-*-*-*-*:",
    "*.8.*.*.*.*.IBM-1046:  -dt-interface "
    "user-medium-r-normal-s*-*-*-*-*-*-*-*-*:",
    "*.10.*.*.*.*.IBM-1046: -dt-interface "
    "user-medium-r-normal-m*-*-*-*-*-*-*-*-*:",
    "*.12.*.*.*.*.IBM-1046: -dt-interface "
    "user-medium-r-normal-l*-*-*-*-*-*-*-*-*:",
    "*.14.*.*.*.*.IBM-1046: -dt-interface "
    "user-medium-r-normal-xl*-*-*-*-*-*-*-*-*:",
    /* for UTF-8 */
    "*.6.*.*.*.*.UTF-8:  -dt-interface "
    "user-medium-r-normal-xs*-*-*-*-*-*-*-*-*:",
    "*.8.*.*.*.*.UTF-8:  -dt-interface "
    "user-medium-r-normal-s*-*-*-*-*-*-*-*-*:",
    "*.10.*.*.*.*.UTF-8: -dt-interface "
    "user-medium-r-normal-m*-*-*-*-*-*-*-*-*:",
    "*.12.*.*.*.*.UTF-8: -dt-interface "
    "user-medium-r-normal-l*-*-*-*-*-*-*-*-*:",
    "*.14.*.*.*.*.UTF-8: -dt-interface "
    "user-medium-r-normal-xl*-*-*-*-*-*-*-*-*:",
    NULL,
};
...
static DtHelpDAFontInfo DefFontInfo = {NULL, NULL, NULL, NULL, NULL, NULL, 0,
                                       NULL, 0,    0,    0,    0,    0};
 ...
 *
 *****************************************************************************/
static int SaveFontStruct(XFontStruct *font_struct,
 ...
 *
 *****************************************************************************/
static int SaveFontSet(XFontSet font_set, DtHelpDAFontInfo *font_info) {
        int fontIndex = 0;
 ...
 *
 *****************************************************************************/
static short LoadFont(Display *dpy, DtHelpDAFontInfo *font_info,
                      char *font_string, long *ret_index) {
        short found = False;
        short colon = False;
        int len;
        char *junk;
        ...
        if (MB_CUR_MAX == 1) {
                ...
                /*
                 * Multibyte environment, have to go through the characters one
                 * at a time.
                 */
                while (*strPtr != '\0') {
                        /*
 ...
 *
 *****************************************************************************/
int __DtHelpFontIndexGet(DtHelpDispAreaStruct *pDAS, XrmQuarkList xrm_list,
                         long *ret_idx) {
        int result = -1;
        ...
        if (XrmQGetResource(fontInfo->font_idx_db, xrm_list, xrm_list, &retType,
                ...
                XrmQPutResource(&(fontInfo->font_idx_db),
                                ((XrmBindingList)FontBindings), xrm_list,
                                _DtHelpXrmInt, &retValue);
                ...
                xrmList[2] = 0;
                XrmQPutResource(&(fontInfo->font_idx_db),
                                ((XrmBindingList)FontBindings), xrmList,
                                _DtHelpXrmQuark, &retValue);
...
/******************************************************************************
 * Function:	int __DtHelpFontCharSetQuarkGet (font_index, XrmQuark
 **ret_quark)
 *
 ...
 *
 *****************************************************************************/
int __DtHelpFontCharSetQuarkGet(DtHelpDispAreaStruct *pDAS, long font_index,
                                XrmQuark *ret_quark) {
        XrmRepresentation retType;
        XrmValue retValue;
        char buffer[10];
 ...
 *
 *****************************************************************************/
int __DtHelpFontLangQuarkGet(DtHelpDispAreaStruct *pDAS, long font_index,
                             XrmQuark *ret_quark) {
        XrmRepresentation retType;
        XrmValue retValue;
        char buffer[10];
 ...
 *****************************************************************************/
void _DtHelpCopyDefaultList(XrmName *xrm_list) {
        int n;
 ...
 * Purpose:	Initializes the font data base.
 *****************************************************************************/
void _DtHelpGetStringQuarks(XrmName *xrm_list) {
 ...
 *
 *****************************************************************************/
void __DtHelpFontDatabaseInit(DtHelpDispAreaStruct *pDAS, XtPointer string_font,
                              XmFontType type, XFontStruct *user_font) {
        int n;
        int strIdx;
        int found = FALSE;
        ...
        *fontInfo = DefFontInfo;
        ...
        if (QuarksInited == False) {
                ...
                DefaultFontQuarks[_DT_HELP_FONT_SPACING] =
                    XrmStringToQuark("p");
                DefaultFontQuarks[_DT_HELP_FONT_SIZE] = XrmStringToQuark("10");
                DefaultFontQuarks[_DT_HELP_FONT_ANGLE] =
                    XrmStringToQuark("roman");
                DefaultFontQuarks[_DT_HELP_FONT_WEIGHT] =
                    XrmStringToQuark("medium");
                DefaultFontQuarks[_DT_HELP_FONT_TYPE] =
                    XrmStringToQuark("sans_serif");
                DefaultFontQuarks[_DT_HELP_FONT_LANG_TER] =
                    XrmStringToQuark("C");
        ...
        XrmQPutResource(&(fontInfo->font_idx_db),
                        ((XrmBindingList)FontBindings), xrmList, _DtHelpXrmInt,
                        &retValue);
         ...
         */
        if (found == False &&
            XrmQGetResource(fontInfo->def_font_db, DefaultFontQuarks,
                            DefaultFontQuarks, &retType, &retValue))
                found = LoadFont(dpy, fontInfo, ((char *)retValue.addr),
                                 &(fontInfo->def_idx));
        ...
        XrmQPutResource(&(fontInfo->font_idx_db),
                        ((XrmBindingList)FontBindings), DefaultFontQuarks,
                        _DtHelpXrmInt, &retValue);
}
 ...
 *
 *****************************************************************************/
XFontStruct *__DtHelpFontStructGet(DtHelpDAFontInfo font_info,
                                   long font_index) {
 ...
 *
 *****************************************************************************/
XFontSet __DtHelpFontSetGet(DtHelpDAFontInfo font_info, long font_index) {
 ...
 *
 *****************************************************************************/
long __DtHelpDefaultFontIndexGet(DtHelpDispAreaStruct *pDAS) {
 ...
 *
 *****************************************************************************/
void __DtHelpFontMetrics(DtHelpDAFontInfo font_info, long font_index,
        ...
        if (font_index < 0) {
                ...
                if (font_index < font_info.set_cnt) {
                        if (font_info.fs_metrics[font_index].inited == True) {
                                maxAscent =
                                    font_info.fs_metrics[font_index].fm.ascent;
                                maxDescent =
                                    font_info.fs_metrics[font_index].fm.descent;
                                maxCharW = font_info.fs_metrics[font_index]
                                               .fm.average_width;
                        } else /* if (font_info.fs_metrics[font_index].inited ==
                                  False) */
                        {
                                fontCount = XFontsOfFontSet(
                                    font_info.font_sets[font_index], &fontList,
                                    &fontNames);
                                for (i = 0; i < fontCount; i++) {
                                        ...
                                        if (fontList[i]->max_bounds.width >
                                            maxCharW)
                                                maxCharW =
                                                    fontList[i]
                                                        ->max_bounds.width;
                                ...
                                font_info.fs_metrics[font_index].fm.descent =
                                    maxDescent;
                                font_info.fs_metrics[font_index]
                                    .fm.average_width = maxCharW;
 ...
 *
 *****************************************************************************/
int _DtHelpGetExactFontIndex(DtHelpDispAreaStruct *pDAS, const char *lang,
                             const char *char_set, char *xlfd_spec,
                             long *ret_idx) {
        int i = 0;
        int result = -1;
        long fontIndex = pDAS->font_info.def_idx;
...
#define REALLOC_INCR 10
        ...
        if (NULL != nameList) {
                for (i = 0; NULL != *nameList && strcmp(*nameList, xlfd_spec);
                     i++)
                        nameList++;
        }
        ...
        if (NULL != nameList && NULL != *nameList) {
                ...
                if (NULL != xlfd_spec) {
                        ...
                        fontInfo->exact_fonts = (char **)_DtHelpCeAddPtrToArray(
                            (void **)fontInfo->exact_fonts, (void *)xlfd_spec);
                        if (NULL != fontInfo->exact_fonts) {
                                if (NULL == fontInfo->exact_idx)
                                        ...
                                        fontInfo->exact_idx = (int *)realloc(
                                            fontInfo->exact_idx,
                                            sizeof(int) *
                                                (i + 1 + REALLOC_INCR));
                                ...
                                if (NULL != fontInfo->exact_idx) {
                                        ...
                                        /*
                                         * remember the character set for this
                                         * font.
                                         */
                                        ...
                                        xrmList[0] = XrmStringToQuark(buffer);
                                        xrmList[1] =
                                            XrmStringToQuark("code_set");
                                        xrmList[2] = 0;
                                        XrmQPutResource(
                                            &(fontInfo->font_idx_db),
                                            ((XrmBindingList)FontBindings),
                                            xrmList, _DtHelpXrmQuark,
                                            &retValue);
