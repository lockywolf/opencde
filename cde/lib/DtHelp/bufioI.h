...
extern void _DtHelpCeBufFileClose(BufFilePtr f, int doClose);
extern BufFilePtr _DtHelpCeBufFileCreate(char *hidden, int (*io)(),
                                         int (*skip)(), int (*close)());
extern int _DtHelpCeBufFileRd(BufFilePtr f, char *buffer, int request_size);
extern BufFilePtr _DtHelpCeBufFileRdWithFd(int fd);
extern BufFilePtr _DtHelpCeBufFileRdRawZ(CECompressInfoPtr file_info);
extern BufFilePtr _DtHelpCeCreatePipeBufFile(FILE *stream);
extern int _DtHelpCeUncompressFile(char *in_file, char *out_file);
