...
/*---------------------------------------------------------------------------
 ...
 __hp_color_object      - Set if HP's ColorObject extension is available in the
Motif library
...
#if defined(_HPUX_SOURCE) || defined(__sun) || defined(USL) ||                 \
    defined(_INCLUDE_BSD_SOURCE) || defined(_OSF_SOURCE) || defined(__aix) ||  \
...
#define XtOffsetCompoundField(class_name1, field1, class_name2, field2)        \
        (((Cardinal)&class_name1::field1 - 1) +                                \
         ((Cardinal)&class_name2::field2 - 1))

#else
#define XtOffsetSimpleField(class_name, field)                                 \
        ((Cardinal)(((char *)(&(((class_name *)NULL)->field))) -               \
                    ((char *)NULL)))

#define XtOffsetCompoundField(class_name1, field1, class_name2, field2)        \
        ((Cardinal)(((char *)(&(((class_name1 *)NULL)->field1))) -             \
                    ((char *)NULL))) +                                         \
            ((Cardinal)(((char *)(&(((class_name2 *)NULL)->field2))) -         \
                        ((char *)NULL)))
#endif
