 ...
 */
/*
 * File:         scoop.h $XConsortium: scoop.h /main/3 1995/10/26 15:48:17
 * rswiston $ Language:     C
 *
...
#if !defined(__sun)
#if (defined(__STDC__) || defined(__STDCPP__) || defined(__cplusplus) ||       \
     defined(c_plusplus))
#define CAT(a, b) a##b
#else
#define CAT(a, b) a /**/ b
...
#define memvf5(v, fn, a1, a2, a3, a4, a5)                                      \
        memf(v., fn, (&(v), a1, a2, a3, a4, a5))
#define memvf6(v, fn, a1, a2, a3, a4, a5, a6)                                  \
        memf(v., fn, (&(v), a1, a2, a3, a4, a5, a6))
...
#define mempf6(p, fn, a1, a2, a3, a4, a5, a6)                                  \
        memf(p->, fn, (p, a1, a2, a3, a4, a5, a6))
...
#define base_memf(my_class, fn, arglist) ((*(my_class->base->fn))arglist)
...
#define stat_def(name, type)                                                   \
        type *name;                                                            \
        type CAT(name, _static);
