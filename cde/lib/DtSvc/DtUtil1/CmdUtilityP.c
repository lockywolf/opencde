...
void _DtCmdBuildPathList(void) {
        ...
        while (i < pathLen) {
                n++;
                cmd_Globals.path_list = (char **)XtRealloc(
                    (char *)cmd_Globals.path_list, n * sizeof(char *));
                ...
                cmd_Globals.path_list[n - 1] =
                    (char *)XtMalloc(((pend - pbeg) + 1) * sizeof(char));
                (void)strncpy(cmd_Globals.path_list[n - 1], pbeg,
                              (pend - pbeg));
