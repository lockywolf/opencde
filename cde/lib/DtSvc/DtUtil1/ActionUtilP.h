...
extern char *_DtActGenerateTmpFile(char *dir, char *format, mode_t mode,
                                   int *fd);
...
extern _DtActChildRecT *_DtActFindChildRec(DtActionInvocationID id,
                                           unsigned long childId);
extern unsigned long _DtActEvalChildren(DtActionInvocationID id);
extern void _DtActExecutionLeafNodeCleanup(DtActionInvocationID id,
...
extern void *_DtActReadTmpFileToBuffer(char *fname, int *sizep);
extern int _DtActGetCmdReturnArgs(DtActionInvocationID invId,
                                  _DtActChildRecT *childp, DtActionArg **aargv);
