 ...
 *
 *************************************<->***********************************/
int DtWsmChangeBackdrop(Display *display, Window root, char *path,
                        Pixmap pixmap) {
 ...
 *
 *************************************<->***********************************/
int _DtWsmChangeBackdrop(Display *display, Window root, char *path,
                         Pixmap pixmap) {
        int rval = BadAtom;
        Window wmWindow;
        ...
        if (!path) {
            ...
            if ((rval = _DtGetMwmWindow(display, root, &wmWindow)) == Success) {
                ...
                rval = XChangeProperty(
                    ...
                    8, PropModeAppend, (unsigned char *)pch, 1 + strlen(pch));
        }
