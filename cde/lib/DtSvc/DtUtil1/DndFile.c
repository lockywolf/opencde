...
static Boolean dndFileConvert(Widget, DtDragInfo *, Atom *, Atom *, Atom *,
                              XtPointer *, unsigned long *, int *,
                              XSelectionRequestEvent *);
static void dndFileConvertFinish(DtDragInfo *);
static void dndFileTransferTargets(DtDropInfo *, Atom *, Cardinal, Atom **,
                                   Cardinal *);
...
static Boolean dndFileContentsToSelectionValue(String, Atom *, XtPointer *,
                                               unsigned long *, int *);
static Boolean dndFileListToSelectionValue(String *, Cardinal, Boolean, Atom *,
                                           XtPointer *, unsigned long *, int *);
 ...
 */
DtDndMethods *_DtDndFileTransferProtocolInitialize(Display *dpy) {
        _DtSvcProcessLock();
        if (XA_FILE_NAME == 0) {
 ...
 */
static void dndFileGetTargets(Boolean doHost, Boolean owCompat, Atom **targets,
                              Cardinal *numTargets) {
        int ii = 0;
 ...
 */
static void dndFileGetAvailTargets(DtDragInfo *dtDragInfo, Atom **availTargets,
 ...
 */
static void dndFileGetExportTargets(DtDragInfo *dtDragInfo,
                                    Atom **exportTargets,
 ...
 */
static void dndFileGetImportTargets(DtDropInfo *dtDropInfo,
                                    Atom **importTargets,
 ...
 */
static void dndFileConvertInit(DtDragInfo *dtDragInfo) {
        DtDndContext *dragData = dtDragInfo->dragData;
        ConvertState *cvtState;

        dragData->data.files =
            (String *)XtMalloc(dragData->numItems * sizeof(String));
 ...
 */
static Boolean dndFileConvert(Widget dragContext, DtDragInfo *dtDragInfo,
        ...
        *returnFormat = 8;
        ...
        if (*target == XA_FILE_NAME || *target == XA_DT_NETFILE) {
                ...
                if (!dndFileListToSelectionValue(
                        ...
                        (*target == XA_DT_NETFILE), returnType, returnValue,
                ...
                if (!dndFileContentsToSelectionValue(
                        dragData->data.files[0], returnType, returnValue,
                        returnLength, returnFormat)) {
                        return False;
                }
 ...
 */
static void dndFileConvertFinish(DtDragInfo *dtDragInfo) {
        DtDndContext *dragData = dtDragInfo->dragData;
 ...
 */
static void dndFileTransferTargets(DtDropInfo *dtDropInfo, Atom *exportTargets,
                                   Cardinal numExportTargets,
 ...
 */
static void dndFileTransfer(Widget dropTransfer, DtDropInfo *dtDropInfo,
        ...
        if (*target == XA_HOST_NAME) {
                ...
                if (!dndSelectionValueToFileList(*type, value, *length, *format,
                                                 (*target == XA_DT_NETFILE),
                                                 &(dropData->data.files),
                                                 &(dropData->numItems))) {
 ...
 */
static void dndFileTransferFinish(DtDropInfo *dtDropInfo) {
        DtDndContext *dropData = dtDropInfo->dropData;
        int ii;
 ...
 */
static Boolean dndFileContentsToSelectionValue(String fileName,
                                               Atom *returnType,
                                               XtPointer *returnValue,
 ...
 */
static Boolean dndFileListToSelectionValue(String *fileList, Cardinal numFiles,
                                           Boolean doNetFile, Atom *returnType,
                                           XtPointer *returnValue,
                                           unsigned long *returnLength,
                                           int *returnFormat) {
 ...
 */
static Boolean dndSelectionValueToFileList(Atom type, XtPointer value,
 ...
 */
static String dndFileEncode(String fileName, Boolean doNetFile) {
        String netFile;
        String retFile;
 ...
 */
static String dndFileDecode(String fileName, Boolean doNetFile) {
        String file;
        String retFile;
