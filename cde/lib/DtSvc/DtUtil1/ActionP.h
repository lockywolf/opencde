...
#ifdef _DT_ALLOW_DT_MSGS
#define _DtAct_ACTION_TYPE_BITS                                                \
        (_DtAct_CMD_BIT | _DtAct_MAP_BIT | _DtAct_DT_NTFY_MSG_BIT |            \
         _DtAct_DT_REQ_MSG_BIT | _DtAct_TT_MSG_BIT)
#else
#define _DtAct_ACTION_TYPE_BITS                                                \
        (_DtAct_CMD_BIT | _DtAct_MAP_BIT | _DtAct_TT_MSG_BIT)
#endif /* _DT_ALLOW_DT_MSGS */
#define _DtAct_ARG_CLASS_BITS                                                  \
        (_DtAct_ARG_CLASS_FILE_BIT | _DtAct_ARG_CLASS_STRING_BIT |             \
         _DtAct_ARG_CLASS_BUFFER_BIT | _DtAct_ARG_CLASS_WILD_BIT)
#define _DtAct_ARG_TYPE_BITS (_DtAct_ARG_TYPE_WILD_BIT)
#define _DtAct_ARG_COUNT_BITS                                                  \
        (_DtAct_ARG_COUNT_LT_BIT | _DtAct_ARG_COUNT_GT_BIT |                   \
         _DtAct_ARG_COUNT_EQ_BIT | _DtAct_ARG_COUNT_WILD_BIT)
#define _DtAct_WINTYPE_BITS                                                    \
        (_DtAct_NO_STDIO_BIT | _DtAct_TERMINAL_BIT | _DtAct_PERM_TERM_BIT)
#define _DtAct_ARGS_USED_BITS (_DtAct_SINGLE_ARG | _DtAct_MULTI_ARG)

#define _DtAct_ACTION_BITS                                                     \
        (_DtAct_ACTION_TYPE_BITS | _DtAct_ARG_CLASS_BITS |                     \
         _DtAct_ARG_TYPE_BITS | _DtAct_ARG_COUNT_BITS | _DtAct_WINTYPE_BITS |  \
 ...
 */
#define IS_ARG_NONE_FOUND(mask)                                                \
        !(mask & (_DtAct_SINGLE_ARG_BIT | _DtAct_MULTI_ARG_BIT))
#define IS_ARG_SINGLE_ARG(mask) (mask & _DtAct_SINGLE_ARG_BIT)
#define IS_ARG_MULTI_ARG(mask) (mask & _DtAct_MULTI_ARG_BIT)

#define SET_ARG_NONE_FOUND(mask)                                               \
        (mask &= ~(_DtAct_SINGLE_ARG_BIT | _DtAct_MULTI_ARG_BIT))
#define SET_ARG_SINGLE_ARG(mask)                                               \
        ((mask |= _DtAct_SINGLE_ARG_BIT), (mask &= ~(_DtAct_MULTI_ARG_BIT)))
#define SET_ARG_MULTI_ARG(mask)                                                \
        ((mask |= _DtAct_MULTI_ARG_BIT), (mask &= ~(_DtAct_SINGLE_ARG_BIT)))
...
#define _DtAct_ACTION_REQUEST_BITS                                             \
        (_DtAct_REPROCESSING_BIT | _DtAct_TOO_MANY_MAPS_BIT |                  \
...
#define _DtAct_OBJ_DATA_BITS                                                   \
        (_DtAct_WRITE_OBJ_BIT | _DtAct_FILE_OBJ_BIT | _DtAct_DIR_OBJ_BIT |     \
         _DtAct_BUFFER_OBJ_BIT | _DtAct_STRING_OBJ_BIT |                       \
...
#define IS_DIR_OBJ(mask)                                                       \
        (mask & (_DtAct_UNKNOWN_IF_DIR_BIT | _DtAct_DIR_OBJ_BIT) ==            \
                    _DtAct_DIR_OBJ_BIT)
...
#define _DtActCHILD_DONE_BITS                                                  \
        ((_DtActCHILD_DONE) | (_DtActCHILD_FAILED) | (_DtActCHILD_CANCELED))
...
#define IS_INV_FINISHED(mask)                                                  \
        (!((mask)&_DtActINV_CMD_QUEUED) &&                                     \
         ((mask) & (_DtActINV_COMPLETE | _DtActINV_CANCEL)))
...
#define CALL_INV_CB(mask)                                                      \
        ((IS_INV_FINISHED(mask)) && (IS_INV_ID_RETURNED(mask)) &&              \
