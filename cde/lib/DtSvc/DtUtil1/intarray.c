...
/* ARGSUSED */
void *_DtShmProtoInitIntLst(int estimated_entries) {
...
int *_DtShmProtoAddIntLst(DtShmProtoIntList handle, int size, int *index) {
        intarray_t *ptr = (intarray_t *)handle;
        intent_t *e =
            (intent_t *)malloc(sizeof(intent_t) + sizeof(int) * (size - 1));
        e->size = size;
        e->next = NULL;
...
int _DtShmProtoSizeIntLst(DtShmProtoIntList handle) {
        intarray_t *ptr = (intarray_t *)handle;
        return (sizeof(int) * ptr->num_ints);
}

DtShmIntList _DtShmProtoCopyIntLst(DtShmProtoIntList handle,
                                   void *destination) {
        intarray_t *ptr = (intarray_t *)handle;
...
int _DtShmProtoDestroyIntLst(DtShmProtoIntList handle) {
        intarray_t *ptr = (intarray_t *)handle;
        intent_t *a = ptr->first;
        intent_t *b;
