...
#define _ActDb_DT_REQUEST_BITS (_ActDb_DT_REQ_NAME_SET | _ActDb_DT_SVC_SET)
#define _ActDb_DT_NOTIFY_BITS (_ActDb_DT_NTFY_NAME_SET | _ActDb_DT_NGROUP_SET)
#endif /* _DT_ALLOW_DT_MSGS */
#define _ActDb_TT_BITS                                                         \
        (_ActDb_TT_CLASS_SET | _ActDb_TT_SCOPE_SET | _ActDb_TT_OPERATION_SET | \
         _ActDb_TT_ARGN_MODE_SET | _ActDb_TT_ARGN_VTYP_SET |                   \
         _ActDb_TT_ARGN_RTYP_SET | _ActDb_TT_ARGN_VAL_SET |                    \
         _ActDb_TT_FILE_SET)
#define _ActDb_CMD_BITS                                                        \
        (_ActDb_EXEC_STRING_SET | _ActDb_CWD_SET | _ActDb_WINDOW_TYPE_SET |    \
         _ActDb_TERM_OPTS_SET)
#define _ActDb_MAP_BITS (_ActDb_MAP_ACTION_SET)

#define _ActDb_TT_ARGN_BITS                                                    \
        (_ActDb_TT_ARGN_MODE_SET | _ActDb_TT_ARGN_VTYP_SET |                   \
         _ActDb_TT_ARGN_RTYP_SET | _ActDb_TT_ARGN_VAL_SET)

#ifdef _DT_ALLOW_DT_MSGS
#define _ActDb_ARGN_BITS (_ActDb_TT_ARGN_BITS | _ActDb_DT_ARGN_VAL_SET)
#else
...
extern Boolean _DtActionConverter(DtDtsDbField *fields, DtDbPathId pathId,
