...
extern void _DtDtsDCConverter(DtDtsDbField *fields, DtDbPathId pathId,
                              char *hostPrefix, Boolean rejectionStatus);
extern void _DtDtsDAConverter(DtDtsDbField *fields, DtDbPathId pathId,
                              char *hostPrefix, Boolean rejectionStatus);
...
static void _DtOAConverter(DtDtsDbField *fields, DtDbPathId pathId,
                           char *hostPrefix, Boolean rejectionStatus) {
        ...
        if (_DtDtsDbGetRecordByName(dc_db, fields[0].fieldValue) ||
            _DtDtsDbGetRecordByName(da_db, fields[0].fieldValue)) {
                _DtSvcProcessUnlock();
                return;
        }
...
void _DtDbLoad(DtDirPaths *dirs) { _DtDtsMMUnLoad(); }
