...
extern void _DtInitializeCommandInvoker(Display *display, char *toolClass,
                                        char *applicationClass,
                                        DtSvcReceiveProc reloadDBHandler,
                                        XtAppContext appContext);
...
extern void _DtCommandInvokerExecute(
...
extern SPC_Channel_Ptr _DtSPCOpen(char *hostname, int iomode,
                                  char *errorMessage); /* MODIFIED */

extern int _DtSPCSpawn(char *path, char *context, char **args, char **env,
                       SPC_Channel_Ptr chan, char *execHost, char *contextHost,
                       char *contextDir, char *errorMessage); /* MODIFIED */
