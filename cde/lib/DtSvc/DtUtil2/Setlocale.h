...
struct _era_data {        /* defines an Emperor/Era time period */
        ...
        short origin_year; /* time axis origin for era (one of start_year or
                              end_year) */
...
extern unsigned char
    *__errptr; /* pointer to an area _errlocale() can use as a buffer */
...
extern unsigned char
    *__C_langinfo[];        /* default langinfo strings for the C locale */
