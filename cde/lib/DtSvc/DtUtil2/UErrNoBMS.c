 ...
 * (c) Copyright 1987, 1988, 1989, 1990, 1993, 1994, 1995 Hewlett-Packard
 * Company (c) Copyright 1993, 1994, 1995 International Business Machines Corp.
...
static char *errno_string(unsigned int errn, char *buff);
static void log_message(char *progName, char *help, char *message,
                        DtSeverity severity, int errnoset);
...
static void log_message(char *progName, char *help, char *message,
        ...
        case DtIgnore:
        DtInformation:
                msg_type = DtMsgLogInformation;
                break;
        case DtWarning:
                msg_type = DtMsgLogWarning;
                break;
        default:
                msg_type = DtMsgLogError;
        }
...
void _DtSimpleError(char *progName, DtSeverity severity, char *help,
                    char *format, ...) {
        va_list args;
...
void _DtSimpleErrnoError(char *progName, DtSeverity severity, char *help,
                         char *format, ...) {
        va_list args;
        char *message = (char *)malloc(MESSAGE_BUFFER);
