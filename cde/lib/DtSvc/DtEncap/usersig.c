 ...
 */
/*
 * File:         usersig.c $XConsortium: usersig.c /main/4 1996/06/21 17:33:04
 * ageorge $ Language:     C
 *
...
#define SIG_HASH_SIZE 32
        ...
        Xe_addsig((XeString) "SIGABRT",
                  SIGABRT); /* Add the XOPEN XPG3 signals */
...
/*-------------------------------------------------------------------------+*/
{
        ...
        /* ---------------------------- */
        case SIGABRT:
                return (XeString) "SIGABRT"; /* "SIGIOT" is an alias */
        case SIGALRM:
                return (XeString) "SIGALRM";
        case SIGFPE:
                return (XeString) "SIGFPE";
        case SIGHUP:
                return (XeString) "SIGHUP";
        case SIGILL:
                return (XeString) "SIGILL";
        case SIGINT:
                return (XeString) "SIGINT";
        case SIGKILL:
                return (XeString) "SIGKILL";
        case SIGPIPE:
                return (XeString) "SIGPIPE";
        case SIGQUIT:
                return (XeString) "SIGQUIT";
        case SIGSEGV:
                return (XeString) "SIGSEGV";
        case SIGTERM:
                return (XeString) "SIGTERM";
        case SIGUSR1:
                return (XeString) "SIGUSR1";
        case SIGUSR2:
                return (XeString) "SIGUSR2";
        case SIGCHLD:
                return (XeString) "SIGCHLD"; /* "SIGCLD" is an alias */
        case SIGCONT:
                return (XeString) "SIGCONT";
        case SIGSTOP:
                return (XeString) "SIGSTOP";
        case SIGTSTP:
                return (XeString) "SIGTSTP";
        case SIGTTIN:
                return (XeString) "SIGTTIN";
        case SIGTTOU:
                return (XeString) "SIGTTOU";

                /* 0 is a valid signal under XPG3, but it doesn't have a signal
                 * name */

        case 0:
                return (XeString) "ZERO";

                /* NOTE: we have ifdef's for cases that are duplicated by other
                 * values   */
                /*       included but contain no code.  This is so when you
                 * compare this */
                /*       code to the stuff in Xe_init_sig_table() above, you see
                 * a one   */
...
*/
        ...
        case SIGEMT:
                return (XeString) "SIGEMT";
#endif

#ifdef SIGBUS /*  hpux sun apollo */
        case SIGBUS:
                return (XeString) "SIGBUS";
#endif
...
*/
        ...
        case SIGURG:
                return (XeString) "SIGURG";
#endif

#ifdef SIGSYS /*  hpux sun apollo */
        case SIGSYS:
                return (XeString) "SIGSYS";
#endif

#ifdef SIGTRAP /*  hpux sun apollo */
        case SIGTRAP:
                return (XeString) "SIGTRAP";
#endif

#ifdef SIGPROF /*  hpux sun apollo */
        case SIGPROF:
                return (XeString) "SIGPROF";
#endif
...
*/
        ...
        case SIGVTALRM:
                return (XeString) "SIGVTALRM";
#endif

#ifdef SIGWINCH /*  sun apollo */
        case SIGWINCH:
                return (XeString) "SIGWINCH";
#endif
