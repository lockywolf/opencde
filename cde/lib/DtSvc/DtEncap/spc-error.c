...
/*----------------------------------------------------------------------+*/
{
        ...
        if (arg1) {
                /* The argument on the stack may be holding an int or a char
                 * pointer. */
                /* Always popping off a long into the value of arg2 works fine
                 */
                /* because the subsequent call to sprintf does the proper
                 * conversion via */
                /* "err->format". */
                arg2 = va_arg(ap, long);
        } else {
        ...
        if (SPC_who_am_i == SPC_I_AM_A_DAEMON) {
                ...
                if (err->severity == XeFatalError ||
                    err->severity == XeInternalError) {
...
/*----------------------------------------------------------------------+*/
int SPC_Make_Log_Filename(XeString name,
...
/*----------------------------------------------------------------------+*/
{
        ...
        if (!name || !*name) {
                ...
                if (strlen(name) > MAXPATHLEN)
                        _DtSimpleError(XeProgName, XeInternalError,
                                       XeString_NULL,
                                       (XeString) "String too long in "
                                                  "DTSPCD_Make_Log_Filename()");
...
/*----------------------------------------------------------------------+*/
int SPC_Open_Log(XeString filename,
...
/*----------------------------------------------------------------------+*/
{
        ...
        SPC_Format_Log((XeString) "*** DTSPCD logging started, file: `%s'",
                       spc_logfile);
...
/*----------------------------------------------------------------------+*/
{
        ...
        case SPC_Out_Of_Memory:
                spc_error_struct.format =
                    (XeString) "><Unable to allocate memory for internal SPC "
                               "operation\n Perhaps you need to add more swap "
                               "space to the system";
        ...
        case SPC_Bad_Argument:
                spc_error_struct.format =
                    (XeString) "><Bad argument to DTSPCD call";
        ...
        case SPC_Cannot_Exec:
                spc_error_struct.format =
                    (XeString) "><Cannot exec file %s.\nPerhaps your PATH "
                               "variable is incorrect.\nUse the following "
                               "errno value to further diagnose the problem.";
                spc_error_struct.severity = XeError;
                spc_error_struct.use_errno = TRUE;
                break;
        ...
        case SPC_No_Pty:
                spc_error_struct.format =
                    (XeString) "><Unable to allocate pty for a DTSPCD "
                               "channel.\nTry cleaning up some currently "
                               "running processes to release their ptys,\nor "
                               "reconfigure your kernel to increase the pty "
                               "limit.";
                spc_error_struct.severity = XeError;
                spc_error_struct.use_errno = TRUE;
                break;
        ...
        case SPC_Reading:
                spc_error_struct.format =
                    (XeString) "><Unexpected error reading data on connection "
                               "to host %s.\nUse the following errno value to "
                               "correct the problem.";
                spc_error_struct.severity = XeError;
                spc_error_struct.use_errno = TRUE;
                break;
        ...
        case SPC_Writing:
                spc_error_struct.format =
                    (XeString) "><Unexpected error writing data on channel";
                spc_error_struct.severity = XeError;
                spc_error_struct.use_errno = TRUE;
                break;
        ...
        case SPC_Unknown_Host:
                spc_error_struct.format =
                    (XeString) "><Unable to find a host entry for %s.\nTry "
                               "adding an entry in /etc/hosts for it.";
                spc_error_struct.severity = XeError;
                spc_error_struct.use_errno = FALSE;
                break;
        ...
        case SPC_Bad_Connect:
                spc_error_struct.format =
                    (XeString) "><Connect call failed to remote host "
                               "%s\nPerhaps the desktop is not installed on "
                               "the remote host,\nor the remote inetd program "
                               "needs to be restarted (via 'inetd -c'),\nor "
                               "the remote file /etc/inetd.conf does not have "
                               "an entry for the dtspcd process.\n";
                spc_error_struct.severity = XeError;
                spc_error_struct.use_errno = FALSE;
                break;
        ...
        case SPC_Bad_Reuse:
                spc_error_struct.format =
                    (XeString) "><Reuse socket option failed";
                spc_error_struct.severity = XeError;
                spc_error_struct.use_errno = TRUE;
                break;
        ...
        case SPC_Connection_EOF:
                if (SPC_who_am_i == SPC_I_AM_A_DAEMON)
                        spc_error_struct.format = (XeString) "><Client has "
                                                             "disconneted "
                                                             "(received EOF).";
                else
                        spc_error_struct.format =
                            (XeString) "><The dtspcd process on host '%s' has "
                                       "terminated.";
                spc_error_struct.severity = XeError;
                spc_error_struct.use_errno = FALSE;
                break;
        ...
        case SPC_Timeout:
                spc_error_struct.format =
                    (XeString) "><Internal timeout expired";
                spc_error_struct.severity = XeError;
                spc_error_struct.use_errno = FALSE;
                break;
        ...
        case SPC_Protocol:
                spc_error_struct.format =
                    (XeString) "><Illegal protocol request";
                spc_error_struct.severity = XeError;
                spc_error_struct.use_errno = FALSE;
                break;
        ...
        case SPC_Unexpected_Reply:
                spc_error_struct.format =
                    (XeString) "><Protocol error: unexpected reply";
                spc_error_struct.severity = XeError;
                spc_error_struct.use_errno = FALSE;
                break;
        ...
        case SPC_No_Channel:
                spc_error_struct.format =
                    (XeString) "><Cannot initialize channel";
                spc_error_struct.severity = XeError;
                spc_error_struct.use_errno = FALSE;
                break;
        ...
        case SPC_Illegal_Iomode:
                spc_error_struct.format =
                    (XeString) "><Inconsistent iomode value specified";
                spc_error_struct.severity = XeError;
                spc_error_struct.use_errno = FALSE;
                break;
        ...
        case SPC_No_Signal_Handler:
                spc_error_struct.format =
                    (XeString) "><Cannot set SIGCLD handler";
                spc_error_struct.severity = XeError;
                spc_error_struct.use_errno = TRUE;
                break;
        ...
        case SPC_Arg_Too_Long:
                spc_error_struct.format =
                    (XeString) "><Argument %.50s... to DTSPCD system call is "
        ...
        case SPC_Write_Prot:
                spc_error_struct.format =
                    (XeString) "><Error writing protocol request to host "
                               "%s.\nPerhaps the remote server has "
                               "crashed.\nUse the following errno value to "
        ...
        case SPC_Cannot_Open_Slave:
                spc_error_struct.format =
                    (XeString) "><Unable to open slave pty %s.\nUse the "
                               "following errno value to correct the problem";
                spc_error_struct.severity = XeError;
                spc_error_struct.use_errno = TRUE;
                break;

        case SPC_Protocol_Abort:
                spc_error_struct.format = (XeString) "><Received ABORT "
                                                     "protocol request on "
                                                     "connection to %s.";
                spc_error_struct.severity = XeFatalError;
                spc_error_struct.use_errno = FALSE;
        ...
        case SPC_Env_Too_Big:
                spc_error_struct.format =
                    (XeString) "><Environment variable %.50s... too "
                               "big,\nmaximum size is %d\n";
                spc_error_struct.severity = XeError;
                spc_error_struct.use_errno = FALSE;
                break;
        ...
        case SPC_Bad_Authentication:
                spc_error_struct.format =
                    (XeString) "><Cannot open user authentication file";
                spc_error_struct.severity = XeFatalError;
                spc_error_struct.use_errno = FALSE;
                break;
        ...
        case SPC_Cannot_Open_Log:
                spc_error_struct.format =
                    (XeString) "><Unable to open log file %s\nUse the "
                               "following errno value to correct the problem";
                spc_error_struct.severity = XeError;
                spc_error_struct.use_errno = FALSE;
                break;
        ...
        case SPC_Connection_Reset:
                spc_error_struct.format =
                    (XeString) "><Remote data connection to %s reset by "
                               "peer\nRemote host may not have an entry for "
                               "the local host in /usr/adm/inetd.sec.";
                spc_error_struct.severity = XeError;
                spc_error_struct.use_errno = FALSE;
                break;
        ...
        case SPC_Register_Username:
                spc_error_struct.format =
                    (XeString) "><Cannot register user --\nImproper password "
                               "or uid for user '%s' on remote host '%s'.";
                spc_error_struct.severity = XeError;
                spc_error_struct.use_errno = FALSE;
                break;
        ...
        case SPC_Register_Netrc:
                spc_error_struct.format =
                    (XeString) "><Cannot register user --\nUnable to create a "
                               "pathname to the authentication file '%s' on "
                               "host '%s'.";
                spc_error_struct.severity = XeError;
                spc_error_struct.use_errno = FALSE;
                break;
        ...
        case SPC_Register_Open:
                spc_error_struct.format =
                    (XeString) "><Cannot register user --\nUnable to open "
                               "authentication file '%s' on host '%s'.\nUse "
                               "the following errno value to diagnose the "
                               "problem.";
                spc_error_struct.severity = XeError;
                spc_error_struct.use_errno = TRUE;
                break;
        ...
        case SPC_Register_Handshake:
                spc_error_struct.format =
                    (XeString) "><Cannot register user --\nPerhaps user '%s' "
                               "does not have the same uid on host '%s'.";
                spc_error_struct.severity = XeError;
                spc_error_struct.use_errno = FALSE;
                break;
        ...
        case SPC_Bad_Termios_Mode:
                spc_error_struct.format =
                    (XeString) "><An error has been detected in the "
                               "TERMIOS_REQUEST data.\nThe item '%s' is not "
                               "recognized as a valid item for the Mode "
        ...
        case SPC_Bad_Termios_Speed:
                spc_error_struct.format =
                    (XeString) "><An error has been detected in the "
                               "TERMIOS_REQUEST data.\nThe item '%s' is not "
                               "recognized as a valid item for a speed "
                               "setting.\nThe item has been ignored.\n";
                spc_error_struct.severity = XeError;
                spc_error_struct.use_errno = FALSE;
                break;
        ...
        case SPC_Bad_Termios_CC:
                spc_error_struct.format =
                    (XeString) "><An error has been detected in the "
                               "TERMIOS_REQUEST data.\nThe item '%s' is not "
                               "recognized as a valid item for a Control "
                               "Character name/value pair.\nThe item has been "
                               "ignored.\n";
                spc_error_struct.severity = XeError;
                spc_error_struct.use_errno = FALSE;
                break;
        ...
        case SPC_Bad_Termios_Proto:
                spc_error_struct.format =
                    (XeString) "><An error has been detected in the "
                               "TERMIOS_REQUEST data.\nThe string does not "
                               "have the correct number of fields -- %s.\n";
                spc_error_struct.severity = XeError;
                spc_error_struct.use_errno = FALSE;
                break;
        ...
        case SPC_Bad_Signal_Name:
                spc_error_struct.format =
                    (XeString) "><The signal '%s' is not supported on this "
                               "machine.\nThe DTSPCD signal request has been "
                               "ignored.\n";
                spc_error_struct.severity = XeError;
                spc_error_struct.use_errno = FALSE;
                break;
        ...
        case SPC_Bad_Signal_Value:
                spc_error_struct.format =
                    (XeString) "><The signal %d is not supported by the "
                               "XeSignalToName() routine.\nIt can not be sent "
                               "via DTSPCD to a remote machine.\n";
                spc_error_struct.severity = XeError;
                spc_error_struct.use_errno = FALSE;
                break;
        ...
        case SPC_Bad_Signal_Format:
                spc_error_struct.format =
                    (XeString) "><The APPLICATION_SIGNAL DTSPCD data '%s' is "
                               "not recognized.\nIt is expected to be a signal "
                               "name or a signal number.\n";
                spc_error_struct.severity = XeError;
                spc_error_struct.use_errno = FALSE;
                break;
        ...
        case SPC_Bad_tc_Call:
                spc_error_struct.format =
                    (XeString) "><The terminal control call to '%s' failed.";
                spc_error_struct.severity = XeError;
                spc_error_struct.use_errno = TRUE;
                break;
        ...
        case SPC_cannot_Chdir:
                spc_error_struct.format =
                    (XeString) "><Cannot cd to directory '%s'.";
                spc_error_struct.severity = XeError;
                spc_error_struct.use_errno = TRUE;
                break;

        case SPC_Bad_Permission:
                spc_error_struct.format = (XeString) "><Incorrect permission "
                                                     "on DTSPCD Authentication "
                                                     "file.";
                spc_error_struct.severity = XeError;
                spc_error_struct.use_errno = TRUE;
                break;
        ...
        case SPC_Cannot_Create_Netfilename:
                spc_error_struct.format =
                    (XeString) "><Cannot create a pathname to the current "
        ...
        case SPC_Protocol_Version_Error:
                spc_error_struct.format =
                    (XeString) "><SPC protocol version mismatch.  The local "
                               "version is %d, but the version of the SPC "
                               "Daemon is %d.  This operation requires "
                               "equivalent protocol versions.";
                spc_error_struct.severity = XeError;
                spc_error_struct.use_errno = FALSE;
                break;
        ...
        case SPC_Buffer_Overflow:
                spc_error_struct.format = (XeString) "><Attempted Buffer "
                                                     "Overflow from host "
                                                     "%s.\nConnection dropped.";
                spc_error_struct.severity = XeError;
                spc_error_struct.use_errno = FALSE;
