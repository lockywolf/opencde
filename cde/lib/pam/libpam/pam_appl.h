 ...
 */
extern int
pam_start(const char *service_name,        /* Service Name */
 ...
 */
extern int pam_end(pam_handle_t *pamh, /* handle from pam_start() */
 ...
 */
extern int pam_set_item(pam_handle_t *pamh, /* PAM handle */
 ...
 */
extern int pam_get_item(const pam_handle_t *pamh, /* PAM handle */
                        int item_type, /* Type of object - see below */
...
extern int pam_get_user(pam_handle_t *pamh, /* PAM handle */
                        char **user,        /* User Name */
 ...
 */
extern char *pam_strerror(pam_handle_t *pamh, /* pam handle */
