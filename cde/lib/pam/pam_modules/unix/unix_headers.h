...
/* from unix_utils.c */
extern int ck_perm(pam_handle_t *, int, char *, struct passwd **,
                   struct spwd **, int *, void **, uid_t, int, int);
...
extern int update_authtok_file(pam_handle_t *, char *, char **, struct passwd *,
                               int, int);
#ifdef PAM_NIS
extern int update_authtok_nis(pam_handle_t *, char *, char **, char *, char *,
                              struct passwd *, int, int);
#endif
#ifdef PAM_NISPLUS
extern int update_authtok_nisplus(pam_handle_t *, char *, char *, char **,
                                  char *, char *, char *, int, struct passwd *,
                                  char *, int, nis_result *, nis_result *, int,
                                  int);
#endif
