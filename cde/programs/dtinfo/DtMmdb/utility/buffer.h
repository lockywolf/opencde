...
class buffer {
      ...
      public:
        ...
        int remaining_sz() const {
                return v_bufsz - int(v_eptr - v_aptr);
        };                                         // remaining space
        ...
        buffer &put(const unsigned char,
                    Boolean exp_buf = false);            // append unsigned char
        buffer &put(const int, Boolean exp_buf = false); // append an int
        buffer &put(const unsigned int,
                    Boolean exp_buf = false); // append a unsigned int
        buffer &put(const long, Boolean exp_buf = false); // append a long
        buffer &put(const unsigned short,
                    Boolean exp_buf = false);                // append a short
        buffer &put(const float y, Boolean exp_buf = false); // put a float
        buffer &put(const char *, int,
                    Boolean exp_buf = false); // append a string
