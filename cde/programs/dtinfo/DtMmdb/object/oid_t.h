...
class oid_t {
      public:
        ...
        oid_t(const oid_t &x)
            : v_c_code(x.v_c_code), v_i_code(x.v_i_code),
              v_e_code(x.v_e_code){};
        ~oid_t(){};
      ...
      protected:
        ...
        void set_c_code(c_code_t c) { v_c_code = c; }
        void set_i_code(i_code_t i) { v_i_code = i; }
        void set_e_code(e_code_t e) { v_e_code = e; }
