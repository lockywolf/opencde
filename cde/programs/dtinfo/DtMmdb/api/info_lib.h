...
class info_lib : public primitive {
      ...
      public:
        ...
        // define a base
        Boolean define_info_base(char *base_name, char *base_desc,
                                 char *spec_file_path);
        ...
        info_base **getInfobasesByComponent(char **locator_strings, int count,
                                            enum TestSelector sel);
      ...
      protected:
        ...
        info_base *_init_info_base(const char *new_db_path,
                                   const char *base_name, const char *base_desc,
                                   const char *base_uid,
