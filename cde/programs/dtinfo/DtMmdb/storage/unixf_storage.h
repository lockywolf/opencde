...
class unixf_storage : public abs_storage, public fstream {
      ...
      public:
        ...
        unixf_storage(char *file_path, char *file_nm, rep_policy *,
        ...
        int get_str_ptr(mmdb_pos_t, char *&, int &) { return -1; };

        int deleteString(mmdb_pos_t, Boolean = false) { return -1; };
        int allocString(mmdb_pos_t &, int, char *&, int = 0) { return -1; };
