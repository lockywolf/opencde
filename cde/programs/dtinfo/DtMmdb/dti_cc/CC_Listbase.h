...
class CC_Listbase {
      ...
      public:
        CC_Listbase() : f_head(NULL), f_tail(NULL), f_length(0) {}
        ...
        CC_Link_base *first() const { return (f_head); }

        CC_Link_base *last() const { return (f_tail); }
...
class CC_List_Iterator_base {
      ...
      public:
        ...
        CC_Link_base *item() const { return (f_current); }
