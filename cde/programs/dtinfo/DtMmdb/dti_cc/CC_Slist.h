...
template <class T> class CC_Link : private CC_Link_base {
      ...
      private:
        CC_Link(T *element) : f_element(element) {}
...
template <class T> class CC_TPtrSlist : public CC_Listbase {
      ...
      public:
        ...
        CC_Boolean get_destructed() const { return (destructed); }

        void set_destructed(CC_Boolean what) { destructed = what; }
};

template <class T> class CC_TPtrSlistIterator : public CC_List_Iterator_base {
        friend class CC_TPtrSlist<T>;
      ...
      public:
        ...
        T *key() const {
                CC_Link<T> *link_item =
                    (CC_Link<T> *)CC_List_Iterator_base::item();
                if (link_item) {
...
template <class T> class CC_TValSlist : public CC_Listbase {
...
template <class T> class CC_TValSlistIterator : public CC_List_Iterator_base {
