...
class Renderer : public Destructable {
      public:
        ...
        virtual unsigned int BeginElement(const Element &element,
        ...
        virtual void data(const char *data, unsigned int size) = 0;
        ...
        virtual void EndElement(const Symbol &element_name) = 0;
        ...
        // These two functions allow a renderer to set up internal variable
        // table.
         ...
         *
         * non zero return value means that it has been entered into the
         * internal table
         *
         * If gRenderer is set to null while style sheet is parsed, the
         * accept() function will not be called from style.y.
         * ************************************************************** */
        virtual unsigned int accept(const char *, const Expression *) {
                return 0;
        }
