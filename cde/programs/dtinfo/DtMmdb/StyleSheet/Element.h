...
class Element {
      public:
        ...
        Element(const Symbol &gi, unsigned int sibling_number = 0,
                AttributeList *attrs = 0, AttributeList *olias_attrs = 0,
        ...
        int relatively_last_child() const { return f_relatively_last_child; }
...
inline ostream &operator<<(ostream &o, const Element &e) { return e.print(o); }
