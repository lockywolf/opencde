...
/* infolib */
/*****************************************************/
int DtMmdbOpenInfoLib DtMmdb_PROTO3(const char *infolib_path,
...
/* bookcase */
/*****************************************************/
int DtMmdbGetBookCaseByName DtMmdb_PROTO2(int infolib_descriptor,
                                          const char *name);

int DtMmdbGetBookCaseByIndex DtMmdb_PROTO2(int infolib_descriptor, int index);

int DtMmdbGetBookCaseByLoc DtMmdb_PROTO2(int infolib_descriptor,
                                         const char *locator);

int *DtMmdbGetBookCaseByLocs DtMmdb_PROTO2(int infolib_descriptor,
                                           const char **locators);

DtMmdbBookCaseInfo *DtMmdbBookCaseGetInfo
DtMmdb_PROTO1(int bookcase_descriptor);
...
const char *DtMmdbSectionGetLongTitle DtMmdb_PROTO2(DtMmdbInfoRequest *request,
                                                    unsigned int *title_length);

const char *DtMmdbSectionGetShortTitle
DtMmdb_PROTO2(DtMmdbInfoRequest *request, unsigned int *title_length);

const char *DtMmdbSectionGetData DtMmdb_PROTO2(DtMmdbInfoRequest *request,
...
DtMmdbHandle *DtMmdbSectionGetBookId DtMmdb_PROTO1(DtMmdbInfoRequest *request);

DtMmdbHandle *DtMmdbSectionGetStyleSheetId
DtMmdb_PROTO1(DtMmdbInfoRequest *request);

/*****************************************************/
/* TOC */
/*****************************************************/
DtMmdbHandle *DtMmdbTocGetParentId DtMmdb_PROTO1(DtMmdbInfoRequest *request);

DtMmdbHandle **DtMmdbTocGetChildIds DtMmdb_PROTO2(DtMmdbInfoRequest *request,
...
/* Locator */
/*****************************************************/
const char *DtMmdbLocatorGetSectionLoc
DtMmdb_PROTO1(DtMmdbInfoRequest *request);
...
/* Graphic */
/*****************************************************/
const char *DtMmdbGraphicGetData DtMmdb_PROTO2(DtMmdbInfoRequest *request,
                                               unsigned int *data_length);
...
/* Stylesheet */
/*****************************************************/
const char *DtMmdbStylesheetGetName DtMmdb_PROTO1(DtMmdbInfoRequest *request);

const char *DtMmdbStylesheetGetata DtMmdb_PROTO2(DtMmdbInfoRequest *request,
                                                 unsigned int *data_length);
...
const char *DtMmdbBookGetShortTitle DtMmdb_PROTO2(DtMmdbInfoRequest *request,
                                                  unsigned int *length);

const char *DtMmdbBookGetLongTitle DtMmdb_PROTO2(DtMmdbInfoRequest *request,
                                                 unsigned int *length);

int DtMmdbBookGetSeqNum DtMmdb_PROTO1(DtMmdbInfoRequest *request);

const char *DtMmdbBookGetSeqLIcense DtMmdb_PROTO2(DtMmdbInfoRequest *request,
                                                  unsigned int *length);

DtMmdbHandle **DtMmdbBookGetTabList DtMmdb_PROTO2(DtMmdbInfoRequest *request,
                                                  unsigned int *length);
...
DtMmdbInfoRequest *newDtMmdbInfoRequestWithSecondaryOid(int bc_id,
                                                        char *oid_str);
