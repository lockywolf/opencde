...
class WXmTextField : public WXmPrimitive {
      public:
        ...
        inline void ClearSelection(Time t) const {
                XmTextFieldClearSelection(widget, t);
        }
        ...
        inline Boolean GetEditable() const {
        ...
        inline char *GetSelection() const {
        ...
        inline Boolean Paste(Widget twidget) const {
                return XmTextFieldPaste(twidget);
        }
        ...
        inline void Replace(XmTextPosition from, XmTextPosition to,
                            char *s) const {
                XmTextFieldReplace(widget, from, to, s);
        }
        ...
        inline void SetString(char *str) const {
