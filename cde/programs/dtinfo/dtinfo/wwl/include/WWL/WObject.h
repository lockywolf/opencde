...
class WObject {
      ...
      public:
        ...
        inline WObject(Widget w) { widget = w; }
        inline WObject(const WObject &w) { widget = w.widget; }
        WObject(const WComposite &super, WidgetClass c, const char *name = NULL,
                ArgList args = NULL, Cardinal card = 0);
        WObject(const WComposite &super, int automanage, WidgetClass c,
        ...
        inline int operator!=(int i) { return (Widget)(size_t)i != widget; }
#endif
        inline WObject &operator=(const Widget w) {
                widget = w;
                return *this;
        }
        ...
        inline void AddCallbacks(const char *name,
                                 XtCallbackList callbacks) const {
                XtAddCallbacks(widget, name, callbacks);
        }

        inline void RemoveCallbacks(const char *name,
                                    XtCallbackList callbacks) const {
