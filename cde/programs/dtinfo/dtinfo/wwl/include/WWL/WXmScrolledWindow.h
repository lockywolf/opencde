...
class WXmScrolledWindow : public WXmManager {
      public:
        ...
        DEFINE_GETTER_SETTER(ScrollBarPlacement, unsigned char,
                             "scrollBarPlacement")
        DEFINE_GETTER_SETTER(ScrolledWindowMarginWidth, short,
                             "scrolledWindowMarginWidth")
        DEFINE_GETTER_SETTER(ScrolledWindowMarginHeight, short,
        ...
        inline void SetAreas(WXmScrollBar hsb, WXmScrollBar vsb,
                             WObject work) const {
                XmScrolledWindowSetAreas(widget, (Widget)hsb, (Widget)vsb,
                                         (Widget)work);
        }
};
