...
class WXmManager : public WConstraint {
      public:
        ...
        DEFINE_GETTER_SETTER(BottomAttachment, unsigned char,
                             "bottomAttachment")
        ...
        DEFINE_GETTER_SETTER(ChildHorizontalAlignment, unsigned char,
                             "childHorizontalAlignment")
        DEFINE_GETTER_SETTER(ChildHorizontalSpacing, Dimension,
                             "childHorizontalSpacing")
        DEFINE_GETTER_SETTER(ChildVerticalAlignment, unsigned char,
        ...
        inline void LeftAttachment(unsigned char to_what, Widget w) {
                Arg a;
                a.name = CASTRNAM "leftAttachment";
                a.value = (XtArgVal)to_what;
                _Set(a);
                a.name = CASTRNAM "leftWidget";
                a.value = (XtArgVal)w;
                _Set(a);
        }
        ...
        inline void RightAttachment(unsigned char to_what, Widget w) {
                Arg a;
                a.name = CASTRNAM "rightAttachment";
                a.value = (XtArgVal)to_what;
                _Set(a);
                a.name = CASTRNAM "rightWidget";
                a.value = (XtArgVal)w;
                _Set(a);
        }
        ...
        inline void TopAttachment(unsigned char to_what, Widget w) {
                Arg a;
                a.name = CASTRNAM "topAttachment";
                a.value = (XtArgVal)to_what;
                _Set(a);
                a.name = CASTRNAM "topWidget";
                a.value = (XtArgVal)w;
                _Set(a);
        }
        ...
        inline void BottomAttachment(unsigned char to_what, Widget w) {
                Arg a;
                a.name = CASTRNAM "bottomAttachment";
                a.value = (XtArgVal)to_what;
                _Set(a);
                a.name = CASTRNAM "bottomWidget";
                a.value = (XtArgVal)w;
                _Set(a);
        }
