...
class WXmCommand : public WXmSelectionBox {
      public:
        ...
        inline Widget GetChild(unsigned char child) const {
                return XmCommandGetChild(widget, child);
        }
        inline void SetValue(WXmString str) const {
                XmCommandSetValue(widget, str);
        }
        inline void AppendValue(WXmString str) const {
                XmCommandAppendValue(widget, str);
        }
        ...
        DEFINE_GETTER_SETTER(HistoryVisibleItemCount, int,
