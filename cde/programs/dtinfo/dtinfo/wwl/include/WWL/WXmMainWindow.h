...
class WXmMainWindow : public WXmScrolledWindow {
      public:
        ...
        inline void SetAreas(Widget mb, Widget c, Widget hsb, Widget vsb,
                             Widget w) const {
        ...
        DEFINE_GETTER_SETTER(MainWindowMarginWidth, short,
                             "mainWindowMarginWidth")
        DEFINE_GETTER_SETTER(MainWindowMarginHeight, short,
