...
int cgm_defs(cgm_s_type *cgm_s) {
        ...
        for (i = 0; i < 3; ++i)
                cgm_s->backcolr[i] = cgm_s->cvextent[3 + i];
        /* control elements */
        cgm_s->vdcintprec = 16;
        ...
        for (i = 0; i < 3; ++i)
                cgm_s->auxcolr[i] = cgm_s->cvextent[i];
        cgm_s->auxcolr[3] = 1;
        cgm_s->transp = ON;
        for (i = 0; i < 4; ++i) {
        ...
        cgm_s->lwidth.s = 1.0;
        for (i = 0; i < 3; ++i)
                cgm_s->lcolr[i] = cgm_s->cvextent[i];
        cgm_s->lcolr[3] = 1;
        cgm_s->mbindex = 1;
        cgm_s->mtype = 3;
        ...
        cgm_s->msize.s = 1.0;
        for (i = 0; i < 3; ++i)
                cgm_s->mcolr[i] = cgm_s->cvextent[i];
        cgm_s->mcolr[3] = 1;
        cgm_s->tbindex = 1;
        cgm_s->tfindex = 1;
        ...
        cgm_s->cspace = 0.0;
        for (i = 0; i < 3; ++i)
                cgm_s->tcolr[i] = cgm_s->cvextent[i];
        cgm_s->tcolr[3] = 1;
        ...
        for (i = 0; i < 3; ++i)
                cgm_s->fillcolr[i] = cgm_s->cvextent[i];
        cgm_s->fillcolr[3] = 1;
        cgm_s->hatchindex = 1;
        cgm_s->patindex = 1;
        cgm_s->edbindex = 1;
        ...
        cgm_s->ewidth.s = 1.0;
        for (i = 0; i < 3; ++i)
                cgm_s->ecolr[i] = cgm_s->cvextent[i];
        cgm_s->ecolr[3] = 1;
        cgm_s->evis = OFF;
        for (i = 0; i < 2; ++i) {
        ...
        if (!(cgm_s->coltab =
                  (int *)malloc(3 * sizeof(int) * (cgm_s->maxcind + 1)))) {
                burp(stderr, "couldn't get memory for def colour table\n");
                return (0);
        }
        for (i = 0; i < NO_ASPSF; ++i)
                cgm_s->aspsflags[i] = F_INDIV;
...
int cgm_assign(cgm_s_type *cgm_1, cgm_s_type *cgm_2) {
        ...
        for (i = 0; i < 3; ++i)
                cgm_2->backcolr[i] = cgm_1->backcolr[i];
        /* control elements */
        ...
        for (i = 0; i < 4; ++i)
                cgm_2->auxcolr[i] = cgm_1->auxcolr[i];
        ...
        for (i = 0; i < 4; ++i)
                cgm_2->fillcolr[i] = cgm_1->fillcolr[i];
        ...
        if (cgm_2->maxcind < cgm_1->maxcind) {
                if (cgm_2->coltab) {
                        if (!(cgm_2->coltab = (int *)realloc(
                                  cgm_2->coltab,
                                  3 * sizeof(int) * (cgm_1->maxcind + 1)))) {
                                burp(stderr,
                                     "couldn't reallocate mem for coltab\n");
                                return (0);
                        }
                } else {
                        if (!(cgm_2->coltab = (int *)malloc(
                                  3 * sizeof(int) * (cgm_1->maxcind + 1)))) {
                                burp(stderr,
                                     "couldn't allocate mem for coltab\n");
                                return (0);
                        }
                }
        ...
        for (i = 0; i < NO_ASPSF; ++i)
                cgm_2->aspsflags[i] = cgm_1->aspsflags[i];
