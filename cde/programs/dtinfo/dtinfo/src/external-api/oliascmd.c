...
static void activate(Widget w, XtPointer client_data, XtPointer call_data) {
...
int main(int argc, char *argv[]) {
        ...
        toplevel = XtVaAppInitialize(&app_context, "OliasCmd", NULL, 0, &argc,
                                     argv, NULL, 0);
...
#define WIDGETM XtVaCreateManagedWidget
        ...
        XtAddCallback(quit, XmNactivateCallback, (XtCallbackProc)exit,
                      toplevel);
        ...
        XtVaSetValues(toplevel, XmNminWidth, (int)width, XmNminHeight,
                      (int)height, XmNmaxHeight, (int)height, NULL);
