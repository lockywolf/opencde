...
void dispatch_targets(XEvent *report) {
        ...
        XChangeProperty(report->xselectionrequest.display,
                        ...
                        report->xselectionrequest.property, XA_ATOM, 32,
        ...
        status =
            XSendEvent(report->xselectionrequest.display,
                       report->xselectionrequest.requestor, True, 0, &reply);
}
...
void dispatch_timestamp(XEvent *report) {
        ...
        XChangeProperty(report->xselectionrequest.display,
                        report->xselectionrequest.requestor,
                        report->xselectionrequest.property, XA_INTEGER, 32,
                        PropModeReplace, (unsigned char *)&g.time, 1);
