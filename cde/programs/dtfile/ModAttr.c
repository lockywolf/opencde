...
static void Create(Display *display, Widget parent, Widget *return_widget,
        ...
        XmStringFree(label_string);
        XtAddCallback(link_label, XmNhelpCallback,
        ...
        label_string = XmStringCreateLocalized(
            ((char *)GETMESSAGE(21, 3, "Owner Name: ")));
        n = 0;
        XtSetArg(args[n], XmNlabelString, label_string);
        n++;
        XtSetArg(args[n], XmNleftAttachment, XmATTACH_FORM);
        ...
        XmStringFree(label_string);
        XtAddCallback(ownerLabel, XmNhelpCallback,
                      (XtCallbackProc)HelpRequestCB,
                      HELP_PROPERTIES_DIALOG_STR);

        label_string = XmStringCreateLocalized(
            ((char *)GETMESSAGE(21, 4, "Group Name: ")));
        n = 0;
        XtSetArg(args[n], XmNlabelString, label_string);
        n++;
        XtSetArg(args[n], XmNleftAttachment, XmATTACH_FORM);
        ...
        XmStringFree(label_string);
        XtAddCallback(groupLabel, XmNhelpCallback,
                      (XtCallbackProc)HelpRequestCB,
                      HELP_PROPERTIES_DIALOG_STR);
        ...
        label_string = XmStringCreateLocalized(
            ((char *)GETMESSAGE(21, 5, "Permissions:")));
        n = 0;
        XtSetArg(args[n], XmNlabelString, label_string);
        n++;
        XtSetArg(args[n], XmNleftAttachment, XmATTACH_FORM);
        ...
        n++;
        permissionLabel =
            XmCreateLabelGadget(form, "permission_label", args, n);
        ...
        label_string =
            XmStringCreateLocalized(((char *)GETMESSAGE(21, 6, "Read")));
        n = 0;
        XtSetArg(args[n], XmNlabelString, label_string);
        n++;
        ...
        label_string =
            XmStringCreateLocalized(((char *)GETMESSAGE(21, 7, "Write")));
        n = 0;
        XtSetArg(args[n], XmNlabelString, label_string);
        n++;
        XtSetArg(args[n], XmNleftAttachment, XmATTACH_POSITION);
        ...
        n++;
        writeLabel =
            XmCreateLabelGadget(permissionForm, "write_label", args, n);
        XtManageChild(writeLabel);
        XmStringFree(label_string);
        XtAddCallback(writeLabel, XmNhelpCallback,
                      (XtCallbackProc)HelpRequestCB,
                      HELP_PROPERTIES_DIALOG_STR);
        ...
        n++;
        executeLabel =
            XmCreateLabelGadget(permissionForm, "execute_label", args, n);
        XtAddCallback(executeLabel, XmNhelpCallback,
                      (XtCallbackProc)HelpRequestCB,
                      HELP_PROPERTIES_DIALOG_STR);
        ...
        label_string =
            XmStringCreateLocalized(((char *)GETMESSAGE(21, 9, "Owner:")));
        n = 0;
        XtSetArg(args[n], XmNlabelString, label_string);
        n++;
        XtSetArg(args[n], XmNleftAttachment, XmATTACH_POSITION);
        ...
        n++;
        ownerPLabel =
            XmCreateLabelGadget(permissionForm, "owner_label", args, n);
        XtManageChild(ownerPLabel);
        XmStringFree(label_string);
        XtAddCallback(ownerPLabel, XmNhelpCallback,
                      (XtCallbackProc)HelpRequestCB,
                      HELP_PROPERTIES_DIALOG_STR);
        ...
        XtAddCallback(ownerWrite, XmNhelpCallback,
                      (XtCallbackProc)HelpRequestCB,
                      HELP_PROPERTIES_DIALOG_STR);
        ...
        XtSetArg(args[n], XmNshadowThickness, 0);
        n++;
        ownerExecute = XmCreateToggleButtonGadget(permissionForm,
                                                  "owner_execute", args, n);
        XtManageChild(ownerExecute);
        XtAddCallback(ownerExecute, XmNhelpCallback,
                      (XtCallbackProc)HelpRequestCB,
                      HELP_PROPERTIES_DIALOG_STR);
        ...
        n++;
        groupPLabel =
            XmCreateLabelGadget(permissionForm, "group_label", args, n);
        XtManageChild(groupPLabel);
        XmStringFree(label_string);
        XtAddCallback(groupPLabel, XmNhelpCallback,
                      (XtCallbackProc)HelpRequestCB,
                      HELP_PROPERTIES_DIALOG_STR);
        ...
        XtAddCallback(groupWrite, XmNhelpCallback,
                      (XtCallbackProc)HelpRequestCB,
                      HELP_PROPERTIES_DIALOG_STR);
        ...
        XtSetArg(args[n], XmNshadowThickness, 0);
        n++;
        groupExecute = XmCreateToggleButtonGadget(permissionForm,
                                                  "group_execute", args, n);
        XtManageChild(groupExecute);
        XtAddCallback(groupExecute, XmNhelpCallback,
                      (XtCallbackProc)HelpRequestCB,
                      HELP_PROPERTIES_DIALOG_STR);
        ...
        n++;
        otherPLabel =
            XmCreateLabelGadget(permissionForm, "other_label", args, n);
        XtManageChild(otherPLabel);
        XmStringFree(label_string);
        XtAddCallback(otherPLabel, XmNhelpCallback,
                      (XtCallbackProc)HelpRequestCB,
                      HELP_PROPERTIES_DIALOG_STR);
        ...
        XtAddCallback(otherWrite, XmNhelpCallback,
                      (XtCallbackProc)HelpRequestCB,
                      HELP_PROPERTIES_DIALOG_STR);
        ...
        XtSetArg(args[n], XmNshadowThickness, 0);
        n++;
        otherExecute = XmCreateToggleButtonGadget(permissionForm,
                                                  "other_execute", args, n);
        XtManageChild(otherExecute);
        XmStringFree(empty_label_string);
        XtAddCallback(otherExecute, XmNhelpCallback,
                      (XtCallbackProc)HelpRequestCB,
                      HELP_PROPERTIES_DIALOG_STR);

        /* Create the optional label and push button to invoke a file-system
         * specific dialog */
        /* Bottom and top attachments will be made when we know which of these
         * widgets will be mannaged */
        /* The callback will be registered in SetValues after the config file
         * has been read */
        ...
        n++;
        fsWarning =
            XmCreateLabelGadget(permissionForm, "fs_warning_label", args, n);
        ...
        XtSetArg(args[n], XmNleftPosition, 5);
        n++;
        fsPushButton = XmCreatePushButtonGadget(permissionForm,
                                                "fs_dialog_button", args, n);
...
static void InstallClose(ModAttrRec *modAttr_rec, XtCallbackProc callback,
        ...
        XmAddWMProtocolCallback(modAttr_rec->shell, delete_window_atom,
...
static XtPointer GetResourceValues(XrmDatabase data_base, char **name_list) {
        ...
        _DtDialogGetResources(data_base, name_list, MODIFY_ATTR,
                              (char *)modAttr_data, resources,
...
static void SetValues(ModAttrRec *modAttr_rec, ModAttrData *modAttr_data) {
        ...
        if ((user_data && user_data->pw_uid == getuid()) ||
            effective_user == root_user) {
                ...
                if (effective_user == root_user) {
                        fullPath = ResolveLocalPathName(
                            modAttr_data->host, modAttr_data->directory,
                            modAttr_data->name, home_host_name, &tt_status);

                        if (TT_OK == tt_status) {
                                /* Check for access rights (e.g. NFS mounted
                                 * filesystem)  */
                                mode = chmod(fullPath,
                                             modAttr_data->accessBits +
                ...
                if (effective_user == root_user) {
                        ...
                        if (modAttr_data->owner) {
                                if (getpwnam(modAttr_data->owner) == NULL) {
                                        char *newstring = XtMalloc(
                                            strlen(modAttr_data->owner) +
                                            strlen(
                        ...
                        if (modAttr_data->owner) {
                                if (getpwnam(modAttr_data->owner) == NULL) {
                                        ...
                                        sprintf(newstring, "%s ( %s ) ",
                                                ...
                                                GETMESSAGE(21, 19, "Unknown"));
                                        labelString =
                                            XmStringCreateLocalized(newstring);
                                        XtFree(newstring);
                                } else
        ...
        if (modAttr_data->filetype) {
                ...
                if ((ptr = (char *)DtDtsDataTypeToAttributeValue(
                        ...
                        string =
                            XmStringCreateLocalized(modAttr_data->filetype);
                }
        } else
                string = XmStringCreateLocalized(" ");
        ...
        if (modAttr_data->pixmapData)
                XtSetArg(args[1], XmNimageName,
                         modAttr_data->pixmapData->iconFileName);
        else
        ...
        XmStringFree(string);
        fullPath = ResolveLocalPathName(
            modAttr_data->host, modAttr_data->directory, modAttr_data->name,
        ...
        if (fsDialogAvailable(fullPath, &modAttr_rec->fileSystem)) {
                ...
                {
                        string = XmStringCreateLocalized(
                            modAttr_rec->fileSystem.buttonLabel);
                        n = 0;
                        ...
                        */
                {
                        n = 0;
                        string = XmStringCreateLocalized(
                            modAttr_rec->fileSystem.warningMessage);
                        XtSetArg(args[n], XmNlabelString, string);
                        n++;
                        XtSetArg(args[n], XmNtopAttachment, XmATTACH_WIDGET);
                        n++;
                ...
                /* the fs dialog pushbutton is created with a callback to cancel
                 * the   */
                /* permissions dialog ... here that callback is removed if that
                 * was    */
                /* requested by a directive in the configuration file
                 * dtfile.config    */
                if (!modAttr_rec->fileSystem.dismissStdPermissionDialog) {
                        XtRemoveAllCallbacks(modAttr_rec->fsPushButton,
                                             XmNactivateCallback);
                }
                XtAddCallback(modAttr_rec->fsPushButton, XmNactivateCallback,
                ...
                if (strlen(modAttr_rec->fileSystem.warningMessage) ==
                    0) /* fs dialog not available and there is no warning
                          message */
                {
                        ...
                        n++;
                        XtSetValues(modAttr_rec->otherPLabel, args, n);
                } else /* fs dialog is not available and there is a warning
                          message */
                {
                        n = 0;
                        XtSetArg(args[n], XmNbottomAttachment, XmATTACH_NONE);
...
static void FreeValues(ModAttrData *modAttr_data) {
        ...
        if (modAttr_data->pixmapData) {
                ...
                DtDtsFreeAttributeValue(
                    modAttr_data->pixmapData->instanceIconName);
...
static void OkCallback(Widget w, ModAttrApply *apply_data,
        ...
        if (result == GMA_VALID) {
                /* Check to see if the file we are changing is the CURRENT
                 * directory. If it is we need to see if after the changes, the
                 * user will have permissions to read this folder. If he/she
                 * doesn't we want to warn the user that this will be the case
                 * and allow them to back out of the change.  If they don't want
                 * to back out of the change, we need to make the change, then
                 * move them up to the parent directory.
                 */
                if (strcmp(old->name, ".") == 0) {
                        /* It is the current directory, now we need to test the
                         * cases where by changing permissions the user would no
                         * should be in this directory because lack of
                         * priviledges. Cases where this is true:
                         *   1. If the execute bit for owner has been changed to
                         * off and the user is the owner.
                         *   2. The user changes the owner, and the execute bit
                         * is for owner is the only execute bit set.
                         *   3. The read access bit for owner has been turned
                         * off.
                         *
                         *   Others?
                         */
                        if (strcmp(old->owner, new_attr_data->owner) == 0 &&
                            (new_attr_data->accessBits & 64) == 0) {
                                ...
                                question = True;
                        } else if (strcmp(old->owner, new_attr_data->owner) !=
                                       0 &&
                ...
                if (question) {
                        ...
                        title = XtNewString(
                            GETMESSAGE(21, 36, "Change Permissions Warning"));
                        message = XtNewString(GETMESSAGE(
                            21, 37,
                            "You are changing the permissions on the "
                            "Current\nFolder in a way "
                            "that won't allow you to view\nthis folder any "
                            "longer.  It will be "
                            "automatically\nclosed and you will no longer be "
                            "able to reopen\nthe "
                            "folder.\n\nIs this what you want to do?"));
                        _DtMessageDialog(modAttr_rec->shell, title, message,
                                         NULL, TRUE, DontChangeCB, ChangeCB,
                                         NULL, HelpRequestCB, False,
                                         QUESTION_DIALOG);
                        XtFree(title);
                        XtFree(message);
                } else
                        /* Information was valid */
                        (*(apply_data->callback))(w, apply_data->client_data,
                                                  NULL);
                ...
                tmpmsg = GETMESSAGE(
                    ...
                    "been closed because this object has been "
                    "deleted\nfrom your system.");
                msg = XtMalloc(strlen(tmpmsg) + strlen(old->directory) +
                               strlen(old->name) + 3);
...
static short GetModAttrValues(ModAttrRec *modAttr_rec,
        ...
        old = (ModAttrData *)old_dialog->data;
        retStatus =
            _LoadFileAttributes(old->host, old->directory, old->name,
...
static void InvalidModAttrMessage(Widget w, int messageIndex) {
        ...
        if (unknownUser == NULL) {
                tmpStr = GETMESSAGE(21, 31,
                                    "Owner Name is invalid.\nThe specified "
                                    "user does not exist.");
                unknownUser = XtNewString(tmpStr);
                tmpStr = GETMESSAGE(
                    21, 32,
                    "Group Name is invalid.\n\nNo group of users with this "
                    "name has been created on your system.\nUse your "
                    "system administration software if you want to "
...
static Boolean _LoadFileAttributes(String host, String dir, String file,
        ...
        if (file_data && (file_data->errnum == 0 || file_data->link)) {
                ...
                if (mask & FILETYPE) {
                        modAttr_data->filetype =
                            XtNewString(file_data->logical_type);

                        if (modAttr_data->pixmapData) {
                                /* free old pixmap data */
                                DtDtsFreeAttributeValue(
                                    modAttr_data->pixmapData->hostPrefix);
                                DtDtsFreeAttributeValue(
                                    modAttr_data->pixmapData->instanceIconName);
                                DtDtsFreeAttributeValue(
                                    modAttr_data->pixmapData->iconName);
                                DtDtsFreeAttributeValue(
                                    modAttr_data->pixmapData->iconFileName);
                                XtFree((char *)modAttr_data->pixmapData);
                                modAttr_data->pixmapData = NULL;
                        ...
                        modAttr_data->pixmapData =
                            _DtRetrievePixmapData(file_data->logical_type, NULL,
                                                  NULL, toplevel, LARGE);
                } else {
                        modAttr_data->filetype = NULL;
                        modAttr_data->pixmapData = NULL;
                ...
                if (file_data->errnum == 0 &&
                    (file_data->stat.st_mode & S_IFMT) != S_IFLNK) {
                        if (mask & GROUP) {
                                ...
                                if (group_data != NULL)
                                        modAttr_data->group =
                                            XtNewString(group_data->gr_name);
                                else {
                                        sprintf(buf, "%ld",
                                                (long)file_data->stat.st_gid);
                        ...
                        if (mask & OWNER) {
                                ...
                                if (user_data != NULL)
                                        modAttr_data->owner =
                                            XtNewString(user_data->pw_name);
                                else {
                                        sprintf(buf, "%ld",
                                                (long)file_data->stat.st_uid);
                        ...
                        modAttr_data->setuidBits =
                            file_data->stat.st_mode & 07000;
                        if (mask & BITS)
                                modAttr_data->accessBits =
                                    file_data->stat.st_mode & 0777;
                        if (mask & SIZE)
                                modAttr_data->size = file_data->stat.st_size;
                        if (mask & MODTIME)
                                modAttr_data->modTime =
                                    file_data->stat.st_mtime;
                } else {
                        modAttr_data->owner = NULL;
                        modAttr_data->group = NULL;
                        modAttr_data->accessBits = 0;
...

{
        ...
        case -1: /* error forking */
                s = GETMESSAGE(
                    21, 26,
                    "Unable to create a process for file system dialog");
                xm_string = XmStringCreateLocalized(s);
                n = 0;
                XtSetArg(args[n], XmNmessageString, xm_string);
                n++;
                dialog =
                    XmCreateErrorDialog(XtParent(w), "fork_error", args, 1);
        ...
        case 0: /* child */
                ...
                s = (char *)XtMalloc(
                    50 +
                    strlen(GETMESSAGE(21, 27,
                                      "Error executing file system dialog")) +
                    strlen(GETMESSAGE(21, 28, "Attempting to execute: ")) +
                    strlen(fileSystem->fsDialogProgram) +
                    strlen(fileSystem->path) + strlen(strerror(errno)));

                strcpy(s, GETMESSAGE(21, 27,
                                     "Error executing file system dialog"));
                strcat(s, "\n");
