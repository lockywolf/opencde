...
extern void help_callback(Widget widget, XtPointer client_data,
                          XtPointer call_data);
extern void sensitize_copy_action_area(Widget *pushbutton_array);
extern void desensitize_copy_action_area(Widget *pushbutton_array);
extern Boolean create_copydir_dialog(Widget parent_widget, char *source,
                                     char *target);
extern void create_error_dialog(Widget parent_widget, char *op, char *filename,
                                int errnum);
extern void create_overwrite_dialog(Widget parent_widget, char *sname,
                                    char *tname, Boolean isdir);
extern void _DtChildPosition(Widget w, Widget parent, Position *newX,
                             Position *newY);
extern void cancel_callback(Widget w, XtPointer client_data,
                            XtPointer call_data);
extern void display_cancel_warning(Widget parent);
extern void toggle_callback(Widget w, XtPointer client_data,
                            XtPointer call_data);
