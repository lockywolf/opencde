...
static void MainWindowHelpClose(XtPointer client_data,
                                DialogData *old_dialog_data,
                                DialogData *new_dialog_data);
static void MainWinHyperLink(Widget w, XtPointer clientData,
                             XtPointer callData);
static void TrashHelpClose(XtPointer client_data, DialogData *old_dialog_data,
                           DialogData *new_dialog_data);
static void TrashHyperLink(Widget w, XtPointer clientData, XtPointer callData);
static void DTHelpClose(XtPointer client_data, DialogData *old_dialog_data,
                        DialogData *new_dialog_data);
static void DTHyperLink(Widget w, XtPointer clientData, XtPointer callData);
...
void ShowHelpDialog(Widget parentShell, XtPointer topLevelRec, int dialogType,
                    DialogData *dialogData, char *idString, char *volString,
                    char *topicTitle, char *fileType, int helpType)

{
        ...
        if (dialogData == NULL) {
                ...
                /* Add to the array of visible help annotation dialogs for this
                 * view */
                ...
                if (dialogType == MAIN_HELP_DIALOG) {
                        ...
                        _DtAddOneSubdialog(
                            dialogData, &fileMgrData->secondaryHelpDialogList,
        ...
        _DtShowDialog(parentShell, NULL, topLevelRec, dialogData, NULL, NULL,
                      MainWindowHelpClose, topLevelRec, NULL, False, False,
                      NULL, NULL);
...
static void MainWinHyperLink(Widget w, XtPointer clientData, XtPointer callData)

{
        ...
        if (hyperData->hyperType == DtHELP_LINK_JUMP_NEW) {
                ShowHelpDialog(fileMgrRec->shell, (XtPointer)fileMgrRec,
                               HYPER_HELP_DIALOG, NULL, hyperData->locationId,
                               hyperData->helpVolume, NULL, NULL,
                               DtHELP_TYPE_TOPIC);
        }
}
...
void ShowTrashHelpDialog(Widget parentShell, int dialogType,
...

{
        ...
        if (dialogType == MAIN_HELP_DIALOG) {
                ...
                /* Hyperlink help window */
                _DtAddOneSubdialog(dialogData, &secondaryTrashHelpDialogList,
        ...
        _DtShowDialog(parentShell, NULL, NULL, dialogData, NULL, NULL,
                      TrashHelpClose, NULL, NULL, False, False, NULL, NULL);
        ...
        helpRec = (HelpRec *)_DtGetDialogInstance(dialogData);
        XtRemoveAllCallbacks(helpRec->helpDialog, DtNhyperLinkCallback);
        XtAddCallback(helpRec->helpDialog, DtNhyperLinkCallback, TrashHyperLink,
                      NULL);
}
...
void ShowDTHelpDialog(Widget parentShell, int workspaceNum, int dialogType,
                      DialogData *dialogData, char *idString, char *volString,
                      char *topicTitle, char *fileType, int helpType)

{
        ...
        if (dialogData == NULL) {
                 ...
                 * view */
                if (dialogType == MAIN_HELP_DIALOG) {
                        desktop_data->workspaceData[workspaceNum]
                            ->primaryHelpDialog = dialogData;
                } else {
                        WorkspaceRec *wsInfo;
        ...
        _DtShowDialog(parentShell, NULL, NULL, dialogData, NULL, NULL,
                      ...
                      desktop_data->workspaceData[workspaceNum]->name, False,
                      False, NULL, NULL);
        ...
        helpRec = (HelpRec *)_DtGetDialogInstance(dialogData);
        XtRemoveAllCallbacks(helpRec->helpDialog, DtNhyperLinkCallback);
        XtAddCallback(helpRec->helpDialog, DtNhyperLinkCallback, DTHyperLink,
                      (XtPointer)(XtArgVal)workspaceNum);
}
...

{
        ...
        hyperData = (DtHelpDialogCallbackStruct *)callData;
        if (hyperData->hyperType == DtHELP_LINK_JUMP_NEW) {
                ShowDTHelpDialog(NULL, workspaceNum, HYPER_HELP_DIALOG, NULL,
