...
static void Create(Display *display, Widget parent, Widget *return_widget,
        ...
        */
        ...
        label_string =
            XmStringCreateLocalized((GETMESSAGE(23, 24, "Iconic Path")));
        n = 0;
        ...
        label_string =
            XmStringCreateLocalized((GETMESSAGE(23, 36, "Text Path")));
        n = 0;
        XtSetArg(args[n], XmNlabelString, label_string);
        n++;
        XtSetArg(args[n], XmNtopAttachment, XmATTACH_FORM);
        ...
        label_string =
            XmStringCreateLocalized((GETMESSAGE(23, 37, "Message Line")));
        n = 0;
        XtSetArg(args[n], XmNlabelString, label_string);
        n++;
        XtSetArg(args[n], XmNtopAttachment, XmATTACH_FORM);
        ...
        label_string =
            XmStringCreateLocalized((GETMESSAGE(23, 18, "Placement")));
        n = 0;
        XtSetArg(args[n], XmNtitleString, label_string);
        n++;
        ...
        label_string =
            XmStringCreateLocalized((GETMESSAGE(23, 20, "As Placed")));
        n = 0;
        XtSetArg(args[n], XmNlabelString, label_string);
        n++;
        XtSetArg(args[n], XmNtopAttachment, XmATTACH_FORM);
        ...
        label_string =
            XmStringCreateLocalized(((char *)GETMESSAGE(23, 7, "Show")));
        n = 0;
        XtSetArg(args[n], XmNtitleString, label_string);
        n++;
        XtSetArg(args[n], XmNtopAttachment, XmATTACH_WIDGET);
        ...
        XmStringFree(label_string);
        XtAddCallback(show_frame, XmNhelpCallback,
                      (XtCallbackProc)HelpRequestCB, HELP_PREFERENCES_SHOW_STR);
        ...
        label_string = XmStringCreateLocalized(
            ((char *)GETMESSAGE(23, 8, "By Single Folder")));
        n = 0;
        XtSetArg(args[n], XmNlabelString, label_string);
        n++;
        XtSetArg(args[n], XmNtopAttachment, XmATTACH_FORM);
        ...
        XtSetArg(args[n], XmNindicatorType, XmONE_OF_MANY);
        n++;
        preferences_rec->show_single = temp = XmCreateToggleButtonGadget(
            group_form, "by_single_directory", args, n);
        XtManageChild(temp);
        XmStringFree(label_string);
        XtAddCallback(temp, XmNvalueChangedCallback, ToggleCallback,
                      (XtPointer)preferences_rec);
        ...
        XtSetArg(args[n], XmNindicatorType, XmONE_OF_MANY);
        n++;
        preferences_rec->show_multiple = temp = XmCreateToggleButtonGadget(
            group_form, "by_directory_tree", args, n);
        XtManageChild(temp);
        XmStringFree(label_string);
        XtAddCallback(temp, XmNvalueChangedCallback, ToggleCallback,
                      (XtPointer)preferences_rec);
        ...
        label_string = XmStringCreateLocalized(
            ((char *)GETMESSAGE(23, 27, "Folders only")));
        n = 0;
        XtSetArg(args[n], XmNlabelString, label_string);
        n++;
        XtSetArg(args[n], XmNtopAttachment, XmATTACH_WIDGET);
        ...
        XtSetArg(args[n], XmNindicatorType, XmONE_OF_MANY);
        n++;
        preferences_rec->tree_files_choose = temp = XmCreateToggleButtonGadget(
            group_form, "tree_files_choose", args, n);
        XtManageChild(temp);
        XmStringFree(label_string);
        XtAddCallback(temp, XmNvalueChangedCallback, ToggleCallback,
                      (XtPointer)preferences_rec);
        ...
        XtSetArg(args[n], XmNindicatorType, XmONE_OF_MANY);
        n++;
        preferences_rec->tree_files_always = temp = XmCreateToggleButtonGadget(
            group_form, "tree_files_always", args, n);
        XtManageChild(temp);
        XmStringFree(label_string);
        XtAddCallback(temp, XmNvalueChangedCallback, ToggleCallback,
                      (XtPointer)preferences_rec);
        ...
        label_string = XmStringCreateLocalized(
            ((char *)GETMESSAGE(23, 31, "Representation")));
        n = 0;
        XtSetArg(args[n], XmNtitleString, label_string);
        n++;
        XtSetArg(args[n], XmNtopAttachment, XmATTACH_WIDGET);
        ...
        XmStringFree(label_string);
        XtAddCallback(view_frame, XmNhelpCallback,
                      (XtCallbackProc)HelpRequestCB, HELP_PREFERENCES_VIEW_STR);
        ...
        label_string = XmStringCreateLocalized(
            ((char *)GETMESSAGE(23, 32, "By Name Only")));
        n = 0;
        XtSetArg(args[n], XmNlabelString, label_string);
        n++;
        XtSetArg(args[n], XmNtopAttachment, XmATTACH_FORM);
        ...
        label_string = XmStringCreateLocalized(
            ((char *)GETMESSAGE(23, 33, "By Large Icons")));
        n = 0;
        XtSetArg(args[n], XmNlabelString, label_string);
        n++;
        XtSetArg(args[n], XmNtopAttachment, XmATTACH_WIDGET);
        ...
        label_string = XmStringCreateLocalized(
            ((char *)GETMESSAGE(23, 34, "By Small Icons")));
        n = 0;
        XtSetArg(args[n], XmNlabelString, label_string);
        n++;
        XtSetArg(args[n], XmNtopAttachment, XmATTACH_WIDGET);
        ...
        preferences_rec->by_name_and_small_icon = temp =
            XmCreateToggleButtonGadget(group_form, "by_name_and_small_icon",
                                       args, n);
        XtManageChild(temp);
        XmStringFree(label_string);
        XtAddCallback(temp, XmNvalueChangedCallback, ToggleCallback,
        ...
        label_string =
            XmStringCreateLocalized(((char *)GETMESSAGE(23, 10, "Order")));
        n = 0;
        XtSetArg(args[n], XmNtitleString, label_string);
        n++;
        XtSetArg(args[n], XmNtopAttachment, XmATTACH_WIDGET);
        ...
        XmStringFree(label_string);
        XtAddCallback(order_frame, XmNhelpCallback,
                      (XtCallbackProc)HelpRequestCB,
        ...
        label_string = XmStringCreateLocalized(
            ((char *)GETMESSAGE(23, 12, "Alphabetically")));
        n = 0;
        XtSetArg(args[n], XmNlabelString, label_string);
        n++;
        XtSetArg(args[n], XmNtopAttachment, XmATTACH_FORM);
        ...
        label_string = XmStringCreateLocalized(
            ((char *)GETMESSAGE(23, 11, "By File Type")));
        n = 0;
        XtSetArg(args[n], XmNlabelString, label_string);
        n++;
        XtSetArg(args[n], XmNtopAttachment, XmATTACH_WIDGET);
        ...
        label_string =
            XmStringCreateLocalized((GETMESSAGE(23, 30, "Defaults")));
...
static void SetValues(PreferencesRec *preferences_rec,
        ...
        if (preferences_data->show_type == SINGLE_DIRECTORY) {
                ...
                if (trashFileMgrData &&
                    (PreferencesData *)trashFileMgrData->preferences->data ==
                        preferences_data)
                        XtSetSensitive(XtParent(preferences_rec->show_multiple),
                                       False);
                else
                        XtSetSensitive(XtParent(preferences_rec->show_multiple),
                                       True);
                ...
                if (*viewP == BY_ATTRIBUTES)
                        XtSetSensitive(XtParent(preferences_rec->random_on),
                                       False);
                else
                        XtSetSensitive(XtParent(preferences_rec->random_on),
                                       True);
        ...
        if (*viewP == BY_NAME) {
                ...
                XtSetValues(preferences_rec->by_name_and_small_icon, false_args,
                            1);
                ...
                XtSetValues(preferences_rec->by_name, false_args, 1);
                XtSetValues(preferences_rec->by_name_and_icon, false_args, 1);
                XtSetValues(preferences_rec->by_name_and_small_icon, true_args,
                            1);
                XtSetValues(preferences_rec->by_attributes, false_args, 1);
        ...
        if (preferences_data->direction == DIRECTION_ASCENDING) {
                ...
                XtSetValues(preferences_rec->direction_descending, false_args,
                            1);
        }
        if (preferences_data->direction == DIRECTION_DESCENDING) {
                XtSetValues(preferences_rec->direction_ascending, false_args,
                            1);
                XtSetValues(preferences_rec->direction_descending, true_args,
                            1);
        }
        ...
        if (trashFileMgrData &&
            (PreferencesData *)trashFileMgrData->preferences->data ==
                ...
                if (preferences_data->show_iconic_path)
                        XtSetValues(preferences_rec->show_iconic_path,
                                    true_args, 1);
                else
                        XtSetValues(preferences_rec->show_iconic_path,
                                    false_args, 1);
                ...
                if (preferences_data->show_current_dir)
                        XtSetValues(preferences_rec->show_current_dir,
                                    true_args, 1);
                else
                        XtSetValues(preferences_rec->show_current_dir,
                                    false_args, 1);
                ...
                if (preferences_data->show_status_line)
                        XtSetValues(preferences_rec->show_status_line,
                                    true_args, 1);
                else
                        XtSetValues(preferences_rec->show_status_line,
                                    false_args, 1);
...
static void WriteResourceValues(DialogData *values, int fd, char **name_list) {
        ...
        if (preferences_data->displayed == True) {
                ...
                preferences_rec =
                    (PreferencesRec *)_DtGetDialogInstance(values);
        }
...
void ShowTypeToString(int fd, unsigned char *value, char *out_buf) {
        char *buf;
...
void TreeFilesToString(int fd, unsigned char *value, char *out_buf) {
        char *buf;
...
void ViewToString(int fd, unsigned char *value, char *out_buf) {
        char *buf;
...
void OrderToString(int fd, unsigned char *value, char *out_buf) {
        char *buf;
...
void DirectionToString(int fd, unsigned char *value, char *out_buf) {
        char *buf;
...
void RandomToString(int fd, unsigned char *value, char *out_buf) {
        char *buf;
