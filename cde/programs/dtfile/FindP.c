...
static void FindClose(XtPointer client_data, DialogData *old_dialog_data,
...
void ShowFindDialog(Widget w, XtPointer client_data, XtPointer callback) {
        ...
        _DtShowDialog(file_mgr_rec->shell, NULL, (XtPointer)file_mgr_rec,
                      file_mgr_data->find, NULL, (XtPointer)file_mgr_rec,
                      FindClose, (XtPointer)file_mgr_rec, NULL, False, False,
                      NULL, NULL);
