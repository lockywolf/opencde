...

{
        ...
        case CANNOT_CONNECT_ERROR_1:
                return ((GETMESSAGE(
                    30, 3,
                    "Cannot move or copy file %s from host %s.\nHost %s "
                    "may not be properly mounted to your file system.")));
        case CANNOT_CONNECT_ERROR_2:
                return ((GETMESSAGE(
                    30, 4,
                    "Cannot move or copy file %1$s from host %2$s.\nHost %3$s "
                    "may not be properly mounted to your file system.")));
        ...
        case CANT_CREATE_ERROR:
                return ((GETMESSAGE(
                    ...
                    "you do not have\nthe correct permissions for the "
                    "involved\nfiles or folders.\n\nTo view permissions, "
        ...
        case CANT_OVERWRITE_ERROR:
                return ((GETMESSAGE(
                    30, 9,
                    "A folder or file with the name\n%s\nalready exists and "
        ...
        case LOCAL_RENAME_ONLY_ERROR:
                return ((GETMESSAGE(
                    30, 11,
                    "You cannot specify a path as part of the filename.")));
        case NO_DIR_ACCESS_ERROR:
                return ((GETMESSAGE(
                    30, 12,
                    "Invalid Find Information.\n\nThe following folder "
                    "does not exist, or is not accessible:\n\n     %s\n")));
        case NO_FILES_FOUND_ERROR:
                return (GETMESSAGE(
                    15, 27, "No files were found that match the search data."));
        ...
        case NO_SPACES_ALLOWED_ERROR:
                return (GETMESSAGE(
                    10, 3, "Spaces are not allowed in a file or folder name."));
        ...
        case ITEM_HELP_ERROR:
                return ((
                    GETMESSAGE(30, 24,
                               "You must select an object within the File "
                               "Manager.\n'On Item' help only works within the "
                               "application where\nyou launched it.")));
        case AMITEM_HELP_ERROR:
                return ((GETMESSAGE(
                    30, 26,
                    "You must select an object within the Application "
                    "Manager.\n'On Item' help only works within the "
                    "application where\nyou launched it.")));
