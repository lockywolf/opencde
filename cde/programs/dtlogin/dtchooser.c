...
static XtResource AppResources[] = {
    ...
    {"chlistFont", "ChlistFont", XmRFontList, sizeof(XmFontList),
     XtOffset(AppInfoPtr, chlistFont), XmRString, "Fixed"},
...
void MakeButtons(void) {
        ...
        i++;
        xmstr = ReadCatalogXms(MC_CHOOSER_SET, MC_UPDATE_LABEL,
                               MC_DEF_UPDATE_LABEL);
        XtSetArg(argt[i], XmNlabelString, xmstr);
        i++;
        ...
        XtAddCallback(clear_button, XmNactivateCallback, DoPing, (XtPointer)0);
...
void MakeChooser(void) {
        ...
        i = InitArg(LabelG);
        xmstr = ReadCatalogXms(MC_CHOOSER_SET, MC_CHOOSER_TITLE,
                               MC_DEF_CHOOSER_TITLE);
        ...
        XtSetArg(argt[i], XmNtopAttachment, XmATTACH_FORM);
        i++;
        XtSetArg(argt[i], XmNtopOffset, 10);
        i++;
        XtSetArg(argt[i], XmNleftAttachment, XmATTACH_FORM);
        i++;
        XtSetArg(argt[i], XmNrightAttachment, XmATTACH_FORM);
        ...
        XtSetArg(argt[i], XmNleftAttachment, XmATTACH_FORM);
        i++;
        XtSetArg(argt[i], XmNleftOffset, 13);
        i++;
        if (appInfo.chlistFont != NULL) {
                XtSetArg(argt[i], XmNfontList, appInfo.chlistFont);
                i++;
        }
        ...
        XtSetArg(argt[i], XmNleftAttachment, XmATTACH_FORM);
        i++;
        XtSetArg(argt[i], XmNleftOffset, 10);
        i++;
        XtSetArg(argt[i], XmNrightAttachment, XmATTACH_FORM);
        i++;
        XtSetArg(argt[i], XmNrightOffset, 10);
        i++;
        XtSetArg(argt[i], XmNtopAttachment, XmATTACH_WIDGET);
        i++;
        XtSetArg(argt[i], XmNtopWidget, list_head);
        i++;
        XtSetArg(argt[i], XmNtopOffset, 1);
        i++;
        ...
        i++;
        XtSetArg(argt[i], XmNlistSizePolicy, XmCONSTANT);
        i++;
        XtSetArg(argt[i], XmNscrollBarDisplayPolicy, XmSTATIC);
        i++;
        if (appInfo.chlistFont != NULL) {
                XtSetArg(argt[i], XmNfontList, appInfo.chlistFont);
                i++;
...
void MakeDialog(DialogType dtype) {
        ...
        case help:
                ...
                XtSetArg(argt[i], XmNvalue, strdup(str));
                i++;
        ...
        case help_chooser:
                xmstr = ReadCatalogXms(MC_HELP_SET, MC_HELP_CHOOSER,
                                       MC_DEF_HELP_CHOOSER);
                ...
                XtSetArg(argt[i], XmNeditable, False);
                i++;
                str = (char *)ReadCatalog(MC_HELP_SET, MC_HELP_CHOOSER,
                                          MC_DEF_HELP_CHOOSER);
                XtSetArg(argt[i], XmNvalue, strdup(str));
                i++;
                text = XmCreateScrolledText(w, "help_message_text", argt, i);
...
void MakeOptionsMenu(void) {
        ...
        XmStringFree(xmstr);
        XtAddCallback(options_item[j], XmNactivateCallback, DoCancel,
