...
void MakeLogo(void) {
        ...
        XtGetSubresources(table, &logoInfo, "logo", "Logo", logoResources,
                          XtNumber(logoResources), NULL, 0);
        ...
        i++;
        XtSetArg(argt[i], XmNrightOffset, 15);
        i++;
        XtSetArg(argt[i], XmNleftAttachment, XmATTACH_WIDGET);
        i++;
        XtSetArg(argt[i], XmNleftWidget, matteFrame);
        i++;
...
#define LOGO_TYPE 0
        ...
        i++;
        XtSetArg(argt[i], XmNhighlightThickness, 0);
        i++;
        XtSetArg(argt[i], XmNbehavior, XmICON_LABEL);
        i++;
        XtSetArg(argt[i], XmNfillMode, XmFILL_TRANSPARENT);
        i++;
        XtSetArg(argt[i], XmNstring, NULL);
        i++;
        if (logoName != NULL) {
                XtSetArg(argt[i], XmNpixmapForeground, fg);
                i++;
                XtSetArg(argt[i], XmNpixmapBackground, bg);
                i++;
                ...
                XtSetArg(argt[i], XmNpixmap, logoPixmap);
                i++;
        }
        ...
        XtSetArg(argt[0], XmNheight,
                 245); /* keeps dialog a consistent height and width */
