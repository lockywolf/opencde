...
#ifdef notdef
static void RemoveIndirectChoice(clientAddress,
                                 connectionType) ARRAY8Ptr clientAddress;
CARD16 connectionType;
{
        ChoicePtr c, prev;
        ...
        if (len > 0) {
                ...
                if (XdmcpReadARRAY8(&buffer, &clientAddress) &&
                    ...
                    XdmcpReadARRAY8(&buffer, &choice)) {
                        ...
                        if (!RegisterIndirectChoice(&clientAddress,
