...
#define MC_DEF_SUS3_LABEL                                                      \
        "* Log in. Desktop Login will resume shortly after you log "           \
        "out.\r\n*\r\n"
#define MC_DEF_RES_LABEL "* Resuming Desktop Login...\r\n*\r\n"
#define MC_DEF_START_LBLDPY                                                    \
        "* Starting Desktop Login on display %1$s...\r\n*\r\n"
#define MC_DEF_WAIT_LABEL                                                      \
        "* Wait for the Desktop Login screen before logging in.\r\n*\r\n"
#define MC_DEF_X_LABEL                                                         \
        "* The X-server can not be started on display %1$s...\r\n*\r\n"
...
#define MC_DEF_LOG_ACC_CTL                                                     \
        "Cannot open access control file %1$s, no XDMCP reqeusts will be "     \
        "granted\n"
...
#define MC_DEF_LOG_LCK_AUTH                                                    \
        "Can not lock authorization file %1$s or backup %2$s\n"
...
#define MC_DEF_LOG_NO_LOCK                                                     \
        "Can not lock pid file %1$s, another Dtlogin is running (pid %2$d)\n"
...
#define MC_DEF_LOG_MAX_LOGFILE                                                 \
        "TrimErrorLog(): maximum size of error log file is 200Kb.\n"
#define MC_DEF_LOG_MISS_NAME "Missing display name in servers file\n"
#define MC_DEF_LOG_MISS_TYPE "Missing display type for %1$s\n"
#define MC_DEF_LOG_INV_HOSTNM                                                  \
        "Hostname %1$s is invalid. Setting DISPLAY to ':0'\n"
#define MC_DEF_LOG_BAD_DPYTYPE                                                 \
        "Unacceptable display type %1$s for display %2$s\n"
...
#define MC_DEF_LOG_HUNG_DPY                                                    \
        "Hung in XOpenDisplay(%1$s) attempt #%2$d, aborting.\n"
#define MC_DEF_LOG_FAIL_SRVOPEN                                                \
        "Server open attempt #%1$d failed for %2$s, giving up\n"
...
#define MC_DEF_LOG_NO_SECKEY                                                   \
        "WARNING: keyboard on display %1$s could not be secured\n"
#define MC_DEF_LOG_NO_BLSACCT "BLS - Could not obtain account information.\n"
#define MC_DEF_LOG_NO_BLSPACCT                                                 \
        "BLS - Could not obtain protected account information.\n"
...
#define MC_DEF_LOG_IMPROP_AUTH                                                 \
        "Improper authentication name \"%1$s\". Use AFS, Kerberos or the "     \
        "default.\n"
...
#define MC_DEF_LOG_NO_SCAN                                                     \
        "Scan of %1$s directory exceeded %2$d seconds. Terminating scan...\n"
#define MC_DEF_LOG_MORE_GRP                                                    \
        "%s belongs to more than %1$d groups, %2$s ignored\n"
#define MC_DEF_LOG_NOT_SUSER "audwrite() error: caller is not superuser\n"
#define MC_DEF_LOG_INV_EVENT                                                   \
        "audwrite() error: invalid event number in audit record.\n"
#define MC_DEF_LOG_ERR_ERRNO "audwrite() error: errno = %1$d\n"
#define MC_DEF_LOG_AFS_FAILATH "AFS authentication failure: %1$s\n"
#define MC_DEF_LOG_ACC_EXP                                                     \
        "Account for %1$s has expired. Please see your System "                \
        "Administrator.\n"
#define MC_DEF_LOG_DEADSRV "Server dead  %1$s\n"
#define MC_DEF_LOG_NO_LOGOBIT "Can't open logo bitmap file: %1$s\n"
#define MC_DEF_LOG_NO_MSGCAT                                                   \
        "cannot read \"%1$s\" message catalog. Using default language."
#define MC_DEF_LOG_NO_DPYINIT                                                  \
        "display %1$s could not be initialized, server may be grabbed.\n"
#define MC_DEF_LOG_BAD_MATTE                                                   \
        "(%1$s): Login matte width exceeds display, using default. Matte "     \
        "units are pixels.\n"
#define MC_DEF_LOG_BAD_HMATTE                                                  \
        "(%1$s) Login matte height exceeds display, using default.  Matte "    \
        "units are pixels.\n"

#define MC_DEF_CHOOSER_TITLE "Select a server to log into:"
#define MC_DEF_CHOOSER_HEADING                                                 \
