...
void activateCB_open_FindSet(Widget find_set_button, XtPointer cdata,
        ...
        name_field_title =
            XtNewString(GETMESSAGE(11, 12, "Enter Icon Filename"));
        ...
        if (!IconSelector) {
                ...
                IconSelector = create_icon_selection_dialog(
                    ...
                    (unsigned char *)container_title, numberOfTopButtons,
                    ...
                    (void (*)())top_button_three_cb, use_icon_name_field,
...
{
        SetIconData(wid,
                    (char *)((bActionIcons) ? ca_full_icon_default
                                            : af_full_icon_default),
                    IconSize);
}
...
void DisplayHelpDialog(Widget wid, XtPointer client_data, XtPointer cbs) {
        ...
        */
        ...
        if (mainHelpDialog == NULL) {
                mainHelpDialog =
                    DtCreateHelpDialog(parent, "mainHelpDialog", args, i);
