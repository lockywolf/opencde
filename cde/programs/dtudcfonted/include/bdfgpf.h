...
extern int falcom_atoi(
    ...
    char * /* str	*/, char /* ed_cod */, int * /* val */
#endif
);

extern int GetDefaultFile(
#if NeedFunctionPrototypes
    int /* size */, char * /* style */, char * /* fname */
#endif
);

extern int get_default_file(
#if NeedFunctionPrototypes
    FILE * /* fp */, int /* size */, char * /* style */, char * /* fname */
#endif
);
...
#if NeedFunctionPrototypes
    char * /* com */, char * /* size_str */, char * /* style */,
    int /* codeset */, char * /* ofile */
#endif
);

extern void ErrMsgTable_FalGetFontList(
#if NeedFunctionPrototypes
    char * /* com */, int /* utyerr */, int /* utyderr */
#endif
);
...
#if NeedFunctionPrototypes
    int /* code  */, int /* num_gr */, FalGlyphRegion * /* gr  */
#endif
);

extern int GetUdcFileName(
#if NeedFunctionPrototypes
    char * /* com  */, int /* code_no  */, char * /* xlfdname  */,
    char * /* fname */
#endif
);
...
#if NeedFunctionPrototypes
    char * /* com */, int /* codeset */, char * /* gpf_file */,
    int * /* num_gr */, FalGlyphRegion ** /* gr */
#endif
);
...
#if NeedFunctionPrototypes
    char * /* gpf_file */, char * /* bdf_file */, char ** /* fontname */
#endif
);
...
#if NeedFunctionPrototypes
    struct btophead * /* head */, char * /* buf */
#endif
);

extern int ReadGpfHeader(
#if NeedFunctionPrototypes
    struct ptobhead * /* head */, char * /* buf */
#endif
);
...
#if NeedFunctionPrototypes
    struct btophead * /* head */, int /* init_start */, int /* init_end */,
    char * /* buf */
#endif
);
...
#if NeedFunctionPrototypes
    struct btophead * /* head */, char * /* buf */, int * /* code */
#endif
);

extern int GetBdfPtn(
#if NeedFunctionPrototypes
    struct btophead * /* head */, char * /* buf */, char * /* ptn */,
    int /* mwidth */, int /* bsize */
#endif
);
...
#if NeedFunctionPrototypes
    struct ptobhead * /* head */, char * /* buf */, int * /* code */
#endif
);

extern int GetGpfPtn(
#if NeedFunctionPrototypes
    struct ptobhead * /* head */, char * /* buf */, char * /* ptn */,
    int /* mwidth */, int /* bsize */
#endif
);
...
#if NeedFunctionPrototypes
    unsigned char * /* ptn */, int /* width */, int /* height */,
    FILE * /* fp */
#endif
);
...
#if NeedFunctionPrototypes
    char * /* ptn */, int /* width */, int /* height */, FILE * /* fp */
#endif
);

extern int PtnZoom(
#if NeedFunctionPrototypes
    char * /* dmem */, char * /* smem */, int /* sw */, int /* sh */,
    int /* dw */, int /* dh */
#endif
);
...
#if NeedFunctionPrototypes
    int /* er_no */, char * /* snf_in */, char * /* snf_out */,
    char * /* gpf_in */, char * /* gpf_out */, char * /* bdf_in */,
    char * /* prog_name  */
#endif
);
...
#if NeedFunctionPrototypes
    int /* msg_level */, char * /* org_name */, char * /* tmp_name */,
...
#if NeedFunctionPrototypes
    char * /* org_name */, char * /* tmp_name */, mode_t /* mode */,
    uid_t /* owner */, gid_t /* group */, char * /* com */
#endif
);
...
#if NeedFunctionPrototypes
    char * /* fname */, mode_t /* mode */, char * /* com */
#endif
);

extern int Chown_File(
#if NeedFunctionPrototypes
    char * /* fname */, uid_t /* owner */, gid_t /* group */, char * /* com */
#endif
);
...
#if NeedFunctionPrototypes
    char * /* com  */, char ** /* path  */, char * /* dflt_path  */,
    char * /* cmd */
#endif
);

extern int Link_NewFile(
#if NeedFunctionPrototypes
    char * /* rd_file */, char * /* wr_file */
#endif
);
