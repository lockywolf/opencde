...
int _fallcmbtowc(lcd, wstr, str, len) XLCd lcd;
wchar_t *wstr;
char *str;
int len;
{
        ...
        if (conv == NULL) {
                conv =
                    _fallcOpenConverter(lcd, XlcNMultiByte, lcd, XlcNWideChar);
                if (conv == NULL)
                        return -1;
        }
...
int _fallcwctomb(lcd, str, wc) XLCd lcd;
char *str;
wchar_t wc;
{
        static XLCd last_lcd = NULL;
        ...
        if (conv == NULL) {
                conv =
                    _fallcOpenConverter(lcd, XlcNWideChar, lcd, XlcNMultiByte);
                if (conv == NULL)
                        return -1;
        }
...
int _fallcmbstowcs(lcd, wstr, str, len) XLCd lcd;
wchar_t *wstr;
char *str;
int len;
{
...
int _fallcwcstombs(lcd, str, wstr, len) XLCd lcd;
char *str;
wchar_t *wstr;
int len;
{
...
int _falmbtowc(wstr, str, len) wchar_t *wstr;
char *str;
int len;
{ return _fallcmbtowc((XLCd)NULL, wstr, str, len); }

int _falmblen(str, len) char *str;
int len;
{ return _falmbtowc((wchar_t *)NULL, str, len); }

int _falwctomb(str, wc) char *str;
wchar_t wc;
{ return _fallcwctomb((XLCd)NULL, str, wc); }

int _falmbstowcs(wstr, str, len) wchar_t *wstr;
char *str;
int len;
{ return _fallcmbstowcs((XLCd)NULL, wstr, str, len); }

int _falwcstombs(str, wstr, len) char *str;
wchar_t *wstr;
int len;
{ return _fallcwcstombs((XLCd)NULL, str, wstr, len); }

wchar_t *_falwcscpy(wstr1, wstr2) register wchar_t *wstr1, *wstr2;
{
...
wchar_t *_falwcsncpy(wstr1, wstr2, len) register wchar_t *wstr1, *wstr2;
register len;
{
        wchar_t *wstr_tmp = wstr1;
...
int _falwcslen(wstr) register wchar_t *wstr;
{
...
int _falwcscmp(wstr1, wstr2) register wchar_t *wstr1, *wstr2;
{
...
int _falwcsncmp(wstr1, wstr2, len) register wchar_t *wstr1, *wstr2;
register len;
{
