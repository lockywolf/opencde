...
#if NeedFunctionPrototypes
    XLCd /* lcd */, XlcArgList /* args */, int /* num_args */
#endif
);

typedef void (*XlcPubGetResourceProc)(
#if NeedFunctionPrototypes
    XLCd /* lcd */, char * /* category */, char * /* class */,
...
#if NeedFunctionPrototypes
    char * /* name */, char * /* control_sequence */
#endif
);
...
#if NeedFunctionPrototypes
    XLCd /* lcd */, Display * /* dpy */, XTextProperty * /* text_prop */,
...
#if NeedFunctionPrototypes
    XLCd /* lcd */, Display * /* dpy */, char ** /* list */, int /* count */,
...
#if NeedFunctionPrototypes
    XLCd /* lcd */, Display * /* dpy */, wchar_t ** /* list */, int /* count */,
    XICCEncodingStyle /* style */, XTextProperty * /* text_prop */
#endif
);
...
#if NeedFunctionPrototypes
    char * /* lc_name */, char * /* full_name */, char * /* language */,
    char * /* territory */, char * /* codeset */
#endif
);

extern int _fallcResolveDBName(
#if NeedFunctionPrototypes
    char * /* lc_name */, char * /* file_name */
#endif
);
...
#if NeedFunctionPrototypes
    XLCd /* lcd */, char * /* category */, char * /* name */,
    char *** /* value */, int * /* count */
#endif
);
