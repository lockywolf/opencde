...
static int euc_mbstowcs(conv, from, from_left, to, to_left, args,
...
static int euc_wcstombs(conv, from, from_left, to, to_left, args,
                        num_args) XlcConv conv;
XPointer *from;
int *from_left;
XPointer *to;
...
static int euc_mbtocs(conv, from, from_left, to, to_left, args,
                      num_args) XlcConv conv;
XPointer *from;
int *from_left;
XPointer *to;
...
static int euc_mbstocs(conv, from, from_left, to, to_left, args,
                       num_args) XlcConv conv;
XPointer *from;
int *from_left;
XPointer *to;
...
static int euc_wcstocs(conv, from, from_left, to, to_left, args,
                       num_args) XlcConv conv;
XPointer *from;
int *from_left;
XPointer *to;
...
int num_args;
{
        ...
        for (; wcstr_len > 0 && buf_len > 0; wcptr++, wcstr_len--) {
                ...
                while (length--) {
                        *tmpptr-- =
                            codeset->length == 1 && codeset->side == XlcGR
                                ? BIT8ON(wch)
                                : BIT8OFF(wch);
...
static int euc_cstombs(conv, from, from_left, to, to_left, args,
                       num_args) XlcConv conv;
XPointer *from;
int *from_left;
XPointer *to;
...
static int euc_cstowcs(conv, from, from_left, to, to_left, args,
                       num_args) XlcConv conv;
XPointer *from;
int *from_left;
XPointer *to;
...
static int euc_ctstowcs(conv, from, from_left, to, to_left, args,
                        num_args) XlcConv conv;
XPointer *from;
int *from_left;
XPointer *to;
...
static int euc_wcstocts(conv, from, from_left, to, to_left, args,
                        num_args) XlcConv conv;
XPointer *from;
int *from_left;
XPointer *to;
...
static int euc_ctstombs(conv, from, from_left, to, to_left, args,
                        num_args) XlcConv conv;
XPointer *from;
int *from_left;
XPointer *to;
...
static int euc_mbstocts(conv, from, from_left, to, to_left, args,
                        num_args) XlcConv conv;
XPointer *from;
int *from_left;
XPointer *to;
...
XLCd _fallcEucLoader(name) char *name;
{
        XLCd lcd;
