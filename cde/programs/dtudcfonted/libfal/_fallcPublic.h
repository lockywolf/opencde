...
typedef char *(*XlcGetCSValuesProc)(
    ...
    XlcCharSet /* charset */, XlcArgList /* args */, int /* num_args */
#endif
);
...
#if NeedFunctionPrototypes
    XLCd /* from_lcd */, char * /* from_type */, XLCd /* to_lcd */,
    char * /* to_type */
#endif
);
...
#if NeedFunctionPrototypes
    XlcConv /* conv */, XPointer * /* from */, int * /* from_left */,
...
#if NeedFunctionPrototypes
    XLCd /* from_lcd */, char * /* from_type */, XLCd /* to_lcd */,
    char * /* to_type */, XlcOpenConverterProc /* open_converter */
#endif
);
