...
CGenOptions CodeGenOptions = {
    CG_GEN_PROJ_FLAG, False, CG_VERBOSITY_NORMAL, NULL, NULL, NULL};
CG_GEN_FLAG CodeGenCmd = CG_GEN_PROJ_FLAG;
CG_VERBOSITY CodeGenVerbosityLevel = CG_VERBOSITY_NORMAL;

void cgenP_update_mod_listCB(Widget widget, XtPointer clientData,
                             XtPointer callData) {
...
)
{
    /*** DTB_USER_CODE_START vvv Add C variables and code below vvv ***/
        ...
        XtVaSetValues(props_dlg->cgen_flags_radiobox_items.Main_Only_item,
                      XmNset, False, NULL);
        XtVaSetValues(
            props_dlg->cgen_flags_radiobox_items.Specific_Modules_Only_item,
            XmNset, False, NULL);
        XtVaSetValues(
            props_dlg->cgen_flags_radiobox_items.Specific_Modules_and_Main_item,
            XmNset, False, NULL);

        /* set the merge flag */
        XtVaSetValues(props_dlg->merge_checkbox_items.Don_t_Merge_item, XmNset,
                      False, NULL);

        /* set the verbosity */
        CodeGenVerbosityLevel = CG_VERBOSITY_NORMAL;
        XtVaSetValues(
            props_dlg->verbosity_opmenu_items.Report_Normal_Messages_item,
            XmNset, True, NULL);
        XtVaSetValues(props_dlg->verbosity_opmenu_items.Be_Silent_item, XmNset,
                      False, NULL);
        XtVaSetValues(props_dlg->verbosity_opmenu_items.Be_Verbose_item, XmNset,
                      False, NULL);
...
)
{
    /*** DTB_USER_CODE_START vvv Add C variables and code below vvv ***/
        ...
        if (CodeGenCmd == CG_GEN_SPECIFIC_FILES_FLAG ||
            CodeGenCmd == CG_GEN_SPECIFIC_FILES_AND_MAIN_FLAG) {
                XtVaGetValues(props_dlg->module_list, XmNselectedItemCount,
                              &num_selected_mods, NULL);
...
)
{
    ...
    /*** DTB_USER_CODE_START vvv Add C code below vvv ***/
        ...
        ui_win_show(dtb_cgen_props_cgen_props_dlg.cgen_props_dlg_shellform,
                    False, XtGrabNone);
    /*** DTB_USER_CODE_END   ^^^ Add C code above ^^^ ***/
}
...
)
{
    /*** DTB_USER_CODE_START vvv Add C variables and code below vvv ***/
        ...
        case CG_GEN_PROJ_FLAG:
                XtVaSetValues(
                    props_dlg->cgen_flags_radiobox_items.Entire_Project_item,
                    XmNset, False, NULL);
                break;

        case CG_GEN_MAIN_FLAG:
                XtVaSetValues(
                    props_dlg->cgen_flags_radiobox_items.Main_Only_item, XmNset,
                    False, NULL);
                break;

        case CG_GEN_SPECIFIC_FILES_FLAG:
                XtVaSetValues(props_dlg->cgen_flags_radiobox_items
                                  .Specific_Modules_Only_item,
                              XmNset, False, NULL);
                XmListDeselectAllItems(props_dlg->module_list);
                break;
        ...
        case CG_GEN_SPECIFIC_FILES_AND_MAIN_FLAG:
                XtVaSetValues(props_dlg->cgen_flags_radiobox_items
                                  .Specific_Modules_and_Main_item,
                              XmNset, False, NULL);
                XmListDeselectAllItems(props_dlg->module_list);
                break;
        ...
        case CG_GEN_PROJ_FLAG:
                ...
                if (XtIsSensitive(props_dlg->module_list)) {
                        XtSetSensitive(props_dlg->module_list, False);
                        XtSetSensitive(props_dlg->module_list_scrolledwin,
                                       False);
                }
                break;
        ...
        case CG_GEN_SPECIFIC_FILES_FLAG:
                ...
                if (CodeGenOptions.module_list != NULL) {
                        XmListDeselectAllItems(props_dlg->module_list);
                        for (i = 0; i < strlist_get_num_strs(
                                            CodeGenOptions.module_list);
                             i++) {
                                mod = objxm_str_to_xmstr(
                                    props_dlg->module_list,
                                    strlist_get_str(CodeGenOptions.module_list,
                                                    i, (void **)NULL));
                                pos =
                                    XmListItemPos(props_dlg->module_list, mod);
                                if (!XmListPosSelected(props_dlg->module_list,
                                                       pos)) {
        ...
        case CG_VERBOSITY_NORMAL:
                XtVaSetValues(props_dlg->verbosity_opmenu_items
                                  .Report_Normal_Messages_item,
                              XmNset, False, NULL);
                break;
        ...
        case CG_VERBOSITY_NORMAL:
                ...
                opmenu_label =
                    XmOptionButtonGadget(props_dlg->verbosity_opmenu);
                XtVaGetValues(props_dlg->verbosity_opmenu_items
                                  .Report_Normal_Messages_item,
                              XmNlabelString, &lbl_str, NULL);
                XtVaSetValues(opmenu_label, XmNlabelString, lbl_str, NULL);
                break;
        ...
        XmTextFieldSetString(props_dlg->run_time_textf,
                             CodeGenOptions.run_args);
...
)
{
    ...
    /*** DTB_USER_CODE_START vvv Add C variables and code below vvv ***/
         ...
         * on a list object.
         */
        XtAddCallback(dtbSource->module_list, XmNmultipleSelectionCallback,
                      cgenP_update_mod_listCB, NULL);
