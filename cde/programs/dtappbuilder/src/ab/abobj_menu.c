...
static int add_win_menu_cache_entry(ABObj winobj, Widget menu);
static int delete_win_menu_cache_entry(ABObj winobj);
static int add_browser_menu_cache_entry(Widget brws_widget, Widget menu);
static int delete_browser_menu_cache_entry(Widget brws_widget);

static Widget get_edit_menu_from_cache(EDIT_MENU_TYPE mtype, Widget origin);
static int set_menu_state(Widget menu, unsigned int flags);
static void set_item_flags(ABSelectedRec *target, unsigned int *ret_item_flag);

/*
 * Callbacks
 */

static void win_cache_menu_destroyCB(Widget widget, XtPointer client_data,
                                     XtPointer call_data);
static void browser_cache_menu_destroyCB(Widget widget, XtPointer client_data,
                                         XtPointer call_data);
static void rev_propCB(Widget widget, XtPointer client_data,
                       XtPointer call_data);

static void fix_propCB(Widget widget, XtPointer client_data,
                       XtPointer call_data);

static void alignCB(Widget widget, XtPointer client_data, XtPointer call_data);

static void undoCB(Widget widget, XtPointer client_data, XtPointer call_data);
...
static void deleteCB(Widget widget, XtPointer client_data, XtPointer call_data);

static void browseCB(Widget widget, XtPointer client_data, XtPointer call_data);

static void groupCB(Widget widget, XtPointer client_data, XtPointer call_data);

static void ungroupCB(Widget widget, XtPointer client_data,
                      XtPointer call_data);

static void attachCB(Widget widget, XtPointer client_data, XtPointer call_data);

static void next_layerCB(Widget widget, XtPointer client_data,
                         XtPointer call_data);

static void make_paneCB(Widget widget, XtPointer client_data,
                        XtPointer call_data);

static void unmake_paneCB(Widget widget, XtPointer client_data,
                          XtPointer call_data);

static void expandCB(Widget widget, XtPointer client_data, XtPointer call_data);

static void expandAllCB(Widget widget, XtPointer client_data,
                        XtPointer call_data);

static void collapseCB(Widget widget, XtPointer client_data,
                       XtPointer call_data);

static void tearOffCB(Widget widget, XtPointer client_data,
                      XtPointer call_data);
...
**************************************************************************/
MenuItem prop_menu[] = {
    {NULL, NULL /*"Revolving..."*/, AB_LABEL_STRING, &xmPushButtonWidgetClass,
     rev_propCB, NULL, (XtPointer)ABMenuProps, NULL, 0, TRUE},
    {NULL, NULL /*"Fixed..."*/, AB_LABEL_STRING, &xmPushButtonWidgetClass,
     fix_propCB, NULL, (XtPointer)ABMenuProps, NULL, 0, TRUE},
    NULL};

MenuItem align_menu[] = {
    {NULL, "bitmaps/align_left.xbm", AB_LABEL_GLYPH, &xmPushButtonWidgetClass,
     alignCB, (XtPointer)LEFT_EDGES, (XtPointer)ABMenuAlign, NULL, 0, TRUE,
     align_left_width, align_left_height, align_left_bits},
    ...
    {NULL, "bitmaps/align_right.xbm", AB_LABEL_GLYPH, &xmPushButtonWidgetClass,
     alignCB, (XtPointer)RIGHT_EDGES, (XtPointer)ABMenuAlign, NULL, 0, TRUE,
     align_right_width, align_right_height, align_right_bits},
    {NULL, "bitmaps/align_labels.xbm", AB_LABEL_GLYPH, &xmPushButtonWidgetClass,
     alignCB, (XtPointer)LABELS, (XtPointer)ABMenuAlign, NULL, 0, TRUE,
     align_labels_width, align_labels_height, align_labels_bits},
    {NULL, "bitmaps/align_top.xbm", AB_LABEL_GLYPH, &xmPushButtonWidgetClass,
     alignCB, (XtPointer)TOP_EDGES, (XtPointer)ABMenuAlign, NULL, 0, TRUE,
     align_top_width, align_top_height, align_top_bits},
    ...
    {NULL, "bitmaps/align_bottom.xbm", AB_LABEL_GLYPH, &xmPushButtonWidgetClass,
     alignCB, (XtPointer)BOTTOM_EDGES, (XtPointer)ABMenuAlign, NULL, 0, TRUE,
     align_bottom_width, align_bottom_height, align_bottom_bits},
    {NULL, "bitmaps/align_grid.xbm", AB_LABEL_GLYPH, &xmPushButtonWidgetClass,
     alignCB, (XtPointer)TO_GRID, (XtPointer)ABMenuAlign, NULL, 0, TRUE,
     align_grid_width, align_grid_height, align_grid_bits},
    NULL};
...
MenuItem distribute_menu[] = {
    {NULL, "bitmaps/distribute_horizontal.xbm", AB_LABEL_GLYPH,
     ...
     (XtPointer)ABMenuDistribute, NULL, 0, TRUE, distribute_horizontal_width,
     distribute_horizontal_height, distribute_horizontal_bits},
    {NULL, "bitmaps/distribute_vertical.xbm", AB_LABEL_GLYPH,
     &xmPushButtonWidgetClass, alignCB, (XtPointer)VSPACING,
     (XtPointer)ABMenuDistribute, NULL, 0, TRUE, distribute_vertical_width,
     distribute_vertical_height, distribute_vertical_bits},
    {NULL, "bitmaps/distribute_hcenter.xbm", AB_LABEL_GLYPH,
     &xmPushButtonWidgetClass, alignCB, (XtPointer)HCENTERED,
     (XtPointer)ABMenuDistribute, NULL, 0, TRUE, distribute_hcenter_width,
     distribute_hcenter_height, distribute_hcenter_bits},
    {NULL, "bitmaps/distribute_vcenter.xbm", AB_LABEL_GLYPH,
     &xmPushButtonWidgetClass, alignCB, (XtPointer)VCENTERED,
     (XtPointer)ABMenuDistribute, NULL, 0, TRUE, distribute_vcenter_width,
     distribute_vcenter_height, distribute_vcenter_bits},
    NULL};
...
MenuItem obj_menu_items[] = {
    {
        ...
        NULL,
        NULL,
        (XtPointer)(XtPointer)ABMenuProps,
        prop_menu,
        1,
        TRUE,
        0,
    ...
    {NULL, NULL /*"Browse..."*/, AB_LABEL_STRING, &xmPushButtonWidgetClass,
     browseCB, NULL, (XtPointer)ABMenuBrowse, NULL, 0, TRUE, 0, 0, NULL},
    {NULL, "", AB_LABEL_SEPARATOR, &xmSeparatorWidgetClass, NULL, NULL, NULL,
     NULL, 0, TRUE, 0, 0, NULL},
    {"undo_menu", NULL /*"Undo"*/, AB_LABEL_STRING, &xmPushButtonWidgetClass,
     undoCB, NULL, (XtPointer)ABMenuUndo, NULL, 0, TRUE, 0, 0, NULL},
    {"cut_menu", NULL /*"Cut"*/, AB_LABEL_STRING, &xmPushButtonWidgetClass,
     cutCB, NULL, (XtPointer)ABMenuCut, NULL, 0, TRUE, 0, 0, NULL},
    {"copy_menu", NULL /*"Copy"*/, AB_LABEL_STRING, &xmPushButtonWidgetClass,
     copyCB, NULL, (XtPointer)ABMenuCopy, NULL, 0, TRUE, 0, 0, NULL},
    {NULL, NULL /*"Paste"*/, AB_LABEL_STRING, &xmPushButtonWidgetClass, pasteCB,
     (XtPointer)AB_PASTE_INITIATOR_OBJ_MENU, (XtPointer)ABMenuPaste, NULL, 0,
     TRUE, 0, 0, NULL},
    {NULL, NULL /*"Delete"*/, AB_LABEL_STRING, &xmPushButtonWidgetClass,
     deleteCB, NULL, (XtPointer)ABMenuDelete, NULL, 0, TRUE, 0, 0, NULL},
    {NULL, "", AB_LABEL_SEPARATOR, &xmSeparatorWidgetClass, NULL, NULL, NULL,
     NULL, 0, TRUE, 0, 0, NULL},
    {"align_menu", NULL /*"Align"*/, AB_LABEL_STRING,
     &xmCascadeButtonWidgetClass, NULL, NULL, (XtPointer)ABMenuAlign,
     align_menu, 2, TRUE, 0, 0, NULL},
    {"distribute_menu", NULL /*"Distribute"*/, AB_LABEL_STRING,
     &xmCascadeButtonWidgetClass, NULL, NULL, (XtPointer)ABMenuDistribute,
     distribute_menu, 2, TRUE, 0, 0, NULL},
    {NULL, NULL /*"Group"*/, AB_LABEL_STRING, &xmPushButtonWidgetClass, groupCB,
     NULL, (XtPointer)ABMenuGroup, NULL, 0, TRUE, 0, 0, NULL},
    {NULL, NULL /*"Ungroup"*/, AB_LABEL_STRING, &xmPushButtonWidgetClass,
     ungroupCB, NULL, (XtPointer)ABMenuUngroup, NULL, 0, TRUE, 0, 0, NULL},
    {NULL, NULL /*"Make Paned Window"*/, AB_LABEL_STRING,
     &xmPushButtonWidgetClass, make_paneCB, NULL, (XtPointer)ABMenuPane, NULL,
     0, TRUE, 0, 0, NULL},
    {NULL, NULL /*"Unmake Paned Window"*/, AB_LABEL_STRING,
     &xmPushButtonWidgetClass, unmake_paneCB, NULL, (XtPointer)ABMenuUnpane,
     NULL, 0, TRUE, 0, 0, NULL},
    {NULL, NULL /*"Attachments..."*/, AB_LABEL_STRING, &xmPushButtonWidgetClass,
     attachCB, NULL, (XtPointer)ABMenuAttach, NULL, 0, TRUE, 0, 0, NULL},
    {NULL, "", AB_LABEL_SEPARATOR, &xmSeparatorWidgetClass, NULL, NULL, NULL,
     NULL, 0, TRUE, 0, 0, NULL},
    {NULL, NULL /*"NextLayer"*/, AB_LABEL_STRING, &xmPushButtonWidgetClass,
     next_layerCB, NULL, (XtPointer)ABMenuNextLayer, NULL, 0, TRUE, 0, 0, NULL},
    NULL};
...
MenuItem browser_menu_items[] = {
    ...
    {NULL, NULL /*"Tearoff Browser..."*/, AB_LABEL_STRING,
     &xmPushButtonWidgetClass, tearOffCB, NULL, (XtPointer)ABMenuTearOff, NULL,
     0, TRUE, 0, 0, NULL},
    {NULL, "", AB_LABEL_SEPARATOR, &xmSeparatorWidgetClass, NULL, NULL, NULL,
     NULL, 0, TRUE, 0, 0, NULL},
    {"undo_menu", NULL /*"Undo"*/, AB_LABEL_STRING, &xmPushButtonWidgetClass,
    ...
    {"copy_menu", NULL /*"Copy"*/, AB_LABEL_STRING, &xmPushButtonWidgetClass,
     copyCB, NULL, (XtPointer)ABMenuCopy, NULL, 0, TRUE, 0, 0, NULL},
    {NULL, NULL /*"Paste"*/, AB_LABEL_STRING, &xmPushButtonWidgetClass, pasteCB,
     NULL, (XtPointer)ABMenuPaste, NULL, 0, TRUE, 0, 0, NULL},
    {NULL, NULL /*"Delete"*/, AB_LABEL_STRING, &xmPushButtonWidgetClass,
     deleteCB, NULL, (XtPointer)ABMenuDelete, NULL, 0, TRUE, 0, 0, NULL},
    {NULL, "", AB_LABEL_SEPARATOR, &xmSeparatorWidgetClass, NULL, NULL, NULL,
     NULL, 0, TRUE, 0, 0, NULL},
    ...
    {NULL, "", AB_LABEL_SEPARATOR, &xmSeparatorWidgetClass, NULL, NULL, NULL,
     NULL, 0, TRUE, 0, 0, NULL},
    {NULL, NULL /*"Expand"*/, AB_LABEL_STRING, &xmPushButtonWidgetClass,
     expandCB, NULL, (XtPointer)ABMenuExpand, NULL, 0, TRUE, 0, 0, NULL},
    {NULL, NULL /*"Expand All"*/, AB_LABEL_STRING, &xmPushButtonWidgetClass,
     expandAllCB, NULL, (XtPointer)ABMenuExpandAll, NULL, 0, TRUE, 0, 0, NULL},
    {NULL, NULL /*"Collapse"*/, AB_LABEL_STRING, &xmPushButtonWidgetClass,
     collapseCB, NULL, (XtPointer)ABMenuCollapse, NULL, 0, TRUE, 0, 0, NULL},
    NULL};
...
static void win_cache_menu_destroyCB(Widget menu, XtPointer client_data,
                                     XtPointer call_data) {
        ABObj winobj = (ABObj)client_data;

        delete_win_menu_cache_entry(winobj);
}
static void browser_cache_menu_destroyCB(Widget menu, XtPointer client_data,
                                         XtPointer call_data) {
...
static int delete_browser_menu_cache_entry(Widget brws_widget) {
        ...
        for (i = 0; i < browser_menu_cache_count; i++) {
                if (browser_menu_cache[i].brws_widget == brws_widget)
                        ...
                        browser_menu_cache[i - 1].brws_widget =
                            browser_menu_cache[i].brws_widget;
                        browser_menu_cache[i - 1].menu =
                            browser_menu_cache[i].menu;
                }
        }
        if (shift)
...
static int add_win_menu_cache_entry(ABObj winobj, Widget menu) {
        ...
        if (win_menu_cache_count == win_menu_cache_max) /* Need Cache Space*/
        {
                ...
                new_cache = (WinMenuCache *)util_malloc(win_menu_cache_max *
                                                        sizeof(WinMenuCache));

                /* Copy old cache into new cache...
                 * NOTE: this would ONLY happen if the number of Window objects
                 *       instantiated exceeds WIN_MENU_CACHE_BLOCK - which
...
static int add_browser_menu_cache_entry(Widget brws_widget, Widget menu) {
        ...
        if (browser_menu_cache_count ==
            browser_menu_cache_max) /* Need Cache Space*/
        {
                /* if browser_menu_cache_count == 0, then it's our first
                 * time...*/
                 ...
                 *       instantiated exceeds EDIT_MENU_CACHE_BLOCK - which
                 * should rarely happen!
                 */
                for (i = 0; i < browser_menu_cache_count; i++) {
...
static Widget get_edit_menu_from_cache(EDIT_MENU_TYPE mtype, Widget origin) {
        ...
        if (mtype == WIN_EDIT_MENU) {
                ...
                menu = ui_build_menu(menup, XmMENU_POPUP, 1, NULL, "obj_menu",
                                     obj_menu_items);
        } else /* BROWSER_EDIT_MENU */
        {
                ...
                /*
                 * The browser routines need a handle to the relevant browser
                 * data structure (different for different browsers). A pointer
                 * to this structure is set as user data on the browser widget.
                 * Set this structure up as client data for the callbacks.
                 * (User data is used for the item flags so we can't use that
                 * here).
                 */
                ...
                if (ab)
                        for (i = 0; browser_menu_items[i].label != NULL; i++) {
                                browser_menu_items[i].client_data =
                                    (XtPointer)ab;
                        }
        ...
        if (mtype == WIN_EDIT_MENU) {
                ...
                XtAddCallback(menu, XtNdestroyCallback,
                              win_cache_menu_destroyCB, (XtPointer)winobj);
        } else /* BROWSER_EDIT_MENU */
        {
                add_browser_menu_cache_entry(origin, menu);
                XtAddCallback(menu, XtNdestroyCallback,
                              browser_cache_menu_destroyCB, (XtPointer)origin);
        }
...
static int set_menu_state(Widget menu, unsigned int flags) {
        ...
        XtVaGetValues(menu, XmNnumChildren, &num_items, XmNchildren, &items,
                      NULL);
...
static void set_item_flags(ABSelectedRec *target,
 ...
 */
void abobj_popup_menu(EDIT_MENU_TYPE mtype, Widget origin,
                      ABSelectedRec *target, XButtonEvent *event) {
        ABObj selobj;
        ABObj selparent;
        ABObj pane_parent;
        Widget popup_menu;
...
static void rev_propCB(Widget menu, XtPointer client_data,
                       XtPointer call_data) {
...
static void fix_propCB(Widget menu, XtPointer client_data,
                       XtPointer call_data) {
        ABObj obj = sel.list[0];
...
static void alignCB(Widget menu, XtPointer client_data, XtPointer call_data) {
        abobj_align((unsigned long)client_data);
}

static void undoCB(Widget menu, XtPointer client_data, XtPointer call_data) {
        (void)abobj_undo();
}

static void cutCB(Widget menu, XtPointer client_data, XtPointer call_data) {
        (void)abobj_cut();
}

static void copyCB(Widget menu, XtPointer client_data, XtPointer call_data) {
        (void)abobj_copy();
}

static void pasteCB(Widget menu, XtPointer client_data, XtPointer call_data) {
        AB_PASTE_INITIATOR_TYPE initiator =
            (AB_PASTE_INITIATOR_TYPE)client_data;
...
static void deleteCB(Widget menu, XtPointer client_data, XtPointer call_data) {
        abobj_delete();
}

static void browseCB(Widget menu, XtPointer client_data, XtPointer call_data) {
        /*
...
static void groupCB(Widget menu, XtPointer client_data, XtPointer call_data) {
        abobj_group_selected_objects();
}
static void

ungroupCB(Widget menu, XtPointer client_data, XtPointer call_data) {
...
static void attachCB(Widget widget, XtPointer client_data,
                     XtPointer call_data) {
        ABObj obj = sel.list[0];
...
static void expandCB(Widget menu, XtPointer client_data, XtPointer call_data) {
        ABBrowser ab = (ABBrowser)client_data;

        brwsP_expand_selected(ab);
}

static void expandAllCB(Widget menu, XtPointer client_data,
                        XtPointer call_data) {
        ABBrowser ab = (ABBrowser)client_data;
...
static void collapseCB(Widget menu, XtPointer client_data,
                       XtPointer call_data) {
        ABBrowser ab = (ABBrowser)client_data;
...
static void tearOffCB(Widget menu, XtPointer client_data, XtPointer call_data) {
        ABBrowser ab = (ABBrowser)client_data;

        brwsP_tear_off_selected(ab);
}

void abobj_build_layout_menu(Widget menu) {
        if (menu)
                ui_populate_pulldown_menu(menu, 1, layout_menu_items);
}

void abobj_set_menu_item_state(Widget menu) {
        ABSelectedRec sel;
...
void abobj_strings_init() {
        ...
        props_str = XtNewString(catgets(Dtb_project_catd, 100, 137, "Props"));
        undo_str = XtNewString(catgets(Dtb_project_catd, 100, 138, "Undo"));
        cut_str = XtNewString(catgets(Dtb_project_catd, 100, 139, "Cut"));
        copy_str = XtNewString(catgets(Dtb_project_catd, 100, 140, "Copy"));
        paste_str = XtNewString(catgets(Dtb_project_catd, 100, 141, "Paste"));
        delete_str = XtNewString(catgets(Dtb_project_catd, 100, 142, "Delete"));
        align_str = XtNewString(catgets(Dtb_project_catd, 100, 143, "Align"));
        distr_str =
            XtNewString(catgets(Dtb_project_catd, 100, 144, "Distribute"));
        group_str = XtNewString(catgets(Dtb_project_catd, 100, 145, "Group"));
        ungroup_str =
            XtNewString(catgets(Dtb_project_catd, 100, 146, "Ungroup"));
        mk_paned_win_str = XtNewString(
            catgets(Dtb_project_catd, 100, 147, "Make Paned Window"));
        unmk_paned_win_str = XtNewString(
            catgets(Dtb_project_catd, 100, 148, "Unmake Paned Window"));
        attach_str =
        ...
        browser_menu_items[1].label = XtNewString(
            catgets(Dtb_project_catd, 100, 154, "Tearoff Browser..."));
