                                ...
                                if (write_OK) {
                                        ...
                                        sprintf(
                                            ...
                                            catgets(Dtb_project_catd, 100, 76,
                                                    "Cannot save module to "
                                                    "\"%s\".\n\"%s\" does not "
                                                    "have write permission."),
                                            mod_dir, mod_dir);
                                        sprintf(
                                            help_buf,
                                            catgets(Dtb_project_catd, 100, 82,
                                                    "You do not have "
                                                    "permission to write to "
                                                    "the\ndirectory \"%s\"."),
                                            mod_dir);
                                        util_set_help_data(help_buf, NULL,
                                                           NULL);
                                        util_printf_err(Buf);
                                }
                        } else {
                                util_dprintf(1, "Error in accessing \"%s\".",
                                             mod_dir);
                        }
                }
        }
        ...
        for (i = 0; i < num_selected; i++) {
                ...
                if (obj_has_flag(obj, MappedFlag)) {
                        ...
                        if (util_get_verbosity() > 0)
                                fprintf(
                                    stderr,
                                    "show_proc: error in abobj_show_tree\n");
                        break;
                }
        ...
        for (i = 0; i < num_selected; i++) {
                ...
                if (abobj_hide_tree(obj) == -1) {
                        if (util_get_verbosity() > 0)
                                fprintf(
                                    stderr,
                                    "hide_proc: error in abobj_hide_tree\n");
                }
        ...
        for (i = 0; i < num_selected; i++) {
                ...
                if (obj_has_flag(obj, SaveNeededFlag)) {
                        ...
                        if (save_count == 0) {
                                 ...
                                 */
                                init_msg = catgets(
                                    Dtb_project_catd, 100, 68,
                                    "The following module(s) have unsaved "
                                    "edits. Removing the\nmodule(s) from the "
                                    "project will discard your "
                                    "changes.\nPlease confirm.");
...
)
{
    ...
    /*** DTB_USER_CODE_START vvv Add C code below vvv ***/
        DtbProjProjMainInfo proj_win = (DtbProjProjMainInfo)clientData;
