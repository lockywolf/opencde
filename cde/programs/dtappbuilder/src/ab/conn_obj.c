...
static AB_WHEN application_whens[] = {
    AB_WHEN_SESSION_SAVE,          AB_WHEN_SESSION_RESTORE,
    AB_WHEN_TOOLTALK_DO_COMMAND,   AB_WHEN_TOOLTALK_GET_STATUS,
    AB_WHEN_TOOLTALK_PAUSE_RESUME, AB_WHEN_TOOLTALK_QUIT,
};

static AB_WHEN basewin_whens[] = {AB_WHEN_AFTER_CREATED, AB_WHEN_DESTROYED,
                                  AB_WHEN_HIDDEN,        AB_WHEN_SHOWN,
                                  AB_WHEN_DRAGGED_FROM,  AB_WHEN_DROPPED_ON};

static AB_BUILTIN_ACTION basewin_acts[] = {
    AB_STDACT_DISABLE,
    AB_STDACT_ENABLE,
    AB_STDACT_HIDE,
    AB_STDACT_SHOW,
...
static AB_WHEN button_whens[] = {
    AB_WHEN_AFTER_CREATED,
    AB_WHEN_DESTROYED,
    AB_WHEN_ACTIVATED,
};

static AB_BUILTIN_ACTION button_acts[] = {
    AB_STDACT_DISABLE, AB_STDACT_ENABLE,    AB_STDACT_HIDE,
    AB_STDACT_SHOW,    AB_STDACT_SET_LABEL,
};

static AB_WHEN choice_whens[] = {
    AB_WHEN_AFTER_CREATED,
    AB_WHEN_DESTROYED,
};

static AB_BUILTIN_ACTION choice_acts[] = {
    AB_STDACT_DISABLE, AB_STDACT_ENABLE,    AB_STDACT_HIDE,
    AB_STDACT_SHOW,    AB_STDACT_SET_LABEL,
};

static AB_WHEN combobox_whens[] = {
    AB_WHEN_AFTER_CREATED,
    AB_WHEN_DESTROYED,
    AB_WHEN_ITEM_SELECTED,
};

static AB_BUILTIN_ACTION combobox_acts[] = {
    AB_STDACT_DISABLE, AB_STDACT_ENABLE,    AB_STDACT_HIDE,
    AB_STDACT_SHOW,    AB_STDACT_SET_LABEL,
};

static AB_WHEN container_whens[] = {
    AB_WHEN_AFTER_CREATED,
    AB_WHEN_DESTROYED,
...
static AB_BUILTIN_ACTION container_acts[] = {
    AB_STDACT_DISABLE,
    AB_STDACT_ENABLE,
    AB_STDACT_HIDE,
    AB_STDACT_SHOW,
...
static AB_WHEN group_whens[] = {
    AB_WHEN_AFTER_CREATED,
    AB_WHEN_DESTROYED,
};

static AB_BUILTIN_ACTION group_acts[] = {
    AB_STDACT_DISABLE,
    AB_STDACT_ENABLE,
    AB_STDACT_HIDE,
    AB_STDACT_SHOW,
...
static AB_WHEN menubar_whens[] = {
    AB_WHEN_AFTER_CREATED,
    AB_WHEN_DESTROYED,
};

static AB_BUILTIN_ACTION menubar_acts[] = {
    AB_STDACT_DISABLE,
    AB_STDACT_ENABLE,
    AB_STDACT_HIDE,
    AB_STDACT_SHOW,
...
static AB_WHEN panedwin_whens[] = {
    AB_WHEN_AFTER_CREATED,
    AB_WHEN_DESTROYED,
};

static AB_BUILTIN_ACTION panedwin_acts[] = {
    AB_STDACT_DISABLE,
    AB_STDACT_ENABLE,
    AB_STDACT_HIDE,
    AB_STDACT_SHOW,
...
static AB_WHEN dialog_whens[] = {AB_WHEN_AFTER_CREATED, AB_WHEN_DESTROYED,
                                 AB_WHEN_HIDDEN,        AB_WHEN_SHOWN,
                                 AB_WHEN_DRAGGED_FROM,  AB_WHEN_DROPPED_ON};

static AB_BUILTIN_ACTION dialog_acts[] = {
    AB_STDACT_DISABLE,
    AB_STDACT_ENABLE,
    AB_STDACT_HIDE,
    AB_STDACT_SHOW,
...
static AB_WHEN drawarea_whens[] = {
    AB_WHEN_AFTER_CREATED, AB_WHEN_DESTROYED,      AB_WHEN_DRAGGED_FROM,
    AB_WHEN_DROPPED_ON,    AB_WHEN_REPAINT_NEEDED, AB_WHEN_AFTER_RESIZED,
};

static AB_BUILTIN_ACTION drawarea_acts[] = {
    AB_STDACT_DISABLE,
    AB_STDACT_ENABLE,
    AB_STDACT_HIDE,
    AB_STDACT_SHOW,
...
static AB_BUILTIN_ACTION label_acts[] = {
    AB_STDACT_DISABLE, AB_STDACT_ENABLE,    AB_STDACT_HIDE,
    AB_STDACT_SHOW,    AB_STDACT_SET_LABEL,
};

static AB_WHEN list_whens[] = {
    AB_WHEN_AFTER_CREATED, AB_WHEN_DESTROYED,  AB_WHEN_DOUBLE_CLICKED_ON,
    AB_WHEN_DRAGGED_FROM,  AB_WHEN_DROPPED_ON, AB_WHEN_ITEM_SELECTED,
};

static AB_BUILTIN_ACTION list_acts[] = {
    AB_STDACT_DISABLE, AB_STDACT_ENABLE,    AB_STDACT_HIDE,
    AB_STDACT_SHOW,    AB_STDACT_SET_LABEL,
};

static AB_WHEN menu_whens[] = {
    AB_WHEN_AFTER_CREATED,
    AB_WHEN_DESTROYED,
    AB_WHEN_POPPED_UP,
    AB_WHEN_POPPED_DOWN,
...
static AB_WHEN separator_whens[] = {
    AB_WHEN_AFTER_CREATED,
    AB_WHEN_DESTROYED,
};

static AB_BUILTIN_ACTION separator_acts[] = {
    AB_STDACT_DISABLE,
    AB_STDACT_ENABLE,
    AB_STDACT_HIDE,
    AB_STDACT_SHOW,
...
static AB_BUILTIN_ACTION scale_acts[] = {
    AB_STDACT_DISABLE, AB_STDACT_ENABLE,    AB_STDACT_HIDE,
    AB_STDACT_SHOW,    AB_STDACT_SET_LABEL, AB_STDACT_SET_VALUE,
};

static AB_WHEN spinbox_whens[] = {
    AB_WHEN_AFTER_CREATED,
    AB_WHEN_DESTROYED,
    AB_WHEN_VALUE_CHANGED,
};

static AB_BUILTIN_ACTION spinbox_acts[] = {
    AB_STDACT_DISABLE, AB_STDACT_ENABLE,    AB_STDACT_HIDE,
    AB_STDACT_SHOW,    AB_STDACT_SET_LABEL, AB_STDACT_SET_VALUE,
};

static AB_WHEN termpane_whens[] = {
    AB_WHEN_AFTER_CREATED,
    AB_WHEN_DESTROYED,
};

static AB_BUILTIN_ACTION termpane_acts[] = {
    AB_STDACT_DISABLE,
    AB_STDACT_ENABLE,
    AB_STDACT_HIDE,
    AB_STDACT_SHOW,
...
static AB_WHEN textfield_whens[] = {
    AB_WHEN_AFTER_CREATED,
    AB_WHEN_DESTROYED,
...
static AB_BUILTIN_ACTION textfield_acts[] = {
    AB_STDACT_DISABLE, AB_STDACT_ENABLE,    AB_STDACT_HIDE,
    AB_STDACT_SHOW,    AB_STDACT_SET_LABEL, AB_STDACT_SET_TEXT,
};

static AB_WHEN textpane_whens[] = {
    AB_WHEN_AFTER_CREATED,
    AB_WHEN_DESTROYED,
    AB_WHEN_BEFORE_TEXT_CHANGED,
    AB_WHEN_TEXT_CHANGED,
...
static AB_BUILTIN_ACTION textpane_acts[] = {
    AB_STDACT_DISABLE, AB_STDACT_ENABLE,   AB_STDACT_HIDE,
    AB_STDACT_SHOW,    AB_STDACT_SET_TEXT,
};

static AB_WHEN menuitem_whens[] = {
    AB_WHEN_AFTER_CREATED,
    AB_WHEN_DESTROYED,
    AB_WHEN_ACTIVATED,
};

static AB_BUILTIN_ACTION menuitem_acts[] = {
    AB_STDACT_DISABLE, AB_STDACT_ENABLE,    AB_STDACT_HIDE,
    AB_STDACT_SHOW,    AB_STDACT_SET_LABEL,
};

static AB_WHEN menubaritem_whens[] = {
    AB_WHEN_AFTER_CREATED,
    AB_WHEN_DESTROYED,
};

static AB_BUILTIN_ACTION menubaritem_acts[] = {
    AB_STDACT_DISABLE, AB_STDACT_ENABLE,    AB_STDACT_HIDE,
    AB_STDACT_SHOW,    AB_STDACT_SET_LABEL,
};

static AB_WHEN choiceitem_whens[] = {
    AB_WHEN_AFTER_CREATED,
    AB_WHEN_DESTROYED,
    AB_WHEN_ACTIVATED,
    AB_WHEN_TOGGLED,
...
static AB_BUILTIN_ACTION choiceitem_acts[] = {
    AB_STDACT_DISABLE, AB_STDACT_ENABLE,    AB_STDACT_HIDE,
    AB_STDACT_SHOW,    AB_STDACT_SET_LABEL,
};

static AB_WHEN message_whens[] = {
    AB_WHEN_ACTION1,
    AB_WHEN_ACTION2,
    AB_WHEN_ACTION3,
    AB_WHEN_CANCEL,
...
static AB_WHEN fchooser_whens[] = {
    AB_WHEN_AFTER_CREATED, AB_WHEN_DESTROYED, AB_WHEN_HIDDEN,
    AB_WHEN_SHOWN,         AB_WHEN_OK,        AB_WHEN_CANCEL,
};

static AB_BUILTIN_ACTION fchooser_acts[] = {
    AB_STDACT_HIDE,
    AB_STDACT_SHOW,
};

ConnObj ConnP_conn_objs[] = {
    {AB_TYPE_PROJECT, -1, "Application", application_whens,
     XtNumber(application_whens), AB_WHEN_SESSION_SAVE,
     (AB_BUILTIN_ACTION *)NULL, (Cardinal)0, (AB_BUILTIN_ACTION)NULL},
    {AB_TYPE_BUTTON, -1, "Button", button_whens, XtNumber(button_whens),
     AB_WHEN_ACTIVATED, button_acts, XtNumber(button_acts),
     AB_STDACT_SET_LABEL},
    {AB_TYPE_CHOICE, -1, "Choice", choice_whens, XtNumber(choice_whens),
     AB_WHEN_AFTER_CREATED, choice_acts, XtNumber(choice_acts),
     AB_STDACT_DISABLE},
    {AB_TYPE_ITEM, (int)AB_ITEM_FOR_CHOICE, "Choice Item", choiceitem_whens,
     XtNumber(choiceitem_whens), AB_WHEN_ACTIVATED, choiceitem_acts,
     XtNumber(choiceitem_acts), AB_STDACT_SET_LABEL},
    {AB_TYPE_COMBO_BOX, -1, "Combo Box", combobox_whens,
     XtNumber(combobox_whens), AB_WHEN_ITEM_SELECTED, combobox_acts,
     XtNumber(combobox_acts), AB_STDACT_DISABLE},
    {AB_TYPE_CONTAINER, -1, "Control Pane", container_whens,
     XtNumber(container_whens), AB_WHEN_AFTER_CREATED, container_acts,
     XtNumber(container_acts), AB_STDACT_DISABLE},
    {AB_TYPE_DIALOG, -1, "Custom Dialog", dialog_whens, XtNumber(dialog_whens),
     AB_WHEN_SHOWN, dialog_acts, XtNumber(dialog_acts), AB_STDACT_SHOW},
    {AB_TYPE_DRAWING_AREA, -1, "Draw Area Pane", drawarea_whens,
     XtNumber(drawarea_whens), AB_WHEN_AFTER_RESIZED, drawarea_acts,
     XtNumber(drawarea_acts), AB_STDACT_DISABLE},
    {AB_TYPE_FILE_CHOOSER, -1, "File Selection Dialog", fchooser_whens,
     XtNumber(fchooser_whens), AB_WHEN_SHOWN, fchooser_acts,
     XtNumber(fchooser_acts), AB_STDACT_SHOW},
    {AB_TYPE_CONTAINER, AB_CONT_GROUP, "Group", group_whens,
     XtNumber(group_whens), AB_WHEN_AFTER_CREATED, group_acts,
     XtNumber(group_acts), AB_STDACT_DISABLE},
    {AB_TYPE_LABEL, -1, "Label", label_whens, XtNumber(label_whens),
     AB_WHEN_AFTER_CREATED, label_acts, XtNumber(label_acts),
     AB_STDACT_SET_LABEL},
    {AB_TYPE_LIST, -1, "List", list_whens, XtNumber(list_whens),
     AB_WHEN_ITEM_SELECTED, list_acts, XtNumber(list_acts), AB_STDACT_DISABLE},
    {AB_TYPE_BASE_WINDOW, -1, "Main Window", basewin_whens,
     XtNumber(basewin_whens), AB_WHEN_SHOWN, basewin_acts,
     XtNumber(basewin_acts), AB_STDACT_SHOW},
    {AB_TYPE_MENU, -1, "Menu", menu_whens, XtNumber(menu_whens),
     AB_WHEN_POPPED_UP, (AB_BUILTIN_ACTION *)NULL, (Cardinal)0,
     (AB_BUILTIN_ACTION)NULL},
    {AB_TYPE_ITEM, (int)AB_ITEM_FOR_MENU, "Menu Item", menuitem_whens,
     XtNumber(menuitem_whens), AB_WHEN_ACTIVATED, menuitem_acts,
     XtNumber(menuitem_acts), AB_STDACT_SET_LABEL},
    {AB_TYPE_CONTAINER, AB_CONT_MENU_BAR, "Menubar", menubar_whens,
     XtNumber(menubar_whens), AB_WHEN_AFTER_CREATED, menubar_acts,
     XtNumber(menubar_acts), AB_STDACT_DISABLE},
    {AB_TYPE_ITEM, (int)AB_ITEM_FOR_MENUBAR, "Menubar Item", menubaritem_whens,
     XtNumber(menubaritem_whens), AB_WHEN_AFTER_CREATED, menubaritem_acts,
     XtNumber(menubaritem_acts), AB_STDACT_SET_LABEL},
    {AB_TYPE_MESSAGE, -1, "Message", message_whens, XtNumber(message_whens),
     (AB_WHEN)NULL, (AB_BUILTIN_ACTION *)NULL, (Cardinal)0,
     (AB_BUILTIN_ACTION)NULL},
    {AB_TYPE_CONTAINER, AB_CONT_PANED, "Paned Window", panedwin_whens,
     XtNumber(panedwin_whens), AB_WHEN_AFTER_CREATED, panedwin_acts,
     XtNumber(panedwin_acts), AB_STDACT_DISABLE},
    {AB_TYPE_SCALE, -1, "Scale", scale_whens, XtNumber(scale_whens),
     AB_WHEN_VALUE_CHANGED, scale_acts, XtNumber(scale_acts),
     AB_STDACT_SET_VALUE},
    {AB_TYPE_SEPARATOR, -1, "Separator", separator_whens,
     XtNumber(separator_whens), AB_WHEN_AFTER_CREATED, separator_acts,
     XtNumber(separator_acts), AB_STDACT_HIDE},
    {AB_TYPE_SPIN_BOX, -1, "Spin Box", spinbox_whens, XtNumber(spinbox_whens),
     AB_WHEN_VALUE_CHANGED, spinbox_acts, XtNumber(spinbox_acts),
     AB_STDACT_SET_VALUE},
    {AB_TYPE_TERM_PANE, -1, "Term Pane", termpane_whens,
     XtNumber(termpane_whens), AB_WHEN_AFTER_CREATED, termpane_acts,
     XtNumber(termpane_acts), AB_STDACT_DISABLE},
    {AB_TYPE_TEXT_FIELD, -1, "Text Field", textfield_whens,
     XtNumber(textfield_whens), AB_WHEN_TEXT_CHANGED, textfield_acts,
     XtNumber(textfield_acts), AB_STDACT_SET_TEXT},
    {AB_TYPE_TEXT_PANE, -1, "Text Pane", textpane_whens,
     XtNumber(textpane_whens), AB_WHEN_TEXT_CHANGED, textpane_acts,
     XtNumber(textpane_acts), AB_STDACT_SET_TEXT}};
...
static BOOL is_descendant(ABObj parent, ABObj child);
static void assign_when_list(AB_OBJECT_TYPE source_type, int source_subtype);
static void assign_action_list(AB_OBJECT_TYPE target_type, int target_subtype);
static STRING get_when_label(AB_WHEN when_type);
static STRING get_stdact_label(AB_BUILTIN_ACTION stdact_type);
...
extern char **connP_get_when_labels(int *num_labels) {
...
extern char **connP_get_act_labels(int *num_labels) {
        ...
        if (stdact_label_list == NULL) {
                ...
                for (i = 1; i < (int)AB_BUILTIN_ACTION_NUM_VALUES; i++)
                        stdact_label_list[i - 1] =
                            get_stdact_label((AB_BUILTIN_ACTION)i);
        }
        *num_labels = (int)AB_BUILTIN_ACTION_NUM_VALUES - 1;
        return (stdact_label_list);
}

extern AB_OBJECT_TYPE connP_get_source_type(void) {
        if (cur_source_type == AB_TYPE_UNKNOWN)
                connP_set_source_type(AB_TYPE_BUTTON, -1);
        return cur_source_type;
}

extern int connP_get_source_subtype(void) { return cur_source_subtype; }

extern AB_OBJECT_TYPE connP_get_target_type(void) {
        if (cur_target_type == AB_TYPE_UNKNOWN)
                connP_set_target_type(AB_TYPE_BUTTON, -1);
        return cur_target_type;
}

extern int connP_get_target_subtype(void) { return cur_target_subtype; }

extern void connP_set_source_type(AB_OBJECT_TYPE obj_type, int obj_subtype) {
        ...
        if (ChangedType || (obj_subtype != cur_source_subtype)) {
                ...
                connP_ui_source_type_update(cur_source_type,
                                            cur_source_subtype);
        }
}

extern void connP_set_target_type(AB_OBJECT_TYPE obj_type, int obj_subtype) {
        ...
        if (ChangedType || (obj_subtype != cur_target_subtype)) {
                ...
                if (ChangedType) {
                        ...
                        connP_ui_target_type_update(cur_target_type,
                                                    cur_target_subtype);
                }
        }
}

extern void conn_set_source(ABObj obj) {
        if (cur_source == obj)
                return;
...
extern ABObj connP_get_source() { return cur_source; }

extern void conn_set_target(ABObj obj) {
        if (cur_target == obj)
                return;
...
extern ABObj connP_get_target() { return cur_target; }

extern ABObj connP_get_connection(void) { return cur_action_obj; }

extern void connP_set_connection(ABObj action) { cur_action_obj = action; }

extern void connP_set_action_type(AB_FUNC_TYPE action_type) {
        cur_action_type = action_type;
}

extern AB_FUNC_TYPE connP_get_action_type(void) { return cur_action_type; }

extern char *connP_make_conn_string(ABObj action_obj) {
        register int i;
        long si;
        ...
        case AB_FUNC_BUILTIN: {
                ...
                strcat(conn_string,
                       catgets(Dtb_project_catd, 100, 196, " on "));
        ...
        case AB_FUNC_USER_DEF:
                strcat(conn_string,
                       catgets(Dtb_project_catd, 100, 197, "Call function"));
                strcat(conn_string, " \"");
                {
        ...
        case AB_FUNC_CODE_FRAG:
                strcat(conn_string,
                       catgets(Dtb_project_catd, 100, 198, "Execute Code"));
                break;

        case AB_FUNC_ON_ITEM_HELP:
                strcat(conn_string, catgets(Dtb_project_catd, 100, 199,
                                            "Activate On-Item Help"));
                break;

        case AB_FUNC_HELP_VOLUME:
                strcat(conn_string, catgets(Dtb_project_catd, 100, 200,
                                            "Access Help Volume"));
                strcat(conn_string, " \"");
                ...
                strcat(conn_string, "\" ");
                strcat(conn_string,
                       catgets(Dtb_project_catd, 100, 201, "at location"));
                strcat(conn_string, " \"");
...
extern long connP_get_obj_type_index(AB_OBJECT_TYPE ab_type, int ab_subtype) {
        register long i;
...
extern AB_ARG_TYPE connP_action_needs_arg(AB_BUILTIN_ACTION act_type) {
        switch (act_type) {
...
extern void connP_guess_when_action(AB_OBJECT_TYPE source_type,
                                    int source_subtype,
                                    AB_OBJECT_TYPE target_type,
                                    int target_subtype, AB_WHEN *when_ret,
        ...
        *func_type = AB_FUNC_BUILTIN;
        ...
        case AB_TYPE_ITEM:
                ...
                case AB_TYPE_DIALOG:
                        if (is_descendant(connP_get_target(),
                                          connP_get_source()))
...
static void assign_when_list(AB_OBJECT_TYPE source_type, int source_subtype) {
        ...
        for (i = 0; i < n; i++) {
                ...
                ConnP_conn_whens[i].label =
                    get_when_label(src_conn_obj->when_list[i]);
        }
...
static void assign_action_list(AB_OBJECT_TYPE target_type, int target_subtype) {
        ...
        for (i = 0; i < n; i++) {
                ...
                ConnP_conn_acts[i].label =
                    get_stdact_label(trg_conn_obj->action_list[i]);
        }
 ...
 */
extern int connP_objtype_needs_subtype(AB_OBJECT_TYPE obj_type,
                                       int obj_subtype) {
        register int i;
...
extern long connP_obj_enabled(AB_OBJECT_TYPE obj_type, int obj_subtype) {
        return (connP_get_obj_type_index(obj_type, obj_subtype) >= 0);
}

extern void connP_set_conn_arg(ABObj ab_action, AB_ARG_TYPE arg_type,
                               char *str_value) {
        /*
...
extern void connP_make_builtin_conn(ABObj ab_action, ABObj c_source,
                                    ABObj c_target, AB_WHEN c_when,
...
extern void connP_make_user_def_conn(ABObj ab_action, ABObj c_source,
                                     AB_WHEN c_when, char *function_name) {
        ab_action->info.action.from = c_source;
        ab_action->info.action.to = NULL;
        ab_action->info.action.when = c_when;
        ab_action->info.action.func_type = AB_FUNC_USER_DEF;
        ab_action->info.action.func_value.func_name =
            istr_create(function_name);
}

extern void connP_make_code_frag_conn(ABObj ab_action, ABObj c_source,
                                      AB_WHEN c_when, char *code_frag) {
        ab_action->info.action.from = c_source;
        ab_action->info.action.to = NULL;
        ab_action->info.action.when = c_when;
...
extern void connP_builtin_remove_arg(ABObj ab_action) {
...
extern BOOL connP_change_in_builtin(ABObj ab_action, ABObj c_source,
                                    ABObj c_target, AB_WHEN c_when,
                                    AB_BUILTIN_ACTION c_act, char *arg_str) {
        ...
        if (old_arg_type != cur_arg_type) {
                ...
                case AB_ARG_STRING:
                        ...
                        if (ACT(arg_value.sval) != istr_value) {
                                ...
                                is_changed = TRUE;
                                connP_builtin_remove_arg(ab_action);
                                connP_set_conn_arg(ab_action, cur_arg_type,
                                                   arg_str);
                        }
                        break;
...
extern void connP_destroy_connections_for(ABObj obj) {
        ABObj project;
        AB_TRAVERSAL trav;
        ABObj cobj;

        if (obj == NULL || (project = obj_get_project(obj)) == NULL)
                return;
...
extern void connP_make_on_item_help_conn(ABObj ab_action, ABObj c_source,
                                         AB_WHEN c_when) {
        ab_action->info.action.from = c_source;
        ab_action->info.action.to = NULL;
        ab_action->info.action.when = c_when;
...
extern void connP_make_help_vol_conn(ABObj ab_action, ABObj c_source,
                                     AB_WHEN c_when, STRING volume,
                                     STRING location) {
        ab_action->info.action.from = c_source;
        ab_action->info.action.to = NULL;
        ab_action->info.action.when = c_when;
...
extern void conn_strings_init() {
        ...
        when_labels[AB_WHEN_ACTION1] = XtNewString(
            catgets(Dtb_project_catd, 100, 160, "Action1 Activated"));
        when_labels[AB_WHEN_ACTION2] = XtNewString(
            catgets(Dtb_project_catd, 100, 161, "Action2 Activated"));
        when_labels[AB_WHEN_ACTION3] = XtNewString(
            catgets(Dtb_project_catd, 100, 162, "Action3 Activated"));
        ...
        when_labels[AB_WHEN_BEFORE_TEXT_CHANGED] = XtNewString(
            catgets(Dtb_project_catd, 100, 166, "Before Text Changed"));
        when_labels[AB_WHEN_CANCEL] = XtNewString(
            catgets(Dtb_project_catd, 100, 167, "Cancel Activated"));
        when_labels[AB_WHEN_DESTROYED] =
            XtNewString(catgets(Dtb_project_catd, 100, 168, "Destroyed"));
        when_labels[AB_WHEN_DOUBLE_CLICKED_ON] = XtNewString(
            catgets(Dtb_project_catd, 100, 169, "Double Clicked On"));
        ...
        when_labels[AB_WHEN_TOOLTALK_DO_COMMAND] = XtNewString(
            catgets(Dtb_project_catd, 100, 184, "ToolTalk Do Command"));
        when_labels[AB_WHEN_TOOLTALK_GET_STATUS] = XtNewString(
            catgets(Dtb_project_catd, 100, 185, "ToolTalk Get Status"));
        when_labels[AB_WHEN_TOOLTALK_PAUSE_RESUME] = XtNewString(
            catgets(Dtb_project_catd, 100, 186, "ToolTalk Pause/Resume"));
