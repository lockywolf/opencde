...
static void reparent_children(ABObj newparent, ABObj *sel_list, int sel_count);
...
void grp_selected_objects() {
        ...
        xy_win = x_xwin_at_rootxy(AB_toplevel, current_rect.x, current_rect.y,
                                  &wx, &wy);
...
static void reparent_children(ABObj newparent, ABObj *sel_list, int sel_count) {
        ...
        for (i = 0; i < sel_count; i++) {
                ...
                abobj_calculate_new_layout(
                    obj, obj->x - current_rect.x, obj->y - current_rect.y,
                    (Dimension)obj->width, (Dimension)obj->height);
        }
}
