 ...
 * Methods
 */
static int glyph_initialize(ABObj obj);
static Widget glyph_prop_init(Widget parent, AB_PROP_TYPE type);
static int glyph_prop_activate(AB_PROP_TYPE type, BOOL active);
static int glyph_prop_clear(AB_PROP_TYPE type);
static int glyph_prop_load(ABObj obj, AB_PROP_TYPE type);
static int glyph_prop_apply(AB_PROP_TYPE type);

static BOOL glyph_prop_pending(AB_PROP_TYPE type);
...
static Widget name_label[AB_PROP_TYPE_NUM_VALUES],
    name_field[AB_PROP_TYPE_NUM_VALUES], name_cb[AB_PROP_TYPE_NUM_VALUES],

    colorf_label[AB_PROP_TYPE_NUM_VALUES],
    colorf_field[AB_PROP_TYPE_NUM_VALUES], colorf_cb[AB_PROP_TYPE_NUM_VALUES],

    monof_label[AB_PROP_TYPE_NUM_VALUES], monof_field[AB_PROP_TYPE_NUM_VALUES],
    monof_cb[AB_PROP_TYPE_NUM_VALUES],

    fg_label[AB_PROP_TYPE_NUM_VALUES], fg_button[AB_PROP_TYPE_NUM_VALUES],
    fg_field[AB_PROP_TYPE_NUM_VALUES], fg_cb[AB_PROP_TYPE_NUM_VALUES],
    fg_glyph[AB_PROP_TYPE_NUM_VALUES],

    bg_label[AB_PROP_TYPE_NUM_VALUES], bg_button[AB_PROP_TYPE_NUM_VALUES],
    bg_field[AB_PROP_TYPE_NUM_VALUES], bg_cb[AB_PROP_TYPE_NUM_VALUES],
...
static Widget glyph_prop_init(Widget parent, AB_PROP_TYPE type) {
        Widget prop_pane, setting, label, button;
        Arg args[20];
        int i;
        Pixel parent_bg;
        XmString xmlabel;

        prop_form[type] = prop_pane = XtVaCreateManagedWidget(
            "glyph_prop_pane", xmFormWidgetClass, parent, XmNresizePolicy,
            XmRESIZE_ANY, NULL);

        /* Set record of changebars currently "ON" to 0 */
        prop_init_change_count(prop_pane);

        XtVaGetValues(prop_pane, XmNbackground, &parent_bg, NULL);

        /********************************************************************
         *  Create Name Setting					   	*
         ********************************************************************/
        name_field[type] = XtVaCreateManagedWidget(
            "namefield", xmTextFieldWidgetClass, prop_pane, XmNshadowThickness,
            1, XmNhighlightThickness, 1, XmNmaxLength, 80, XmNleftAttachment,
            XmATTACH_POSITION, XmNleftPosition, prop_setting_anchor,
            XmNleftOffset, prop_offset_from_lbl, XmNrightAttachment,
            XmATTACH_POSITION, XmNrightPosition, prop_setting_end,
            XmNtopAttachment, XmATTACH_FORM, XmNtopOffset, prop_setting_offset,
            NULL);
        setting = name_field[type];

        xmlabel = XmStringCreateLocalized("Object Name:");
        name_label[type] = label = XtVaCreateManagedWidget(
            "prop_label", xmLabelWidgetClass, prop_pane, XmNlabelString,
            xmlabel, XmNalignment, XmALIGNMENT_END, XmNrightAttachment,
            XmATTACH_POSITION, XmNrightPosition, prop_setting_anchor,
            XmNleftAttachment, XmATTACH_POSITION, XmNleftPosition,
            prop_label_anchor, XmNtopAttachment, XmATTACH_OPPOSITE_WIDGET,
            XmNtopWidget, setting, XmNbottomAttachment,
            XmATTACH_OPPOSITE_WIDGET, XmNbottomWidget, setting, NULL);
        XmStringFree(xmlabel);

        name_cb[type] = XtVaCreateManagedWidget(
            "changebar", xmSeparatorWidgetClass, prop_pane, XmNorientation,
            XmVERTICAL, XmNseparatorType, XmSINGLE_LINE, XmNwidth,
            prop_cb_width, XmNbackground, parent_bg, XmNforeground, parent_bg,
            XmNleftAttachment, XmATTACH_POSITION, XmNleftPosition,
            prop_cb_anchor, XmNtopAttachment, XmATTACH_OPPOSITE_WIDGET,
            XmNtopWidget, setting, XmNrightAttachment, XmATTACH_POSITION,
            XmNrightPosition, prop_label_anchor, XmNbottomAttachment,
            XmATTACH_OPPOSITE_WIDGET, XmNbottomWidget, setting, XmNuserData,
            PROP_CB_OFF, NULL);
        XtAddCallback(name_field[type], XmNvalueChangedCallback,
                      prop_field_chgCB, name_cb[type]);
        XtVaSetValues(name_field[type], XmNuserData, PROP_EDIT, NULL);

        /********************************************************************
         *  Create Color Filename Setting                                   *
         ********************************************************************/
        colorf_field[type] = XtVaCreateManagedWidget(
            "field", xmTextFieldWidgetClass, prop_pane, XmNshadowThickness, 1,
            XmNhighlightThickness, 1, XmNmaxLength, 80, XmNleftAttachment,
            XmATTACH_POSITION, XmNleftPosition, prop_setting_anchor,
            XmNleftOffset, prop_offset_from_lbl, XmNtopAttachment,
            XmATTACH_WIDGET, XmNtopWidget, setting, XmNtopOffset,
            prop_setting_offset, XmNrightAttachment, XmATTACH_POSITION,
            XmNrightPosition, prop_setting_end, NULL);

        setting = colorf_field[type];
        xmlabel = XmStringCreateLocalized("Color Filename:");
        colorf_label[type] = XtVaCreateManagedWidget(
            "prop_label", xmLabelWidgetClass, prop_pane, XmNlabelString,
            xmlabel, XmNalignment, XmALIGNMENT_END, XmNrightAttachment,
            XmATTACH_POSITION, XmNrightPosition, prop_setting_anchor,
            XmNleftAttachment, XmATTACH_POSITION, XmNleftPosition,
        ...
        colorf_cb[type] = XtVaCreateManagedWidget(
            "changebar", xmSeparatorWidgetClass, prop_pane, XmNorientation,
            XmVERTICAL, XmNseparatorType, XmSINGLE_LINE, XmNwidth,
            prop_cb_width, XmNbackground, parent_bg, XmNforeground, parent_bg,
            XmNleftAttachment, XmATTACH_POSITION, XmNleftPosition,
            ...
            XmATTACH_OPPOSITE_WIDGET, XmNbottomWidget, setting, XmNuserData,
            PROP_CB_OFF, NULL);
        XtAddCallback(colorf_field[type], XmNvalueChangedCallback,
                      prop_field_chgCB, colorf_cb[type]);
        XtVaSetValues(colorf_field[type], XmNuserData, PROP_EDIT, NULL);

        /********************************************************************
         *  Create Mono Filename Setting                                    *
         ********************************************************************/
        monof_field[type] = XtVaCreateManagedWidget(
            "field", xmTextFieldWidgetClass, prop_pane, XmNshadowThickness, 1,
            XmNhighlightThickness, 1, XmNmaxLength, 80, XmNleftAttachment,
            XmATTACH_POSITION, XmNleftPosition, prop_setting_anchor,
            XmNleftOffset, prop_offset_from_lbl, XmNtopAttachment,
        ...
        xmlabel = XmStringCreateLocalized("Color Filename:");
        monof_label[type] = XtVaCreateManagedWidget(
            "prop_label", xmLabelWidgetClass, prop_pane, XmNlabelString,
            xmlabel, XmNalignment, XmALIGNMENT_END, XmNrightAttachment,
            XmATTACH_POSITION, XmNrightPosition, prop_setting_anchor,
            XmNleftAttachment, XmATTACH_POSITION, XmNleftPosition,
        ...
        monof_cb[type] = XtVaCreateManagedWidget(
            "changebar", xmSeparatorWidgetClass, prop_pane, XmNorientation,
            XmVERTICAL, XmNseparatorType, XmSINGLE_LINE, XmNwidth,
            prop_cb_width, XmNbackground, parent_bg, XmNforeground, parent_bg,
            XmNleftAttachment, XmATTACH_POSITION, XmNleftPosition,
            ...
            XmATTACH_OPPOSITE_WIDGET, XmNbottomWidget, setting, XmNuserData,
            PROP_CB_OFF, NULL);
        XtAddCallback(monof_field[type], XmNvalueChangedCallback,
                      prop_field_chgCB, monof_cb[type]);
        ...
        /*
            ...
            bg_cb[type] = XtVaCreateManagedWidget("changebar",
                                ...
                                NULL);
            XtAddCallback(bg_field[type], XmNvalueChangedCallback,
           prop_field_chgCB, bg_cb[type]); XtVaSetValues(bg_field[type],
           XmNuserData,      PROP_EDIT, NULL);
        ...
        * /
            ...
            /*
                xmlabel = XmStringCreateLocalized("ColorChooser...");
                fg_button[type] = button =
               XtVaCreateManagedWidget("color_button", xmPushButtonWidgetClass,
                                    prop_pane,
                                    XmNlabelString,		xmlabel,
                                    XmNleftAttachment,      XmATTACH_POSITION,
                                    XmNleftPosition,        prop_setting_anchor,
                                    XmNleftOffset,
               prop_offset_from_lbl, XmNtopAttachment,       XmATTACH_WIDGET,
                                    XmNtopWidget,           setting,
                                    XmNtopOffset,           prop_setting_offset,
                                    NULL);
                XmStringFree(xmlabel);
                ...
                fg_glyph[type] =
                            XtVaCreateManagedWidget("color_glyph",
                                    ...
                                    XmNleftOffset,		4,
                                    XmNtopAttachment,
               XmATTACH_OPPOSITE_WIDGET, XmNtopWidget,		button,
                                    XmNtopOffset,		2,
                                    XmNbottomAttachment,
               XmATTACH_OPPOSITE_WIDGET, XmNbottomWidget,	button,
                                    XmNbottomOffset,	2,
                                    NULL);
                XmStringFree(xmlabel);
               ...
               XmATTACH_OPPOSITE_WIDGET, XmNbottomWidget,        setting, NULL);
                ...
                fg_cb[type] = XtVaCreateManagedWidget("changebar",
                                    ...
                                    XmNrightPosition,       prop_label_anchor,
                                    XmNbottomAttachment,
               XmATTACH_OPPOSITE_WIDGET, XmNbottomWidget,        setting,
                                    XmNuserData,            PROP_CB_OFF,
                                    NULL);
                XtAddCallback(fg_field[type], XmNvalueChangedCallback,
               prop_field_chgCB, fg_cb[type]); XtVaSetValues(fg_field[type],
               XmNuserData,      PROP_EDIT, NULL);

                /* Install color chooser */
            prop_add_color_chooser(fg_button[type], fg_glyph[type],
                                   fg_field[type]);
        ...
        * /
        ...
        if (type == AB_PROP_REVOLVING)
                XtVaSetValues(parent, XmNuserData, current_obj[type], NULL);
...
static int glyph_prop_clear(AB_PROP_TYPE type) {
        ...
        */
        ...
        current_obj[type] = NULL;
        if (type == AB_PROP_REVOLVING)
                XtVaSetValues(ab_glyph_palitem->rev_prop_frame, XmNuserData,
                              current_obj[type], NULL);
        ...
        if (obj == NULL) {
                ...
                if (type == AB_PROP_REVOLVING)
                        XtVaSetValues(ab_glyph_palitem->rev_prop_frame,
                                      XmNuserData, current_obj[type], NULL);
        }
...
int glyph_prop_apply(AB_PROP_TYPE type) {
        STRING value;
        ...
        if (prop_changed(colorf_cb[type])) {
                /*
                        ...
                        abobj_set_label(current_obj[type],
                   current_obj[type]->label_type, value); XtFree(value);
                */
        }
        /*
            if (prop_changed(fg_cb[type]))
            {
                ...
                XtFree(value);
                prop_set_color_glyph(fg_glyph[type],
           obj_get_fg_color(current_obj[type]));
            }
            if (prop_changed(bg_cb[type]))
            {
                ...
                XtFree(value);
                prop_set_color_glyph(bg_glyph[type],
           obj_get_bg_color(current_obj[type]));
            }
        */
...
static BOOL verify_props(AB_PROP_TYPE type) {
        ...
        if (prop_changed(name_cb[type]) &&
            !prop_name_ok(current_obj[type], name_field[type]))
                return FALSE;
