...
#define abo_attachments_create(o)                                              \
        (o)->attachments =                                                     \
...
int obj_init_attachments(ABObj obj) {
...
int obj_construct(ABObj obj, AB_OBJECT_TYPE type, ABObj parent) {
...
#endif
        obj->flags = NoFlags;
        obj->impl_flags = ObjFlagIsDefined | ObjFlagIsInitiallyVisible |
                          ObjFlagIsInitiallyActive;
        obj->x = -1;
        obj->y = -1;
        obj->width = -1;
        obj->width_max = -1;
...
static int obj_construct_action(ABObj obj) {
...
static int obj_construct_action_list(ABObj obj) { return 0; }

static int obj_construct_button(ABObj obj) {
...
static int obj_construct_drawing_area(ABObj obj) {
...
static int obj_construct_combo_box(ABObj obj) {
...
static int obj_construct_container(ABObj obj) {
...
static int obj_construct_file_chooser(ABObj obj) {
...
static int obj_construct_msg(ABObj obj) {
...
static int obj_construct_module(ABObj obj) {
...
static int obj_construct_item(ABObj obj) {
...
static int obj_construct_label(ABObj obj) {
...
static int obj_construct_layers(ABObj obj) {
...
static int obj_construct_menu(ABObj obj) {
...
static int obj_construct_project(ABObj obj) {
...
static int obj_construct_choice(ABObj obj) {
...
static int obj_construct_separator(ABObj obj) {
...
static int obj_construct_scale(ABObj obj) {
...
static int obj_construct_spin_box(ABObj obj) {
...
static int obj_construct_list(ABObj obj) {
...
static int obj_construct_term_pane(ABObj obj) {
...
static int obj_construct_text(ABObj obj) {
...
static int obj_construct_window(ABObj obj) {
