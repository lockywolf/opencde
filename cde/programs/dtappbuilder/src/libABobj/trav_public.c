...
int trav_open_cond(ABTraversal trav, ABObj root, unsigned travType,
...
int trav_open(ABTraversal trav, ABObj root, unsigned travType) {
...
ABObj trav_goto(ABTraversal trav, int nodeNum) {
        ABObj obj = NULL;
        if (travP_is_safe(trav)) {
 ...
 */
int trav_perform(ABObj root, int trav_type, ABTraversalCB clientfunc) {
        AB_TRAVERSAL trav;
        ABObj obj;
        int retval = 0;
 ...
 */
int trav_count_cond(ABObj root, int trav_type, ABObjTestFunc testFunc) {
        AB_TRAVERSAL trav;
        ABObj obj = NULL;
        int objCount = 0;
