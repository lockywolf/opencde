...
static ABObj travP_obj_salient_prev_sibling(ABObj obj, ABTraversal trav) {
        ...
        while ((curObj != NULL) && ((!obj_is_salient(curObj)) || (firstTime))) {
                firstTime = FALSE;
                if (obj_is_root(curObj)) {
                        if (curObj->prev_sibling != NULL) {
                                curObj = curObj->prev_sibling;
                        } else {
                                curObj = find_ancestor_prev_sibling(curObj,
                                                                    compRoot);
                        }
                } else {
                        if (curObj->first_child != NULL) {
                                ...
                                if (curObj->prev_sibling != NULL) {
                                        ...
                                        curObj = find_ancestor_prev_sibling(
                                            curObj, compRoot);
                                }
                        }
                }
...
static ABObj travP_obj_salient_next_sibling(ABObj obj, ABTraversal trav) {
         ...
         */
        searchTop = (obj_is_descendant_of(trav->rootObj, compRoot)
        ...
        while ((curObj != NULL) && ((!obj_is_salient(curObj)) || (firstTime))) {
                ...
                if (obj_is_root(curObj)) {
                        if (curObj->next_sibling != NULL) {
                                ...
                                curObj = find_ancestor_next_sibling(curObj,
                                                                    searchTop);
                        }
                } else {
                        if (curObj->first_child != NULL) {
                                ...
                                if (curObj->next_sibling != NULL) {
                                        ...
                                        curObj = find_ancestor_next_sibling(
                                            curObj, searchTop);
                                }
                        }
                }
