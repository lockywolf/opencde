...
int trigger_destroy(ABTrigger trigger) {
 ...
 */
int trigger_init(ABTrigger trigger) {
        trigger->next = NULL;
        trigger->prev = NULL;
        trigger->owner = NULL;
        trigger->from = NULL;
 ...
 */
int trigger_release(ABTrigger trigger) { return trigger_unlink(trigger); }

/*
 * Removes the trigger completely from the network of data structures.
 */
int trigger_unlink(ABTrigger trigger) {
