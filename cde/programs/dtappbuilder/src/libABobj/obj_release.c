...
static int obj_destruct_action(ABObj obj) { return 0; }

static int obj_destruct_action_list(ABObj obj) { return 0; }

static int obj_destruct_button(ABObj obj) {
        AB_BUTTON_INFO *info = &(obj->info.button);
        return 0;
}

static int obj_destruct_drawing_area(ABObj obj) {
        AB_DRAWING_AREA_INFO *info = &(obj->info.drawing_area);
        istr_destroy(info->menu_title);
        return 0;
}

static int obj_destruct_combo_box(ABObj obj) {
        AB_COMBO_BOX_INFO *info = &(obj->info.combo_box);
        return 0;
}

static int obj_destruct_container(ABObj obj) {
        AB_CONTAINER_INFO *info = &(obj->info.container);
        istr_destroy(info->menu_title);
        return 0;
}

static int obj_destruct_file_chooser(ABObj obj) {
...
static int obj_destruct_msg(ABObj obj) {
...
static int obj_destruct_module(ABObj obj) {
...
static int obj_destruct_item(ABObj obj) {
...
static int obj_destruct_layers(ABObj obj) {
        obj = obj; /* avoid warnings */
        return 0;
}

static int obj_destruct_menu(ABObj obj) {
        AB_MENU_INFO *info = &(obj->info.menu);
        return 0;
}

static int obj_destruct_project(ABObj obj) {
...
static int obj_destruct_choice(ABObj obj) {
        AB_CHOICE_INFO *info = &(obj->info.choice);
        info = info; /* avoid warnings */
        return 0;
}

static int obj_destruct_separator(ABObj obj) {
        AB_SEPARATOR_INFO *info = &(obj->info.separator);
        return 0;
}

static int obj_destruct_scale(ABObj obj) {
        AB_SCALE_INFO *info = &(obj->info.scale);
        return 0;
}

static int obj_destruct_spin_box(ABObj obj) {
        AB_SPIN_BOX_INFO *info = &(obj->info.spin_box);
        return 0;
}

static int obj_destruct_list(ABObj obj) {
        AB_LIST_INFO *info = &(obj->info.list);
        istr_destroy(info->menu_title);
        return 0;
}

static int obj_destruct_term_pane(ABObj obj) {
        istr_destroy(obj->info.term.process_string);
        istr_destroy(obj->info.term.menu_title);
        return 0;
}

static int obj_destruct_text(ABObj obj) {
...
static int obj_destruct_window(ABObj obj) {
