...
int obj_set_is_selected(ABObj obj, BOOL new_is_selected) {
        return (new_is_selected ? obj_set_selected_true(obj)
                                : obj_set_selected_false(obj));
}
...
BOOL obj_is_selected(ABObj obj) {
