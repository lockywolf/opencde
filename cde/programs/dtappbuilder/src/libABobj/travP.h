...
#define travP_clean(trav)                                                      \
        ((trav)->travType = 0, (trav)->rootObj = NULL, (trav)->curObj = NULL,  \
         (trav)->objArray = NULL, (trav)->objArraySize = 0,                    \
         (trav)->objArrayIndex = -1, (trav)->done = FALSE,                     \
         (trav)->testFunc = NULL)
 ...
 * Safe traversals
 */
int travP_open_safe(ABTraversal trav, ABObj root, unsigned travType,
