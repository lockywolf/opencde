...
ABObj objP_get_names_scope_obj_for_children(ABObj parent) {
...
StringList objP_get_names_scope_for_children(ABObj parent) {
...
int objP_tree_add_to_names_list(ABObj tree) {
...
int objP_tree_remove_from_names_list(ABObj tree) {
        ABObj scopeObj = objP_get_names_scope_obj(tree);
        StringList names = NULL;
        AB_TRAVERSAL trav;
        ABObj obj = NULL;
