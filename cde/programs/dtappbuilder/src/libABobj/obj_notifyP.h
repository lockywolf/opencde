...
int objP_notify_send_allow_geometry_change(ABObj, int new_x, int new_y,
...
int objP_notify_send_geometry_change(ABObj, int old_x, int old_y, int old_width,
                                     int old_height);
...
int objP_notify_send_update_with_data(ABObj obj, BOOL update_subtree,
                                      int update_code, void *update_data,
