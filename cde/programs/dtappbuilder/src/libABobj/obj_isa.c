 ...
 */
BOOL obj_is_salient(ABObj obj) {

        /*
         * Check type first
         */
        BOOL itIs =
            (obj_is_ui(obj) || (obj->type == AB_TYPE_MODULE) ||
             (obj->type == AB_TYPE_PROJECT) || (obj->type == AB_TYPE_ACTION));

        /*
         * regardless of the type, composite subobjs and menu references are not
         * salient
         */
        if (itIs && ((obj_is_ref(obj)) || (!obj_is_root(obj)))) {
                itIs = FALSE;
        }
 ...
 */
BOOL obj_is_item(ABObj obj) { return (obj->type == AB_TYPE_ITEM); }
 ...
 */
BOOL obj_is_top_level(ABObj obj) { return obj_is_window(obj); }
 ...
 */
BOOL obj_is_push_button(ABObj obj) {
        if (obj->type == AB_TYPE_BUTTON && obj->info.button.type == AB_BUT_PUSH)
                return TRUE;
        return FALSE;
}
...
BOOL obj_is_menu_button(ABObj obj) {
        if (obj->type == AB_TYPE_BUTTON && obj->info.button.type == AB_BUT_MENU)
                return TRUE;
        return FALSE;
}
 ...
 */
BOOL obj_is_label(ABObj obj) { return (obj->type == AB_TYPE_LABEL); }

/*
 * Does the object affect more than one module?
 */
BOOL obj_is_cross_module(ABObj obj) { return !obj_is_intra_module(obj); }

/*
 * Does the object affect only one module?
 */
BOOL obj_is_intra_module(ABObj obj) {
        /*
         *
         */
        BOOL isIt = TRUE;
 ...
 */
BOOL obj_is_term_pane(ABObj obj) { return (obj->type == AB_TYPE_TERM_PANE); }

/*
 * Return whether a type is a text pane
 */
BOOL obj_is_text_pane(ABObj obj) { return (obj->type == AB_TYPE_TEXT_PANE); }

/*
 * Return whether a type is a canvas
 */
BOOL obj_is_container(ABObj obj) { return (obj->type == AB_TYPE_CONTAINER); }
 ...
 */
BOOL obj_is_list(ABObj obj) { return (obj->type == AB_TYPE_LIST); }
 ...
 */
BOOL obj_is_menu(ABObj obj) { return (obj->type == AB_TYPE_MENU); }

/*
 * All functions dealing with references must allow NULL params
 */
BOOL obj_is_ref(ABObj obj) {
 ...
 */
BOOL obj_is_separator(ABObj obj) { return (obj->type == AB_TYPE_SEPARATOR); }

BOOL obj_is_scale(ABObj obj) { return (obj->type == AB_TYPE_SCALE); }

/*
 * Return whether a type is a combo box
 */
BOOL obj_is_combo_box(ABObj obj) { return (obj->type == AB_TYPE_COMBO_BOX); }
/*
 * Return whether a type is a spin box
 */
BOOL obj_is_spin_box(ABObj obj) { return (obj->type == AB_TYPE_SPIN_BOX); }
...
BOOL obj_is_text_field(ABObj obj) { return (obj->type == AB_TYPE_TEXT_FIELD); }
...
BOOL obj_is_popup(ABObj obj) {
        ...
        case AB_TYPE_DIALOG:
                ...
                break;
        case AB_TYPE_MENU:
                is_popup = obj_is_pane(obj->parent) || obj_is_list(obj->parent);
                break;
        }
        return is_popup;
}
 ...
 * Return whether a type is a menu
 */
BOOL obj_is_choice(ABObj obj) { return (obj->type == AB_TYPE_CHOICE); }
...
BOOL obj_is_layers(ABObj obj) { return (obj->type == AB_TYPE_LAYERS); }

BOOL obj_is_base_win(ABObj obj) { return (obj->type == AB_TYPE_BASE_WINDOW); }

BOOL obj_is_popup_win(ABObj obj) { return (obj->type == AB_TYPE_DIALOG); }
 ...
 */
BOOL obj_is_message(ABObj obj) { return (obj->type == AB_TYPE_MESSAGE); }
...
BOOL obj_is_action(ABObj obj) { return (obj->type == AB_TYPE_ACTION); }
...
BOOL obj_is_xmconfiged(ABObj obj) {
        return (obj_is_sub(obj) || (obj_has_flag(obj, XmConfiguredFlag)));
}
