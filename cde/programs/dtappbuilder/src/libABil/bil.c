...
bilP_token_to_packing(int type) {
        ...
        switch (type) {
        case AB_BIL_NONE:
                obj_type = AB_PACK_NONE;
                break;
        case AB_BIL_TIGHT:
                obj_type = AB_PACK_TIGHT;
                break;
        case AB_BIL_EQUAL:
                obj_type = AB_PACK_EQUAL;
                break;
        }
        return (obj_type);
}
...
bilP_token_to_container_type(int type) {
        ...
        case AB_BIL_ACTIVATED:
                obj_type = AB_CONT_BUTTON_PANEL;
                break;
        case AB_BIL_ABSOLUTE:
                obj_type = AB_CONT_ABSOLUTE;
                break;
        case AB_BIL_FOOTER:
                obj_type = AB_CONT_FOOTER;
                break;
        case AB_BIL_GROUP:
                obj_type = AB_CONT_GROUP;
                break;
        case AB_BIL_MAIN_WINDOW:
                obj_type = AB_CONT_MAIN_WINDOW;
                break;
        case AB_BIL_MENU_BAR:
                obj_type = AB_CONT_MENU_BAR;
                break;
        case AB_BIL_PANED:
                obj_type = AB_CONT_PANED;
                break;
        case AB_BIL_RELATIVE:
                obj_type = AB_CONT_RELATIVE;
                break;
        case AB_BIL_SCROLLED_WINDOW:
                obj_type = AB_CONT_SCROLLED_WINDOW;
                break;
        case AB_BIL_ROW_COLUMN:
                obj_type = AB_CONT_ROW_COLUMN;
                break;
        case AB_BIL_TOOL_BAR:
                obj_type = AB_CONT_TOOL_BAR;
                break;
        }
        return (obj_type);
}
...
bilP_token_to_item_type(int type) {
        ...
        switch (type) {
        case AB_BIL_ITEM_FOR_CHOICE:
                obj_type = AB_ITEM_FOR_CHOICE;
                break;
        case AB_BIL_ITEM_FOR_COMBO_BOX:
                obj_type = AB_ITEM_FOR_COMBO_BOX;
                break;
        case AB_BIL_ITEM_FOR_LIST:
                obj_type = AB_ITEM_FOR_LIST;
                break;
        case AB_BIL_ITEM_FOR_MENU:
                obj_type = AB_ITEM_FOR_MENU;
                break;
        case AB_BIL_ITEM_FOR_MENUBAR:
                obj_type = AB_ITEM_FOR_MENUBAR;
                break;
        case AB_BIL_ITEM_FOR_SPIN_BOX:
                obj_type = AB_ITEM_FOR_SPIN_BOX;
                break;
        }
        return (obj_type);
}
...
bilP_token_to_label_style(int type) {
        ...
        switch (type) {
        case AB_BIL_STYLE_NORMAL:
                obj_type = AB_STYLE_NORMAL;
                break;
        case AB_BIL_STYLE_BOLD:
                obj_type = AB_STYLE_BOLD;
                break;
        case AB_BIL_STYLE_3D:
                obj_type = AB_STYLE_3D;
                break;
        }
        return (obj_type);
}
...
bilP_token_to_attachment(int type) {
        ...
        switch (type) {
        case AB_BIL_ATTACH_POINT:
                obj_type = AB_ATTACH_POINT;
                break;
        case AB_BIL_ATTACH_OBJ:
                obj_type = AB_ATTACH_OBJ;
                break;
        case AB_BIL_ATTACH_ALIGN_OBJ_EDGE:
                obj_type = AB_ATTACH_ALIGN_OBJ_EDGE;
                break;
        case AB_BIL_ATTACH_GRIDLINE:
                obj_type = AB_ATTACH_GRIDLINE;
                break;
        case AB_BIL_ATTACH_CENTER_GRIDLINE:
                obj_type = AB_ATTACH_CENTER_GRIDLINE;
                break;
        case AB_BIL_NONE:
                obj_type = AB_ATTACH_NONE;
                break;
        }
        return (obj_type);
}
...
bilP_token_to_direction(int type) {
        ...
        switch (type) {
        case AB_BIL_LEFT_TO_RIGHT:
                dir = AB_DIR_LEFT_TO_RIGHT;
                break;
        case AB_BIL_RIGHT_TO_LEFT:
                dir = AB_DIR_RIGHT_TO_LEFT;
                break;
        case AB_BIL_TOP_TO_BOTTOM:
                dir = AB_DIR_TOP_TO_BOTTOM;
                break;
        case AB_BIL_BOTTOM_TO_TOP:
                dir = AB_DIR_BOTTOM_TO_TOP;
                break;
        }
        return (dir);
}
...
bilP_token_to_func_type(int type) {
        ...
        switch (type) {
        case AB_BIL_BUILTIN:
                obj_type = AB_FUNC_BUILTIN;
                break;
        case AB_BIL_CALL_FUNCTION:
                obj_type = AB_FUNC_USER_DEF;
                break;
        case AB_BIL_EXECUTE_CODE:
                obj_type = AB_FUNC_CODE_FRAG;
                break;
        case AB_BIL_ACCESS_HELP_VOLUME:
                obj_type = AB_FUNC_HELP_VOLUME;
                break;
        case AB_BIL_ON_ITEM_HELP:
                obj_type = AB_FUNC_ON_ITEM_HELP;
                break;
        }
        return obj_type;
}
...
BOOL bilP_token_to_bool(BIL_TOKEN token) {
        BOOL boolVal = FALSE;
...
AB_BUILTIN_ACTION
bilP_token_to_builtin_action(int type) { /* REMIND: will need to add more */
        AB_BUILTIN_ACTION obj_type = AB_STDACT_UNDEF;

        switch (type) {
        case AB_BIL_DISABLE:
                obj_type = AB_STDACT_DISABLE;
                break;
        case AB_BIL_ENABLE:
                obj_type = AB_STDACT_ENABLE;
                break;
        case AB_BIL_HIDE:
                obj_type = AB_STDACT_HIDE;
                break;
        case AB_BIL_SET_LABEL:
                obj_type = AB_STDACT_SET_LABEL;
                break;
        case AB_BIL_SET_TEXT:
                obj_type = AB_STDACT_SET_TEXT;
                break;
        case AB_BIL_SET_VALUE:
                obj_type = AB_STDACT_SET_VALUE;
                break;
        case AB_BIL_SHOW:
                obj_type = AB_STDACT_SHOW;
                break;
        case AB_BIL_UNDEF:
...
bilP_token_to_compass_point(int type) {
        ...
        case AB_BIL_UNDEF:
        case AB_BIL_UNDEF_KEYWORD:
                obj_type = AB_CP_UNDEF;
                break;
        case AB_BIL_NORTH:
                obj_type = AB_CP_NORTH;
                break;
        case AB_BIL_NORTHEAST:
                obj_type = AB_CP_NORTHEAST;
                break;
        case AB_BIL_EAST:
                obj_type = AB_CP_EAST;
                break;
        case AB_BIL_SOUTHEAST:
                obj_type = AB_CP_SOUTHEAST;
                break;
        case AB_BIL_SOUTH:
                obj_type = AB_CP_SOUTH;
                break;
        case AB_BIL_SOUTHWEST:
                obj_type = AB_CP_SOUTHWEST;
                break;
        case AB_BIL_WEST:
                obj_type = AB_CP_WEST;
                break;
        case AB_BIL_NORTHWEST:
                obj_type = AB_CP_NORTHWEST;
                break;
        case AB_BIL_CENTER:
                obj_type = AB_CP_CENTER;
                break;
        default:
                break;
        }
...
bilP_compass_point_to_token(AB_COMPASS_POINT cp) {
        ...
        case AB_CP_NORTH:
                token = AB_BIL_NORTH;
                break;
        case AB_CP_NORTHEAST:
                token = AB_BIL_NORTHEAST;
                break;
        case AB_CP_EAST:
                token = AB_BIL_EAST;
                break;
        case AB_CP_SOUTHEAST:
                token = AB_BIL_SOUTHEAST;
                break;
        case AB_CP_SOUTH:
                token = AB_BIL_SOUTH;
                break;
        case AB_CP_SOUTHWEST:
                token = AB_BIL_SOUTHWEST;
                break;
        case AB_CP_WEST:
                token = AB_BIL_WEST;
                break;
        case AB_CP_NORTHWEST:
...
ABDndOpFlags bilP_token_to_dnd_op_flag(BIL_TOKEN token) {
        ABDndOpFlags flag = 0;
...
ABDndTypeFlags bilP_token_to_dnd_type_flag(BIL_TOKEN token) {
        ABDndTypeFlags typeFlag = 0;
        switch (token) {
        case AB_BIL_ANY:
                typeFlag = ABDndTypeAny;
                break;
        case AB_BIL_FILENAME:
                typeFlag = ABDndTypeFilename;
                break;
        case AB_BIL_TEXT:
                typeFlag = ABDndTypeText;
                break;
        case AB_BIL_USER_DEF:
                typeFlag = ABDndTypeUserDef;
                break;
        }
        return typeFlag;
}
...
bilP_dnd_type_flag_to_token(BYTE typeFlag) {
        ...
        case ABDndTypeAny:
                token = AB_BIL_ANY;
                break;
        case ABDndTypeFilename:
                token = AB_BIL_FILENAME;
                break;
        case ABDndTypeText:
                token = AB_BIL_TEXT;
                break;
        case ABDndTypeUserDef:
...
bilP_token_to_choice_type(int type) {
        ...
        case AB_BIL_EXCLUSIVE:
                obj_type = AB_CHOICE_EXCLUSIVE;
                break;
        case AB_BIL_NONEXCLUSIVE:
                obj_type = AB_CHOICE_NONEXCLUSIVE;
                break;
        case AB_BIL_OPTION_MENU:
                obj_type = AB_CHOICE_OPTION_MENU;
                break;
        }
        return obj_type;
}
...
bilP_token_to_orientation(int type) {
        ...
        switch (type) {
        case AB_BIL_HORIZONTAL:
                obj_type = AB_ORIENT_HORIZONTAL;
                break;
        case AB_BIL_VERTICAL:
                obj_type = AB_ORIENT_VERTICAL;
                break;
        }
        return obj_type;
}
...
bilP_token_to_arg_class(int token) {
        ...
        switch (token) {
        case AB_BIL_COLOR:
                argClass = AB_ARG_CLASS_COLOR;
                break;
        case AB_BIL_GEOMETRY:
                argClass = AB_ARG_CLASS_GEOMETRY;
                break;
        case AB_BIL_GLYPH:
                argClass = AB_ARG_CLASS_GLYPH;
                break;
        case AB_BIL_LABEL_STRING:
                argClass = AB_ARG_CLASS_NON_GLYPH_LABEL;
                break;
        case AB_BIL_OTHER:
                argClass = AB_ARG_CLASS_OTHER;
                break;
        case AB_BIL_OTHER_STRING:
                argClass = AB_ARG_CLASS_OTHER_STRING;
                break;
        case AB_BIL_VALUE:
                argClass = AB_ARG_CLASS_VALUE;
                break;
        }
        return argClass;
}
...
bilP_arg_class_to_token(AB_ARG_CLASS argClass) {
        ...
        case AB_ARG_CLASS_GEOMETRY:
                token = AB_BIL_GEOMETRY;
                break;
        case AB_ARG_CLASS_GLYPH:
                token = AB_BIL_GLYPH;
                break;
        case AB_ARG_CLASS_NON_GLYPH_LABEL:
                token = AB_BIL_LABEL_STRING;
                break;
        case AB_ARG_CLASS_OTHER:
                token = AB_BIL_OTHER;
                break;
        case AB_ARG_CLASS_OTHER_STRING:
                token = AB_BIL_OTHER_STRING;
                break;
...
bilP_token_to_arg_type(int type) {
        ...
        case AB_BIL_INT:
                ...
                break;
        case AB_BIL_FLOAT:
                obj_type = AB_ARG_FLOAT;
                break;
        case AB_BIL_STRING:
                obj_type = AB_ARG_STRING;
                break;
        case AB_BIL_VOID:
                obj_type = AB_ARG_VOID_PTR;
                break;
        case AB_BIL_BOOLEAN:
                obj_type = AB_ARG_BOOLEAN;
                break;
        case AB_BIL_CALLBACK:
                obj_type = AB_ARG_CALLBACK;
                break;
        case AB_BIL_LITERAL:
                obj_type = AB_ARG_LITERAL;
                break;
        case AB_BIL_XMSTRING:
                obj_type = AB_ARG_XMSTRING;
                break;
        case AB_BIL_XMSTRING_TBL:
                obj_type = AB_ARG_XMSTRING_TBL;
                break;
        case AB_BIL_PIXEL:
                obj_type = AB_ARG_PIXEL;
                break;
        case AB_BIL_PIXMAP:
                obj_type = AB_ARG_PIXMAP;
                break;
        case AB_BIL_FONT:
                obj_type = AB_ARG_FONT;
                break;
        case AB_BIL_WIDGET:
                obj_type = AB_ARG_WIDGET;
                break;
        case AB_BIL_UNDEF_KEYWORD:
        case AB_BIL_UNDEF:
                obj_type = AB_ARG_UNDEF;
                break;
        }
        return obj_type;
}
...
bilP_token_to_text_type(int type) {
        ...
        switch (type) {
        case AB_BIL_ALPHANUMERIC:
                obj_type = AB_TEXT_ALPHANUMERIC;
                break;
        case AB_BIL_NUMERIC:
                obj_type = AB_TEXT_NUMERIC;
                break;
        case AB_BIL_DEFINED_STRING:
                obj_type = AB_TEXT_DEFINED_STRING;
                break;
        }
        return obj_type;
}
...
bilP_token_to_button_type(int type) {
        ...
        switch (type) {
        case AB_BIL_PUSH_BUTTON:
                obj_type = AB_BUT_PUSH;
                break;
        case AB_BIL_DRAWN_BUTTON:
                obj_type = AB_BUT_DRAWN;
                break;
        case AB_BIL_MENU_BUTTON:
                obj_type = AB_BUT_MENU;
                break;
        }
        return obj_type;
}
...
bilP_token_to_label_type(int type) {
        ...
        switch (type) {
        case AB_BIL_ARROW_DOWN:
                obj_type = AB_LABEL_ARROW_DOWN;
                break;
        case AB_BIL_ARROW_LEFT:
                obj_type = AB_LABEL_ARROW_LEFT;
                break;
        case AB_BIL_ARROW_RIGHT:
                obj_type = AB_LABEL_ARROW_RIGHT;
                break;
        case AB_BIL_ARROW_UP:
                obj_type = AB_LABEL_ARROW_UP;
                break;
        case AB_BIL_STRING:
                obj_type = AB_LABEL_STRING;
                break;
        case AB_BIL_GRAPHIC:
        case AB_BIL_ICON:
                obj_type = AB_LABEL_GLYPH;
                break;
        case AB_BIL_SEPARATOR:
                obj_type = AB_LABEL_SEPARATOR;
                break;
        }
        return obj_type;
}
...
bilP_token_to_group_type(int type) {
        ...
        switch (type) {
        case AB_BIL_ROW:
                obj_type = AB_GROUP_ROWS;
                break;
        case AB_BIL_COLUMN:
                obj_type = AB_GROUP_COLUMNS;
                break;
        case AB_BIL_IGNORE:
                obj_type = AB_GROUP_IGNORE;
                break;
        case AB_BIL_ROWSCOLUMNS:
                obj_type = AB_GROUP_ROWSCOLUMNS;
                break;
        }
        return obj_type;
}
...
bilP_token_to_alignment(int type) {
        ...
        switch (type) {
        case AB_BIL_TOP:
                obj_type = AB_ALIGN_TOP;
                break;
        case AB_BIL_RIGHT:
                obj_type = AB_ALIGN_RIGHT;
                break;
        case AB_BIL_BOTTOM:
                obj_type = AB_ALIGN_BOTTOM;
                break;
        case AB_BIL_LEFT:
                obj_type = AB_ALIGN_LEFT;
                break;
        case AB_BIL_CENTER:
                obj_type = AB_ALIGN_CENTER;
                break;
        case AB_BIL_VCENTER:
                obj_type = AB_ALIGN_VCENTER;
                break;
        case AB_BIL_HCENTER:
                obj_type = AB_ALIGN_HCENTER;
                break;
        case AB_BIL_LABELS:
                obj_type = AB_ALIGN_LABELS;
                break;
        }
        return obj_type;
}
...
bilP_token_to_object_type(int type) {
        ...
        switch (type) {
        case AB_BIL_ACTION:
                obj_type = AB_TYPE_ACTION;
                break;
        case AB_BIL_BASE_WINDOW:
                obj_type = AB_TYPE_BASE_WINDOW;
                break;
        case AB_BIL_BUTTON:
                obj_type = AB_TYPE_BUTTON;
                break;
        case AB_BIL_CHOICE:
                obj_type = AB_TYPE_CHOICE;
                break;
        case AB_BIL_COMBO_BOX:
                obj_type = AB_TYPE_COMBO_BOX;
                break;
        case AB_BIL_FILE_CHOOSER:
                obj_type = AB_TYPE_FILE_CHOOSER;
                break;
        case AB_BIL_MESSAGE:
                obj_type = AB_TYPE_MESSAGE;
                break;
        case AB_BIL_CONTAINER:
                obj_type = AB_TYPE_CONTAINER;
                break;
        case AB_BIL_DIALOG:
                obj_type = AB_TYPE_DIALOG;
                break;
        case AB_BIL_DRAWING_AREA:
                obj_type = AB_TYPE_DRAWING_AREA;
                break;
        case AB_BIL_ITEM:
                obj_type = AB_TYPE_ITEM;
                break;
        case AB_BIL_LABEL:
                obj_type = AB_TYPE_LABEL;
                break;
        case AB_BIL_LAYERS:
                obj_type = AB_TYPE_LAYERS;
                break;
        case AB_BIL_LIST:
                obj_type = AB_TYPE_LIST;
                break;
        case AB_BIL_MENU:
                obj_type = AB_TYPE_MENU;
                break;
        case AB_BIL_MODULE:
                obj_type = AB_TYPE_MODULE;
                break;
        case AB_BIL_PROJECT:
                obj_type = AB_TYPE_PROJECT;
                break;
        case AB_BIL_SEPARATOR:
                obj_type = AB_TYPE_SEPARATOR;
                break;
        case AB_BIL_SCALE:
                obj_type = AB_TYPE_SCALE;
                break;
        case AB_BIL_SPIN_BOX:
                obj_type = AB_TYPE_SPIN_BOX;
                break;
        case AB_BIL_TERM_PANE:
                obj_type = AB_TYPE_TERM_PANE;
                break;
        case AB_BIL_TEXT_FIELD:
                obj_type = AB_TYPE_TEXT_FIELD;
                break;
        case AB_BIL_TEXT_PANE:
                obj_type = AB_TYPE_TEXT_PANE;
                break;
        }
        return obj_type;
}
...
bilP_token_to_when(int type) {
        ...
        switch (type) {
        case AB_BIL_ACTION1:
                when = AB_WHEN_ACTION1;
                break;
        case AB_BIL_ACTION2:
                when = AB_WHEN_ACTION2;
                break;
        case AB_BIL_ACTION3:
                when = AB_WHEN_ACTION3;
                break;
        case AB_BIL_ACTIVATED:
                when = AB_WHEN_ACTIVATED;
                break;
        case AB_BIL_AFTER_CREATED:
                when = AB_WHEN_AFTER_CREATED;
                break;
        case AB_BIL_BEFORE_POST_MENU:
                when = AB_WHEN_BEFORE_POST_MENU;
                break;
        case AB_BIL_BEFORE_TEXT_CHANGED:
                when = AB_WHEN_BEFORE_TEXT_CHANGED;
                break;
        case AB_BIL_CANCEL:
                when = AB_WHEN_CANCEL;
                break;
        case AB_BIL_DESTROYED:
                when = AB_WHEN_DESTROYED;
                break;
        case AB_BIL_DOUBLE_CLICKED_ON:
                when = AB_WHEN_DOUBLE_CLICKED_ON;
                break;
        case AB_BIL_DRAGGED:
                when = AB_WHEN_DRAGGED;
                break;
        case AB_BIL_DRAGGED_FROM:
                when = AB_WHEN_DRAGGED_FROM;
                break;
        case AB_BIL_DROPPED_ON:
                when = AB_WHEN_DROPPED_ON;
                break;
        case AB_BIL_HIDE:
                when = AB_WHEN_HIDDEN;
                break;
        case AB_BIL_ITEM_SELECTED:
                when = AB_WHEN_ITEM_SELECTED;
                break;
        case AB_BIL_OK:
                when = AB_WHEN_OK;
                break;
        case AB_BIL_POPPED_DOWN:
                when = AB_WHEN_POPPED_DOWN;
                break;
        case AB_BIL_POPPED_UP:
                when = AB_WHEN_POPPED_UP;
                break;
        case AB_BIL_REPAINT_NEEDED:
                when = AB_WHEN_REPAINT_NEEDED;
                break;
        case AB_BIL_RESIZED:
                when = AB_WHEN_AFTER_RESIZED;
                break;
        case AB_BIL_SESSION_RESTORE:
                when = AB_WHEN_SESSION_RESTORE;
                break;
        case AB_BIL_SESSION_SAVE:
                when = AB_WHEN_SESSION_SAVE;
                break;
        case AB_BIL_SHOW:
                when = AB_WHEN_SHOWN;
                break;
        case AB_BIL_TEXT_CHANGED:
                when = AB_WHEN_TEXT_CHANGED;
                break;
        case AB_BIL_TOGGLED:
                when = AB_WHEN_TOGGLED;
                break;
        case AB_BIL_TOOLTALK_DO_COMMAND:
                when = AB_WHEN_TOOLTALK_DO_COMMAND;
                break;
        case AB_BIL_TOOLTALK_GET_STATUS:
                when = AB_WHEN_TOOLTALK_GET_STATUS;
                break;
        case AB_BIL_TOOLTALK_PAUSE_RESUME:
                when = AB_WHEN_TOOLTALK_PAUSE_RESUME;
                break;
        case AB_BIL_TOOLTALK_QUIT:
                when = AB_WHEN_TOOLTALK_QUIT;
                break;
        case AB_BIL_VALUE_CHANGED:
                when = AB_WHEN_VALUE_CHANGED;
                break;
        }
        return when;
}
...
bilP_when_to_token(AB_WHEN ab_when) {
        ...
        case AB_WHEN_ACTION1:
                token = AB_BIL_ACTION1;
                break;
        case AB_WHEN_ACTION2:
                token = AB_BIL_ACTION2;
                break;
        case AB_WHEN_ACTION3:
                token = AB_BIL_ACTION3;
                break;
 ...
 */
static long bil_token_entry_compare(const void *leftEntry,
 ...
 */
static long bil_token_key_compare(const void *voidIstr, const void *voidEntry) {
        return ((long)((ISTRING)(voidIstr))) -
               ((long)(((BilTokenIndexEntry)voidEntry)->string));
}

static int bil_token_table_init() {
...
#define off ((int)BIL_TOKEN_MIN_VALUE) /* offset to 1st token */
        ...
        btt[AB_BIL_ACCESS_HELP_VOLUME - off] =
            istr_const(":access-help-volume");
        ...
        btt[AB_BIL_ATTACH_CENTER_GRIDLINE - off] =
            istr_const(":center-grid-line");
        ...
        btt[AB_BIL_BEFORE_POST_MENU - off] = istr_const(":before-post-menu");
        ...
        btt[AB_BIL_DOUBLE_DASHED_LINE - off] =
            istr_const(":double-dashed-line");
        ...
        btt[AB_BIL_DRAG_TO_ROOT_ALLOWED - off] =
            istr_const(":drag-to-root-allowed");
        ...
        btt[AB_BIL_MULTIPLE_SELECTIONS - off] =
            istr_const(":multiple-selections");
        ...
        btt[AB_BIL_SELECTION_REQUIRED - off] =
            istr_const(":selection-required");
        ...
        btt[AB_BIL_SESSIONING_CMDLINE_AND_FILE - off] =
            istr_const(":cmdline-file");
        ...
        btt[AB_BIL_SINGLE_DASHED_LINE - off] =
            istr_const(":single-dashed-line");
        ...
        btt[AB_BIL_TOOLTALK_DO_COMMAND - off] =
            istr_const(":tooltalk-do-command");
        btt[AB_BIL_TOOLTALK_GET_STATUS - off] =
            istr_const(":tooltalk-get-status");
        btt[AB_BIL_TOOLTALK_PAUSE_RESUME - off] =
            istr_const(":tooltalk-pause-resume");
        ...
        qsort(bil_token_table_index, BIL_TOKEN_NUM_VALUES,
              sizeof(bil_token_table_index[0]), bil_token_entry_compare);
...
bilP_token_to_initial_state(int token) {
        ...
        switch (token) {
        case AB_BIL_ACTIVE:
                obj_type = AB_STATE_ACTIVE;
                break;
        case AB_BIL_ICONIC:
                obj_type = AB_STATE_ICONIC;
                break;
        case AB_BIL_INACTIVE:
                obj_type = AB_STATE_INACTIVE;
                break;
        case AB_BIL_INVISIBLE:
                obj_type = AB_STATE_INVISIBLE;
                break;
        case AB_BIL_NOTSELECTED:
                obj_type = AB_STATE_INVISIBLE;
                break;
        case AB_BIL_OPEN:
                obj_type = AB_STATE_OPEN;
                break;
        case AB_BIL_SELECTED:
                obj_type = AB_STATE_SELECTED;
                break;
        case AB_BIL_VISIBLE:
                obj_type = AB_STATE_VISIBLE;
                break;
        }
        return (obj_type);
}
...
bilP_token_to_border_frame(int token) {
        ...
        case AB_BIL_NONE:
                type = AB_LINE_NONE;
                break;
        case AB_BIL_SHADOW_IN:
                type = AB_LINE_SHADOW_IN;
                break;
        case AB_BIL_SHADOW_OUT:
                type = AB_LINE_SHADOW_OUT;
                break;
        case AB_BIL_ETCHED_IN:
                type = AB_LINE_ETCHED_IN;
                break;
        case AB_BIL_ETCHED_OUT:
                type = AB_LINE_ETCHED_OUT;
                break;
        }
        return (type);
}
...
bilP_token_to_line_style(int token) {
        ...
        switch (token) {
        case AB_BIL_NONE:
                line_style = AB_LINE_NONE;
                break;
        case AB_BIL_ETCHED_IN:
                line_style = AB_LINE_ETCHED_IN;
                break;
        case AB_BIL_ETCHED_OUT:
                line_style = AB_LINE_ETCHED_OUT;
                break;
        case AB_BIL_ETCHED_IN_DASH:
                line_style = AB_LINE_ETCHED_IN_DASH;
                break;
        case AB_BIL_ETCHED_OUT_DASH:
                line_style = AB_LINE_ETCHED_OUT_DASH;
                break;
        case AB_BIL_SINGLE_LINE:
                line_style = AB_LINE_SINGLE_LINE;
                break;
        case AB_BIL_DOUBLE_LINE:
                line_style = AB_LINE_DOUBLE_LINE;
                break;
        case AB_BIL_SINGLE_DASHED_LINE:
                line_style = AB_LINE_SINGLE_DASHED_LINE;
                break;
        case AB_BIL_DOUBLE_DASHED_LINE:
                line_style = AB_LINE_DOUBLE_DASHED_LINE;
                break;
        }
        return (line_style);
}
...
bilP_token_to_arrow_style(int token) {
        ...
        switch (token) {
        case AB_BIL_ARROW_FLAT_BEGIN:
                arrow_style = AB_ARROW_FLAT_BEGIN;
                break;
        case AB_BIL_ARROW_FLAT_END:
                arrow_style = AB_ARROW_FLAT_END;
                break;
        case AB_BIL_ARROW_BEGIN:
                arrow_style = AB_ARROW_BEGIN;
                break;
        case AB_BIL_ARROW_END:
                arrow_style = AB_ARROW_END;
                break;
        case AB_BIL_ARROW_SPLIT:
                arrow_style = AB_ARROW_SPLIT;
                break;
        }
        return (arrow_style);
}
...
bilP_token_to_selection_mode(int token) {
        ...
        switch (token) {
        case AB_BIL_SINGLE:
                selection_mode = AB_SELECT_SINGLE;
                break;
        case AB_BIL_BROWSE:
                selection_mode = AB_SELECT_BROWSE;
                break;
        case AB_BIL_MULTIPLE:
                selection_mode = AB_SELECT_MULTIPLE;
                break;
        case AB_BIL_BROWSE_MULTIPLE:
                selection_mode = AB_SELECT_BROWSE_MULTIPLE;
                break;
        }
...
bilP_scrollbar_policy_to_token(AB_SCROLLBAR_POLICY sb_policy) {
        ...
        switch (sb_policy) {
        case AB_SCROLLBAR_ALWAYS:
                token = AB_BIL_ALWAYS;
                break;
        case AB_SCROLLBAR_NEVER:
                token = AB_BIL_NEVER;
                break;
        case AB_SCROLLBAR_WHEN_NEEDED:
...
bilP_token_to_scrollbar_policy(BIL_TOKEN token) {
        ...
        switch (token) {
        case AB_BIL_ALWAYS:
                sb_policy = AB_SCROLLBAR_ALWAYS;
                break;
        case AB_BIL_NEVER:
                sb_policy = AB_SCROLLBAR_NEVER;
                break;
        case AB_BIL_WHEN_NEEDED:
...
bilP_token_to_msg_type(BIL_TOKEN token) {
        ...
        switch (token) {
        case AB_BIL_ERROR:
                msg_type = AB_MSG_ERROR;
                break;
        case AB_BIL_INFO:
                msg_type = AB_MSG_INFORMATION;
                break;
        case AB_BIL_QUESTION:
                msg_type = AB_MSG_QUESTION;
                break;
        case AB_BIL_WARNING:
                msg_type = AB_MSG_WARNING;
                break;
        case AB_BIL_WORKING:
                msg_type = AB_MSG_WORKING;
                break;
        default:
                break;
        }
...
bilP_token_to_sessioning_method(BIL_TOKEN token) {
        ...
        switch (token) {
        case AB_BIL_NONE:
                sessioning_method = AB_SESSIONING_NONE;
                break;
        case AB_BIL_SESSIONING_CMDLINE:
                sessioning_method = AB_SESSIONING_CMDLINE;
                break;
        case AB_BIL_SESSIONING_FILE:
                sessioning_method = AB_SESSIONING_FILE;
                break;
        case AB_BIL_SESSIONING_CMDLINE_AND_FILE:
                sessioning_method = AB_SESSIONING_CMDLINE_AND_FILE;
                break;
        default:
                break;
        }
...
bilP_token_to_tt_desktop_level(BIL_TOKEN token) {
        ...
        switch (token) {
        case AB_BIL_NONE:
                tt_level = AB_TOOLTALK_NONE;
                break;
        case AB_BIL_ADVANCED:
                tt_level = AB_TOOLTALK_DESKTOP_ADVANCED;
                break;
        case AB_BIL_BASIC:
                tt_level = AB_TOOLTALK_DESKTOP_BASIC;
                break;
        default:
                break;
        }
...
bilP_default_button_to_token(AB_DEFAULT_BUTTON button) {
        ...
        case AB_DEFAULT_BTN_ACTION1:
                token = AB_BIL_ACTION1_BUTTON;
                break;
        case AB_DEFAULT_BTN_ACTION2:
                token = AB_BIL_ACTION2_BUTTON;
                break;
        case AB_DEFAULT_BTN_ACTION3:
                token = AB_BIL_ACTION3_BUTTON;
                break;
...
bilP_token_to_default_button(BIL_TOKEN token) {
        ...
        switch (token) {
        case AB_BIL_ACTION1_BUTTON:
                button = AB_DEFAULT_BTN_ACTION1;
                break;
        case AB_BIL_ACTION2_BUTTON:
                button = AB_DEFAULT_BTN_ACTION2;
                break;
        case AB_BIL_ACTION3_BUTTON:
                button = AB_DEFAULT_BTN_ACTION3;
                break;
        case AB_BIL_CANCEL_BUTTON:
                button = AB_DEFAULT_BTN_CANCEL;
                break;
        case AB_BIL_NONE:
                button = AB_DEFAULT_BTN_NONE;
                break;
        default:
                break;
        }
