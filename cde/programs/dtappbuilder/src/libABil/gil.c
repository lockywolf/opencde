...
gilP_string_to_arg_type(STRING arg_type_string) {
        return (AB_ARG_TYPE)convert_string_to_int(
            arg_type_string, arg_type_tab, ARRAY_NENTS(arg_type_tab), -1);
}
...
static int gat_init() {
        ...
        gat[AB_GIL_DND_ACCEPT_CURSOR_XHOT] =
            istr_const(":dnd-accept-cursor-xhot");
        gat[AB_GIL_DND_ACCEPT_CURSOR_YHOT] =
            istr_const(":dnd-accept-cursor-yhot");
        ...
        gat[AB_GIL_INTERNATIONAL_DB_BEGIN] =
            istr_const(":international-db-begin");
        ...
        gat[AB_GIL_MENU_ITEM_ACCELERATORS] =
            istr_const(":menu-item-accelerators");
        ...
        gat[AB_GIL_MENU_ITEM_LABEL_TYPES] =
            istr_const(":menu-item-label-types");
...
gilP_string_to_att(STRING s_att) {
        ...
        att = (AB_GIL_ATTRIBUTE)convert_string_to_int(
            istr_string(istr_att), gat, AB_GIL_ATTRIBUTE_NUM_VALUES,
            AB_GIL_UNDEF);
...
gilP_string_to_builtin_action(STRING action) {
        ...
        act = (AB_BUILTIN_ACTION)convert_string_to_int(
...
gilP_string_to_button_type(STRING type_string) {
        return (AB_BUTTON_TYPE)convert_string_to_int(
            type_string, button_type_tab, ARRAY_NENTS(button_type_tab), -1);
}

/******************* AB_CHOICE_TYPE **************************************/
AB_CHOICE_TYPE
gilP_string_to_choice_type(STRING s_choice_type) { return AB_CHOICE_EXCLUSIVE; }
...
gilP_string_to_compass_point(STRING compass_str) {
        return (AB_COMPASS_POINT)convert_string_to_int(
            compass_str, compass_tab, ARRAY_NENTS(compass_tab), -1);
}
...
int gilP_string_to_file_chooser_type(STRING s_type) { return 0; }
...
gilP_string_to_label_type(STRING type_string) {
        return (AB_LABEL_TYPE)convert_string_to_int(
            type_string, label_type_tab, ARRAY_NENTS(label_type_tab), -1);
}
