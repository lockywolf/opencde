...
int abmfP_comp_get_widget_specific_includes(StringList includes, ABObj compObj);
int abmfP_obj_get_widget_specific_includes(StringList includes, ABObj obj);
int abmfP_tree_write_widget_specific_includes(File codeFile, ABObj tree);
