 ...
 */
int abmfP_get_num_args_of_classes(ABObj obj, ABMF_ARG_CLASS classes);

int abmfP_comp_get_num_args_of_classes(ABObj obj, ABMF_ARG_CLASS classes);

int abmfP_get_num_code_file_args_of_classes(GenCodeInfo genCodeInfo, ABObj obj,
                                            ABMF_ARG_CLASS classes);

int abmfP_comp_get_num_code_file_args_of_classes(GenCodeInfo genCodeInfo,
                                                 ABObj obj,
                                                 ABMF_ARG_CLASS classes);

int abmfP_get_num_res_file_args_of_classes(GenCodeInfo genCodeInfo, ABObj obj,
                                           ABMF_ARG_CLASS classes);

int abmfP_comp_get_num_res_file_args_of_classes(GenCodeInfo genCodeInfo,
                                                ABObj obj,
                                                ABMF_ARG_CLASS classes);

BOOL abmfP_arg_is_spewed(/* saved out, or ignored completely? */
                         GenCodeInfo genCodeInfo, STRING argName, ABObj obj);
...
AB_ARG_TYPE abmfP_get_res_type(STRING res_xmname, ABObj obj /* may be NULL */
);
