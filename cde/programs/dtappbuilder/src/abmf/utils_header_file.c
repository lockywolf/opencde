...
**                                                                      **
**************************************************************************/
static int write_session_typedefs(GenCodeInfo genCodeInfo, ABObj project);
...
int abmfP_write_utils_header_file(GenCodeInfo genCodeInfo, STRING fileName,
                                  ABObj project) {
        char name[1024];
        ...
        abmfP_write_file_header(
            genCodeInfo, fileName, TRUE, name, util_get_program_name(),
            ABMF_MODIFY_NOT,
        ...
        abmfP_write_file_footer(genCodeInfo, fileName, TRUE);
        return 0;
}
...
static int write_drag_types(GenCodeInfo genCodeInfo, ABObj project) {
        ...
        abio_puts(
            ...
            "    unsigned char      operations;     /* XmCopy | XmMove | "
            "XmLink */\n"
            ...
            "} DtbDndDroppedOnRootWindowInfoRec, "
            "*DtbDndDroppedOnRootWindowInfo;\n"
            "\n"
...
static int write_group_types(GenCodeInfo genCodeInfo) {
        ...
        abio_puts(codeFile, "\n");
        abmfP_write_c_comment(genCodeInfo, FALSE, "Types of group layout");
        abio_puts(codeFile, "typedef enum {\n");
