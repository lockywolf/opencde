...
int abmfP_gencode_construct(GenCodeInfo gen) {
        gen->code_file = NULL;
...
int abmfP_gencode_destruct(GenCodeInfo gen) {
...
int abmfP_gencode_enter_func(GenCodeInfo genCodeInfo) {
        ...
        strlist_set_is_unique(&(genCodeInfo->cur_func.submenu_params), FALSE);
...
BOOL abmfP_obj_is_substruct_obj(ABObj obj) {
        ...
        if ((item != NULL) && (obj_get_item_type(item) != AB_ITEM_FOR_LIST) &&
...
int abmfP_write_user_start_comment(GenCodeInfo genCodeInfo, STRING desc) {
        abio_printf(genCodeInfo->code_file, "/*** %s %s ***/\n",
                    abmfP_cmt_user_code_start, desc);
        return 0;
}

int abmfP_write_user_long_start_comment(GenCodeInfo genCodeInfo, STRING desc) {
...
int abmfP_write_user_end_comment(GenCodeInfo genCodeInfo, STRING desc) {
        abio_printf(genCodeInfo->code_file, "/*** %s   %s ***/\n",
                    abmfP_cmt_user_code_end, desc);
        return 0;
}

int abmfP_write_user_long_end_comment(GenCodeInfo genCodeInfo, STRING desc) {
        File codeFile = genCodeInfo->code_file;
        if (desc == NULL) {
...
int abmfP_write_user_seg(GenCodeInfo genCodeInfo, STRING desc,
                         STRING contents) {
        File codeFile = genCodeInfo->code_file;
...
int abmfP_write_user_long_seg(GenCodeInfo genCodeInfo, STRING desc) {
...
int abmfP_write_user_type_and_var_seg(GenCodeInfo genCodeInfo) {
        return abmfP_write_user_seg(genCodeInfo,
                                    "Add type and variable definitions", NULL);
}

int abmfP_write_user_struct_fields_seg(GenCodeInfo genCodeInfo) {
        return abmfP_write_user_seg(genCodeInfo, "Add structure fields", NULL);
}

int abmfP_write_user_funcs_seg(GenCodeInfo genCodeInfo) {
        return abmfP_write_user_seg(genCodeInfo, "Add user-defined functions",
                                    NULL);
}

int abmfP_write_user_code_seg(GenCodeInfo genCodeInfo, STRING contents) {
        return abmfP_write_user_seg(genCodeInfo, "Add C code", contents);
}

int abmfP_write_user_var_seg(GenCodeInfo genCodeInfo) {
        return abmfP_write_user_seg(genCodeInfo, "Add C variables", NULL);
}

int abmfP_write_user_var_and_code_seg(GenCodeInfo genCodeInfo,
                                      STRING contents) {
        return abmfP_write_user_seg(genCodeInfo, "Add C variables and code",
                                    contents);
}

int abmfP_write_user_header_seg(GenCodeInfo genCodeInfo) {
        return abmfP_write_user_seg(genCodeInfo, "Add file header", NULL);
}

int abmfP_write_user_file_top_seg(GenCodeInfo genCodeInfo) {
        File codeFile = genCodeInfo->code_file;
        ...
        abio_printf(codeFile, " ***\n");
        abio_printf(codeFile, " *** Add include files, types, macros, externs, "
                              "and user functions here.\n");
        abio_printf(codeFile, " ***/\n");
...
int abmfP_write_user_file_bottom_seg(GenCodeInfo genCodeInfo) {
        File codeFile = genCodeInfo->code_file;
        ...
        abio_printf(codeFile, " *** %s\n", abmfP_cmt_user_code_start);
        abio_printf(codeFile, " ***\n");
        abio_printf(codeFile, " *** All automatically-generated data and "
