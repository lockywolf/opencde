...
static MsgSet get_cached_msg_set(MsgFile msg_file, ABObj obj);

extern BOOL abmfP_initialize_msg_file(GenCodeInfo genCodeInfo, ABObj project) {
...
extern char *abmfP_catgets_prefix_str(GenCodeInfo genCodeInfo, ABObj obj,
                                      char *msg_string) {
        ...
        if ((msg_set = get_cached_msg_set(genCodeInfo->msg_file_obj, obj)) ==
            NULL)
                goto cret;
        ...
        sprintf(str_catg, "catgets(Dtb_project_catd, %d, %d, ",
                MsgSet_get_number(msg_set), msg_num);
...
static MsgSet get_cached_msg_set(MsgFile msg_file, ABObj obj) {
        ...
        if (obj == prev_obj)
                ...
                msg_set =
                    MsgFile_sure_find_msg_set(msg_file, proj_suffixed_name);
                ...
                if (module == prev_module)
                        ...
                        msg_set =
                            MsgFile_sure_find_msg_set(msg_file, module_name);
