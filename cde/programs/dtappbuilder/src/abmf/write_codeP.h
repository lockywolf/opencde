...
#define abmfP_create_obj(genCodeInfo) (abmfP_cur_func(genCodeInfo)->create_obj)

#define abmfP_ip_obj(genCodeInfo) (abmfP_cur_func(genCodeInfo)->ip_obj)

#define abmfP_args_var(genCodeInfo) (abmfP_cur_func(genCodeInfo)->args_var)
...
#define abmfP_name_param(genCodeInfo) (abmfP_cur_func(genCodeInfo)->name_param)
