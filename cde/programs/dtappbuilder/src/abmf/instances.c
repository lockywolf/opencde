...
#ifdef BOGUS
static int write_create_and_attach_all_item_menus(GenCodeInfo genCodeInfo,
                                                  ABObj obj);
static int write_create_and_attach_item_menu(GenCodeInfo genCodeInfo,
                                             ABObj item);
#endif

static int write_comp_create_all_subobjs(GenCodeInfo genCodeInfo, ABObj obj);
static int write_create_one_item(GenCodeInfo genCodeInfo, ABObj item,
...
static int write_assign_local_vars_for_icon(GenCodeInfo genCodeInfo, ABObj obj);
static int write_assign_local_vars_for_label(GenCodeInfo genCodeInfo,
                                             ABObj obj);
static int write_assign_local_vars_for_acceltext(GenCodeInfo genCodeInfo,
                                                 ABObj obj);
static int write_assign_local_vars_for_value(GenCodeInfo genCodeInfo,
                                             ABObj obj);
static int write_assign_local_vars_for_fchooser(GenCodeInfo genCodeInfo,
                                                ABObj obj);

static int write_free_local_vars(GenCodeInfo genCodeInfo, ABObj obj);
static int write_free_local_vars_for_label(GenCodeInfo genCodeInfo, ABObj obj);
static int write_free_local_vars_for_icon(GenCodeInfo genCodeInfo, ABObj obj);
static int write_free_local_vars_for_acceltext(GenCodeInfo genCodeInfo,
                                               ABObj obj);
static int write_free_local_vars_for_value(GenCodeInfo genCodeInfo, ABObj obj);
static int write_free_local_vars_for_fchooser(GenCodeInfo genCodeInfo,
                                              ABObj obj);
static int write_free_local_xmstring_array(GenCodeInfo genCodeInfo, ABObj obj);

static int write_comp_file_chooser(GenCodeInfo genCodeInfo, ABObj fchooser);

static int write_widget_menu_button(GenCodeInfo genCodeInfo, ABObj obj,
                                    int index, int num_submenus, ABObj parent);

static int write_comp_except_for_actual_obj_tree(GenCodeInfo genCodeInfo,
                                                 ABObj obj);

static int write_comp_except_for_subtree(GenCodeInfo genCodeInfo, ABObj obj,
                                         ABObj subtree);

static int write_comp_parents_of_obj(GenCodeInfo genCodeInfo, ABObj obj);

static void write_help_setup_for_obj(GenCodeInfo genCodeInfo, ABObj obj);

static void write_help_setup_for_scrolled_parent(GenCodeInfo genCodeInfo,
                                                 ABObj obj);
...
static int write_assign_local_vars_for_icon(GenCodeInfo genCodeInfo,
                                            ABObj obj) {
        ...
        *parentName = 0;
        ...
        if ((obj_get_icon(obj) != NULL) || (obj_get_icon_mask(obj) != NULL)) {
                ...
                {
                    sprintf(parentName, "%s()",
                abmfP_lib_get_toplevel_widget->name);
                }
                else
                */
                {
        ...
        if ((obj_get_icon_label(obj) != NULL) &&
            ...
            (!abmfP_icon_name_str_var_has_value(genCodeInfo))) {
                if (genCodeInfo->i18n_method == ABMF_I18N_XPG4_API) {
                        ...
                        abio_printf(
                            codeFile, "%s = XtNewString(",
                            istr_string(abmfP_icon_name_str_var(genCodeInfo)));

                        abio_puts(codeFile, abmfP_catgets_prefix_str(
                                                genCodeInfo, obj, label));
 ...
 * this object
 */
static write_assign_local_vars_for_label(GenCodeInfo genCodeInfo, ABObj obj) {
        File codeFile = genCodeInfo->code_file;
        ABObj wholeObj = NULL;
        ABObj labelObj = NULL;
         ...
         * nothing to do.
         */
        if ((labelObj != obj) || (obj_get_label(wholeObj) == NULL))
                return 0;
                ...
                if ((abmfP_title_str_var(genCodeInfo) != NULL) &&
                    (!abmfP_title_str_var_has_value(genCodeInfo))) {
                        if (genCodeInfo->i18n_method == ABMF_I18N_XPG4_API) {
                                ...
                                abio_printf(codeFile, "%s = XtNewString(",
                                            istr_string(abmfP_title_str_var(
                                                genCodeInfo)));
                ...
                case AB_LABEL_STRING:
                        if ((abmfP_label_xmstr_var(genCodeInfo) != NULL) &&
                            (!abmfP_label_xmstr_var_has_value(genCodeInfo))) {
                                if (obj_is_item(obj) &&
                                    abmfP_label_array_var(genCodeInfo) !=
                                        NULL &&
                                    abmfP_label_array_has_nulls(genCodeInfo)) {
                                        abio_printf(
                                            codeFile, "if (%s[i] != NULL)\n",
                                            istr_string(abmfP_label_array_var(
                                                genCodeInfo)));
                                        abio_indent(codeFile);
                                }
                                abio_printf(codeFile,
                                            "%s = XmStringCreateLocalized(",
                                            istr_string(abmfP_label_xmstr_var(
                                                genCodeInfo)));
                                ...
                                if (obj_is_item(obj) &&
                                    abmfP_label_array_var(genCodeInfo) !=
                                        ...
                                        /*
                                         * TBD: passing array references for
                                         * items won't work with catgets: need
                                         * to fix that
                                         */
                                        /*
                                         * TBD: Streamline this and update
                                         * macros like write_str_resource to
                                         * handle i18n transparently
                                         */
                                        if (genCodeInfo->i18n_method ==
                                            ABMF_I18N_XPG4_API) {
                                                char *label =
                                                    obj_get_label(wholeObj);
 ...
 * this object
 */
static write_assign_local_vars_for_acceltext(GenCodeInfo genCodeInfo,
                                             ABObj obj) {
        File codeFile = genCodeInfo->code_file;
            ...
            (accel = obj_get_accelerator(obj)) != NULL) {
                if ((abmfP_acceltext_xmstr_var(genCodeInfo) != NULL) &&
                    (!abmfP_acceltext_xmstr_var_has_value(genCodeInfo))) {
                        ...
                        abio_printf(codeFile, "%s = XmStringCreateLocalized(",
                                    istr_string(abmfP_acceltext_xmstr_var(
                                        genCodeInfo)));

                        if (genCodeInfo->i18n_method == ABMF_I18N_XPG4_API) {
                                abio_puts(codeFile,
                                          abmfP_catgets_prefix_str(
                                              genCodeInfo, obj, acceltext));
 ...
 */
static write_assign_local_vars_for_value(GenCodeInfo genCodeInfo, ABObj obj) {
        File codeFile = genCodeInfo->code_file;
        ABObj wholeObj = obj_get_root(obj);
        ABObj text_obj = NULL;

        if (!obj_is_text(wholeObj))
                return 0;
        text_obj = objxm_comp_get_subobj(wholeObj, AB_CFG_OBJECT_OBJ);
        if ((obj == text_obj) &&
            (obj_get_initial_value_string(wholeObj) != NULL)) {
                if ((abmfP_value_str_var(genCodeInfo) != NULL) &&
                    (!abmfP_value_str_var_has_value(genCodeInfo))) {
                        if (genCodeInfo->i18n_method == ABMF_I18N_XPG4_API) {
                                char *value =
                                    obj_get_initial_value_string(wholeObj);

                                abio_printf(codeFile, "%s = XtNewString(",
                                            istr_string(abmfP_value_str_var(
                                                genCodeInfo)));
 ...
 * file choosers
 */
static write_assign_local_vars_for_fchooser(GenCodeInfo genCodeInfo,
                                            ABObj obj) {
        File codeFile = genCodeInfo->code_file;
        ABObj wholeObj = obj_get_root(obj);
        ABObj fsb_obj = NULL;
        ...
        if (obj == fsb_obj) {
                if ((obj_get_ok_label(wholeObj) != NULL) &&
                    ...
                    (!abmfP_ok_label_xmstr_var_has_value(genCodeInfo))) {
                        ...
                        abio_printf(
                            codeFile, "%s = XmStringCreateLocalized(",
                            istr_string(abmfP_ok_label_xmstr_var(genCodeInfo)));

                        if (genCodeInfo->i18n_method == ABMF_I18N_XPG4_API) {
                                abio_puts(codeFile,
                                          abmfP_catgets_prefix_str(
                                              genCodeInfo, obj, ok_label));
                ...
                if ((obj_get_directory(wholeObj) != NULL) &&
                    ...
                    (!abmfP_directory_xmstr_var_has_value(genCodeInfo))) {
                        ...
                        abio_printf(codeFile, "%s = XmStringCreateLocalized(",
                                    istr_string(abmfP_directory_xmstr_var(
                                        genCodeInfo)));
...
static int write_free_local_xmstring_array(GenCodeInfo genCodeInfo, ABObj obj) {
        ...
        if (num_items > 0) {
                ...
                abio_printf(codeFile, "XmStringFree(%s[i]);\n\n",
                            abmfP_get_c_array_of_xmstrings_name(
                                obj_get_item(obj_get_root(obj), 0)));
                abio_outdent(codeFile);
        }
        return 0;
}
 ...
 */
static BOOL abmfP_subobj_should_be_written(ABObj subobj) {
        BOOL should_it = TRUE;
...
static STRING abmfP_strip_item_name(char *item_name) {
 ...
 */
int abmfP_write_add_callbacks_and_actions(GenCodeInfo genCodeInfo,
                                          ABObj srcObj) {
        File codeFile = genCodeInfo->code_file;
        AB_TRAVERSAL trav;
                     ...
                     (action = trav_next(&trav)) != NULL;) {
                        ...
                        if (from != NULL)
                                ...
                                case AB_WHEN_DRAGGED_FROM: {
                                        unsigned dragOps =
                                            obj_get_drag_ops(from);
                                        unsigned dragTypes =
                                            obj_get_drag_types(from);
                                        int numOps = 0;

                                        actualSrcSubobj = objxm_comp_get_subobj(
                                            from, AB_CFG_DND_OBJ);
                                        abio_printf(
                                            codeFile, "%s(%s,\n",
                                        ...
                                        abio_printf(
                                            codeFile, "%s, ",
                                            (obj_get_drag_to_root_allowed(from)
                                                 ? "True"
                                                 : "False"));
                                ...
                                case AB_WHEN_DROPPED_ON: {
                                        unsigned dropOps =
                                            obj_get_drop_ops(from);
                                        unsigned dropTypes =
                                            obj_get_drop_types(from);
                                        int numProtocols = 0;
                                        int numOps = 0;
                                        ...
                                        if ((dropTypes & ABDndTypeText) != 0) {
                                                abio_printf(
                                                    codeFile,
                                                    "%sDtDND_TEXT_TRANSFER",
                                                    numProtocols > 0
                                                        ? "|"
                                                        : Util_empty_string);
                                                ++numProtocols;
                                        }
                                        if ((dropTypes & ABDndTypeFilename) !=
                                            0) {
                                                abio_printf(
                                                    codeFile,
                                                    "%sDtDND_FILENAME_TRANSFER",
                                                    numProtocols > 0
                                                        ? "|"
                                                        : Util_empty_string);
                                                ++numProtocols;
                                        }
                                        if ((dropTypes & ABDndTypeUserDef) !=
                                            0) {
                                                abio_printf(
                                                    codeFile,
                                                    "%sDtDND_BUFFER_TRANSFER",
                                                    numProtocols > 0
                                                        ? "|"
                                                        : Util_empty_string);
                                                ++numProtocols;
                                        ...
                                        abio_printf(
                                            codeFile, "%s, ",
                                            (obj_drop_on_children_is_allowed(
                                                 from)
                                                 ? "True"
                                                 : "False"));
                                ...
                                default: {
                                        if (from == commonSrcObj) {
                                                ...
                                                if (resource == NULL) {
                                                        ...
                                                        actualSrcSubobj =
                                                            objxm_comp_get_source_for_when(
                                                                srcObj, when);
                                                        actualTargetSubobj =
                                                            objxm_comp_get_target_for_builtin_action(
                                                                dest,
                                                                builtin_action);
                                                        if (actualTargetSubobj ==
                                                            NULL) {
                                                                /* Although the
                                                                 * individual
                                                                 * widget is not
...
int abmfP_write_add_callback(GenCodeInfo genCodeInfo, STRING resource,
                             STRING func_name, ABObj src, ABObj dest) {
        File codeFile = genCodeInfo->code_file;

        if (ObjWClassIsPulldownMenu(src) || ObjWClassIsPopupMenu(src)) {
                abio_printf(
                    codeFile, "\tXtAddCallback(XtParent(%s),\n\t\t%s, %s,\n",
                    abmfP_get_c_name(genCodeInfo, src), resource, func_name);
        } else {
                abio_printf(codeFile, "\tXtAddCallback(%s,\n\t\t%s, %s,\n",
                            abmfP_get_c_name(genCodeInfo, src), resource,
                            func_name);
        }
        ...
        if (abmfP_get_c_name(genCodeInfo, dest) == NULL) {
                ...
                if ((refList != NULL) && (numRefs > 0)) {
                        for (i = 0; i < numRefs; ++i) {
                                ...
                                if (abmfP_get_c_struct_name(genCodeInfo,
                                                            refObj) != NULL) {
                                        abio_printf(codeFile,
                                                    "\t\t(XtPointer)&%s);\n",
                ...
                if (!handled) {
                        /*
                        ** is this an acceptable way to recover? possibly not,
                        *but the
                        ** resulting code will compile.
                        */
                        util_dprintf(0, "ERROR: abmfP_write_add_callback(): ");
                        util_dprintf(0, "Unable to determine client_data, "
                                        "substituting \"NULL\"\n");
...
int abmfP_write_add_callback_with_string(GenCodeInfo genCodeInfo,
                                         STRING resource, STRING func_name,
                                         ABObj src, STRING client_data) {
        File codeFile = genCodeInfo->code_file;
 ...
 */
static int write_convert_strings_to_xmstrings(GenCodeInfo genCodeInfo,
                                              ABObj obj) {
        File codeFile = genCodeInfo->code_file;
        ...
        if (genCodeInfo->i18n_method != ABMF_I18N_XPG4_API) {
                ...
                for (i = 0; i < num_items; ++i) {
                        ...
                        abio_printf(
                            codeFile, "%s[i++] = XmStringCreateLocalized(",
                            abmfP_get_c_array_of_xmstrings_name(first_item));
...
static int write_set_glyph_labels(GenCodeInfo genCodeInfo, ABObj obj) {
        ...
        if (!obj_is_item(obj)) { /* obj is not an item */
                if (abmfP_obj_has_glyph_label(rootObj)) {
                        ABObj labelObj = NULL;

                        labelObj =
                            objxm_comp_get_subobj(rootObj, AB_CFG_LABEL_OBJ);
                        if (obj == labelObj) {
        ...
        case AB_TYPE_COMBO_BOX:
                ...
                if (obj == objxm_comp_get_subobj(obj, AB_CFG_OBJECT_OBJ) &&
                    (value = obj_get_width(obj_get_root(obj))) != -1) {
                        abmfP_write_c_comment(genCodeInfo, FALSE,
                                              "Workaround: ComboBox size "
                                              "resources ignored at "
                                              "Create-time");
                        abio_printf(codeFile,
                                    "XtVaSetValues(%s, XmNwidth, %d, NULL);\n",
 ...
 */
static int write_create_widget_by_non_va_conv_func(GenCodeInfo genCodeInfo,
                                                   ABObj obj, STRING conv_func,
                                                   BOOL useAllCompArgs) {
        File codeFile = genCodeInfo->code_file;
        int num_args = 0;
        ...
        num_args = abmfP_get_num_args_of_classes(
            obj, ABMF_ARGCLASS_ALL_BUT_WIDGET_REF);
        if (num_args > 0) {
                ...
                if (useAllCompArgs) {
                        ...
                        ABObj subobj = NULL;
                        for (trav_open(&compTrav, compRoot,
                                       AB_TRAV_COMP_SUBOBJS);
                             (subobj = trav_next(&compTrav)) != NULL;) {
                                abmfP_obj_spew_args(
                                    genCodeInfo, subobj,
                                    ABMF_ARGCLASS_ALL_BUT_WIDGET_REF,
                                    ABMF_ARGFMT_ARRAY);
                        }
                        trav_close(&compTrav);
                } else {
 ...
 */
static int write_create_widget_by_xt_va_create(GenCodeInfo genCodeInfo,
                                               ABObj obj) {
        File codeFile = genCodeInfo->code_file;
        ...
        abmfP_obj_spew_args(genCodeInfo, obj, ABMF_ARGCLASS_ALL_BUT_WIDGET_REF,
                            ABMF_ARGFMT_VA_LIST);
...
static int write_create_widget_normally(GenCodeInfo genCodeInfo, ABObj obj) {
        int return_value = -1;
        BOOL wroteIt = FALSE;
        ...
        if (!wroteIt) {
                return_value =
                    write_create_widget_by_xt_va_create(genCodeInfo, obj);
        }
        write_free_local_vars(genCodeInfo, obj);
...
static int write_comp_create_menu_button(GenCodeInfo genCodeInfo, ABObj obj) {
        File codeFile = genCodeInfo->code_file;
        int return_value = 0;
        int rc = 0;
        ABObj menuObj = NULL;

        rc = write_create_widget_by_non_va_conv_func(
            genCodeInfo, obj, "DtCreateMenuButton", FALSE);
        return_if_err(rc, rc);
...
static int write_comp_create_button(GenCodeInfo genCodeInfo, ABObj obj) {
        int return_value = 0;
 ...
 *
 */
static int write_comp_create_choice(GenCodeInfo genCodeInfo, ABObj obj) {
                ...
                if (itemParentObj != NULL) {
                        if ((actualObj != NULL) &&
                            (!obj_is_descendant_of(itemParentObj, actualObj))) {
                                write_comp_parents_of_obj(genCodeInfo,
                                                          itemParentObj);
                        }
                        abmfP_write_create_widgets_for_one_obj(genCodeInfo,
                                                               itemParentObj);
                }
        }
...
static int write_comp_file_chooser(GenCodeInfo genCodeInfo, ABObj fchooser) {
        ...
        abio_printf(genCodeInfo->code_file,
                    "%s = ", abmfP_get_c_name(genCodeInfo, fchooser));
 ...
 */
static int write_comp_create_term_pane(GenCodeInfo genCodeInfo, ABObj obj) {
        int return_value = 0;
        int rc = 0; /* return code */
        ABObj actualObj = objxm_comp_get_subobj(obj, AB_CFG_OBJECT_OBJ);
...
static int write_comp_create_text(GenCodeInfo genCodeInfo, ABObj obj) {
        int return_value = 0;
        ...
        if (scrollingObj != NULL) {
                ...
                if (!obj_is_initially_visible(obj)) {
                        abmfP_write_c_comment(genCodeInfo, FALSE,
                                              ...
                                              "ScrolledWindow");
                        abio_printf(
                            genCodeInfo->code_file, "XtUnmanageChild(%s);\n",
                            abmfP_get_c_name(genCodeInfo, scrollingObj));
                }
        } else {
                return_value = write_comp_create_all_subobjs(genCodeInfo, obj);
 ...
 *
 */
static int write_obj_create_base_win(GenCodeInfo genCodeInfo, ABObj obj) {
        File codeFile = genCodeInfo->code_file;
 ...
 */
static int write_obj_create_for_choice(GenCodeInfo genCodeInfo, ABObj obj) {
        int return_value = 0;
        ABObj wholeObj = obj_get_root(obj);
 ...
 *
 */
static int write_obj_create_dialog(GenCodeInfo genCodeInfo, ABObj dialog) {
 ...
 */
static int write_list(GenCodeInfo genCodeInfo, ABObj list) {
        ABObj wholeObj = NULL;
        ...
        write_create_widget_by_non_va_conv_func(genCodeInfo, list,
                                                "XmCreateScrolledList", FALSE);

        for (i = 0; i < num_items; i++) {
                item = obj_get_item(list, i);
                if (obj_is_initially_selected(item))
                        abio_printf(genCodeInfo->code_file,
                                    "XmListSelectPos(%s, %d, False);\n",
        ...
        if (scrollObj != NULL) {
                ...
                abio_printf(genCodeInfo->code_file,
                            "%s = ", abmfP_get_c_name(genCodeInfo, scrollObj));
                genCodeInfo->cur_func.create_obj = list;
                abio_printf(genCodeInfo->code_file, "XtParent(%s);\n",
 ...
 */
static int write_spinbox(GenCodeInfo genCodeInfo, ABObj spinbox) {
        ...
        write_create_widget_by_non_va_conv_func(genCodeInfo, spinbox,
                                                "DtCreateSpinBox", FALSE);
...
static int write_menu(GenCodeInfo genCodeInfo, ABObj menu) {
        int return_value = 0;
...
static int write_menu_bar(GenCodeInfo genCodeInfo, ABObj mbar) {
        write_create_widget_by_non_va_conv_func(genCodeInfo, mbar,
                                                "XmCreateMenuBar", FALSE);
        return 0;
}
 ...
 */
static int write_create_all_items(GenCodeInfo genCodeInfo, ABObj obj) {
        File codeFile = genCodeInfo->code_file;
        ...
        if (obj_is_list_item(firstItem) || obj_is_spin_box_item(firstItem)) {
                ...
                if (obj_is_menu(obj)) {
                        ...
                        if (itemParent != NULL) {
                                /* we'll just create widgets up to the first
                                 * item */
                                for (trav_open(&trav, itemParent,
                                               AB_TRAV_CHILDREN);
                ...
                if ((genCodeInfo->i18n_method != ABMF_I18N_XPG4_API) &&
                    ...
                    !abmfP_items_have_accelerators(
                        obj)) /* Create Items in a Loop */
                {
                        /*
                         * Create the items in a loop
                         */
                        strcpy(widgetArrayName,
                               abmfP_get_c_array_of_widgets_name(firstItem));
                        abio_printf(
                            codeFile, "for (i = 0; i < XtNumber(%s); i++)\n",
                        ...
                        /*
                         * Since we only generate code for one item, any
                         * "dumped" resources for the other items must be
                         * explicitly dumped to the resource file.
                         */
                        for (trav_open(&trav, obj, AB_TRAV_ITEMS_FOR_OBJ),
                        ...
                        if (!obj_is_combo_box_item(firstItem)) {
                                /*
                                 * Assign the values of the local array into the
                                 * global widget variables
                                 */
                                for (trav_open(&trav, obj,
                                               AB_TRAV_ITEMS_FOR_OBJ);
                                     (item = trav_next(&trav)) != NULL;) {
                                        abio_printf(
                                            codeFile, "%s = %s[%d];\n",
                ...
                } else /* Roll out Creation of each item */
                {
                        if (!obj_is_combo_box_item(firstItem)) {
                                ...
                                for (i = 0; i < obj_get_num_items(obj); ++i) {
                                        ...
                                        abio_printf(codeFile, "\n");
                                        write_create_one_item(genCodeInfo, item,
                                                              NULL);
                                }
                        }
                }
...
static int write_create_and_attach_all_item_menus(GenCodeInfo genCodeInfo,
        ...
        abmfP_write_c_comment(genCodeInfo, FALSE,
                              "Create and attach the submenus");
...
static int write_create_and_attach_item_menu(GenCodeInfo genCodeInfo,
        ...
        strncpy(parentVar, abmfP_get_widget_parent_name(genCodeInfo, menu_ref),
                256);
        parentVar[255] = 0;
...
static BOOL ancestor_is_menu(ABObj obj) {
        AB_TRAVERSAL trav;
        AB_OBJ *ancestor;
        BOOL isit = FALSE;
...
#define MAX_ANCESTORS 100
        ...
        for (ancestor = abmfP_parent(obj); ancestor != NULL;
...
static int write_comp_except_for_subtree(GenCodeInfo genCodeInfo, ABObj obj,
         ...
         */
        if ((subtree != NULL) &&
            ((obj == subtree) || (obj_is_descendant_of(obj, subtree)))) {
                return 0;
        }
        ...
        for (trav_open(&trav, obj, AB_TRAV_CHILDREN);
             (subobj = trav_next(&trav)) != NULL;) {
                if ((subobj != obj) && (obj_get_root(subobj) == comp_root)) {
                        write_comp_except_for_subtree(genCodeInfo, subobj,
                                                      subtree);
                }
        }
        trav_close(&trav);
...
static int write_create_one_item(GenCodeInfo genCodeInfo, ABObj item,
        ...
        *widgetArrayVarName = 0;
        ...
        if (obj_is_combo_box_item(item)) {
                ABObj parent = objxm_comp_get_subobj(obj_get_parent(item),
                                                     AB_CFG_PARENT_OBJ);
                 ...
                 */
                for (i = 0; i < num_items; i++)
                        if (obj_is_initially_selected(
                                obj_get_item(itemParent, i)))
                                break;
                ...
                if (i != 0) {
                        ...
                        abio_indent(codeFile);
                        abio_printf(
                            codeFile, "DtComboBoxSelectItem(%s, %s);\n",
                            abmfP_get_c_name(genCodeInfo, parent),
                            istr_string(abmfP_label_xmstr_var(genCodeInfo)));
                        abio_outdent(codeFile);
                }
                ...
                abmfP_obj_spew_args(genCodeInfo, item, argClasses,
                                    ABMF_ARGFMT_VA_LIST);
                abmfP_xt_va_list_close(genCodeInfo);

                if ((counterVarName != NULL) &&
                    (!util_strempty(widgetArrayVarName))) {
                        /*
                         * Set additional arguments
                         * REMIND: This should probably be put into a local
                         * array, as well
                         */
                        for (i = 0,
                            trav_open(&itemTrav, itemParent, AB_TRAV_ITEMS);
                             (siblingItem = trav_next(&itemTrav)) != NULL;
                             ++i) {
                                if (!obj_is_initially_active(siblingItem)) {
                                        sprintf(buf, "%d", i);
                                        strlist_add_str(inactiveItems, buf,
                                                        NULL);
                                }
                        ...
                        if (numInactiveItems > 0) {
                                ...
                                for (i = 0; i < numInactiveItems; ++i) {
                                        ...
                                        abio_printf(
                                            codeFile, "%s == %s",
                                            counterVarName,
                                            strlist_get_str(inactiveItems, i,
                                                            NULL));
                                        if (numInactiveItems > 1) {
                                                abio_printf(codeFile, ")");
                                        }
                                ...
                                abmfP_write_c_block_begin(genCodeInfo);
                                abio_printf(codeFile,
                                            "XtSetSensitive(%s[%s], False);\n",
                                            widgetArrayVarName, counterVarName);
                                abmfP_write_c_block_end(genCodeInfo);
                        }

                        /* If OptionMenu has an item other than the
                         * first(default) selected, we must generate special
                         * code to set this "current" selection.
                         */
                        if (obj_is_option_menu(itemParent) &&
                            selectedIndex > 0) {
                                abio_printf(
                                    codeFile,
                                    "if (%s == %d) /* Set selected item */\n",
                                    counterVarName, selectedIndex);
                                abmfP_write_c_block_begin(genCodeInfo);
                                abio_printf(
                                    codeFile,
                                    "XtVaSetValues(%s, XmNmenuHistory, %s[%s], "
                                    "NULL);\n",
                                    abmfP_get_c_name(
                                        genCodeInfo,
                                        objxm_comp_get_subobj(
                                            itemParent, AB_CFG_OBJECT_OBJ)),
                                    widgetArrayVarName, counterVarName);
                                abmfP_write_c_block_end(genCodeInfo);
                        }
...
static int write_widget_file_chooser_shell(GenCodeInfo genCodeInfo, ABObj obj) {
        File codeFile = genCodeInfo->code_file;
...
abmfP_get_widget_parent_name(GenCodeInfo genCodeInfo, ABObj obj) {
        ...
        *parentName = 0;
        ...
        if ((genCodeInfo->writing_func) && (createObj == obj) &&
            (parentParamExists)) {
        ...
        if ((!parentFound) && (parent != NULL)) {
                ...
                while (((ancestor != NULL) && (ancestor != topAncestorObj) &&
                ...
                if (ancestor != NULL) {
                        if (ancestor == topAncestorObj) {
                                util_strncpy(parentName,
                                             istr_string(abmfP_parent_param(
                                                 genCodeInfo)),
                                             MAX_NAME_SIZE);
                                parentFound = TRUE;
                                ...
                                util_strncpy(
                                    parentName,
                                    abmfP_get_c_name(genCodeInfo, ancestor),
                                    MAX_NAME_SIZE);
                                parentFound = TRUE;
                        }
                }
...
static int child_isnumeric(ABObj child) {
        return ((child->type == AB_TYPE_TEXT_FIELD) &&
                (child->info.text.type == AB_TEXT_NUMERIC));
}

static int write_check_null(GenCodeInfo genCodeInfo, ABObj obj) {
        abio_printf(genCodeInfo->code_file, "if (%s == NULL) {\n",
                    abmfP_get_c_name(genCodeInfo, obj));
        abio_indent(genCodeInfo->code_file);
        return 0;
}
...
static void write_help_setup_for_obj(GenCodeInfo genCodeInfo, ABObj obj) {
        ...
        */
        ...
        if (obj_has_help_data(wholeObj)) {
                ...
                /*
                ** See if the current object is the root object's help object.
                *If so,
                ** then we need to set up the help callback.  Special case
                *handling
                ** is necessary for label-less lists and for textpanes because
                *they are
                ** both created in the _ui.c file using XmCreate...()
                *convenience
                ** functions that implicitly create the ScrolledWindow parent
                *upon
                ** which we need to hang help.
                */
                if ((obj_is_list(obj) || obj_is_text_pane(obj)) &&
                    (obj == actualObj)) {
                        ABObj scrollObj = objxm_comp_get_subobj(
                            wholeObj, AB_CFG_SCROLLING_OBJ);
                        if (scrollObj == helpObj) {
                                write_help_setup_for_scrolled_parent(
                                    genCodeInfo, obj);
                        }
                        return;
                }
                ...
                if (testObj == helpObj) {
                        ...
                        /* Must fetch help text from message catalog for
                         * I18N-ized app */
                        if (genCodeInfo->i18n_method == ABMF_I18N_XPG4_API) {
                                obj_get_help_data(wholeObj, &help_volume,
                                                  &help_location, &help_text);
                                abio_printf(
                                    codeFile, "tmp_txt = %s",
                                    abmfP_catgets_prefix_str(
                                        genCodeInfo, wholeObj, help_text));
                                abio_put_string(codeFile, help_text);
                                abio_puts(codeFile, ");\n");

                                abio_printf(codeFile, "help_data.help_text = "
                                                      "XtMalloc(strlen(tmp_txt)"
                                                      "+1);\n");
                                abio_printf(
                                    codeFile,
                        ...
                        /* Help callback is wired in the same regardless of
                         * I18N-ization */
                        abmfP_write_add_callback_with_string(
                            genCodeInfo, "XmNhelpCallback", "dtb_help_dispatch",
                            helpObj, "&help_data");
                }
        }
        /*
        ...
        if (obj_is_button(obj)) {
                ...
                if (win_parent != (ABObj)NULL) {
                        ...
                        if (obj == help_btn) {
                                ...
                                helpObj = objxm_comp_get_subobj(
                                    win_parent, AB_CFG_HELP_OBJ);
                                abmfP_write_c_comment(genCodeInfo, FALSE,
                                                      "Add help callback");
                                abmfP_write_help_indirect_callback(
                                    genCodeInfo, obj, helpObj);
                        }
                }
        }
}
...
static void write_help_setup_for_scrolled_parent(GenCodeInfo genCodeInfo,
        ...
        if (genCodeInfo->i18n_method == ABMF_I18N_XPG4_API) {
                ...
                abio_printf(codeFile, "strcpy(help_data.help_text,tmp_txt);\n");
                abio_puts(codeFile, "\n");
        }
 ...
 *
 */
int abmfP_write_create_widgets_for_one_obj(GenCodeInfo genCodeInfo, ABObj obj) {
        int return_value = 0;
        File codeFile = genCodeInfo->code_file;
        ...
        if (obj_has_flag(obj, NoCodeGenFlag) || (obj_was_written(obj))) {
                goto epilogue;
        }
...
int abmfP_write_create_widgets_for_comp_obj(GenCodeInfo genCodeInfo,
                                            ABObj obj) {
        int return_value = 0;
...
int abmfP_write_help_indirect_callback(GenCodeInfo genCodeInfo, ABObj src_obj,
                                       ABObj help_obj) {
        File codeFile = genCodeInfo->code_file;
...
BOOL ObjWClassIsCompositeSubclass(ABObj obj) {
        return (ObjWClassIsComposite(obj) || ObjWClassIsConstraint(obj) ||
...
BOOL ObjWClassIsManagerSubclass(ABObj obj) {
        return (
            ObjWClassIsComposite(obj) || ObjWClassIsConstraint(obj) ||
            ObjWClassIsManager(obj) || ObjWClassIsBulletinBoard(obj) ||
            ObjWClassIsForm(obj) || ObjWClassIsSelectionBox(obj) ||
            ObjWClassIsMessageBox(obj) || ObjWClassIsCommand(obj) ||
            ObjWClassIsFileSelectionBox(obj) || ObjWClassIsDrawingArea(obj) ||
            ObjWClassIsFrame(obj) || ObjWClassIsPanedWindow(obj) ||
             ...
             * Our pseudo-classes
             */
            || (ObjWClassIsPulldownMenu(obj)) || (ObjWClassIsPopupMenu(obj)));
}

BOOL ObjWClassIsShellSubclass(ABObj obj) {
        return (
            (ObjWClassIsShell(obj)) || (ObjWClassIsOverrideShell(obj)) ||
            (ObjWClassIsMenuShell(obj)) || (ObjWClassIsWMShell(obj)) ||
            (ObjWClassIsVendorShell(obj)) || (ObjWClassIsTopLevelShell(obj)) ||
            (ObjWClassIsApplicationShell(obj)) ||
            (ObjWClassIsTransientShell(obj)) || (ObjWClassIsDialogShell(obj)) ||
