...
STRING abmfP_cvt_file_name_to_bitmap_data_vars(STRING fileName,
                                               STRING *widthVarPtr,
                                               STRING *heightVarPtr,
                                               STRING *bitsVarPtr);
...
STRING abmfP_obj_get_create_proc_return_widget_name(ABObj obj, int which_param);
...
#define abmfP_obj_has_clear_proc(obj) (abmfP_obj_is_struct_obj(obj))

#define abmfP_obj_has_init_proc(obj) (abmfP_obj_is_struct_obj(obj))
