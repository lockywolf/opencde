...
static int write_user_or_auto_decls(GenCodeInfo genCodeInfo, ABObj project,
                                    BOOL auto_named);
static int write_app_resource_struct(GenCodeInfo genCodeInfo, ABObj project);
static int write_app_resource_var_extern(GenCodeInfo genCodeInfo,
                                         ABObj project);
...
int abmfP_write_project_header_file(GenCodeInfo genCodeInfo, ABObj project,
        ...
        abmfP_write_file_header(
            genCodeInfo, codeFileName, TRUE, projectName,
 ...
 */
static int write_connection_decls(GenCodeInfo genCodeInfo, ABObj project) {
 ...
 */
static int write_callback_decls(GenCodeInfo genCodeInfo, ABObj project) {
