...
int strlist_add_index(StringList, int index, STRING s, void *userData);
...
STRING strlist_get_str(StringList, int whichString, void **userDataOut);
...
long strlist_add_index_istr(StringList, int index, ISTRING s, void *userData);
BOOL strlist_istr_exists(StringList list, ISTRING s);
long strlist_get_istr_index(StringList list, ISTRING s);
ISTRING strlist_get_istr(StringList, int whichString, void **userDataOut);
