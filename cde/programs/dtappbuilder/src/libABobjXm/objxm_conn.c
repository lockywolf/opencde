 ...
 *
 *	@(#)objxm_conn.c	1.23 04 May 1995
 *cde_app_builder/src/libABobjXm
 *
...
#define ObjWClassIsApplicationShell(obj) (ObjWClassIs((obj), _applicationShell))

#define ObjWClassIsArrowButton(obj) (ObjWClassIs((obj), _xmArrowButton))

#define ObjWClassIsBulletinBoard(obj) (ObjWClassIs((obj), _xmBulletinBoard))

#define ObjWClassIsCascadeButton(obj) (ObjWClassIs((obj), _xmCascadeButton))

#define ObjWClassIsDialogShell(obj) (ObjWClassIs((obj), _xmDialogShell))

#define ObjWClassIsDrawingArea(obj) (ObjWClassIs((obj), _xmDrawingArea))

#define ObjWClassIsDrawnButton(obj) (ObjWClassIs((obj), _xmDrawnButton))

#define ObjWClassIsFileChooserShell(obj)                                       \
        (ObjWClassIs((obj), _xmFileSelectionBox))

#define ObjWClassIsForm(obj) (ObjWClassIs((obj), _xmForm))

#define ObjWClassIsLabel(obj) (ObjWClassIs((obj), _xmLabel))

#define ObjWClassIsList(obj) (ObjWClassIs((obj), _xmList))

#define ObjWClassIsMainWindow(obj) (ObjWClassIs((obj), _xmMainWindow))

#define ObjWClassIsMenuButton(obj) (ObjWClassIs((obj), _dtMenuButton))

#define ObjWClassIsMenuShell(obj) (ObjWClassIs((obj), _xmMenuShell))

#define ObjWClassIsPanedWindow(obj) (ObjWClassIs((obj), _xmPanedWindow))

#define ObjWClassIsPrimitive(obj) (ObjWClassIs((obj), _xmPrimitive))

#define ObjWClassIsPushButton(obj) (ObjWClassIs((obj), _xmPushButton))

#define ObjWClassIsRowColumn(obj) (ObjWClassIs((obj), _xmRowColumn))

#define ObjWClassIsScrolledWindow(obj) (ObjWClassIs((obj), _xmScrolledWindow))

#define ObjWClassIsTextField(obj) (ObjWClassIs((obj), _xmTextField))

#define ObjWClassIsText(obj) (ObjWClassIs((obj), _xmText))

#define ObjWClassIsToggleButton(obj) (ObjWClassIs((obj), _xmToggleButton))

#define ObjWClassIsBaseWinShell(obj) (ObjWClassIsApplicationShell(obj))

#define ObjWClassIsScale(obj) (ObjWClassIs((obj), _xmScale))

#define ObjWClassIsSpinBox(obj) (ObjWClassIs((obj), _dtSpinBox))

/*
 * Complex checks
 */
#define ObjWClassIsShell(obj)                                                  \
        ((ObjWClassIsBaseWinShell(obj)) || (ObjWClassIsDialogShell(obj)) ||    \
         (ObjWClassIsFileChooserShell(obj)) || (ObjWClassIsMenuShell(obj)))

STRING
objxm_get_resource_for_when(ABObj obj, AB_WHEN when) {
        STRING res = NULL;
        ...
        case AB_TYPE_BASE_WINDOW:
                switch (when) {
                case AB_WHEN_HIDDEN:
                        res = XmNpopdownCallback;
                        break;
                case AB_WHEN_SHOWN:
                        res = XmNpopupCallback;
                        break;
                }
                break;
        ...
        case AB_TYPE_DRAWING_AREA:
                ...
                case AB_WHEN_REPAINT_NEEDED:
                        res = XmNexposeCallback;
                        break;
                case AB_WHEN_AFTER_RESIZED:
                        res = XmNresizeCallback;
                        break;
                }
                break;
 ...
 */
STRING
objxm_get_resource_for_builtin_action(ABObj obj,
        ...
        case AB_STDACT_SHOW:
                 ...
                 *  a convenience function. So, this case isn't really
                 * necessary, but is here for completeness.
                 */
...
ABObj objxm_comp_get_source_for_when(ABObj subObj, AB_WHEN when) {
        ABObj source = NULL;
        ...
        case AB_WHEN_POPPED_DOWN:
                ...
                /*
                            ...
                            {
                                source = objxm_comp_get_subobj(compObj,
                   AB_CFG_PARENT_OBJ);
                            }
...
ABObj objxm_comp_get_target_for_builtin_action(ABObj subObj,
        ...
        case AB_STDACT_SHOW:
                if (obj_is_popup_win(compObj)) {
                        actualTarget = objxm_comp_get_subobj(
                            compObj, AB_CFG_WINDOW_BB_OBJ);
                } else if (obj_is_base_win(compObj)) {
                        actualTarget =
                            objxm_comp_get_subobj(compObj, AB_CFG_OBJECT_OBJ);
...
static STRING get_resource_for_set_label(ABObj compObj, ABObj obj) {
        ...
        if (ObjWClassIsShell(obj)) {
                resource = XmNtitleString;
                   ...
                   ObjWClassIsDrawnButton(obj) || ObjWClassIsMenuButton(obj) ||
                   ObjWClassIsPushButton(obj) || ObjWClassIsToggleButton(obj) ||
