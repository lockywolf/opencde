...
#define check_obj_class_name(obj)                                              \
        ((obj_get_class_name(obj) != NULL)                                     \
             ...
             : obj_set_class_name(obj,                                         \
                                  objxm_obj_get_default_motif_class(obj)))

/*
 * XmConfigure/UnConfigure Methods
 */
static int mainwin_xmconfig(ABObj obj);
static int mainwin_unconfig(ABObj obj);
static int choice_xmconfig(ABObj obj);
static int choice_unconfig(ABObj obj);
static int combo_box_xmconfig(ABObj obj);
static int combo_box_unconfig(ABObj obj);
static ABObj combo_box_get_config_obj(ABObj obj, AB_CFG_OBJ_TYPE type);
static int cpanel_xmconfig(ABObj obj);
static int cpanel_unconfig(ABObj obj);
static int custdlg_xmconfig(ABObj obj);
static int custdlg_unconfig(ABObj obj);
static int layer_xmconfig(ABObj obj);
static int layer_unconfig(ABObj obj);
static int group_xmconfig(ABObj obj);
static int group_unconfig(ABObj obj);
static int item_xmconfig(ABObj obj);
static int list_xmconfig(ABObj obj);
static int list_unconfig(ABObj obj);
static int menu_xmconfig(ABObj obj);
static int menu_unconfig(ABObj obj);
static int menubar_xmconfig(ABObj obj);
static int pane_xmconfig(ABObj obj);
static int pane_unconfig(ABObj obj);
static int simple_xmconfig(ABObj obj);
static int simple_unconfig(ABObj obj);
static int scale_xmconfig(ABObj obj);
static int scale_unconfig(ABObj obj);
static int spin_box_xmconfig(ABObj obj);
static int spin_box_unconfig(ABObj obj);
static int textf_xmconfig(ABObj obj);
static int textf_unconfig(ABObj obj);
static int fchooser_xmconfig(ABObj obj);
static int box_unconfig(ABObj obj);

/*
 * GetConfigObj Methods
 */
static ABObj mainwin_get_config_obj(ABObj obj, AB_CFG_OBJ_TYPE type);
static ABObj choice_get_config_obj(ABObj obj, AB_CFG_OBJ_TYPE type);
static ABObj container_get_config_obj(ABObj obj, AB_CFG_OBJ_TYPE type);
static ABObj custdlg_get_config_obj(ABObj obj, AB_CFG_OBJ_TYPE type);
static ABObj layer_get_config_obj(ABObj obj, AB_CFG_OBJ_TYPE type);
static ABObj item_get_config_obj(ABObj obj, AB_CFG_OBJ_TYPE type);
static ABObj list_get_config_obj(ABObj obj, AB_CFG_OBJ_TYPE type);
static ABObj menu_get_config_obj(ABObj obj, AB_CFG_OBJ_TYPE type);
static ABObj pane_get_config_obj(ABObj obj, AB_CFG_OBJ_TYPE type);
static ABObj separator_get_config_obj(ABObj obj, AB_CFG_OBJ_TYPE type);
static ABObj spin_box_get_config_obj(ABObj obj, AB_CFG_OBJ_TYPE type);
static ABObj simple_get_config_obj(ABObj obj, AB_CFG_OBJ_TYPE type);
static ABObj textf_get_config_obj(ABObj obj, AB_CFG_OBJ_TYPE type);
static ABObj scale_get_config_obj(ABObj obj, AB_CFG_OBJ_TYPE type);
static ABObj box_get_config_obj(ABObj obj, AB_CFG_OBJ_TYPE type);
static ABObj panedwin_get_config_obj(ABObj obj, AB_CFG_OBJ_TYPE type);

/*
 * Resource Setting methods
 */
static int mainwin_set_args(ABObj obj, OBJXM_CONFIG_TYPE ctype);
static int simple_set_args(ABObj obj, OBJXM_CONFIG_TYPE ctype);
static int choice_set_args(ABObj obj, OBJXM_CONFIG_TYPE ctype);
static int combo_box_set_args(ABObj obj, OBJXM_CONFIG_TYPE ctype);
static int cpanel_set_args(ABObj obj, OBJXM_CONFIG_TYPE ctype);
static int custdlg_set_args(ABObj obj, OBJXM_CONFIG_TYPE ctype);
static int layer_set_args(ABObj obj, OBJXM_CONFIG_TYPE ctype);
static int group_set_args(ABObj obj, OBJXM_CONFIG_TYPE ctype);
static int item_set_args(ABObj obj, OBJXM_CONFIG_TYPE ctype);
static int drawp_set_args(ABObj obj, OBJXM_CONFIG_TYPE ctype);
static int separator_set_args(ABObj obj, OBJXM_CONFIG_TYPE ctype);
static int spin_box_set_args(ABObj obj, OBJXM_CONFIG_TYPE ctype);
static int termp_set_args(ABObj obj, OBJXM_CONFIG_TYPE ctype);
static int textp_set_args(ABObj obj, OBJXM_CONFIG_TYPE ctype);
static int list_set_args(ABObj obj, OBJXM_CONFIG_TYPE ctype);
static int menu_set_args(ABObj obj, OBJXM_CONFIG_TYPE ctype);
static int menubar_set_args(ABObj obj, OBJXM_CONFIG_TYPE ctype);
static int textf_set_args(ABObj obj, OBJXM_CONFIG_TYPE ctype);
static int scale_set_args(ABObj obj, OBJXM_CONFIG_TYPE ctype);
static int fchooser_set_args(ABObj obj, OBJXM_CONFIG_TYPE ctype);

/*
 * Post-Instantiation Methods
 */
static int post_set_size(ABObj obj, OBJXM_CONFIG_TYPE ctype);
static int mainwin_post_inst(ABObj obj, OBJXM_CONFIG_TYPE ctype);
static int choice_post_inst(ABObj obj, OBJXM_CONFIG_TYPE ctype);
static int cpanel_post_inst(ABObj obj, OBJXM_CONFIG_TYPE ctype);
static int dialog_post_inst(ABObj obj, OBJXM_CONFIG_TYPE ctype);
static int drawp_post_inst(ABObj obj, OBJXM_CONFIG_TYPE ctype);
static int item_post_inst(ABObj obj, OBJXM_CONFIG_TYPE ctype);
static int list_post_inst(ABObj obj, OBJXM_CONFIG_TYPE ctype);
static int menubar_post_inst(ABObj obj, OBJXM_CONFIG_TYPE ctype);
static int termp_post_inst(ABObj obj, OBJXM_CONFIG_TYPE ctype);
static int fchooser_post_inst(ABObj obj, OBJXM_CONFIG_TYPE ctype);
static void clear_fchooser_fields(Widget widget);

/*
 * General
 */

static ABObj get_menu_ref(ABObj obj);
 ...
 */
int objxm_init(Widget toplevel) {
        if (!init_done) {
                ObjxmP_toplevel = toplevel;
                if (toplevel != NULL)
                        XtVaGetValues(toplevel, XmNdepth, &ObjxmP_visual_depth,
                                      NULL);
 ...
 */
static int xmconfig_window_select_area(ABObj winobj, ABObj parentobj) {
        ...
        obj_set_unique_name(msgobj, ab_ident_from_name_and_label(
                                        obj_get_name(winobj), "status_area"));
        ...
        obj_set_unique_name(modobj,
                            ab_ident_from_name_and_label(obj_get_name(winobj),
                                                         "module_display"));
        obj_set_class_name(modobj, _xmLabel);
        obj_set_attachment(modobj, AB_CP_WEST, AB_ATTACH_GRIDLINE, (void *)0,
                           0);
        obj_set_attachment(modobj, AB_CP_EAST, AB_ATTACH_GRIDLINE, (void *)50,
                           0);
        ...
        obj_set_attachment(selobj, AB_CP_WEST, AB_ATTACH_GRIDLINE, (void *)50,
                           0);
        obj_set_attachment(selobj, AB_CP_EAST, AB_ATTACH_GRIDLINE, (void *)100,
                           0);
...
static int set_window_select_area_args(ABObj obj) {
        ABObj modobj, selobj;
        ABObj msgobj;
        ...
        /* Pane Resources */
        objxm_obj_set_ui_arg(msgobj, AB_ARG_INT, XmNpositionIndex,
                             XmLAST_POSITION);

        /* REMIND: aim - memory leak */
        /* Module-area Resources */
        objxm_obj_set_ui_arg(
            modobj, AB_ARG_XMSTRING, XmNlabelString,
            XmStringCreateLocalized(obj_get_name(obj_get_module(obj))));
        objxm_obj_set_ui_arg(modobj, AB_ARG_BOOLEAN, XmNrecomputeSize, FALSE);
        objxm_obj_set_ui_arg(modobj, AB_ARG_LITERAL, XmNalignment,
        ...
        objxm_obj_set_ui_arg(selobj, AB_ARG_LITERAL, XmNalignment,
                             XmALIGNMENT_END);

        return 0;
}

static int make_pane_fixed_height(ABObj paneobj, ABObj child, int height,
                                  int margin) {
        Dimension hgt;
        ...
        if (child != NULL) {
                if (child->ui_handle != NULL)
                        XtVaGetValues((Widget)child->ui_handle, XmNheight, &hgt,
                                      NULL);
                else
                        return -1;
        } else
...
static int post_inst_window_select_area(ABObj obj) {
        ABObj selobj, msgobj;
 ...
 ************************************************
 */
ABObj objxm_comp_mainwin_get_area(ABObj obj, AB_CONTAINER_TYPE area_type) {
...
static int mainwin_xmconfig(ABObj obj) {
        ...
        obj_set_unique_name(
            pwobj, ab_ident_from_name_and_label(obj_get_name(obj), "panedwin"));
        obj_set_unique_name(
            mwobj, ab_ident_from_name_and_label(obj_get_name(obj), "mainwin"));
        obj_set_unique_name(
            workobj, ab_ident_from_name_and_label(obj_get_name(obj), "form"));
...
static int mainwin_unconfig(ABObj obj) {
        ...
        obj_destroy(
            pwobj); /* destroys PanedWindow,MainWindow & Message SubObjs */
...
static int mainwin_set_args(ABObj obj, OBJXM_CONFIG_TYPE ctype) {
        ...
        if (!cgen_args)
                objxm_obj_set_ui_arg(mwobj, AB_ARG_BOOLEAN, XmNallowResize,
                                     True);

        /* Form WorkArea resources */
        objxm_obj_set_literal_ui_arg(workobj, ctype, XmNresizePolicy,
                                     obj_get_width(obj) == -1 ? XmRESIZE_ANY
                                                              : XmRESIZE_GROW);
...
static int mainwin_post_inst(ABObj obj, OBJXM_CONFIG_TYPE ctype) {
        ...
        if (ctype == OBJXM_CONFIG_BUILD) {
                ...
                XtVaSetValues(objxm_get_widget(mwobj), XmNworkWindow,
                              objxm_get_widget(workobj), NULL);
        } else {
                objxm_obj_set_widget_ui_arg(mwobj, ctype, XmNworkWindow,
                                            workobj);
...
ABObj objxm_comp_custdlg_get_area(ABObj obj, AB_CONTAINER_TYPE area_type) {
...
static int custdlg_xmconfig(ABObj obj) {
        ...
        obj_set_attachment(pwobj, AB_CP_EAST, AB_ATTACH_GRIDLINE, (void *)100,
                           0);
        obj_set_attachment(pwobj, AB_CP_NORTH, AB_ATTACH_GRIDLINE, (void *)0,
                           0);
        obj_set_attachment(pwobj, AB_CP_SOUTH, AB_ATTACH_GRIDLINE, (void *)100,
                           0);
...
static ABObj simple_get_config_obj(ABObj obj, AB_CFG_OBJ_TYPE type) {
        ...
        case AB_CFG_MENU_OBJ:
                ...
                cfg_obj = (obj_get_num_children(obj) > 0)
                              ? obj_get_child(obj, 0)
                              : NULL;
                break;
        case AB_CFG_PARENT_OBJ:
        ...
        default:
                util_dprintf(
                    1, "simple_get_config_obj: unsupported config-type\n");
        }
...
static int choice_xmconfig(ABObj obj) {
        ...
        if (type == AB_CHOICE_OPTION_MENU) {
                ...
                obj_set_unique_name(p_obj, ab_ident_from_name_and_label(
                                               obj_get_name(obj), "menu"));
        }

        if (lbl_obj) /* Has Label */
        {
                obj_append_child(obj, lbl_obj);
                obj_set_unique_name(lbl_obj, ab_ident_from_name_and_label(
                                                 obj_get_name(obj), "label"));

                obj_append_child(obj, ch_obj);
                obj_set_unique_name(ch_obj, ab_ident_from_name_and_label(
                                                obj_get_name(obj), "choice"));
        }
        return OK;
}
static int choice_unconfig(ABObj obj) {
...
static ABObj choice_get_config_obj(ABObj obj, AB_CFG_OBJ_TYPE type) {
        ...
        case AB_CFG_SIZE_OBJ:
                if (has_label)
                        cfg_obj = obj_get_child(
                            obj, choice_type == AB_CHOICE_OPTION_MENU ? 2 : 1);
                else
                        cfg_obj = obj;
                break;
        case AB_CFG_PARENT_OBJ:
        ...
        case AB_CFG_LABEL_OBJ:
                if (has_label)
                        cfg_obj = obj_get_child(
                            obj, choice_type == AB_CHOICE_OPTION_MENU ? 1 : 0);
                else
                        cfg_obj = NULL;
                break;
        case AB_CFG_POSITION_OBJ:
        ...
        default:
                util_dprintf(
                    1, "choice_get_config_obj: unsupported config-type\n");
        }
...
static int choice_set_args(ABObj obj, OBJXM_CONFIG_TYPE ctype) {
        ...
        if ((type = (AB_CHOICE_TYPE)obj_get_subtype(obj)) !=
            AB_CHOICE_OPTION_MENU) {
                orient = obj_get_orientation(obj);

                switch (orient) {
                case AB_ORIENT_HORIZONTAL:
                        objxm_obj_set_literal_ui_arg(
                            ch_obj, ctype, XmNorientation, XmHORIZONTAL);
                        if (obj_get_num_columns(obj) > 1) {
                                objxm_obj_set_literal_ui_arg(
                                    xy_obj, ctype, XmNentryVerticalAlignment,
                ...
                case AB_ORIENT_VERTICAL:
                        objxm_obj_set_literal_ui_arg(
                            ch_obj, ctype, XmNorientation, XmVERTICAL);
                        objxm_obj_set_literal_ui_arg(
                            xy_obj, ctype, XmNentryVerticalAlignment,
                            XmALIGNMENT_BASELINE_BOTTOM);
                        if (lbl_obj)
                                objxm_obj_set_ui_arg(lbl_obj, AB_ARG_INT,
                                                     XmNmarginHeight, 8);
                        break;
                }
                if (obj_get_num_columns(obj) > 1)
                        objxm_obj_set_literal_ui_arg(ch_obj, ctype, XmNpacking,
                                                     XmPACK_COLUMN);
                else
                        objxm_obj_set_literal_ui_arg(ch_obj, ctype, XmNpacking,
                                                     XmPACK_TIGHT);
                objxm_obj_set_literal_ui_arg(ch_obj, ctype, XmNrowColumnType,
                                             XmWORK_AREA);
                objxm_obj_set_ui_arg(ch_obj, AB_ARG_INT, XmNspacing, 0);
                objxm_obj_set_ui_arg(ch_obj, AB_ARG_BOOLEAN, XmNisHomogeneous,
                                     TRUE);
                objxm_obj_set_ui_arg(ch_obj, AB_ARG_INT, XmNnumColumns,
                                     obj_get_num_columns(obj));
                objxm_obj_set_ui_arg(ch_obj, AB_ARG_INT, XmNentryClass,
                                     xmToggleButtonWidgetClass);
                objxm_obj_set_ui_arg(ch_obj, AB_ARG_BOOLEAN, XmNradioBehavior,
                                     type == AB_CHOICE_EXCLUSIVE ? TRUE
                                                                 : FALSE);
        } else /* AB_CHOICE_OPTION_MENU */
        {
                ...
                objxm_obj_set_literal_ui_arg(ch_obj, ctype, XmNrowColumnType,
                                             XmMENU_OPTION);
                objxm_obj_set_literal_ui_arg(p_obj, ctype, XmNrowColumnType,
                                             XmMENU_PULLDOWN);
        }
        return 0;
}
...
static int cpanel_set_args(ABObj obj, OBJXM_CONFIG_TYPE ctype) {
        ...
        case AB_CONT_BUTTON_PANEL:
                margin = 7;
                /*
                            objxm_obj_set_ui_arg(xy_obj, AB_ARG_INT,
                   XmNpositionIndex, 1);
                */
                break;
        case AB_CONT_FOOTER:
                ...
                if (obj_is_popup_win(parent)) {
                        if (objxm_comp_custdlg_get_area(
                                parent, AB_CONT_BUTTON_PANEL) != NULL)
                                objxm_obj_set_ui_arg(xy_obj, AB_ARG_INT,
                                                     XmNpositionIndex, 2);
                        else
                                objxm_obj_set_ui_arg(xy_obj, AB_ARG_INT,
        ...
        /*
           ...
           XmRESIZE_GROW);
        */
        /* For standard ControlPane's with Resize Policy of "Fit Contents", we
         * want to use XmRESIZE_ANY, all other cases we want to use
         * XmRESIZE_GROW to ensure they don't snap to a zero size if they have
         * no children (because there is no way to get it back!).  Only standard
         * ControlPanes can have a height == -1.
         */
        objxm_obj_set_literal_ui_arg(cp_obj, ctype, XmNresizePolicy,
                                     obj_get_height(obj) == -1 ? XmRESIZE_ANY
                                                               : XmRESIZE_GROW);
...
static int cpanel_post_inst(ABObj obj, OBJXM_CONFIG_TYPE ctype) {
        ...
        case AB_CONT_BUTTON_PANEL:
                if (obj_is_base_win(obj_get_root(obj_get_parent(obj)))) {
                        ...
                        if (ctype == OBJXM_CONFIG_BUILD) {
                                /* Area must be Managed before MainWindow
                                 * resource gets set */
                                ...
                                objxm_obj_set_widget_ui_arg(
                                    mwobj, ctype, XmNmessageWindow, obj);
                                obj_set_flag(mwobj, AttrChangedFlag);
                        }
                } else {
                        height = obj_get_height(obj);

                        /* If a height is specified for the pane, use that
                         * value, else pass in the object responsible for the
                         * size of the pane and let the routine query its
                         * widget's size.
                         */
                        make_pane_fixed_height(
                            obj,
                            height == -1
                                ? objxm_comp_get_subobj(obj, AB_CFG_SIZE_OBJ)
                                : NULL,
                            height, 0);
                }
                break;
        case AB_CONT_TOOL_BAR:
                ...
                if (ctype == OBJXM_CONFIG_BUILD) {
                        /* Area must be Managed before MainWindow resource gets
                         * set */
                        XtManageChild(objxm_get_widget(obj));
                        util_dprintf(3, "MANAGING %s\n", obj_get_name(obj));
                        XtVaSetValues(objxm_get_widget(mwobj), XmNcommandWindow,
                                      objxm_get_widget(obj),
                                      XmNcommandWindowLocation,
                                      XmCOMMAND_ABOVE_WORKSPACE, NULL);
                } else {
                        objxm_obj_set_widget_ui_arg(mwobj, ctype,
                                                    XmNcommandWindow, obj);
                        objxm_obj_set_literal_ui_arg(mwobj, ctype,
                                                     XmNcommandWindowLocation,
...
static int layer_unconfig(ABObj obj) { return OK; }
...
static int group_set_args(ABObj obj, OBJXM_CONFIG_TYPE ctype) {
        ...
        objxm_obj_set_literal_ui_arg(g_obj, ctype, XmNresizePolicy,
                                     XmRESIZE_ANY);
        ...
        if (util_streq(obj_get_class_name(g_obj), _xmRowColumn)) {
                ...
                case AB_PACK_NONE:
                        objxm_obj_set_literal_ui_arg(g_obj, ctype, XmNpacking,
                                                     XmPACK_NONE);
                        break;
                case AB_PACK_TIGHT:
                        objxm_obj_set_literal_ui_arg(g_obj, ctype, XmNpacking,
                ...
                case AB_GROUP_COLUMNS:
                        objxm_obj_set_literal_ui_arg(
                            g_obj, ctype, XmNorientation, XmVERTICAL);
                        break;
                case AB_GROUP_ROWS:
                        objxm_obj_set_literal_ui_arg(
                            g_obj, ctype, XmNorientation, XmHORIZONTAL);
                        break;
                }
        }
        return 0;
...
static int item_xmconfig(ABObj obj) {
        ...
        case AB_ITEM_FOR_MENU:
                obj_set_class_name(obj, obj_has_menu(obj) ? _xmCascadeButton
                                                          : _xmPushButton);
                break;
...
static int item_set_args(ABObj obj, OBJXM_CONFIG_TYPE ctype) {
        ...
        if (obj_is_choice_item(obj)) {
                ...
                if (vobj->info.choice.type == AB_CHOICE_EXCLUSIVE)
                        objxm_obj_set_literal_ui_arg(
                            i_obj, ctype, XmNindicatorType, XmONE_OF_MANY);
                else if (vobj->info.choice.type == AB_CHOICE_NONEXCLUSIVE)
                        objxm_obj_set_literal_ui_arg(
                            i_obj, ctype, XmNindicatorType, XmN_OF_MANY);
        ...
        if ((mnemonic = obj_get_mnemonic(obj)) != NULL) {
                objxm_obj_set_ui_arg(i_obj, AB_ARG_MNEMONIC, XmNmnemonic,
                                     ctype == OBJXM_CONFIG_BUILD
                                         ? (XtArgVal)XStringToKeysym(mnemonic)
                                         : (XtArgVal)istr_create(mnemonic));
        }
        if ((accel = obj_get_accelerator(obj)) != NULL) {
                acceltext = objxm_accel_to_acceltext(accel);

                objxm_obj_set_ui_arg(i_obj, AB_ARG_STRING, XmNaccelerator,
                                     accel);
                objxm_obj_set_ui_arg(
                    i_obj, AB_ARG_XMSTRING, XmNacceleratorText,
                    ctype == OBJXM_CONFIG_BUILD
                        ? (XtArgVal)XmStringCreateLocalized(acceltext)
...
static int pane_xmconfig(ABObj obj) {
        ...
        if (obj_has_hscrollbar(obj) || obj_has_vscrollbar(obj)) {
                ...
                pane_obj =
                    objxmP_create_direct_subobj(root_obj, obj->type, "pane");
                ...
                if (obj_is_term_pane(obj)) {
                        ...
                        obj_set_unique_name(
                            sbobj, ab_ident_from_name_and_label(
                                       obj_get_name(obj), "vscrollbar"));
                }
        } else /* No Scrolling */
                pane_obj = root_obj;
...
static ABObj pane_get_config_obj(ABObj obj, AB_CFG_OBJ_TYPE type) {
        ...
        case AB_CFG_DND_OBJ:
        case AB_CFG_PARENT_OBJ:
                if (obj_is_text_pane(obj) || obj_is_term_pane(obj))
                        cfg_obj = NULL;
                else
                        cfg_obj = pane_obj;
                break;
        case AB_CFG_SCROLLBAR_OBJ:
                if (obj_is_term_pane(obj) && sb_obj)
                        cfg_obj =
                            obj_get_child(sb_obj, b_obj ? 1 : (mr_obj ? 2 : 1));
                break;
        case AB_CFG_MENU_OBJ:
                cfg_obj = mr_obj;
                break;
...
static int drawp_set_args(ABObj obj, OBJXM_CONFIG_TYPE ctype) {
        ...
        if (obj_has_vscrollbar(obj) || obj_has_hscrollbar(obj)) {
                ...
                objxm_obj_set_literal_ui_arg(sw_obj, ctype, XmNscrollingPolicy,
                                             XmAUTOMATIC);
                ...
                if (obj_get_vscrollbar_policy(obj) == AB_SCROLLBAR_ALWAYS ||
                    obj_get_hscrollbar_policy(obj) == AB_SCROLLBAR_ALWAYS)
                        objxm_obj_set_literal_ui_arg(
                            sw_obj, ctype, XmNscrollBarDisplayPolicy, XmSTATIC);
                else
                        objxm_obj_set_literal_ui_arg(sw_obj, ctype,
                                                     XmNscrollBarDisplayPolicy,
                                                     XmAS_NEEDED);

                /* This sets the TOTAL width/height of the DrawArea (not
                 * necessarily the 'visible' portion)
                 */
                objxm_obj_set_ui_arg(da_obj, AB_ARG_INT, XmNwidth,
                                     obj_get_drawarea_width(obj));
                objxm_obj_set_ui_arg(da_obj, AB_ARG_INT, XmNheight,
                                     obj_get_drawarea_height(obj));
        }
...
static int termp_set_args(ABObj obj, OBJXM_CONFIG_TYPE ctype) {
        ...
        if ((pstr = obj_get_process_string(obj)) != NULL)
                objxm_obj_set_ui_arg(tp_obj, AB_ARG_STRING, DtNsubprocessCmd,
                                     pstr);
        ...
        if (obj_has_vscrollbar(obj)) {
                ...
                objxm_obj_set_literal_ui_arg(sb_obj, ctype, XmNorientation,
                                             XmVERTICAL);
        }
...
static int termp_post_inst(ABObj obj, OBJXM_CONFIG_TYPE ctype) {
        ABObj paneObj = (ABObj)NULL, sbObj = (ABObj)NULL;

        /* If Scrollable TermPane, hook up vertical scrollbar to Term widget */
        if (obj_has_vscrollbar(obj)) {
                sbObj = objxm_comp_get_subobj(obj_get_root(obj),
                                              AB_CFG_SCROLLBAR_OBJ);
                paneObj =
                    objxm_comp_get_subobj(obj_get_root(obj), AB_CFG_OBJECT_OBJ);

                objxm_obj_set_widget_ui_arg(paneObj, ctype,
                                            DtNverticalScrollBar, sbObj);
...
static int textp_set_args(ABObj obj, OBJXM_CONFIG_TYPE ctype) {
        ...
        if (obj_has_vscrollbar(obj)) {
                ...
                objxm_obj_set_ui_arg(tx_obj, AB_ARG_BOOLEAN,
                                     XmNscrollHorizontal,
                ...
                objxm_obj_set_literal_ui_arg(sw_obj, ctype, XmNscrollingPolicy,
                                             XmAPPLICATION_DEFINED);
                objxm_obj_set_literal_ui_arg(sw_obj, ctype, XmNvisualPolicy,
                                             XmVARIABLE);
                objxm_obj_set_literal_ui_arg(
                    sw_obj, ctype, XmNscrollBarDisplayPolicy, XmSTATIC);

                objxm_obj_set_literal_ui_arg(sw_obj, ctype, XmNwidth,
                                             obj_get_textpane_height(sw_obj));
                objxm_obj_set_literal_ui_arg(sw_obj, ctype, XmNheight,
                                             obj_get_textpane_width(sw_obj));
        }

        objxm_obj_set_literal_ui_arg(tx_obj, ctype, XmNeditMode,
                                     XmMULTI_LINE_EDIT);
        objxm_obj_set_ui_arg(tx_obj, AB_ARG_BOOLEAN, XmNwordWrap,
                             obj->info.text.word_wrap);
        ...
        if ((strval = obj_get_initial_value_string(obj)) != NULL)
            ...
            if (ctype == OBJXM_CONFIG_BUILD)
                objxm_obj_set_ui_arg(tx_obj, AB_ARG_STRING, XmNvalue,
                                     Util_empty_string);
...
static int list_xmconfig(ABObj obj) {
        ...
        if (lbl_obj != NULL) {
                ...
                obj_set_unique_name(
                    sw_obj, ab_ident_from_name_and_label(obj_get_name(obj),
                                                         "scrolledwin"));
        }
        obj_append_child(sw_obj, l_obj);
        obj_set_unique_name(
            l_obj, ab_ident_from_name_and_label(obj_get_name(obj), "list"));
...
static int list_set_args(ABObj obj, OBJXM_CONFIG_TYPE ctype) {
        ...
        if ((rows = obj_get_num_rows(obj)) != -1) {
                objxm_obj_set_ui_arg(l_obj, AB_ARG_INT, XmNvisibleItemCount,
                                     rows);
 ...
 ***********************
 */
static int menu_xmconfig(ABObj obj) { return OK; }

static int menu_unconfig(ABObj obj) { return OK; }
...
static int menubar_set_args(ABObj obj, OBJXM_CONFIG_TYPE ctype) {
        ...
        objxm_obj_set_literal_ui_arg(mb_obj, ctype, XmNrowColumnType,
                                     XmMENU_BAR);
...
static int menubar_post_inst(ABObj obj, OBJXM_CONFIG_TYPE ctype) {
        ...
        if (ctype == OBJXM_CONFIG_BUILD) {
                ...
                XtManageChild(objxm_get_widget(obj));
                util_dprintf(3, "MANAGING %s\n", obj_get_name(obj));
                XtVaSetValues(objxm_get_widget(mwobj), XmNmenuBar,
                              objxm_get_widget(obj), NULL);
        } else {
        ...
        if ((help_item = obj_get_menubar_help_item(obj)) != NULL) {
                objxm_obj_set_widget_ui_arg(obj, ctype, XmNmenuHelpWidget,
                                            help_item);
                obj_set_flag(obj, AttrChangedFlag);
        }
        return 0;
 ...
 */
static int textf_xmconfig(ABObj obj) {
        objxm_comp_config_labeled_obj(obj, AB_TYPE_TEXT_FIELD, "field",
                                      _xmTextField);
...
static int textf_set_args(ABObj obj, OBJXM_CONFIG_TYPE ctype) {
        ...
        if ((valstr = obj_get_initial_value_string(obj)) != NULL)
            ...
            if (ctype == OBJXM_CONFIG_BUILD)
                objxm_obj_set_ui_arg(tf_obj, AB_ARG_STRING, XmNvalue,
                                     Util_empty_string);
 ...
 */
static int spin_box_xmconfig(ABObj obj) {
        objxm_comp_config_labeled_obj(obj, AB_TYPE_SPIN_BOX, "field",
                                      _dtSpinBox);
...
static ABObj spin_box_get_config_obj(ABObj obj, AB_CFG_OBJ_TYPE type) {
        ...
        default:
                util_dprintf(
                    1, "spin_box_get_config_obj: unsupported config-type\n");
        }
        return (cfg_obj);
}
...
static int spin_box_set_args(ABObj obj, OBJXM_CONFIG_TYPE ctype) {
        ...
        /* SpinBox Type */
        objxm_obj_set_literal_ui_arg(
            sb_obj, ctype, DtNspinBoxChildType,
        ...
        {
                /* Set Initially Selected Item - can only do this for generated
                 * code because in Build mode, the items might not be created
                 * yet!
                 */
                num_items = obj_get_num_items(obj);
                for (i = 0; i < num_items; i++)
                        if (obj_is_initially_selected(obj_get_item(obj, i))) {
                                objxm_obj_set_ui_arg(sb_obj, AB_ARG_INT,
                                                     DtNposition, i);
                                break;
                        }
        }
 ...
 */
static int combo_box_xmconfig(ABObj obj) {
        objxm_comp_config_labeled_obj(obj, AB_TYPE_COMBO_BOX, "field",
                                      _dtComboBox);
...
static ABObj combo_box_get_config_obj(ABObj obj, AB_CFG_OBJ_TYPE type) {
        ...
        default:
                util_dprintf(
                    1, "combo_box_get_config_obj: unsupported config-type\n");
        }
...
static int scale_set_args(ABObj obj, OBJXM_CONFIG_TYPE ctype) {
        ...
        /* Value Range */
        objxm_obj_set_ui_arg(o_obj, AB_ARG_INT, XmNminimum,
                             obj_get_min_value(obj));
        objxm_obj_set_ui_arg(o_obj, AB_ARG_INT, XmNmaximum,
                             obj_get_max_value(obj));
...
static int fchooser_xmconfig(ABObj obj) {
        ...
        obj_set_unique_name(
            pwobj, ab_ident_from_name_and_label(obj_get_name(obj), "panedwin"));
        obj_set_unique_name(
            workobj, ab_ident_from_name_and_label(obj_get_name(obj), "fsb"));
...
static ABObj box_get_config_obj(ABObj obj, AB_CFG_OBJ_TYPE type) {
        ...
        case AB_CFG_SELECT_OBJ: {
                ...
                if (type == AB_CFG_SIZE_OBJ)
                        ...
                        num_children = obj_get_num_children(pwobj);
                        /* Search through immediate children of the
                         * Shell-container and find the WorkArea & Status
                         * SubObjs if they exist
                         */
                        for (i = 0; i < num_children; i++) {
                                childobj = obj_get_child(pwobj, i);
                                if (obj_is_label(childobj) &&
                                    childobj->part_of == obj) {
                                        msgobj = childobj;
                                        modobj = obj_get_child(msgobj, 0);
                                        selobj = obj_get_child(msgobj, 1);
                                }
        ...
        default:
                if (util_get_verbosity() > 0)
                        fprintf(
                            stderr,
                            "box_get_config_obj: unsupported config-type\n");
                cfg_obj = NULL;
        }
...
static int fchooser_set_args(ABObj obj, OBJXM_CONFIG_TYPE ctype) {
        ...
        objxm_obj_set_ui_arg(lbl_obj, AB_ARG_BOOLEAN, XmNallowShellResize,
                             TRUE);
        ...
        if (!util_strempty(str)) {
                if (cgen_args)
                        ...
                        valstr =
                            (XtArgVal)objxm_str_to_xmstr(ObjxmP_toplevel, str);
                objxm_obj_set_ui_arg(fsb_obj, AB_ARG_XMSTRING, XmNpattern,
                                     valstr);
        }
        ...
        if (!util_strempty(str)) {
                if (cgen_args)
                        ...
                        valstr =
                            (XtArgVal)objxm_str_to_xmstr(ObjxmP_toplevel, str);
                objxm_obj_set_ui_arg(fsb_obj, AB_ARG_XMSTRING, XmNdirectory,
                                     valstr);
        }
        ...
        if (!util_strempty(str)) {
                if (cgen_args)
                        ...
                        valstr =
                            (XtArgVal)objxm_str_to_xmstr(ObjxmP_toplevel, str);
                objxm_obj_set_ui_arg(fsb_obj, AB_ARG_XMSTRING, XmNokLabelString,
                                     valstr);
        }

        objxm_obj_set_ui_arg(fsb_obj, AB_ARG_BOOLEAN, XmNautoUnmanage,
                             obj_get_auto_dismiss(obj) ? TRUE : FALSE);
...
static int fchooser_post_inst(ABObj obj, OBJXM_CONFIG_TYPE ctype) {
        Widget dir_list = NULL, files_list = NULL, fselnbox = NULL;
        ABObj fsb_obj = objxm_comp_get_subobj(obj, AB_CFG_OBJECT_OBJ);
        ...
        if (ctype == OBJXM_CONFIG_BUILD) {
                ...
                dir_list =
                    XmFileSelectionBoxGetChild(fselnbox, XmDIALOG_DIR_LIST);
                if (dir_list)
                        XmListDeleteAllItems(dir_list);

                files_list =
                    XmFileSelectionBoxGetChild(fselnbox, XmDIALOG_LIST);
                if (files_list)
...
static void clear_fchooser_fields(Widget widget) {
        ...
        XtVaGetValues(widget, XmNnumChildren, &numChild, XmNchildren, &children,
                      NULL);
...
static ABObj panedwin_get_config_obj(ABObj obj, AB_CFG_OBJ_TYPE type) {
        ...
        default:
                util_dprintf(
                    1, "panedwin_get_config_obj: unsupported config-type\n");
        }
