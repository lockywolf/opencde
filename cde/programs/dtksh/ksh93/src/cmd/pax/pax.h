...
extern __MANGLE__ int listprintf __PROTO__((Sfio_t *, Archive_t *, File_t *,
                                            const char *));
...
extern __MANGLE__ unsigned long omemsum __PROTO__((const __V_ *, int,
                                                   unsigned long));
extern __MANGLE__ int openin __PROTO__((Archive_t *, File_t *));
extern __MANGLE__ int openout __PROTO__((Archive_t *, File_t *));
extern __MANGLE__ int paxdelta __PROTO__((Archive_t *, Archive_t *, File_t *,
                                          int, ...));
...
extern __MANGLE__ int setoption __PROTO__((__V_ *, const __V_ *, int,
                                           const char *));
