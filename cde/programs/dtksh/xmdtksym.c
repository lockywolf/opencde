...
struct symarray Symarray[] = {
    ...
    {"do_XmCreateFileSelectionBox",
     (unsigned long)&do_XmCreateFileSelectionBox},
    {"do_XmCreateFileSelectionDialog",
     (unsigned long)&do_XmCreateFileSelectionDialog},
    ...
    {"do_XmCreateInformationDialog",
     (unsigned long)&do_XmCreateInformationDialog},
    ...
    {"do_XmListAddItemsUnselected",
     (unsigned long)&do_XmListAddItemsUnselected},
    ...
    {"do_XmListReplaceItemsPosUnselected",
     (unsigned long)&do_XmListReplaceItemsPosUnselected},
    ...
    {"do_XmListUpdateSelectedList",
     (unsigned long)&do_XmListUpdateSelectedList},
    ...
    {"do_XmCreatePushButtonGadget",
     (unsigned long)&do_XmCreatePushButtonGadget},
    ...
    {"do_XmCreateToggleButtonGadget",
     (unsigned long)&do_XmCreateToggleButtonGadget},
    ...
    {"do_XmFileSelectionBoxGetChild",
     (unsigned long)&do_XmFileSelectionBoxGetChild},
    ...
    {"do_XmRemoveWMProtocolCallback",
     (unsigned long)&do_XmRemoveWMProtocolCallback},
    ...
    {"do_XmTextGetInsertionPosition",
     (unsigned long)&do_XmTextGetInsertionPosition},
    ...
    {"do_XmTextGetSelectionPosition",
     (unsigned long)&do_XmTextGetSelectionPosition},
    ...
    {"do_XmTextSetInsertionPosition",
     (unsigned long)&do_XmTextSetInsertionPosition},
    ...
    {"do_XtCreateApplicationShell",
     (unsigned long)&do_XtCreateApplicationShell},
    ...
    {"do_XtLastTimestampProcessed",
     (unsigned long)&do_XtLastTimestampProcessed},
    ...
    {"do_DtWsmAddWorkspaceFunctions",
     (unsigned long)&do_DtWsmAddWorkspaceFunctions},
    {"do_DtWsmRemoveWorkspaceFunctions",
     (unsigned long)&do_DtWsmRemoveWorkspaceFunctions},
    {"do_DtWsmGetCurrentWorkspace",
     (unsigned long)&do_DtWsmGetCurrentWorkspace},
    {"do_DtWsmSetCurrentWorkspace",
     (unsigned long)&do_DtWsmSetCurrentWorkspace},
    {"do_DtWsmGetWorkspaceList", (unsigned long)&do_DtWsmGetWorkspaceList},
    {"do_DtWsmGetWorkspacesOccupied",
     (unsigned long)&do_DtWsmGetWorkspacesOccupied},
    {"do_DtWsmSetWorkspacesOccupied",
     (unsigned long)&do_DtWsmSetWorkspacesOccupied},
    {"do_DtWsmGetCurrentBackdropWindow",
     (unsigned long)&do_DtWsmGetCurrentBackdropWindow},
    {"do_DtWsmOccupyAllWorkspaces",
     (unsigned long)&do_DtWsmOccupyAllWorkspaces},
    ...
    {"do_DtWsmAddCurrentWorkspaceCallback",
     (unsigned long)&do_DtWsmAddCurrentWorkspaceCallback},
    {"do_DtWsmRemoveWorkspaceCallback",
     (unsigned long)&do_DtWsmRemoveWorkspaceCallback},
    ...
    {"do_DtDtsFileToAttributeValue",
     (unsigned long)&do_DtDtsFileToAttributeValue},
    {"do_DtDtsFileToAttributeList",
     (unsigned long)&do_DtDtsFileToAttributeList},
    {"do_DtDtsDataTypeToAttributeValue",
     (unsigned long)&do_DtDtsDataTypeToAttributeValue},
    {"do_DtDtsDataTypeToAttributeList",
     (unsigned long)&do_DtDtsDataTypeToAttributeList},
