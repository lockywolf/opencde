...
static void PendingDestroy(Widget w, wtab_t *wtab, caddr_t callData);
static Boolean WtabDestroy(caddr_t callData);
static int _CreateWidget(Widget (*func)(), int argc, char *argv[]);
static int _DTKSH_XtDestroyWidget(Widget w);
static int do_single_widget_arg_func(int (*func)(), int argc, char **argv);
static void mainloopsighandler(int sig);
static int XtCallCallbacks_usage(char *arg0);
static void RegisterCmdStr(char type, long id, char *cmd);
static void RemoveCmdStr(char type, long id);
static int do_RootWindowCmd(int (*func)(), int argc, char *argv[]);
static int cvtfontstruct(char *name, XFontStruct **fn);
static int CatchNonFatalFontError(Display *display, XErrorEvent *event);
static int cvtfont(Display *display, char *name, Font *fn);
static int cvtcolor(char *name, Pixel *pix);
static int invokeXDrawFunction(int function, int argc, char *argv[]);
static int XtAddInputUsage(char *arg0);
static void DestroyInputRecord(XtInputId id);
static int FindInputRecord(XtInputId id);
static Boolean ProcessInput(inputrec_t *inp, int source, XtInputId id,
                            Boolean eofFound);
static int VerifyString_usage(char *arg0);
static int XtSetSensitive_usage(char *arg0);
static int GetDisplayHandle(int argc, char **argv, Widget (*func)());
static int RegisterTranslations(void (*func)(), int argc, char *argv[]);
static int LocateEHRecord(wtab_t *w, char *ksh_cmd);
static int GetWorkspaceList(char *usageMsg, Boolean getOccupied, int argc,
                            char *argv[]);
static int DtTurnOnOrOffHourGlass(void (*func)(), int argc, char *argv[]);
static int WsmCommonProc(int argc, char *argv[], void (*func)());
static int ttdt_SaveOrRevert(Tt_status (*func)(), int argc, char *argv[]);
static int message_DestroyOrReply(Tt_status (*func)(), int argc, char *argv[]);
static int message_FailOrReject(Tt_status (*func)(), int argc, char *argv[]);
static Tt_message TtFileCB(Tt_message msg, Tttk_op op, char *pathName,
                           void *clientData, int sameEuidEgid, int sameProcId);
static int tt_netfile_handler(int paramCount, char *(*func)(), char *usageMsg,
                              int argc, char *argv[]);
static Namval_t *CreateEmptyNameValuePair(Namval_t *np, char *name,
                                          Namfun_t *fp);
static Namval_t *ProcessIntValue(int value, Namval_t *np, char *name,
                                 Namfun_t *fp, char *format, Namfun_t *fp_new);
static Namval_t *ProcessStringValue(char *value, Namval_t *np, char *name,
                                    Namfun_t *fp);
static Namval_t *ProcessBooleanIntValue(int value, Namval_t *np, char *name,
                                        Namfun_t *fp, Namfun_t *fp_new);
static Namval_t *ProcessTraversalDirection(XmTraversalDirection dir,
                                           Namval_t *np, char *name,
                                           Namfun_t *fp);
static Namval_t *ProcessSelectionType(char selType, Namval_t *np, char *name,
                                      Namfun_t *fp);
static Namval_t *ProcessIntTable(int *table, int count, Namval_t *np,
                                 char *name, Namfun_t *fp);
static Namval_t *ProcessXmStringTable(XmString *table, int count, Namval_t *np,
                                      char *name, Namfun_t *fp);
static Namval_t *ProcessWidgetHandle(Widget handle, Namval_t *np, char *name,
                                     Namfun_t *fp);
static Namval_t *ProcessXmStringValue(XmString xmstring, Namval_t *np,
                                      char *name, Namfun_t *fp);
static Namval_t *ProcessHyperType(int hyperType, Namval_t *np, char *name,
                                  Namfun_t *fp);
static void InitEventTables(void);
static Namval_t *ProcessCallbackEvent(XEvent *event, Namval_t *np, char *name,
                                      Namfun_t *fp);
static Namval_t *_IntProcessCallbackReason(struct named_integer *table,
                                           XmAnyCallbackStruct *cbData,
                                           Namval_t *np, char *name,
                                           Namfun_t *fp);
static Namval_t *ProcessCallbackReason(XmAnyCallbackStruct *cbData,
                                       Namval_t *np, char *name, Namfun_t *fp);
static Namval_t *ProcessHelpCallbackReason(XmAnyCallbackStruct *cbData,
                                           Namval_t *np, char *name,
                                           Namfun_t *fp);
static void _DtActionInvokeUsage(void);
static void DtkReloadHandler(XtPointer clientData);
static Namfun_t *CloneDiscipline(Namdisc_t *discipline);
static void FreeDiscipline(Namfun_t *discipline);
static Namdisc_t *CheckClassDisciplines(WidgetClass class, char *cbname);
void SetTextDoit(Namval_t *np, char *name, Namfun_t *fp);
void SetTextStartPos(Namval_t *np, char *name, Namfun_t *fp);
void SetTextEndPos(Namval_t *np, char *name, Namfun_t *fp);
void SetTextPtr(Namval_t *np, char *name, Namfun_t *fp);
void SetTextLen(Namval_t *np, char *name, Namfun_t *fp);
void SetTextFormat(Namval_t *np, char *name, Namfun_t *fp);
void SetTextWCSptr(Namval_t *np, char *name, Namfun_t *fp);
void SetTextWCSlen(Namval_t *np, char *name, Namfun_t *fp);
...
static Namdisc_t transDiscipline = {
    0, NULL, NULL, NULL, NULL, (Namval_t * (*)()) transCreateDisc, NULL, NULL};
static Namdisc_t ehDiscipline = {
    0, NULL, NULL, NULL, NULL, (Namval_t * (*)()) ehCreateDisc, NULL, NULL};
static Namdisc_t dftDiscipline = {
    0, NULL, NULL, NULL, NULL, (Namval_t * (*)()) dftCreateDisc, NULL, NULL};
static Namdisc_t nopDiscipline = {
    0, NULL, NULL, NULL, NULL, (Namval_t * (*)()) nopCreateDisc, NULL, NULL};

static Namdisc_t text_doit_disc = {
    0, (void (*)())SetTextDoit, NULL, NULL, NULL, NULL, NULL, NULL};
static Namdisc_t text_startpos_disc = {
    0, (void (*)())SetTextStartPos, NULL, NULL, NULL, NULL, NULL, NULL};
static Namdisc_t text_endpos_disc = {
    0, (void (*)())SetTextEndPos, NULL, NULL, NULL, NULL, NULL, NULL};
static Namdisc_t text_ptr_disc = {
    0, (void (*)())SetTextPtr, NULL, NULL, NULL, NULL, NULL, NULL};
static Namdisc_t text_len_disc = {
    0, (void (*)())SetTextLen, NULL, NULL, NULL, NULL, NULL, NULL};
static Namdisc_t text_format_disc = {
    0, (void (*)())SetTextFormat, NULL, NULL, NULL, NULL, NULL, NULL};
static Namdisc_t text_wcsptr_disc = {
    0, (void (*)())SetTextWCSptr, NULL, NULL, NULL, NULL, NULL, NULL};
static Namdisc_t text_wcslen_disc = {
    0, (void (*)())SetTextWCSlen, NULL, NULL, NULL, NULL, NULL, NULL};

static const XtActionsRec Ksh_actions[] = {{"ksh_eval", Translation_ksh_eval}};
...
static Boolean WtabDestroy(caddr_t callData) {
        ...
        for (i = 0; i < NumW; i++) {
                if ((W[i]->type == TAB_WIDGET) &&
                    (W[i]->mask & DT_PENDING_DESTROY)) {
                        XtFree(W[i]->wname);
                        XtFree(W[i]->widid);
                        if (W[i]->envar) {
                                ...
                                /*
                                 * Blank out the environment variable holding
                                 * the widget handle, but only if it still holds
                                 * the handle!  This guards against the
                                 * possibility that the user has re-used the
                                 * same variable for another widget later.
                                 */
                                if (val && W[i]->widid &&
                                    strcmp(val, W[i]->widid) == 0) {
                                        env_blank(W[i]->envar);
                                }
                                XtFree(W[i]->envar);
                        }
...
wtab_t *set_up_w(Widget wid, wtab_t *parent, char *var, char *name,
                 classtab_t *class) {
        char widid[8];
        static wtab_t *w;
...
void parse_args(char *arg0, int argc, char **argv, wtab_t *w, wtab_t *parent,
                classtab_t *class, int *n, Arg *args, int *pargc, char **pargv,
        ...
        for (i = 0; i < argc; i++) {
                if (i >= MAXARGS) {
                        errmsg = strdup(GETMESSAGE(5, 1,
                                                   ...
                                                   "specified; skipping '%s'"));
                        printerrf(arg0, errmsg, argv[*n], NULL, NULL, NULL,
                                  NULL, NULL, NULL, NULL);
                        free(errmsg);
                        continue;
                }
                if ((colon = strchr(argv[i], ':')) == NULL) {
                        errmsg = strdup(GETMESSAGE(
                            5, 2,
                            "Bad resource specification; should be of the "
                            "form 'name:value' : %s"));
                        printerrf(arg0, errmsg, argv[i], NULL, NULL, NULL, NULL,
                                  NULL, NULL, NULL);
                        free(errmsg);
                        continue;
                }
                ...
                if ((conversionResult = ConvertStringToType(
                         arg0, w, parent, class, resource, val, &argval,
                         &freeflag, postponePixmaps)) == CONVERT_SUCCEEDED) {
...
int do_XtInitialize(int argc, char *argv[]) {
        int ret;
        char *dtkdb_hook;
        char *errmsg;
        int *lockedFds;
        ...
        if (Toplevel != NULL) {
                errmsg = strdup(GETMESSAGE(
                    5, 4, "The toolkit has already been initialized"));
        ...
        if (argc < 4) {
                errmsg = strdup(
                    GETMESSAGE(5, 5,
                               "Usage: XtInitialize variable applicationName "
...
static int _CreateWidget(Widget (*func)(), int argc, char *argv[]) {
        ...
        if (widget != NULL) {
                ...
                printerrf(argv[0], errmsg, wname, NULL, NULL, NULL, NULL, NULL,
                          NULL, NULL);
                free(errmsg);
                env_blank(argv[1]);
        }
...
int do_XtCreateApplicationShell(int argc, char *argv[]) {
        Widget widget;
        classtab_t *class;
        char *arg0 = argv[0];
        wtab_t *w, *wtab;
        ...
        if (argc < 4) {
                errmsg =
                    strdup(GETMESSAGE(5, 7,
                                      "Usage: XtCreateApplicationShell "
                                      "variable name class [arg:val ...]"));
                printerr(str_nill, errmsg, NULL);
                free(errmsg);
                return (1);
        }
        ...
        n = 0;
        parse_args(arg0, argc, argv, NULL, NULL, class, &n, args, &pargc, pargv,
                   True);
        ...
        if (widget != NULL) {
                ...
                if (pargc > 0) {
                        free_args(n, args);
                        n = 0;
                        parse_args(arg0, pargc, pargv, wtab, NULL, class, &n,
                                   args, NULL, NULL, False);
                        XtSetValues(widget, args, n);
                }
        } else {
...
int do_XtCreatePopupShell(int argc, char *argv[]) {
        return (_CreateWidget(XtCreatePopupShell, argc, argv));
}

int do_XtCreateManagedWidget(int argc, char *argv[]) {
        return (_CreateWidget(XtCreateManagedWidget, argc, argv));
}

int do_XtCreateWidget(int argc, char *argv[]) {
        return (_CreateWidget(XtCreateWidget, argc, argv));
}

int do_XtPopup(int argc, char *argv[]) {
        wtab_t *w;
        XtGrabKind grab;
        char *errmsg;
        ...
        if (argc != 3) {
                errmsg = strdup(GETMESSAGE(5, 8,
                                           "Usage: XtPopup widget "
                                           "GrabNone|GrabNonexclusive|"
                                           "GrabExclusive"));
                printerr(str_nill, errmsg, NULL);
                free(errmsg);
                return (1);
        ...
        if (w == NULL)
                ...
                if (argc < 3 || strcmp(argv[2], "GrabNone") == 0)
                        ...
                        errmsg =
                            strdup(GETMESSAGE(5, 9,
                                              "The grab type '%s' is not "
                                              "recognized; using 'GrabNone'"));
...
int do_XtDestroyWidget(int argc, char *argv[]) {
        return (do_single_widget_arg_func(_DTKSH_XtDestroyWidget, argc, argv));
}

int do_single_widget_test_func(int (*func)(), int argc, char **argv) {
        wtab_t *w;
        register int i;
        char *errmsg;
...
int do_XtIsSensitive(int argc, char *argv[]) {
        return (
            do_single_widget_test_func((int (*)())XtIsSensitive, argc, argv));
}

/*
 * XtIsShell() is a macro, so we can't use do_single_widget_test_func().
 */
int do_XtIsShell(int argc, char *argv[]) {
        wtab_t *w;
        register int i;
        char *errmsg;
...
int do_XtIsManaged(int argc, char *argv[]) {
        return (do_single_widget_test_func((int (*)())XtIsManaged, argc, argv));
}

int do_XtIsRealized(int argc, char *argv[]) {
        return (
            do_single_widget_test_func((int (*)())XtIsRealized, argc, argv));
}

int do_XtRealizeWidget(int argc, char *argv[]) {
        return (
            do_single_widget_arg_func((int (*)())XtRealizeWidget, argc, argv));
}

int do_XtUnrealizeWidget(int argc, char *argv[]) {
        return (do_single_widget_arg_func((int (*)())XtUnrealizeWidget, argc,
                                          argv));
}
...
int do_XtMapWidget(int argc, char *argv[]) {
        wtab_t *w;
        register int i;
        char *errmsg;
...
int do_XtUnmapWidget(int argc, char **argv) {
        wtab_t *w;
        register int i;
        char *errmsg;
        ...
        if (argc < 2) {
                errmsg =
                    strdup(GETMESSAGE(5, 12, "Usage: XtUnmapWidget widget"));
                printerr(str_nill, errmsg, NULL);
                free(errmsg);
                return (1);
        }
...
int do_XtPopdown(int argc, char **argv) {
        return (do_single_widget_arg_func((int (*)())XtPopdown, argc, argv));
}

int do_XtMainLoop(int argc, char **argv) {
        /*
...
int do_XtDisplay(int argc, char **argv) {
        return (GetDisplayHandle(argc, argv, (Widget(*)())XtDisplay));
}

int do_XtDisplayOfObject(int argc, char **argv) {
...
int do_XtNameToWidget(int argc, char *argv[]) {
        char *arg0 = argv[0];
        wtab_t *w;
        char *variable = argv[1];
        Widget child;
...
int do_XtScreen(int argc, char **argv) {
        wtab_t *w;
        char *arg0 = argv[0];
        char *variable = argv[1];
        char buf[128];
        ...
        if (argc != 3) {
                errmsg = strdup(
                    GETMESSAGE(5, 14, "Usage: XtScreen variable widget"));
                printerr(str_nill, errmsg, NULL);
                free(errmsg);
                return (1);
        }
...
int do_XtWindow(int argc, char **argv) {
        wtab_t *w;
        char *arg0 = argv[0];
        char *variable = argv[1];
        char buf[128];
        ...
        if (argc != 3) {
                errmsg = strdup(
                    GETMESSAGE(5, 15, "Usage: XtWindow variable widget"));
                printerr(str_nill, errmsg, NULL);
                free(errmsg);
                return (1);
        }
...
static int XtCallCallbacks_usage(char *arg0) {
        ...
        errmsg = strdup(
            GETMESSAGE(5, 16, "Usage: XtCallCallbacks widget callbackName"));
        printerr(str_nill, errmsg, NULL);
        free(errmsg);
        return (1);
}

int do_XtCallCallbacks(int argc, char **argv) {
        wtab_t *w;
        char *arg0 = argv[0];
...
int do_XtHasCallbacks(int argc, char **argv) {
        wtab_t *w;
        char *arg0 = argv[0];
        char *msg;
        char *variable = argv[1];
...
int do_XtAddCallback(int argc, char **argv) {
        char *errmsg;
 ...
 */
int AddOneCallback(char *cmd, char *widget, char *cbName, char *kshcmd,
                   char *propAtomStr) {
        wtab_t *w;
        ...
        if (propAtomStr) {
                ...
                if (p == propAtomStr) {
                        ...
                        printerrf(cmd, errmsg, propAtomStr, NULL, NULL, NULL,
                                  NULL, NULL, NULL, NULL);
                        free(errmsg);
                        return (1);
                }
        ...
        if (strcmp(cmd, "XtAddCallback") == 0)
                XtAddCallback(w->w, cbName, (XtCallbackProc)stdCB,
                              (XtPointer)cdata);
        else {
...
int do_XtRemoveCallback(int argc, char **argv) {
        char *errmsg;
        ...
        return (
            RemoveOneCallback(argv[0], argv[1], argv[2], argv[3], NULL, NULL));
}
 ...
 * Motif WMProtocol callback.
 */
int RemoveOneCallback(char *cmd, char *widget, char *cbName, char *kshcmd,
                      char *propAtomStr, char *handleStr) {
        wtab_t *w;
        dtksh_client_data_t *cdata;
        int i;
        Atom propAtom;
        ...
        if (handleStr) {
                ...
                if (p == handleStr) {
                        ...
                        printerrf(cmd, errmsg, handleStr, NULL, NULL, NULL,
                                  NULL, NULL, NULL, NULL);
                        free(errmsg);
                        return (1);
                }
        ...
        if ((i = LocateCBRecord(w, cbName, kshcmd, propAtom, handle)) >= 0) {
                ...
                if (strcmp(cmd, "XtRemoveCallback") == 0)
                        XtRemoveCallback(w->w, cbName, (XtCallbackProc)stdCB,
                                         (XtPointer)cdata);
                else if (strcmp(cmd, "XmRemoveWMProtocolCallback") == 0) {
                        XmRemoveWMProtocolCallback(w->w, propAtom,
                                                   (XtCallbackProc)stdCB,
                                                   (XtPointer)cdata);
                } else {
        ...
        errmsg = strdup(
            GETMESSAGE(5, 21, "The specified callback is not registered"));
        printerr(cmd, errmsg, NULL);
        free(errmsg);
        return (1);
}

int do_XtAddEventHandler(int argc, char **argv) {
        wtab_t *w;
        char *arg0 = argv[0];
        ...
        if (argc != 5) {
                errmsg = strdup(GETMESSAGE(5, 22,
                                           "Usage: XtAddEventHandler widget "
                                           "mask nonMaskable ksh-command"));
                printerr(str_nill, errmsg, NULL);
                free(errmsg);
                return (1);
        }
...
int do_XtRemoveEventHandler(int argc, char **argv) {
        wtab_t *w;
        char *arg0 = argv[0];
        dtksh_event_handler_data_t *ehdata;
        int i;
        ...
        if (argc != 5) {
                errmsg = strdup(GETMESSAGE(5, 23,
                                           "Usage: XtRemoveEventHandler widget "
                                           "mask nonMaskable ksh-command"));
                printerr(str_nill, errmsg, NULL);
                free(errmsg);
                return (1);
        ...
        if ((i = LocateEHRecord(w, argv[4])) >= 0) {
                ...
                if (tval.size != 0) {
                        ...
                        /* See if non-maskable event processing has been turned
                         * off */
                        if (nonMaskable)
                ...
                XtRemoveEventHandler(w->w, eventMask, nonMaskable,
                                     (XtEventHandler)stdEH, (XtPointer)ehdata);

                if ((ehdata->eventMask == 0) &&
                    (ehdata->nonMaskable == False)) {
        ...
        errmsg = strdup(
            GETMESSAGE(5, 24, "The specified event handler is not registered"));
        printerr(arg0, errmsg, NULL);
        free(errmsg);
        return (1);
}

int do_XtGetValues(int argc, char **argv) {
        register int i, j;
        int n;
        char *arg0 = argv[0];
        char *val, *p, *str;
        ...
        if (argc < 3) {
                errmsg = strdup(GETMESSAGE(
                    5, 25, "Usage: XtGetValues widget resource:variable ..."));
                printerr(str_nill, errmsg, NULL);
                free(errmsg);
                return (1);
        }
        ...
        for (i = 0; i < n; i++) {
                if (ConvertTypeToString(arg0, w->wclass, w, w->parent,
...
int do_XtSetValues(int argc, char **argv) {
        int n;
        char *arg0 = argv[0];
        Arg args[MAXARGS];
        wtab_t *w;
        ...
        if (argc < 3) {
                errmsg = strdup(
                    GETMESSAGE(5, 27, "Usage: XtSetValues widget arg:val ..."));
                printerr(str_nill, errmsg, NULL);
                free(errmsg);
                return (1);
        }
        ...
        if (w == NULL) {
                ...
                if (pargc > 0) {
                        free_args(n, args);
                        n = 0;
                        parse_args(arg0, pargc, pargv, w, w->parent, w->wclass,
...
static void RegisterCmdStr(char type, long id, char *cmd) {
        ...
        (*tableSize)++;
        *table = (CommandString *)XtRealloc(
            (char *)*table, sizeof(CommandString) * (*tableSize));
...
int do_XtAddWorkProc(int argc, char *argv[]) {
        char *variable;
        char *cmd;
        char buf[256];
        XtWorkProcId id;
        ...
        if (argc != 3) {
                errmsg = strdup(
                    GETMESSAGE(5, 28, "Usage: XtAddWorkProc variable command"));
                printerr(str_nill, errmsg, NULL);
                free(errmsg);
                return (1);
        }
...
int do_XtRemoveWorkProc(int argc, char *argv[]) {
        XtWorkProcId id;
        char *p;
        char *errmsg;
        ...
        if (argc != 2) {
                errmsg = strdup(
                    GETMESSAGE(5, 29, "Usage: XtRemoveWorkProc workProcId"));
                printerr(str_nill, errmsg, NULL);
                free(errmsg);
                return (1);
        }
...
int do_XtAddTimeOut(int argc, char *argv[]) {
...
int do_XtRemoveTimeOut(int argc, char *argv[]) {
        XtIntervalId id;
        char *p;
        char *errmsg;
        ...
        if (argc != 2) {
                errmsg = strdup(
                    GETMESSAGE(5, 33, "Usage: XtRemoveTimeOut intervalId"));
                printerr(str_nill, errmsg, NULL);
                free(errmsg);
                return (1);
        }
...
int do_XtUnmanageChildren(int argc, char *argv[]) {
        return (do_managelist_func(argc, argv, (int (*)())XtUnmanageChildren));
}

int do_XtManageChildren(int argc, char *argv[]) {
        return (do_managelist_func(argc, argv, (int (*)())XtManageChildren));
}

int do_managelist_func(int argc, char *argv[], int (*func)()) {
        wtab_t *w;
        register int i;
...
int do_XtIsSubclass(int argc, char *argv[]) {
        wtab_t *w;
        register int i;
        char *errmsg;
        ...
        if (argc != 3) {
                errmsg = strdup(
                    GETMESSAGE(5, 120, "Usage: XtIsSubclass widget class"));
                printerr(str_nill, errmsg, NULL);
                free(errmsg);
                return (1);
        }
        ...
        errmsg =
            strdup(GETMESSAGE(5, 121, "%s is not a valid widget class name"));
        printerrf(str_nill, errmsg, argv[2], NULL, NULL, NULL, NULL, NULL, NULL,
                  NULL);
        free(errmsg);
        return (255);
}

int do_XtClass(int argc, char *argv[]) {
        wtab_t *w;
        register int i;
        char *errmsg;
        WidgetClass class;
        ...
        if (argc != 3) {
                errmsg = strdup(
                    GETMESSAGE(5, 122, "Usage: XtClass variable widget"));
                printerr(str_nill, errmsg, NULL);
                free(errmsg);
                return (1);
        }
...
int create_standard_gc(Display *display, Window drawable) {
        Standard_GC = XCreateGC(display, drawable, 0, NULL);
        return (0);
}

int do_XBell(int argc, char *argv[]) {
        int volume;
        Display *display;
        char *p;
        char *errmsg;
        ...
        if (argc != 3) {
                errmsg =
                    strdup(GETMESSAGE(5, 36, "Usage: XBell display volume"));
                printerr(str_nill, errmsg, NULL);
                free(errmsg);
                return (1);
        } else
...
static int do_RootWindowCmd(int (*func)(), int argc, char *argv[]) {
        ...
        if (p == argv[2]) {
                errmsg = strdup(
                    GETMESSAGE(5, 38, "The screen parameter is invalid: %s"));
                printerrf(argv[0], errmsg, argv[2], NULL, NULL, NULL, NULL,
                          NULL, NULL, NULL);
                free(errmsg);
                return (1);
        }
...
int do_XRootWindowOfScreen(int argc, char *argv[]) {
        return (do_RootWindowCmd((int (*)())XRootWindowOfScreen, argc, argv));
}

int do_XWidthOfScreen(int argc, char *argv[]) {
        return (do_RootWindowCmd(XWidthOfScreen, argc, argv));
}

int do_XHeightOfScreen(int argc, char *argv[]) {
        return (do_RootWindowCmd(XHeightOfScreen, argc, argv));
}

int do_XDefineCursor(int argc, char *argv[]) {
        Cursor cursor;
        Display *display;
        Window window;
        char *p;
        ...
        if (argc != 4) {
                errmsg = strdup(GETMESSAGE(
                    5, 39, "Usage: XDefineCursor display window cursorId"));
                printerr(str_nill, errmsg, NULL);
                free(errmsg);
                return (1);
        }
        ...
        if (p == argv[3]) {
                errmsg = strdup(
                    GETMESSAGE(5, 40, "The cursorId parameter is invalid: %s"));
                printerrf(argv[0], errmsg, argv[3], NULL, NULL, NULL, NULL,
                          NULL, NULL, NULL);
                free(errmsg);
                return (1);
        }
...
int do_XUndefineCursor(int argc, char *argv[]) {
        Display *display;
        Window window;
        char *p;
        char *errmsg;
        ...
        if (argc != 3) {
                errmsg = strdup(
                    GETMESSAGE(5, 41, "Usage: XUndefineCursor display window"));
                printerr(str_nill, errmsg, NULL);
                free(errmsg);
                return (1);
        }
...
int do_XtRemoveAllCallbacks(int argc, char *argv[]) {
        wtab_t *w;
        register int i;
        char *errmsg;
        ...
        if (argc != 3) {
                errmsg = strdup(GETMESSAGE(
                    5, 42, "Usage: XtRemoveAllCallbacks widget callbackName"));
                printerr(str_nill, errmsg, NULL);
                free(errmsg);
                return (1);
        }
...
int do_XTextWidth(int argc, char *argv[]) {
        XFontStruct *fn;
        char *s;
        char buf[128];
        char *errmsg;
        ...
        if (argc != 4) {
                errmsg = strdup(GETMESSAGE(
                    5, 43, "Usage: XTextWidth variable fontName string"));
                printerr(str_nill, errmsg, NULL);
                free(errmsg);
                return (1);
        }
...
static int invokeXDrawFunction(int function, int argc, char *argv[]) {
        ...
        if (argc < 3) {
                errmsg = strdup(
                    GETMESSAGE(5, 44, "Usage: %s display drawable [args ...]"));
                printerrf(str_nill, errmsg, functionName, NULL, NULL, NULL,
                          NULL, NULL, NULL, NULL);
                free(errmsg);
                return (1);
        }
        ...
        if (sp == argv[2]) {
                errmsg = strdup(
                    GETMESSAGE(5, 45, "The drawable parameter is invalid: %s"));
                printerrf(argv[0], errmsg, argv[2], NULL, NULL, NULL, NULL,
                          NULL, NULL, NULL);
                free(errmsg);
                return (1);
        ...
        if (function == COPY_AREA) {
                ...
                if (sp == argv[3]) {
                        errmsg = strdup(GETMESSAGE(
                            5, 46, "The destination parameter is invalid: %s"));
                        printerrf(argv[0], errmsg, argv[3], NULL, NULL, NULL,
                                  NULL, NULL, NULL, NULL);
                        free(errmsg);
                        return (1);
                }
                ...
                if (argc > 3) {
                        while (argv[3][0] == '-') {
                                if (strcmp(argv[3], "-Complex") == 0)
                                        ...
                                        polymode = Nonconvex;
                                else if (strcmp(argv[3], "-CoordModeOrigin") ==
                                         0)
                                        coordmode = CoordModeOrigin;
        ...
        while (argc > 4 && argv[3][0] == '-') {
                ...
                if (strcmp(argv[3], "-gc") == 0) {
                        ...
                        if (cvtfont(display, argv[4], &fn) == SUCCESS)
                                ...
                                errmsg = strdup(GetSharedMsg(DT_BAD_FONT));
                                printerrf(functionName, errmsg, argv[4], NULL,
                        ...
                        if (strcmp(argv[4], "LineSolid") == 0)
                                ...
                                errmsg = strdup(GETMESSAGE(
                                    5, 48, "Unrecognized line style: %s"));
                                printerrf(functionName, errmsg, argv[4], NULL,
                                          NULL, NULL, NULL, NULL, NULL, NULL);
                                free(errmsg);
                                returnVal = 1;
                        ...
                        errmsg = strdup(GETMESSAGE(
                            5, 49, "Unrecognized drawing option: %s"));
        ...
        if (parse == PARSE_POINTLIST) {
                XPoint *points =
                    (XPoint *)malloc(sizeof(XPoint) * (argc / 2 + 1));
                int npoints = 0;
                ...
                switch (argtype) {
                case POLYGON_ARGS: {
                        (*func)(display, drawable, gc, points, argc / 2,
                                polymode, coordmode);
                        break;
                }
                ...
                segments =
                    (XSegment *)malloc(sizeof(XSegment) * (argc / 4 + 1));
                ...
                if (argc > 0) {
                        ...
                        XtConvert(Toplevel, XtRString, &fval, XtRBoolean,
                                  &tval);
                ...
                while (argc >= parse) {
                        ...
                        if (text) {
                                (*func)(display, drawable, gc, p[0], p[1],
                                ...
                                (*func)(display, drawable, gc, p[0], p[1], p[2],
                                        p[3], p[4], p[5]);
                        }
        ...
        if (argc != 0) {
                errmsg = strdup(GETMESSAGE(
                    5, 50, "There were left over points which were ignored"));
...
int do_XDrawArc(int argc, char *argv[]) {
        invokeXDrawFunction(DRAW_ARC, argc, argv);
}

int do_XDrawImageString(int argc, char *argv[]) {
        invokeXDrawFunction(DRAW_IMAGE_STRING, argc, argv);
}

int do_XDrawLine(int argc, char *argv[]) {
        invokeXDrawFunction(DRAW_LINE, argc, argv);
}

int do_XDrawLines(int argc, char *argv[]) {
        invokeXDrawFunction(DRAW_LINES, argc, argv);
}

int do_XDrawPoint(int argc, char *argv[]) {
        invokeXDrawFunction(DRAW_POINT, argc, argv);
}

int do_XDrawPoints(int argc, char *argv[]) {
        invokeXDrawFunction(DRAW_POINTS, argc, argv);
}

int do_XDrawRectangle(int argc, char *argv[]) {
        invokeXDrawFunction(DRAW_RECTANGLE, argc, argv);
}

int do_XCopyArea(int argc, char *argv[]) {
        char *errmsg;

        if (argc < 10) {
                errmsg = strdup(
                    GETMESSAGE(5, 51,
                               "Usage: XCopyArea display source dest sourceX "
                               "sourceY width height destX destY [args ...]"));
                printerr(str_nill, errmsg, NULL);
                free(errmsg);
                return (1);
        }
...
int do_XDrawSegments(int argc, char *argv[]) {
        invokeXDrawFunction(DRAW_SEGMENTS, argc, argv);
}

int do_XDrawString(int argc, char *argv[]) {
        invokeXDrawFunction(DRAW_STRING, argc, argv);
}

int do_XFillArc(int argc, char *argv[]) {
        invokeXDrawFunction(FILL_ARC, argc, argv);
}

int do_XFillPolygon(int argc, char *argv[]) {
        invokeXDrawFunction(FILL_POLYGON, argc, argv);
}

int do_XFillRectangle(int argc, char *argv[]) {
        invokeXDrawFunction(FILL_RECTANGLE, argc, argv);
}

int do_XClearArea(int argc, char *argv[]) {
        invokeXDrawFunction(CLEAR_AREA, argc, argv);
}

int do_XClearWindow(int argc, char *argv[]) {
        invokeXDrawFunction(CLEAR_WINDOW, argc, argv);
}

int ConvertTypeToString(char *arg0, classtab_t *class, wtab_t *w,
                        wtab_t *parent, char *resource, XtArgVal val,
                        char **ret) {
        char *from_type;
        XtResourceList res;
        ...
        if ((nam = hashget((Hash_table_t *)class->res, resource)) == NULL) {
                ...
                if (parent == NULL || parent->wclass == NULL ||
                    ...
                    (nam = hashget((Hash_table_t *)parent->wclass->con,
                        ...
                        printerrf(arg0, errmsg, (char *)(class->cname),
        ...
        XtConvert(w ? w->w : Toplevel, res->resource_type, /* from type */
                  &fr_val,                                 /* from value */
        ...
        if ((to_val.addr) || (strcmp(res->resource_type, XmRXmString) == 0)) {
                *ret = to_val.addr;
                ...
                errmsg = strdup(GETMESSAGE(
                    5, 52, "Unable to convert resource type '%s' to 'String'"));
                printerrf(arg0, errmsg, res->resource_type, NULL, NULL, NULL,
                          NULL, NULL, NULL, NULL);
                free(errmsg);
                return (FAIL);
        }
...
int ConvertStringToType(char *arg0, wtab_t *w, wtab_t *parent,
                        classtab_t *class, char *resource, char *val,
                        XtArgVal *ret, int *freeit, Boolean postponePixmaps) {
        char *to_type;
        XtResourceList res;
        XrmValue fr_val, to_val;
        char *nam;
         ...
         */
        if (toolkit_special_resource(arg0, res, w, parent, class, resource, val,
                                     ret, freeit, postponePixmaps)) {
                return (CONVERT_POSTPONED);
        }
        XtConvert(w ? w->w : Toplevel, str_XtRString, /* from type */
                  &fr_val,                            /* from value */
        ...
        if (to_val.size && to_val.addr) {
                ...
                default:
                         ...
                         * the only way to handle this is to handle such types
                         * as special cases.  Maybe we need a hash table that
...
int do_XtAddInput(int argc, char *argv[]) {
        register int i, j;
        int fd;
        char *arg0 = argv[0];
        char *variable;
        ...
        if (strcmp(argv[0], "-r") == 0) {
                /* Raw mode; the registered handler will take care of reading
                 * input */
...
int do_XtRemoveInput(int argc, char *argv[]) {
        XtInputId id;
        char *p;
        char *errmsg;
        ...
        if (argc != 2) {
                errmsg =
                    strdup(GETMESSAGE(5, 56, "Usage: XtRemoveInput inputId"));
                printerr(str_nill, errmsg, NULL);
                free(errmsg);
                return (1);
        }
        ...
        if (p == argv[1]) {
                errmsg = strdup(GETMESSAGE(
                    5, 57, "The inputId parameter must be a hex number: %s"));
                printerrf(argv[0], errmsg, argv[1], NULL, NULL, NULL, NULL,
                          NULL, NULL, NULL);
                free(errmsg);
                return (1);
...
void Translation_ksh_eval(Widget w, XEvent *event, String *params,
                          Cardinal *num_params) {
        char buf[128];
        int i;
        Namval_t *np;
...
void RestorePriorEnvVarValues(Namval_t *np1, char *value1, Namval_t *np2,
                              char *value2) {
        if (value1 && np1) {
                nv_newattr(np1, 0, 0);
...
void stdCB(void *widget, caddr_t clientData, caddr_t callData) {
        char buf[128];
        ...
        if (cdata->cbname) {
                if ((strcmp(cdata->cbname, XmNpopupCallback) == 0) ||
                    ...
                    (strcmp(cdata->cbname, XmNdestroyCallback) == 0)) {
                        ...
                        while (class) {
                                if (discipline = CheckClassDisciplines(
                                        class, cdata->cbname))
                                        break;
        ...
        RestorePriorEnvVarValues(np2, oldCB_WIDGET_value, np,
                                 oldCB_CALL_DATA_value);
 ...
 */
void stdWSCB(void *widget, Atom atom, caddr_t clientData) {
        char buf[128];
        dtksh_client_data_t *cdata = (dtksh_client_data_t *)clientData;
        Namval_t *np;
        Namval_t *np2;
...
void stdInputCB(inputrec_t *inp, int *source, XtInputId *id) {
        char buf[LINESIZE];
        ...
        for (i = 0; i < n;) {
                ...
                if ((len == 1) && (buf[i] == '\\') &&
                    (!inp->lastCharIsBackslash)) {
                        /* Skip this character; the next character will be
                         * treated specially */
                ...
                /*
                 * If the previous character has been a backslash, then the
                 * current character gets placed into the buffer without any
                 * special processing; the exception is the newline character,
                 * which gets dumped.
                 */
                if ((len == 1) && (buf[i] == '\n')) {
                        /*
                         * If the newline is escaped, then drop it, and
                         * continue. Otherwise, process the line.
                         */
                        i++;
                        ...
                        if (ProcessInput(inp, *source, *id, False)) {
                                /* The handler called XtRemoveInput() on this
                                 * source; abort */
                                return;
                        }
                        inp->lnend = 0;
...
int stdWorkProcCB(char *clientData) {
        int retcode;
        int i;
        ...
        if (retcode != 0) {
                ...
                for (i = 0; i < workProcCmdsSize; i++) {
                        if (clientData == workProcCmds[i].cmd) {
                                RemoveCmdStr(WORKPROC_CMDS,
                                             (long)workProcCmds[i].id);
                                break;
                        }
                }
        }
...
void stdTimerCB(char *clientData, long *id) {
        ksh_eval((char *)clientData);
        RemoveCmdStr(TIMEOUT_CMDS, (long)*id);
        return;
}

int do_XFlush(int argc, char *argv[]) {
        char *p;
        Display *display;
        char *errmsg;
...
int do_XSync(int argc, char *argv[]) {
        Boolean discard;
        XrmValue fval, tval;
        char *p;
        Display *display;
        ...
        if (argc != 3) {
                errmsg =
                    strdup(GETMESSAGE(5, 60, "Usage: XSync display discard"));
                printerr(str_nill, errmsg, NULL);
                free(errmsg);
                return (1);
        }
...
int do_XRaiseWindow(int argc, char *argv[]) {
        Boolean discard;
        XrmValue fval, tval;
        wtab_t *w;
        char *p;
        ...
        if (argc != 3) {
                errmsg = strdup(
                    GETMESSAGE(5, 61, "Usage: XRaiseWindow display window"));
                printerr(str_nill, errmsg, NULL);
                free(errmsg);
                return (1);
        }
...
int do_XtSetSensitive(int argc, char *argv[]) {
        wtab_t *w;
        Boolean bool;
        XrmValue fval, tval;
...
static int RegisterTranslations(void (*func)(), int argc, char *argv[]) {
        ...
        if (argc != 3) {
                errmsg =
                    strdup(GETMESSAGE(5, 63, "Usage: %s widget translations"));
                printerrf(str_nill, errmsg, argv[0], NULL, NULL, NULL, NULL,
                          NULL, NULL, NULL);
                free(errmsg);
                return (1);
...
int do_XtOverrideTranslations(int argc, char **argv) {
        return (RegisterTranslations(XtOverrideTranslations, argc, argv));
}

int do_XtAugmentTranslations(int argc, char **argv) {
        return (RegisterTranslations(XtAugmentTranslations, argc, argv));
}

int do_XtUninstallTranslations(int argc, char *argv[]) {
        wtab_t *w;
        XtTranslations *translationTable;
        XrmValue fval, tval;
        char *errmsg;
        ...
        if (argc != 2) {
                errmsg = strdup(
                    GETMESSAGE(5, 64, "Usage: XtUninstallTranslations widget"));
                printerr(str_nill, errmsg, NULL);
                free(errmsg);
                return (1);
        }
...
int do_XtParent(int argc, char **argv) {
        char *arg0 = argv[0];
        char *wname;
        wtab_t *wtab;
        classtab_t *ctab;
        ...
        if (argc != 3) {
                errmsg = strdup(
                    GETMESSAGE(5, 65, "Usage: XtParent variable widget"));
                printerr(str_nill, errmsg, NULL);
                free(errmsg);
                return (1);
        }
...
int do_XtLastTimestampProcessed(int argc, char **argv) {
        char *arg0 = argv[0];
        Display *display;
        char *p;
        char buf[128];
        ...
        if (argc != 3) {
                errmsg = strdup(GETMESSAGE(
                    5, 66, "Usage: XtLastTimestampProcessed variable display"));
                printerr(str_nill, errmsg, NULL);
                free(errmsg);
                return (1);
        }
...
dtksh_client_data_t *GetNewCBData(char *ksh_cmd, wtab_t *w, char *cbname,
                                  Atom propAtom) {
        dtksh_client_data_t *cdata;
        int i;
        int j;
        ...
        if (i >= cbDataTableSize) {
                ...
                cbDataTableSize += 10;
                cbDataTable = (dtksh_client_data_t **)XtRealloc(
                    (XtPointer)cbDataTable,
...
int LocateCBRecord(wtab_t *w, char *cbname, char *ksh_cmd, Atom propAtom,
                   DtWsmCBContext handle) {
        int i;
...
void stdEH(void *widget, caddr_t clientData, XEvent *event,
...
dtksh_event_handler_data_t *GetNewEHData(char *ksh_cmd, wtab_t *w,
                                         EventMask eventMask,
                                         Boolean nonMaskable) {
        dtksh_event_handler_data_t *ehdata;
        int i;
        ...
        if (i >= ehDataTableSize) {
                /* Need to enlarge the table */
                ehDataTableSize += 10;
                ehDataTable = (dtksh_event_handler_data_t **)XtRealloc(
                    (XtPointer)ehDataTable,
                    sizeof(dtksh_event_handler_data_t *) * ehDataTableSize);
                for (j = i; j < ehDataTableSize; j++)
                        ehDataTable[j] = NULL;
        }

        ehdata = (dtksh_event_handler_data_t *)XtMalloc(
            sizeof(dtksh_event_handler_data_t));
        if (ksh_cmd)
...
int do_DtSessionRestorePath(int argc, char *argv[]) {
        wtab_t *w;
        char *path;
        Boolean status;
        char *errmsg;
        ...
        if (argc != 4) {
                errmsg = strdup(GETMESSAGE(5, 67,
                                           "Usage: DtSessionRestorePath widget "
                                           "pathVariable saveFile"));
                printerr(str_nill, errmsg, NULL);
                free(errmsg);
                return (1);
        }
...
int do_DtSessionSavePath(int argc, char *argv[]) {
        wtab_t *w;
        char *path;
        char *file;
        Boolean status;
        ...
        if (argc != 4) {
                errmsg = strdup(GETMESSAGE(5, 68,
                                           "Usage: DtSessionSavePath widget "
                                           "pathVariable fileVariable"));
                printerr(str_nill, errmsg, NULL);
                free(errmsg);
                return (1);
        }
...
int do_DtShellIsIconified(int argc, char *argv[]) {
        wtab_t *w;
        Boolean status;
        Atom actual_type;
        int actual_format;
        ...
        if (argc != 2) {
                errmsg = strdup(
                    GETMESSAGE(5, 69, "Usage: DtShellIsIconified widget"));
                printerr(str_nill, errmsg, NULL);
                free(errmsg);
                return (1);
        }
        ...
        XGetWindowProperty(XtDisplay(w->w), XtWindow(w->w), wmStateAtom, 0L,
                           (long)LINESIZE, False, wmStateAtom, &actual_type,
...
int do_DtSetStartupCommand(int argc, char *argv[]) {
        wtab_t *w;
        Atom commandAtom;
        char *errmsg;
        ...
        if (argc != 3) {
                errmsg = strdup(GETMESSAGE(
                    5, 70, "Usage: DtSetStartupCommand widget command"));
                printerr(str_nill, errmsg, NULL);
                free(errmsg);
                return (1);
        }
        ...
        XChangeProperty(XtDisplay(w->w), XtWindow(w->w), commandAtom, XA_STRING,
                        8, PropModeReplace, (unsigned char *)argv[2],
                        strlen(argv[2]) + 1);
...
int do_DtSetIconifyHint(int argc, char *argv[]) {
        wtab_t *w;
        Boolean state;
        XrmValue fval, tval;
        XWMHints *wmhints;
        ...
        if (argc != 3) {
                errmsg = strdup(GETMESSAGE(
                    5, 71, "Usage: DtSetIconifyHint widget boolean"));
                printerr(str_nill, errmsg, NULL);
                free(errmsg);
                return (1);
        }
...
int do_DtWsmAddWorkspaceFunctions(int argc, char *argv[]) {
        return (
            WsmCommonProc(argc, argv, (void (*)())DtWsmAddWorkspaceFunctions));
}

int do_DtWsmRemoveWorkspaceFunctions(int argc, char *argv[]) {
        return (WsmCommonProc(argc, argv,
...
int do_DtWsmGetCurrentWorkspace(int argc, char *argv[]) {
        wtab_t *w;
        Display *display;
        Window rootWindow;
        char *p;
        ...
        if (p == argv[2]) {
                errmsg = strdup(GETMESSAGE(
                    5, 73, "The rootWindow parameter is invalid: %s"));
                printerrf(argv[0], errmsg, argv[2], NULL, NULL, NULL, NULL,
                          NULL, NULL, NULL);
                free(errmsg);
                env_blank(argv[3]);
...
int do_DtWsmSetCurrentWorkspace(int argc, char *argv[]) {
        wtab_t *w;
        char *p;
        Atom atom;
        Status result;
        ...
        if (argc != 3) {
                errmsg = strdup(GETMESSAGE(
                    5, 74, "Usage: DtWsmSetCurrentWorkspace widget atom"));
                printerr(str_nill, errmsg, NULL);
                free(errmsg);
                return (1);
        }
        ...
        if (p == argv[2]) {
                errmsg = strdup(
                    GETMESSAGE(5, 75, "The workspace atom is invalid: %s"));
                printerrf(argv[0], errmsg, argv[2], NULL, NULL, NULL, NULL,
                          NULL, NULL, NULL);
                free(errmsg);
                return (1);
...
static int GetWorkspaceList(char *usageMsg, Boolean getOccupied, int argc,
        ...
        if (argc != 4) {
                printerrf(str_nill, usageMsg, argv[0], NULL, NULL, NULL, NULL,
                          NULL, NULL, NULL);
                return (1);
        }
        ...
        if (getOccupied)
                result =
                    DtWsmGetWorkspacesOccupied(display, root, &wsList, &numWS);
        else
                result = DtWsmGetWorkspaceList(display, root, &wsList,
                                               (int *)&numWS);
...
int do_DtWsmGetWorkspaceList(int argc, char *argv[]) {
        char *errmsg;
        int retVal;
...
int do_DtWsmGetWorkspacesOccupied(int argc, char *argv[]) {
        char *errmsg;
        int retVal;
...
int do_DtWsmSetWorkspacesOccupied(int argc, char *argv[]) {
        char *p;
        Display *display;
        Window window;
        unsigned long numWS;
        ...
        if (argc != 4) {
                errmsg = strdup(GETMESSAGE(5, 78,
                                           "Usage: DtWsmSetWorkspacesOccupied "
                                           "display window workspaceList"));
                printerr(str_nill, errmsg, NULL);
                free(errmsg);
                return (1);
        }
        ...
        while (nextAtom) {
                if (strlen(nextAtom) > 0) {
                        wsList = (Atom *)XtRealloc((char *)wsList,
                                                   sizeof(Atom) * (numWS + 1));
...
int do_DtWsmGetCurrentBackdropWindow(int argc, char *argv[]) {
        char *p;
        Display *display;
...
int do_DtWsmOccupyAllWorkspaces(int argc, char *argv[]) {
        return (
            WsmCommonProc(argc, argv, (void (*)())DtWsmOccupyAllWorkspaces));
}

int do__DtGetHourGlassCursor(int argc, char *argv[]) {
        char *p;
        Display *display;
        Cursor cursor;
        char buf[128];
        ...
        if (argc != 3) {
                errmsg = strdup(GETMESSAGE(
                    5, 79, "Usage: _DtGetHourGlassCursor variable display"));
                printerr(str_nill, errmsg, NULL);
                free(errmsg);
                return (1);
        }
...
int do__DtTurnOnHourGlass(int argc, char *argv[]) {
        return (DtTurnOnOrOffHourGlass(_DtTurnOnHourGlass, argc, argv));
}

int do__DtTurnOffHourGlass(int argc, char *argv[]) {
        return (DtTurnOnOrOffHourGlass(_DtTurnOffHourGlass, argc, argv));
}

int do_DtWsmAddCurrentWorkspaceCallback(int argc, char **argv) {
        wtab_t *w;
        dtksh_client_data_t *cdata;
        char *p;
        Atom propAtom;
        ...
        if (argc != 4) {
                errmsg =
                    strdup(GETMESSAGE(5, 80,
                                      "Usage: DtWsmAddCurrentWorkspaceCallback "
                                      "variable widget ksh-command"));
                printerr(str_nill, errmsg, NULL);
                free(errmsg);
                return (1);
        }
        ...
        handle = DtWsmAddCurrentWorkspaceCallback(
            w->w, (DtWsmWsChangeProc)stdWSCB, (XtPointer)cdata);
...
int do_DtWsmRemoveWorkspaceCallback(int argc, char **argv) {
        char *errmsg, *p;
        ...
        if (argc != 2) {
                errmsg = strdup(GETMESSAGE(
                    5, 81, "Usage: DtWsmRemoveWorkspaceCallback handle"));
                printerr(str_nill, errmsg, NULL);
                free(errmsg);
                return (1);
        }
        ...
        if (cdata == (dtksh_client_data_t *)NULL) {
                errmsg = strdup(GETMESSAGE(
                    5, 20, "The following is an invalid callback handle: %s"));
                printerrf(argv[0], errmsg, argv[1], NULL, NULL, NULL, NULL,
                          NULL, NULL, NULL);
                free(errmsg);
                return (1);
        ...
        return (RemoveOneCallback(argv[0], cdata->w->widid, NULL,
                                  cdata->ksh_cmd, NULL, argv[1]));
}

/*****************************************************************************/
/*****************************************************************************/

int do_DtDbLoad(int argc, char *argv[]) {
        char *errmsg;
 ...
 * new one.
 */
int do_DtDbReloadNotify(int argc, char *argv[]) {
        char *errmsg;
        static Boolean firstTime = True;

        if (argc != 2) {
                errmsg = strdup(
                    GETMESSAGE(5, 84, "Usage: DtDbReloadNotify ksh-command"));
                printerr(str_nill, errmsg, NULL);
                free(errmsg);
                return (1);
        }
        ...
        if (firstTime) {
                firstTime = False;
                DtDbReloadNotify((DtDbReloadCallbackProc)DtkReloadHandler,
                                 NULL);
        }
 ...
 */
int do_DtActionExists(int argc, char *argv[]) {
        char *errmsg;

        if (argc != 2) {
                errmsg = strdup(
                    GETMESSAGE(5, 85, "Usage: DtActionExists actionName"));
                printerr(str_nill, errmsg, NULL);
                free(errmsg);
                return (1);
        }
 ...
 * is returned.
 */
int do_DtActionLabel(int argc, char *argv[]) {
        char *errmsg;
        char *label;

        if (argc != 3) {
                errmsg = strdup(GETMESSAGE(
                    5, 86, "Usage: DtActionLabel variable actionName"));
                printerr(str_nill, errmsg, NULL);
                free(errmsg);
                return (1);
        }
 ...
 * is returned.
 */
int do_DtActionDescription(int argc, char *argv[]) {
        char *errmsg;
        char *description;

        if (argc != 3) {
                errmsg = strdup(GETMESSAGE(
                    5, 87, "Usage: DtActionDescription variable actionName"));
                printerr(str_nill, errmsg, NULL);
                free(errmsg);
                return (1);
        }
...
static void _DtActionInvokeUsage(void) {
        ...
        errmsg = strdup(GETMESSAGE(5, 88,
                                   "Usage: DtActionInvoke widget actionName "
                                   "termParms execHost contextDir useIndicator "
                                   "ksh-command [\"FILE\" fileName] ..."));
        printerr(str_nill, errmsg, NULL);
        free(errmsg);
}
 ...
 */
int do_DtActionInvoke(int argc, char *argv[]) {
        wtab_t *w;
         ...
         * This will have to change when/if we support arguments other than
         * files.
         */
        if ((aac = (argc - 8) / 2) > 0) {
         ...
         */
        DtActionInvoke(w->w, argv[2], aap, aac, termParms, execHost, contextDir,
                       useIndicator, NULL, (XtPointer)NULL);
        UnlockKshFileDescriptors(lockedFds);
...
int do_DtDtsLoadDataTypes(int argc, char *argv[]) {
        char *errmsg;
...
int do_DtDtsFileToDataType(int argc, char *argv[]) {
        char *errmsg;
        char *datatype;

        if (argc != 3) {
                errmsg = strdup(GETMESSAGE(
                    5, 90, "Usage: DtDtsFileToDataType variable fileName"));
                printerr(str_nill, errmsg, NULL);
                free(errmsg);
                return (1);
        }
...
int do_DtDtsFileToAttributeValue(int argc, char *argv[]) {
        char *errmsg;
        char *attribute;

        if (argc != 4) {
                errmsg = strdup(GETMESSAGE(5, 91,
                                           "Usage: DtDtsFileToAttributeValue "
                                           "variable fileName attrName"));
                printerr(str_nill, errmsg, NULL);
                free(errmsg);
                return (1);
        }
...
int do_DtDtsFileToAttributeList(int argc, char *argv[]) {
        char *errmsg;
        char *attributeList;
        ...
        if (attributes = DtDtsFileToAttributeList(argv[2])) {
                ...
                for (i = 0; attributes[i]; i++) {
                        attributeList = XtRealloc(
                            attributeList, strlen(attributeList) +
...
int do_DtDtsDataTypeToAttributeValue(int argc, char *argv[]) {
        char *errmsg;
        char *attribute;
        char *optName;
        ...
        if ((argc != 4) && (argc != 5)) {
                errmsg = strdup(
                    GETMESSAGE(5, 93,
                               "Usage: DtDtsDataTypeToAttributeValue variable "
        ...
        if (attribute =
                DtDtsDataTypeToAttributeValue(argv[2], argv[3], optName)) {
                alt_env_set_var(argv[1], attribute);
                DtDtsFreeAttributeValue(attribute);
        } else
                alt_env_set_var(argv[1], str_nill);
...
int do_DtDtsDataTypeToAttributeList(int argc, char *argv[]) {
        char *errmsg;
        char *attributeList;
        DtDtsAttribute **attributes;
        int i;
        ...
        if ((argc != 3) && (argc != 4)) {
                errmsg =
                    strdup(GETMESSAGE(5, 94,
                                      "Usage: DtDtsDataTypeToAttributeList "
                                      "variable dataType optName"));
                printerr(str_nill, errmsg, NULL);
                free(errmsg);
                return (1);
        }
...
int do_DtDtsFindAttribute(int argc, char *argv[]) {
        char *errmsg;
        char *dataTypeList;
        char **dataTypes;
        int i;
        ...
        if (argc != 4) {
                errmsg = strdup(GETMESSAGE(
                    5, 95, "Usage: DtDtsFindAttribute variable name value"));
                printerr(str_nill, errmsg, NULL);
                free(errmsg);
                return (1);
        }
...
int do_DtDtsDataTypeNames(int argc, char *argv[]) {
        char *errmsg;
        char *dataTypeList;
        char **dataTypes;
        int i;
        ...
        if (argc != 2) {
                errmsg = strdup(
                    GETMESSAGE(5, 96, "Usage: DtDtsDataTypeNames variable"));
                printerr(str_nill, errmsg, NULL);
                free(errmsg);
                return (1);
        }
...
int do_DtDtsSetDataType(int argc, char *argv[]) {
        char *errmsg;
        char *savedDataType;
        Boolean override;
        ...
        if (argc != 5) {
                errmsg = strdup(GETMESSAGE(5, 97,
                                           "Usage: DtDtsSetDataType variable "
                                           "fileName dataType override"));
                printerr(str_nill, errmsg, NULL);
                free(errmsg);
                return (1);
        }
...
int do_DtDtsDataTypeIsAction(int argc, char *argv[]) {
        char *errmsg;

        if (argc != 2) {
                errmsg = strdup(
                    GETMESSAGE(5, 98, "Usage: DtDtsDataTypeIsAction dataType"));
                printerr(str_nill, errmsg, NULL);
                free(errmsg);
                return (1);
        }
 ...
 */
int do_ttdt_open(int argc, char *argv[]) {
        char *errmsg;
        char *procId;
        Boolean sendStarted;
        XrmValue toVal;
        ...
        if (argc != 8) {
                errmsg = strdup(
                    GETMESSAGE(5, 99,
                               "Usage: ttdt_open variable status variable2 "
                               "toolname vendor version sendStarted"));
                printerr(str_nill, errmsg, NULL);
                free(errmsg);
                return (1);
        }
 ...
 */
int do_ttdt_close(int argc, char *argv[]) {
        char *errmsg;
        Boolean sendStopped;
        XrmValue fval, tval;
        Tt_status ttStatus;
 ...
 */
int do_tttk_Xt_input_handler(int argc, char *argv[]) {
        char *errmsg;
        int source;
        XtInputId fid;
        char *p;
        ...
        if (argc != 4) {
                errmsg = strdup(GETMESSAGE(
                    5, 100, "Usage: tttk_Xt_input_handler procId source id"));
                printerr(str_nill, errmsg, NULL);
                free(errmsg);
                return (1);
        }
        ...
        if (p == argv[2]) {
                errmsg = strdup(GETMESSAGE(
                    5, 101, "The source parameter must be an integer: %s"));
                printerrf(argv[0], errmsg, argv[2], NULL, NULL, NULL, NULL,
                          NULL, NULL, NULL);
                free(errmsg);
                return (1);
        ...
        if (p == argv[3]) {
                errmsg = strdup(GETMESSAGE(
                    5, 102, "The id parameter must be a hex number: %s"));
                printerrf(argv[0], errmsg, argv[3], NULL, NULL, NULL, NULL,
                          NULL, NULL, NULL);
                free(errmsg);
                return (1);
...
int do_ttdt_session_join(int argc, char *argv[]) {
        char *errmsg;
        Boolean join;
        char *sessId;
        XrmValue fval, tval;
        ...
        if (argc != 6) {
                errmsg = strdup(
                    GETMESSAGE(5, 104,
                               "Usage: ttdt_session_join variable status "
                               "sessId shellWidgetHandle join"));
                printerr(str_nill, errmsg, NULL);
                free(errmsg);
                return (1);
        }
...
int do_ttdt_session_quit(int argc, char *argv[]) {
        char *errmsg;
        Boolean quit;
        char *sessId;
        XrmValue fval, tval;
        ...
        if (argc != 5) {
                errmsg = strdup(GETMESSAGE(5, 105,
                                           "Usage: ttdt_session_quit status "
                                           "sessId sessPatterns quit"));
                printerr(str_nill, errmsg, NULL);
                free(errmsg);
                return (1);
        }
...
int do_ttdt_file_event(int argc, char *argv[]) {
        char *errmsg;
        XrmValue fval, tval;
        Tt_status ttStatus;
        char *statusString;
        ...
        if (argc != 5) {
                errmsg = strdup(GETMESSAGE(
                    5, 107, "Usage: ttdt_file_event status op patterns send"));
                printerr(str_nill, errmsg, NULL);
                free(errmsg);
                return (1);
        }
...
int do_ttdt_file_join(int argc, char *argv[]) {
        char *errmsg;
        XrmValue fval, tval;
        Tt_status ttStatus;
        char *statusString;
        ...
        if (argc != 7) {
                errmsg = strdup(
                    GETMESSAGE(5, 115,
                               "Usage: ttdt_file_join variable status pathName "
                               "scope join ksh-command"));
                printerr(str_nill, errmsg, NULL);
                free(errmsg);
                return (1);
        }
        ...
        if (ttStatus == TT_OK) {
                ...
                if (i >= sizeFileCBList) {
                        /* Grow the array */
                        sizeFileCBList += 10;
                        fileCBList = (Ttdt_file_cb_data **)XtRealloc(
                            (char *)fileCBList,
...
int do_ttdt_file_quit(int argc, char *argv[]) {
        char *errmsg;
        XrmValue fval, tval;
        Tt_status ttStatus;
        char *statusString;
        ...
        if (argc != 4) {
                errmsg = strdup(GETMESSAGE(
                    5, 108, "Usage: ttdt_file_quit status patterns quit"));
                printerr(str_nill, errmsg, NULL);
                free(errmsg);
                return (1);
        }
...
int do_ttdt_Get_Modified(int argc, char *argv[]) {
        char *errmsg;
        XrmValue fval, tval;
        Tt_scope scope;
        int timeout;
        ...
        if (argc != 4) {
                errmsg = strdup(GETMESSAGE(
                    5, 109, "Usage: ttdt_Get_Modified pathName scope timeout"));
                printerr(str_nill, errmsg, NULL);
                free(errmsg);
                return (1);
        }
...
static int ttdt_SaveOrRevert(Tt_status (*func)(), int argc, char *argv[]) {
        ...
        if (argc != 5) {
                errmsg = strdup(GETMESSAGE(
                    5, 110, "Usage: %s status pathName scope timeout"));
                printerrf(str_nill, errmsg, argv[0], NULL, NULL, NULL, NULL,
                          NULL, NULL, NULL);
                free(errmsg);
                return (1);
        ...
        if (p == argv[4]) {
                errmsg = strdup(GetSharedMsg(DT_BAD_TIMEOUT));
                printerrf(argv[0], errmsg, argv[4], NULL, NULL, NULL, NULL,
                          NULL, NULL, NULL);
                free(errmsg);
                return (1);
        }
...
int do_ttdt_Save(int argc, char *argv[]) {
        return (ttdt_SaveOrRevert(ttdt_Save, argc, argv));
}

int do_ttdt_Revert(int argc, char *argv[]) {
        return (ttdt_SaveOrRevert(ttdt_Revert, argc, argv));
}

int do_tt_error_pointer(int argc, char *argv[]) {
        char *errmsg;
        XrmValue fval, tval;
        Tt_status ttStatus;
        void *errPtr;
        ...
        if (argc != 3) {
                errmsg = strdup(GETMESSAGE(
                    5, 112, "Usage: tt_error_pointer variable ttStatus"));
                printerr(str_nill, errmsg, NULL);
                free(errmsg);
                return (1);
        }
...
int do_tttk_message_destroy(int argc, char *argv[]) {
        return (message_DestroyOrReply(tttk_message_destroy, argc, argv));
}

int do_tt_message_reply(int argc, char *argv[]) {
...
int do_tttk_message_reject(int argc, char *argv[]) {
        return (message_FailOrReject(tttk_message_reject, argc, argv));
}

int do_tttk_message_fail(int argc, char *argv[]) {
...
static int tt_netfile_handler(int paramCount, char *(*func)(), char *usageMsg,
        ...
        /*
         * Map the ttStatus into a string.  Note that we can't call the
         * XtConvert function, since a shell script may not have called
         * XtInitialize.
         */
...
int do_tt_file_netfile(int argc, char *argv[]) {
        char *usageMsg;
        int results;

        usageMsg = strdup(GETMESSAGE(
            5, 116, "Usage: tt_file_netfile variable status filename"));
        results = tt_netfile_handler(4, tt_file_netfile, usageMsg, argc, argv);
        XtFree(usageMsg);
        return (results);
}

int do_tt_netfile_file(int argc, char *argv[]) {
        char *usageMsg;
        int results;

        usageMsg = strdup(GETMESSAGE(
            5, 117, "Usage: tt_netfile_file variable status netfilename"));
        results = tt_netfile_handler(4, tt_netfile_file, usageMsg, argc, argv);
        XtFree(usageMsg);
        return (results);
}

int do_tt_host_file_netfile(int argc, char *argv[]) {
        char *usageMsg;
        int results;
        ...
        results =
            tt_netfile_handler(5, tt_host_file_netfile, usageMsg, argc, argv);
        XtFree(usageMsg);
        return (results);
}

int do_tt_host_netfile_file(int argc, char *argv[]) {
        char *usageMsg;
        int results;
        ...
        results =
            tt_netfile_handler(5, tt_host_netfile_file, usageMsg, argc, argv);
        XtFree(usageMsg);
        return (results);
}
                ...
                if (C[i].class == class) {
                        if (C[i].disciplines) {
                                while (C[i].disciplines[j].callbackName) {
                                        if (strcmp(cbname, C[i].disciplines[j]
                                                               .callbackName) ==
                                            0)
                                                return (C[i].disciplines[j]
                                                            .discipline);
 ...
 */
Namval_t *GetNameValuePair(char *name) {
        Namval_t *np2;
        Namval_t **list;
        int i;
        ...
        if (((np2 = nv_search(name, sh.var_tree, 0)) == NULL) ||
            (nestingLevel == 0)) {
                ...
                if (nestingLevel + 1 > npTableSize) {
                        npTable = (Namval_t ***)XtRealloc(
                            (char *)npTable,
                            sizeof(Namval_t **) * (nestingLevel + 1));
                        npListSizes =
                            (int *)XtRealloc((char *)npListSizes,
                ...
                /*
                 * I _think_ this works OK, because I _think_ the subshell code
                 * will automatically clean up the "extra" Namval_t it might
                 * create here. As long as we clean up the original, I don't
                 * think we leak here.
                 */
                if (sh.subshell)
...
static Namval_t *ProcessIntTable(int *table, int count, Namval_t *np,
        ...
        if (count > 0) {
                for (i = 0; i < count; i++) {
                        ...
                        buf = XtRealloc(buf, strlen(buf) + strlen(buf2) +
                                                 (i == 0 ? 1 : 2));
                        if (i != 0)
                                strcat(buf, ",");
                        strcat(buf, buf2);
...
static EventEntryTable xanyTable[] = {
    ...
    {"DISPLAY", "XE_HexValue", XtOffsetOf(XEvent, xany.display),
     sizeof(Display *)},
    {"WINDOW", "XE_Window", XtOffsetOf(XEvent, xany.window), sizeof(Window)},
    {NULL, NULL, 0, 0},
};
...
static EventEntryTable xbuttonTable[] = {
    ...
    {"DISPLAY", "XE_HexValue", XtOffsetOf(XEvent, xbutton.display),
     sizeof(Display *)},
    {"WINDOW", "XE_Window", XtOffsetOf(XEvent, xbutton.window), sizeof(Window)},
    {"ROOT", "XE_Window", XtOffsetOf(XEvent, xbutton.root), sizeof(Window)},
    {"SUBWINDOW", "XE_Window", XtOffsetOf(XEvent, xbutton.subwindow),
     sizeof(Window)},
    {"TIME", "XE_IntValue", XtOffsetOf(XEvent, xbutton.time),
     sizeof(unsigned int)},
    {"X", "XE_IntValue", XtOffsetOf(XEvent, xbutton.x), sizeof(int)},
    {"Y", "XE_IntValue", XtOffsetOf(XEvent, xbutton.y), sizeof(int)},
    {"X_ROOT", "XE_IntValue", XtOffsetOf(XEvent, xbutton.x_root), sizeof(int)},
    {"Y_ROOT", "XE_IntValue", XtOffsetOf(XEvent, xbutton.y_root), sizeof(int)},
...
static EventEntryTable xexposeTable[] = {
    ...
    {"DISPLAY", "XE_HexValue", XtOffsetOf(XEvent, xexpose.display),
     sizeof(Display *)},
    {"WINDOW", "XE_Window", XtOffsetOf(XEvent, xexpose.window), sizeof(Window)},
    {"X", "XE_IntValue", XtOffsetOf(XEvent, xexpose.x), sizeof(int)},
    {"Y", "XE_IntValue", XtOffsetOf(XEvent, xexpose.y), sizeof(int)},
    {"WIDTH", "XE_IntValue", XtOffsetOf(XEvent, xexpose.width), sizeof(int)},
    {"HEIGHT", "XE_IntValue", XtOffsetOf(XEvent, xexpose.height), sizeof(int)},
    {"COUNT", "XE_IntValue", XtOffsetOf(XEvent, xexpose.count), sizeof(int)},
    {NULL, NULL, 0, 0},
};
...
static EventEntryTable xgraphicsExposeTable[] = {
    {"TYPE", "XE_EventType", XtOffsetOf(XEvent, xgraphicsexpose.type),
     sizeof(int)},
    ...
    {"DRAWABLE", "XE_Window", XtOffsetOf(XEvent, xgraphicsexpose.drawable),
     sizeof(Window)},
    {"X", "XE_IntValue", XtOffsetOf(XEvent, xgraphicsexpose.x), sizeof(int)},
    {"Y", "XE_IntValue", XtOffsetOf(XEvent, xgraphicsexpose.y), sizeof(int)},
    ...
    {"MAJOR_CODE", "XE_IntValue",
     XtOffsetOf(XEvent, xgraphicsexpose.major_code), sizeof(int)},
    {"MINOR_CODE", "XE_IntValue",
     XtOffsetOf(XEvent, xgraphicsexpose.minor_code), sizeof(int)},
    {NULL, NULL, 0, 0},
};
...
static EventEntryTable xkeyTable[] = {
    ...
    {"SERIAL", "XE_IntValue", XtOffsetOf(XEvent, xkey.serial),
     sizeof(unsigned long)},
    {"SEND_EVENT", "X_Bool", XtOffsetOf(XEvent, xkey.send_event), sizeof(Bool)},
    {"DISPLAY", "XE_HexValue", XtOffsetOf(XEvent, xkey.display),
     sizeof(Display *)},
    {"WINDOW", "XE_Window", XtOffsetOf(XEvent, xkey.window), sizeof(Window)},
    {"ROOT", "XE_Window", XtOffsetOf(XEvent, xkey.root), sizeof(Window)},
    {"SUBWINDOW", "XE_Window", XtOffsetOf(XEvent, xkey.subwindow),
     sizeof(Window)},
    {"TIME", "XE_IntValue", XtOffsetOf(XEvent, xkey.time),
     sizeof(unsigned int)},
    {"X", "XE_IntValue", XtOffsetOf(XEvent, xkey.x), sizeof(int)},
    {"Y", "XE_IntValue", XtOffsetOf(XEvent, xkey.y), sizeof(int)},
    {"X_ROOT", "XE_IntValue", XtOffsetOf(XEvent, xkey.x_root), sizeof(int)},
    {"Y_ROOT", "XE_IntValue", XtOffsetOf(XEvent, xkey.y_root), sizeof(int)},
...
static EventEntryTable xmotionTable[] = {
    ...
    {"DISPLAY", "XE_HexValue", XtOffsetOf(XEvent, xmotion.display),
     sizeof(Display *)},
    {"WINDOW", "XE_Window", XtOffsetOf(XEvent, xmotion.window), sizeof(Window)},
    {"ROOT", "XE_Window", XtOffsetOf(XEvent, xmotion.root), sizeof(Window)},
    {"SUBWINDOW", "XE_Window", XtOffsetOf(XEvent, xmotion.subwindow),
     sizeof(Window)},
    {"TIME", "XE_IntValue", XtOffsetOf(XEvent, xmotion.time),
     sizeof(unsigned int)},
    {"X", "XE_IntValue", XtOffsetOf(XEvent, xmotion.x), sizeof(int)},
    {"Y", "XE_IntValue", XtOffsetOf(XEvent, xmotion.y), sizeof(int)},
    {"X_ROOT", "XE_IntValue", XtOffsetOf(XEvent, xmotion.x_root), sizeof(int)},
    {"Y_ROOT", "XE_IntValue", XtOffsetOf(XEvent, xmotion.y_root), sizeof(int)},
        ...
        if (name = strtok(NULL, ".")) {
                if (event == NULL)
                        ...
                        if (strcmp(name, "TYPE") == 0) {
                                ...
                                XtConvert(Toplevel, "XE_EventType", &fval,
                                          XtRString, &tval);
                                if (tval.size != 0)
                                        ptr = (char *)(tval.addr);
                                else
                                ...
                                while (eventTable[i].eventType) {
                                        if (strcmp(eventTable[i].eventType,
                                                   name) == 0) {
                                                sprintf(buf, "0x%lx",
                                                        (long)event);
                                                nv_putval(np2, buf, NV_RDONLY);
...
static Namval_t *ProcessCallbackReason(XmAnyCallbackStruct *cbData,
                                       Namval_t *np, char *name, Namfun_t *fp) {
        return (
            _IntProcessCallbackReason(CallbackReasons, cbData, np, name, fp));
}
...
static Namval_t *ProcessHelpCallbackReason(XmAnyCallbackStruct *cbData,
                                           Namval_t *np, char *name,
                                           Namfun_t *fp) {
        return (_IntProcessCallbackReason(HelpCallbackReasons, cbData, np, name,
                                          fp));
}
 ...
 */
Namval_t *nopCreateDisc(Namval_t *np, char *name, Namfun_t *fp) {
        Namval_t *np2;
        char *token;
 ...
 */
Namval_t *dftCreateDisc(Namval_t *np, char *name, Namfun_t *fp) {
        Namval_t *np2;
        char buf[128];
        XmAnyCallbackStruct *cbData;
        char *cbDataAddrStr;
        ...
        if (cbData == NULL)
                ...
                np2 = ProcessCallbackReason((XmAnyCallbackStruct *)cbData, np,
                                            token, fp);
 ...
 */
Namval_t *ehCreateDisc(Namval_t *np, char *name, Namfun_t *fp) {
        Namval_t *np2;
        char buf[128];
        XEvent *event;
        char *eventAddrStr;
 ...
 * It only knows how to reference the event structure.
 */
Namval_t *transCreateDisc(Namval_t *np, char *name, Namfun_t *fp) {
        Namval_t *np2;
        char buf[128];
        XEvent *event;
        char *eventAddrStr;
 ...
 */
Namval_t *scaleCreateDisc(Namval_t *np, char *name, Namfun_t *fp) {
        char *cbDataAddrStr;
        ...
        if (cbData == NULL)
                ...
                np2 = ProcessIntValue((int)cbData->value, np, token, fp, "%d",
                                      NULL);
        else
                np2 = CreateEmptyNameValuePair(np, token, fp);
 ...
 */
Namval_t *arrowCreateDisc(Namval_t *np, char *name, Namfun_t *fp) {
        char *cbDataAddrStr;
        ...
        if (cbData == NULL)
                ...
                if (cbData->reason == XmCR_ACTIVATE) {
                        np2 = ProcessIntValue((int)cbData->click_count, np,
                                              token, fp, "%d", NULL);
                } else
                        np2 = CreateEmptyNameValuePair(np, token, fp);
        } else
 ...
 */
Namval_t *comboCreateDisc(Namval_t *np, char *name, Namfun_t *fp) {
        char *cbDataAddrStr;
        ...
        if (cbData == NULL)
                ...
                np2 = ProcessIntValue((int)cbData->item_position, np, token, fp,
                                      "%d", NULL);
        } else
                np2 = CreateEmptyNameValuePair(np, token, fp);
 ...
 */
Namval_t *cmdCreateDisc(Namval_t *np, char *name, Namfun_t *fp) {
        char *cbDataAddrStr;
 ...
 */
Namval_t *dAreaCreateDisc(Namval_t *np, char *name, Namfun_t *fp) {
        char *cbDataAddrStr;
        ...
        if (cbData == NULL)
                ...
                np2 = ProcessIntValue((int)cbData->window, np, token, fp,
                                      "0x%x", NULL);
        else
                np2 = CreateEmptyNameValuePair(np, token, fp);
 ...
 */
Namval_t *dbtnCreateDisc(Namval_t *np, char *name, Namfun_t *fp) {
        char *cbDataAddrStr;
 ...
 */
Namval_t *fselCreateDisc(Namval_t *np, char *name, Namfun_t *fp) {
        char *cbDataAddrStr;
        ...
        cbDataAddrStr = nv_getv(np, fp);
        cbData =
            (XmFileSelectionBoxCallbackStruct *)strtoul(cbDataAddrStr, &p, 0);
 ...
 */
Namval_t *listCreateDisc(Namval_t *np, char *name, Namfun_t *fp) {
        char *cbDataAddrStr;
        ...
        if (cbData == NULL)
                ...
                if ((cbData->reason == XmCR_DEFAULT_ACTION) ||
                    (cbData->reason == XmCR_MULTIPLE_SELECT) ||
                    (cbData->reason == XmCR_EXTENDED_SELECT)) {
                        np2 = ProcessIntValue((int)cbData->selected_item_count,
                                              np, token, fp, "%d", NULL);
                } else
                        np2 = CreateEmptyNameValuePair(np, token, fp);
                ...
                if ((cbData->reason == XmCR_DEFAULT_ACTION) ||
                    ...
                    (cbData->reason == XmCR_EXTENDED_SELECT)) {
                        np2 = ProcessIntTable(cbData->selected_item_positions,
                                              cbData->selected_item_count, np,
                                              token, fp);
                } else
                        np2 = CreateEmptyNameValuePair(np, token, fp);
        } else if (strcmp(token, "SELECTION_TYPE") == 0) {
                if (cbData->reason == XmCR_EXTENDED_SELECT)
                        np2 = ProcessSelectionType(cbData->selection_type, np,
                                                   token, fp);
                else
                        np2 = CreateEmptyNameValuePair(np, token, fp);
        } else
 ...
 */
Namval_t *pbtnCreateDisc(Namval_t *np, char *name, Namfun_t *fp) {
        char *cbDataAddrStr;
 ...
 */
Namval_t *rcCreateDisc(Namval_t *np, char *name, Namfun_t *fp) {
        char *cbDataAddrStr;
        ...
        if (cbData == NULL)
                ...
                np2 = ProcessWidgetHandle(cbData->widget, np, token, fp);
                   ...
                   (cbData->reason == XmCR_ACTIVATE))
                np2 = ProcessIntValue((int)cbData->data, np, token, fp, "0x%x",
                                      NULL);
        else if ((strcmp(token, "CALLBACKSTRUCT") == 0) &&
                 (cbData->reason == XmCR_ACTIVATE)) {
                np2 = ProcessIntValue((int)cbData->callbackstruct, np, token,
                                      fp, "0x%x", NULL);
        } else
                np2 = CreateEmptyNameValuePair(np, token, fp);
 ...
 */
Namval_t *sbarCreateDisc(Namval_t *np, char *name, Namfun_t *fp) {
        char *cbDataAddrStr;
        ...
        if (cbData == NULL)
                ...
                if ((cbData->reason == XmCR_TO_BOTTOM) ||
                    (cbData->reason == XmCR_TO_TOP))
                        np2 = ProcessIntValue((int)cbData->pixel, np, token, fp,
                                              "%d", NULL);
                else
                        np2 = CreateEmptyNameValuePair(np, token, fp);
        } else
 ...
 */
Namval_t *swinCreateDisc(Namval_t *np, char *name, Namfun_t *fp) {
        char *cbDataAddrStr;
        ...
        cbDataAddrStr = nv_getv(np, fp);
        cbData =
            (XmTraverseObscuredCallbackStruct *)strtoul(cbDataAddrStr, &p, 0);
        ...
        if (cbData == NULL)
                ...
                np2 = ProcessWidgetHandle(cbData->traversal_destination, np,
                                          token, fp);
        else if (strcmp(token, "DIRECTION") == 0)
                np2 =
                    ProcessTraversalDirection(cbData->direction, np, token, fp);
        else
                np2 = CreateEmptyNameValuePair(np, token, fp);
 ...
 */
Namval_t *sboxCreateDisc(Namval_t *np, char *name, Namfun_t *fp) {
        char *cbDataAddrStr;
 ...
 */
Namval_t *tbtnCreateDisc(Namval_t *np, char *name, Namfun_t *fp) {
        char *cbDataAddrStr;
        ...
        if (cbData == NULL)
                ...
                np2 = ProcessBooleanIntValue((int)cbData->set, np, token, fp,
                                             NULL);
        else
                np2 = CreateEmptyNameValuePair(np, token, fp);
 ...
 */
Namval_t *textCreateDisc(Namval_t *np, char *name, Namfun_t *fp) {
        char *cbDataAddrStr;
        ...
        if (cbData == NULL)
                ...
                np2 = ProcessBooleanIntValue((int)cbData->doit, np, token, fp,
                                             disc);
        } else if (strcmp(token, "CURRINSERT") == 0)
                np2 = ProcessIntValue((int)cbData->currInsert, np, token, fp,
                                      "%d", NULL);
        else if (strcmp(token, "NEWINSERT") == 0)
                np2 = ProcessIntValue((int)cbData->newInsert, np, token, fp,
                                      "%d", NULL);
                ...
                if ((cbData->reason == XmCR_LOSING_FOCUS) ||
                    (cbData->reason == XmCR_MODIFYING_TEXT_VALUE)) {
                        np2 = ProcessIntValue((int)cbData->startPos, np, token,
                                              fp, "%d", disc);
                } else
                        np2 = CreateEmptyNameValuePair(np, token, fp);
                ...
                if ((cbData->reason == XmCR_LOSING_FOCUS) ||
                    (cbData->reason == XmCR_MODIFYING_TEXT_VALUE)) {
                        np2 = ProcessIntValue((int)cbData->endPos, np, token,
                                              fp, "%d", disc);
                } else
                        np2 = CreateEmptyNameValuePair(np, token, fp);
                ...
                if (cbData->reason == XmCR_MODIFYING_TEXT_VALUE) {
                        ...
                        if (token = strtok(NULL, ".")) {
                                ...
                                if (strcmp(token, "PTR") == 0) {
                                        ...
                                        if (disc == NULL)
                                                disc = CloneDiscipline(
                                                    &text_ptr_disc);

                                        /* Any old disciplies MUST be cleared,
                                        ...
                                        f.addr =
                                            (caddr_t) & (cbData->text->format);
                                        f.size = sizeof(XmTextFormat);
                                        t.addr = NULL;
                                        t.size = 0;
                                        XtConvert(Toplevel, "TextFormat", &f,
                                                  XtRString, &t);
 ...
 */
Namval_t *textCreateDisc2(Namval_t *np, char *name, Namfun_t *fp) {
        char *cbDataAddrStr;
        ...
        if (cbData == NULL)
                ...
                if (token = strtok(NULL, ".")) {
                        ...
                        if (strcmp(token, "WCSPTR") == 0) {
                                ...
                                if (disc == NULL)
                                        disc =
                                            CloneDiscipline(&text_wcsptr_disc);

                                /* Any old disciplies MUST be cleared, before
                                 * setting value */
                                nv_stack(np2, NULL);
                                if (cbData->text->wcsptr) {
                                        ...
                                        /*
                                         * It appears that the wchar string
                                         * coming in is NOT NULL terminated; we
                                         * must make our own copy, before
                                         * calling wcstombs().
                                         */
                                        wcBuf = (wchar_t *)XtMalloc(
                                            (cbData->text->length + 1) *
                                            sizeof(wchar_t));
                                        for (i = 0; i < cbData->text->length;
                                             i++)
                                                wcBuf[i] =
                                                    cbData->text->wcsptr[i];
                                        wcBuf[i] = 0;
                                ...
                                if (disc == NULL)
                                        disc =
                                            CloneDiscipline(&text_wcslen_disc);
 ...
 */
Namval_t *helpCreateDisc(Namval_t *np, char *name, Namfun_t *fp) {
        char *cbDataAddrStr;
        ...
        if (cbData == NULL)
                 ...
                 * callback reasons are not unique!  They overlap with the
                 * normal callback reasons.
                 */
                np2 = ProcessHelpCallbackReason((XmAnyCallbackStruct *)cbData,
                                                np, token, fp);
        } else if (strcmp(token, "EVENT") == 0) {
                if (cbData->event)
                        np2 =
                            ProcessCallbackEvent(cbData->event, np, token, fp);
                else
                        np2 = CreateEmptyNameValuePair(np, token, fp);
        } else if (strcmp(token, "LOCATIONID") == 0) {
                if (cbData->reason == DtCR_HELP_LINK_ACTIVATE)
                        np2 = ProcessStringValue(cbData->locationId, np, token,
                                                 fp);
                else
                        np2 = CreateEmptyNameValuePair(np, token, fp);
        } else if (strcmp(token, "HELPVOLUME") == 0) {
                if (cbData->reason == DtCR_HELP_LINK_ACTIVATE)
                        np2 = ProcessStringValue(cbData->helpVolume, np, token,
                                                 fp);
                else
                        np2 = CreateEmptyNameValuePair(np, token, fp);
        } else if (strcmp(token, "SPECIFICATION") == 0) {
                if (cbData->reason == DtCR_HELP_LINK_ACTIVATE)
                        np2 = ProcessStringValue(cbData->specification, np,
                                                 token, fp);
                else
                        np2 = CreateEmptyNameValuePair(np, token, fp);
                ...
                if (cbData->reason == DtCR_HELP_LINK_ACTIVATE)
                        np2 =
                            ProcessHyperType(cbData->hyperType, np, token, fp);
                else
                        np2 = CreateEmptyNameValuePair(np, token, fp);
        } else
                np2 = CreateEmptyNameValuePair(np, token, fp);
 ...
 */
Namval_t *dtPrintSetupProcDisc(Namval_t *np, char *name, Namfun_t *fp) {
        char *cbDataAddrStr;
        ...
        if (cbData == NULL)
                ...
                np2 = ProcessIntValue(cbData->destination, np, token, fp, "%d",
                                      NULL);
...
static void FreeDiscipline(Namfun_t *discipline) { XtFree((char *)discipline); }
...
void SetTextDoit(Namval_t *np, char *name, Namfun_t *fp) {
        ...
        if (cbDataNp = nv_open("CB_CALL_DATA", sh.var_tree, 0)) {
                ...
                cbData =
                    (XmTextVerifyCallbackStruct *)strtoul(cbDataAddrStr, &p, 0);
                cbData->doit = doit;
        }
}
...
void SetTextWCSptr(Namval_t *np, char *name, Namfun_t *fp) {
        ...
        if (cbDataNp = nv_open("CB_CALL_DATA", sh.var_tree, 0)) {
                cbDataAddrStr = nv_getv(cbDataNp, NULL);
                cbData = (XmTextVerifyCallbackStructWcs *)strtoul(cbDataAddrStr,
                                                                  &p, 0);
                 ...
                 */
                wcBuf =
                    (wchar_t *)XtMalloc((strlen(name) + 1) * sizeof(wchar_t));
...
void stdPrintSetupProc(int proctype, void *widget, DtPrintSetupData *callData) {
        wtab_t *w;
        ProcInfo_t *pinfo;
        char buf[128];
        Namval_t *np;
        ...
        while (class) {
                if (discipline =
                        CheckClassDisciplines(class, DtRPrintSetupProc))
                        break;
                class = class->core_class.superclass;
        }
...
void stdPrinterInfoProc(void *widget, DtPrintSetupData *callData) {
        stdPrintSetupProc(PRINTER_INFO_PROC, widget, callData);
        return;
}

void stdSelectFileProc(void *widget, DtPrintSetupData *callData) {
        stdPrintSetupProc(SELECT_FILE_PROC, widget, callData);
        return;
}

void stdSelectPrinterProc(void *widget, DtPrintSetupData *psd) {
        stdPrintSetupProc(SELECT_PRINTER_PROC, widget, psd);
        return;
}

void stdSetupProc(void *widget, DtPrintSetupData *callData) {
        stdPrintSetupProc(SETUP_PROC, widget, callData);
        return;
}

void stdVerifyPrinterProc(void *widget, DtPrintSetupData *callData) {
