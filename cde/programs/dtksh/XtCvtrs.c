...
static void FreePixel(XtAppContext app, XrmValuePtr toVal, XtPointer closure,
...
Boolean DtkshCvtStringToPixel(Display *dpy, XrmValuePtr args,
                ...
                if (XLookupColor(DisplayOfScreen(screen), colormap, (char *)str,
                        ...
                        *closure_ret = (char *)True;
                        ...
                        if (p == str) {
                                ...
                                errmsg =
                                    GETMESSAGE(1, 1,
                                               "DtkshCvtStringToPixel: The "
                                               "color '%s' is not defined");
                                errbuf =
                                    XtMalloc(strlen(errmsg) + strlen(str) + 10);
...
Boolean DtCompareISOLatin1(char *first, char *second) {
...
void RegisterXtOverrideConverters(void) {
