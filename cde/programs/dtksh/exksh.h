...
#define F_FIELD                                                                \
        (2)              /* memtbl is a field of a structure, not the          \
                                                     name of a type */
#define F_TBL_IS_PTR (4) /* tbl field is pointer, not number; */
#define F_TYPE_IS_PTR                                                          \
        (8) /* type is built-in, but is already a pointer, like K_STRING */
...
#define XK_PRINT(ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, ARG7)                     \
        (_Delim = 0, xk_print(ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, ARG7))
#define XK_PARSE(ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, ARG7)                     \
        (_Delim = 0, xk_parse(ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, ARG7))
#define XK_FREE(ARG1, ARG2, ARG3, ARG4, ARG5)                                  \
        (_Delim = 0, xk_free(ARG1, ARG2, ARG3, ARG4, ARG5))
#endif
