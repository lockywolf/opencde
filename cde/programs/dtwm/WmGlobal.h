...
#define WM_SHOW_FB_ALL                                                         \
        (WM_SHOW_FB_BEHAVIOR | WM_SHOW_FB_MOVE | WM_SHOW_FB_PLACEMENT |        \
         WM_SHOW_FB_RESIZE | WM_SHOW_FB_RESTART | WM_SHOW_FB_QUIT |            \
         WM_SHOW_FB_KILL)
...
#define F_SUBCONTEXT_W_TITLEBAR                                                \
        (F_SUBCONTEXT_W_SYSTEM | F_SUBCONTEXT_W_TITLE |                        \
         F_SUBCONTEXT_W_MINIMIZE | F_SUBCONTEXT_W_MAXIMIZE)
...
typedef struct _MenuSpec {
        ...
        unsigned int
            menuButtonCount;    /* number of menuButtons elements in use */
...
#endif /* WSM */
#ifdef PANELIST
        struct _WmFpEmbeddedClientData
            *pECD; /* clients living in front panel */
...
typedef struct _WmWorkspaceData {
        ...
        struct _ClientData
            *keyboardFocus; /* ptr to client with the key focus */
