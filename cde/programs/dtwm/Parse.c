...
Boolean StringToString(char *parse_source, void **parse_return)
...
Boolean StringToInt(char *parse_source, void **parse_return)
...
Boolean StringToBoolean(char *parse_source, void **parse_return)
...
Boolean StringToResolution(char *parse_source, void **parse_return)
...
Boolean StringToControlBehavior(char *parse_source, void **parse_return)
...
Boolean StringToGeometry(char *parse_source, void **parse_return)
...
Boolean StringToAction(char *parse_source, void **parse_return)

{
        ...
        if ((string = _DtWmParseNextTokenC(&source, False)) != NULL) {
                ...
                while ((string = _DtWmParseNextTokenC(&source, False)) !=
                       NULL) {
                        action_data->count++;
                        action_data->aap = (DtActionArg *)XtRealloc(
                            (char *)action_data->aap,
                            (sizeof(DtActionArg) * action_data->count));
                        action_data->aap[action_data->count - 1].argClass =
                            DtACTION_FILE;
...
Boolean StringToControlType(char *parse_source, void **parse_return)
...
Boolean StringToMonitorType(char *parse_source, void **parse_return)
...
Boolean StringToControlContainerType(char *parse_source, void **parse_return)

{
        if (strcmp(parse_source, entry_types[BOX]) == 0)
                ...
                *parse_return = (void *)SWITCH;
                ...
                _DtSimpleError(panel.app_name, DtError, NULL,
                               "Invalid Control Container Type -- %s",
                               parse_source);
                return (False);
        }
...
Boolean StringToPositionHints(char *parse_source, void **parse_return)
...
Boolean StringToFileName(char *parse_source, void **parse_return)
...
void FreeString(void **parse_value)
...
void FreeGeometry(void **parse_value)
...
void FreeAction(void **parse_value) {
