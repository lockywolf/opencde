...
**	Resource List
*/
#define R_Offset(field) XtOffset(DtPanelShellWidget, panel.field)

static XtResource panelResources[] = {
    {XmNresolution, XmCDimension, XmRDimension, sizeof(Dimension),
     R_Offset(resolution), XmRImmediate, (XtPointer)0},
    {XmNhighResFontList, XmCHighResFontList, XmRFontList, sizeof(XmFontList),
     R_Offset(high_res_font_list), XmRString, (XtPointer) "fixed"},
    {XmNmediumResFontList, XmCMediumResFontList, XmRFontList,
     sizeof(XmFontList), R_Offset(medium_res_font_list), XmRString,
     (XtPointer) "fixed"},
    {XmNlowResFontList, XmCLowResFontList, XmRFontList, sizeof(XmFontList),
