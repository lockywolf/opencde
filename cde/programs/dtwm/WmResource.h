...
#endif
extern void GetAppearanceGCs(WmScreenData *pSD, Pixel fg, Pixel bg,
                             XFontStruct *font, Pixmap bg_pixmap,
                             Pixel ts_color, Pixmap ts_pixmap, Pixel bs_color,
                             Pixmap bs_pixmap, GC *pGC, GC *ptsGC, GC *pbsGC);
extern GC GetHighlightGC(WmScreenData *pSD, Pixel fg, Pixel bg, Pixmap pixmap);
extern void MakeAppearanceResources(WmScreenData *pSD, AppearanceData *pAData,
...
extern void ProcessScreenResources(WmScreenData *pSD,
...
extern Boolean SimilarAppearanceData(AppearanceData *pAD1,
                                     AppearanceData *pAD2);
#ifdef WSM
