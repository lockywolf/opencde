...
#ifdef WSM
                if (DtwmBehavior) {
                        builtinSystemMenu = (char *)XtNewString(
                            (String)DEFAULT_DTWM_SYSTEMMENU);
                } else {
                        builtinSystemMenu =
...
XtResource wmGlobalResources[] = {
...
#ifndef WSM
    {WmNsessionClientDB, WmCSessionClientDB, XtRString, sizeof(String),
     XtOffsetOf(WmGlobalData, sessionClientDB), XtRImmediate, (XtPointer)NULL},
#endif /* ! WSM */
    ...
    {WmNdtLite, WmCDtLite, XtRBoolean, sizeof(Boolean),
     XtOffsetOf(WmGlobalData, dtLite), XtRImmediate, (XtPointer)False}
#endif /* MINIMAL_DT */
...
XtResource wmGlobalScreenResources[] = {
    {WmNmultiScreen, WmCMultiScreen, XtRBoolean, sizeof(Boolean),
     XtOffsetOf(WmGlobalData, multiScreen), XtRImmediate,
#ifdef WSM
     (XtPointer)True
#else  /* WSM */
     (XtPointer)False
...
XtResource wmScreenResources[] = {
...
#else  /* WSM */
    {WmNiconImageMaximum, WmCIconImageMaximum, WmRSize, sizeof(WHSize),
     XtOffsetOf(WmScreenData, iconImageMaximum), XtRString, "50x50"},
#endif /* WSM */
    ...
    {WmNiconBoxGeometry, WmCIconBoxGeometry, XtRString, sizeof(String),
     XtOffsetOf(WmScreenData, iconBoxGeometry), XtRString, (XtPointer)NULL},
#endif /* WSM */
...
#if ((!defined(WSM)) || defined(MWM_QATS_PROTOCOL))
    {WmNrootMenu, WmCRootMenu, XtRString, sizeof(String),
     XtOffsetOf(WmScreenData, rootMenu), XtRString,
...
XtResource wmClientResources[] = {
    ...
    {WmNuseClientIcon, WmCUseClientIcon, XtRBoolean, sizeof(Boolean),
     XtOffsetOf(ClientData, useClientIcon), XtRImmediate,
#ifdef WSM
     (XtPointer)True
#else
     (XtPointer)False
...
void _WmIconImageFDefault(Widget widget, int offset, XrmValue *value) {
        _WmGetDynamicDefault(widget, WmFGC, 0, _pCD->iconImageBackground,
                             value);
...
void _WmIconImageBSCDefault(Widget widget, int offset, XrmValue *value) {
        _WmGetDynamicDefault(widget, WmBSC, 0, _pCD->iconImageBackground,
                             value);
...
void _WmIconImageTSCDefault(Widget widget, int offset, XrmValue *value) {
        _WmGetDynamicDefault(widget, WmTSC, 0, _pCD->iconImageBackground,
                             value);
...
void _WmBackgroundPixmapDefault(Widget widget, int offset, XrmValue *value) {
        ...
        if ((Monochrome(XtScreen(widget))) ||
            (_pAppearanceData->topShadowColor ==
             _pAppearanceData->background)) {
            ...
            (_pAppearanceData->topShadowColor ==
             _pAppearanceData->background)) {
                ...
                if (_pAppearanceData->backgroundPStr != NULL)
                        if (!strcmp(_pAppearanceData->backgroundPStr,
                                    _25_foreground) ||
                            !strcmp(_pAppearanceData->backgroundPStr,
                                    _50_foreground)) {
...
void _WmAForegroundDefault(Widget widget, int offset, XrmValue *value) {
        _WmGetDynamicDefault(widget, WmFGC, 0,
                             _pAppearanceData->activeBackground, value);
            ...
            (_pAppearanceData->activeTopShadowColor ==
             _pAppearanceData->activeBackground)) {
                ...
                if (_pAppearanceData->activeBackgroundPStr != NULL)
                        if (!strcmp(_pAppearanceData->activeBackgroundPStr,
                                    _25_foreground) ||
                            !strcmp(_pAppearanceData->activeBackgroundPStr,
                                    _50_foreground)) {
                                string = (String)_foreground;
                        }
        } else {
...
#define _WS_HIGH_COLOR_COUNT 4
        ...
        if (pWS) {
                ...
                iIndex =
                    (int)((unsigned long)(pWS) - (unsigned long)(pSD->pWS)) /
                ...
                case XmCO_BLACK_WHITE:
                case XmCO_LOW_COLOR:
                        rval = 1 + (pSD->pInactivePixelSet - pSD->pPixelData) /
                                       sizeof(XmPixelSet);
                        break;
...
void ProcessWmResources(void) {
        ...
        if (wmGD.useStandardBehavior) {
                XtGetApplicationResources(
                    wmGD.topLevelW, (XtPointer)&wmGD, wmStdGlobalResources,
                ...
                XtGetApplicationResources(wmGD.topLevelW, (XtPointer)&wmGD,
                                          wmGlobalResources,
                                          XtNumber(wmGlobalResources), NULL, 0);
        }

        if (wmGD.autoRaiseDelay < 0) {
                wmGD.autoRaiseDelay = 500;
                Warning(
                    ((char *)GETMESSAGE(62, 66,
                                        "Out of range autoRaiseDelay resource "
...
void ProcessWmColors(WmScreenData *pSD) {
        ...
        if ((pSD->pPixelData = (XmPixelSet *)XtMalloc(XmCO_NUM_COLORS *
                                                      sizeof(XmPixelSet)))) {
                /*
                 *
                 *
                ...
                if (XmeGetPixelData(pSD->screen, &pSD->colorUse,
                        ...
                        /*  Hack here.  The index "4" is the proper array
                         * reference.   */
                        /*  This is used because XmGetPixelData has not been
                         * properly  */
                        /*  updated. */
                ...
                Warning(((char *)GETMESSAGE(
                    62, 22, "Insufficient memory for color data")));
                ExitWM(WM_ERROR_EXIT_VALUE);
        }
...
static void WriteOutXrmColors(WmScreenData *pSD) {
        ...
        if (pSD->pActivePixelSet) {
                ...
                if (pSD->colorUse == XmCO_BLACK_WHITE) {
                        ...
                        /* activeForeground */
                        value.addr =
                            (XtPointer) & (BlackPixel(DISPLAY, pSD->screen));

                        XrmPutResource(&db,
                                       ResCat(res_class, screen_name,
                                              WmNactiveForeground, NULL),
                                       XtRPixel, &value);

                        /* activeBackground */
                        value.addr =
                            (XtPointer) & (WhitePixel(DISPLAY, pSD->screen));

                        XrmPutResource(&db,
                                       ResCat(res_class, screen_name,
                                              WmNactiveBackground, NULL),
                                       XtRPixel, &value);
                        ...
                        XrmPutResource(&db,
                                       ResCat(res_class, screen_name,
                                              WmNactiveBottomShadowColor, NULL),
                                       XtRPixel, &value);
                ...
                else /* active colors for non-BW systems */
                {
                        ...
                        if (XmCO_DitherTopShadow(DISPLAY, thisScreen,
                                                 tpixset)) {
                        ...
                        if (XmCO_DitherBottomShadow(DISPLAY, thisScreen,
                                                    tpixset)) {
                                XrmPutStringResource(
                                    &db,
                                    ResCat(res_class, screen_name,
        ...
        if (pSD->pInactivePixelSet) {
                ...
                if (pSD->colorUse == XmCO_BLACK_WHITE) {
                        ...
                        /*
                         *
                         *  Ensure that the icon images have a black foreground
                ...
                } else /* inactive colors for non-BW systems */
                {
                        ...
                        XrmPutResource(&db,
                                       ResCat(res_class, screen_name,
                                              XmNtopShadowColor, NULL),
                                       XtRPixel, &value);

                        value.addr = (XtPointer) & (fpixset->bs);
                        XrmPutResource(&db,
                                       ResCat(res_class, screen_name,
                                              XmNbottomShadowColor, NULL),
                                       XtRPixel, &value);

                        /*
                         *
                         *  Set up the select color, as for buttons in the
                         * dialogue boxes.
                         *
                         */
                         ...
                         */
                        {
                                ...
                                XrmPutResource(
                                    &db,
                                    ResCat(res_class, screen_name,
                                           WmNiconImageBottomShadowColor, NULL),
                                    XtRPixel, &value);
                                ...
                                XrmPutResource(
                                    &db,
                                    ResCat(res_class, screen_name,
                                           WmNiconImageTopShadowColor, NULL),
                                    XtRPixel, &value);
                        } else
                        /*
                         *
                         ...
                         */
                        {
                                value.addr = (XtPointer) &
                                             (BlackPixel(DISPLAY, pSD->screen));
        ...
        if (pSD->pTextPixelSet) {
                ...
                XrmPutResource(
                    &db,
                    ResCat(res_class, screen_name, "XmText", WmNbackground),
                    XtRPixel, &value);
        }
}
        ...
        if (s1) {
                ...
                if (s2 && (count > 0)) {
                        ...
                        if (s3 && (count > 0)) {
                                ...
                                if (s4) {
                                        strncat((char *)wmGD.tmpBuffer, "*",
                                                count);
                                        count -= 1;
                                        strncat((char *)wmGD.tmpBuffer, s4,
                                                count);
                                }
                        }
                }
...
void ProcessAppearanceResources(WmScreenData *pSD) {
        ...
        (void)XtGetSubresources(clientW,
                                (XtPointer) & (pSD->clientTitleAppearance),
        ...
        if (SimilarAppearanceData(&(pSD->clientAppearance),
                ...
                /* make background, top and bottom shadow pixmaps */
                MakeAppearanceResources(pSD, &(pSD->clientTitleAppearance),
                                        True);
        ...
        (void)XtGetSubresources(pSD->screenTopLevelW,
                                (XtPointer) & (pSD->iconAppearance), WmNicon,
                                WmCIcon, wmAppearanceResources,
                                XtNumber(wmAppearanceResources), NULL, 0);
#ifdef WSM
...
int FallbackMakeTitleHeight(AppearanceData *pAData) {
        ...
        while (entry) {
                ...
                switch (type) {
                case XmFONT_IS_FONT:
                        /* does not really happen since
                           XmeRenderTableGetDefaultFont seems to fail only on
                           fontsets */
                        break;
                case XmFONT_IS_FONTSET:
                        ...
                        if (WM_TITLE_BAR_PADDING +
                                pExtents->max_logical_extent.height >
                            pAData->titleHeight) {
                                pAData->titleHeight =
...
void MakeAppearanceResources(WmScreenData *pSD, AppearanceData *pAData,
        ...
        if (!XmeRenderTableGetDefaultFont(pAData->fontList, &(pAData->font))) {
                ...
                /* HACK to try get _some_ font anyway (fontList seems to end up
                 * as an empty list on some modern systems; investigate) */
                pAData->font = XLoadQueryFont(wmGD.display, "fixed");
                if (pAData->font == NULL) {
                        ExitWM(WM_ERROR_EXIT_VALUE);
                }
                /* try to get right title hight using XExtentsOfFontSet: on
                 * UTF-8 locales XmeRenderTableGetDefaultFont does not return
                 * anything when font is a compound fontset*/
                if (!FallbackMakeTitleHeight(pAData)) {
                        /* failed to get height from fontList - falling back to
                         * fixed */
...
#ifndef NO_MULTIBYTE
                /*
                 *  Calculate title bar's height (using selected font) and store
                 * it in pAData.
                 */
                pAData->titleHeight = (pAData->font)->ascent +
                                      (pAData->font)->descent +
        ...
        if (pAData->backgroundPStr) {
                pAData->backgroundPixmap =
                    XmGetPixmap(ScreenOfDisplay(DISPLAY, pSD->screen),
                                pAData->backgroundPStr, pAData->foreground,
                                pAData->background);
        ...
        if (pAData->topShadowPStr) {
                ...
                pAData->topShadowPixmap = XmGetPixmap(
                    ScreenOfDisplay(DISPLAY, pSD->screen),
        ...
        GetAppearanceGCs(pSD, pAData->foreground, pAData->background,
                         pAData->font, pAData->backgroundPixmap,
                         pAData->topShadowColor, pAData->topShadowPixmap,
                         pAData->bottomShadowColor, pAData->bottomShadowPixmap,
                         &(pAData->inactiveGC), &(pAData->inactiveTopShadowGC),
        ...
        if (pAData->activeBackgroundPStr) {
                pAData->activeBackgroundPixmap = XmGetPixmap(
                    ScreenOfDisplay(DISPLAY, pSD->screen),
                    pAData->activeBackgroundPStr, pAData->activeForeground,
        ...
        if (pAData->activeTopShadowPStr) {
                pAData->activeTopShadowPixmap = XmGetPixmap(
                    ScreenOfDisplay(DISPLAY, pSD->screen),
                    pAData->activeTopShadowPStr, pAData->activeTopShadowColor,
                    pAData->activeBackground);
        ...
        GetAppearanceGCs(
            pSD, pAData->activeForeground, pAData->activeBackground,
            pAData->font, pAData->activeBackgroundPixmap,
            pAData->activeTopShadowColor, pAData->activeTopShadowPixmap,
            pAData->activeBottomShadowColor, pAData->activeBottomShadowPixmap,
            &(pAData->activeGC), &(pAData->activeTopShadowGC),
...
#ifndef MOTIF_ONE_DOT_ONE
                pSD->moveOpaque =
                    (((XmScreen)XmGetXmScreen(XtScreen(pSD->screenTopLevelW)))
                         ->screen.moveOpaque);
#endif
        }
            ...
            (pSD->frameBorderWidth == (Dimension)BIGSIZE)) {
                ...
                if (pSD->resizeBorderWidth == (Dimension)BIGSIZE) {
                        ...
                        if (wmGD.frameStyle == WmSLAB) {
                                ...
                                if (pSD->resizeBorderWidth > 7)
                                        pSD->resizeBorderWidth = 7;
                        }
#endif /* WSM */
                }
...
void ProcessWorkspaceList(WmScreenData *pSD) {
        ...
        if (bHaveWorkspaceList) {
                ...
                ppchWsNames =
                    (char **)XtMalloc(wsNamesAlloced * sizeof(char *));
        ...
        if (!(pSD->pWS = (WmWorkspaceData *)XtMalloc(
 ...
 */
        ...
        if (wmGD.useStandardBehavior) {
                ...
                if (pWS->iconBoxGeometry) {
                        pWS->iconBoxGeometry =
                            XtNewString(pWS->iconBoxGeometry);
                }
#endif /* WSM */
        }
        ...
        XtGetSubresources(pWS->workspaceTopLevelW,
                          (XtPointer) & (pWS->backdrop), WmNbackdrop,
                          WmCBackdrop, wmBackdropResources,
...
void ProcessPresenceResources(WmScreenData *pSD) {
        ...
        if (pSD->presence.shellW) {
                XtGetSubresources(pSD->presence.shellW,
                                  (XtPointer)&pSD->presence,
...
void ProcessClientResources(ClientData *pCD) {
        ...
        if (wmGD.useStandardBehavior) {
                XtGetSubresources(pSD->screenTopLevelW, (XtPointer)pCD,
                                  clientName, clientClass, wmStdClientResources,
                ...
                XtGetSubresources(pSD->screenTopLevelW, (XtPointer)pCD,
                                  clientName, clientClass, wmClientResources,
                ...
                if ((pCD->iconImageBottomShadowPStr ==
                    ...
                    (pCD->iconImageBackground ==
                     pSD->iconAppearance.background)) {
                        ...
                        if (pCD->iconImageBottomShadowPixmap ==
                ...
                if ((pCD->iconImageTopShadowPStr ==
                    ...
                    (pCD->iconImageBackground ==
                     pSD->iconAppearance.background)) {
                        ...
                        if (pCD->iconImageTopShadowPixmap ==
                            XmUNSPECIFIED_PIXMAP) {
        ...
        if (pCD->matteWidth > 0) {
                XtGetSubresources(pSD->screenTopLevelW, (XtPointer)pCD,
                                  clientName, clientClass, wmClientResourcesM,
                        ...
                        if ((pCD->matteBottomShadowPStr ==
                            ...
                            (pCD->matteBackground ==
                             pSD->clientAppearance.background)) {
                                ...
                                if (pCD->matteBottomShadowPixmap ==
                                    XmUNSPECIFIED_PIXMAP) {
                                        pCD->matteBottomShadowPixmap =
                                            (Pixmap)NULL;
                                }
                ...
                pCD->clientMatteTopShadowGC = GetHighlightGC(
                    pCD->pSD, pCD->matteTopShadowColor, pCD->matteBackground,
                    pCD->matteTopShadowPixmap);

                pCD->clientMatteBottomShadowGC = GetHighlightGC(
                    pCD->pSD, pCD->matteBottomShadowColor, pCD->matteBackground,
                    pCD->matteBottomShadowPixmap);
        }
...
void _WmGetDynamicDefault(Widget widget, unsigned char type,
        ...
        if (Monochrome(newScreen)) {
                ...
                if (wmGD.statusColorServer == CSERVE_NORMAL) {
                        ...
                        for (i = 0; i < wmGD.numScreens; i++) {
                                if (XScreenNumberOfScreen(newScreen) ==
                                    wmGD.Screens[i].screen) {
                                        pSD = &wmGD.Screens[i];
                                        ok = True;
                                        break;
                                }
        ...
        if ((oldScreen != NULL) && (oldScreen == newScreen) &&
            ...
            (background == newBackground)) {
                ...
                /*
                 * Find or generate a background color and associated 3-D
                 * colors.
                 */

                oldDefaultColor = defaultColor;
                /*
                 * Fix for CR 5152 - Due to the use of Realloc in the color
                 * caches, a static pointer is not acceptable.  Change it to a
                 * static structure to maintain the data
                 */
                colorData =
                    *_WmGetDefaultColors(newScreen, newColormap, defaultColor);
        } else {
                /*
                 * Find or generate a color based on the associated background
                 * color.
                 */
                ...
                XmGetColors(
                    newScreen, newColormap, background,
                    &colorData.foreground.pixel, &colorData.top_shadow.pixel,
                    &colorData.bottom_shadow.pixel, &colorData.select.pixel);
        }
...
XmColorData *_WmGetDefaultColors(screen, colormap, defaultColor) Screen *screen;
Colormap colormap;
String defaultColor;

{
        ...
        for (i = 0; i < count; i++) {
                if (((set + i)->screen == screen) &&
                    ((set + i)->color_map == colormap)) {
                        return (set + i);
                }
        }
        ...
        if (!XParseColor(display, colormap, defaultColor, &colorDef)) {
                if (!(strcmp(defaultColor, _defaultColor1))) {
                        XParseColor(display, colormap, _defaultColor1HEX,
                                    &colorDef);
                } else {
                        XParseColor(display, colormap, _defaultColor2HEX,
                                    &colorDef);
                }
        }
        ...
        XmGetColors(screen, colormap, colorDef.pixel,
                    &set[count].foreground.pixel, &set[count].top_shadow.pixel,
                    &set[count].bottom_shadow.pixel, &set[count].select.pixel);
...
char *WmRealloc(ptr, size) char *ptr;
unsigned size;
...
char *WmMalloc(ptr, size) char *ptr;
unsigned size;
...
void SetupDefaultResources(pSD)
...

{
        ...
        /*
         * If (using DefaultBindings mechanism and bindings are not found in
         *.mwmrc) then use the builtin bindings.
         */
        if (!pSD->keySpecs && !wmGD.useStandardBehavior) {
                ...
                if (strcmp(pSD->keyBindings, defaultKeyBindingsName)) {
                        MWarning(((char *)GETMESSAGE(62, 67,
                                                     "Key bindings %s not "
                                                     "found, using builtin key "
                                                     "bindings\n")),
                                 pSD->keyBindings);
                }
                pSD->keyBindings = builtinKeyBindingsName;
        ...
        if (!pSD->buttonSpecs && !wmGD.useStandardBehavior) {
                ...
                if (strcmp(pSD->buttonBindings, defaultButtonBindingsName)) {
                        MWarning(((char *)GETMESSAGE(62, 68,
                                                     "Button bindings %s not "
                                                     "found, using builtin "
                                                     "button bindings\n")),
                                 pSD->buttonBindings);
                }
...
Boolean SimilarAppearanceData(AppearanceData *pAD1, AppearanceData *pAD2) {
        ...
        if ((pAD1->fontList == pAD2->fontList) &&
            ...
            (pAD1->activeBottomShadowPixmap ==
             pAD2->activeBottomShadowPixmap) &&
...
Boolean Monochrome(Screen *screen) {
        ...
        if (wmGD.statusColorServer == CSERVE_NORMAL) {
                for (scr = 0; scr < wmGD.numScreens; scr++) {
                        ...
                        if (pSD->managed) {
                                if (XScreenOfDisplay(DISPLAY, pSD->screen) ==
                                    screen) {
                                        if (pSD->colorUse == XmCO_BLACK_WHITE) {
                                                return (True);
                                        } else {
