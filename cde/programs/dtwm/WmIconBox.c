...
Boolean MakeIconBox(WmWorkspaceData *pWS, ClientData *pCD) {
        ...
        if (pCD) {
                ...
                if (!(pIBD->IPD.placeList = (IconInfo *)XtMalloc(
...
void MakeShell(WmWorkspaceData *pWS, IconBoxData *pIBD) {
        ...
        XtSetArg(setArgs[i], XmNallowShellResize, (XtArgVal)True);
        i++;

        XtSetArg(setArgs[i], XmNborderWidth, (XtArgVal)0);
        i++;

        XtSetArg(setArgs[i], XmNkeyboardFocusPolicy, (XtArgVal)XmEXPLICIT);
        i++;

#ifndef WSM
        if (!(Monochrome(XtScreen(pWS->pSD->screenTopLevelW)))) {
                XtSetArg(setArgs[i], XmNbackground,
                         (XtArgVal)pWS->pSD->clientAppearance.background);
                i++;
                XtSetArg(setArgs[i], XmNforeground,
                         (XtArgVal)pWS->pSD->clientAppearance.foreground);
                i++;
        }
#else  /* WSM  */
        if (pWS->pSD->iconBoxTitle) {
                ...
                XtSetArg(setArgs[i], XmNtitle, (XtArgVal)pchIBTitle);
                i++;
                XtSetArg(setArgs[i], XmNiconName, (XtArgVal)pchIBTitle);
                i++;
        }
#endif /* WSM */
        XtSetArg(setArgs[i], XmNmappedWhenManaged, (XtArgVal)False);
        i++;
        XtSetArg(setArgs[i], XmNdialogStyle, (XtArgVal)XmDIALOG_MODELESS);
        i++;
        XtSetArg(setArgs[i], XmNdepth,
                 (XtArgVal)DefaultDepth(DISPLAY, pWS->pSD->screen));
        i++;
        XtSetArg(setArgs[i], XmNscreen,
                 (XtArgVal)ScreenOfDisplay(DISPLAY, pWS->pSD->screen));
        i++;

#ifdef WSM
        pIBD->shellWidget = (Widget)XtCreatePopupShell(
            WmNclient, topLevelShellWidgetClass, pWS->workspaceTopLevelW,
            (ArgList)setArgs, i);
...
#else  /* WSM */
        pIBD->shellWidget = (Widget)XtCreatePopupShell(
            WmNiconBox, topLevelShellWidgetClass, pWS->workspaceTopLevelW,
            (ArgList)setArgs, i);
#endif /* WSM */
...
*/
        ...
        XtSetArg(setArgs[i], XmNborderWidth, (XtArgVal)0);
        i++;
        XtSetArg(setArgs[i], XmNmarginWidth, (XtArgVal)0);
        i++;
        XtSetArg(setArgs[i], XmNmarginHeight, (XtArgVal)0);
        i++;
        XtSetArg(setArgs[i], XmNshadowType, (XtArgVal)XmSHADOW_OUT);
        i++;
        XtSetArg(setArgs[i], XmNshadowThickness,
                 (XtArgVal)frameShadowThickness);
        i++;
        pIBD->frameWidget =
            XtCreateManagedWidget("IBframe", xmFrameWidgetClass,
                                  pIBD->shellWidget, (ArgList)setArgs, i);

#ifdef WSM
        XtAddCallback(pIBD->frameWidget, XmNhelpCallback, WmDtWmTopicHelpCB,
                      WM_DT_ICONBOX_TOPIC);
        ...
        XtSetArg(setArgs[i], XmNscrollingPolicy, (XtArgVal)XmAUTOMATIC);
        i++;

        XtSetArg(setArgs[i], XmNborderWidth, (XtArgVal)0);
        i++;
        XtSetArg(setArgs[i], XmNspacing, (XtArgVal)IB_MARGIN_WIDTH);
        i++;
#ifndef WSM
        ...
        XtSetArg(setArgs[i], XmNscrolledWindowMarginWidth, (XtArgVal)3);
        i++;
        XtSetArg(setArgs[i], XmNscrolledWindowMarginHeight, (XtArgVal)3);
        i++;
        XtSetArg(setArgs[i], XmNshadowThickness,
                 (XtArgVal)FRAME_EXTERNAL_SHADOW_WIDTH);
        i++;

        XtSetArg(setArgs[i], XmNscrollBarDisplayPolicy, (XtArgVal)XmSTATIC);
        i++;
        XtSetArg(setArgs[i], XmNvisualPolicy, (XtArgVal)XmVARIABLE);
        i++;

        pIBD->scrolledWidget =
            XtCreateManagedWidget("IBsWindow", xmScrolledWindowWidgetClass,
                                  pIBD->frameWidget, (ArgList)setArgs, i);
        ...
        XtAddEventHandler(pIBD->scrolledWidget, StructureNotifyMask, False,
                          (XtEventHandler)UpdateIncrements, (XtPointer)pIBD);
...
void MakeBulletinBoard(WmWorkspaceData *pWS, IconBoxData *pIBD) {
        ...
        XtSetArg(setArgs[i], XmNborderWidth, 1);
        i++;
#else
        XtSetArg(setArgs[i], XmNborderWidth, 0);
        i++;
#endif /* DEBUG_ICON_BOX */

        XtSetArg(setArgs[i], XmNshadowThickness, (XtArgVal)0);
        i++;
#ifndef WSM
        if (!(Monochrome(XtScreen(pWS->pSD->screenTopLevelW)))) {
                XtSetArg(setArgs[i], XmNforeground,
                ...
                i++;
                XtSetArg(
                    setArgs[i], XmNbottomShadowColor,
                    (XtArgVal)pWS->pSD->clientAppearance.bottomShadowColor);
                i++;
                XtSetArg(setArgs[i], XmNtopShadowColor,
                         (XtArgVal)pWS->pSD->clientAppearance.topShadowColor);
                i++;
        }
#endif /* WSM */

        XtSetArg(setArgs[i], XmNspacing, 0);
        i++;
        XtSetArg(setArgs[i], XmNmarginHeight, 0);
        i++;
        XtSetArg(setArgs[i], XmNmarginWidth, 0);
        i++;

        XtSetArg(setArgs[i], XmNdialogStyle, (XtArgVal)XmDIALOG_WORK_AREA);
        i++;

        XtSetArg(setArgs[i], XmNresizePolicy, (XtArgVal)XmRESIZE_NONE);
        i++;
        XtSetArg(setArgs[i], XmNdefaultPosition, (XtArgVal)False);
        i++;

        XtSetArg(setArgs[i], XtNinsertPosition, InsertPosition);
        i++;

        pIBD->bBoardWidget =
            XtCreateManagedWidget("IBbBoard", xmBulletinBoardWidgetClass,
                                  pIBD->scrolledWidget, (ArgList)setArgs, i);
...
void RealizeIconBox(WmWorkspaceData *pWS, IconBoxData *pIBD, ClientData *pCD) {
        ...
        i = 0;
        XtSetArg(setArgs[i], XmNbackground, (XtArgVal)select_color);
        i++;
        XtSetValues(pIBD->bBoardWidget, (ArgList)setArgs, i);

        i = 0;
        XtSetArg(getArgs[i], XmNbackgroundPixmap, (XtArgVal)&bgPixmap);
        i++;
        XtGetValues(pIBD->bBoardWidget, getArgs, i);

        i = 0;
        XtSetArg(getArgs[i], XmNclipWindow, (XtArgVal)&clipWidget);
        i++;
        ...
        if (pWS->pSD->iconDecoration & ICON_IMAGE_PART) {
                 ...
                 */
                defaultImage = XCreateBitmapFromData(
                    DISPLAY, pWS->pSD->rootWindow, (char *)iImage_bits,
                    iImage_width, iImage_height);

                pWS->pSD->defaultPixmap = MakeIconPixmap(
                    pCD, defaultImage, None, iImage_width, iImage_height, 1);
        }
...
#ifdef WSM
                mask = XParseGeometry(pWS->iconBoxGeometry, &X, &Y, &width,
                                      &height);
#else  /* WSM */
                mask = XParseGeometry(pWS->pSD->iconBoxGeometry, &X, &Y, &width,
                                      &height);
#endif /* WSM */
...
void InitializeClientData(ClientData *pCD, IconBoxData *pIBD) {
        pCD->internalBevel =
            (wmGD.frameStyle == WmSLAB) ? 0 : FRAME_INTERNAL_SHADOW_WIDTH;
        ...
        pCD->widthInc = pIBD->IPD.iPlaceW =
            ICON_WIDTH(pCD) + IB_SPACING + (2 * IB_MARGIN_WIDTH);

        pCD->heightInc = pIBD->IPD.iPlaceH =
            ICON_HEIGHT(pCD) + IB_SPACING + (2 * IB_MARGIN_HEIGHT);
...
void MakeShrinkWrapIconsGC(WmScreenData *pSD, Pixmap bgPixmap) {
        ...
        if (!pSD->shrinkWrapGC) {
                pSD->shrinkWrapGC =
                    XCreateGC(DISPLAY, pSD->rootWindow, 0, (XGCValues *)NULL);

                copyMask = ~0L;

                XCopyGC(DISPLAY, pSD->iconAppearance.inactiveGC, copyMask,
                        pSD->shrinkWrapGC);
                ...
                if (bgPixmap != XmUNSPECIFIED_PIXMAP) {
                        ...
                        XSetBackground(DISPLAY, pSD->shrinkWrapGC,
                                       select_color);
                } else {
                        XSetForeground(DISPLAY, pSD->shrinkWrapGC,
                                       select_color);
                }
        }
...
void MakeFadeIconGC(WmScreenData *pSD) {
        ...
        tmpFontClipMask = XCreateBitmapFromData(
            DISPLAY, pSD->rootWindow, (char *)greyed75_bits, greyed75_width,
            greyed75_height);

        greyedPixmap =
            XCreateBitmapFromData(DISPLAY, pSD->rootWindow, (char *)slant2_bits,
                                  slant2_width, slant2_height);
...
void SetGeometry(WmWorkspaceData *pWS, ClientData *pCD, IconBoxData *pIBD) {
        ...
        if ((decoration = pCD->decor) & MWM_DECOR_TITLE) {
                ...
                tmpMin = boxdim + ((decoration & MWM_DECOR_MENU) ? boxdim : 0) +
        ...
        } else if ((diff = ((pCD->minWidth - pCD->baseWidth) %
                            pCD->widthInc)) != 0) {
        ...
        pIBD->IPD.placementCols =
            (int)((pCD->clientWidth - pCD->baseWidth) / pCD->widthInc);
        ...
        XtSetArg(setArgs[i], XmNwidth,
                 (XtArgVal)pCD->clientWidth - pCD->baseWidth);
        i++;
        XtSetArg(setArgs[i], XmNheight,
                 (XtArgVal)pCD->clientHeight - pCD->baseHeight);
        i++;
        XtSetValues(pIBD->bBoardWidget, (ArgList)setArgs, i);
        ...
        i = 0;
        XtSetArg(setArgs[i], XmNwidth,
                 (XtArgVal)(pCD->clientWidth - (2 * frameShadowThickness)));
        i++;
        XtSetArg(setArgs[i], XmNheight,
                 (XtArgVal)(pCD->clientHeight - (2 * frameShadowThickness)));
        i++;
...
#ifdef WSM
        mask = XParseGeometry(pWS->iconBoxGeometry, &X, &Y, &width, &height);
#else  /* WSM */
        mask =
            XParseGeometry(pCD->pSD->iconBoxGeometry, &X, &Y, &width, &height);
#endif /* WSM */

        if (mask & XValue) {
                if (mask & XNegative) {
                        pCD->clientX =
                            X + DisplayWidth(DISPLAY, SCREEN_FOR_CLIENT(pCD)) -
                            pCD->clientWidth - pCD->clientOffset.x;
                } else {
        ...
        if (mask & YValue) {
                if (mask & YNegative) {
                        pCD->clientY =
                            Y + DisplayHeight(DISPLAY, SCREEN_FOR_CLIENT(pCD)) -
                            pCD->clientHeight - pCD->clientOffset.x;
                } else {
        ...
        PlaceFrameOnScreen(pCD, &pCD->clientX, &pCD->clientY, pCD->clientWidth,
                           pCD->clientHeight);
        pCD->clientX -= (wmGD.positionIsFrame ? pCD->clientOffset.x : 0);

        pCD->clientY -= (wmGD.positionIsFrame ? pCD->clientOffset.y : 0);

        i = 0;

        XtSetArg(setArgs[i], XmNx, (XtArgVal)pCD->clientX);
        i++;
        XtSetArg(setArgs[i], XmNy, (XtArgVal)pCD->clientY);
        i++;
...
void SetGranularity(WmWorkspaceData *pWS, ClientData *pCD, IconBoxData *pIBD) {
        ...
        XtSetArg(getArgs[i], XmNspacing, (XtArgVal)&spacing);
        i++;
        XtSetArg(getArgs[i], XmNshadowThickness, (XtArgVal)&shadowThickness);
        i++;
        XtSetArg(getArgs[i], XmNscrolledWindowMarginWidth,
                 (XtArgVal)&marginWidth);
        i++;
        XtSetArg(getArgs[i], XmNscrolledWindowMarginHeight,
                 (XtArgVal)&marginHeight);
        i++;
        XtSetArg(getArgs[i], XmNverticalScrollBar, (XtArgVal)&pIBD->vScrollBar);
        i++;
        XtSetArg(getArgs[i], XmNhorizontalScrollBar,
                 (XtArgVal)&pIBD->hScrollBar);
        i++;
        XtGetValues(pIBD->scrolledWidget, getArgs, i);
        ...
        if (strcmp(pWS->pSD->iconBoxSBDisplayPolicy, szvertical)) {
                 ...
                 */
                i = 0;
                XtSetArg(getArgs[i], XmNheight, (XtArgVal)&hBarHeight);
                i++;
                XtSetArg(getArgs[i], XmNhighlightThickness,
                         (XtArgVal)&hShighlightThickness);
                i++;
                XtGetValues(pIBD->hScrollBar, getArgs, i);

                i = 0;
                XtSetArg(setArgs[i], XmNincrement, (XtArgVal)pCD->widthInc);
                i++;
                ...
                i = 0;
                XtSetArg(getArgs[i], XmNtroughColor, (XtArgVal)&select_color);
                i++;
                XtSetArg(getArgs[i], XmNheight, (XtArgVal)&hScrollBarHeight);
                i++;
                XtGetValues(pIBD->hScrollBar, getArgs, i);
        }
        ...
        if (strcmp(pWS->pSD->iconBoxSBDisplayPolicy, szhorizontal)) {
                 ...
                 */
                i = 0;
                XtSetArg(getArgs[i], XmNwidth, (XtArgVal)&vBarWidth);
                i++;
                XtSetArg(getArgs[i], XmNhighlightThickness,
                         (XtArgVal)&vShighlightThickness);
                i++;
                XtGetValues(pIBD->vScrollBar, getArgs, i);

                i = 0;
                XtSetArg(setArgs[i], XmNincrement, (XtArgVal)pCD->heightInc);
                i++;
                XtSetArg(setArgs[i], XmNhighlightThickness,
                         IB_HIGHLIGHT_BORDER);
                i++;
                ...
                XtSetArg(getArgs[i], XmNtroughColor, (XtArgVal)&select_color);
                i++;
                XtSetArg(getArgs[i], XmNwidth, (XtArgVal)&vScrollBarWidth);
                i++;
                XtGetValues(pIBD->vScrollBar, getArgs, i);
        }
        ...
        pCD->baseWidth =
            IB_SPACING + 2 * IB_HIGHLIGHT_BORDER
#ifdef DEBUG_ICON_BOX
            + 2 + spacing
#endif /* DEBUG_ICON_BOX */
            + (int)vScrollBarWidth + 2 * frameShadowThickness +
            (int)2 * marginWidth +
            (marginWidth > 0 ? 2 * (int)shadowThickness : shadowThickness);
        ...
        pCD->baseHeight =
            ...
            + 2
#endif /* DEBUG_ICON_BOX */
            + spacing + (int)hScrollBarHeight + 2 * frameShadowThickness +
            (int)2 * marginHeight +
            (marginHeight > 0 ? 2 * (int)shadowThickness : shadowThickness);
...

{
        ...
        return (ParseMwmMenuStr(
            pSD,
            (unsigned char *)((char *)GETMESSAGE(
                36, 3, "\"Pack Icons\" _P  Alt Shift<Key>F7 f.pack_icons\n"))));
        ...
        if (pWS->pIconBox) {
                ...
                while (pibd) {
                        XUnmapWindow(DISPLAY,
                                     pibd->pCD_iconBox->clientFrameWin);
                        pibd = pibd->pNextIconBox;
                }
        }
...
#ifdef PANELIST
Boolean IconBoxShowing(WmWorkspaceData *pWS)
#else  /* PANELIST */
Boolean IconBoxShowing(WmWorkspaceData *pWS, ControlWindowStruct *pCW)
#endif /* PANELIST */
{
        Boolean rval = False;
...
#ifdef PANELIST
void IconBoxPopUp(WmWorkspaceData *pWS, Boolean up)
#else  /* PANELIST */
void IconBoxPopUp(WmWorkspaceData *pWS, ControlWindowStruct *pCW, Boolean up)
#endif /* PANELIST */
{
                ...
                while (pibd) {
                        if (up) {
                                if (ClientInWorkspace(pWS, pibd->pCD_iconBox)) {
                                   ...
                                   ClientInWorkspace(pWS, pibd->pCD_iconBox)) {
...
Boolean InsertIconIntoBox(IconBoxData *pIBD, ClientData *pCD) {
        ...
        if (pCD->client) {
                ...
                iconWidth = ICON_WIDTH(pCD) + (2 * IB_MARGIN_WIDTH);

                iconHeight = ICON_HEIGHT(pCD) + (2 * IB_MARGIN_HEIGHT);
                ...
                if (pIconInfo) {
                        ...
                        i = 0;
                        XtSetArg(setArgs[i], XmNbackground,
                                 (XtArgVal)ICON_APPEARANCE(pCD).background);
                        i++;
                        XtSetArg(setArgs[i], XmNforeground,
                                 (XtArgVal)ICON_APPEARANCE(pCD).foreground);
                        i++;

#ifdef WSM
                        XtSetArg(setArgs[i], XmNx, (XtArgVal)pWsc->iconX);
                        i++;
                        XtSetArg(setArgs[i], XmNy, (XtArgVal)pWsc->iconY);
                        i++;
#else  /* WSM */
                        XtSetArg(setArgs[i], XmNx, (XtArgVal)ICON_X(pCD));
                        i++;
                        XtSetArg(setArgs[i], XmNy, (XtArgVal)ICON_Y(pCD));
                        i++;
#endif /* WSM */

                        XtSetArg(setArgs[i], XmNwidth, (XtArgVal)iconWidth);
                        i++;
                        XtSetArg(setArgs[i], XmNheight, (XtArgVal)iconHeight);
                        i++;
                        ...
                        i++;
                        /*
                         * Use type XmString so we don't get a message from
                         * XmLabel
                         */
                        XtSetArg(setArgs[i], XmNlabelType, (XtArgVal)XmSTRING);
                        i++;

                        XtSetArg(setArgs[i], XmNrecomputeSize, (XtArgVal)False);
                        i++;

                        XtSetArg(setArgs[i], XmNtraversalOn, (XtArgVal)True);
                        i++;

                        XtSetArg(setArgs[i], XmNpushButtonEnabled,
                                 (XtArgVal)False);
                        i++;
                        ...
                        iconWidget = XtCreateManagedWidget(
                            "iconInIconBox", xmDrawnButtonWidgetClass,
#ifdef WSM
                        ...
                        if (dummyString == NULL) {
                                dummyString = XmStringCreateLocalized("");
                        }

                        i = 0;
                        XtSetArg(setArgs[i], XmNlabelString,
                                 (XtArgVal)dummyString);
                        i++;
                        ...
                        XtAddEventHandler(
                            iconWidget, SELECT_BUTTON_MOTION_MASK, False,
                            (XtEventHandler)HandleIconBoxButtonMotion,
                            (XtPointer)NULL);

                        XtAddEventHandler(
                            iconWidget, DMANIP_BUTTON_MOTION_MASK, False,
                            (XtEventHandler)HandleIconBoxButtonMotion,
                            (XtPointer)NULL);

                        XtAddEventHandler(
                            iconWidget, KeyPressMask, False,
                            (XtEventHandler)HandleIconBoxIconKeyPress,
                            (XtPointer)NULL);

                        if (ICON_DECORATION(pCD) & ICON_ACTIVE_LABEL_PART) {
                                XtAddEventHandler(
                                    iconWidget, FocusChangeMask, False,
                                    (XtEventHandler)ChangeActiveIconboxIconText,
                                    (XtPointer)NULL);

                                if (pCD->pSD->activeLabelParent !=
                                    pCD->pSD->rootWindow) {
                                        XRaiseWindow(
                                            DISPLAY,
...

{
        ...
        CvtIconPlaceToPosition(&pIBD->IPD, pWsc->iconPlace, &pWsc->iconX,
                               &pWsc->iconY);
        ...
        CvtIconPlaceToPosition(&pIBD->IPD, ICON_PLACE(pCD), &ICON_X(pCD),
                               &ICON_Y(pCD));
...
#else  /* WSM */
                        if (clipHeight <=
                            (pII->pCD->iconY + pIBD->pCD_iconBox->heightInc)) {
                                /*
                                 * Increase bulletin board height as needed.
                                 */
                                XtSetArg(setArgs[i], XmNheight,
                                         (XtArgVal)pII->pCD->iconY +
                                             pIBD->pCD_iconBox->heightInc);
                                i++;
                        }
#endif /* WSM */
...
#else  /* WSM */
                        if (clipWidth <=
                            (pII->pCD->iconX + pIBD->pCD_iconBox->widthInc)) {
                                /*
                                 * Increase bulletin board width as needed
                                 */
                                XtSetArg(setArgs[i], XmNwidth,
...
void DeleteIconFromBox(IconBoxData *pIBD, ClientData *pCD) {
        ...
        i = 0;
        XtSetArg(args[i], XmNwidth, (XtArgVal)&oldWidth);
        i++;
        XtSetArg(args[i], XmNheight, (XtArgVal)&oldHeight);
        i++;
        XtGetValues(pIBD->bBoardWidget, args, i);

        i = 0;
        XtSetArg(args[i], XmNwidth, (XtArgVal)&clipWidth);
        i++;
        XtSetArg(args[i], XmNheight, (XtArgVal)&clipHeight);
        i++;
        ...
        if (clipWidth <= (Dimension)(pIBD->lastCol + 1)) {
                ...
                XtSetArg(args[i], XmNwidth, (XtArgVal)newWidth);
                i++;
        ...
        if (clipHeight <= (Dimension)(pIBD->lastRow + 1)) {
                ...
                XtSetArg(args[i], XmNheight, (XtArgVal)newHeight);
                i++;
...
void ResetIconBoxMaxSize(ClientData *pCD, Widget bBoardWidget) {
        ...
        i = 0;
        XtSetArg(getArgs[i], XmNwidth, (XtArgVal)&newWidth);
        i++;
        XtSetArg(getArgs[i], XmNheight, (XtArgVal)&newHeight);
        i++;
...
Boolean CheckIconBoxSize(IconBoxData *pIBD) {
        ...
        i = 0;
        XtSetArg(getArgs[i], XmNwidth, (XtArgVal)&oldWidth);
        i++;
        XtSetArg(getArgs[i], XmNheight, (XtArgVal)&oldHeight);
        i++;
        XtGetValues(pIBD->bBoardWidget, getArgs, i);
        ...
        if (pIBD->IPD.iconPlacement & ICON_PLACE_LEFT_PRIMARY) {
                if (oldRow < pIBD->lastRow + 1) {
                         ...
                         */
                        newHeight =
                            (pIBD->lastRow * pIBD->pCD_iconBox->heightInc) +
                            pIBD->pCD_iconBox->heightInc;
                ...
                if (oldCol < pIBD->lastCol + 1) {
                         ...
                         */
                        newWidth =
                            (pIBD->lastCol * pIBD->pCD_iconBox->widthInc) +
                            pIBD->pCD_iconBox->widthInc;

                        XtSetArg(setArgs[i], XmNwidth, newWidth);
                        i++;
                }
        }
...
void CheckIconBoxResize(ClientData *pCD, unsigned int changedValues,
        ...
        if (changedValues & CWWidth) {
                ...
                if (newWidth > (int)oldWidth) {
                        ...
                        XtSetArg(setArgs[i], XmNwidth, (XtArgVal)newWidth);
                        i++;
                }
                ...
                if (newHeight < (int)oldHeight) {
                        if ((!strcmp(pSD->iconBoxSBDisplayPolicy, szhorizontal)) &&
                            (newHeight / pCD->heightInc < pIBD->lastRow + 1)) {
                                ...
                                newRows = newHeight / pCD->heightInc;
                                packHorz = True;
                        } else if (newHeight / pCD->heightInc <
                                   pIBD->lastRow + 1) {
                                newHeight =
                                    (pIBD->lastRow + 1) * pCD->heightInc;
                                XtSetArg(setArgs[i], XmNheight,
                                         (XtArgVal)newHeight);
                                i++;
                        } else {
...
Boolean ExtendIconList(IconBoxData *pIBD, int incr) {
        ...
        if ((pTmp = (IconInfo *)XtMalloc(newSize * sizeof(IconInfo))) != NULL) {
                ...
                memcpy(pTmp, pIBD->IPD.placeList,
                       pIBD->IPD.totalPlaces * sizeof(IconInfo));
                memset(&pTmp[pIBD->IPD.totalPlaces], 0,
                       incr * sizeof(IconInfo));
 ...
 *
 *************************************<->***********************************/
void PackIconBox(IconBoxData *pIBD, Boolean packVert, Boolean packHorz,
                 int passedInWidth, int passedInHeight) {
        ...
        if (pIBD->IPD.iconPlacement & ICON_PLACE_LEFT_PRIMARY) {
                XtSetArg(args[i], XmNwidth, (XtArgVal)&majorDimension);
                i++;
                XtSetArg(args[i], XmNheight, (XtArgVal)&minorDimension);
                i++;
                XtGetValues(pIBD->clipWidget, args, i);
                if (packVert) {
                ...
                XtSetArg(args[i], XmNheight, (XtArgVal)&majorDimension);
                i++;
                XtSetArg(args[i], XmNwidth, (XtArgVal)&minorDimension);
                i++;
                XtGetValues(pIBD->clipWidget, args, i);
                if (packHorz) {
        ...
        while (ix1 < count) {
                 ...
                 */
                        ...
                        rippling =
                            ((newX != pWsc->iconX) || (newY != pWsc->iconY));
#else  /* WSM */
                        CvtIconPlaceToPosition(
                            &pIBD->IPD, pII_2->pCD->iconPlace, &newX, &newY);
                ...
                if ((pII_2->pCD == NULL) || rippling) {
                        ...
                        if ((ix1 < count) && (pII_1->pCD != NULL)) {
                                ...
                                CvtIconPlaceToPosition(&pIBD->IPD, ix2, &newX,
                                                       &newY);

#ifdef WSM
                                pWS = GetWorkspaceData(pII_2->pCD->pSD,
                                                       pIBD->wsID);
                                pWsc = GetWsClientData(pWS, pII_2->pCD);
                                pWsc->iconX = newX;
                                pWsc->iconY = newY;
                                ...
                                if (hasActiveText && (pII_2->pCD == pCD_tmp)) {
                                        ...
                                        HideActiveIconText(
                                            (WmScreenData *)NULL);
                                        XtMoveWidget(pII_2->theWidget, newX,
                                                     newY);
        ...
        if (pIBD->IPD.iconPlacement & ICON_PLACE_LEFT_PRIMARY) {
                if (majorDimension <= (Dimension)(pIBD->lastCol + 1)) {
                        newWidth =
                            (pIBD->lastCol + 1) * pIBD->pCD_iconBox->widthInc;
                        XtSetArg(args[i], XmNwidth, (XtArgVal)newWidth);
                        i++;
                } else {
                        newWidth = oldWidth;
                ...
                if (minorDimension <= (Dimension)(pIBD->lastRow + 1)) {
                        /* set height of bboard */
                        newHeight =
                            (pIBD->lastRow + 1) * pIBD->pCD_iconBox->heightInc;
                        XtSetArg(args[i], XmNheight, (XtArgVal)newHeight);
                        i++;
                } else {
                        newHeight =
            ...
            ((oldCols < newCols) &&
             (pIBD->IPD.iconPlacement & ICON_PLACE_LEFT_PRIMARY))) {
                ...
                for (ix1 = pIBD->IPD.totalPlaces - 1,
                    pII = &pIBD->IPD.placeList[ix1];
                     ix1 >= 0; ix1--, pII--) {
                        if (pII->pCD != NULL) {
                                CvtIconPlaceToPosition(&pIBD->IPD, ix1, &c1,
                                                       &c2);
...
void IconScrollVisibleCallback(Widget w, caddr_t client_data,
        ...
        XmScrollVisible(ACTIVE_WS->pIconBox->scrolledWidget,
                        vis_data->traversal_destination, 0, 0);
        /*
...
void IconActivateCallback(Widget w, caddr_t client_data,
        ...
        if (!(XFindContext(DISPLAY, theIcon, wmGD.windowContextType,
                           (caddr_t *)&pCD))) {
...
void ChangeActiveIconboxIconText(Widget icon, caddr_t dummy,
        ...
        if (!(XFindContext(DISPLAY, theIcon, wmGD.windowContextType,
                           (caddr_t *)&pCD)) &&
            P_ICON_BOX(pCD) && P_ICON_BOX(pCD)->pCD_iconBox &&
...
void HandleIconBoxIconKeyPress(Widget icon, caddr_t dummy,
        ...
        if (!(XFindContext(DISPLAY, theIcon, wmGD.windowContextType,
                ...
                if (!(HandleKeyPress(keyEvent, ACTIVE_PSD->keySpecs, True,
                                     context, False, pCD))) {
                        keyEvent->window = 0;
                        keyEvent->type = 0;
                }
...
void GetIconBoxIconRootXY(ClientData *pCD, int *pX, int *pY) {
...
#endif /* WSM */
        {
                ...
                XTranslateCoordinates(
                    DISPLAY, XtWindow(pWsc->pIconBox->bBoardWidget),
                    ROOT_FOR_CLIENT(pCD), pWsc->iconX + IB_MARGIN_WIDTH,
                    pWsc->iconY + IB_MARGIN_HEIGHT, pX, pY, &child);
#else  /* WSM */
                XTranslateCoordinates(
                    DISPLAY, XtWindow(P_ICON_BOX(pCD)->bBoardWidget),
                    ROOT_FOR_CLIENT(pCD), ICON_X(pCD) + IB_MARGIN_WIDTH,
                    ICON_Y(pCD) + IB_MARGIN_HEIGHT, pX, pY, &child);
#endif /* WSM */
...
Boolean IconVisible(ClientData *pCD) {
        ...
        i = 0;
        XtSetArg(getArgs[i], XmNwidth, (XtArgVal)&tmpWidth);
        i++;
        XtSetArg(getArgs[i], XmNheight, (XtArgVal)&tmpHeight);
        i++;
        ...
        XtTranslateCoords(pWsc->pIconBox->scrolledWidget, tmpX, tmpY, &clipX,
                          &clipY);
#else  /* WSM */
