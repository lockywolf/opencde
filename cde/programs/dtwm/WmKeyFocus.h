...
extern Boolean CheckForKeyFocus(ClientListEntry *pNextEntry, unsigned long type,
...
extern ClientData *FindNextTFocusInSeq(ClientData *pCD, unsigned long startAt);
extern ClientData *FindPrevTFocusInSeq(ClientData *pCD, unsigned long startAt);
