...
#ifndef lint
static char rcsid[] =
    "$XConsortium: WmResParse.c /main/9 1996/11/01 10:17:34 drk $"
#endif
#endif
/*
...
String CCIEntryModifierNames[] = {
    "none",           "inline",          "cascade", "delimit",
    "delimit_inline", "delimit_cascade", "exclude"};
...
static Boolean ParseWmFuncCCIArgs(unsigned char **linePP, WmFunction wmFunction,
                                  String *pArgs);
#endif /* !defined(WSM) || defined(MWM_QATS_PROTOCOL) */
...
static Boolean ParseWmFuncNoArg(unsigned char **linePP, WmFunction wmFunction,
                                String *pArgs);
#ifndef PANELIST
static Boolean ParseWmFuncStrArg(unsigned char **linePP, WmFunction wmFunction,
                                 String *pArgs);
#endif /* PANELIST */
...
FunctionTableEntry functionTable[] = {
#ifdef WSM
#ifdef PANELIST
    {"f.action", 0, CRS_ANY, 0, F_Action, ParseWmFuncActionArg},
#else  /* PANELIST */
    {"f.action", 0, CRS_ANY, 0, F_Action, ParseWmFuncStrArg},
#endif /* PANELIST */
#endif /* WSM */
    {"f.beep", 0, CRS_ANY, 0, F_Beep, ParseWmFuncNoArg},
#if ((!defined(WSM)) || defined(MWM_QATS_PROTOCOL))
    {"f.cci", 0, CRS_ANY, 0, F_Nop, ParseWmFuncCCIArgs},
#endif /* !defined(WSM) || defined(MWM_QATS_PROTOCOL) */
    {"f.circle_down", F_SUBCONTEXT_IB_IICON | F_SUBCONTEXT_IB_WICON, CRS_ANY, 0,
     F_Circle_Down, ParseWmFuncGrpArg},
    {"f.circle_up", F_SUBCONTEXT_IB_IICON | F_SUBCONTEXT_IB_WICON, CRS_ANY, 0,
     F_Circle_Up, ParseWmFuncGrpArg},
#ifdef WSM
    {"f.create_workspace", 0, CRS_ANY, 0, F_CreateWorkspace, ParseWmFuncNoArg},
    {"f.delete_workspace", 0, CRS_ANY, 0, F_DeleteWorkspace, ParseWmFuncNoArg},
#endif /* WSM */
    {"f.exec", 0, CRS_ANY, 0, F_Exec, ParseWmFuncStrArg},
    {"f.focus_color", F_SUBCONTEXT_IB_IICON | F_SUBCONTEXT_IB_WICON, CRS_ANY, 0,
     F_Focus_Color, ParseWmFuncNoArg},
    {"f.focus_key", F_SUBCONTEXT_IB_IICON | F_SUBCONTEXT_IB_WICON, CRS_ANY, 0,
     F_Focus_Key, ParseWmFuncNoArg},
#ifdef WSM
    {"f.goto_workspace", 0, CRS_ANY, 0, F_Goto_Workspace, ParseWmFuncStrArg},
#endif /* WSM */
#ifdef WSM
    {"f.help", 0, CRS_ANY, 0, F_Help,
     ParseWmFuncStrArg}, /* [helpvolume && helptopic] */
    {"f.help_mode", 0, CRS_ANY, 0, F_Help_Mode, ParseWmFuncNoArg}, /* for now */
#endif                                                             /* WSM */
#if ((!defined(WSM)) || defined(MWM_QATS_PROTOCOL))
    {"f.invoke_command", 0, CRS_ANY, 0, F_InvokeCommand, ParseWmFuncStrArg},
#endif /* !defined(WSM) || defined(MWM_QATS_PROTOCOL) */
    {"f.kill", F_CONTEXT_ROOT, CRS_ANY, MWM_FUNC_CLOSE, F_Kill,
     ParseWmFuncNoArg},
    {"f.lower", F_SUBCONTEXT_IB_IICON | F_SUBCONTEXT_IB_WICON, CRS_ANY, 0,
     F_Lower, ParseWmFuncMaybeStrArg},
#ifdef WSM
    {"f.marquee_selection",
     F_CONTEXT_WINDOW | F_CONTEXT_ICON | F_SUBCONTEXT_IB_IICON, CRS_ANY, 0,
     F_Marquee_Selection, ParseWmFuncNoArg},
#endif /* WSM */
    {"f.maximize", F_CONTEXT_ROOT | F_CONTEXT_MAXIMIZE | F_SUBCONTEXT_IB_WICON,
     CRS_ANY, MWM_FUNC_MAXIMIZE, F_Maximize, ParseWmFuncNoArg},
    {"f.menu", 0, CRS_ANY, 0, F_Menu, ParseWmFuncStrArg},
    {"f.minimize", F_CONTEXT_ICON | F_CONTEXT_ROOT | F_SUBCONTEXT_IB_IICON,
     CRS_ANY, MWM_FUNC_MINIMIZE, F_Minimize, ParseWmFuncNoArg},
    {"f.move", F_CONTEXT_ROOT, CRS_ANY, MWM_FUNC_MOVE, F_Move,
     ParseWmFuncNoArg},
    {"f.next_cmap", 0, CRS_ANY, 0, F_Next_Cmap, ParseWmFuncNoArg},
    {"f.next_key", 0, CRS_ANY, 0, F_Next_Key, ParseWmFuncGrpArg},
#ifdef WSM
    {"f.next_workspace", 0, CRS_ANY, 0, F_Next_Workspace, ParseWmFuncNoArg},
#endif /* WSM */
    {"f.nop",
     F_CONTEXT_ROOT | F_CONTEXT_ICON | F_CONTEXT_WINDOW |
         F_SUBCONTEXT_IB_WICON | F_SUBCONTEXT_IB_IICON,
     CRS_ANY, 0, F_Nop, ParseWmFuncNoArg},
    {"f.normalize", F_CONTEXT_ROOT | F_CONTEXT_NORMAL | F_SUBCONTEXT_IB_WICON,
     CRS_ANY, 0, F_Normalize, ParseWmFuncNoArg},
#ifdef PANELIST
    {"f.normalize_and_raise", F_CONTEXT_ROOT | F_CONTEXT_NORMAL, CRS_ANY, 0,
     F_Normalize_And_Raise, ParseWmFuncMaybeStrArg},
#else  /* PANELIST */
    {"f.normalize_and_raise", F_CONTEXT_ROOT | F_CONTEXT_NORMAL, CRS_ANY, 0,
     F_Normalize_And_Raise, ParseWmFuncNoArg},
#endif /* PANELIST */
#ifdef WSM
    {"f.occupy_all", F_CONTEXT_ICONBOX | F_CONTEXT_ROOT, CRS_ANY,
     DtWM_FUNC_OCCUPY_WS, F_AddToAllWorkspaces, ParseWmFuncNoArg},
#endif /* WSM */
    {"f.pack_icons", 0, CRS_ANY, 0, F_Pack_Icons, ParseWmFuncNoArg},
    {"f.pass_keys", 0, CRS_ANY, 0, F_Pass_Key, ParseWmFuncNoArg},
#if ((!defined(WSM)) || defined(MWM_QATS_PROTOCOL))
    {"f.post_rmenu", 0, CRS_KEY, 0, F_Post_RMenu, ParseWmFuncNoArg},
#endif /* !defined(WSM) || defined(MWM_QATS_PROTOCOL) */
    {"f.post_wmenu", 0, CRS_BUTTON | CRS_KEY, 0, F_Post_SMenu,
     ParseWmFuncNoArg},
    {"f.prev_cmap", 0, CRS_ANY, 0, F_Prev_Cmap, ParseWmFuncNoArg},
    {"f.prev_key", 0, CRS_ANY, 0, F_Prev_Key, ParseWmFuncGrpArg},
#ifdef WSM
    {"f.prev_workspace", 0, CRS_ANY, 0, F_Prev_Workspace, ParseWmFuncNoArg},
#endif /* WSM */
    ...
    {"f.raise", F_SUBCONTEXT_IB_IICON | F_SUBCONTEXT_IB_WICON, CRS_ANY, 0,
     F_Raise, ParseWmFuncMaybeStrArg},
    {"f.raise_lower",
     F_CONTEXT_ROOT | F_SUBCONTEXT_IB_IICON | F_SUBCONTEXT_IB_WICON, CRS_ANY, 0,
     F_Raise_Lower, ParseWmFuncNoArg},
    {"f.refresh", 0, CRS_ANY, 0, F_Refresh, ParseWmFuncNoArg},
    {"f.refresh_win", F_CONTEXT_ICON | F_CONTEXT_ROOT, CRS_ANY, 0,
     F_Refresh_Win, ParseWmFuncNoArg},
#ifdef WSM
    ...
    {"f.resize",
     ...
     CRS_ANY, MWM_FUNC_RESIZE, F_Resize, ParseWmFuncNoArg},
#ifdef WSM
    ...
    {"f.restore", F_CONTEXT_ROOT | F_CONTEXT_NORMAL | F_SUBCONTEXT_IB_WICON,
     CRS_ANY, 0, F_Restore, ParseWmFuncNoArg},
    {"f.restore_and_raise", F_CONTEXT_ROOT | F_CONTEXT_NORMAL, CRS_ANY, 0,
     F_Restore_And_Raise, ParseWmFuncNoArg},
    {"f.screen", 0, CRS_ANY, 0, F_Screen, ParseWmFuncStrArg},
    {"f.send_msg", F_CONTEXT_ROOT, CRS_ANY, 0, F_Send_Msg, ParseWmFuncNbrArg},
    {"f.separator", 0, CRS_MENU, 0, F_Separator, ParseWmFuncNoArg},
    {"f.set_behavior", 0, CRS_ANY, 0, F_Set_Behavior, ParseWmFuncNoArg},
#ifdef WSM
    {"f.set_context", 0, CRS_ANY, 0, F_Set_Context, ParseWmFuncNbrArg},
#endif /* WSM */
    {"f.title", 0, CRS_MENU, 0, F_Title, ParseWmFuncNoArg},
#if defined(PANELIST)
    {"f.toggle_frontpanel", 0, CRS_ANY, 0, F_Toggle_Front_Panel,
     ParseWmFuncNoArg},

    {"f.version", 0, CRS_ANY, 0, F_Version, ParseWmFuncNoArg},
#endif /* PANELIST */
#ifdef WSM
...
#ifdef OLD
    {
        ...
        {"f.workspace_presence",
         ...
         DtWM_FUNC_OCCUPY_WS, F_Workspace_Presence, ParseWmFuncNoArg},
#endif /* WSM */
#if defined(DEBUG) && defined(WSM)
        {"f.zz_debug", 0, CRS_ANY, 0, F_ZZ_Debug, ParseWmFuncStrArg},
#endif /* DEBUG */
    };
                    ...
                    pSD->pDtSessionItems[count].commandArgc == commandArgc) {
                        ...
                        for (argNum = 0; argNum < commandArgc; argNum++) {
                                if (strcmp(commandArgv[argNum],
                                           pSD->pDtSessionItems[count]
                                               .commandArgv[argNum]))

                                {
                                        /*
                                         * One mismatch and we quit looking at
                                         * this item. Decrement argNum so a
                                         * mismatch on the last item will not
                                         * look like a match below when
                                         * comparing argNum == commandArgc
                                         */
                                        argNum--;
                                        break;
                                }
                        ...
                        if (argNum == commandArgc) {
                                /*
                                 * Made it through all strings so this is a
                                 * match
                                 */
                                ...
                                /*
                                 * Free strings malloc'd for commandArgv for
                                 * this item
                                 */

                                for (relCount = 0; relCount < commandArgc;
                                     relCount++) {
                                        XtFree(pSD->pDtSessionItems[count]
                                                   .commandArgv[relCount]);
                                }
                                XtFree((char *)pSD->pDtSessionItems[count]
                                           .commandArgv);
                                ...
                                if (pSD->pDtSessionItems[count].sessionGeom) {
                                        ...
                                        if (sessionGeom->flags & WidthValue) {
                                                pCD->clientWidth =
                                                    sessionGeom->clientWidth;
                                                pCD->clientFlags |= SM_WIDTH;
                                        }
                                        if (sessionGeom->flags & HeightValue) {
                                                pCD->clientHeight =
                                                    sessionGeom->clientHeight;
                                                pCD->clientFlags |= SM_HEIGHT;
                                        }

                                        /*
                                         * Free SessionGeom malloc'd space for
                                         * this item
                                         */

                                        XtFree(
                                            (char *)pSD->pDtSessionItems[count]
                                                .sessionGeom);
                                }

                                if (pSD->pDtSessionItems[count].clientMachine) {
                                        /*
                                         * Free clientMachine malloc'd space for
                                         * this item
                                         */
                                ...
                                if (pSD->remainingSessionItems == 0) {
                                        /*
                                         * Free the whole pSD->pDtSessionHints
                                         * structure
                                         */
...

{
        ...
        if (mask) {
                ...
                if ((pTmpSessionGeom = (SessionGeom *)XtMalloc(
                         sizeof(SessionGeom))) == NULL) {
                        Warning(((char *)GETMESSAGE(
                            60, 1,
                            "Insufficient memory for session geometry item")));
                        return;
                }
...
#define ARG_AMT 100
        ...
        while ((string = GetSmartSMString(commandString)) != NULL) {
                ...
                if (argc >= iSizeArgv) {
                        iSizeArgv += ARG_AMT;
                        argv = (unsigned char **)XtRealloc(
                            (char *)argv, (iSizeArgv * sizeof(char *)));
                }
        }
...

{
        ...
        if ((pSD->pDtSessionItems = (DtSessionItem *)XtMalloc(
                ...
                Warning(((char *)GETMESSAGE(
                    60, 5, "Insufficient memory for Dt Session Hints")));
                return (False);
        }
                ...
                for (j = 0; j < map->max_keypermod; j++) {
                        if (map->modifiermap[k]) {
                                ...
                                if (nm && !strncmp("Alt", nm, 3)) {
                                        modifierStrings[ALT_INDEX].mask =
                                            (1 << i);
                                } else if (nm && !strncmp("Meta", nm, 4)) {
                                        modifierStrings[META_INDEX].mask =
                                            (1 << i);
                                }
                        }
                        k++;
        ...
        if (!bNested) {
...
#ifdef WSM
                /**** hhhhhhhhhhhh   ******/
                GetFunctionTableValues(&F_EXEC_INDEX, &F_NOP_INDEX,
                                       &F_ACTION_INDEX);
#endif /* WSM */
                /*
                ...
                if ((cfileP = FopenConfigFile()) == NULL) {
                        if (!wmGD.useStandardBehavior)
                                Warning(((char *)GETMESSAGE(
                                    60, 6, "Cannot open configuration file")));
                        return;
                }
...
static char *ExtractLocaleName(lang) String lang;
{
...
FILE *FopenConfigFile(void) {
        ...
        if ((LANGp == NULL) || (strlen(LANGp) == 0)) {
                ...
                /*
                 * To get a name for the file first look at the value of the
                 * configFile resource.  Interpret "~/.." as relative to the
                 * user's home directory. Use the LANG variable if set and
                 * .mwmrc is in $HOME/$LANG/.mwmrc
                 */
...
#endif /* PANELIST  */
                                if ((fileP = fopen(wmGD.configFile, "r")) !=
                                    NULL) {
                                        if (LANG != NULL) {
                                                XtFree(LANG);
                                                LANG = NULL;
...
#define SLASH_MWMRC "/system.mwmrc"
        ...
        strlcpy(cfileName, homeDir, MAXWMPATH + 1);
                ...
                if (MwmBehavior) {
                        ...
                        strncat(cfileName, LANG_DT_WMRC,
                                MAXWMPATH - strlen(cfileName));
                }
#else  /* WSM */
        if (LANG != NULL) {
        ...
        strncat(cfileName, HOME_MWMRC, MAXWMPATH - strlen(cfileName));
                ...
                strlcpy(cfileName, homeDir, MAXWMPATH + 1);
                        ...
                        if (MwmBehavior) {
                                 ...
                                 */
                                strncat(cfileName, HOME_DT_WMRC,
                                        MAXWMPATH - strlen(cfileName));
                        }
#else  /* WSM */
                strncat(cfileName, HOME_MWMRC, MAXWMPATH - strlen(cfileName));
...
static void ParseMenuSet(WmScreenData *pSD, unsigned char *lineP) {
        ...
        if ((menuSpec = (MenuSpec *)XtMalloc(sizeof(MenuSpec))) == NULL) {
                PWarning((
                    (char *)GETMESSAGE(60, 9, "Insufficient memory for menu")));
                return;
        }
        ...
        while ((GetNextLine() != NULL)) /* not EOF nor read error */
        {
                ...
                /* not a '{' */
                PWarning(((char *)GETMESSAGE(60, 11,
...
static MenuItem *ParseMenuItems(WmScreenData *pSD
        ...
        while ((GetNextLine() != NULL)) {
                ...
                if ((menuItem = (MenuItem *)XtMalloc(sizeof(MenuItem))) ==
                    NULL) {
                        PWarning(((char *)GETMESSAGE(
                            60, 12, "Insufficient memory for menu item")));
                        continue;
                }
                ...
                if (IsClientCommand((String)string)) {
                        if (!ParseClientCommand(&lineP, menuSpec, menuItem,
                                                string, &use_separators)) {
                                XtFree((char *)menuItem);
                                continue;
                        }

                        for (ix = 0; ix < WMFUNCTIONTABLESIZE - 1; ++ix)
                                if (functionTable[ix].wmFunction ==
                                    F_InvokeCommand)
                                        break;
                        ...
                        if (ix == WMFUNCTIONTABLESIZE - 1) {
                                ...
                                menuItem->wmFunction = F_InvokeCommand;
                ...
                if (!ParseWmAccelerator(&lineP, menuItem)) {
                         ...
                         * command. If it is a client command, then the
                         * wmFunction field should already be set, as well as
                         * the ix variable, but we do want to search for a menu
                         * item name that occupies the same place as the
                         * function does for normal menu items.
                         */
#if ((!defined(WSM)) || defined(MWM_QATS_PROTOCOL))
...
#endif /* !defined(WSM) || defined(MWM_QATS_PROTOCOL) */
                        ix = ParseWmFunction(&lineP, CRS_MENU,
                                             &menuItem->wmFunction);
                ...
                if ((menuItem->wmFunction == F_Toggle_Front_Panel) &&
                    ((wmGD.useFrontPanel == False) || (wmGD.dtSD != pSD))) {
                        ...
                        menuItem->greyedContext |=
                            (F_CONTEXT_ALL | F_SUBCONTEXT_IB_WICON |
                ...
                if (ix == F_CCI_INDEX) {
                        CCIEntryModifier mod =
                            ((CCIFuncArg *)menuItem->wmFuncArgs)->mod;

                        /* first fix the label if needed. */
                        if (!strcmp(menuItem->label,
                                    CCI_USE_DEFAULT_NAME_TAG)) {
                        ...
                        if (mod == DELIMIT || mod == DELIMIT_CASCADE ||
                            mod == DELIMIT_INLINE)
                                use_separators = True;
                }
                ...
                if (use_separators) {
                        MenuItem *separator =
                            MakeSeparatorTemplate(TOP_SEPARATOR);
                        if (lastMenuItem != NULL)
                                lastMenuItem->nextMenuItem = separator;
                        else
                                firstMenuItem = separator;
                ...
                if (use_separators) {
                        MenuItem *separator =
                            MakeSeparatorTemplate(BOTTOM_SEPARATOR);
                        if (lastMenuItem != NULL)
                                lastMenuItem->nextMenuItem = separator;
                        else
                                firstMenuItem = separator;
...
Boolean IsClientCommand(String string) {
        if ((mblen((char *)string, MB_CUR_MAX) == 1 && *string == '<') ||
            (strncmp(string, "-><", 3) == 0) ||
            (strncmp(string, "=<", 2) == 0) ||
            (strncmp(string, "=><", 3) == 0) || (strncmp(string, "~<", 2) == 0))
                return (TRUE);
...
static Boolean ParseClientCommand(unsigned char **linePP, MenuSpec *menuSpec,
        ...
        if ((unchanged_stream = stream = (String)XtMalloc(
                 (unsigned int)(sizeof(unsigned char) * linelen))) == NULL) {
                PWarning(((char *)GETMESSAGE(
        ...
        for (;;) {
                ...
                while (token == PRS_NO_STATE) {
                        ...
                        case '\0':
                        case '\n':
                                /* We've reached the end of the stream. Return
                                   the PRS_END token. */
                                token = PRS_END;
                                break;
                        case '-':
                        ...
                        case '~':
                                ...
                                token = PRS_MODIFIER;
                                exclusion = TRUE;
                                /* Setup a pointer to the text following the ~
                                   so we can do matching later for exclusions.
                                 */
                        ...
                        case '<':
                                ...
                                /* This should be the beginning of a reference.
                                ...
                                /* At this point, we should be looking at the
                                   close of the reference */
                                if (*stream == '>') {
                                        token = PRS_REFERENCE;
                                        ++stream;
                                } else
                        ...
                        case ' ':
                        case '\t':
                                /* The only place white space is allowed as at
                                   the beginning of the line, after all the
                                   client command text and within the delimiters
                                   of a REFERENCE. We are guaranteed not to have
                                   whitespace at the beginning of the line by
                                   the time this function is called. Also, the
                                   REFERENCE parsing above handles all white
                                   space internal to the client command.
                                   Therefore, since we are seeing white space,
                                   we must be at the end of the client command.
                                 */
                                token = PRS_END;
                                break;
                        default:
                ...
                for (i = 0; cmd_parse_table[state][i] != PRS_NO_STATE; ++i) {
                        if (token == cmd_parse_table[state][i]) {
                                /* It is a valid transition, so break out of the
                                 * loop */
                                break;
                        }
                }
...
#else  /* WSM */
                if ((menuItem->labelBitmapIndex =
                         GetBitmapIndex(pSD, (char *)string)) >= 0)
#endif /* WSM */
                {
...
static void ParseWmMnemonic(unsigned char **linePP, MenuItem *menuItem) {
         ...
         * If no string exists, the labelType is not XmSTRING, or does not
         * contain the first character, then skip the string and return.
         ...
         */
        {
                ...
                /* valid mnemonic */
                {
                        ...
                        PWarning(((char *)GETMESSAGE(
                            60, 14, "Invalid mnemonic specification")));
                }
        }
            ...
            (*(lineP + 1) != '.')) /* skip if we have f.xxx WmFunction */
        {
                if (ParseKeyEvent(&lineP, &eventType, &keycode, &state)) {
                        if ((string = (String)XtMalloc((
                                ...
                                PWarning(((char *)GETMESSAGE(
                                    60, 15,
                                    "Insufficient memory for accelerator "
                                    "specification")));
                                status = FALSE;
                        } else
                        /*
                        ...
                        PWarning(((char *)GETMESSAGE(
                            60, 16, "Invalid accelerator specification")));
                        status = FALSE;
                }
...
static void ParseMenuItemName(unsigned char **linePP, MenuItem *menuItem) {
        ...
        if (mblen((char *)lineP, MB_CUR_MAX) == 1 && *lineP == '"') {
                ...
                while (*endquote != '\0' &&
                       ...
                       (chlen > 1 || *endquote != '"')) {
                        /* If we ran off the end of the line, then just abort.
                           Bad syntax. */
                        if ((chlen == 1 && *endquote == '\n') ||
                            *endquote == '\0')
                                return;
                ...
                strncpy(menuItem->clientCommandName, (char *)lineP,
                        endquote - lineP);
                menuItem
                    ->clientCommandName[strlen(menuItem->clientCommandName) +
                                        1] = '\0';
        } else {
...
int ParseWmFunction(unsigned char **linePP, unsigned int res_spec,
         ...
         * This handles NULL and comment strings, bad function names, and
         * functions in inappropriate resource sets.
         */
        ...
        *linePP = lineP;
        ...
        if (string != NULL) {
                ...
                while (low <= high) {
                        mid = (low + high) / 2;
                        cmp =
                            strcmp(functionTable[mid].funcName, (char *)string);
        ...
        *pWmFunction = F_Nop;
         ...
         *  Comments:
         *  --------
         *  Only used to parse arguments for F_Lower, F_Raise, and
...
#endif
    Boolean
    ParseWmFuncMaybeStrArg(unsigned char **linePP, WmFunction wmFunction,
                           String *pArgs) {
...
static Boolean ParseWmFuncNoArg(unsigned char **linePP, WmFunction wmFunction,
        ...
        *pArgs = NULL;
         ...
         *  F_Raise_Lower, and F_Screen.  If it is used for any other function,
         *be sure to change FreeMenuItem () accordingly.
         *
         *************************************<->***********************************/
...
#endif
    Boolean
    ParseWmFuncStrArg(unsigned char **linePP, WmFunction wmFunction,
                      String *pArgs) {
        unsigned char *string;
        unsigned int len;
#ifndef NO_MULTIBYTE
...
void FreeMenuItem(MenuItem *menuItem) {
        ...
        /*
         * If menuItem->wmFuncArgs is nonNULL, we assume that it is a string
         * that was malloc'ed in ParseWmFuncStrArg () and we free it now.
         */
        ...
        *pGroup = 0;
        while (1) {
                ...
                /* Group missing => use default or complain */
                {
                        if (*pGroup) {
                                PWarning(((char *)GETMESSAGE(
                                    60, 18, "Missing group specification")));
                                return (FALSE);
                        } else {
                ...
                {
                        PWarning(((char *)GETMESSAGE(
                            60, 19, "Invalid group specification")));
                        return (FALSE);
                }
...
static Boolean ParseWmFuncNbrArg(unsigned char **linePP, WmFunction wmFunction,
        ...
        if (val == -1) {
                PWarning(((char *)GETMESSAGE(60, 20,
...
static Boolean ParseWmFuncCCIArgs(unsigned char **linePP, WmFunction wmFunction,
        ...
        if ((string = GetString(linePP)) == NULL) {
                /* Error - no data for f.cci command. cci_entry_list is
                 * required. */
                ...
                if (string[0] == '<') {
                        ...
                        if (!GetCCIModifier((String)string, &mod)) {
                                ...
                                if ((string = GetString(linePP)) == NULL) {
                                        /* Found a modifier, but there's no
                                         * cci_entry_list. */
                                        fprintf(stderr, "Incorrect format for "
                                                        "f.cci command.\n");
                                        return (FALSE);
                                } else {
                                        cciArg->cciEntry =
                                            XtNewString((char *)string);
                                }
                        }
                }
...
static void ParseButtonSet(WmScreenData *pSD, unsigned char *lineP) {
        ...
        while ((GetNextLine() != NULL)) /* not EOF nor read error */
        {
                ...
                /* not a '{' */
                PWarning(((char *)GETMESSAGE(
                    60, 21, "Expected '{' after button set name")));
                return;
        }
        ...
        while ((GetNextLine() != NULL)) /* not EOF nor read error */
        {
                 ...
                 */
                if ((buttonSpec = (ButtonSpec *)XtMalloc(sizeof(ButtonSpec))) ==
                    NULL) {
                        PWarning(((char *)GETMESSAGE(
                            60, 22,
                 ...
                 */
                lineP = line;
                if (!ParseBtnEvent(&lineP, &buttonSpec->eventType,
                                   &buttonSpec->button, &buttonSpec->state,
                                   &buttonSpec->click)) {
                        PWarning(((char *)GETMESSAGE(
                            60, 23, "Invalid button specification")));
                ...
                ix = ParseWmFunction(&lineP, CRS_BUTTON,
                                     &buttonSpec->wmFunction);
                ...
                /*
                 * Add the button specification to the button specification
                 * list.
                 */
                if (lastButtonSpec != NULL)
        ...
        *subContext = 0;
        while (1) {
                ...
                if (!strcmp("root", (char *)ctxStr)) {
                        ...
                        *context |=
                            (F_CONTEXT_ICON | F_CONTEXT_ICONBOX |
                             F_SUBCONTEXT_IB_IICON | F_SUBCONTEXT_IB_WICON);
                        *subContext |=
                            (F_SUBCONTEXT_I_ALL | F_SUBCONTEXT_IB_IICON |
                             F_SUBCONTEXT_IB_WICON);
...
static void ParseKeySet(WmScreenData *pSD, unsigned char *lineP) {
        ...
        while ((GetNextLine() != NULL)) /* not EOF nor read error */
        {
                ...
                /* not a '{' */
                PWarning(((char *)GETMESSAGE(
                    60, 25, "Expected '{' after key set name")));
                return;
        }
...
#else  /* WSM */
                        PWarning(((char *)GETMESSAGE(
                            60, 27, "Invalid key specification")));
                        XtFree((char *)keySpec);
...
#endif /* WSM */
                        PWarning((
                            (char *)GETMESSAGE(60, 28, "Invalid key context")));
                        XtFree((char *)keySpec);
                        continue; /* skip this key specification */
                }
#ifdef WSM
...
unsigned char *GetNextLine(void) {
        ...
        /* read fopened file */
        {
                if ((string = (unsigned char *)fgets((char *)line, MAXLINE,
                                                     cfileP)) != NULL) {
#ifndef NO_MULTIBYTE

                        lastlen = 0;
                        while (*string && ((len = mblen((char *)string,
                                                        MB_CUR_MAX)) > 0)) {
                        ...
                        if (lastlen == 1 && last == wdelim) {
                                do {
                                        ...
                                        while (
                                            *string &&
                                            ((len = mblen((char *)string,
                                                          MB_CUR_MAX)) > 0)) {
                                                mbtowc(&last, (char *)string,
                                                       MB_CUR_MAX);
                                                lastlen = len;
                                                string += len;
                                        }
...
#endif /* WSM */
{
        ...
        /* Quoted string */
        {
...
#endif /* WSM */
                /*
                 * Start beyond double quote and find the end of the quoted
                 * string.
                 * '\' quotes the next character.
                 * Otherwise,  matching double quote or NULL terminates the
                 * string.
                 *
                 * We use lnwsP to point to the last non-whitespace character in
                 * the quoted string.  When we have found the end of the quoted
                 * string, increment lnwsP and if lnwsP < endP, write NULL into
                 * *lnwsP. This removes any trailing whitespace without
                 * overwriting the matching quote, needed later.  If the quoted
                 * string was all whitespace, then this will write a NULL at the
                 * beginning of the string that will be returned -- OK.
                 */
                 ...
                 */
                {
                         ...
                         */
                        {
                                ...
                                if (SmBehavior) {
                                        /*
                                         * Check to see if this is a quoted
                                         * quote - if it is strip off a level -
                                         * if not - it's sacred leave it alone
                                         */
                                        checkLev = PeekAhead((curP - 1),
                                                             quoteLevel[level]);
                                        if (checkLev > 0) {
                                                if (quoteLevel[level] <=
                                                    checkLev) {
                        ...
                        /* Multibyte (nonwhitespace) character:  point lnwsP to
                         * it. Finish character byte copy.
                         */
                        {
                                lnwsP = endP++;
                                while (--chlen) {
        ...
        /* Unquoted string */
        {
                 ...
                 * '\' quotes the next character.
                 * Otherwise,  whitespace, end-of-line, or '#' terminates the
                 * string.
                 */
                curP = endP = lineP;
                 ...
                 *   whitespace or
                 *     matching quote -> write end-of-line over char and point
                 * beyond NULL -> point to NULL
                 */
...
Boolean ParseBtnEvent(unsigned char **linePP, unsigned int *eventType,
                      unsigned int *button, unsigned int *state,
                      Boolean *fClick) {
        if (!ParseEvent(linePP, buttonEvents, eventType, button, state,
                        fClick)) {
                return (FALSE);
        }
        ...
        if (*eventType == ButtonRelease) {
                /* the button that is going up will always be in the
                 * modifiers... */
...

{
        ...
        if (!ParseEvent(linePP, keyEvents, eventType, &keySym, state,
                        &fClick)) {
                return (FALSE);
        }
...
static Boolean ParseKeySym(unsigned char **linePP, unsigned int closure,
...
#ifndef NO_MULTIBYTE
        while (*lineP && ((chlen = mblen((char *)lineP, MB_CUR_MAX)) > 0) &&
               ((chlen > 1) ||
...
#endif
        {
                if (!isdigit(keySymName[0]) ||
                    ((*detail = StrToNum((unsigned char *)&keySymName[0])) ==
                     -1)) {
                        *detail = NoSymbol;
                        return (FALSE);
                }
...
void PWarning(char *message) {
        ...
        if (cfileP != NULL) {
                ...
                fprintf(
                    stderr,
                    ((char *)GETMESSAGE(
                        60, 34, "%s: %s on line %d of specification string\n")),
                    wmGD.mwmName, message, linec);
        }
        fflush(stderr);
#endif /* WSM */
...
static void InitKeySubs(KeySub **ppKeySubs, int *pNumKeySubs) {
        ...
        while (*pch0 != '\0') {
                ...
                if (pKSret == NULL) {
                        ...
                        pKSret = (KeySub *)XtRealloc(
                            (char *)pKSret, (numKS + 1) * sizeof(KeySub));
                }
                pKS = &pKSret[numKS];
...
#ifndef NO_MULTIBYTE
                while (*pch1 &&
                       ((chlen = mblen((char *)pch1, MB_CUR_MAX)) > 0)) {
                        if ((chlen == 1) && (*pch1 == ' ')) {
                                break;
                        }
                        pch1 += chlen;
        ...
        while (*startP != '<') {
                ...
                for (i = 0; i < numKeySubs; i++) {
                        if ((pKeySub[i].lenFrom == startP - pchFirst) &&
                            (!strncasecmp((char *)pKeySub[i].pchFrom,
                                          (char *)pchFirst,
                                          pKeySub[i].lenFrom))) {
...
#define WM_ACTION_ARG_PAD 256
        ...
        if (pAP && (string = GetString(linePP)) != NULL) {
                ...
                if ((pAP->aap = (DtActionArg *)XtMalloc(
                         WM_ACTION_ARG_INCREMENT * sizeof(DtActionArg)))) {
                        ...
                        while ((string = GetString(linePP)) != NULL) {
                                if ((pAP->aap[pAP->numArgs].u.file.name =
                                        ...
                                        if (pAP->numArgs == iArgSz) {
                                                /* need to increase our array
                                                 * space */
                                                iArgSz +=
                                                    WM_ACTION_ARG_INCREMENT;
                                                pAP->aap =
                                                    (DtActionArg *)XtRealloc(
                                                        (char *)pAP->aap,
                                                        (iArgSz *
                                                         sizeof(DtActionArg)));
                                                if (!pAP->aap) {
...
Boolean SetGreyedContextAndMgtMask(MenuItem *menuItem, WmFunction wmFunction) {
        int ix;
        ...
        for (ix = 0; ix < WMFUNCTIONTABLESIZE - 1; ++ix) {
                if (functionTable[ix].wmFunction == wmFunction) {
                        ...
                        menuItem->greyedContext =
                            functionTable[ix].greyedContext;
                        menuItem->mgtMask = functionTable[ix].mgtMask;
                        return (True);
                }
        }
 ...
 *
 *************************************<->***********************************/
static MenuItem *MakeSeparatorTemplate(int position) {
        MenuItem *item;
