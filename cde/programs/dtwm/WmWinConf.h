...
extern void DrawOutline(int x, int y, unsigned int width, unsigned int height);
...
extern void FixFrameValues(ClientData *pcd, int *pfX, int *pfY,
                           ...
                           Boolean resizing);
extern void FlashOutline(int x, int y, unsigned int width, unsigned int height);
extern void ForceOnScreen(int screen, int *pX, int *pY);
extern void GetClipDimensions(ClientData *pCD, Boolean fromRoot);
extern void GetConfigEvent(Display *display, Window window, unsigned long mask,
...
extern void MoveOpaque(ClientData *pcd, int x, int y, unsigned int width,
                       unsigned int height);
extern void MoveOutline(int x, int y, unsigned int width, unsigned int height);
...
extern void SetPointerPosition(int newX, int newY, int *actualX, int *actualY);
