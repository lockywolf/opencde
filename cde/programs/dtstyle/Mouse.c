...
#define WARN_MSG                                                               \
        ((char *)GETMESSAGE(9, 13,                                             \
                            "The right and left mouse buttons will swap\n\
...
#define MID_WARN_MSG_T                                                         \
        ((char *)GETMESSAGE(9, 14,                                             \
                            "If you click on OK, mouse button 2 will be set\n\
to `transfer' (drag) at your next session."))
#define IMMEDIATE_MSG                                                          \
        ((char *)GETMESSAGE(9, 15,                                             \
                            "The new double-click time will take effect\n\
as applications are restarted."))
#define LATER_MSG                                                              \
        ((char *)GETMESSAGE(9, 16,                                             \
                            "The new double-click time will take effect\n\
at your next session."))
#define MID_WARN_MSG_A                                                         \
        ((char *)GETMESSAGE(9, 19,                                             \
                            "If you click on OK, mouse button 2 will be set\n\
...
static Widget build_mouseDialog(Widget shell);
static void formLayoutCB(Widget w, XtPointer client_data, XtPointer call_data);
static void _DtmapCB_mouseDialog(Widget w, XtPointer client_data,
                                 XtPointer call_data);
static int getValue(Widget w);
static void valueChangedCB(Widget w, XtPointer client_data,
                           XtPointer call_data);
static void dclickVCCB(Widget w, XtPointer client_data, XtPointer call_data);
static void dclickTestCB(Widget w, XtPointer client_data, XtPointer call_data);
static void reverseToggleCB(Widget w, XtPointer client_data,
                            XtPointer call_data);
static void midreverseToggleCB(Widget w, XtPointer client_data,
                               XtPointer call_data);
static void warnToggleCB(Widget w, XtPointer client_data, XtPointer call_data);
static void midwarnToggleCB(Widget w, XtPointer client_data,
                            XtPointer call_data);
static void cancelWarnCB(Widget w, XtPointer client_data, XtPointer call_data);
static void midcancelWarnCB(Widget w, XtPointer client_data,
                            XtPointer call_data);
...
void popup_mouseBB(Widget shell) {
...
static Widget build_mouseDialog(Widget shell) {
        ...
        nmap = 256;
        mouse.numButtons =
            XGetPointerMapping(style.display, mouse.map_return, nmap);
        ...
        if (mouse.type == POINTER3B) {
                mouse.b3 = XmGetPixmap(style.screen, B3, style.secBSCol,
                                       style.secTSCol);
                mouse.b3_rev = XmGetPixmap(style.screen, B3_REV, style.secBSCol,
                                           style.secTSCol);
                mouse.b3Sel = XmGetPixmap(style.screen, B3, style.secTSCol,
                                          style.secBSCol);
        ...
        {
                mouse.b2 = XmGetPixmap(style.screen, B2, style.secBSCol,
                                       style.secTSCol);
                mouse.b2_rev = XmGetPixmap(style.screen, B2_REV, style.secBSCol,
                                           style.secTSCol);
                mouse.b2Sel = XmGetPixmap(style.screen, B2, style.secTSCol,
                                          style.secBSCol);
        ...
        if (!XrmGetResource(database, str_name, str_class,
                            (char **)&str_type_return, &value_return)) {
                mouse.function = TRANSFER;
                mouse.origFunction = TRANSFER;
        } else if (strcmp(value_return.addr, "True") == 0) {
        ...
        save.poscnt++;
        style.mouseDialog = __DtCreateDialogBoxDialog(
            shell, mouseString, save.posArgs, save.poscnt);
        ...
        XtSetArg(args[n], XmNtitle,
                 ((char *)GETMESSAGE(9, 18, "Style Manager - Mouse")));
        n++;
        ...
        n++;
        widget_list[count++] = mouse.systemDefault =
        ...
        n++;
        widget_list[count++] = mouse.pictFrame =
            XmCreateFrame(form, "pictFrame", args, n);

        n = 0;
        XtSetArg(args[n], XmNorientation, XmVERTICAL);
        n++;
        XtSetArg(args[n], XmNadjustMargin, False);
        n++;
        ...
        n++;
        XtSetArg(args[n], XmNlabelPixmap, mouse.pixmap);
        n++;
        ...
        n++;
        mouse.pictButton =
            XmCreatePushButton(mouse.pictRC, "mousePict", args, n);
        ...
        n++;
        mouse.pictLabel =
            XmCreateLabelGadget(mouse.pictRC, "mouseLabel", args, n);
        XmStringFree(string);
        ...
        XtSetArg(args[n], XmNlabelString, string);
        n++;
        widget_list[count++] = mouse.handLabGad =
            XmCreateLabelGadget(form, "handLabGad", args, n);
        XmStringFree(string);
        ...
        n++;
        mouse.rightToggle =
            XmCreateToggleButtonGadget(form, "rightToggle", args, n);
        XmStringFree(string);
        ...
        n++;
        mouse.leftToggle =
            XmCreateToggleButtonGadget(form, "leftToggle", args, n);
        XmStringFree(string);
        ...
        XtSetArg(args[n], XmNlabelString, string);
        n++;
        widget_list[count++] = mouse.middleLabGad =
            XmCreateLabelGadget(form, "middleLabGad", args, n);
        XmStringFree(string);
        ...
        XtSetArg(args[n], XmNalignment, XmALIGNMENT_BEGINNING);
        n++;
        mouse.transferToggle =
            XmCreateToggleButtonGadget(form, "transToggle", args, n);
        XmStringFree(string);
        ...
        n++;
        mouse.adjustToggle =
            XmCreateToggleButtonGadget(form, "adjToggle", args, n);
        XmStringFree(string);
        ...
        XtSetArg(args[n], XmNlabelString, string);
        n++;
        widget_list[count++] = mouse.dclickLabGad =
            XmCreateLabelGadget(form, "dclickLabGad", args, n);
        XmStringFree(string);

        n = 0;
        XtSetArg(args[n], XmNmaximum, DCLICK_MAX);
        n++;
        XtSetArg(args[n], XmNminimum, DCLICK_MIN);
        n++;
        ...
        n++;
        XtSetArg(args[n], XmNvalue, mouse.mydclick);
        n++;
        XtSetArg(args[n], XmNdecimalPoints, (short)1);
        n++;
        widget_list[count++] = mouse.dclickScale =
            XmCreateScale(form, "dclickScale", args, n);
        ...
        XtSetArg(args[n], XmNlabelString, string);
        n++;
        widget_list[count++] = mouse.accelLabGad =
            XmCreateLabelGadget(form, "accelLabGad", args, n);
        XmStringFree(string);

        n = 0;
        XtSetArg(args[n], XmNminimum, ACCEL_MIN);
        n++;
        XtSetArg(args[n], XmNmaximum, ACCEL_MAX);
        n++;
        XtSetArg(args[n], XmNorientation, XmHORIZONTAL);
        n++;
        XtSetArg(args[n], XmNprocessingDirection, XmMAX_ON_RIGHT);
        ...
        XtSetArg(args[n], XmNshowValue, True);
        n++;
        widget_list[count++] = mouse.accelScale =
            XmCreateScale(form, "accelScale", args, n);
        ...
        XtSetArg(args[n], XmNlabelString, string);
        n++;
        widget_list[count++] = mouse.threshLabGad =
            XmCreateLabelGadget(form, "threshLabGad", args, n);
        XmStringFree(string);

        n = 0;
        XtSetArg(args[n], XmNminimum, THRESH_MIN);
        n++;
        XtSetArg(args[n], XmNmaximum, THRESH_MAX);
        n++;
        XtSetArg(args[n], XmNorientation, XmHORIZONTAL);
        n++;
        XtSetArg(args[n], XmNprocessingDirection, XmMAX_ON_RIGHT);
        ...
        XtSetArg(args[n], XmNshowValue, True);
        n++;
        widget_list[count++] = mouse.threshScale =
            XmCreateScale(form, "threshScale", args, n);

        XtAddCallback(style.mouseDialog, XmNmapCallback, formLayoutCB, NULL);
        XtAddCallback(style.mouseDialog, XmNmapCallback, _DtmapCB_mouseDialog,
                      shell);
        XtAddCallback(mouse.systemDefault, XmNactivateCallback, systemDefaultCB,
                      NULL);
        ...
        if (mouse.function == TRANSFER) {
                ...
                XmToggleButtonGadgetSetState(mouse.transferToggle, False,
                                             False);
        }
        ...
        XtAddCallback(mouse.rightToggle, XmNvalueChangedCallback, warnToggleCB,
                      (XtPointer)RIGHT_HANDED);

        XtAddCallback(mouse.leftToggle, XmNvalueChangedCallback, warnToggleCB,
                      (XtPointer)LEFT_HANDED);
        ...
        XtAddCallback(mouse.accelScale, XmNvalueChangedCallback, valueChangedCB,
                      NULL);

        XtAddCallback(mouse.threshScale, XmNvalueChangedCallback,
                      valueChangedCB, NULL);
        XtAddCallback(mouse.dclickScale, XmNvalueChangedCallback, dclickVCCB,
                      (caddr_t)mouse.pictButton);
        XtAddCallback(mouse.pictButton, XmNactivateCallback, dclickTestCB,
                      NULL);
...
static void formLayoutCB(Widget w, XtPointer client_data, XtPointer call_data) {
        ...
        n++;
        XtSetArg(args[n], XmNtopWidget, mouse.systemDefault);
        n++;
        XtSetArg(args[n], XmNtopOffset, 4 * style.verticalSpacing);
        n++;
        XtSetArg(args[n], XmNbottomAttachment, XmATTACH_NONE);
        n++;
        XtSetArg(args[n], XmNleftAttachment, XmATTACH_WIDGET);
        n++;
        XtSetArg(args[n], XmNleftWidget, mouse.pictFrame);
        n++;
        XtSetArg(args[n], XmNleftOffset, 2 * style.horizontalSpacing);
        n++;
        XtSetArg(args[n], XmNrightAttachment, XmATTACH_NONE);
        n++;
        ...
        n++;
        XtSetArg(args[n], XmNtopWidget, mouse.handLabGad);
        n++;
        ...
        XtSetArg(args[n], XmNleftAttachment, XmATTACH_WIDGET);
        n++;
        XtSetArg(args[n], XmNleftWidget, mouse.handLabGad);
        n++;
        XtSetArg(args[n], XmNleftOffset, style.horizontalSpacing);
        n++;
        XtSetArg(args[n], XmNrightAttachment, XmATTACH_NONE);
        ...
        XtSetArg(args[n], XmNleftAttachment, XmATTACH_WIDGET);
        n++;
        XtSetArg(args[n], XmNleftWidget, mouse.rightToggle);
        n++;
        XtSetArg(args[n], XmNleftOffset, style.horizontalSpacing);
        n++;
        XtSetArg(args[n], XmNrightAttachment, XmATTACH_FORM);
        ...
        XtSetArg(args[n], XmNtopWidget, mouse.handLabGad);
        n++;
        XtSetArg(args[n], XmNtopOffset, 3 * style.verticalSpacing);
        n++;
        XtSetArg(args[n], XmNbottomAttachment, XmATTACH_NONE);
        n++;
        XtSetArg(args[n], XmNleftAttachment, XmATTACH_WIDGET);
        ...
        XtSetArg(args[n], XmNtopAttachment, XmATTACH_OPPOSITE_WIDGET);
        n++;
        XtSetArg(args[n], XmNtopWidget, mouse.middleLabGad);
        n++;
        XtSetArg(args[n], XmNtopOffset, -5);
        n++;
        XtSetArg(args[n], XmNbottomAttachment, XmATTACH_NONE);
        ...
        XtSetArg(args[n], XmNleftAttachment, XmATTACH_WIDGET);
        n++;
        XtSetArg(args[n], XmNleftWidget, mouse.transferToggle);
        n++;
        XtSetArg(args[n], XmNleftOffset, style.horizontalSpacing);
        n++;
        XtSetArg(args[n], XmNrightAttachment, XmATTACH_FORM);
        ...
        XtSetArg(args[n], XmNtopAttachment, XmATTACH_WIDGET);
        n++;
        XtSetArg(args[n], XmNtopWidget, mouse.pictFrame);
        n++;
        XtSetArg(args[n], XmNtopOffset, TopOffset);
        n++;
        XtSetArg(args[n], XmNbottomAttachment, XmATTACH_NONE);
        n++;
        XtSetArg(args[n], XmNleftAttachment, XmATTACH_FORM);
        ...
        XtSetArg(args[n], XmNleftOffset, LeftOffset);
        n++;
        XtSetArg(args[n], XmNrightAttachment, XmATTACH_NONE);
        n++;
        ...
        n++;
        XtSetArg(args[n], XmNbottomWidget, mouse.dclickLabGad);
        n++;
        XtSetArg(args[n], XmNbottomOffset, 0);
        n++;
        XtSetArg(args[n], XmNleftAttachment, XmATTACH_WIDGET);
        n++;
        XtSetArg(args[n], XmNleftWidget, mouse.dclickLabGad);
        n++;
        XtSetArg(args[n], XmNleftOffset, 2 * style.horizontalSpacing);
        n++;
        XtSetArg(args[n], XmNrightAttachment, XmATTACH_FORM);
        ...
        XtSetArg(args[n], XmNtopAttachment, XmATTACH_WIDGET);
        n++;
        XtSetArg(args[n], XmNtopWidget, mouse.dclickLabGad);
        n++;
        XtSetArg(args[n], XmNtopOffset, TopOffset);
        n++;
        XtSetArg(args[n], XmNbottomAttachment, XmATTACH_NONE);
        ...
        XtSetArg(args[n], XmNbottomAttachment, XmATTACH_OPPOSITE_WIDGET);
        n++;
        XtSetArg(args[n], XmNbottomWidget, mouse.accelLabGad);
        n++;
        XtSetArg(args[n], XmNbottomOffset, 0);
        n++;
        XtSetArg(args[n], XmNleftAttachment, XmATTACH_WIDGET);
        n++;
        XtSetArg(args[n], XmNleftWidget, mouse.accelLabGad);
        n++;
        XtSetArg(args[n], XmNleftOffset, 2 * style.horizontalSpacing);
        n++;
        XtSetArg(args[n], XmNrightAttachment, XmATTACH_FORM);
        ...
        XtSetArg(args[n], XmNtopAttachment, XmATTACH_WIDGET);
        n++;
        XtSetArg(args[n], XmNtopWidget, mouse.accelScale);
        n++;
        XtSetArg(args[n], XmNtopOffset, TopOffset);
        n++;
        ...
        XtSetArg(args[n], XmNbottomAttachment, XmATTACH_OPPOSITE_WIDGET);
        n++;
        XtSetArg(args[n], XmNbottomWidget, mouse.threshLabGad);
        n++;
        XtSetArg(args[n], XmNbottomOffset, 0);
        n++;
        XtSetArg(args[n], XmNleftAttachment, XmATTACH_WIDGET);
        n++;
        XtSetArg(args[n], XmNleftWidget, mouse.threshLabGad);
        n++;
        XtSetArg(args[n], XmNleftOffset, 2 * style.horizontalSpacing);
        n++;
        XtSetArg(args[n], XmNrightAttachment, XmATTACH_FORM);
...
static void _DtmapCB_mouseDialog(Widget w, XtPointer client_data,
        ...
        n = 0;
        XtSetArg(args[n], XmNvalue, mouse.accel_numerator);
        n++;
        XtSetValues(mouse.accelScale, args, n);

        n = 0;
        XtSetArg(args[n], XmNvalue, mouse.threshold);
        n++;
        XtSetValues(mouse.threshScale, args, n);
}
...
static void valueChangedCB(Widget w, XtPointer client_data,
        ...
        XChangePointerControl(style.display, True, True, new_acceln, new_acceld,
                              new_thresh);
...
static void dclickTestCB(Widget w, XtPointer client_data, XtPointer call_data) {
        ...
        if (cb->event->xbutton.button == 1) {
                if (cb->click_count == 2) {
                        if (selectstate) {
                                n = 0;
                                XtSetArg(color[n], XmNlabelPixmap,
                                         mouse.pixmap);
                                n++;
                                ...
                                if (style.useMultiColorIcons) {
                                        n = 0;
                                        XtSetArg(color[n], XmNbackground,
                                                 style.secBgCol);
                                        n++;
                                        XtSetValues(w, color, n);
                                ...
                                /* This will change the  background color to
                                   select color, but it causes the pixmap to
...
static void warnToggleCB(Widget w, XtPointer client_data, XtPointer call_data) {
        ...
        n = 0;
        XtSetArg(args[n], XmNokLabelString, CMPSTR((String)_DtOkString));
        n++;
        ...
        XtSetArg(args[n], XmNdialogTitle,
                 CMPSTR((char *)GETMESSAGE(2, 2, "Notice")));
        n++;
        warnDialog =
            XmCreateInformationDialog(style.shell, "WarnDialog", args, n);
        XmStringFree(string);
...
static void midwarnToggleCB(Widget w, XtPointer client_data,
        ...
        n++;
        midwarnDialog =
            XmCreateInformationDialog(style.shell, "MidWarnDialog", args, n);

        XtUnmanageChild(
            XmMessageBoxGetChild(midwarnDialog, XmDIALOG_HELP_BUTTON));

        if ((intptr_t)client_data == TRANSFER) {
                warnstring = CMPSTR(MID_WARN_MSG_T);
                XtVaSetValues(midwarnDialog, XmNmessageString, warnstring,
                              NULL);
                n++;
...
static void systemDefaultCB(Widget w, XtPointer client_data,
        ...
        XGetPointerControl(style.display, &new_acceln, &new_acceld,
                           &new_thresh);

        n = 0;
        XtSetArg(args[n], XmNvalue, new_acceln);
        n++;
        XtSetValues(mouse.accelScale, args, n);

        n = 0;
        XtSetArg(args[n], XmNvalue, new_thresh);
        n++;
        XtSetValues(mouse.threshScale, args, n);

        n = 0;
        XtSetArg(args[n], XmNvalue, DCLICKDEFAULT / 100);
        n++;
        XtSetValues(mouse.dclickScale, args, n);
...
static void ButtonCB(Widget w, XtPointer client_data, XtPointer call_data) {
        ...
        case OK_BUTTON:
                ...
                if (style.smState.smSendSettings) {
                        ...
                        } else /* dclick or one of the sliders changed */
                        {
                                ...
                                if (mouse.numButtons == 3 ||
                                    mouse.numButtons == 5)
                                        sprintf(message2, "%d_%d_%d",
                                                mouse.new_map_return[0],
                                                mouse.new_map_return[1],
                                                mouse.new_map_return[2]);
                                else
                                        sprintf(message2, "%d_%d_%d_%d_%d",
                                                mouse.new_map_return[0],
                                                mouse.new_map_return[1],
                                                mouse.new_map_return[2],
                                ...
                                sprintf(message3, "%d",
                                        getValue(mouse.accelScale));
                                sprintf(message4, "%d",
                                        getValue(mouse.threshScale));
                                ...
                                if (mouse.dclickChanged) {
                                        if (style.xrdb.writeXrdbImmediate) {
                                                InfoDialog(IMMEDIATE_MSG,
                                                           style.shell, False);
                                                _DtAddToResource(style.display,
                                                                 dclickRes);
                                        } else
                                                InfoDialog(LATER_MSG,
                                                           style.shell, False);
                                }

                                sprintf(pointerStr, "%s %s %s %s %s", message1,
                                        message2, message3, message4,
                                        dclickRes);

                                SmNewPointerSettings(pointerStr);
                        }
                } else { /* sendSettings is False. If double click has changed
                          * update Xrdb
                          */
                ...
                if (mouse.btn2Changed)
                        if (mouse.function == TRANSFER)
                                sprintf(enableBtn1Res, enableBtn1TransferString,
                                        "button2_transfer");
                        else
                                sprintf(enableBtn1Res, enableBtn1TransferString,
                                        "True");
        ...
        case CANCEL_BUTTON:
                ...
                if ((new_thresh != mouse.threshold) ||
                    (new_acceln != mouse.accel_numerator)) {
                        ...
                        XChangePointerControl(style.display, do_accel,
                                              do_thresh, mouse.accel_numerator,
                                              mouse.accel_denominator,
                                              mouse.threshold);
                }
                ...
                if (mouse.handed != mouse.origHanded) {
                        if (XSetPointerMapping(style.display, mouse.map_return,
                                               mouse.numButtons) !=
                            MappingSuccess)
                                _DtSimpleError(progName, DtWarning, NULL, MSG3,
                                               NULL);
                ...
                if (mouse.function != mouse.origFunction) {
                        ...
                        if (mouse.origFunction == TRANSFER) {
                                XmToggleButtonGadgetSetState(
                                    mouse.transferToggle, True, True);
                                XmToggleButtonGadgetSetState(mouse.adjustToggle,
                                                             False, False);
                        } else {
                                XmToggleButtonGadgetSetState(
                                    mouse.transferToggle, False, False);
                                XmToggleButtonGadgetSetState(mouse.adjustToggle,
                                                             True, True);
                        }
                }
        ...
        case HELP_BUTTON:
                XtCallCallbacks(style.mouseDialog, XmNhelpCallback,
                                (XtPointer)NULL);
                break;
 ...
 ************************************************************************/
void restoreMouse(Widget shell, XrmDatabase db) {
        XrmName xrm_name[5];
