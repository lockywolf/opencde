...
void HelpRequestCB(Widget w, caddr_t client_data, caddr_t call_data) {
...
void QuickHelpRequestCB(Widget w, caddr_t client_data, caddr_t call_data) {}

void HelpModeCB(Widget w, caddr_t client_data, caddr_t call_data) {
        Widget widget;

        switch (
            DtHelpReturnSelectedWidgetId(style.shell, (Cursor)NULL, &widget)) {
        /*
