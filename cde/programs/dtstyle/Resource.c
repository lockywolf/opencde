...
XtResource resources[] = {
    ...
    {"writeXrdbImmediate", "WriteXrdbImmediate", XmRBoolean, sizeof(Boolean),
     XtOffset(ApplicationDataPtr, writeXrdbImmediate), XmRImmediate,
     (XtPointer)True},
    {"writeXrdbColors", "WriteXrdbColors", XmRBoolean, sizeof(Boolean),
     XtOffset(ApplicationDataPtr, writeXrdbColors), XmRImmediate,
     (XtPointer)True},
    ...
    {"imServerHosts", "ImServerHosts", XmRXmStringTable, sizeof(XmStringTable),
     XtOffset(ApplicationDataPtr, imServerHosts), XmRImmediate, NULL},
 ...
 ************************************************************************/
void GetSysFontResource(int i) {
        XtGetApplicationResources(style.shell, &style.xrdb,
                                  &sysFont_resources[i], 1, NULL, 0);
}
 ...
 ************************************************************************/
void GetUserFontResource(int i) {
        XtGetApplicationResources(style.shell, &style.xrdb,
                                  &userFont_resources[i], 1, NULL, 0);
}
 ...
 *  -----------
 ************************************************************************/
static void GetFontStrResources(void) {
        int i;
