...
void popup_audioBB(Widget shell) {
...
static Widget build_audioDlg(Widget shell) {
        ...
        save.poscnt++;
        style.audioDialog = __DtCreateDialogBoxDialog(
            shell, "AudioDialog", save.posArgs, save.poscnt);
        XtAddCallback(style.audioDialog, XmNmapCallback, formLayoutCB, NULL);
        XtAddCallback(style.audioDialog, XmNmapCallback, _DtmapCB_audioDlg,
                      shell);
        ...
        XtSetArg(args[n], XmNtitle,
                 ((char *)GETMESSAGE(6, 7, "Style Manager - Beep")));
        n++;
        ...
        n++;
        XtSetArg(args[n], XmNimageName, BEEP_ICON);
        n++;
        XtSetArg(args[n], XmNtraversalOn, False);
        n++;
        widget_list[count++] = audio.pictLabel =
            _DtCreateIcon(form, "audiopictLabel", args, n);
        ...
        n++;
        widget_list[count++] = audio.systemDefault =
        ...
        n++;
        widget_list[count++] = audio.volLabGad =
            XmCreateLabelGadget(form, "volLabGad", args, n);
        XmStringFree(string);

        n = 0;
        XtSetArg(args[n], XmNmaximum, VOLUME_MAX);
        n++;
        ...
        n++;
        widget_list[count++] = audio.volScale =
            XmCreateScale(form, "volScale", args, n);
        ...
        XtSetArg(args[n], XmNmarginHeight, 0);
        n++;
        widget_list[count++] = audio.toneLabGad =
            XmCreateLabelGadget(form, "toneLabGad", args, n);
        XmStringFree(string);
        ...
        n++;
        widget_list[count++] = audio.toneScale =
            XmCreateScale(form, "toneScale", args, n);
        ...
        XtSetArg(args[n], XmNmarginHeight, 0);
        n++;
        widget_list[count++] = audio.durLabGad =
            XmCreateLabelGadget(form, "durLabGad", args, n);
        XmStringFree(string);
        ...
        XtSetArg(args[n], XmNscaleWidth, SCALE_WIDTH);
        n++;
        widget_list[count++] = audio.durScale =
            XmCreateScale(form, "durationScale", args, n);

        XtAddCallback(audio.systemDefault, XmNactivateCallback, systemDefaultCB,
                      NULL);
        XtAddCallback(audio.volScale, XmNvalueChangedCallback, valueChangedCB,
                      NULL);
        XtAddCallback(audio.toneScale, XmNvalueChangedCallback, valueChangedCB,
                      NULL);
        XtAddCallback(audio.durScale, XmNvalueChangedCallback, valueChangedCB,
                      NULL);
...
static void formLayoutCB(Widget w, XtPointer client_data, XtPointer call_data) {
        ...
        n++;
        XtSetArg(args[n], XmNtopWidget, audio.pictLabel);
        n++;
        ...
        n++;
        XtSetArg(args[n], XmNbottomWidget, audio.volLabGad);
        n++;
        XtSetArg(args[n], XmNbottomOffset, 0);
        n++;
        XtSetArg(args[n], XmNleftAttachment, XmATTACH_WIDGET);
        n++;
        XtSetArg(args[n], XmNleftWidget, audio.volLabGad);
        n++;
        XtSetArg(args[n], XmNleftOffset, style.horizontalSpacing);
        n++;
        XtSetArg(args[n], XmNrightAttachment, XmATTACH_FORM);
        ...
        XtSetArg(args[n], XmNtopAttachment, XmATTACH_WIDGET);
        n++;
        XtSetArg(args[n], XmNtopWidget, audio.volScale);
        n++;
        XtSetArg(args[n], XmNtopOffset, TopOffset);
        n++;
        XtSetArg(args[n], XmNbottomAttachment, XmATTACH_NONE);
        ...
        XtSetArg(args[n], XmNbottomAttachment, XmATTACH_OPPOSITE_WIDGET);
        n++;
        XtSetArg(args[n], XmNbottomWidget, audio.toneLabGad);
        n++;
        XtSetArg(args[n], XmNbottomOffset, 0);
        n++;
        XtSetArg(args[n], XmNleftAttachment, XmATTACH_WIDGET);
        n++;
        XtSetArg(args[n], XmNleftWidget, audio.toneLabGad);
        n++;
        XtSetArg(args[n], XmNleftOffset, style.horizontalSpacing);
        n++;
        XtSetArg(args[n], XmNrightAttachment, XmATTACH_FORM);
        ...
        XtSetArg(args[n], XmNtopAttachment, XmATTACH_WIDGET);
        n++;
        XtSetArg(args[n], XmNtopWidget, audio.toneScale);
        n++;
        XtSetArg(args[n], XmNtopOffset, TopOffset);
        n++;
        ...
        XtSetArg(args[n], XmNbottomAttachment, XmATTACH_OPPOSITE_WIDGET);
        n++;
        XtSetArg(args[n], XmNbottomWidget, audio.durLabGad);
        n++;
        XtSetArg(args[n], XmNbottomOffset, 0);
        n++;
        XtSetArg(args[n], XmNleftAttachment, XmATTACH_WIDGET);
        n++;
        XtSetArg(args[n], XmNleftWidget, audio.durLabGad);
        n++;
        XtSetArg(args[n], XmNleftOffset, style.horizontalSpacing);
        n++;
        XtSetArg(args[n], XmNrightAttachment, XmATTACH_FORM);
...
/* _DtmapCB_audioDlg                        */
/*+++++++++++++++++++++++++++++++++++++++*/
static void _DtmapCB_audioDlg(Widget w, XtPointer client_data,
                              XtPointer call_data) {
        ...
        if (first_time) {
                ...
                XtSetArg(args[n], XmNvalue,
                         (int)audio.values.bell_duration / 100);
                n++;
                XtSetValues(audio.durScale, args, n);
        }
}
...
static void systemDefaultCB(Widget w, XtPointer client_data,
        ...
        n = 0;
        XtSetArg(args[n], XmNvalue, kbdState.bell_percent);
        n++;
        XtSetValues(audio.volScale, args, n);

        n = 0;
        XtSetArg(args[n], XmNvalue, kbdState.bell_pitch);
        n++;
        XtSetValues(audio.toneScale, args, n);

        n = 0;
        XtSetArg(args[n], XmNvalue, (int)kbdState.bell_duration / 100);
        n++;
        XtSetValues(audio.durScale, args, n);
...
static void ButtonCB(Widget w, XtPointer client_data, XtPointer call_data) {
        ...
        case CANCEL_BUTTON:
                ...
                XChangeKeyboardControl(style.display, kbdControlMask,
                                       &kbdControl);
        ...
        case HELP_BUTTON:
                XtCallCallbacks(style.audioDialog, XmNhelpCallback,
                                (XtPointer)NULL);
                break;
 ...
 ************************************************************************/
void restoreAudio(Widget shell, XrmDatabase db) {
        XrmName xrm_name[5];
