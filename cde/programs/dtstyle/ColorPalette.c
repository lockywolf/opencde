...
**************************************************************************/
Bool AllocatePaletteCells(Widget shell) {
        int i;
        int colorUse;
        ...
        XmeGetPixelData(
            style.screenNum, &colorUse, pixels, &(pCurrentPalette->active),
            &(pCurrentPalette->inactive), &(pCurrentPalette->primary),
...
**************************************************************************/
void CheckMonitor(Widget shell) {
        WaitSelection = TRUE;
