...
static void _DtmapCB_keyboardDlg(Widget w, XtPointer client_data,
                                 XtPointer call_data);
static int getValue(Widget w);
static void valueChangedCB(Widget w, XtPointer client_data,
                           XtPointer call_data);
static void autoRepeatToggleCB(Widget w, XtPointer client_data,
                               XtPointer call_data);
...
/* popup_kbdDialog                       */
/*+++++++++++++++++++++++++++++++++++++++*/
void popup_keyboardBB(Widget shell) {
...
static Widget build_keyboardDlg(Widget shell) {
        ...
        save.poscnt++;
        style.kbdDialog = __DtCreateDialogBoxDialog(shell, "KeyboardDialog",
        ...
        XtAddCallback(style.kbdDialog, XmNhelpCallback,
                      ...
                      (XtPointer)HELP_KEYBOARD_DIALOG);
        ...
        XtSetArg(args[n], XmNtitle,
                 ((char *)GETMESSAGE(13, 6, "Style Manager - Keyboard")));
        n++;
        ...
        n++;
        XtSetArg(args[n], XmNimageName, KEYBOARD_ICON);
        n++;
        XtSetArg(args[n], XmNtraversalOn, False);
        n++;
        widget_list[count++] = kbd.pictLabel =
            _DtCreateIcon(form, "keyboardpictLabel", args, n);
        ...
        n++;
        widget_list[count++] = kbd.systemDefault =
            XmCreatePushButtonGadget(form, "systemDefault", args, n);
        XmStringFree(string);

        n = 0;
        set =
            (kbd.values.global_auto_repeat == AutoRepeatModeOn) ? True : False;
        ...
        XtSetArg(args[n], XmNnavigationType, XmTAB_GROUP);
        n++;
        widget_list[count++] = kbd.autoRepeatToggle =
            XmCreateToggleButtonGadget(form, "autoRepeatToggle", args, n);
        XmStringFree(string);
        ...
        XtSetArg(args[n], XmNlabelString, string);
        n++;
        widget_list[count++] = kbd.volumeLabGad =
            XmCreateLabelGadget(form, "volumeLabGad", args, n);
        XmStringFree(string);
        ...
        n++;
        widget_list[count++] = kbd.volumeScale =
            XmCreateScale(form, "volumeScale", args, n);

        XtAddCallback(style.kbdDialog, XmNmapCallback, layoutCB, NULL);
        XtAddCallback(style.kbdDialog, XmNmapCallback, _DtmapCB_keyboardDlg,
                      shell);
        XtAddCallback(kbd.systemDefault, XmNactivateCallback, systemDefaultCB,
                      NULL);
        XtAddCallback(kbd.volumeScale, XmNvalueChangedCallback, valueChangedCB,
                      NULL);
        XtAddCallback(kbd.autoRepeatToggle, XmNvalueChangedCallback,
                      autoRepeatToggleCB, NULL);
...
static void layoutCB(Widget w, XtPointer client_data, XtPointer call_data) {
        ...
        n++;
        XtSetArg(args[n], XmNtopWidget, kbd.pictLabel);
        n++;
        XtSetArg(args[n], XmNtopOffset, style.verticalSpacing);
        n++;
        XtSetArg(args[n], XmNbottomAttachment, XmATTACH_NONE);
        ...
        XtSetArg(args[n], XmNtopAttachment, XmATTACH_WIDGET);
        n++;
        XtSetArg(args[n], XmNtopWidget, kbd.autoRepeatToggle);
        n++;
        XtSetArg(args[n], XmNtopOffset, style.verticalSpacing);
        n++;
        XtSetArg(args[n], XmNbottomAttachment, XmATTACH_FORM);
        ...
        n++;
        XtSetArg(args[n], XmNleftWidget, kbd.volumeLabGad);
        n++;
        XtSetArg(args[n], XmNleftOffset, style.horizontalSpacing);
        n++;
        XtSetArg(args[n], XmNrightAttachment, XmATTACH_FORM);
...
static void _DtmapCB_keyboardDlg(Widget w, XtPointer client_data,
        ...
        n = 0;
        XtSetArg(args[n], XmNvalue, kbd.values.key_click_percent);
        n++;
        XtSetValues(kbd.volumeScale, args, n);
...
static void systemDefaultCB(Widget w, XtPointer client_data,
        ...
        n = 0;
        XtSetArg(args[n], XmNvalue, kbdState.key_click_percent);
        n++;
        XtSetValues(kbd.volumeScale, args, n);
...
static void ButtonCB(Widget w, XtPointer client_data, XtPointer call_data) {
                ...
                if (style.smState.smSendSettings) {
                        if (kbd.systemDefaultFlag) {
                                ...
                                SmNewKeyboardSettings(
                                    kbd.new_key_click_percent, /* 0-100 */
        ...
        case CANCEL_BUTTON:
                ...
                n = 0;
                XtSetArg(args[n], XmNset, kbd.values.global_auto_repeat);
                n++;
                XtSetValues(kbd.autoRepeatToggle, args, n);
        ...
        case HELP_BUTTON:
                XtCallCallbacks(style.kbdDialog, XmNhelpCallback,
                                (XtPointer)NULL);
                break;
 ...
 ************************************************************************/
void restoreKeybd(Widget shell, XrmDatabase db) {
        XrmName xrm_name[5];
