...
#define MSG2                                                                   \
        ((char *)GETMESSAGE(10, 3,                                             \
                            "%s is the file that would have been used to "     \
                            "save your session\n"))
...
void saveSessionCB(Widget w, XtPointer client_data, XtPointer call_data) {
        ...
        /*If this is a session manager requested saveYrSlf, need to put dialogs
         * in*/
        ...
        n = 0;
        xa_CommandStr[n] = style.execName;
        n++;
...
Boolean restoreSession(Widget shell, char *name) {
        XrmDatabase db;
        char *tmpStr;
        char *longpath;
        Boolean status;
