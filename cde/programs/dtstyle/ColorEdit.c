...
static void sliderLayoutCB(Widget w, XtPointer client_data,
                           XtPointer call_data);
static void InitializeNewButton(void);
static void InitializeOldButton(void);
static void GenerateColors(void);
static Pixel GetPixel(Widget widget, char *color_string);
static void changRGB_CB(Widget w, XtPointer client_data, XtPointer call_data);
static void changHSV_CB(Widget w, XtPointer client_data, XtPointer call_data);
static void SetScales(XColor *rgb);
static void SetRGBHSVScales(XColor *rgb, int h, int s, int v);
static void CopyPixelSet(ColorSet *color_set_dest, ColorSet *color_set_src);
static void HSVtoRGB(int h, int s, int v, unsigned short *r, unsigned short *g,
                     unsigned short *b);
static double max(double x, double y, double z);
static double min(double x, double y, double z);
static void grabcolorCB(Widget w, XtPointer client_data, XtPointer call_data);
 ...
 *  the dialog.
 ************************************************************************/
void ColorEditor(Widget parent, ColorSet *color_set) {
        if (edit.DialogShell == NULL) {
                ...
                if (!XtIsManaged(edit.DialogShell)) {
                        ...
                        if (style.visualClass == TrueColor ||
                            style.visualClass == DirectColor) {
                                XtVaSetValues(
                                    edit.oldButton, XmNbackground,
                                    edit.color_set->bg.pixel, XmNarmColor,
                                    edit.color_set->bg.pixel, XmNforeground,
                                    edit.color_set->fg.pixel, XmNtopShadowColor,
                                    edit.color_set->ts.pixel,
                                    XmNbottomShadowColor,
                                    edit.color_set->bs.pixel, NULL);
                        }
                        InitializeNewButton();
...
static void CreateColorEditor(Widget parent) {
        ...
        XtSetArg(args[save.poscnt], XmNchildType, XmWORK_AREA);
        save.poscnt++;
        ...
        XtAddCallback(edit.DialogShell, XmNhelpCallback,
                      ...
                      (XtPointer)HELP_MODIFY_PALETTE_DIALOG);
        ...
        n++;
        XtSetArg(args[n], XmNcancelButton, widgetlist1[0]);
        n++;
        XtSetValues(edit.DialogShell, args, n);

        n = 0;
        XtSetArg(args[n], XmNtitle,
                 ((char *)GETMESSAGE(17, 16, "Style Manager - Modify Color")));
        n++;
        ...
        if (!OldNewSame) {
                 ...
                 */
                XtSetArg(args[n], XmNforeground, edit.oldButtonColor.fg.pixel);
                n++;
        ...
        if (!OldNewSame) {
                ...
                n++;
                XtSetArg(args[n], XmNleftWidget, edit.oldButton);
                n++;
        } else {
                XtSetArg(args[n], XmNleftAttachment, XmATTACH_FORM);
                n++;
        ...
        if (!OldNewSame) {
                /* make old and new button both the size of the larger of the
                 * two */
                ...
                n++;
                XtSetArg(args[n], XmNwidth, w + 2 * BUTTON_MARGIN);
                n++;
                XtSetArg(args[n], XmNheight, w + 2 * BUTTON_MARGIN);
                n++;
        ...
        n++;
        edit.grabColor =
            XmCreatePushButtonGadget(sampleForm, "grabColor", args, n);
        ...
        n++;
        XtSetArg(args[n], XmNtopWidget, sampleTB);
        n++;
        XtSetArg(args[n], XmNleftAttachment, XmATTACH_FORM);
        n++;
        XtSetArg(args[n], XmNrightAttachment, XmATTACH_FORM);
        ...
        n++;
        edit.hueLabel =
            XmCreateLabelGadget(edit.sliderForm, "hueLabel", args, n);
        ...
        n++;
        XtSetArg(args[n], XmNmaximum, 359);
        n++;
        XtSetArg(args[n], XmNminimum, 0x0);
        n++;
        ...
        XtAddCallback(edit.hueScale, XmNvalueChangedCallback, changHSV_CB,
                      (XtPointer)HUE);
        XtAddCallback(edit.hueScale, XmNdragCallback, changHSV_CB,
                      (XtPointer)HUE);
        ...
        n++;
        edit.redLabel =
            XmCreateLabelGadget(edit.sliderForm, "redLabel", args, n);
        ...
        n++;
        edit.greenLabel =
            XmCreateLabelGadget(edit.sliderForm, "greenLabel", args, n);
        ...
        n++;
        edit.blueLabel =
            XmCreateLabelGadget(edit.sliderForm, "blueLabel", args, n);
        ...
        XtSetArg(args[n], XmNhighlightThickness, SCALE_HIGHLIGHT_THICKNESS);
        n++;
        XtSetArg(args[n], XmNmaximum, 0xff);
        n++;
        XtSetArg(args[n], XmNminimum, 0x0);
        n++;
        XtSetArg(args[n], XmNincrement, 1);
        n++;
        XtSetArg(args[n], XmNscaleWidth, SCALE_WIDTH);
        n++;
        widgetlist2[widget_count2++] = edit.redScale =
            XmCreateScale(edit.sliderForm, "redScale", args, n);
        XtAddCallback(edit.redScale, XmNvalueChangedCallback, changRGB_CB,
                      (XtPointer)RED);
        XtAddCallback(edit.redScale, XmNdragCallback, changRGB_CB,
                      (XtPointer)RED);

        widgetlist2[widget_count2++] = edit.greenScale =
            XmCreateScale(edit.sliderForm, "greenScale", args, n);
        XtAddCallback(edit.greenScale, XmNvalueChangedCallback, changRGB_CB,
                      (XtPointer)GREEN);
        XtAddCallback(edit.greenScale, XmNdragCallback, changRGB_CB,
                      (XtPointer)GREEN);

        widgetlist2[widget_count2++] = edit.blueScale =
            XmCreateScale(edit.sliderForm, "blueScale", args, n);
        XtAddCallback(edit.blueScale, XmNvalueChangedCallback, changRGB_CB,
                      (XtPointer)BLUE);
        XtAddCallback(edit.blueScale, XmNdragCallback, changRGB_CB,
                      (XtPointer)BLUE);
        ...
        n++;
        XtSetArg(
            args[n], XmNlabelPixmap,
            XmGetPixmap(style.screen, SATURATION_BITS, foreground, background));
        n++;
        XtSetArg(args[n], XmNmarginHeight, 3);
        n++;
        edit.satLabel =
            XmCreateLabelGadget(edit.sliderForm, "satLabel", args, n);
        ...
        XtSetArg(args[n], XmNlabelPixmap,
                 XmGetPixmap(style.screen, VALUE_BITS, foreground, background));
        n++;
        XtSetArg(args[n], XmNmarginHeight, 3);
        n++;
        edit.valLabel =
            XmCreateLabelGadget(edit.sliderForm, "valLabel", args, n);
        ...
        XtAddCallback(edit.satScale, XmNvalueChangedCallback, changHSV_CB,
                      (XtPointer)SATURATION);
        XtAddCallback(edit.satScale, XmNdragCallback, changHSV_CB,
                      (XtPointer)SATURATION);

        widgetlist2[widget_count2++] = edit.valScale =
            XmCreateScale(edit.sliderForm, "valScale", args, n);
        XtAddCallback(edit.valScale, XmNvalueChangedCallback, changHSV_CB,
                      (XtPointer)VALUE);
        XtAddCallback(edit.valScale, XmNdragCallback, changHSV_CB,
                      (XtPointer)VALUE);
...
static void sliderLayoutCB(Widget w, XtPointer client_data,
        ...
        XtSetArg(args[n], XmNtopAttachment, XmATTACH_WIDGET);
        n++;
        XtSetArg(args[n], XmNtopWidget, edit.hueLabel);
        n++;
        ...
        XtSetArg(args[n], XmNbottomOffset,
                 2 * (style.verticalSpacing + redScaleHeight) + 40);
        n++;
        XtSetArg(args[n], XmNleftAttachment, XmATTACH_NONE);
        n++;
        XtSetArg(args[n], XmNrightAttachment, XmATTACH_FORM);
        ...
        XtSetArg(args[n], XmNleftOffset,
                 style.horizontalSpacing + (MaxLabelWidth - redLabelWidth));
        n++;
        ...
        XtSetArg(args[n], XmNtopAttachment, XmATTACH_WIDGET);
        n++;
        XtSetArg(args[n], XmNtopWidget, edit.redLabel);
        n++;
        XtSetArg(args[n], XmNtopOffset, TopOffset);
        n++;
        XtSetArg(args[n], XmNbottomAttachment, XmATTACH_NONE);
        ...
        n++;
        XtSetArg(args[n], XmNleftOffset,
                 style.horizontalSpacing + (MaxLabelWidth - greenLabelWidth));
        n++;
        XtSetArg(args[n], XmNrightAttachment, XmATTACH_NONE);
        n++;
        ...
        XtSetArg(args[n], XmNtopAttachment, XmATTACH_WIDGET);
        n++;
        XtSetArg(args[n], XmNtopWidget, edit.greenLabel);
        n++;
        XtSetArg(args[n], XmNtopOffset, TopOffset);
        n++;
        XtSetArg(args[n], XmNbottomAttachment, XmATTACH_NONE);
        ...
        n++;
        XtSetArg(args[n], XmNleftOffset,
                 style.horizontalSpacing + (MaxLabelWidth - blueLabelWidth));
        n++;
        XtSetArg(args[n], XmNrightAttachment, XmATTACH_NONE);
        n++;
        ...
        XtSetArg(args[n], XmNtopAttachment, XmATTACH_WIDGET);
        n++;
        XtSetArg(args[n], XmNtopWidget, edit.blueLabel);
        n++;
        TopOffset =
            style.verticalSpacing + 40 + redScaleHeight - satLabelHeight;
        XtSetArg(args[n], XmNtopOffset, TopOffset);
        n++;
        XtSetArg(args[n], XmNbottomAttachment, XmATTACH_NONE);
        n++;
        ...
        n++;
        XtSetArg(args[n], XmNleftOffset,
                 style.horizontalSpacing + (MaxLabelWidth - satLabelWidth));
        n++;
        XtSetArg(args[n], XmNrightAttachment, XmATTACH_NONE);
        n++;
        ...
        XtSetArg(args[n], XmNtopAttachment, XmATTACH_WIDGET);
        n++;
        XtSetArg(args[n], XmNtopWidget, edit.satLabel);
        n++;
        ...
        n++;
        XtSetArg(args[n], XmNleftOffset,
                 style.horizontalSpacing + (MaxLabelWidth - valLabelWidth));
        n++;
        XtSetArg(args[n], XmNrightAttachment, XmATTACH_NONE);
        n++;
        ...
        XtSetArg(args[n], XmNbottomAttachment, XmATTACH_OPPOSITE_WIDGET);
        n++;
        XtSetArg(args[n], XmNbottomWidget, edit.greenLabel);
        n++;
        XtSetArg(args[n], XmNbottomOffset, 0);
        n++;
        XtSetArg(args[n], XmNleftAttachment, XmATTACH_WIDGET);
        ...
        XtSetArg(args[n], XmNbottomAttachment, XmATTACH_OPPOSITE_WIDGET);
        n++;
        XtSetArg(args[n], XmNbottomWidget, edit.blueLabel);
        n++;
        XtSetArg(args[n], XmNbottomOffset, 0);
        n++;
        XtSetArg(args[n], XmNleftAttachment, XmATTACH_WIDGET);
        ...
        XtSetArg(args[n], XmNbottomAttachment, XmATTACH_OPPOSITE_WIDGET);
        n++;
        XtSetArg(args[n], XmNbottomWidget, edit.satLabel);
        n++;
        XtSetArg(args[n], XmNbottomOffset, 0);
        n++;
        XtSetArg(args[n], XmNleftAttachment, XmATTACH_WIDGET);
        ...
        XtSetArg(args[n], XmNbottomAttachment, XmATTACH_OPPOSITE_WIDGET);
        n++;
        XtSetArg(args[n], XmNbottomWidget, edit.valLabel);
        n++;
        XtSetArg(args[n], XmNbottomOffset, 0);
        n++;
        XtSetArg(args[n], XmNleftAttachment, XmATTACH_WIDGET);
        ...
        XtRemoveCallback(edit.DialogShell, XmNmapCallback, sliderLayoutCB,
                         NULL);
}
...
static void InitializeNewButton(void) {
        ...
        n++;
        XtSetArg(args[n], XmNbackground, edit.color_set->bg.pixel);
        n++;
        XtSetArg(args[n], XmNarmColor, edit.color_set->sc.pixel);
        n++;
        if (UsePixmaps == FALSE) {
                XtSetArg(args[n], XmNtopShadowColor, edit.color_set->ts.pixel);
                n++;
                XtSetArg(args[n], XmNbottomShadowColor,
                         edit.color_set->bs.pixel);
                n++;
        }
        XtSetValues(edit.newButton, args, n);
}
...
static void InitializeOldButton(void) {
        ...
        status = XAllocColorCells(style.display, style.colormap, 0, &plane_mask,
                                  0, pixels, numOfPixels);
        ...
        RGBtoHSV(edit.oldButtonColor.bg.red, edit.oldButtonColor.bg.green,
                 edit.oldButtonColor.bg.blue, &hue, &sat, &val);
...
static void GenerateColors(void) {
        ...
        RGBtoHSV(edit.color_set->bg.red, edit.color_set->bg.green,
                 edit.color_set->bg.blue, &hue, &sat, &val);
        ...
        if (style.visualClass == PseudoColor ||
            style.visualClass == StaticColor) {
                XStoreColors(style.display, style.colormap, colors, j);
        } else if (style.visualClass == TrueColor ||
                   style.visualClass == DirectColor) {
                ...
                XtVaSetValues(edit.newButton, XmNbackground,
                              edit.color_set->bg.pixel, XmNarmColor,
                              edit.color_set->bg.pixel, XmNforeground,
                              edit.color_set->fg.pixel, XmNtopShadowColor,
                              edit.color_set->ts.pixel, XmNbottomShadowColor,
                              edit.color_set->bs.pixel, NULL);
        }
}
...
static void changHSV_CB(Widget w, XtPointer client_data, XtPointer call_data) {
        ...
        if (reason_code == XmCR_VALUE_CHANGED || reason_code == XmCR_DRAG) {
                ...
                if (edit.current_scale == NONE) {
                        ...
                        HSVtoRGB(hue, sat, val, &edit.color_set->bg.red,
...
static void CopyPixelSet(ColorSet *color_set_dest, ColorSet *color_set_src) {
        ...
        if (OldNewSame && edit.oldButton != NULL) {
                n = 0;
                XtSetArg(args[n], XmNforeground, color_set_dest->fg.pixel);
                n++;
                XtSetArg(args[n], XmNbackground, color_set_dest->bg.pixel);
                n++;
                XtSetArg(args[n], XmNarmColor, color_set_dest->sc.pixel);
                n++;
                XtSetArg(args[n], XmNtopShadowColor, color_set_dest->ts.pixel);
                n++;
                XtSetArg(args[n], XmNbottomShadowColor,
...
static void grabcolorCB(Widget w, XtPointer client_data, XtPointer call_data) {
        ...
        status = XtGrabPointer(
            style.colorDialog, TRUE, ButtonPressMask | ButtonReleaseMask,
            GrabModeAsync, GrabModeAsync, None, cursor, CurrentTime);
        if (status != GrabSuccess) {
                _DtSimpleError(
                    progName, DtWarning, NULL,
                    ((char *)GETMESSAGE(17, 14,
                                        "Warning, couldn't grab pointer.\n")),
                    NULL);
                return;
        }
        ...
        while (notDone) {
                ...
                case KeyPress:
                        ...
                        if (keySym == XK_Escape) {
                                XtUngrabKeyboard(style.colorDialog,
                                                 CurrentTime);
                                XtUngrabPointer(style.colorDialog, CurrentTime);
                                return;
                        }
        ...
        image_ptr = XGetImage(style.display, style.root, x, y, 1, 1, AllPlanes,
                              ZPixmap);
 ...
 ****************************************************/
void restoreColorEdit(Widget shell, XrmDatabase db) {
