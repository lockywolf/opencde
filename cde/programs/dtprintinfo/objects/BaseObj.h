...
class BaseObj {
      ...
      protected:
        ...
        BaseObj(BaseObj *parent, const char *name);

        void AddToParent();
        void DeleteFromParent();
        void DeleteAttribute(const char *ReferenceName);
        void AddAttribute(
            const char *ReferenceName, const char *DisplayName = NULL,
            const char *Help = NULL, const char *ContextualHelp = NULL,
            Characteristics Mask = OPTIONAL, ValueList ValueListType = NO_LIST,
            const char *Listing = NULL, const char *Dependancies = NULL,
            const char *DefaultValue = NULL,
            const char *DisplayDefaultValue = NULL);
        void DeleteAction(const char *ReferenceName);
        void AddAction(ActionHandler Handler, const char *ReferenceName,
                       const char *DisplayName = NULL,
                       const char *Nmemonic = NULL, const char *Help = NULL,
      ...
      public:
        ...
        boolean SendAction(Action *action, BaseObj *requestor = NULL);
        ...
        int RunCommand(const char *command, char **std_out = NULL,
                       char **std_err = NULL);
        ...
        void Dump(boolean verbose = false, int level = 0);
