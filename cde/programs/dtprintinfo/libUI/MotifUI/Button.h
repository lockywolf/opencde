...
class Button : public MotifUI {
      ...
      public:
        // If the callback_data is NULL, the this pointer will be the callback
        // data
        Button(MotifUI *parent, char *name,
               ButtonType button_type = PUSH_BUTTON,
               ButtonCallback callback = NULL, void *callback_data = NULL,
               char *mnemonic = NULL, char *acceleratorText = NULL,
               char *accelerator = NULL, char *iconFile = NULL);

        Button(char *category, MotifUI *parent, char *name,
               ButtonType button_type = PUSH_BUTTON,
               ButtonCallback callback = NULL, void *callback_data = NULL,
               char *mnemonic = NULL, char *acceleratorText = NULL,
               char *accelerator = NULL, char *iconFile = NULL);
