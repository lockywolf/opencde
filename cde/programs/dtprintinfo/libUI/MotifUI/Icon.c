...
extern void _XmRegionDestroy(XmRegion r);
extern void _XmRegionClear(XmRegion r);
extern void _XmRegionUnionRectWithRegion(XRectangle *rect, XmRegion source,
                                         XmRegion dest);
extern void _XmRegionDrawShadow(Display *display, Drawable d, GC top_gc,
                                GC bottom_gc, XmRegion region,
#if NeedWidePrototypes
                                int border_thick, int shadow_thick,
#else
                                Dimension border_thick, Dimension shadow_thick,
#endif /* NeedWidePrototypes */
                                unsigned int shadow_type);
extern Boolean _XmRegionPointInRegion(XmRegion pRegion, int x, int y);

/* Resource Strings */

const char gui_icon_strings[] = {
    't', 'o', 'p', 'L', 'a', 'b', 'e', 'l', 'S', 't', 'r', 'i', 'n', 'g', 0,
    'b', 'o', 't', 't', 'o', 'm', 'L', 'a', 'b', 'e', 'l', 'S', 't', 'r', 'i',
    'n', 'g', 0,   'p', 'i', 'x', 'm', 'a', 'p', 'P', 'l', 'a', 'c', 'e', 'm',
    'e', 'n', 't', 0,   'P', 'i', 'x', 'm', 'a', 'p', 'P', 'l', 'a', 'c', 'e',
    'm', 'e', 'n', 't', 0,   'P', 'i', 'x', 'm', 'a', 'p', 'P', 'l', 'a', 'c',
    'e', 'm', 'e', 'n', 't', 0,   'd', 'o', 'u', 'b', 'l', 'e', 'C', 'l', 'i',
    'c', 'k', 'C', 'a', 'l', 'l', 'b', 'a', 'c', 'k', 0,   's', 'i', 'n', 'g',
    'l', 'e', 'C', 'l', 'i', 'c', 'k', 'C', 'a', 'l', 'l', 'b', 'a', 'c', 'k',
    0,   's', 'e', 'l', 'e', 'c', 't', 'e', 'd', 0,   'S', 'e', 'l', 'e', 'c',
    't', 'e', 'd', 0,   'i', 'c', 'o', 'n', 'S', 'h', 'a', 'd', 'o', 'w', 'T',
    'y', 'p', 'e', 0,   'I', 'c', 'o', 'n', 'S', 'h', 'a', 'd', 'o', 'w', 'T',
    'y', 'p', 'e', 0,   'i', 'c', 'o', 'n', 'S', 'h', 'a', 'd', 'o', 'w', 'T',
    'h', 'i', 'c', 'k', 'n', 'e', 's', 's', 0,   'I', 'c', 'o', 'n', 'S', 'h',
    'a', 'd', 'o', 'w', 'T', 'h', 'i', 'c', 'k', 'n', 'e', 's', 's', 0,   't',
    'e', 'x', 't', 'S', 'e', 'l', 'e', 'c', 't', 'C', 'o', 'l', 'o', 'r', 0,
    'T', 'e', 'x', 't', 'S', 'e', 'l', 'e', 'c', 't', 'C', 'o', 'l', 'o', 'r',
    0,   's', 'e', 'l', 'e', 'c', 't', 'C', 'o', 'l', 'o', 'r', 0,   'S', 'e',
    'l', 'e', 'c', 't', 'C', 'o', 'l', 'o', 'r', 0,   's', 'e', 'l', 'e', 'c',
    't', 'C', 'o', 'l', 'o', 'r', 'P', 'e', 'r', 's', 'i', 's', 't', 'e', 'n',
    't', 0,   'S', 'e', 'l', 'e', 'c', 't', 'C', 'o', 'l', 'o', 'r', 'P', 'e',
    'r', 's', 'i', 's', 't', 'e', 'n', 't', 0,   's', 'h', 'o', 'w', 'S', 'e',
    'l', 'e', 'c', 't', 'e', 'd', 'P', 'i', 'x', 'm', 'a', 'p', 0,   'S', 'h',
    'o', 'w', 'S', 'e', 'l', 'e', 'c', 't', 'e', 'd', 'P', 'i', 'x', 'm', 'a',
    'p', 0,   'i', 'c', 'o', 'n', 'M', 'a', 'r', 'g', 'i', 'n', 'T', 'h', 'i',
    'c', 'k', 'n', 'e', 's', 's', 0,   'I', 'c', 'o', 'n', 'M', 'a', 'r', 'g',
    'i', 'n', 'T', 'h', 'i', 'c', 'k', 'n', 'e', 's', 's', 0,   'a', 'c', 't',
    'i', 'v', 'e', 0,   'A', 'c', 't', 'i', 'v', 'e', 0,   'i', 'c', 'o', 'n',
    'M', 'a', 's', 'k', 0,   'I', 'c', 'o', 'n', 'M', 'a', 's', 'k', 0,   's',
    'h', 'r', 'i', 'n', 'k', 'O', 'u', 't', 'l', 'i', 'n', 'e', 0,   'S', 'h',
    'r', 'i', 'n', 'k', 'O', 'u', 't', 'l', 'i', 'n', 'e', 0,   'f', 'i', 'e',
    'l', 'd', 's', 0,   'F', 'i', 'e', 'l', 'd', 's', 0,   's', 't', 'a', 't',
    'e', 'P', 'i', 'x', 'm', 'a', 'p', 0,   's', 't', 'a', 't', 'e', 'I', 'c',
    'o', 'n', 'M', 'a', 's', 'k', 0,   'S', 't', 'a', 't', 'e', 'I', 'c', 'o',
    'n', 'M', 'a', 's', 'k', 0,   's', 't', 'a', 't', 'e', 'G', 'r', 'a', 'v',
    'i', 't', 'y', 0,   'S', 't', 'a', 't', 'e', 'G', 'r', 'a', 'v', 'i', 't',
    'y', 0};
...
static void CalculateNewField(Widget w, Dimension name_width, int index,
...
static char defaultTranslations[] = "<Btn1Down>:           SingleClickCB()\n\
...
static char *PixmapPlacement[] = {"pixmap_top", "pixmap_bottom", "pixmap_left",
                                  "pixmap_right"};
...
static char *StatePixmapPlacement[] = {
    ...
    "west_gravity",      "center_gravity", "east_gravity",
    "southwest_gravity", "south_gravity",  "southeast_gravity"};

static XtResource resources[] = {
    {XmNlabelString, XmCXmString, XmRXmString, sizeof(XmString),
     XtOffsetOf(struct _IconRec, icon.label), XmRImmediate, (XtPointer)NULL},
    ...
    {GuiNbottomLabelString, XmCXmString, XmRXmString, sizeof(XmString),
     ...
     (XtPointer)NULL},
    {GuiNtextSelectColor, GuiCTextSelectColor, XmRPixel, sizeof(Pixel),
     XtOffsetOf(struct _IconRec, icon.select_label_color), XmRImmediate,
     (XtPointer)ForegroundColorDefault},
    {GuiNselectColor, GuiCSelectColor, XmRPixel, sizeof(Pixel),
     XtOffsetOf(struct _IconRec, icon.select_color), XmRImmediate,
     (XtPointer)SelectColorDefault},
    {XmNfontList, XmCFontList, XmRFontList, sizeof(XmFontList),
     XtOffsetOf(struct _IconRec, icon.font), XmRImmediate, (XtPointer)NULL},
    {XmNlabelPixmap, XmCLabelPixmap, XmRPrimForegroundPixmap, sizeof(Pixmap),
     XtOffsetOf(struct _IconRec, icon.pixmap), XmRImmediate,
     (XtPointer)XmUNSPECIFIED_PIXMAP},
    {GuiNiconMask, GuiCIconMask, XmRPrimForegroundPixmap, sizeof(Pixmap),
     XtOffsetOf(struct _IconRec, icon.mask), XmRImmediate,
     (XtPointer)XmUNSPECIFIED_PIXMAP},
    {GuiNstatePixmap, XmCLabelPixmap, XmRPrimForegroundPixmap, sizeof(Pixmap),
     XtOffsetOf(struct _IconRec, icon.state_pixmap), XmRImmediate,
     (XtPointer)XmUNSPECIFIED_PIXMAP},
    {GuiNstateIconMask, GuiCStateIconMask, XmRPrimForegroundPixmap,
     sizeof(Pixmap), XtOffsetOf(struct _IconRec, icon.state_mask), XmRImmediate,
     (XtPointer)XmUNSPECIFIED_PIXMAP},
    {GuiNstateGravity, GuiCStateGravity, GuiRStateGravity,
     sizeof(unsigned char), XtOffsetOf(struct _IconRec, icon.state_gravity),
     XmRImmediate, (XtPointer)GuiSOUTHEAST_GRAVITY},
    {GuiNsingleClickCallback, XtCCallback, XtRCallback, sizeof(caddr_t),
     XtOffsetOf(struct _IconRec, icon.single_click_callback), XtRCallback,
     NULL},
    {GuiNdoubleClickCallback, XtCCallback, XtRCallback, sizeof(caddr_t),
     XtOffsetOf(struct _IconRec, icon.double_click_callback), XtRCallback,
     NULL},
    {GuiNiconShadowType, GuiCIconShadowType, XmRShadowType,
     sizeof(unsigned char), XtOffsetOf(struct _IconRec, icon.icon_shadow_type),
     XmRImmediate, (XtPointer)XmSHADOW_OUT},
    {GuiNiconShadowThickness, GuiCIconShadowThickness, XmRHorizontalDimension,
     sizeof(Dimension), XtOffsetOf(struct _IconRec, icon.icon_shadow_thickness),
     XmRImmediate, (XtPointer)0},
    {XmNalignment, XmCAlignment, XmRAlignment, sizeof(unsigned char),
     XtOffsetOf(struct _IconRec, icon.alignment), XmRImmediate,
    ...
    {GuiNiconMarginThickness, GuiCIconMarginThickness, XmRHorizontalDimension,
     sizeof(Dimension), XtOffsetOf(struct _IconRec, icon.icon_margin_thickness),
     XmRImmediate, (XtPointer)2},
    {GuiNselectColorPersistent, GuiCSelectColorPersistent, XmRBoolean,
     sizeof(Boolean), XtOffsetOf(struct _IconRec, icon.select_color_persistent),
     XmRImmediate, (XtPointer)False},
    {XmNresizeHeight, XmCResizeHeight, XmRBoolean, sizeof(Boolean),
     XtOffsetOf(struct _IconRec, icon.resize_height), XmRImmediate,
     (XtPointer)True},
    {XmNresizeWidth, XmCResizeWidth, XmRBoolean, sizeof(Boolean),
     XtOffsetOf(struct _IconRec, icon.resize_width), XmRImmediate,
     (XtPointer)True},
    ...
    {XmNwordWrap, XmCWordWrap, XmRBoolean, sizeof(Boolean),
     XtOffsetOf(struct _IconRec, icon.word_wrap), XmRImmediate,
     (XtPointer)False},
    {GuiNselected, GuiCSelected, XmRBoolean, sizeof(Boolean),
     XtOffsetOf(struct _IconRec, icon.selected), XmRImmediate,
     (XtPointer)False},
    {GuiNshrinkOutline, GuiCShrinkOutline, XmRBoolean, sizeof(Boolean),
     XtOffsetOf(struct _IconRec, icon.shrink_outline), XmRImmediate,
     (XtPointer)True},
    {GuiNactive, GuiCActive, XmRBoolean, sizeof(Boolean),
     XtOffsetOf(struct _IconRec, icon.active), XmRImmediate, (XtPointer)True},
    {XmNstringDirection, XmCStringDirection, XmRStringDirection,
     sizeof(unsigned char), XtOffsetOf(struct _IconRec, icon.string_direction),
     XmRImmediate, (XtPointer)XmSTRING_DIRECTION_DEFAULT},
    {XmNtraversalOn, XmCTraversalOn, XmRBoolean, sizeof(Boolean),
     XtOffsetOf(struct _XmPrimitiveRec, primitive.traversal_on), XmRImmediate,
     (XtPointer)True},
...
static XmSyntheticResource syn_resources[] = {
    {XmNlabelString, sizeof(XmString), XtOffsetOf(struct _IconRec, icon.label),
     GetLabelString, NULL},
    ...
    {GuiNbottomLabelString, sizeof(XmString),
     XtOffsetOf(struct _IconRec, icon.bottom_label), GetBottomLabelString,
     NULL}};
 ...
 *   RETURNS:
 */
void GuiIconSetFieldNameWidth(Widget w, Dimension name_width) {
        GuiIconFields fields;
        if (!GuiIsIcon(w)) {
                XmeWarning(
                    w,
                    "Cannot set field name width of non-subclass of GuiIcon");
                return;
        }
 ...
 *   RETURNS:
 */
Dimension GuiIconGetFieldNameWidth(Widget w) {
        GuiIconFields fields;
        if (!GuiIsIcon(w)) {
                XmeWarning(
                    w,
                    "Cannot get field name width of non-subclass of GuiIcon");
                return 0;
        }
        if (fields = Fields(w))
 ...
 *   RETURNS:
 */
void GuiIconSetField(Widget w, /* GuiIconWidget */
                     int index,
                     XmString new_string, /* NULL does not change value */
                     Dimension new_width, /* 0 does not change value */
                     unsigned char alignment, Boolean draw_field,
                     Boolean selected, Boolean active) {
        GuiIconFields fields;
        if (!GuiIsIcon(w)) {
                XmeWarning(w,
                           "Cannot set icon fields of non-subclass of GuiIcon");
                return;
        }
        if (fields = Fields(w)) {
                if (index >= 0 && index < fields->n_fields) {
                        ...
                        if (XtIsRealized(w) && XtIsManaged(w) && refresh)
                                XClearArea(XtDisplay(w), XtWindow(w), 0, 0, 0,
                                           0, TRUE);
                }
        }
}
 ...
 *   RETURNS:
 */
void GuiIconGetField(Widget w, int index, XmString *string, Dimension *width,
                     unsigned char *alignments, Boolean *draw_field,
                     Boolean *selected, Boolean *active) {
        GuiIconFields fields;
        if (!GuiIsIcon(w)) {
                XmeWarning(w,
                           "Cannot get icon fields of non-subclass of GuiIcon");
                return;
        }
        if (fields = Fields(w)) {
                if (index >= 0 && index < fields->n_fields) {
 ...
 *   RETURNS:
 */
void GuiIconGetRects(Widget w, XRectangle *pixmap_rect,
                     XRectangle *label_rect) {
        if (!GuiIsIcon(w)) {
                XmeWarning(
                    w, "Cannot get icon rectangles of non-subclass of GuiIcon");
                return;
        }
        if (ShrinkOutline(w) == True) {
                ...
                case GuiPIXMAP_BOTTOM:
                        pixmap_rect->x =
                            (LabelX(w) < PixmapX(w) ? LabelX(w) : PixmapX(w));
                        pixmap_rect->y = (short)PixmapY(w);
                        pixmap_rect->width =
                            (LabelWidth(w) > PixmapWidth(w) ? LabelWidth(w)
                                                            : PixmapWidth(w));
                        pixmap_rect->height = (short)PixmapHeight(w);
                ...
                case GuiPIXMAP_RIGHT:
                        pixmap_rect->x = (short)PixmapX(w);
                        pixmap_rect->y =
                            (LabelY(w) < PixmapY(w) ? LabelY(w) : PixmapY(w));
                        pixmap_rect->width = (short)PixmapWidth(w);
 ...
 */
static void ClassInitialize(void) {
        GuiRID_PIXMAP_PLACEMENT =
            XmRepTypeRegister(GuiRPixmapPlacement, PixmapPlacement, NULL,
                              sizeof(PixmapPlacement) / sizeof(char *));
        GuiRID_STATE_PIXMAP_PLACEMENT =
            XmRepTypeRegister(GuiRStateGravity, StatePixmapPlacement, NULL,
                              sizeof(StatePixmapPlacement) / sizeof(char *));
}
 ...
 *   RETURNS:
 */
static void Initialize(IconWidget request, IconWidget new, ArgList args,
                       Cardinal *num_args) {
        ...
        if (StringDirection(new) == XmSTRING_DIRECTION_DEFAULT) {
                if (XmIsManager(XtParent(new))) {
                        n = 0;
                        XtSetArg(new_args[n], XmNstringDirection,
                                 &stringDirection);
                        n++;
        ...
        if (Font(new) == NULL) {
                ...
                defaultFont =
                    XmeGetDefaultRenderTable((Widget) new, XmLABEL_FONTLIST);
        ...
        if (Pixmap(new) == XmUNSPECIFIED_PIXMAP && Label(new) == NULL) {
                XmString string;
                string = (XmString)XmeGetLocalizedString(
                    (char *)NULL, (Widget) new, XmNlabelString, new->core.name);
                ...
                if (XmeStringIsValid((XmString)Label(new)))
                        ...
                        XmString string;
                        string = (XmString)XmeGetLocalizedString(
                            (char *)NULL, (Widget) new, XmNlabelString,
                            new->core.name);
                        Label(new) = XmStringCopy(string);
                        XmStringFree(string);
                }
        ...
        if (SelectColorPersistent(new) == False)
                XmGetColors(new->core.screen, new->core.colormap,
                            BackgroundPixel(new), NULL, NULL, NULL,
                            &SelectColor(new));
 ...
 *   RETURNS:
 */
static void CreateGC(IconWidget w) {
        XGCValues values;
        XtGCMask valueMask;
        ...
        values.tile = XmGetPixmapByDepth(XtScreen((Widget)(w)), "50_foreground",
                                         BackgroundPixel(w), Foreground(w),
                                         w->core.depth);
 ...
 *   RETURNS:
 */
static void CreateStateMaskGC(IconWidget w) {
        XGCValues values;
        XtGCMask valueMask;
 ...
 *   RETURNS:
 */
static void CreateMaskGC(IconWidget w) {
        XGCValues values;
        XtGCMask valueMask;
        ...
        values.stipple =
            XmGetPixmapByDepth(XtScreen((Widget)(w)), "50_foreground",
 ...
 *   RETURNS:
 */
static void Destroy(IconWidget w) {
        if (Label(w))
 ...
 *   RETURNS:
 */
static void Resize(IconWidget w) { (void)CalculateSize(w, True); }
 ...
 *   RETURNS:
 */
static Dimension CalculateSize(IconWidget w, Boolean query_geometry) {
        ...
        if (Label(w) != NULL) {
                XmStringExtent(Font(w), Label(w), &LabelWidth(w),
                               &LabelHeight(w));
                LabelWidth(w) += 4;
                LabelHeight(w) += 4;
        } else {
        ...
        if (IconPlacement(w) == GuiPIXMAP_TOP ||
            IconPlacement(w) == GuiPIXMAP_BOTTOM) {
                ...
                if (ResizeWidth(w) == True)
                        _width =
                            Max(PixmapWidth(w), LabelWidth(w)) +
                            2 * (IconShadowThickness(w) + MarginThickness(w) +
                                 HighlightThickness(w));
                if (ResizeHeight(w) == True)
                        Height(w) =
                            PixmapHeight(w) + LabelHeight(w) +
                ...
                if (ResizeWidth(w) == True)
                        _width =
                            PixmapWidth(w) + LabelWidth(w) +
                            2 * (MarginThickness(w) + HighlightThickness(w) +
                                 IconShadowThickness(w));
                if (ResizeHeight(w) == True)
                        Height(w) =
                            Max(PixmapHeight(w), LabelHeight(w)) +
                            2 * (IconShadowThickness(w) + MarginThickness(w) +
                                 HighlightThickness(w));
        }
        ...
        case GuiPIXMAP_BOTTOM:
                ...
                case XmALIGNMENT_END:
                        LabelX(w) =
                            _width -
                            (MarginThickness(w) + IconShadowThickness(w) +
                             HighlightThickness(w) + LabelWidth(w));
                        PixmapX(w) =
                            _width -
                            (MarginThickness(w) + IconShadowThickness(w) +
                             HighlightThickness(w) + PixmapWidth(w));
                        break;
                }
                break;
        ...
        if (TopLabel(w) || BottomLabel(w)) {
                ...
                if (BottomLabel(w)) {
                        XmStringExtent(Font(w), BottomLabel(w),
                                       &BottomLabelWidth(w),
                                       &BottomLabelHeight(w));
                ...
                BottomLabelY(w) = Height(w) - MarginThickness(w) -
                                  IconShadowThickness(w) -
                                  HighlightThickness(w) - BottomLabelHeight(w);
                ...
                case XmALIGNMENT_CENTER:
                        TopLabelX(w) =
                            (Position)(_width - TopLabelWidth(w)) / 2;
                        BottomLabelX(w) =
                            (Position)(_width - BottomLabelWidth(w)) / 2;
                        if (offset > 0) {
                                offset /= 2;
                                PixmapX(w) += offset;
                                LabelX(w) += offset;
        ...
        if (ShrinkOutline(w) == True) {
                ...
                case GuiPIXMAP_TOP:
                case GuiPIXMAP_LEFT:
                        SetRegions((Widget)w, PixmapX(w), PixmapY(w),
                                   PixmapWidth(w), PixmapHeight(w));
                        if (show_fields) {
                                int wid = _width - LabelX(w) - 2 -
                                          (MarginThickness(w) +
                                           HighlightThickness(w) +
                                           IconShadowThickness(w));
                                SetRegions((Widget)w, LabelX(w), LabelY(w), wid,
                                           LabelHeight(w));
                        } else {
                ...
                case GuiPIXMAP_BOTTOM:
                        ...
                        SetRegions((Widget)w, x, PixmapY(w), (int)width,
                                   PixmapHeight(w));
                        SetRegions((Widget)w, x, LabelY(w), (int)width,
                                   LabelHeight(w));
                        break;
                        ...
                        if (show_fields) {
                                int wid = _width - 2 -
                                          2 * (MarginThickness(w) +
                                               HighlightThickness(w) +
                                               IconShadowThickness(w));
                                SetRegions((Widget)w, PixmapX(w), y, wid,
                                           (int)height);
                        } else {
                                SetRegions((Widget)w, LabelX(w), y,
                                           LabelWidth(w), (int)height);
                                SetRegions((Widget)w, PixmapX(w), y,
                                           PixmapWidth(w), (int)height);
                        }
                        break;
                }
        }
        ...
        if (StatePixmap(w) != XmUNSPECIFIED_PIXMAP) {
                ...
                XGetGeometry(XtDisplay(w), StatePixmap(w), &junkwin,
                             (int *)&junk, (int *)&junk, &width, &height, &junk,
                             &junk);
                ...
                case GuiWEST_GRAVITY:
                        x_offset = 0;
                        y_offset = (Dimension)(
                            (int)(PixmapHeight(w) - StatePixmapHeight(w)) / 2);
                        break;
                case GuiCENTER_GRAVITY:
                        x_offset = (Dimension)(
                            (int)(PixmapWidth(w) - StatePixmapWidth(w)) / 2);
                        y_offset = (Dimension)(
                            (int)(PixmapHeight(w) - StatePixmapHeight(w)) / 2);
                        break;
 ...
 *   RETURNS:
 */
static void SetRegions(Widget w, int x, int y, int width, int height) {
        XRectangle rect;
        ...
        _XmRegionUnionRectWithRegion(&rect, HighlightRegion(w),
                                     HighlightRegion(w));
}
 ...
 *   RETURNS:
 */
static void Redisplay(IconWidget w, XEvent *event, Region region) {
        ...
        if (XtIsRealized((Widget)w) && XtIsManaged((Widget)w)) {
                ...
                if ((w->core.sensitive) && (w->core.ancestor_sensitive)) {
                                ...
                                for (i = 0; i < Fields(w)->n_fields; i++) {
                                        ...
                                        if (draw_field) {
                                                XmStringDraw(
                                                    ...
                                                    Font(w),
                                                    Fields(w)->fields[i],
                                                    label_gc, x, LabelY(w) + 2,
                                                    Fields(w)->widths[i],
                                                    Fields(w)->alignments[i],
                        ...
                        if (Label(w) != NULL) {
                                ...
                                XmStringDraw(XtDisplay(w), XtWindow(w), Font(w),
                                             Label(w), label_gc, LabelX(w) + 2,
                                             LabelY(w) + 2, LabelWidth(w) - 4,
                                             Alignment(w), StringDirection(w),
                                             NULL);
                        }
                        if (TopLabel(w) != NULL) {
                                XmStringDraw(XtDisplay(w), XtWindow(w), Font(w),
                                             TopLabel(w), NormalGC(w),
                                             TopLabelX(w) + 2, TopLabelY(w),
                                             TopLabelWidth(w) - 4, Alignment(w),
                                             StringDirection(w), NULL);
                        }
                        if (BottomLabel(w) != NULL) {
                                XmStringDraw(
                                    XtDisplay(w), XtWindow(w), Font(w),
                        ...
                        if (Pixmap(w) != XmUNSPECIFIED_PIXMAP) {
                                if (ShowSelectedPixmap(w) == True &&
                                    Selected(w) == True) {
                                        if (ShrinkOutline(w) == True) {
                                                XFillRectangle(
                                                    XtDisplay(w), XtWindow(w),
                                                    SelectBGGC(w), PixmapX(w),
                                                    PixmapY(w), PixmapWidth(w),
                                                    PixmapHeight(w));
                                        } else {
                                                XFillRectangle(
                                                    XtDisplay(w), XtWindow(w),
                                        ...
                                        XCopyArea(XtDisplay(w), Pixmap(w),
                                                  XtWindow(w), MaskGC(w), 0, 0,
                                                  PixmapWidth(w),
                                                  PixmapHeight(w), PixmapX(w),
                                                  PixmapY(w));
                                } else {
                                        XCopyArea(XtDisplay(w), Pixmap(w),
                                                  XtWindow(w), MaskGC(w), 0, 0,
                ...
                } else /* Widget is insensitive */
                {
                        ...
                        if (Label(w) != NULL) {
                                ...
                                XmStringDraw(XtDisplay(w), XtWindow(w), Font(w),
                                             Label(w), StippleGC(w),
                                             LabelX(w) + 2, LabelY(w) + 2,
                                             LabelWidth(w) - 4, Alignment(w),
                                             StringDirection(w), NULL);
                        }
                        if (TopLabel(w) != NULL) {
                                XmStringDraw(XtDisplay(w), XtWindow(w), Font(w),
                                             TopLabel(w), StippleGC(w),
                                             TopLabelX(w) + 2, TopLabelY(w),
                                             TopLabelWidth(w) - 4, Alignment(w),
                                             StringDirection(w), NULL);
                        }
                ...
                if (StatePixmap(w) && StatePixmap(w) != XmUNSPECIFIED_PIXMAP) {
                        XCopyArea(XtDisplay(w), StatePixmap(w), XtWindow(w),
                                  StateMaskGC(w), 0, 0, StatePixmapWidth(w),
                                  StatePixmapHeight(w), StatePixmapX(w),
                                  StatePixmapY(w));
                }
                if (IconShadowThickness(w)) {
                        _XmRegionDrawShadow(
                            XtDisplay(w), XtWindow(w), TopShadowGC(w),
                            BottomShadowGC(w), ShadowRegion(w), 0,
                            IconShadowThickness(w), IconShadowType(w));
                }
                if (Highlighted(w)) {
 ...
 *   RETURNS:
 */
static Boolean SetValues(Widget cur, Widget req, IconWidget new, ArgList args,
                         Cardinal *num_args) {
        Boolean flag = False;
        ...
        if (BottomLabel(new) != BottomLabel(cur)) {
                newstring = True;
                if (BottomLabel(new) &&
                    XmeStringIsValid((XmString)BottomLabel(new)))
                        BottomLabel(new) =
                            XmStringCopy((XmString)BottomLabel(new));
                else
                        BottomLabel(new) = NULL;
        ...
        if (Font(new) != Font(cur)) {
                ...
                if (Font(new) == NULL)
                        Font(new) = XmeGetDefaultRenderTable((Widget) new,
                                                             XmLABEL_FONTLIST);
                Font(new) = XmFontListCopy(Font(new));
        }
        ...
        if (IconPlacement(new) != IconPlacement(cur)) {
                if (!XmRepTypeValidValue(GuiRID_PIXMAP_PLACEMENT,
                                         IconPlacement(new), (Widget) new)) {
        ...
        if (Foreground(new) != Foreground(cur) ||
            ...
            Font(new) != Font(cur)) {
                if (BackgroundPixel(new) != BackgroundPixel(cur)) {
                        ...
                        XmGetColors(new->core.screen, new->core.colormap,
                                    BackgroundPixel(new), NULL,
                                    &top_shadow_color, &bottom_shadow_color,
                                    &select_color);
                        if (!SelectColorPersistent(new))
                                SelectColor(new) = select_color;
                        XtSetArg(gc_args[0], XmNtopShadowColor,
                                 top_shadow_color);
                        XtSetArg(gc_args[1], XmNbottomShadowColor,
                                 bottom_shadow_color);
 ...
 *   RETURNS:
 */
static XtGeometryResult QueryGeometry(IconWidget w, XtWidgetGeometry *intended,
 ...
 *   RETURNS:
 */
static void SingleClickCB(Widget widget, XEvent *event, String *params,
                          Cardinal *num_params) {
 ...
 *   RETURNS:
 */
static void DoubleClickCB(Widget widget, XEvent *event, String *params,
                          Cardinal *num_params) {
        IconWidget w = (IconWidget)widget;
        GuiIconCallbackStruct call_value;
        Arg args[1];
...
static void HighlightBorder(Widget w) {
        ...
        _XmRegionDrawShadow(XtDisplay(w), XtWindow(w), NormalGC(w), NormalGC(w),
                            HighlightRegion(w), 0, HighlightThickness(w),
                            IconShadowType(w));
 ...
 *   RETURNS:
 */
static void GetLabelString(Widget w, int offset, XtArgVal *value) {
        XmString string;
 ...
 *   RETURNS:
 */
static void GetTopLabelString(Widget w, int offset, XtArgVal *value) {
        XmString string;
 ...
 *   RETURNS:
 */
static void GetBottomLabelString(Widget w, int offset, XtArgVal *value) {
        XmString string;
...
static void ForegroundColorDefault(Widget widget, int offset, XrmValue *value) {
        XmeGetDefaultPixel(widget, XmFOREGROUND, offset, value);
}

static void SelectColorDefault(Widget widget, int offset, XrmValue *value) {
