...
const char gui_workarea_strings[] = {
    'i', 's', 'L', 'i', 's', 't', 0,   'a', 't', 't', 'a', 'c', 'h', 'm', 'e',
    'n', 't', 0,   'A', 't', 't', 'a', 'c', 'h', 'm', 'e', 'n', 't', 0,   'A',
    't', 't', 'a', 'c', 'h', 'm', 'e', 'n', 't', 0,   'i', 's', 'W', 'o', 'r',
    'k', 'A', 'r', 'e', 'a', 0,   'a', 'u', 't', 'o', 'R', 'e', 's', 'i', 'z',
    'e', 'W', 'i', 'd', 't', 'h', 0,   'i', 's', 'O', 'p', 'e', 'n', 'e', 'd',
    0,   'i', 's', 'T', 'r', 'a', 'n', 's', 'i', 'e', 'n', 't', 0,   'l', 'i',
    'n', 'e', 'T', 'h', 'i', 'c', 'k', 'n', 'e', 's', 's', 0,   'L', 'i', 'n',
    'e', 'T', 'h', 'i', 'c', 'k', 'n', 'e', 's', 's', 0,   'l', 'i', 'n', 'e',
    'O', 'f', 'f', 's', 'e', 't', 0,   'L', 'i', 'n', 'e', 'O', 'f', 'f', 's',
    'e', 't', 0,   'n', 'o', 'd', 'e', 'L', 'i', 'n', 'e', 'L', 'e', 'n', 'g',
    't', 'h', 0,   'N', 'o', 'd', 'e', 'L', 'i', 'n', 'e', 'L', 'e', 'n', 'g',
    't', 'h', 0,   'n', 'u', 'm', 'b', 'e', 'r', 'S', 'u', 'b', 'N', 'o', 'd',
    'e', 's', 0,   'N', 'u', 'm', 'b', 'e', 'r', 'S', 'u', 'b', 'N', 'o', 'd',
    'e', 's', 0,   'n', 'u', 'm', 'b', 'e', 'r', 'C', 'o', 'l', 'u', 'm', 'n',
    's', 0,   'N', 'u', 'm', 'b', 'e', 'r', 'C', 'o', 'l', 'u', 'm', 'n', 's',
    0,   's', 'u', 'b', 'N', 'o', 'd', 'e', 's', 0,   'S', 'u', 'b', 'N', 'o',
    'd', 'e', 's', 0,   'h', 'o', 'r', 'i', 'z', 'o', 'n', 't', 'a', 'l', 'S',
    'p', 'a', 'c', 'e', 0,   'v', 'e', 'r', 't', 'i', 'c', 'a', 'l', 'S', 'p',
    'a', 'c', 'e', 0,   'S', 'p', 'a', 'c', 'e', 0,   's', 'u', 'p', 'e', 'r',
    'N', 'o', 'd', 'e', 0,   'S', 'u', 'p', 'e', 'r', 'N', 'o', 'd', 'e', 0,
};
...
static char *ChildrenAttachment[] = {"attach_top", "attach_bottom",
...
static XtResource resources[] = {
    {GuiNlineOffset, GuiCLineOffset, XtRDimension, sizeof(Dimension),
     XtOffsetOf(struct _WorkAreaRec, workArea.line_offset), XtRImmediate,
     (XtPointer)25},
    {GuiNnodeLineLength, GuiCNodeLineLength, XtRDimension, sizeof(Dimension),
     XtOffsetOf(struct _WorkAreaRec, workArea.node_line_length), XtRImmediate,
     (XtPointer)15},
    {GuiNlineThickness, GuiCLineThickness, XtRDimension, sizeof(Dimension),
     XtOffsetOf(struct _WorkAreaRec, workArea.line_thickness), XtRImmediate,
     (XtPointer)2},
    {GuiNhorizontalSpace, GuiCSpace, XtRDimension, sizeof(Dimension),
     XtOffsetOf(struct _WorkAreaRec, workArea.horizontal_spacing), XtRImmediate,
     (XtPointer)5},
    {GuiNverticalSpace, GuiCSpace, XtRDimension, sizeof(Dimension),
     XtOffsetOf(struct _WorkAreaRec, workArea.vertical_spacing), XtRImmediate,
     (XtPointer)5},
    {XmNalignment, XmCAlignment, XmRAlignment, sizeof(unsigned char),
     XtOffsetOf(struct _WorkAreaRec, workArea.alignment), XtRImmediate,
     (XtPointer)XmALIGNMENT_CENTER},
    {XmNentryVerticalAlignment, XmCVerticalAlignment, XmRVerticalAlignment,
     sizeof(unsigned char),
     XtOffsetOf(struct _WorkAreaRec, workArea.vertical_alignment), XtRImmediate,
     (XtPointer)XmALIGNMENT_CENTER},
    {XmNpacking, XmCPacking, XmRPacking, sizeof(unsigned char),
     XtOffsetOf(struct _WorkAreaRec, workArea.packing), XtRImmediate,
     (XtPointer)XmPACK_COLUMN},
    {GuiNautoResizeWidth, XtCBoolean, XtRBoolean, sizeof(Boolean),
     XtOffsetOf(struct _WorkAreaRec, workArea.auto_resize_width), XtRImmediate,
     (XtPointer)TRUE},
    {GuiNisList, XtCBoolean, XtRBoolean, sizeof(Boolean),
     XtOffsetOf(struct _WorkAreaRec, workArea.is_list), XtRImmediate,
     (XtPointer)FALSE}};
...
static XtResource workAreaConstraintResources[] = {
    ...
    {XmNorientation, XmCOrientation, XmROrientation, sizeof(unsigned char),
     XtOffset(WorkAreaConstraints, workArea.orientation), XtRImmediate,
     (XtPointer)XmVERTICAL},
    {GuiNisTransient, XtCBoolean, XtRBoolean, sizeof(Boolean),
     XtOffset(WorkAreaConstraints, workArea.is_transient), XtRImmediate,
     (XtPointer)FALSE},
    {GuiNisWorkArea, XtCBoolean, XtRBoolean, sizeof(Boolean),
     XtOffset(WorkAreaConstraints, workArea.is_workArea), XtRImmediate,
     (XtPointer)FALSE},
    {GuiNisOpened, XtCBoolean, XtRBoolean, sizeof(Boolean),
     XtOffset(WorkAreaConstraints, workArea.is_opened), XtRImmediate,
     (XtPointer)FALSE},
    ...
    {GuiNnumberSubNodes, GuiCNumberSubNodes, XtRInt, sizeof(int),
     XtOffset(WorkAreaConstraints, workArea.n_sub_nodes), XtRImmediate,
     (XtPointer)0},
    {GuiNnumberColumns, GuiCNumberColumns, XtRInt, sizeof(int),
     XtOffset(WorkAreaConstraints, workArea.n_columns), XtRImmediate,
     (XtPointer)0},
    {GuiNattachment, GuiCAttachment, GuiRAttachment, sizeof(unsigned char),
     XtOffset(WorkAreaConstraints, workArea.attachment), XtRImmediate,
     (XtPointer)GuiATTACH_LEFT}};
 ...
 *   RETURNS:
 */
Widget GuiCreateWorkArea(Widget parent, char *name, ArgList arglist,
                         Cardinal argcount) {
        return XtCreateWidget(name, workAreaWidgetClass, parent, arglist,
                              argcount);
}
 ...
 *   RETURNS:
 */
Widget GuiCreateScrolledWorkArea(Widget parent, char *name, ArgList arglist,
                                 Cardinal argcount) {
        Widget swindow;
        Widget sworkArea;
        Arg args_cache[30];
        ...
        n++;
        XtSetArg(merged_args[n], XmNscrollBarDisplayPolicy,
                 (XtArgVal)XmAS_NEEDED);
        n++;

        swindow = XtCreateManagedWidget(s, xmScrolledWindowWidgetClass, parent,
                                        merged_args, n);
        XtAddCallback(swindow, XmNtraverseObscuredCallback, MakeChildVisible,
                      NULL);
        ...
        XtAddCallback(XtParent(sworkArea), XmNresizeCallback, ResizeSW,
                      sworkArea);
 ...
 *   RETURNS:
 */
void GuiWorkAreaReorderChildren(Widget parent_subnode, WidgetList subnode_list,
                                int n_subnodes, Widget position) {
        WorkAreaConstraints workArea_const;

        if (GuiIsWorkArea(parent_subnode))
                parent_subnode =
                    ((WorkAreaWidget)parent_subnode)->workArea.workArea_root;
        if (GuiIsWorkArea(XtParent(parent_subnode))) {
                ...
                XmeWarning(parent_subnode, "Cannot ReorderChildren of parent "
                                           "widget of non-subclass of "
                                           "WorkArea");
        }
}
 ...
 *   RETURNS:
 */
void GuiWorkAreaDisableRedisplay(Widget w) {
        ...
        if (GuiIsWorkArea(w))
                ...
                XmeWarning(
                    w,
                    "Cannot set DisableRedisplay of non-subclass of WorkArea");
}
 ...
 *   RETURNS:
 */
void GuiWorkAreaEnableRedisplay(Widget w) {
        WorkAreaWidget workArea = (WorkAreaWidget)w;
        ...
        if (GuiIsWorkArea(w)) {
                ...
                XmeWarning(
                    w,
                    "Cannot set EnableRedisplay of non-subclass of WorkArea");
}
 ...
 */
static void ClassInitialize(void) {
        GuiRID_CHILDREN_ATTACHMENT =
            XmRepTypeRegister(GuiRAttachment, ChildrenAttachment, NULL,
                              sizeof(ChildrenAttachment) / sizeof(char *));
}
 ...
 *   RETURNS:
 */
static void Initialize(WorkAreaWidget request, WorkAreaWidget new) {
        Arg wargs[3];
        WorkAreaConstraints workArea_const;
        ...
        if (!XmRepTypeValidValue(XmRepTypeGetId(XmRVerticalAlignment),
                                 new->workArea.vertical_alignment,
                                 (Widget) new))
                new->workArea.alignment = XmALIGNMENT_CENTER;
        ...
        new->workArea.workArea_root = XtCreateWidget(
            "root", xmPrimitiveWidgetClass, (Widget) new, wargs, 3);
}
...
static void Realize(Widget w, XtValueMask *valueMask,
        ...
        if (((WorkAreaWidget)w)->workArea.auto_resize_width) {
                if (XmIsScrolledWindow(sw))
                        ...
                        /* Check the parent of the parent of the workArea,
                           because the workArea could be a child of the scrolled
                           window's clip widget */
        ...
        if (sw_child == TRUE) {
                n = 0;
                XtSetArg(args[n], XmNverticalScrollBar, &vbar);
                n++;
                XtSetArg(args[n], XmNwidth, &width);
                n++;
                XtSetArg(args[n], XmNspacing, &spacing);
                n++;
                XtSetArg(args[n], XmNshadowThickness, &shadow_thickness);
                n++;
                XtSetArg(args[n], XmNscrolledWindowMarginHeight, &marginHeight);
                n++;
                XtSetArg(args[n], XmNscrolledWindowMarginWidth, &marginWidth);
                n++;
                XtGetValues(sw, args, n);

                if (vbar != NULL) {
                        n = 0;
                        XtSetArg(args[n], XmNwidth, &vbar_width);
                        n++;
                ...
                w->core.width = width - vbar_width -
                                (2 * (highlight_thickness + shadow_thickness +
                                      spacing + marginHeight + marginWidth));
        }
 ...
 *   RETURNS:
 */
static Boolean SetValues(WorkAreaWidget current, WorkAreaWidget request,
                         WorkAreaWidget new) {
        int redraw = FALSE;
        ...
        if (new->workArea.vertical_alignment !=
            current->workArea.vertical_alignment) {
                if (!XmRepTypeValidValue(XmRepTypeGetId(XmRVerticalAlignment),
                                         new->workArea.vertical_alignment,
                                         (Widget) new))
                        new->workArea.vertical_alignment =
         ...
         */
        if (new->workArea.vertical_spacing !=
                current->workArea.vertical_spacing ||
            new->workArea.horizontal_spacing !=
                current->workArea.horizontal_spacing ||
            new->workArea.line_offset != current->workArea.line_offset ||
            new->workArea.node_line_length !=
                current->workArea.node_line_length ||
            new->workArea.vertical_alignment !=
                current->workArea.vertical_alignment ||
            new->workArea.packing != current->workArea.packing ||
            new->workArea.alignment != current->workArea.alignment) {
...
static Boolean ConstraintSetValues(Widget current, Widget request, Widget new) {
        ...
        if (current_const->workArea.sub_nodes != newconst->workArea.sub_nodes)
                newconst->workArea.sub_nodes =
                    current_const->workArea.sub_nodes;
        if (current_const->workArea.n_sub_nodes !=
            newconst->workArea.n_sub_nodes)
                newconst->workArea.n_sub_nodes =
                    current_const->workArea.n_sub_nodes;

        if (newconst->workArea.is_workArea == TRUE &&
            current_const->workArea.is_opened != newconst->workArea.is_opened)
                CallNewLayout = TRUE;

        if (current_const->workArea.attachment !=
            newconst->workArea.attachment) {
                if (!XmRepTypeValidValue(GuiRID_CHILDREN_ATTACHMENT,
                                         newconst->workArea.attachment,
                                         (Widget) new))
                        newconst->workArea.attachment =
                            current_const->workArea.attachment;
                else
                        CallNewLayout = TRUE;
        }

        if (current_const->workArea.orientation !=
            newconst->workArea.orientation) {
                if (!XmRepTypeValidValue(XmRepTypeGetId(XmROrientation),
                                         newconst->workArea.orientation,
                                         (Widget) new))
                        newconst->workArea.orientation =
                            current_const->workArea.orientation;
                else
                        CallNewLayout = TRUE;
        }

        if (current_const->workArea.is_workArea !=
            newconst->workArea.is_workArea)
                CallNewLayout = TRUE;
        if (current_const->workArea.is_transient == TRUE &&
            current_const->workArea.is_transient !=
                newconst->workArea.is_transient)
                CallNewLayout = TRUE;
...
static void DeleteNode(Widget super_node, Widget node) {
        ...
        for (i = pos; i < super_const->workArea.n_sub_nodes; i++)
                super_const->workArea.sub_nodes[i] =
                    super_const->workArea.sub_nodes[i + 1];
 ...
 *   RETURNS:
 */
static void ChangeManaged(WorkAreaWidget workArea) { NewLayout(workArea); }
 ...
 *   RETURNS:
 */
static void Redisplay(WorkAreaWidget w, XEvent *event, Region region) {
        int i, j;
        WorkAreaConstraints workArea_const;
        Widget child;
                        ...
                        if (child != w->workArea.workArea_root &&
                            workArea_const->workArea.n_sub_nodes > 0) {
                                if (XtIsManaged(child)) {
                                        ...
                                        x0 = child->core.x +
                                             w->workArea.line_offset;
                                        y0 = child->core.y + child->core.height;
                                        x_max = y_max = -1;

                                        for (j = 0; j < workArea_const->workArea
                                                            .n_sub_nodes;
                                             j++) {
                                                if (!XtIsManaged(
                                                        workArea_const->workArea
                                                            .sub_nodes[j]))
                                                        continue;

                                                x1 = workArea_const->workArea
                                                         .sub_nodes[j]
                                                         ->core.x;
                                                if (WORKAREA_CONSTRAINT(
                                                        workArea_const->workArea
                                                            .sub_nodes[j])
                                                        ->workArea.is_opened ||
                                                    !WORKAREA_CONSTRAINT(
 ...
 *   RETURNS:
 */
static void CreateGC(WorkAreaWidget w) {
        XGCValues values;
        XtGCMask valueMask;
 ...
 *   RETURNS:
 */
static void NewLayout(WorkAreaWidget workArea) {
        WorkAreaConstraints workArea_const;
        ...
        for (i = 0; i < workArea_const->workArea.n_sub_nodes; i++) {
                if (XtIsManaged(workArea_const->workArea.sub_nodes[i]) &&
                    workArea_const->workArea.is_transient == FALSE) {
                        if (workArea_const->workArea.sub_nodes[i]->core.width >
                            node_width)
                                node_width =
                                    workArea_const->workArea.sub_nodes[i]
                                        ->core.width;
                        if (workArea_const->workArea.sub_nodes[i]->core.height >
                            node_height)
                                node_height =
                                    workArea_const->workArea.sub_nodes[i]
                                        ->core.height;
        ...
        ComputePositions(workArea, workArea->workArea.workArea_root, &new_width,
                         &new_height, node_width, node_height, &cur_x, &cur_y,
                         0, &seen_one);
         ...
         */
        if (workArea->core.width != new_width ||
            workArea->core.height != new_height) {
                result =
                    XtMakeResizeRequest((Widget)workArea, new_width, new_height,
                                        &replyWidth, &replyHeight);

                /* Accept any compromise. */
                if (result == XtGeometryAlmost)
                        XtMakeResizeRequest((Widget)workArea, replyWidth,
        ...
        if (XtIsRealized((Widget)workArea))
                XClearArea(XtDisplay(workArea), XtWindow(workArea), 0, 0, 0, 0,
                           TRUE);
}
 ...
 *   RETURNS:
 */
static void ComputePositions(WorkAreaWidget workArea, Widget w,
                             Dimension *workArea_width,
                             Dimension *workArea_height, Dimension node_width,
                             Dimension node_height, int *cur_x, int *cur_y,
                             int level, int *seen_one) {
        int i;
        ...
        if (XtIsManaged(w) && node_const->workArea.is_transient == FALSE) {
                ...
                if (level == 1) {
                        if (node_const->workArea.is_opened == FALSE) {
                                if ((Dimension)(*cur_x + h_spacing +
                                                node_width) > *workArea_width) {
                                        if (*seen_one) {
                                                *cur_x =
                                                    h_spacing +
                                                    (level - 1) * level_offset;
                                                *cur_y = *cur_y + node_height +
                                                         v_spacing;
                                        }
                                }
                                ...
                                *cur_x = *cur_x + h_spacing + node_width;
                                if (workArea->workArea.alignment ==
                                    XmALIGNMENT_CENTER) {
                                        offset = (Dimension)(node_width -
                                                             w->core.width) /
                                                 2;
                        ...
                        {
                                if (*cur_x !=
                                    (h_spacing + (level - 1) * level_offset)) {
                                        *cur_x = h_spacing +
                                                 (level - 1) * level_offset;
        ...
        if (!workArea->workArea.is_list || level == 0) {
                for (i = 0; i < node_const->workArea.n_sub_nodes; i++) {
                        ComputePositions(
                            workArea, node_const->workArea.sub_nodes[i],
                        ...
                        if (!workArea->workArea.is_list) {
                                ...
                                int h;
                                tmp_const = WORKAREA_CONSTRAINT(
                                    node_const->workArea.sub_nodes[i]);
                                h = node_const->workArea.sub_nodes[i]
                                        ->core.height +
                                    v_spacing + tmp_const->workArea.y;
                ...
                if (has_managed_children) {
                        ...
                        if ((Dimension)(super_const->workArea.y + offset) <
                            v_spacing) {
                                *cur_y = node_height + 2 * v_spacing;
                                super_const->workArea.y =
                                    v_spacing +
                                    (Position)(node_height - w->core.height) /
                                        2;
                        } else if (node_height > w->core.height) {
                                *cur_y = *cur_y - w->core.height + node_height;
                                offset =
                                    (Dimension)(node_height - w->core.height) /
                                    2;
                                super_const->workArea.y += offset;
                        }
                        for (i = 0; i < super_const->workArea.n_sub_nodes;
                             i++) {
                                widget = super_const->workArea.sub_nodes[i];
                                if (!XtIsManaged(widget))
                                        continue;
                                ...
                                offset = (Dimension)(node_height -
                                         ...
                                         2;
                                node_const->workArea.y =
                                    *cur_y - node_height - v_spacing + offset;
                        }
 ...
 *   RETURNS:
 */
static void SetPositions(WorkAreaWidget workArea, Widget w) {
        int i;
        ...
        if (XtIsManaged(w) && node_const->workArea.is_transient == FALSE) {
                ...
                if (node_const->workArea.is_workArea) {
                        new_width =
                            workArea->core.width - node_const->workArea.x;
                        XtResizeWidget(w, new_width, w->core.height,
                                       w->core.border_width);
                }
        }
 ...
 *   RETURNS:
 */
static int OpenedSubnodes(Widget w) {
        int i, n_subnodes = 0;
        WorkAreaConstraints node_const;
        WorkAreaConstraints workArea_const;
        ...
        for (i = 0; i < workArea_const->workArea.n_sub_nodes; i++) {
                node_const =
                    WORKAREA_CONSTRAINT(workArea_const->workArea.sub_nodes[i]);
 ...
 *   RETURNS:
 */
static void Resize(WorkAreaWidget w) {
        NewLayout(w);
 ...
 *   RETURNS:
 */
static void MakeChildVisible(Widget widget, XtPointer client_data,
 ...
 *   RETURNS:
 */
static void ResizeSW(Widget w, XtPointer client_data, XtPointer callback_data) {
 ...
 *   RETURNS:
 */
static void DestroyParent(Widget w, XtPointer client_data,
                          XtPointer callback_data) {
 ...
 *   RETURNS:
 */
static void ResizeTimeOut(Widget workArea, XtIntervalId *id) {
        Arg args[1];
