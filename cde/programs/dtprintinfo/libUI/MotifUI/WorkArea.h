...
enum { GuiATTACH_TOP, GuiATTACH_BOTTOM, GuiATTACH_LEFT, GuiATTACH_RIGHT };
...
extern Widget GuiCreateWorkArea(Widget parent, char *name, ArgList arglist,
                                Cardinal argcount);

extern Widget GuiCreateScrolledWorkArea(Widget parent, char *name,
...
extern void GuiWorkAreaReorderChildren(Widget parent_subnode,
                                       WidgetList subnode_list, int n_subnodes,
                                       Widget position);
