...
class Menu : public MotifUI {
      ...
      public:
        Menu(char *category, MotifUI *parent, char *name, char *mnemonic = NULL,
             MenuType menu_type = PULLDOWN_MENU);
        Menu(char *category, MotifUI *parent, boolean has_title, char *title,
             char *name, char *mnemonic = NULL,
             MenuType menu_type = PULLDOWN_MENU);
        Menu(MotifUI *parent, char *name, char *mnemonic = NULL,
             MenuType menu_type = PULLDOWN_MENU);
        Menu(MotifUI *parent, boolean has_title, char *title, char *name,
             char *mnemonic = NULL, MenuType menu_type = PULLDOWN_MENU);
