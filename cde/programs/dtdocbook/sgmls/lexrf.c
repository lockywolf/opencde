 ...
 */
/* $XConsortium: lexrf.c /main/3 1996/06/19 17:15:37 drk $ */
...
struct lexical lex =
    {/* Delimiter set constants for parser use. */
     {
...
UNCH *lextabs[] = {lexcnm, lexcon, lexgrp, lexlms, lexmark, lexsd, lextoke, 0};
