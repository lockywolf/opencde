 ...
 */
/* $XConsortium: getopt.c /main/3 1996/06/19 17:15:14 drk $ */
/* getopt.c -
...
char *opts;
{
        ...
        if (sp == 1) {
                ...
                if ((argv[optind][0] == OPTION_CHAR &&
                     argv[optind][1] == OPTION_CHAR && argv[optind][2] == '\0')
#ifdef SWITCHAR
                    || (argv[optind][0] == switchar &&
                        argv[optind][1] == switchar && argv[optind][2] == '\0')
#endif
                ) {
                        optind++;
                        return (EOF);
