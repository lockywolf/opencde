...
// destroy()			:  Destroy node, its contents and release
// objrefs.
...
class Node {
      ...
      public:
        Node();
        Node(DtMailMessageHandle msg_num, char *str);
        ...
        void set_message_handle(DtMailMessageHandle a_hndl);
        ...
        void set_previous_node(Node *anyNode);
        void set_next_node(Node *anyNode);

        void append(Node *anyNode);
        void prepend(Node *anyNode);
