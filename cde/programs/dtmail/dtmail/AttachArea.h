...
class AttachArea : public UIComponent {
      ...
      public:
        ...
        unsigned int getIconSelectedCount() { return (_iconSelectedCount); }

        unsigned int getDeleteCount() { return (_deleteCount); }
        void incIconCount() { _iconCount++; }
        void decIconCount() { _iconCount--; }
        void incIconSelectedCount() { _iconSelectedCount++; }
        void decIconSelectedCount() { _iconSelectedCount--; }
        ...
        void setFsState(FSState state) { (_fsState = state); }
        void setFsDialog(Widget w) { _fsDialog = w; }
        void setRenameDialog(Widget w) { _renameDialog = w; }
        void setDescriptionDialog(Widget w) { _descriptionDialog = w; }
        Widget getFsDialog() { return (_fsDialog); }
        Widget getRenameDialog() { return (_renameDialog); }

        Widget getDescriptionDialog() { return (_descriptionDialog); }
        ...
        Attachment *addAttachment(DtMail::Message *, DtMail::BodyPart *,
                                  char *filename, char *);

        Attachment *addAttachment(DtMail::Message *, DtMail::BodyPart *, String,
                                  DtMailBuffer);
        ...
        String getRenameMessageString() { return ("RenameMessageString"); }
        String getDescriptionMessageString() {
                return ("DescriptionMessageString");
        }
        unsigned int getAttachmentsSize() { return (_attachmentsSize); }
        ...
        void calculate_attachment_position(Attachment *, Attachment *);
        void CalcLastRow();
        ...
        void parseAttachments(DtMailEnv &, DtMail::Message *, Boolean, int);
        ...
        int handleQuestionDialog(char *title, char *buf,
                                 char *helpId = DTMAILHELPERROR);

        int handleErrorDialog(char *title, char *buf,
                              char *helpId = DTMAILHELPERROR);
};
#endif
