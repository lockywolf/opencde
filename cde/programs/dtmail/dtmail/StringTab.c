...
String ApplicationFallbacks[] = {
    "Dtmail*interval:	5", "Dtmail*Next:		True",
    "Dtmail*Next*default:	True", "Dtmail*PrintScript: lp -dpubs3 ",
    "Dtmail*From*label:	From:", "Dtmail*Text*label:	Text:",
    ...
    "Dtmail*find*To.columns: 1", "Dtmail*find*From.columns: 1",
    "Dtmail*find*Subject.columns: 1", "Dtmail*find*Cc.columns: 1",
    ...
    "Dtmail*ComposeDialog*menubar*File.Log_Message.indicatorType: "
    "XmONE_OF_MANY",
    ...
    "Dtmail*ComposeDialog*Add_File.mnemonic: F", "Dtmail*Save_As.mnemonic: A",
    ...
    "Dtmail*ComposeDialog*menubar*Attachments.Show_List.indicatorType: "
    "XmONE_OF_MANY",
    ...
    "Dtmail*ComposeDialog*menubar*Format.Word_Wrap.indicatorType: "
    "XmONE_OF_MANY",
    ...
    "Dtmail*menubar*Attachments.mnemonic: A", "Dtmail*menubar*View.mnemonic: V",
    ...
    "Dtmail*menubar*Move.mnemonic: o", "Dtmail*RoamMsgsPopup*Move.mnemonic: o",
    "Dtmail*Inbox.mnemonic: I", "Dtmail*Other_Mailboxes.mnemonic: O",
    ...
    "*Message_View*Work_Area.width: 600", "*Message_View*Work_Area.height: 400",
    ...
    */
    ...
    "Dtmail*Work_Area*Text*columns: 72", NULL};
