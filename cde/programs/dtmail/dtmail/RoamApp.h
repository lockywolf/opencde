...
class RoamApp : public Application {
      ...
      public:
        ...
        Display *getErrorPrintDisplay(void) { return _errorPrintDisplay; }
        void globalAddToCachedContainerList(char *);
        void globalPropChange(void);
        char *glyphName(void) { return _glyph_name; }
        ...
        Boolean quitSilently(void) { return _quitSilently; }
        Boolean quitQuickly(void) { return _quitQuickly; }
...
char *getPropStringValue(DtVirtArray<PropStringPair *> &result,
                         const char *value);
