...
typedef struct {
        ...
        OptionsCfrmAttCheckboxItemsRec cfrm_att_checkbox_items;
 ...
 */
int dtb_options_dialog_initialize(DtbOptionsDialogInfo instance, Widget parent);

/*
 * User Callbacks
 */
void opt_dlog_cancelCB(Widget widget, XtPointer clientData, XtPointer callData);

void opt_pane_okCB(Widget widget, XtPointer clientData, XtPointer callData);

void options_applyCB(Widget widget, XtPointer clientData, XtPointer callData);

void start_vacationCB(Widget widget, XtPointer clientData, XtPointer callData);

void stop_vacationCB(Widget widget, XtPointer clientData, XtPointer callData);

void vacationOnCB(Widget widget, XtPointer clientData, XtPointer callData);

void vacationOffCB(Widget widget, XtPointer clientData, XtPointer callData);

void opt_dlog_resetCB(Widget widget, XtPointer clientData, XtPointer callData);

void opt_dlog_HelpCB(Widget widget, XtPointer clientData, XtPointer callData);

void alias_addCB(Widget widget, XtPointer clientData, XtPointer callData);

void alias_delCB(Widget widget, XtPointer clientData, XtPointer callData);

void alias_changeCB(Widget widget, XtPointer clientData, XtPointer callData);

void message_header_listCB(Widget widget, XtPointer clientData,
                           XtPointer callData);

void message_viewCB(Widget widget, XtPointer clientData, XtPointer callData);

void compose_windowCB(Widget widget, XtPointer clientData, XtPointer callData);

void message_filingCB(Widget widget, XtPointer clientData, XtPointer callData);

void vacationCB(Widget widget, XtPointer clientData, XtPointer callData);

void templatesCB(Widget widget, XtPointer clientData, XtPointer callData);

void aliasesCB(Widget widget, XtPointer clientData, XtPointer callData);

void advancedCB(Widget widget, XtPointer clientData, XtPointer callData);

void printingCB(Widget widget, XtPointer clientData, XtPointer callData);

void mailretrievalCB(Widget widget, XtPointer clientData, XtPointer callData);
