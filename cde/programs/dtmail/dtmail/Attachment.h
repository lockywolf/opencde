...
class Attachment : public UIComponent {
      ...
      public:
        ...
        void action(DtActionInvocationID, DtActionArg *, int, int);
        ...
        unsigned long getContentsSize() { return (_myContentsSize); }
        ...
        String getSaveAsFilename() { return (_saveAsFilename); }
        ...
        void deleteIt();
        void undeleteIt();
        void setSaveAsFilename(String str) { (_saveAsFilename = str); }

        void set_binary(Boolean binary) { (_binary = binary); }
      ...
      protected:
        static void actionCallback(DtActionInvocationID id,
