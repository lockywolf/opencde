...
class DmxPrintOptions : public UIComponent {
      ...
      private:
        DtVirtArray<IndexedOptionMenu *> *_iom_array;
        DtVirtArray<PropUiItem *> *_propui_array;
        ...
        static DmxpoPropValue *stringToPropValue(const char *, int,
                                                 DmxpoPropValue *);
        static char *isValidMarginSpec(PropUiItem *, void *);
