...
class RoamMenuWindow : public MenuWindow, public AbstractEditorParent {
      public:
        ...
        static XtActionProc msgListDragStart(Widget, XEvent *, String *,
                                             Cardinal *);
        // DND: Drop Site
        ...
        UndelFromListDialog *get_undel_dialog() {
                return _msg_undelete_from_list->dialog();
        }
        ...
        static DtMailBoolean syncViewAndStoreCallback(DtMailCallbackOp op,
                                                      const char *path,
        ...
        // XSMP support
        static RoamMenuWindow *restoreSession(char *);
      ...
      protected:
        ...
        UnifiedSelectMailboxCmd *_open_container_other;
        ...
        void configurenotify(unsigned int, unsigned int, unsigned int,
      ...
      private:
        ...
        static void conversionFinishedCallback(RoamInterruptibleCmd *, Boolean,
                                               void *);
