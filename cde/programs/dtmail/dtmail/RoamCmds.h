...
class UnifiedSelectFileCmd : public SelectFileCmd {
      ...
      public:
        UnifiedSelectFileCmd(char *name, char *label, char *title,
                             char *ok_label, int active,
                             FileCallback select_callback, void *client_data,
                             Widget parent);
        ~UnifiedSelectFileCmd();

        virtual const char *const className() { return "UnifiedSelectFileCmd"; }
        virtual void doit();
};
...
class UnifiedSelectMailboxCmd : public SelectFileCmd {
      private:
        ...
        static void unifiedMailboxSelectedCB(void *client_data,
                                             char *selection);
        static void unifiedMailboxCanceledCB(void *client_data,
                                             char *selection);
      ...
      protected:
        ...
        void updateUnifiedData();
        void unifiedMailboxSelected(FileCallback cb, void *client_data,
                                    char *selection);

      public:
        UnifiedSelectMailboxCmd(char *name, char *label, char *title,
                                char *ok_label, int active,
                                FileCallback select_callback, void *client_data,
                                Widget parent,
        ...
        virtual const char *const className() {
                return "UnifiedSelectMailboxCmd";
        }
        virtual void doit();
};
...
class MoveCopyCmd : public UnifiedSelectMailboxCmd {
      ...
      public:
        MoveCopyCmd(char *, char *, int, FileCallback, FileCallback,
                    RoamMenuWindow *, Widget, DtMailBoolean);
        ~MoveCopyCmd();
...
class PrintCmd : public ChooseCmd {
      ...
      private:
        ...
        static void actioncb(DtActionInvocationID, XtPointer, DtActionArg *,
                             int, int);
...
class PopupCmd : public NoUndoCmd {
      ...
      public:
        virtual void doit();
        PopupCmd(char *, char *, int, PopupWindow *(RoamMenuWindow::*)(void),
                 RoamMenuWindow *);
...
class SaveAsTextCmd : public UnifiedSelectFileCmd {
      ...
      public:
        virtual void doit();
        SaveAsTextCmd(char *, char *, char *title, int, Editor *,
                      RoamMenuWindow *, Widget);
        SaveAsTextCmd(char *, char *, char *title, int, Editor *, void *,
                      Widget);
...
class SaveAttachCmd : public UnifiedSelectFileCmd {
      ...
      public:
        virtual void doit();
        SaveAttachCmd(char *, char *, char *, int, FileCallback,
                      RoamMenuWindow *, Widget);
        SaveAttachCmd(char *, char *, char *, int, FileCallback,
                      ViewMsgDialog *, Widget);
        SaveAttachCmd(char *, char *, char *, int, FileCallback,
                      SendMsgDialog *, Widget);
        ~SaveAttachCmd(){};
...
class EditPasteSpecialCmd : public NoUndoCmd {
      ...
      public:
        virtual void doit();
        EditPasteSpecialCmd(char *, char *, int, AbstractEditorParent *,
                            Editor::InsertFormat);
