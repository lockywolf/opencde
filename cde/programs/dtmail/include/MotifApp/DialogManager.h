...
class DialogManager : public UIComponent {
      ...
      private:
        static void destroyTmpDialogCallback(Widget, XtPointer, XtPointer);
      ...
      public:
        ...
        virtual Widget post(char *, char *, Widget w, void *clientData = NULL,
        ...
        virtual int post_and_return(char *, char *, Widget);
        virtual int post_and_return(char *, char *, char *, Widget);
        virtual int post_and_return(char *, char *, char *, char *, Widget);
};
#endif
