 ...
 *
 ************************************************************************/
void CreateDefaultImage(char *bits, int width, int height, char *name) {
...
char *MbStrchr(char *str, int ch) {
        ...
        for (i = 0, numBytes = 0, byteLen = strlen(str); i < byteLen;
             i += numBytes) {
 ...
 * MbStrchri -
 ************************************************************************/
char *MbStrchri(char *str, int ch, int *in) {
        size_t mbCurMax = MB_CUR_MAX;
        wchar_t targetChar, curChar;
        char tmpChar;
 ...
 * MbStrrchr -
 ************************************************************************/
char *MbStrrchr(char *str, int ch) {
        size_t mbCurMax = MB_CUR_MAX;
        wchar_t targetChar, curChar;
        ...
        tmpChar = (char)ch;
        mbtowc(&targetChar, &tmpChar, mbCurMax);
        for (i = 0, numBytes = 0, lastChar = (char *)NULL,
            byteLen = strlen(str);
 ...
 ************************************************************************/
void ChangeMainWindowTitle(Editor *pPad) {
        Arg al[5];
        char *name;
        char *title;
 ...
 ************************************************************************/
void SetSaveAsLabelAndDialog(Editor *pPad) {
        char buf[256];
        Arg al[10];
        int ac, count = 0;
        char *mnemonic;
        ...
        if (pPad->fileStuff.fileWidgets.saveAsBtn) {
                if (pPad->xrdb.nameChange) {
                        ...
                        tmpStr = XmStringCreateLocalized(
                            ((char *)GETMESSAGE(11, 26, "Save As...")));
                } else {
                        mnemonic = strdup(((char *)GETMESSAGE(11, 109, "F")));
                        tmpStr = XmStringCreateLocalized(
                            ((char *)GETMESSAGE(11, 110, "Copy To File...")));
                }
                ac = 0;
                XtSetArg(al[ac], XmNlabelString, tmpStr);
                ac++;
                XtSetArg(al[ac], XmNmnemonic, mnemonic[0]);
                ac++;
        ...
        if (pPad->fileStuff.fileWidgets.saveAs.saveAs_form) {
                ...
                XtSetValues(pPad->fileStuff.fileWidgets.saveAs.saveAs_form, al,
                            1);
                XmStringFree(tmpStr);
        }
}
 ...
 *
 ************************************************************************/
static void CreateHelpMenu(Editor *pPad) {
        ...
        XtAddCallback(help_pane, XmNhelpCallback, (XtCallbackProc)HelpHelpCB,
                      pPad);
        mnemonic = strdup(((char *)GETMESSAGE(11, 81, "H")));
        tmpStr = XmStringCreateLocalized(((char *)GETMESSAGE(11, 82, "Help")));
        ac = 0;
        XtSetArg(al[ac], XmNsubMenuId, help_pane);
        ac++;
        XtSetArg(al[ac], XmNlabelString, tmpStr);
        ac++;
        XtSetArg(al[ac], XmNmnemonic, mnemonic[0]);
        ...
        XtAddCallback(cascade, XmNhelpCallback, (XtCallbackProc)HelpHelpCB,
                      pPad);
        ...
        tmpStr =
            XmStringCreateLocalized(((char *)GETMESSAGE(11, 84, "Overview")));
        ac = 0;
        XtSetArg(al[ac], XmNlabelString, tmpStr);
        ac++;
        XtSetArg(al[ac], XmNmnemonic, mnemonic[0]);
        ac++;
        WidgList[count++] =
            XmCreatePushButtonGadget(help_pane, "overview", al, ac);
        ...
        ac++;
        WidgList[count++] =
            XmCreatePushButtonGadget(help_pane, "tasks", al, ac);
        XtAddCallback(WidgList[count - 1], XmNactivateCallback,
        ...
        tmpStr = XmStringCreateLocalized(
            ((char *)GETMESSAGE(11, 88, "Table of Contents")));
        ac = 0;
        XtSetArg(al[ac], XmNlabelString, tmpStr);
        ac++;
        XtSetArg(al[ac], XmNmnemonic, mnemonic[0]);
        ...
        tmpStr =
            XmStringCreateLocalized(((char *)GETMESSAGE(11, 90, "Reference")));
        ac = 0;
        XtSetArg(al[ac], XmNlabelString, tmpStr);
        ac++;
        XtSetArg(al[ac], XmNmnemonic, mnemonic[0]);
        ac++;
        WidgList[count++] =
            XmCreatePushButtonGadget(help_pane, "reference", al, ac);
        XtAddCallback(WidgList[count - 1], XmNactivateCallback,
        ...
        tmpStr =
            XmStringCreateLocalized(((char *)GETMESSAGE(11, 92, "On Item")));
        ac = 0;
        XtSetArg(al[ac], XmNlabelString, tmpStr);
        ac++;
        XtSetArg(al[ac], XmNmnemonic, mnemonic[0]);
        ac++;
        WidgList[count++] =
            XmCreatePushButtonGadget(help_pane, "onItem", al, ac);
        XtAddCallback(WidgList[count - 1], XmNactivateCallback,
        ...
        tmpStr =
            XmStringCreateLocalized(((char *)GETMESSAGE(11, 94, "Using Help")));
        ac = 0;
        XtSetArg(al[ac], XmNlabelString, tmpStr);
        ac++;
        XtSetArg(al[ac], XmNmnemonic, mnemonic[0]);
        ac++;
        WidgList[count++] =
            XmCreatePushButtonGadget(help_pane, "usingHelp", al, ac);
        XtAddCallback(WidgList[count - 1], XmNactivateCallback,
        ...
        tmpStr = XmStringCreateLocalized(
            ((char *)GETMESSAGE(11, 96, "About Text Editor")));
        ac = 0;
        XtSetArg(al[ac], XmNlabelString, tmpStr);
        ac++;
        XtSetArg(al[ac], XmNmnemonic, mnemonic[0]);
        ac++;
        WidgList[count++] =
            XmCreatePushButtonGadget(help_pane, "about", al, ac);
        XtAddCallback(WidgList[count - 1], XmNactivateCallback,
 ...
 *
 ************************************************************************/
static void CreateFileMenu(Editor *pPad) {
        ...
        XtAddCallback(file_pane, XmNhelpCallback, (XtCallbackProc)HelpFileCB,
                      pPad);
        mnemonic = strdup(((char *)GETMESSAGE(11, 15, "F")));
        tmpStr = XmStringCreateLocalized(((char *)GETMESSAGE(11, 16, "File")));
        ac = 0;
        XtSetArg(al[ac], XmNsubMenuId, file_pane);
        ac++;
        XtSetArg(al[ac], XmNlabelString, tmpStr);
        ac++;
        XtSetArg(al[ac], XmNmnemonic, mnemonic[0]);
        ...
        XtAddCallback(cascade, XmNhelpCallback, (XtCallbackProc)HelpFileCB,
                      pPad);
        XtManageChild(cascade);
        free(mnemonic);
        XmStringFree(tmpStr);
        ...
        tmpStr =
            XmStringCreateLocalized(((char *)GETMESSAGE(11, 20, "Open...")));
        ac = 0;
        XtSetArg(al[ac], XmNlabelString, tmpStr);
        ac++;
        XtSetArg(al[ac], XmNmnemonic, mnemonic[0]);
        ...
        tmpStr =
            XmStringCreateLocalized(((char *)GETMESSAGE(11, 22, "Include...")));
        ac = 0;
        XtSetArg(al[ac], XmNlabelString, tmpStr);
        ac++;
        XtSetArg(al[ac], XmNmnemonic, mnemonic[0]);
        ac++;
        WidgList[count++] =
            XmCreatePushButtonGadget(file_pane, "include", al, ac);
        ...
        pPad->fileStuff.saveNeededBtnLabel = XmStringCreateLocalized(
            ((char *)GETMESSAGE(11, 73, "Save (needed)")));
        ac = 0;
        XtSetArg(al[ac], XmNmnemonic, mnemonic[0]);
        ac++;
        ...
        ac = 0;
        WidgList[count++] =
            XmCreatePushButtonGadget(file_pane, "saveAs", al, ac);
        ...
        tmpStr =
            XmStringCreateLocalized(((char *)GETMESSAGE(11, 28, "Print...")));
        ac = 0;
        XtSetArg(al[ac], XmNlabelString, tmpStr);
        ac++;
        XtSetArg(al[ac], XmNmnemonic, mnemonic[0]);
        ac++;
        WidgList[count++] =
            XmCreatePushButtonGadget(file_pane, "print", al, ac);
        ...
        ac++;
        WidgList[count++] =
            XmCreatePushButtonGadget(file_pane, "close", al, ac);
 ...
 *
 ************************************************************************/
static void CreateEditMenu(Editor *pPad) {
        ...
        XtAddCallback(edit_pane, XmNhelpCallback, (XtCallbackProc)HelpEditCB,
                      pPad);
        mnemonic = strdup(((char *)GETMESSAGE(11, 31, "E")));
        tmpStr = XmStringCreateLocalized(((char *)GETMESSAGE(11, 32, "Edit")));
        ac = 0;
        XtSetArg(al[ac], XmNsubMenuId, edit_pane);
        ac++;
        XtSetArg(al[ac], XmNlabelString, tmpStr);
        ac++;
        XtSetArg(al[ac], XmNmnemonic, mnemonic[0]);
        ...
        XtAddCallback(cascade, XmNhelpCallback, (XtCallbackProc)HelpEditCB,
                      pPad);
        XtManageChild(cascade);
        free(mnemonic);
        XmStringFree(tmpStr);
        ...
        ac++;
        WidgList[count++] =
            XmCreatePushButtonGadget(edit_pane, "paste", al, ac);
        ...
        ac++;
        WidgList[count++] =
            XmCreatePushButtonGadget(edit_pane, "clear", al, ac);
        ...
        tmpStr =
            XmStringCreateLocalized(((char *)GETMESSAGE(11, 44, "Delete")));
        ac = 0;
        XtSetArg(al[ac], XmNlabelString, tmpStr);
        ac++;
        XtSetArg(al[ac], XmNmnemonic, mnemonic[0]);
        ac++;
        WidgList[count++] =
            XmCreatePushButtonGadget(edit_pane, "delete", al, ac);
        ...
        tmpStr = XmStringCreateLocalized(
            ((char *)GETMESSAGE(11, 102, "Select All")));
        ac = 0;
        XtSetArg(al[ac], XmNlabelString, tmpStr);
        ac++;
        XtSetArg(al[ac], XmNmnemonic, mnemonic[0]);
        ac++;
        WidgList[count++] =
            XmCreatePushButtonGadget(edit_pane, "selectAll", al, ac);
        ...
        tmpStr = XmStringCreateLocalized(
            ((char *)GETMESSAGE(11, 104, "Find/Change...")));
        ac = 0;
        XtSetArg(al[ac], XmNlabelString, tmpStr);
        ac++;
        XtSetArg(al[ac], XmNmnemonic, mnemonic[0]);
        ...
        tmpStr = XmStringCreateLocalized(
            ((char *)GETMESSAGE(11, 106, "Check Spelling...")));
        ac = 0;
        XtSetArg(al[ac], XmNlabelString, tmpStr);
        ac++;
        XtSetArg(al[ac], XmNmnemonic, mnemonic[0]);
        ac++;
        WidgList[count++] =
            XmCreatePushButtonGadget(edit_pane, "checkSpelling", al, ac);
 ...
 *
 ************************************************************************/
static void CreateFormatMenu(Editor *pPad) {
        ...
        ac = 0;
        format_pane =
            XmCreatePulldownMenu(pPad->menu_bar, "formatMenu", al, ac);
        XtAddCallback(format_pane, XmNhelpCallback,
                      (XtCallbackProc)HelpFormatCB, pPad);
        mnemonic = strdup(((char *)GETMESSAGE(11, 51, "r")));
        tmpStr =
            XmStringCreateLocalized(((char *)GETMESSAGE(11, 52, "Format")));
        ac = 0;
        XtSetArg(al[ac], XmNsubMenuId, format_pane);
        ac++;
        XtSetArg(al[ac], XmNlabelString, tmpStr);
        ac++;
        XtSetArg(al[ac], XmNmnemonic, mnemonic[0]);
        ...
        XtAddCallback(cascade, XmNhelpCallback, (XtCallbackProc)HelpFormatCB,
                      pPad);
        ...
        tmpStr = XmStringCreateLocalized(
            ((char *)GETMESSAGE(11, 54, "Settings...")));
        ac = 0;
        XtSetArg(al[ac], XmNlabelString, tmpStr);
        ac++;
        XtSetArg(al[ac], XmNmnemonic, mnemonic[0]);
        ...
        tmpStr =
            XmStringCreateLocalized(((char *)GETMESSAGE(11, 56, "Paragraph")));
        ac = 0;
        XtSetArg(al[ac], XmNlabelString, tmpStr);
        ac++;
        XtSetArg(al[ac], XmNmnemonic, mnemonic[0]);
        ...
        ac++;
        WidgList[count++] =
            XmCreatePushButtonGadget(format_pane, "all", al, ac);
        XtAddCallback(WidgList[count - 1], XmNactivateCallback,
 ...
 *
 ************************************************************************/
static void CreateOptionsMenu(Editor *pPad) {
        ...
        ac = 0;
        options_pane =
            XmCreatePulldownMenu(pPad->menu_bar, "optionsMenu", al, ac);
        XtAddCallback(options_pane, XmNhelpCallback,
                      (XtCallbackProc)HelpOptionsCB, pPad);
        mnemonic = strdup(((char *)GETMESSAGE(11, 59, "O")));
        tmpStr =
            XmStringCreateLocalized(((char *)GETMESSAGE(11, 60, "Options")));
        ac = 0;
        XtSetArg(al[ac], XmNsubMenuId, options_pane);
        ac++;
        XtSetArg(al[ac], XmNlabelString, tmpStr);
        ac++;
        XtSetArg(al[ac], XmNmnemonic, mnemonic[0]);
        ac++;
        cascade =
            XmCreateCascadeButtonGadget(pPad->menu_bar, "options", al, ac);
        XtAddCallback(cascade, XmNhelpCallback, (XtCallbackProc)HelpOptionsCB,
                      pPad);
        ...
        tmpStr =
            XmStringCreateLocalized(((char *)GETMESSAGE(11, 62, "Overstrike")));
        ac = 0;
        XtSetArg(al[ac], XmNlabelString, tmpStr);
        ac++;
        XtSetArg(al[ac], XmNmnemonic, mnemonic[0]);
        ...
        ac++;
        XtSetArg(al[ac], XmNset, pPad->xrdb.overstrike);
        ac++;
        WidgList[count++] =
            XmCreateToggleButton(options_pane, "overstrike", al, ac);
        ...
        tmpStr = XmStringCreateLocalized(
            ((char *)GETMESSAGE(11, 112, "Wrap To Fit")));
        ac = 0;
        XtSetArg(al[ac], XmNlabelString, tmpStr);
        ac++;
        XtSetArg(al[ac], XmNmnemonic, mnemonic[0]);
        ...
        XtSetArg(al[ac], XmNvisibleWhenOff, True);
        ac++;
        XtSetArg(al[ac], XmNset, pPad->xrdb.wordWrap);
        ac++;
        WidgList[count++] =
            XmCreateToggleButton(options_pane, "wordWrap", al, ac);
        ...
        tmpStr = XmStringCreateLocalized(
            ((char *)GETMESSAGE(11, 66, "Status Line")));
        ac = 0;
        XtSetArg(al[ac], XmNlabelString, tmpStr);
        ac++;
        XtSetArg(al[ac], XmNmnemonic, mnemonic[0]);
        ...
        XtSetArg(al[ac], XmNvisibleWhenOff, True);
        ac++;
        XtSetArg(al[ac], XmNset, pPad->xrdb.statusLine);
        ac++;
        WidgList[count++] =
            XmCreateToggleButton(options_pane, "statusLine", al, ac);
 ...
 *
 ************************************************************************/
void CreateMenuBar(Editor *pPad) {
 ...
 ************************************************************************/
void CreateEditorWidget(Editor *pPad) {
        ...
        ac = 0;
        XtSetArg(al[ac], DtNrows, DEFAULT_ROWS);
        ac++;
        XtSetArg(al[ac], DtNcolumns, DEFAULT_COLS);
        ac++;
        XtSetArg(al[ac], DtNdialogTitle, dialogTitleStr);
        ac++;
        ...
        XtAddCallback(pPad->editor, XmNhelpCallback,
                      (XtCallbackProc)HelpEditorWidgetCB, (XtPointer)pPad);
        XtAddCallback(pPad->editor, DtNtextSelectCallback,
                      (XtCallbackProc)TextSelectedCB, (XtPointer)pPad);
        XtAddCallback(pPad->editor, DtNtextDeselectCallback,
                      (XtCallbackProc)TextDeselectedCB, (XtPointer)pPad);
 ...
 *
 ************************************************************************/
Boolean FindOrCreatePad(Editor **ppPad) {
        ...
        if (foundPad == False) {
                ...
                char *pProgName;
                Display *display;
                unsigned short group_id, user_id;

                /* -----> Save some defaults from the last entry that was
                 * created. */
                ...
                /* -----> Create a new entry and point pPad and the global,
                 * pPadList to it. */
                CreatePad(&pPad);
                pPad->inUse = True;

                /* -----> Set some defaults from the last entry that was
                 * created. */
                ...
                XtSetArg(al[ac], XmNargc, argc_l);
                ac++;
                pPad->app_shell = XtAppCreateShell(
                    pPad->progname, DTPAD_CLASS_NAME,
                    applicationShellWidgetClass, pPad->display, al, ac);
                pPad->app_context =
                    XtWidgetToApplicationContext(pPad->app_shell);
        ...
        if (workspaces) {
                ...
                if (DtWsmGetCurrentWorkspace(XtDisplay(shell), rootWindow,
                        ...
                        DtWsmSetWorkspacesOccupied(
                            XtDisplay(shell), XtWindow(shell), &pCurrent, 1);
                }
        }
}
 ...
 ************************************************************************/
/* ARGSUSED */
void ClearStatusMessage(Editor *pPad) {
 ...
 ************************************************************************/
/* ARGSUSED */
void SetStatusMessage(Editor *pPad, char *str) {
...
void CreatePopupMenu(Editor *pPad) {
        Arg al[5];
        int ac;
        ...
        XtSetArg(al[ac], XmNlabelString, tmpStr);
        ac++;
        XtSetArg(al[ac], XmNsubMenuId, fileMenu);
        ac++;
        XtSetArg(al[ac], XmNmnemonic, mnemonic);
        ac++;
        popupBtns[i++] =
            XmCreateCascadeButtonGadget(pPad->popup, "File", al, ac);
        free(mnemonic);
        XmStringFree(tmpStr);
        ...
        CreateButton(fileMenu, "Open...", 'O', DisplayFsbCb,
                     (XtPointer)LOAD_DATA);
        CreateButton(fileMenu, "Include...", 'I', DisplayFsbCb,
                     (XtPointer)INSERT_DATA);
        CreateButton(fileMenu, "Save As...", 'A', DisplayFsbCb,
                     (XtPointer)SAVE_DATA);
        ...
        CreateButton(popupMenu, "Find/Change...", 'F', FindCb,
                     (XtPointer)ad.editor);
