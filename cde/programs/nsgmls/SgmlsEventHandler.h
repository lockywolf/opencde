...
class SgmlsEventHandler : public ErrorCountEventHandler,
      ...
      public:
        ...
        SgmlsEventHandler(const SgmlParser *, OutputCharStream *, Messenger *,
...
inline void SgmlsEventHandler::outputString(const StringC &str) {
        outputString(str.data(), str.size());
}

inline OutputCharStream &SgmlsEventHandler::os() { return *os_; }
