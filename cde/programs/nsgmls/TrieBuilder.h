...
class TrieBuilder {
      public:
        ...
        void recognize(const String<EquivCode> &chars, Token t,
                       Priority::Type pri, TokenVector &ambiguities);
        void recognize(const String<EquivCode> &chars,
                       const String<EquivCode> &set, Token t,
                       Priority::Type pri, TokenVector &ambiguities);
        ...
        void recognizeB(const String<EquivCode> &chars,
                        ...
                        const String<EquivCode> &chars2, Token t,
      ...
      private:
        ...
        void doB(Trie *trie, int tokenLength, int minBLength, size_t maxLength,
                 const String<EquivCode> &blankCodes,
                 const String<EquivCode> &chars2, Token token,
                 Priority::Type pri, TokenVector &ambiguities);
        Trie *extendTrie(Trie *, const String<EquivCode> &);
        void setToken(Trie *trie, int tokenLength, Token token,
                      Priority::Type pri, TokenVector &ambiguities);
