...
// This file was automatically generated from EntityManagerMessages.msg by
// msggen.pl.
#include "Message.h"
...
const MessageType1
    EntityManagerMessages::fsiSyntax(MessageType::error,
#ifdef BUILD_LIBSP
...
const MessageType1
    EntityManagerMessages::fsiUnknownBctf(MessageType::error,
#ifdef BUILD_LIBSP
                                          MessageFragment::libModule,
#else
                                          MessageFragment::appModule,
...
const MessageType1
    EntityManagerMessages::fsiLookupChar(MessageType::error,
#ifdef BUILD_LIBSP
                                         MessageFragment::libModule,
#else
                                         MessageFragment::appModule,
...
#ifndef SP_NO_MESSAGE_TEXT
                                         ,
                                         "non-minimum data character (number "
                                         "%1) in value of formal system "
