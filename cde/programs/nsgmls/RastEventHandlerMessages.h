 ...
 */
// This file was automatically generated from RastEventHandlerMessages.msg by
// msggen.pl.
#include "Message.h"
...
const MessageType0
    RastEventHandlerMessages::noLinkRuleMatch(MessageType::error,
#ifdef BUILD_LIBSP
                                              MessageFragment::libModule,
#else
                                              MessageFragment::appModule,
...
#ifndef SP_NO_MESSAGE_TEXT
                                              ,
                                              "rast-link-rule: processing "
                                              "instruction matches does not "
                                              "match any link rules"
#endif
    );
