...
inline Boolean ShortReferenceMap::defined() const {
        return nameMap_.size() > 0;
}

inline const StringC *ShortReferenceMap::entityName(size_t i) const {
...
inline const ConstPtr<Entity> &ShortReferenceMap::entity(size_t i) const {
...
inline void ShortReferenceMap::setEntityMap(Vector<ConstPtr<Entity> > &map) {
        map.swap(entityMap_);
}

inline Boolean ShortReferenceMap::used() const { return used_; }

inline void ShortReferenceMap::setUsed() { used_ = 1; }

inline void ShortReferenceMap::setDefLocation(const Location &loc) {
        defLocation_ = loc;
}

inline const Location &ShortReferenceMap::defLocation() const {
        return defLocation_;
}
