...
inline unsigned CharsetInfo::univToDesc(UnivChar from, WideChar &to,
                                        ISet<WideChar> &toSet) const {
...
inline Boolean CharsetInfo::descToUniv(UnivChar from, WideChar &to) const {
        if (from < nSmall) {
...
inline Char CharsetInfo::execToDesc(char c) const {
        return execToDesc_[(unsigned char)c];
}

inline Boolean CharsetInfo::descToUniv(WideChar from, UnivChar &to,
                                       WideChar &alsoMax) const {
...
inline const UnivCharsetDesc &CharsetInfo::desc() const { return desc_; }
