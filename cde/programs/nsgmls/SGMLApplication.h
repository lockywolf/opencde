...
class SP_API SGMLApplication {
      public:
        ...
        struct ExternalId {
                ...
                CharString
                    generatedSystemId; // valid if haveGeneratedSystemId is true
        };
        struct Notation {
                CharString name;
        ...
        struct Attribute {
                CharString name;
                enum Type { invalid, implied, cdata, tokenized };
                Type type;
                enum Defaulted {
                ...
                struct CdataChunk {
                        ...
                        CharString data;
                        CharString
                            entityName; // non-ESIS; optional for SDATA chunks
                };
...
inline const SGMLApplication::OpenEntity *SGMLApplication::OpenEntityPtr::
operator->() const {
        return ptr_;
}

inline void SGMLApplication::OpenEntityPtr::
operator=(const OpenEntityPtr &ptr) {
        *this = ptr.ptr_;
}

inline SGMLApplication::OpenEntityPtr::operator int() const {
        return ptr_ != 0;
}
