...
// This file was automatically generated from ArcEngineMessages.msg by
// msggen.pl.
#include "Message.h"
...
const MessageType1
    ArcEngineMessages::unfinishedElement(MessageType::error,
#ifdef BUILD_LIBSP
                                         MessageFragment::libModule,
#else
                                         MessageFragment::appModule,
...
const MessageType0
    ArcEngineMessages::renameMissingAttName(MessageType::error,
#ifdef BUILD_LIBSP
                                            MessageFragment::libModule,
#else
                                            MessageFragment::appModule,
...
const MessageType1
    ArcEngineMessages::invalidSuppress(MessageType::error,
#ifdef BUILD_LIBSP
                                       MessageFragment::libModule,
#else
                                       MessageFragment::appModule,
...
const MessageType1
    ArcEngineMessages::arcDtdNotExternal(MessageType::error,
#ifdef BUILD_LIBSP
                                         MessageFragment::libModule,
#else
                                         MessageFragment::appModule,
...
const MessageType1
    ArcEngineMessages::noArcDataF(MessageType::error,
#ifdef BUILD_LIBSP
                                  MessageFragment::libModule,
#else
                                  MessageFragment::appModule,
...
const MessageType0
    ArcEngineMessages::invalidData(MessageType::error,
#ifdef BUILD_LIBSP
                                   MessageFragment::libModule,
#else
                                   MessageFragment::appModule,
...
const MessageType1
    ArcEngineMessages::invalidIgnD(MessageType::error,
#ifdef BUILD_LIBSP
                                   MessageFragment::libModule,
#else
                                   MessageFragment::appModule,
...
const MessageType1
    ArcEngineMessages::invalidQuantity(MessageType::error,
#ifdef BUILD_LIBSP
                                       MessageFragment::libModule,
#else
                                       MessageFragment::appModule,
...
const MessageType1
    ArcEngineMessages::missingQuantityValue(MessageType::error,
#ifdef BUILD_LIBSP
                                            MessageFragment::libModule,
#else
                                            MessageFragment::appModule,
...
const MessageType1 ArcEngineMessages::invalidDigit(MessageType::error,
#ifdef BUILD_LIBSP
                                                   MessageFragment::libModule,
#else
                                                   MessageFragment::appModule,
