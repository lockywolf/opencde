 ...
 */
/* $XConsortium: Location.h /main/1 1996/07/29 16:56:22 cde-hp $ */
...
class SP_API NamedCharRef {
      public:
        enum RefEndType { endOmitted, endRE, endRefc };
        NamedCharRef();
...
inline Index NamedCharRef::refStartIndex() const { return refStartIndex_; }

inline NamedCharRef::RefEndType NamedCharRef::refEndType() const {
        return refEndType_;
}

inline const StringC &NamedCharRef::origName() const { return origName_; }

inline const ExternalInfo *InputSourceOrigin::externalInfo() const {
