...
// This file was automatically generated from URLStorageMessages.msg by
// msggen.pl.
#include "Message.h"
...
const MessageType1 URLStorageMessages::emptyHost(MessageType::error,
#ifdef BUILD_LIBSP
...
const MessageType1
    URLStorageMessages::badRelative(MessageType::error,
#ifdef BUILD_LIBSP
                                    MessageFragment::libModule,
#else
                                    MessageFragment::appModule,
...
const MessageType1
    URLStorageMessages::emptyPort(MessageType::error,
#ifdef BUILD_LIBSP
                                  MessageFragment::libModule,
#else
                                  MessageFragment::appModule,
...
const MessageType1
    URLStorageMessages::invalidPort(MessageType::error,
#ifdef BUILD_LIBSP
                                    MessageFragment::libModule,
#else
                                    MessageFragment::appModule,
...
const MessageType1 URLStorageMessages::hostNotFound(MessageType::error,
#ifdef BUILD_LIBSP
                                                    MessageFragment::libModule,
#else
                                                    MessageFragment::appModule,
...
const MessageType1
    URLStorageMessages::hostNoData(MessageType::error,
#ifdef BUILD_LIBSP
                                   MessageFragment::libModule,
#else
                                   MessageFragment::appModule,
...
const MessageType2
    URLStorageMessages::hostOtherError(MessageType::error,
#ifdef BUILD_LIBSP
                                       MessageFragment::libModule,
#else
                                       MessageFragment::appModule,
...
const MessageType1
    URLStorageMessages::cannotCreateSocket(MessageType::error,
#ifdef BUILD_LIBSP
                                           MessageFragment::libModule,
#else
                                           MessageFragment::appModule,
...
const MessageType2
    URLStorageMessages::cannotConnect(MessageType::error,
#ifdef BUILD_LIBSP
                                      MessageFragment::libModule,
#else
                                      MessageFragment::appModule,
...
const MessageType2
    URLStorageMessages::writeError(MessageType::error,
#ifdef BUILD_LIBSP
                                   MessageFragment::libModule,
#else
                                   MessageFragment::appModule,
...
const MessageType2
    URLStorageMessages::readError(MessageType::error,
#ifdef BUILD_LIBSP
                                  MessageFragment::libModule,
#else
                                  MessageFragment::appModule,
...
const MessageType2
    URLStorageMessages::closeError(MessageType::error,
#ifdef BUILD_LIBSP
                                   MessageFragment::libModule,
#else
                                   MessageFragment::appModule,
...
const MessageType1
    URLStorageMessages::invalidHostNumber(MessageType::error,
#ifdef BUILD_LIBSP
                                          MessageFragment::libModule,
#else
                                          MessageFragment::appModule,
...
const MessageType0
    URLStorageMessages::notSupported(MessageType::error,
#ifdef BUILD_LIBSP
                                     MessageFragment::libModule,
#else
                                     MessageFragment::appModule,
...
const MessageType0 URLStorageMessages::onlyHTTP(MessageType::error,
#ifdef BUILD_LIBSP
                                                MessageFragment::libModule,
#else
                                                MessageFragment::appModule,
...
const MessageType0
    URLStorageMessages::winsockVersion(MessageType::error,
#ifdef BUILD_LIBSP
                                       MessageFragment::libModule,
#else
                                       MessageFragment::appModule,
