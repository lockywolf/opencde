...
// This file was automatically generated from PosixStorageMessages.msg by
// msggen.pl.
#include "Message.h"
...
const MessageType2
    PosixStorageMessages::readSystemCall(MessageType::error,
#ifdef BUILD_LIBSP
...
const MessageType2
    PosixStorageMessages::openSystemCall(MessageType::error,
#ifdef BUILD_LIBSP
                                         MessageFragment::libModule,
#else
                                         MessageFragment::appModule,
...
const MessageType2
    PosixStorageMessages::closeSystemCall(MessageType::error,
#ifdef BUILD_LIBSP
                                          MessageFragment::libModule,
#else
                                          MessageFragment::appModule,
...
const MessageType2
    PosixStorageMessages::lseekSystemCall(MessageType::error,
#ifdef BUILD_LIBSP
                                          MessageFragment::libModule,
#else
                                          MessageFragment::appModule,
...
const MessageType1
    PosixStorageMessages::invalidFilename(MessageType::error,
#ifdef BUILD_LIBSP
                                          MessageFragment::libModule,
#else
                                          MessageFragment::appModule,
...
const MessageType2
    PosixStorageMessages::fdRead(MessageType::error,
#ifdef BUILD_LIBSP
                                 MessageFragment::libModule,
#else
                                 MessageFragment::appModule,
...
const MessageType2
    PosixStorageMessages::fdLseek(MessageType::error,
#ifdef BUILD_LIBSP
                                  MessageFragment::libModule,
#else
                                  MessageFragment::appModule,
...
const MessageType2 PosixStorageMessages::cannotFind(MessageType::error,
#ifdef BUILD_LIBSP
                                                    MessageFragment::libModule,
#else
                                                    MessageFragment::appModule,
