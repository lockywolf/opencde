...
const MessageType2
    NsgmlsMessages::cannotOpenOutputError(MessageType::error,
#ifdef BUILD_LIBSP
...
const MessageType2
    NsgmlsMessages::closeOutputError(MessageType::error,
#ifdef BUILD_LIBSP
                                     MessageFragment::libModule,
#else
                                     MessageFragment::appModule,
...
const MessageType1
    NsgmlsMessages::unknownOutputOption(MessageType::error,
#ifdef BUILD_LIBSP
                                        MessageFragment::libModule,
#else
                                        MessageFragment::appModule,
