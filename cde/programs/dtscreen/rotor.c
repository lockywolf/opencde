...
void initrotor(perwindow *pwin) {
        ...
        /*
         * sometimes, you go into small view, only to see a really whizzy
         * pattern that you would like to look more closely at. Normally,
         * clicking in the icon reinitializes everything - but I don't, cuz I'm
         * that kind of guy. HENCE, the wassmall stuff you see here.
         */
        ...
        if (wassmall && !fs->smallscreen)
                ...
                if ((fs->elements = (struct elem *)malloc(sizeof(struct elem) *
                                                          fs->num)) == 0) {
                        perror("malloc");
                        exit(1);
                }
