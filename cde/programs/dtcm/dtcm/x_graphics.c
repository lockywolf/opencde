...
static char bold30PtFont[] = "-*-times-bold-r-normal-*-0-300-0-0-p-0-*-*:";
static char bold20PtFont[] = "-*-times-bold-r-normal-*-0-200-0-0-p-0-*-*:";
static char bold16PtFont[] = "-*-times-bold-r-normal-*-0-160-0-0-p-0-*-*:";
static char bold14PtFont[] = "-*-times-bold-r-normal-*-0-140-0-0-p-0-*-*:";
static char bold12PtFont[] = "-*-times-bold-r-normal-*-0-120-0-0-p-0-*-*:";
static char bold10PtFont[] = "-*-times-bold-r-normal-*-0-100-0-0-p-0-*-*:";
static char bold9PtFont[] = "-*-times-bold-r-normal-*-0-90-0-0-p-0-*-*:";
static char bold7PtFont[] = "-*-times-bold-r-normal-*-0-70-0-0-p-0-*-*:";

static char helv10PtFont[] =
    "-*-helvetica-medium-r-normal-*-0-100-0-0-p-0-*-*:";
static char helv9PtFont[] = "-*-helvetica-medium-r-normal-*-0-90-0-0-p-0-*-*:";
static char helv8PtFont[] = "-*-helvetica-medium-r-normal-*-0-80-0-0-p-0-*-*:";

static char cour12PtFont[] = "-*-courier-medium-r-normal-*-0-120-0-0-m-0-*-*:";
static char cour7PtFont[] = "-*-courier-medium-r-normal-*-0-70-0-0-m-0-*-*:";
#else
static char bold40PtFont[] =
...
static XtResource dvDefaultResources[] = {
    {"dvpTitleFont", "PrintTitleFont", XmRString, sizeof(String),
     sizeof(String) * DV_TITLE_FONT, XmRImmediate, (XtPointer)bold16PtFont},
    {"dvpHeaderFont", "PrintHeaderFont", XmRString, sizeof(String),
     sizeof(String) * DV_HEADER_FONT, XmRImmediate, (XtPointer)bold9PtFont},
    {"dvpApptFont", "PrintApptFont", XmRString, sizeof(String),
     sizeof(String) * DV_APPT_FONT, XmRImmediate, (XtPointer)helv10PtFont},
    {"dvpTimeFont", "PrintTimeFont", XmRString, sizeof(String),
     sizeof(String) * DV_TIME_FONT, XmRImmediate, (XtPointer)bold10PtFont}};

static XtResource wvDefaultResources[] = {
    {"wvpTitleFont", "PrintTitleFont", XmRString, sizeof(String),
     sizeof(String) * WV_TITLE_FONT, XmRImmediate, (XtPointer)bold16PtFont},
    {"wvpHeaderFont", "PrintHeaderFont", XmRString, sizeof(String),
     sizeof(String) * WV_HEADER_FONT, XmRImmediate, (XtPointer)bold9PtFont},
    {"wvpApptFont", "PrintApptFont", XmRString, sizeof(String),
     sizeof(String) * WV_APPT_FONT, XmRImmediate, (XtPointer)helv9PtFont},
    {"wvpDayFont", "PrintDayFont", XmRString, sizeof(String),
     sizeof(String) * WV_DAY_FONT, XmRImmediate, (XtPointer)bold12PtFont},
    {"wvpBoxFont", "PrintBoxFont", XmRString, sizeof(String),
     sizeof(String) * WV_BOX_FONT, XmRImmediate, (XtPointer)bold12PtFont}};

static XtResource mvDefaultResources[] = {
    {"mvpTitleFont", "PrintTitleFont", XmRString, sizeof(String),
     sizeof(String) * MV_TITLE_FONT, XmRImmediate, (XtPointer)bold30PtFont},
    {"mvpHeaderFont", "PrintHeaderFont", XmRString, sizeof(String),
     sizeof(String) * MV_HEADER_FONT, XmRImmediate, (XtPointer)bold9PtFont},
    {"mvpApptFont", "PrintApptFont", XmRString, sizeof(String),
     sizeof(String) * MV_APPT_FONT, XmRImmediate, (XtPointer)helv8PtFont},
    {"mvpDayFont", "PrintDayFont", XmRString, sizeof(String),
     sizeof(String) * MV_DAY_FONT, XmRImmediate, (XtPointer)bold14PtFont},
    {"mvpDateFont", "PrintDateFont", XmRString, sizeof(String),
     sizeof(String) * MV_DATE_FONT, XmRImmediate, (XtPointer)bold20PtFont},
    ...
    {"mvpTinyDayFont", "PrintTinyDayFont", XmRString, sizeof(String),
     sizeof(String) * MV_TINY_DAY_FONT, XmRImmediate, (XtPointer)cour7PtFont},
    {"mvpTinyDateFont", "PrintTinyDateFont", XmRString, sizeof(String),
     sizeof(String) * MV_TINY_DATE_FONT, XmRImmediate, (XtPointer)bold7PtFont}};

static XtResource yvDefaultResources[] = {
    {"yvpTitleFont", "PrintTitleFont", XmRString, sizeof(String),
     sizeof(String) * YV_TITLE_FONT, XmRImmediate, (XtPointer)bold40PtFont},
    {"yvpHeaderFont", "PrintHeaderFont", XmRString, sizeof(String),
     sizeof(String) * YV_HEADER_FONT, XmRImmediate, (XtPointer)bold9PtFont},
    ...
    {"yvpTinyDayFont", "PrintTinyDayFont", XmRString, sizeof(String),
     sizeof(String) * YV_TINY_DAY_FONT, XmRImmediate, (XtPointer)cour12PtFont},
...
static XtResource avDefaultResources[] = {
    {"avpTitleFont", "PrintTitleFont", XmRString, sizeof(String),
     sizeof(String) * AV_TITLE_FONT, XmRImmediate, (XtPointer)bold16PtFont},
    {"avpHeaderFont", "PrintHeaderFont", XmRString, sizeof(String),
     sizeof(String) * AV_HEADER_FONT, XmRImmediate, (XtPointer)bold9PtFont},
    {"avpApptFont", "PrintApptFont", XmRString, sizeof(String),
     sizeof(String) * AV_APPT_FONT, XmRImmediate, (XtPointer)helv10PtFont},
    {"avpItemFont", "PrintItemFont", XmRString, sizeof(String),
     sizeof(String) * AV_ITEM_FONT, XmRImmediate, (XtPointer)bold10PtFont},
    ...
    {"avpTinyDayFont", "PrintTinyDayFont", XmRString, sizeof(String),
     sizeof(String) * AV_TINY_DAY_FONT, XmRImmediate, (XtPointer)cour12PtFont},
...
static XtResource tvDefaultResources[] = {
    {"tvpTitleFont", "PrintTitleFont", XmRString, sizeof(String),
     sizeof(String) * TV_TITLE_FONT, XmRImmediate, (XtPointer)bold16PtFont},
    {"tvpHeaderFont", "PrintHeaderFont", XmRString, sizeof(String),
     sizeof(String) * TV_HEADER_FONT, XmRImmediate, (XtPointer)bold9PtFont},
    {"tvpApptFont", "PrintApptFont", XmRString, sizeof(String),
     sizeof(String) * TV_APPT_FONT, XmRImmediate, (XtPointer)helv10PtFont},
    {"tvpItemFont", "PrintItemFont", XmRString, sizeof(String),
     sizeof(String) * TV_ITEM_FONT, XmRImmediate, (XtPointer)bold10PtFont},
    ...
    {"tvpTinyDayFont", "PrintTinyDayFont", XmRString, sizeof(String),
     sizeof(String) * TV_TINY_DAY_FONT, XmRImmediate, (XtPointer)cour12PtFont},
...
static XtResource displayResources[] = {
    {"lightGrayPixel", "LightGrayPixel", XmRPixel, sizeof(Pixel),
     XtOffsetOf(PrintResources, lightGrayPixel), XmRString, "yellow"},
    {"darkGrayPixel", "DarkGrayPixel", XmRPixel, sizeof(Pixel),
     XtOffsetOf(PrintResources, darkGrayPixel), XmRString, "red"}};
...
static void cm_print_header_string(CMGraphicsInfo *, Props_op, char *, char *,
                                   char *, char *);
...
static void cm_week_sched_update(CMGraphicsInfo *, Dtcm_appointment *, Props *);
...
static void cm_print_todo_text(CMGraphicsInfo *, char *, CSA_sint32, CSA_sint32,
                               int);
static int cm_tiny_month_height(CMGraphicsInfo *, int);
static void cm_print_todo_months(CMGraphicsInfo *, time_t);
static int cm_count_appts(CMGraphicsInfo *, CSA_entry_handle *, int, CSA_sint32,
                          int);
static void cm_get_todo_lines_per_page(CMGraphicsInfo *, CSA_sint32, int *,
                                       int *);
...
static void cm_std_month_dates(CMGraphicsInfo *, int, int, int, int, int, int,
                               int);
...
static void tmpFn(Widget w, XtPointer uData, XtPointer cbData) {
...
static void x_print_string(CMGraphicsInfo *gInfo, char *str, int x, int y,
                           int flags) {
        ...
        nargs = 0;
        XtSetArg(args[nargs], XmNstringDirection, &xmStringDirection);
        nargs++;
        XtGetValues(w, args, nargs);

        if ((gInfo->nFonts == 0) || (gInfo->curFont == (CMFontInfo *)NULL)) {
                nargs = 0;
                XtSetArg(args[nargs], XmNlabelFontList, &fontList);
                nargs++;
        ...
        XmStringDraw(XtDisplay(w), XtWindow(w), fontList, xmString, gc, textX,
                     textY, textWd, XmALIGNMENT_BEGINNING, xmStringDirection,
                     NULL);
        XmStringFree(xmString);
}

static void x_fill_light_box(CMGraphicsInfo *gInfo, int x1, int y1, int x2,
                             int y2, int lineWidth) {
#ifdef GR_DEBUG
        Widget w = gInfo->drawingArea;
        GC gc = gInfo->gc;
        int fillX, fillY;
        ...
        fillWd = x2 - x1 + 1;
        fillHt = y2 - y1 + 1;
        XFillRectangle(XtDisplay(w), XtWindow(w), gc, fillX, fillY, fillWd,
                       fillHt);
        ...
        if (gInfo->lightPixmap == None) {
                ...
                nargs = 0;
                XtSetArg(args[nargs], XmNdepth, &depth);
                nargs++;
                XtGetValues(w, args, nargs);

                gInfo->lightPixmap = XCreatePixmapFromBitmapData(
                    XtDisplay(w), XtWindow(w), lightStippleData, lightStippleWd,
                    lightStippleHt, fg, bg, depth);
        }
...
static void x_fill_dark_box(CMGraphicsInfo *gInfo, int x1, int y1, int x2,
                            int y2, int lineWidth) {
#ifdef GR_DEBUG
        Widget w = gInfo->drawingArea;
        GC gc = gInfo->gc;
        ...
        if (gInfo->darkPixmap == None) {
                ...
                gInfo->darkPixmap = XCreatePixmapFromBitmapData(
                    XtDisplay(w), XtWindow(w), darkStippleData, darkStippleWd,
                    darkStippleHt, fg, bg, depth);
        }
...
static void x_fill_black_box(CMGraphicsInfo *gInfo, int x1, int y1, int x2,
                             int y2) {
        x_fill_box(gInfo, x1, y1, x2, y2, None, 0);
}

static void x_fill_box(CMGraphicsInfo *gInfo, int x1, int y1, int x2, int y2,
                       Pixmap stipple, int lineWidth) {
        Widget w = gInfo->drawingArea;
        GC gc = gInfo->gc;
        int fillX, fillY;
        int fillWd, fillHt;
...
static void x_draw_box(CMGraphicsInfo *gInfo, int x1, int y1, int x2, int y2,
                       int lineWidth) {
        Widget w = gInfo->drawingArea;
        GC gc = gInfo->gc;
...
#ifdef NEVER
        /* X centers thick lines; we want them wholly within specified
         * rectangle. */
        if (lineWidth > 1) {
...
static void x_draw_line(CMGraphicsInfo *gInfo, int x1, int y1, int x2, int y2,
                        int lineWidth) {
        Widget w = gInfo->drawingArea;
        GC gc = gInfo->gc;
        XGCValues newGCValues;
...
static void x_set_clip_box(CMGraphicsInfo *gInfo, int x1, int y1, int x2,
                           int y2) {
        XRectangle rect;
        Widget w = gInfo->drawingArea;
...
static void x_unset_clip_box(CMGraphicsInfo *gInfo) {
        Widget w = gInfo->drawingArea;

        XSetClipMask(XtDisplay(w), gInfo->gc, None);
}

static Boolean x_load_font(CMGraphicsInfo *gInfo, CMFontInfo *fInfo,
                           char *fontPattern) {
        Widget w = gInfo->drawingArea;
        XrmValue fromValue;
        XrmValue toValue;
...
static Boolean cm_load_font(CMGraphicsInfo *gInfo, CMFontEnum fontEnum,
                            char *fontPattern) {
        int i;
        ...
        fInfo = (CMFontInfo *)XtRealloc(
            (char *)gInfo->fontInfo, sizeof(CMFontInfo) * (gInfo->nFonts + 1));
        if (fInfo == (CMFontInfo *)NULL)
                return False;
...
static void cm_load_font_error(CMGraphicsInfo *gInfo, char *fontPattern) {
        Calendar *c = gInfo->c;
        ...
        errFmt =
            catgets(c->DT_catd, 1, 1119, "Warning - Unable to load font %s.");
        ...
        title = XtNewString(
            catgets(c->DT_catd, 1, 1118, "Calendar : Warning - Print"));

        dialog_popup(c->frame, DIALOG_TITLE, title, DIALOG_TEXT, errText,
                     BUTTON_IDENT, 1, label, DIALOG_IMAGE,
...
static void cm_release_fonts(CMGraphicsInfo *gInfo) {
        XtFree((char *)gInfo->fontInfo);
        gInfo->fontInfo = (CMFontInfo *)NULL;
        gInfo->nFonts = 0;
}

static Boolean cm_set_font(CMGraphicsInfo *gInfo, CMFontEnum fontEnum) {
        CMFontInfo *fInfo;

        if ((gInfo->curFont == (CMFontInfo *)NULL) ||
            (gInfo->curFont->fontEnum != fontEnum)) {
                if ((fInfo = cm_find_font(gInfo, fontEnum)) ==
                    (CMFontInfo *)NULL)
                        return False;
...
static CMFontInfo *cm_find_font(CMGraphicsInfo *gInfo, CMFontEnum fontEnum) {
        int i;
...
static void cm_font_extents(CMGraphicsInfo *gInfo, CMFontInfo *fInfo, int *wd,
                            int *ht) {
        int maxHt = 0;
        int maxWd = 0;
        ...
        if ((gInfo != (CMGraphicsInfo *)NULL) &&
            (fInfo != (CMFontInfo *)NULL)) {
                ...
                if (XmFontListInitFontContext(&fontContext, fInfo->fontList)) {
                        ...
                        while ((fontListEntry = XmFontListNextEntry(
                                    fontContext)) != (XmFontListEntry)NULL) {
                                fontEntryFont = XmFontListEntryGetFont(
                                    fontListEntry, &fontType);
                                if (fontType == XmFONT_IS_FONT) {
                                        fontStruct =
                                            (XFontStruct *)fontEntryFont;
                                        thisWd =
                                            fontStruct->max_bounds.rbearing -
                                            fontStruct->min_bounds.lbearing;
                                        thisHt = fontStruct->ascent +
                                                 fontStruct->descent;
                                } else if (fontType == XmFONT_IS_FONTSET) {
                                        fontSet = (XFontSet)fontEntryFont;
                                        fontSetExtents =
                                            XExtentsOfFontSet(fontSet);
                                        thisWd = fontSetExtents
                                                     ->max_logical_extent.width;
                                        thisHt =
                                            fontSetExtents->max_logical_extent
                                                .height;
                                } else
                                        continue;
...
static int cm_font_height(CMGraphicsInfo *gInfo, CMFontInfo *fInfo) {
        int wd, ht;
...
static int cm_font_width(CMGraphicsInfo *gInfo, CMFontInfo *fInfo) {
        int wd, ht;
...
static int cm_string_width(CMGraphicsInfo *gInfo, CMFontInfo *fInfo,
                           char *str) {
        if ((gInfo != (CMGraphicsInfo *)NULL) &&
            (fInfo != (CMFontInfo *)NULL) && (str != (char *)NULL)) {
                XmString xmStr;
                Dimension textWd;
                Dimension textHt;
...
static void cm_reverse_video(CMGraphicsInfo *gInfo, Boolean enabled) {
...
static CMFontEnum cm_get_title_enum(CMGraphicsInfo *gInfo) {
...
static CMFontEnum cm_get_header_enum(CMGraphicsInfo *gInfo) {
        switch (gInfo->reportType) {
        case PR_DAY_VIEW:
...
static CMFontEnum cm_get_tiny_title_enum(CMGraphicsInfo *gInfo) {
        switch (gInfo->reportType) {
        default:
        case PR_MONTH_VIEW:
...
static CMFontEnum cm_get_tiny_day_enum(CMGraphicsInfo *gInfo) {
        switch (gInfo->reportType) {
        default:
        case PR_MONTH_VIEW:
...
static CMFontEnum cm_get_tiny_date_enum(CMGraphicsInfo *gInfo) {
        switch (gInfo->reportType) {
        default:
        case PR_MONTH_VIEW:
...
static void cm_adjust_margins(CMGraphicsInfo *gInfo) {
        CMFontInfo *fInfo;
        ...
        if ((fInfo = cm_find_font(gInfo, headerFont)) != (CMFontInfo *)NULL)
                gInfo->bottomMarginY -=
                    VMARGIN(gInfo) + cm_font_height(gInfo, fInfo);
}

static int cm_cvt_margin(CMGraphicsInfo *gInfo, Props_op prop, int defaultVal) {
        Widget w = gInfo->drawingArea;
        ...
        returnVal = XmConvertStringToUnits(XtScreen(w), get_char_prop(p, prop),
                                           XmHORIZONTAL, XmPIXELS, &badCvt);

        return badCvt ? defaultVal : returnVal;
}

static void cm_print_time(CMGraphicsInfo *gInfo, char *str, Glance view) {
        cm_print_text(gInfo, str, (view == dayGlance) ? 0 : 2, view);
}

static void cm_print_appt_text(CMGraphicsInfo *gInfo, char *str, int indentAmt,
                               Glance view) {
        char *to = NULL;
...
static void cm_print_text(CMGraphicsInfo *gInfo, char *str, int indentAmt,
                          Glance view) {
        int textX, textY;
        int clipX1, clipX2;
        ...
        case dayGlance:
                ...
                if (gInfo->u.dayInfo.line1 +
                        cm_font_height(gInfo, gInfo->curFont) +
                        VMARGIN(gInfo) <=
                    gInfo->u.dayInfo.curY1 - (gInfo->normalWd / 2)) {
                        textX =
        ...
        case weekGlance:
                ...
                /* Make sure the text fits in the box. */
                if (gInfo->u.weekInfo.lineY +
                        cm_font_height(gInfo, gInfo->curFont) +
                        VMARGIN(gInfo) <=
                    gInfo->u.weekInfo.lineMaxY - (gInfo->thickWd / 2)) {
                        textX =
                            gInfo->u.weekInfo.lineX + (gInfo->normalWd / 2) +
                            HMARGIN(gInfo) +
                            (indentAmt * cm_font_width(gInfo, gInfo->curFont));
        ...
        if (clipX2 > clipX1) {
                x_set_clip_box(gInfo, clipX1, gInfo->topMarginY, clipX2,
                               gInfo->bottomMarginY - 1);
                x_print_string(gInfo, str, textX, textY, LEFT_AT_X | TOP_AT_Y);
                x_unset_clip_box(gInfo);
        }
}

static void cm_week_sched_update(CMGraphicsInfo *gInfo, Dtcm_appointment *appt,
                                 Props *p) {
        /*
        ...
        if (appt->end_time)
                _csa_iso8601_to_tick(
                    appt->end_time->value->item.date_time_value, &end_tick);
...
static int cm_week_sched_box_indent(CMGraphicsInfo *gInfo) {
...
static void cm_set_todo_text_clipping(CMGraphicsInfo *gInfo) {
        x_set_clip_box(gInfo, gInfo->u.toDoInfo.innerX1,
                       gInfo->u.toDoInfo.innerY1,
                       gInfo->u.toDoInfo.boxX2 - ((gInfo->thickWd / 2) + 1) -
                           HMARGIN(gInfo),
                       gInfo->u.toDoInfo.boxY2 - ((gInfo->thickWd / 2) + 1));
}

static void cm_unset_todo_text_clipping(CMGraphicsInfo *gInfo) {
        x_unset_clip_box(gInfo);
}

static void cm_print_todo_text(CMGraphicsInfo *gInfo, char *str1, CSA_sint32 as,
        ...
        for (i = 0; i <= 9; i++) {
                snprintf(buf, 20, "%d", i);
                if ((digitWd = cm_string_width(gInfo, gInfo->curFont, buf)) >
                    maxDigitWd)
                        maxDigitWd = digitWd;
        }
        ...
        x_print_string(gInfo, buf, textX, textY, RIGHT_AT_X | TOP_AT_Y);
        ...
        if (isTodo) {
                /* draw check box */
                x_draw_box(gInfo, textX + (gInfo->normalWd / 2) + 1,
                ...
                if (as == CSA_STATUS_COMPLETED) {
                        x_draw_line(gInfo, textX + (fontHt / 4),
                                    textY + (fontHt / 2), textX + (fontHt / 2),
                                    textY + fontHt -
                                        ((gInfo->normalWd + 3) / 2),
                                    gInfo->normalWd);
                        x_draw_line(
                            gInfo, textX + (fontHt / 2),
                            textY + fontHt - ((gInfo->normalWd + 3) / 2),
                            textX + ((5 * fontHt) / 4),
                            textY + (gInfo->normalWd / 2) + 1, gInfo->normalWd);
                }
...
static int cm_tiny_month_height(CMGraphicsInfo *gInfo, int spacing) {
        int monthBoxHt;
        CMFontInfo *fInfo;
...
static void cm_print_todo_months(CMGraphicsInfo *gInfo, time_t end_time) {
        ...
        if ((mon - 1) == 0)
                x_print_month((void *)gInfo, 12, yr - 1, x1 + tlOff, y1 + tlOff,
                              x2 - brOff, y2 - brOff, VMARGIN(gInfo));
        else
                x_print_month((void *)gInfo, mon - 1, yr, x1 + tlOff,
                              y1 + tlOff, x2 - brOff, y2 - brOff,
                              VMARGIN(gInfo));

        x1 = x2;
        x2 = gInfo->u.toDoInfo.boxX1 + ((2 * monthBoxWd) / 3);
        x_draw_line(gInfo, x2, y1, x2, y2, gInfo->thickWd);
        x_print_month((void *)gInfo, mon, yr, x1 + tlOff, y1 + tlOff,
                      x2 - brOff, y2 - brOff, VMARGIN(gInfo));

        x1 = x2;
        x2 = lastX;
        if ((mon + 1) > 12)
                x_print_month((void *)gInfo, 1, yr + 1, x1 + tlOff, y1 + tlOff,
                              x2 - brOff, y2 - brOff, VMARGIN(gInfo));
        else
                x_print_month((void *)gInfo, mon + 1, yr, x1 + tlOff,
                              y1 + tlOff, x2 - brOff, y2 - brOff,
...
static int cm_count_appts(CMGraphicsInfo *gInfo, CSA_entry_handle *list,
                          int a_total, CSA_sint32 appt_type, int vf) {
        int i, meoval;
        boolean_t skip_appt;
        ...
        appt = allocate_appt_struct(
            appt_read, c->general->version, CSA_ENTRY_ATTR_CLASSIFICATION_I,
            CSA_ENTRY_ATTR_TYPE_I, CSA_ENTRY_ATTR_STATUS_I,
            CSA_ENTRY_ATTR_START_DATE_I, CSA_ENTRY_ATTR_SUMMARY_I,
...
static void cm_get_todo_lines_per_page(CMGraphicsInfo *gInfo,
                                       CSA_sint32 apptType, int *linesFullPageP,
                                       int *linesPartialPageP) {
        CMFontInfo *fInfo = cm_find_font(
            gInfo, (apptType == CSA_TYPE_TODO) ? TV_APPT_FONT : AV_APPT_FONT);
        ...
        *linesFullPageP = (gInfo->u.toDoInfo.boxY2 - gInfo->u.toDoInfo.innerY1 -
                          ...
                          fontHt;
        *linesPartialPageP =
            (gInfo->u.toDoInfo.innerY2 - gInfo->u.toDoInfo.innerY1 -
             gInfo->thickWd - (2 * VMARGIN(gInfo))) /
            fontHt;
}

static void cm_todo_outline(CMGraphicsInfo *gInfo, Boolean lastPage) {
        x_fill_dark_box(gInfo, gInfo->u.toDoInfo.outerX1,
                        gInfo->u.toDoInfo.outerY1, gInfo->u.toDoInfo.outerX2,
                        gInfo->u.toDoInfo.outerY2, gInfo->thickWd);

        if (lastPage) {
                /* Appts box. */
                x_fill_light_box(gInfo, gInfo->u.toDoInfo.innerX1,
                                 gInfo->u.toDoInfo.innerY1,
                                 gInfo->u.toDoInfo.innerX2,
                                 gInfo->u.toDoInfo.innerY2, gInfo->thickWd);

                /* Months box. */
                x_fill_light_box(gInfo, gInfo->u.toDoInfo.boxX1,
                                 gInfo->u.toDoInfo.boxY1,
                                 gInfo->u.toDoInfo.boxX2,
                                 gInfo->u.toDoInfo.boxY2, gInfo->thickWd);
        } else {
                /* Appts box. */
                x_fill_light_box(gInfo, gInfo->u.toDoInfo.innerX1,
                                 gInfo->u.toDoInfo.innerY1,
...
static void cm_print_month_time(CMGraphicsInfo *gInfo, char *str) {
        int textX, textY;
        int clipX1, clipX2;
        ...
        if (gInfo->u.monthInfo.lineY + cm_font_height(gInfo, gInfo->curFont) +
                VMARGIN(gInfo) <=
            gInfo->u.monthInfo.lineMaxY - (gInfo->normalWd / 2)) {
                /* Time is right-justified. */
                textX = gInfo->u.monthInfo.lineX + (gInfo->normalWd / 2) +
                        HMARGIN(gInfo) +
                        cm_string_width(gInfo, gInfo->curFont, baselineTime);
                gInfo->u.monthInfo.lastX = textX;
                textY = gInfo->u.monthInfo.lineY;
                clipX1 = gInfo->u.monthInfo.lineX + (gInfo->normalWd / 2) +
                         HMARGIN(gInfo);
                clipX2 = gInfo->u.monthInfo.lineMaxX - (gInfo->normalWd / 2) -
                         HMARGIN(gInfo);

                if (clipX2 > clipX1) {
                        x_set_clip_box(gInfo, clipX1, gInfo->u.monthInfo.lineY,
                                       clipX2, gInfo->u.monthInfo.lineMaxY);
                        x_print_string(gInfo, str, textX, textY,
                                       RIGHT_AT_X | TOP_AT_Y);
                        x_unset_clip_box(gInfo);
                }
        }
...
static void cm_print_month_text(CMGraphicsInfo *gInfo, char *str,
                                int indentAmt) {
        int textX, textY;
        int clipX1, clipX2;
        ...
        if (gInfo->u.monthInfo.lineY + cm_font_height(gInfo, gInfo->curFont) +
                VMARGIN(gInfo) <=
            gInfo->u.monthInfo.lineMaxY - (gInfo->normalWd / 2)) {
                textX = gInfo->u.monthInfo.lastX + (gInfo->normalWd / 2) +
                        HMARGIN(gInfo);
                textY = gInfo->u.monthInfo.lineY;
                clipX1 = textX;
                clipX2 = gInfo->u.monthInfo.lineMaxX - (gInfo->normalWd / 2) -
...
static void cm_std_month_weekdays(CMGraphicsInfo *gInfo, int colWd, int x1,
                                  int y1, int x2) {
...
static void cm_std_month_dates(CMGraphicsInfo *gInfo, int first_dom, int monlen,
        ...
        for (i = 0; i < monlen; i++, first_dom++) {
                ...
                dateX = x1 + (indent * colWd) +
                        ((indent * extraWd) / (DAYS_IN_WEEK + 1));
                dateY = y1 + ((first_dom / DAYS_IN_WEEK) * (spacing + fontHt));
                snprintf(dateStr, 3, "%d", i + 1);
                x_print_string(gInfo, dateStr, dateX, dateY,
                               RIGHT_AT_X | TOP_AT_Y);
        }
}

static void cm_print_header_string(CMGraphicsInfo *gInfo, Props_op printOp,
                                   char *timeStamp, char *userId, char *pageStr,
                                   char *reportTypeStr) {
        Props *p = (Props *)gInfo->c->properties;
...
static void local_dayname(Calendar *c, char **array_place, int dayNum) {
        char *source;
        char *str;
        char *to = NULL;
        unsigned long to_len = 0;
        unsigned long _len;
        static char *defaultDays[DAYS_IN_WEEK] = {"S", "M", "T", "W",
                                                  "T", "F", "S"};
        static int dayCatIndex[DAYS_IN_WEEK] = {497, 491, 492, 493,
                                                494, 495, 496};

        source =
            catgets(c->DT_catd, 1, dayCatIndex[dayNum], defaultDays[dayNum]);
...
static void local_dayname3(Calendar *c, char **array_place, int dayNum) {
        char *source;
        char *str;
        char *to = NULL;
        unsigned long to_len = 0;
        unsigned long _len;
        static char *defaultDays[DAYS_IN_WEEK] = {"Sun", "Mon", "Tue", "Wed",
                                                  "Thu", "Fri", "Sat"};
        static int dayCatIndex[DAYS_IN_WEEK] = {480, 481, 482, 483,
                                                484, 485, 486};
...
static char *get_report_type_string(CMGraphicsInfo *gInfo) {
        Calendar *c = gInfo->c;
        int reportType = gInfo->reportType;
        static char *defaultStrs[] = {
            "Day view by Calendar Manager",   "Week view by Calendar Manager",
            "Month view by Calendar Manager", "Year view by Calendar Manager",
            "Appt List by Calendar Manager",  "To Do List by Calendar Manager"};
        static int catIndex[] = {469, 490, 477, 507, 474, 473};
        static char *reportStrs[] = {NULL, NULL, NULL, NULL, NULL, NULL};
...
static void filePrintReportStatus(Calendar *c, Boolean ok) {
        Props_pu *pu = (Props_pu *)c->properties_pu;
        char *errText;
        char *title;
        char *label;
        ...
        label = XtNewString(catgets(c->DT_catd, 1, 95, "Continue"));
        if (!ok) {
                errText = XtNewString(catgets(
                    c->DT_catd, 1, 1115, "Error - unable to print to file."));
                title = XtNewString(catgets(
                    c->DT_catd, 1, 1114, "Calendar : Error - Print To File"));
                pixmap = pu->xm_error_pixmap;
        } else {
                errText = XtNewString(catgets(c->DT_catd, 1, 1117,
                                              "Print to file has completed."));
                title = XtNewString(
                    catgets(c->DT_catd, 1, 1116, "Calendar : Print To File"));
                pixmap = pu->xm_info_pixmap;
        }

        dialog_popup(c->frame, DIALOG_TITLE, title, DIALOG_TEXT, errText,
                     BUTTON_IDENT, 1, label, DIALOG_IMAGE, pixmap, NULL);
...
static void showBadAllocError(Calendar *c) {
        Props_pu *pu = (Props_pu *)c->properties_pu;
        char *errText;
        char *title;
        char *label;
        ...
        label = XtNewString(catgets(c->DT_catd, 1, 95, "Continue"));
        errText =
            XtNewString(catgets(c->DT_catd, 1, 1122, "Print job failed.\n\n\
The X Print Server is temporarily out of resources."));
        title = XtNewString(
            catgets(c->DT_catd, 1, 1121, "Calendar : Print Server Error"));
        pixmap = pu->xm_error_pixmap;
...
void *x_open_file(Calendar *c) {
        ...
        Arg args[10];
        int nargs;
        unsigned int gcMask = GCFont | GCForeground | GCBackground | GCTile |
        ...
        if (getResources) {
                XtGetApplicationResources(
                    c->frame, (XtPointer)&dvFonts, dvDefaultResources,
                    XtNumber(dvDefaultResources), NULL, 0);
                XtGetApplicationResources(
                    c->frame, (XtPointer)&wvFonts, wvDefaultResources,
                    XtNumber(wvDefaultResources), NULL, 0);
                XtGetApplicationResources(
                    c->frame, (XtPointer)&mvFonts, mvDefaultResources,
                    XtNumber(mvDefaultResources), NULL, 0);
                XtGetApplicationResources(
                    c->frame, (XtPointer)&yvFonts, yvDefaultResources,
                    XtNumber(yvDefaultResources), NULL, 0);
                XtGetApplicationResources(
                    c->frame, (XtPointer)&avFonts, avDefaultResources,
                    XtNumber(avDefaultResources), NULL, 0);
                XtGetApplicationResources(
                    c->frame, (XtPointer)&tvFonts, tvDefaultResources,
                    XtNumber(tvDefaultResources), NULL, 0);
                getResources = False;
        }
  ...
  if (!inDebugMode(c))
  {
    ...
    else
    {
      XpStartJob(XtDisplay(printShell), XPSpool);
        ...
        nargs = 0;
#ifdef SHELL_SIZE_BUG
        XtSetArg(args[nargs], XmNwidth, &shellWd);
        nargs++;
        XtSetArg(args[nargs], XmNheight, &shellHt);
        nargs++;
#endif /* SHELL_SIZE_BUG */
        XtSetArg(args[nargs], XmNchildren, &shellChildren);
        nargs++;
        ...
        if ((shellWd < 10) || (shellHt < 10)) {
                shellWd = XmConvertUnits(printShell, XmHORIZONTAL,
                                         Xm1000TH_INCHES, PAGE_WIDTH, XmPIXELS);
                shellHt =
                    XmConvertUnits(printShell, XmVERTICAL, Xm1000TH_INCHES,
        ...
        if (nChildren == 0) {
                nargs = 0;
                XtSetArg(args[nargs], XmNunitType, XmPIXELS);
                nargs++;
#ifdef GR_DEBUG
                if (!inDebugMode(c)) {
#endif
                        XtSetArg(args[nargs], XmNbackground,
                                 WhitePixelOfScreen(XtScreen(printShell)));
                        nargs++;
#ifdef GR_DEBUG
                }
#endif
                drawingArea =
                    XmCreateDrawingArea(printShell, "PrintArea", args, nargs);
        } else
                drawingArea = shellChildren[0];

#ifdef GR_DEBUG
        if (inDebugMode(c))
                XtAddCallback(drawingArea, XmNinputCallback, tmpFn,
                              (XtPointer)NULL);
#endif
...
#ifdef GR_DEBUG
        nargs = 0;
        XtSetArg(args[nargs], XmNforeground, &(gInfo->fg));
        nargs++;
        XtSetArg(args[nargs], XmNbackground, &(gInfo->bg));
        nargs++;
...
void x_print_file(void *gInfoP, Calendar *c) {
    ...
    XpEndJob(dsp);
        ...
        if (pd_get_bad_alloc_error(c) && (!pd_print_to_file(c))) {
                showBadAllocError(c);
                pd_set_bad_alloc_error(c, False);
        }
...
void x_init_printer(void *gInfoP, short orientation) {
        CMGraphicsInfo *gInfo = (CMGraphicsInfo *)gInfoP;
        Widget w = gInfo->drawingArea;
        Arg args[10];
        int nargs;
  ...
  if (inDebugMode(gInfo->c))
  {
    ...
    XpStartPage(XtDisplay(w), XtWindow(XtParent(w)));
        ...
        nargs = 0;
        XtSetArg(args[nargs], XmNwidth, &daWd);
        nargs++;
        XtSetArg(args[nargs], XmNheight, &daHt);
        nargs++;
        XtGetValues(XtParent(w), args, nargs);
        ...
        if (inDebugMode(gInfo->c)) {
                ...
                XtRemoveCallback(w, XmNexposeCallback, tmpFn, (XtPointer)NULL);
        ...
        inchWd =
            XmConvertUnits(w, XmHORIZONTAL, Xm1000TH_INCHES, XINCH, XmPIXELS);
        ...
        pageWd =
            XmConvertUnits(w, XmHORIZONTAL, XmPIXELS, daWd, Xm1000TH_INCHES);
        pageHt = XmConvertUnits(w, XmVERTICAL, XmPIXELS, daHt, Xm1000TH_INCHES);
        ...
        gInfo->thinWd =
            XmConvertUnits(w, XmHORIZONTAL, Xm100TH_POINTS, 25, XmPIXELS);
        if (gInfo->thinWd < 1)
                gInfo->thinWd = 1;
        gInfo->normalWd =
            XmConvertUnits(w, XmHORIZONTAL, Xm100TH_POINTS, 100, XmPIXELS);
        if (gInfo->normalWd < 1)
                gInfo->normalWd = 1;
        gInfo->thickWd =
            XmConvertUnits(w, XmHORIZONTAL, Xm100TH_POINTS, 200, XmPIXELS);
        if (gInfo->thickWd < 1)
                gInfo->thickWd = 1;
}

void x_init_day(void *gInfoP, int timeslots) {
        CMGraphicsInfo *gInfo = (CMGraphicsInfo *)gInfoP;
        CMFontInfo *fInfo;
        ...
        gInfo->u.dayInfo.tab1 =
            (cm_font_height(gInfo, fInfo) * 2) + gInfo->normalWd;
        ...
        gInfo->u.dayInfo.curY1 = gInfo->topMarginY + (gInfo->normalWd / 2) +
...
int x_get_day_lines_per_page(void *gInfoP) {
        CMGraphicsInfo *gInfo = (CMGraphicsInfo *)gInfoP;
        CMFontInfo *fInfo = cm_find_font(gInfo, DV_APPT_FONT);

        return (gInfo->u.dayInfo.boxHt - gInfo->normalWd -
                (2 * VMARGIN(gInfo))) /
               cm_font_height(gInfo, fInfo);
}

int x_get_week_lines_per_page(void *gInfoP) {
        CMGraphicsInfo *gInfo = (CMGraphicsInfo *)gInfoP;
        CMFontInfo *fInfo = cm_find_font(gInfo, DV_APPT_FONT);

        return (gInfo->u.weekInfo.boxHt - gInfo->u.weekInfo.tab1 -
                ((gInfo->normalWd + 1) / 2) - (gInfo->thickWd / 2) -
                (2 * VMARGIN(gInfo))) /
               cm_font_height(gInfo, fInfo);
}

void x_print_header(void *gInfoP, char *buf, int pageNum, int numPages) {
        CMGraphicsInfo *gInfo = (CMGraphicsInfo *)gInfoP;
        Calendar *c = gInfo->c;
        char *str;
        ...
        if (buf != (char *)NULL) {
                ...
                x_print_string(gInfo, str,
                               ...
                               gInfo->topMarginY, CENTER_AT_X | BOTTOM_AT_Y);
        }
        ...
        snprintf(pageStr, BUFFERSIZE, "%s %d %s %d", str2, pageNum, str,
                 numPages);

        /* Header/footer strings are all set - print 'em! */
        cm_print_header_string(gInfo, CP_PRINTLHEADER, timeStamp, userId,
                               pageStr, reportTypeStr);
        cm_print_header_string(gInfo, CP_PRINTRHEADER, timeStamp, userId,
                               pageStr, reportTypeStr);
        cm_print_header_string(gInfo, CP_PRINTLFOOTER, timeStamp, userId,
                               pageStr, reportTypeStr);
        cm_print_header_string(gInfo, CP_PRINTRFOOTER, timeStamp, userId,
                               pageStr, reportTypeStr);
}

void x_day_header(void *gInfoP) {
        CMGraphicsInfo *gInfo = (CMGraphicsInfo *)gInfoP;
        CMFontInfo *fInfo;
        char *str;
        Calendar *c = gInfo->c;
        ...
        fInfo = cm_find_font(gInfo, DV_HEADER_FONT);
        dayBoxVOffset = (gInfo->normalWd / 2) + cm_font_height(gInfo, fInfo) +
                        VMARGIN(gInfo);
        ...
        x_fill_light_box(
            gInfo, gInfo->u.dayInfo.curX1, gInfo->topMarginY + dayBoxVOffset,
        ...
        x_fill_dark_box(gInfo, midX, gInfo->topMarginY + dayBoxVOffset,
        ...
        x_print_string(
            ...
            gInfo->topMarginY + dayBoxVOffset + (gInfo->u.dayInfo.tab1 / 2),
...
void x_day_timeslots(void *gInfoP, int i, Boolean more) {
        CMGraphicsInfo *gInfo = (CMGraphicsInfo *)gInfoP;
        ...
        snprintf(modbuf, 6, "%s",
                 morning(i) ? catgets(c->DT_catd, 1, 4, "am")
        ...
        if (i == 12) {
                 ...
                 */
                gInfo->u.dayInfo.boxWd = gInfo->rightMarginX -
                                         ((gInfo->normalWd + 1) / 2) -
        ...
        x_draw_box(gInfo, gInfo->u.dayInfo.curX1, gInfo->u.dayInfo.curY1,
                   ...
                   gInfo->normalWd);
        x_fill_light_box(gInfo, gInfo->u.dayInfo.curX1, gInfo->u.dayInfo.curY1,
                         gInfo->u.dayInfo.curX1 + gInfo->u.dayInfo.tab1,
                         gInfo->u.dayInfo.curY1 + gInfo->u.dayInfo.boxHt,
                         gInfo->normalWd);
...
Boolean x_print_multi_appts(void *gInfoP, CSA_entry_handle *list, int a_total,
                            int num_page, Glance view) {
        /*
        ...
        for (j = 0; j < a_total; j++) {
                ...
                if (lines != NULL && lines->s != NULL) {
                        ...
                        while (lines != NULL) {
                                ...
                                cm_print_appt_text(gInfo, lines->s, indentAmt,
                                                   view);
                                lines = lines->next;
                        }
                }
...
void x_finish_printer(void *gInfoP) {
        CMGraphicsInfo *gInfo = (CMGraphicsInfo *)gInfoP;
        Widget w = gInfo->drawingArea;
...
void x_print_list_range(Calendar *c, CSA_sint32 appt_type, int item_data,
        ...
        if (appt_type == CSA_TYPE_TODO)
                snprintf(
                    buf, MAXNAMELEN,
                    catgets(c->DT_catd, 1, 899, "To Do List Beginning: %s"),
                    buf2);
        else
                snprintf(buf, MAXNAMELEN,
                         catgets(c->DT_catd, 1, 900, "Appt List Beginning: %s"),
                         buf2);

        setup_range(&range_attrs, &ops, &i, start, end, appt_type, 0, B_FALSE,
                    c->general->version);
        stat = csa_list_entries(c->cal_handle, i, range_attrs, ops, &a_total,
                                &list, NULL);
        if (stat != CSA_SUCCESS) {
                return;
        }

        x_print_todo(xp, list, a_total, appt_type, (start_tick != end_tick),
                     todo_view, end, buf);
...
void x_init_list(void *gInfoP) {
        ...
        gInfo->u.toDoInfo.boxY1 = gInfo->u.toDoInfo.boxY2 -
                                  cm_tiny_month_height(gInfo, VMARGIN(gInfo)) -
                                  gInfo->thickWd;
        gInfo->u.toDoInfo.innerX2 = gInfo->u.toDoInfo.boxX2;
        gInfo->u.toDoInfo.innerY2 = gInfo->u.toDoInfo.boxY1 - vIndent;

        gInfo->u.toDoInfo.lineX = gInfo->u.toDoInfo.innerX1 +
                                  ((gInfo->thickWd + 1) / 2) + HMARGIN(gInfo);
        gInfo->u.toDoInfo.lineY = gInfo->u.toDoInfo.innerY1 +
                                  ((gInfo->thickWd + 1) / 2) + VMARGIN(gInfo);
}

void x_print_todo(void *gInfoP, CSA_entry_handle *list, int a_total,
        ...
        for (numPages = 1, numAppts -= linesPartialPage; numAppts > 0;
             numPages++)
...
void x_print_month(void *gInfoP, int mon, int yr, int x1, int y1, int x2,
                   int y2, int spacing) {
        CMGraphicsInfo *gInfo = (CMGraphicsInfo *)gInfoP;
        CMFontInfo *fInfo;
        ...
        x_fill_light_box(gInfo, x1 + HMARGIN(gInfo), y1, x2 - HMARGIN(gInfo),
                         y1 + cm_font_height(gInfo, gInfo->curFont), 0);
        x_print_string(gInfo, str, (x1 + x2) / 2, y1, CENTER_AT_X | TOP_AT_Y);
        ...
        cm_std_month_dates(gInfo, fdom(j), monLen, colWd, x1, y1, x2, spacing);

        x_unset_clip_box(gInfo);
}

void x_init_std_year(void *gInfoP) {
        CMGraphicsInfo *gInfo = (CMGraphicsInfo *)gInfoP;
        CMFontInfo *fInfo;
...
void x_std_year_name(void *gInfoP, int yr) {
        CMGraphicsInfo *gInfo = (CMGraphicsInfo *)gInfoP;
...
void x_print_year(void *gInfoP, int yr) {
        CMGraphicsInfo *gInfo = (CMGraphicsInfo *)gInfoP;
        CMFontInfo *fInfo;
        int i;
        int leftX, topY;
        ...
        topY =
            gInfo->topMarginY + cm_font_height(gInfo, fInfo) + VMARGIN(gInfo);
        ...
        for (i = 0; i < 12; i++) {
                ...
                if (extraSpace > 0) {
                        y1 = topY + (((row + 1) * extraSpace) / 5) +
                             (row * monthHt);
                        y2 = topY + (((row + 2) * extraSpace) / 5) +
                             ((row + 1) * monthHt);
                } else {
                ...
                x_print_month(gInfoP, i + 1, yr, x1, y1, x2, y2,
                              VMARGIN(gInfo));
        }
}

void x_init_week(void *gInfoP) {
        CMGraphicsInfo *gInfo = (CMGraphicsInfo *)gInfoP;
        CMFontInfo *fInfo;
        ...
        gInfo->u.weekInfo.curY1 = gInfo->topMarginY +
                                  cm_font_height(gInfo, fInfo) +
        ...
        gInfo->u.weekInfo.boxHt =
            (gInfo->bottomMarginY - ((gInfo->thickWd + 1) / 2) -
             gInfo->u.weekInfo.curY1) /
            2;
        gInfo->u.weekInfo.curY2 =
            gInfo->u.weekInfo.curY1 + gInfo->u.weekInfo.boxHt;

        fInfo = cm_find_font(gInfo, WV_DAY_FONT);
        gInfo->u.weekInfo.tab1 = ((3 * cm_font_height(gInfo, fInfo)) +
                                  gInfo->thickWd + gInfo->normalWd) /
                                 2;
}

void x_week_appt_boxes(void *gInfoP) {
        CMGraphicsInfo *gInfo = (CMGraphicsInfo *)gInfoP;
        int x1, y1, x2, y2;
        ...
        /* Draw weekends box. */
        x1 = gInfo->u.weekInfo.curX1 +
             (((WEEK_DAYS - WEEKEND_DAYS) * gInfo->u.weekInfo.boxWd) /
              WEEK_DAYS);
        y1 = y2;
        y2 = y1 + gInfo->u.weekInfo.tab1;
        x_fill_light_box(gInfo, x1, y1, x2, y2, gInfo->normalWd);
...
void x_week_sched_boxes(void *gInfoP) {
        CMGraphicsInfo *gInfo = (CMGraphicsInfo *)gInfoP;
        char *day_of_week[DAYS_IN_WEEK];
        ...
        boxY1 = gInfo->u.weekInfo.curY2 +
                (2 * cm_font_height(gInfo, gInfo->curFont)) + gInfo->thickWd;
        ...
        for (i = 0; i < DAYS_IN_WEEK; i++)
                local_dayname(gInfo->c, &day_of_week[i],
                              (i + 1) % DAYS_IN_WEEK);
        ...
        for (i = 0; i < DAYS_IN_WEEK; i++) {
                ...
                x_print_string(gInfo, day_of_week[i], (x1 + x2) / 2,
                               boxY1 - gInfo->thickWd - (2 * VMARGIN(gInfo)),
                               CENTER_AT_X | BOTTOM_AT_Y);
                free(day_of_week[i]);
                if (i > 0)
                        x_draw_line(gInfo, x1, boxY1, x1, boxY2,
                                    gInfo->normalWd);
        }
...
void x_week_daynames(void *gInfoP, char *dayName, int dayIndex, Boolean more) {
        CMGraphicsInfo *gInfo = (CMGraphicsInfo *)gInfoP;
        Calendar *c = gInfo->c;
        int x1, y1, x2, y2;
        ...
        snprintf(dayBuf, BUFFERSIZE, more ? "%s *" : "%s",
                 euc_to_octal(dayName));
        x_print_string(gInfo, dayBuf, (x1 + x2) / 2, (y1 + y2) / 2,
                       CENTER_AT_X | CENTER_AT_Y);

        gInfo->u.weekInfo.lineX = x1;
        gInfo->u.weekInfo.lineY =
            y2 + ((gInfo->normalWd + 1) / 2) + VMARGIN(gInfo);
        gInfo->u.weekInfo.lineMaxY = y1 + gInfo->u.weekInfo.boxHt;
}

void x_week_sched_init(void *gInfoP) {
        CMGraphicsInfo *gInfo = (CMGraphicsInfo *)gInfoP;
...
void x_week_sched_draw(void *gInfoP, int dayIndex) {
        CMGraphicsInfo *gInfo = (CMGraphicsInfo *)gInfoP;
        int i;
        Props *p = (Props *)gInfo->c->properties;
        int begin = get_int_prop(p, CP_DAYBEGIN);
        ...
        x2 = gInfo->u.weekInfo.schedBoxX1 +
             (((dayIndex + 1) * boxWd) / DAYS_IN_WEEK) - (gInfo->normalWd / 2) -
             1;

        lastColor = 0;
        for (i = 0; i < nIntervals; i++) {
                y1 = gInfo->u.weekInfo.schedBoxY1 + ((i * boxHt) / nIntervals);
                y2 = gInfo->u.weekInfo.schedBoxY1 +
                     (((i + 1) * boxHt) / nIntervals);
                ...
                if (currColor != lastColor) {
                        if ((currColor != 2) && (lastColor != 2))
                                x_draw_line(gInfo, x1, y1, x2 + 1, y1,
                                            gInfo->thinWd);
                        lastColor = currColor;
                }
        }
...
void x_init_month(void *gInfoP, int nRows) {
        CMGraphicsInfo *gInfo = (CMGraphicsInfo *)gInfoP;
        CMFontInfo *fInfo;
...
int x_get_month_lines_per_page(void *gInfoP) {
        CMGraphicsInfo *gInfo = (CMGraphicsInfo *)gInfoP;
...
void x_month_daynames(void *gInfoP, int nRows) {
        CMGraphicsInfo *gInfo = (CMGraphicsInfo *)gInfoP;
        char *day_of_week[DAYS_IN_WEEK];
        int i;
        Calendar *c = gInfo->c;
        ...
        for (i = 0; i < DAYS_IN_WEEK; i++) {
                ...
                x_print_string(gInfo, day_of_week[i], (x1 + x2) / 2,
                               (y1 + y2) / 2, CENTER_AT_X | CENTER_AT_Y);
                free(day_of_week[i]);

                cm_reverse_video(gInfo, False);
                if (i != 0)
                        x_draw_line(gInfo, x1, y1, x1,
                                    y1 + gInfo->u.monthInfo.boxHt,
                                    gInfo->normalWd);
        }
...
void x_print_little_months(void *gInfoP, Tick tick) {
        CMGraphicsInfo *gInfo = (CMGraphicsInfo *)gInfoP;
        ...
        for (spacing = VMARGIN(gInfo); cm_tiny_month_height(gInfo, spacing) >
...
void x_month_timeslots(void *gInfoP, Tick tick, Boolean more) {
        CMGraphicsInfo *gInfo = (CMGraphicsInfo *)gInfoP;
        int fday = fdom(tick); /* first day of month, 0=Sun ... */
        ...
        gInfo->u.monthInfo.lineMaxX =
            boxX1 + (((dayCol + 1) * boxWd) / DAYS_IN_WEEK);
...
Boolean x_print_month_appts(void *gInfoP, CSA_entry_handle *list, int a_total,
                            int num_page, time_t hi_hour, int lines_per_box) {
        CMGraphicsInfo *gInfo = (CMGraphicsInfo *)gInfoP;
        int indented;
        Lines *lines;
        ...
        appt = allocate_appt_struct(
            appt_read, c->general->version, CSA_ENTRY_ATTR_CLASSIFICATION_I,
            CSA_ENTRY_ATTR_START_DATE_I, CSA_ENTRY_ATTR_SUMMARY_I,
            CSA_X_DT_ENTRY_ATTR_SHOWTIME_I, NULL);
        for (i = 0; i < a_total; i++) {
                stat = query_appt_struct(c->cal_handle, list[i], appt);
                if (stat != CSA_SUCCESS) {
                        free_appt_struct(&appt);
                ...
                if (pos < start) {
                        ...
                        if ((lines != NULL) && (lines->s != NULL)) {
                                ...
                                cm_print_month_text(gInfo, lines->s,
                                                    indented ? 2 : 0);
                        }
