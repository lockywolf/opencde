...
**  fallbacks.h
**
**  static char sccsid[] = "@(#)misc.h 1.12 94/02/17 Copyr 1991 Sun
*Microsystems, Inc.";
**
...
String fallback_resources[] = {
    ...
    /* Miscellaneous */
    "Dtcm*XmMonthPanel*fontList: -dt-interface "
    "user-medium-r-normal-xs*-*-*-*-*-*-*-*-*:",
    "Dtcm*canvas*XmPushButton.fontList: -dt-interface "
    "user-medium-r-normal-xs*-*-*-*-*-*-*-*-*:",
    "Dtcm*labelForm*fontList: -dt-interface "
    "user-medium-r-normal-xs*-*-*-*-*-*-*-*-*:",
    "Dtcm*XmMonthPanel.activeHeader: True",
    "Dtcm*XmMonthPanel*recomputeSize: False", "Dtcm*lastMonth.activeDays: True",
    "Dtcm*thisMonth.activeDays: True", "Dtcm*nextMonth.activeDays: True",
    "Dtcm.iconFont:  -dt-application-bold-r-normal-sans-*-180-*-*-p-*-*-*:",
    "Dtcm.applicationFontFamily: application", NULL};
