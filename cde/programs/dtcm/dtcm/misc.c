...
*/
extern Widget create_repeat_menu(Widget parent, XtCallbackProc cb_func,
                                 XtPointer data) {
        int ac;
        Arg args[5];
        Widget cb;
        ...
        ac = 0;
        XtSetArg(args[ac], XmNcomboBoxType, XmDROP_DOWN_LIST);
        ++ac;
        ...
        xmstr = XmStringCreateLocalized(
            catgets(calendar->DT_catd, 1, 200, "One Time"));
        XmComboBoxAddItem((Widget)cb, xmstr, 0, False);
        XmStringFree(xmstr);

        xmstr = XmStringCreateLocalized(
            catgets(calendar->DT_catd, 1, 853, "Daily"));
        XmComboBoxAddItem((Widget)cb, xmstr, 0, False);
        XmStringFree(xmstr);

        xmstr = XmStringCreateLocalized(
            catgets(calendar->DT_catd, 1, 854, "Weekly"));
        XmComboBoxAddItem((Widget)cb, xmstr, 0, False);
        XmStringFree(xmstr);

        xmstr = XmStringCreateLocalized(
            catgets(calendar->DT_catd, 1, 855, "Every Two Weeks"));
        XmComboBoxAddItem((Widget)cb, xmstr, 0, False);
        XmStringFree(xmstr);

        xmstr = XmStringCreateLocalized(
            catgets(calendar->DT_catd, 1, 856, "Monthly By Date"));
        XmComboBoxAddItem((Widget)cb, xmstr, 0, False);
        XmStringFree(xmstr);

        xmstr = XmStringCreateLocalized(
            catgets(calendar->DT_catd, 1, 857, "Monthly By Weekday"));
        XmComboBoxAddItem((Widget)cb, xmstr, 0, False);
        XmStringFree(xmstr);

        xmstr = XmStringCreateLocalized(
            catgets(calendar->DT_catd, 1, 858, "Yearly"));
        XmComboBoxAddItem((Widget)cb, xmstr, 0, False);
        XmStringFree(xmstr);

        xmstr = XmStringCreateLocalized(
            catgets(calendar->DT_catd, 1, 859, "Monday Thru Friday"));
        XmComboBoxAddItem((Widget)cb, xmstr, 0, False);
        XmStringFree(xmstr);

        xmstr = XmStringCreateLocalized(
            catgets(calendar->DT_catd, 1, 860, "Mon, Wed, Fri"));
        XmComboBoxAddItem((Widget)cb, xmstr, 0, False);
        XmStringFree(xmstr);
        ...
        xmstr = XmStringCreateLocalized(
            catgets(calendar->DT_catd, 1, 862, "Repeat Every..."));
        XmComboBoxAddItem((Widget)cb, xmstr, 0, False);
        XmStringFree(xmstr);
...
extern Widget create_for_menu(Widget parent) {
        int ac;
        Arg args[5];
        Widget cb, list, text;
        XmString xmstr;
        ...
        xmstr =
            XmStringCreateLocalized(catgets(calendar->DT_catd, 1, 863, "2"));
        XmComboBoxAddItem((Widget)cb, xmstr, 0, False);
        XmStringFree(xmstr);

        xmstr =
            XmStringCreateLocalized(catgets(calendar->DT_catd, 1, 864, "3"));
        XmComboBoxAddItem((Widget)cb, xmstr, 0, False);
        XmStringFree(xmstr);

        xmstr =
            XmStringCreateLocalized(catgets(calendar->DT_catd, 1, 865, "4"));
        XmComboBoxAddItem((Widget)cb, xmstr, 0, False);
        XmStringFree(xmstr);

        xmstr =
            XmStringCreateLocalized(catgets(calendar->DT_catd, 1, 866, "5"));
        XmComboBoxAddItem((Widget)cb, xmstr, 0, False);
        XmStringFree(xmstr);

        xmstr =
            XmStringCreateLocalized(catgets(calendar->DT_catd, 1, 867, "6"));
        XmComboBoxAddItem((Widget)cb, xmstr, 0, False);
        XmStringFree(xmstr);

        xmstr =
            XmStringCreateLocalized(catgets(calendar->DT_catd, 1, 868, "7"));
        XmComboBoxAddItem((Widget)cb, xmstr, 0, False);
        XmStringFree(xmstr);

        xmstr =
            XmStringCreateLocalized(catgets(calendar->DT_catd, 1, 869, "8"));
        XmComboBoxAddItem((Widget)cb, xmstr, 0, False);
        XmStringFree(xmstr);

        xmstr =
            XmStringCreateLocalized(catgets(calendar->DT_catd, 1, 870, "9"));
        XmComboBoxAddItem((Widget)cb, xmstr, 0, False);
        XmStringFree(xmstr);

        xmstr =
            XmStringCreateLocalized(catgets(calendar->DT_catd, 1, 871, "10"));
        XmComboBoxAddItem((Widget)cb, xmstr, 0, False);
        XmStringFree(xmstr);

        xmstr =
            XmStringCreateLocalized(catgets(calendar->DT_catd, 1, 872, "11"));
        XmComboBoxAddItem((Widget)cb, xmstr, 0, False);
        XmStringFree(xmstr);

        xmstr =
            XmStringCreateLocalized(catgets(calendar->DT_catd, 1, 873, "12"));
        XmComboBoxAddItem((Widget)cb, xmstr, 0, False);
        XmStringFree(xmstr);

        xmstr =
            XmStringCreateLocalized(catgets(calendar->DT_catd, 1, 874, "13"));
        XmComboBoxAddItem((Widget)cb, xmstr, 0, False);
        XmStringFree(xmstr);

        xmstr =
            XmStringCreateLocalized(catgets(calendar->DT_catd, 1, 875, "14"));
        XmComboBoxAddItem((Widget)cb, xmstr, 0, False);
        XmStringFree(xmstr);
...
extern Widget create_privacy_menu(Widget parent) {
        int ac, i;
        Arg args[5];
        Widget cb;
        XmString xmstr;
        ...
        XtSetArg(args[ac], XmNcomboBoxType, XmDROP_DOWN_LIST);
        ++ac;
        XtSetArg(args[ac], XmNvisibleItemCount, 3);
        ++ac;
        XtSetArg(args[ac], XmNpositionMode, XmONE_BASED);
        ++ac;
        ...
        xmstr = XmStringCreateLocalized(
            catgets(calendar->DT_catd, 1, 721, "Others See Time And Text"));
        XmComboBoxAddItem((Widget)cb, xmstr, 0, False);
        XmStringFree(xmstr);

        xmstr = XmStringCreateLocalized(
            catgets(calendar->DT_catd, 1, 722, "Others See Time Only"));
        XmComboBoxAddItem((Widget)cb, xmstr, 0, False);
        XmStringFree(xmstr);

        xmstr = XmStringCreateLocalized(
            catgets(calendar->DT_catd, 1, 723, "Others See Nothing"));
        XmComboBoxAddItem((Widget)cb, xmstr, 0, False);
        XmStringFree(xmstr);
...
extern void set_time_submenu(Widget parent, Widget option_menu, Props *p,
                             XtCallbackProc callback, XtPointer client_data,
                             Boolean nt, Boolean ad, Widget **widget_list,
                             int *widget_count) {
        ...
        */
        for (i = beg; i < end; i++) {
                ...
                for (j = 0; j <= 45; j += 15) {
                        ...
                        (*widget_list)[allocation_counter++] = menuitem =
                            XtVaCreateWidget(buf2, xmPushButtonGadgetClass,
                                             menu, XmNuserData,
                                             (i * hrsec) + (j * minsec), NULL);
                        if (callback)
        ...
        if (nt) {
                xmstr = XmStringCreateLocalized(
                    catgets(c->DT_catd, 1, 353, "No Time"));
                (*widget_list)[allocation_counter++] = menuitem =
                    XtVaCreateWidget("noTime", xmPushButtonGadgetClass, menu,
                                     XmNlabelString, xmstr, XmNuserData,
                                     NO_TIME, NULL);
                XmStringFree(xmstr);
                if (callback)
                        XtAddCallback(menuitem, XmNactivateCallback, callback,
                                      client_data);
        }

        if (ad) {
                xmstr = XmStringCreateLocalized(
                    catgets(c->DT_catd, 1, 354, "All Day"));
                (*widget_list)[allocation_counter++] = menuitem =
                    XtVaCreateWidget("allDay", xmPushButtonGadgetClass, menu,
                                     XmNlabelString, xmstr, XmNuserData,
                                     ALL_DAY, NULL);
                XmStringFree(xmstr);
                if (callback)
...
extern Widget create_start_stop_time_menu(Widget parent, XmString label,
                                          XtCallbackProc callback,
                                          XtPointer client_data, Props *p,
                                          Boolean nt, Boolean ad,
                                          Widget **widget_list,
                                          int *widget_count) {
        ...
        XtVaSetValues(menu, XmNpacking, XmPACK_COLUMN, XmNorientation,
                      XmHORIZONTAL, XmNnumColumns, (end - beg) + 1, NULL);
        ac = 0;
        XtSetArg(args[ac], XmNsubMenuId, menu);
        ++ac;
        XtSetArg(args[ac], XmNlabelString, label);
        ++ac;
        option_m = XmCreateOptionMenu(parent, "option_m", args, ac);

        set_time_submenu(parent, option_m, p, callback, client_data, nt, ad,
                         widget_list, widget_count);

        return option_m;
}

extern Widget create_time_scope_menu(Widget parent, XmString label,
                                     XtCallbackProc callback,
        ...
        menu = XmCreatePulldownMenu(parent, "pulldown", NULL, 0);
        XtVaSetValues(menu, XmNpacking, XmPACK_COLUMN, XmNorientation,
                      XmHORIZONTAL, XmNnumColumns, TIME_DAYS + 1, NULL);
        ...
        menuitems[0] =
            XtVaCreateWidget("timescope0", xmPushButtonGadgetClass, menu,
                             XmNlabelString, xmstr, XmNuserData, 0, NULL);
        if (callback)
                XtAddCallback(menuitems[0], XmNactivateCallback, callback,
                              client_data);
        XmStringFree(xmstr);

        xmstr = XmStringCreateLocalized(catgets(c->DT_catd, 1, 878, "Hrs"));
        menuitems[1] =
            XtVaCreateWidget("timescope1", xmPushButtonGadgetClass, menu,
                             XmNlabelString, xmstr, XmNuserData, 1, NULL);
        if (callback)
                XtAddCallback(menuitems[1], XmNactivateCallback, callback,
                              client_data);
        XmStringFree(xmstr);

        xmstr = XmStringCreateLocalized(catgets(c->DT_catd, 1, 879, "Days"));
        menuitems[2] =
            XtVaCreateWidget("timescope2", xmPushButtonGadgetClass, menu,
                             XmNlabelString, xmstr, XmNuserData, 2, NULL);
        if (callback)
                XtAddCallback(menuitems[2], XmNactivateCallback, callback,
                              client_data);
        XmStringFree(xmstr);
...
extern Widget create_repeat_scope_menu(Widget parent, XmString label,
                                       XtCallbackProc callback,
                                       XtPointer client_data) {
        int ac;
        Arg args[5];
        ...
        menu = XmCreatePulldownMenu(parent, "pulldown", NULL, 0);
        XtVaSetValues(menu, XmNpacking, XmPACK_COLUMN, XmNorientation,
                      XmHORIZONTAL, XmNnumColumns, REPEAT_MONTHS + 1, NULL);
        ...
        ;
        menuitems[0] =
            XtVaCreateWidget(buf, xmPushButtonGadgetClass, menu, XmNlabelString,
                             xmstr, XmNuserData, REPEAT_DAYS, NULL);
        if (callback)
                XtAddCallback(menuitems[0], XmNactivateCallback, callback,
                              client_data);
        XmStringFree(xmstr);
        ...
        menuitems[1] =
            XtVaCreateWidget(buf, xmPushButtonGadgetClass, menu, XmNlabelString,
                             xmstr, XmNuserData, REPEAT_WEEKS, NULL);
        if (callback)
                XtAddCallback(menuitems[1], XmNactivateCallback, callback,
                              client_data);
        XmStringFree(xmstr);
        ...
        menuitems[2] =
            XtVaCreateWidget(buf, xmPushButtonGadgetClass, menu, XmNlabelString,
                             xmstr, XmNuserData, REPEAT_MONTHS, NULL);
        if (callback)
                XtAddCallback(menuitems[2], XmNactivateCallback, callback,
                              client_data);
        XmStringFree(xmstr);
...
static void fill_pixmap(XImage *xi, int w, int h, unsigned char *data) {
        xi->width = w;
        xi->height = h;
        xi->data = (char *)data;
        xi->xoffset = 0;
...
extern void create_all_pixmaps(Props_pu *p, Widget w) {
        Pixel fg, bg;
        Screen *s;
...
*/
extern char *cm_mbchar(char *str) {
        static char *string;
...
*/
static void response(Widget w, XtPointer client_data, XtPointer cbs) {
...
*/
extern int dialog_popup(Widget parent, ...) {
        ...
        frame = XtVaCreatePopupShell("generic_dialog", xmDialogShellWidgetClass,
                                     parent, XmNallowShellResize, True,
                                     XmNmwmFunctions,
                                     MWM_FUNC_MOVE | MWM_FUNC_CLOSE, NULL);

        form = XtVaCreateWidget("form", xmFormWidgetClass, frame,
                                XmNhorizontalSpacing, 5, XmNverticalSpacing, 5,
                                XmNmarginWidth, 0, XmNfractionBase, 100,
                                XmNautoUnmanage, False, XmNdialogStyle,
                                XmDIALOG_FULL_APPLICATION_MODAL, NULL);

        image =
            XtVaCreateWidget("image", xmLabelGadgetClass, form, XmNlabelType,
                             XmPIXMAP, XmNtopAttachment, XmATTACH_FORM,
                             XmNleftAttachment, XmATTACH_FORM, NULL);

        sep = XtVaCreateWidget("sep", xmSeparatorGadgetClass, form,
        ...
        while (op) {
                ...
                case DIALOG_TITLE:
                        ...
                        XtVaSetValues(frame, XtNtitle, ptr, NULL);
                        break;
                case DIALOG_TEXT:
                        ptr = va_arg(pvar, char *);
                        if (text_str)
                ...
                case BUTTON_INSENSITIVE:
                        ...
                        button = XtVaCreateWidget(
                            buf, xmPushButtonGadgetClass, form, XmNlabelString,
                            xmstr, XmNleftAttachment, XmATTACH_POSITION,
                            XmNleftPosition, b_cnt * 2, XmNleftOffset, 5,
                            XmNrightAttachment, XmATTACH_POSITION,
                            XmNrightPosition, (b_cnt + 1) * 2, XmNrightOffset,
                            5, XmNuserData, button_id, XmNtopAttachment,
                            XmATTACH_WIDGET, XmNtopWidget, sep, XmNtopOffset,
                            10, XmNbottomAttachment, XmATTACH_FORM,
                            XmNbottomOffset, 10, NULL);
                        ++b_cnt;
                        if (op == BUTTON_INSENSITIVE)
                                XtSetSensitive(button, False);
                        XtAddCallback(button, XmNactivateCallback, response,
                                      (XtPointer)&answer);
                        XmStringFree(xmstr);
                        break;
                case BUTTON_HELP:
                        ...
                        button = XtVaCreateWidget(
                            "help_button", xmPushButtonGadgetClass, form,
                            XmNlabelString, xmstr, XmNleftAttachment,
                            XmATTACH_POSITION, XmNleftPosition, b_cnt * 2,
                            XmNrightAttachment, XmATTACH_POSITION,
                            XmNrightPosition, (b_cnt + 1) * 2, XmNrightOffset,
                            5, XmNtopAttachment, XmATTACH_WIDGET, XmNtopWidget,
                            sep, XmNtopOffset, 10, XmNbottomAttachment,
        ...
        va_end(pvar);
        XtVaSetValues(form, XmNfractionBase, b_cnt * 2, NULL);
        ...
        while (ptr) {
                ...
                xmstr = XmStringCreateLocalized(ptr);
                text = XtVaCreateWidget(
                    buf, xmLabelGadgetClass, form, XmNalignment,
                    XmALIGNMENT_BEGINNING, XmNlabelString, xmstr,
                    XmNleftAttachment, XmATTACH_WIDGET, XmNleftWidget, image,
                    XmNrightAttachment, XmATTACH_FORM, NULL);
                XmStringFree(xmstr);
        ...
        XtVaSetValues(sep, XmNtopWidget, last_text, XmNtopOffset, 10, NULL);
        ManageChildren(form);
        XtManageChild(form);
...
*/
extern void get_range(Glance glance, time_t date, time_t *start, time_t *stop) {
        int day_of_week;
...
*/
extern void editor_err_msg(Widget frame, char *name, Validate_op op, Pixmap p) {
        Calendar *c = calendar;
        char buf[MAXNAMELEN], buf2[MAXNAMELEN * 2], error_buf[64];
        ...
        case CANCEL_APPT:
                snprintf(buf, MAXNAMELEN, "%s",
                         catgets(c->DT_catd, 1, 356,
                                 "Per user request, Operation was "
                                 "cancelled.\nCalendar"));
                help_button = False;
                break;
        case INVALID_DATE:
        ...
        case REPEAT_FOR_MISMATCH:
                snprintf(buf, MAXNAMELEN, "%s",
                         catgets(c->DT_catd, 1, 363,
                                 "Invalid or mismatched REPEAT and FOR "
        ...
        case INVALID_NOTIME_APPT:
                snprintf(buf, MAXNAMELEN, "%s",
                         catgets(c->DT_catd, 1, 724,
                                 "No Time appointments must have a WHAT value "
                                 "specified.\nOperation was cancelled.  "
                                 "Calendar"));
        ...
        if (help_button) {
                char *title = XtNewString(
                    catgets(c->DT_catd, 1, 914, "Calendar : Error - Editor"));
                char *ident1 =
                    XtNewString(catgets(c->DT_catd, 1, 95, "Continue"));
                dialog_popup(frame, DIALOG_TITLE, title, DIALOG_TEXT, buf2,
                             BUTTON_IDENT, 1, ident1, BUTTON_HELP, error_buf,
                             DIALOG_IMAGE, p, NULL);
                XtFree(ident1);
                XtFree(title);
        } else {
                ...
                char *ident1 =
                    XtNewString(catgets(c->DT_catd, 1, 95, "Continue"));
                dialog_popup(frame, DIALOG_TITLE, title, DIALOG_TEXT, buf2,
                             BUTTON_IDENT, 1, ident1, DIALOG_IMAGE, p, NULL);
                XtFree(ident1);
                XtFree(title);
        }
}

extern void backend_err_msg(Widget frame, char *name, CSA_return_code stat,
                            Pixmap p) {
        char buf[MAXNAMELEN], buf2[MAXNAMELEN * 2], error_buf[64];
        Calendar *c = calendar;
        int help_button = True;
        ...
        case CSA_X_DT_E_ENTRY_NOT_FOUND:
                snprintf(buf, MAXNAMELEN, "%s",
                         catgets(c->DT_catd, 1, 725,
                                 "Calendar Entry does not exist.\nOperation "
                                 "was cancelled.  Calendar"));
                break;
        case CSA_E_INVALID_ENTRY_HANDLE:
                snprintf(buf, MAXNAMELEN, "%s",
                         catgets(c->DT_catd, 1, 881,
                                 "Internal Error #1: Invalid calendar/entry "
                                 "handle.\nOperation was cancelled.  "
                                 "Calendar"));
                break;
        case CSA_E_INVALID_SESSION_HANDLE:
                snprintf(buf, MAXNAMELEN, "%s",
                         catgets(c->DT_catd, 1, 882,
                                 "Internal Error #2: Invalid session "
                                 "handle.\nOperation was cancelled.  "
                                 "Calendar"));
                break;
        case CSA_E_NO_AUTHORITY:
                snprintf(buf, MAXNAMELEN, "%s",
                         catgets(c->DT_catd, 1, 370,
                                 "Authorization error.  Permission "
                                 "denied.\nOperation was cancelled.  "
                                 "Calendar"));
                help_button = False;
                break;
        case CSA_E_INVALID_PARAMETER:
                snprintf(buf, MAXNAMELEN, "%s",
                         catgets(c->DT_catd, 1, 883,
                                 "Internal Error #3: Invalid data "
                                 "value.\nOperation was cancelled.  Calendar"));
                break;
        case CSA_E_READONLY:
                snprintf(buf, MAXNAMELEN, "%s",
                         catgets(c->DT_catd, 1, 884,
                                 "Internal Error #4: Value specified for a "
                                 "read-only attribute.\nOperation was "
                                 "cancelled.  Calendar"));
                break;
        case CSA_E_INVALID_ATTRIBUTE_VALUE:
                snprintf(buf, MAXNAMELEN, "%s",
                         catgets(c->DT_catd, 1, 885,
                                 "Internal Error #5: Incorrect data type "
                                 "specified for an attribute value.\nOperation "
                                 "was cancelled.  Calendar"));
                break;
        case CSA_E_UNSUPPORTED_ATTRIBUTE:
                snprintf(buf, MAXNAMELEN, "%s",
                         catgets(c->DT_catd, 1, 886,
                                 "Internal Error #6: Specified attribute is "
                                 "not supported on this calendar "
                                 "version.\nOperation was cancelled.  "
                                 "Calendar"));
                break;
        case CSA_E_NOT_SUPPORTED:
                snprintf(buf, MAXNAMELEN, "%s",
                         catgets(c->DT_catd, 1, 887,
                                 "Internal Error #7: Specified function is not "
                                 "supported on this calendar "
                                 "version.\nOperation was cancelled.  "
                                 "Calendar"));
                break;
        case CSA_E_INVALID_ENUM:
                snprintf(buf, MAXNAMELEN, "%s",
                         catgets(c->DT_catd, 1, 888,
                                 "Internal Error #8: Invalid operator "
                                 "specified.\nOperation was cancelled.  "
                                 "Calendar"));
                break;
        case CSA_E_INSUFFICIENT_MEMORY:
                snprintf(buf, MAXNAMELEN, "%s",
                         catgets(c->DT_catd, 1, 378,
                                 "Memory allocation error - not enough "
                                 "memory.\nOperation was cancelled.  "
                                 "Calendar"));
        ...
        case CSA_E_SERVICE_UNAVAILABLE:
                snprintf(
                    buf, MAXNAMELEN, "%s",
                    catgets(c->DT_catd, 1, 921, "Couldn't access calendar: "));
                break;
        case CSA_X_DT_E_INVALID_SERVER_LOCATION:
                snprintf(buf, MAXNAMELEN, "%s",
                         catgets(c->DT_catd, 1, 641,
                                 "Server failed to get network address\nfor "
                                 "the specified location:  invalid hostname."));
                break;
        case CSA_X_DT_E_SERVICE_NOT_REGISTERED:
                snprintf(buf, MAXNAMELEN, "%s",
                         catgets(c->DT_catd, 1, 642,
                                 "rpc.cmsd daemon is not registered.\nPlease "
                                 "verify rpc.cmsd is installed correctly on "
                                 "your system."));
                snprintf(error_buf, 64, CMSD_ERROR_HELP);
                break;
        case CSA_X_DT_E_SERVER_TIMEOUT:
                snprintf(buf, MAXNAMELEN, "%s",
                         catgets(c->DT_catd, 1, 727,
                                 "Your request timed out\nPlease verify "
                                 "rpc.cmsd is installed correctly on your "
                                 "system."));
                snprintf(error_buf, 64, CMSD_ERROR_HELP);
                break;
        case CSA_E_FAILURE:
                snprintf(buf, MAXNAMELEN, "%s",
                         catgets(c->DT_catd, 1, 643,
                                 "Couldn't access calendar. Calendar"));
                break;
        case CSA_E_INVALID_RULE:
                snprintf(buf, MAXNAMELEN, "%s",
                         catgets(c->DT_catd, 1, 1120,
                                 "The event cannot be scheduled in the given "
        ...
        if (help_button) {
                char *title = XtNewString(
                    catgets(c->DT_catd, 1, 890, "Calendar : Error - Services"));
                char *ident1 =
                    XtNewString(catgets(c->DT_catd, 1, 95, "Continue"));
                dialog_popup(frame, DIALOG_TITLE, title, DIALOG_TEXT, buf2,
                             BUTTON_IDENT, 1, ident1, BUTTON_HELP, error_buf,
 ...
 * her intentions
 */
extern boolean_t query_user(void *user_data) {
        char buf[MAXNAMELEN];
        ...
        snprintf(buf, MAXNAMELEN, "%s",
                 catgets(c->DT_catd, 1, 386,
                         "That appointment has an end time earlier than its "
                         "begin time.\nDo you want to schedule it into the "
                         "next day?"));
        title = XtNewString(
            catgets(c->DT_catd, 1, 248, "Calendar : Schedule Appointment"));
        ident1 = XtNewString(catgets(c->DT_catd, 1, 923, "Cancel"));
        ident2 = XtNewString(catgets(c->DT_catd, 1, 389, "Next Day"));
        answer = dialog_popup(c->frame, DIALOG_TITLE, title, DIALOG_TEXT, buf,
...
extern void set_message(Widget w, char *msg) {
        XmString xmstr;
...
extern void setup_quit_handler(Widget w, XtCallbackProc cb, caddr_t user_data) {
        Atom delete_window;
...
int ds_is_double_click(last_event, event) XEvent *last_event;
XEvent *event;
{
 ...
 *
 */
extern int cm_select_text(Widget field, Time time) {
        XmTextPosition last;
...
extern Dimension ComputeMaxWidth(Widget w1, Widget w2, Widget w3, Widget w4) {
        ...
        XtVaGetValues(w1, XmNwidth, &width1, NULL);

        for (i = 1; w[i]; i++) {

                XtVaGetValues(w[i], XmNwidth, &width2, NULL);
...
extern void ManageChildren(Widget w) {
        WidgetList children;
        int n;

        XtVaGetValues(w, XmNchildren, &children, XmNnumChildren, &n, NULL);
...
extern void _i18n_HighestWidget(int num, Widget *ret, Dimension *dim, ...) {
        ...
        *dim = (Dimension)0;
        ...
        for (i = 0, _max = (Dimension)0; i < num; i++) {
                ...
                /*
                 * Ugly check. XmScale's XmNheight is determined after being
                 * mapped. So if WidgeClass == xmScaleWidgetClass, use
                 * XtQueryGeometry() !! ( It's dangerous ! ) See
                 * p_create_display_pane()'s comment :)
                 *
...
extern void _i18n_HighestWidgetAdjust(int num, Widget *ret, Dimension *dim,
        ...
        *dim = (Dimension)0;
        ...
        for (i = 0; i < num; i++) {
                if (i != _high) {
                        XtSetArg(_args[0], XmNbottomAttachment,
                                 XmATTACH_OPPOSITE_WIDGET);
                        XtSetArg(_args[1], XmNbottomWidget, _highestW);
                        XtSetArg(_args[2], XmNbottomOffset,
                                 (_max - _height[i]) >> 1);
