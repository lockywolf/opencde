...
**  dssw.h
**
**  static char sccsid[] = "@(#)dssw.h 1.18 94/11/07 Copyr 1991 Sun
*Microsystems, Inc.";
**
...
**
*******************************************************************************/
typedef enum { TIME_AM, TIME_PM } Time_block_op;
...
extern Boolean dssw_form_to_appt P((DSSW *, Dtcm_appointment *, char *, Tick));
extern Boolean dssw_form_flags_to_appt P((DSSW *, Dtcm_appointment *, char *,
                                          Tick, int *));
extern Boolean dssw_form_to_todo P((DSSW *, Dtcm_appointment *, char *, Tick));
