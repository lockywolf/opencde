...
#ifndef lint
static char sccsid[] =
    "@(#)fns.c 1.3 94/11/07 Copyr 1993 Sun Microsystems, Inc.";
#endif
 ...
 */
int cm_register_calendar(const char *username, const char *location)
 ...
 */
int cmfns_name_from_file(const char *path, /* Path to file to get name from */
