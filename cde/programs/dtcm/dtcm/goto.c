...
#ifndef lint
static char sccsid[] =
    "@(#)goto.c 1.40 95/03/28 Copyr 1993 Sun Microsystems, Inc.";
#endif
...
extern caddr_t make_goto(Calendar *c) {
        Goto *g;
        XmString xmstr;
        ...
        title =
            XtNewString(catgets(c->DT_catd, 1, 715, "Calendar : Go to Date"));
        g->frame = XtVaCreatePopupShell(
            "frame", xmDialogShellWidgetClass, c->frame, XmNtitle, title,
            XmNallowShellResize, True, XmNmappedWhenManaged, False, NULL);
        XtFree(title);

        g->form = XtVaCreateWidget(
            "form", xmFormWidgetClass, g->frame, XmNautoUnmanage, False,
        ...
        g->datelabel = XtVaCreateWidget(
            "Date:", xmLabelWidgetClass, g->form, XmNleftAttachment,
            XmATTACH_FORM, XmNleftOffset, 5, XmNtopAttachment, XmATTACH_FORM,
            XmNtopOffset, 11, XmNlabelString, xmstr, NULL);
        XmStringFree(xmstr);

        g->datetext = XtVaCreateWidget(
            "text", xmTextWidgetClass, g->form, XmNtopAttachment, XmATTACH_FORM,
            XmNtopWidget, g->datelabel, XmNtopOffset, 7, XmNleftAttachment,
            XmATTACH_WIDGET, XmNleftWidget, g->datelabel, XmNrightAttachment,
        ...
        separator = XtVaCreateWidget(
            "separator", xmSeparatorGadgetClass, g->form, XmNleftAttachment,
            XmATTACH_FORM, XmNrightAttachment, XmATTACH_FORM, XmNtopAttachment,
            XmATTACH_WIDGET, XmNtopWidget, g->datetext, XmNtopOffset, 5, NULL);

        button_form = XtVaCreateWidget(
            "form", xmFormWidgetClass, g->form, XmNautoUnmanage, False,
        ...
        g->datebutton = XtVaCreateWidget(
            "goTo", xmPushButtonWidgetClass, button_form, XmNtopAttachment,
            XmATTACH_WIDGET, XmNtopWidget, separator, XmNlabelString, xmstr,
            XmNnavigationType, XmTAB_GROUP, XmNleftAttachment,
        ...
        g->cancelbutton = XtVaCreateWidget(
            "cancel", xmPushButtonWidgetClass, button_form, XmNtopAttachment,
            XmATTACH_WIDGET, XmNtopWidget, separator, XmNleftAttachment,
            XmATTACH_POSITION, XmNleftPosition, 1, XmNrightAttachment,
            XmATTACH_POSITION, XmNrightPosition, 2, XmNlabelString, xmstr,
            NULL);
        ...
        g->helpbutton = XtVaCreateWidget(
            "help", xmPushButtonWidgetClass, button_form, XmNtopAttachment,
            XmATTACH_WIDGET, XmNtopWidget, separator, XmNleftAttachment,
            XmATTACH_POSITION, XmNleftPosition, 2, XmNrightAttachment,
            XmATTACH_POSITION, XmNrightPosition, 3, XmNlabelString, xmstr,
            NULL);
        XtAddCallback(g->helpbutton, XmNactivateCallback,
                      (XtCallbackProc)help_cb, GOTO_HELP_BUTTON);
        XtAddCallback(g->form, XmNhelpCallback, (XtCallbackProc)help_cb,
                      (XtPointer)GOTO_HELP_BUTTON);
        XmStringFree(xmstr);

        g->goto_message = XtVaCreateWidget(
            "message", xmLabelGadgetClass, g->form, XmNalignment,
            XmALIGNMENT_BEGINNING, XmNtopAttachment, XmATTACH_WIDGET,
            XmNtopWidget, g->cancelbutton, XmNleftAttachment, XmATTACH_FORM,
...
void goto_date(Widget widget, XtPointer client_data,
        ...
        if ((date == NULL) || (*date == '\0')) {
                snprintf(message, 40, "%s",
                         catgets(c->DT_catd, 1, 297, "Please type in a date"));
        ...
        if (!strcmp(today, date)) {
                snprintf(
                    message, 40,
                    catgets(c->DT_catd, 1, 298, "You are already viewing %s"),
                    date);
                set_message(g->goto_message, message);
                return;
        }
        ...
        if (gotodate == DATE_BBOT) {
                snprintf(
                    ...
                    catgets(
                        c->DT_catd, 1, 814,
                        "You must enter a date after 1969 and before 2038"));
                set_message(g->goto_message, message);
                return;
                ...
                snprintf(message, 40, "%s",
                         catgets(c->DT_catd, 1, 299, "Invalid Date"));
                set_message(g->goto_message, message);
                return;
        }
...
void g_cancel_cb(Widget widget, XtPointer client_data,
                 XmPushButtonCallbackStruct *cbs) {
        Calendar *c = calendar;
        Goto *g;
