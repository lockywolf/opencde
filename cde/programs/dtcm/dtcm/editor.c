...
*/
static void appt_to_form(Editor *e, CSA_entry_handle a) {
        char buf[MAXNAMELEN];
        ...
        appt = allocate_appt_struct(appt_read, e->cal->general->version,
        ...
        snprintf(buf, MAXNAMELEN, "%s:  %s",
                 catgets(e->cal->DT_catd, 1, 251, "Author"),
...
*/
static void e_list_select_proc(Widget w, XtPointer client_data,
                               XtPointer data) {
        CSA_entry_handle a;
...
*/
static void e_quit_handler(Widget w, XtPointer cdata, XtPointer data) {
...
static void e_view_cancel_cb(Widget widget, XtPointer client_data,
...
*/
static void e_build_view_popup(Editor *e) {
        int ac = 0;
        Arg args[15];
        XmString xmstr;
        Calendar *c = e->cal;
        ...
        */
        title = XtNewString(
            catgets(c->DT_catd, 1, 1086, "Calendar : Appointment List"));
        e->view_frame = XtVaCreatePopupShell(
            "appt_list", xmDialogShellWidgetClass, e->cal->frame, XmNtitle,
            title, XmNdeleteResponse, XmDO_NOTHING, XmNautoUnmanage, False,
            XmNallowShellResize, True, NULL);
        XtFree(title);
        setup_quit_handler(e->view_frame, e_quit_handler, (caddr_t)e);

        e->view_form = XtVaCreateWidget(
            "apptform", xmFormWidgetClass, e->view_frame, XmNfractionBase, 2,
            XmNmarginWidth, 2, XmNautoUnmanage, False, NULL);

        xmstr = XmStringCreateLocalized(catgets(c->DT_catd, 1, 680, "Close"));
        e->view_cancel_button = XtVaCreateWidget(
            "cancel", xmPushButtonWidgetClass, e->view_form, XmNlabelString,
            xmstr, XmNleftAttachment, XmATTACH_POSITION, XmNleftPosition, 0,
            XmNrightAttachment, XmATTACH_POSITION, XmNrightPosition, 1,
            XmNbottomAttachment, XmATTACH_FORM, XmNleftOffset, 10, NULL);
        XmStringFree(xmstr);

        XtAddCallback(e->view_cancel_button, XmNactivateCallback,
                      (XtCallbackProc)e_view_cancel_cb, e);

        xmstr = XmStringCreateLocalized(catgets(c->DT_catd, 1, 77, "Help"));
        e->view_help_button = XtVaCreateWidget(
            "help", xmPushButtonWidgetClass, e->view_form, XmNlabelString,
            xmstr, XmNleftAttachment, XmATTACH_POSITION, XmNleftPosition, 1,
            XmNrightAttachment, XmATTACH_POSITION, XmNrightPosition, 2,
            XmNbottomAttachment, XmATTACH_FORM, XmNrightOffset, 10, NULL);
        XmStringFree(xmstr);

        separator = XtVaCreateWidget(
            "separator", xmSeparatorGadgetClass, e->view_form,
            XmNleftAttachment, XmATTACH_FORM, XmNrightAttachment, XmATTACH_FORM,
            XmNbottomAttachment, XmATTACH_WIDGET, XmNbottomWidget,
            e->view_cancel_button, XmNbottomOffset, 5, NULL);

        xmstr = XmStringCreateLocalized(catgets(c->DT_catd, 1, 703, "context"));
        e->view_list_label = XtVaCreateWidget(
            "type_label", xmLabelGadgetClass, e->view_form, XmNtopAttachment,
            XmATTACH_FORM, XmNleftAttachment, XmATTACH_FORM, XmNleftOffset, 5,
            XmNtopOffset, 5, XmNlabelString, xmstr, NULL);
        XmStringFree(xmstr);
        ...
        ac++;
        XtSetArg(args[ac], XmNscrolledWindowMarginHeight, 5);
        ac++;
        XtSetArg(args[ac], XmNscrolledWindowMarginWidth, 5);
        ac++;
        XtSetArg(args[ac], XmNlistSpacing, 5);
        ac++;
        ...
        ++ac;
        XtSetArg(args[ac], XmNtopWidget, e->view_list_label);
        ++ac;
        ...
        ++ac;
        XtSetArg(args[ac], XmNdoubleClickInterval, 5);
        ++ac;
        e->view_list =
            XmCreateScrolledList(e->view_form, "view_list", args, ac);

        XtAddCallback(e->view_help_button, XmNactivateCallback,
                      (XtCallbackProc)help_cb, APPT_LIST_HELP_BUTTON);
        XtAddCallback(e->view_form, XmNhelpCallback, (XtCallbackProc)help_cb,
                      (XtPointer)APPT_LIST_HELP_BUTTON);
...
*/
static void e_build_expand(Editor *e) {
        ...
        */
        ...
        XtVaSetValues(e->rfp.rfp_form_mgr, XmNleftAttachment, XmATTACH_FORM,
                      XmNleftOffset, 3, XmNtopAttachment, XmATTACH_WIDGET,
                      XmNtopWidget, e->separator1, NULL);
        ...
        */
        ...
        XtVaSetValues(e->reminders.bfpm_form_mgr, XmNleftAttachment,
                      XmATTACH_WIDGET, XmNleftWidget, e->rfp.rfp_form_mgr,
                      XmNrightOffset, 3, XmNtopAttachment, XmATTACH_WIDGET,
                      XmNtopWidget, e->separator1, NULL);
...
*/
static void e_expand_ui_proc(Widget w, XtPointer client_data, XtPointer data) {
        Editor *e = (Editor *)client_data;
        ...
        XtVaGetValues(e->appt_list_sw, XmNheight, &height, XmNwidth, &width,
                      NULL);
        ...
        if (expand_state_closed) {
                ...
                xmstr = XmStringCreateLocalized(
                    catgets(e->cal->DT_catd, 1, 625, "Less"));
                XtVaSetValues(e->expand_ui_button, XmNlabelString, xmstr, NULL);
                XmStringFree(xmstr);
                ...
                xmstr = XmStringCreateLocalized(
                    catgets(e->cal->DT_catd, 1, 626, "More"));
                XtVaSetValues(e->expand_ui_button, XmNlabelString, xmstr, NULL);
                XmStringFree(xmstr);
        ...
        XtVaSetValues(e->appt_list_sw, XmNheight, height, XmNwidth, width,
                      NULL);
}
...
*/
static Dtcm_appointment *form_to_appt(Editor *e) {
        boolean_t all_ok;
        Dtcm_appointment *a;
        ...
        if (all_ok)
                all_ok = reminders_form_to_appt(&e->reminders, a,
                                                e->cal->view->current_calendar);
...
**  Action procedures
*/
static void e_insert_proc(Widget w, XtPointer client_data, XtPointer data) {
        Editor *e = (Editor *)client_data;
        ...
        if (strcmp(c->calname, c->view->current_calendar) != 0) {
                ...
                snprintf(buf, BUFSIZ, "%s",
                         catgets(c->DT_catd, 1, 210,
                                 "The appointment will be scheduled in the "
                                 "calendar\nyou are currently browsing.  Do "
                                 "you still want to schedule it?"));
                snprintf(buf2, BUFSIZ, "%s %s",
                         catgets(c->DT_catd, 1, 211, "Schedule in"),
                         c->view->current_calendar);
                title = XtNewString(catgets(c->DT_catd, 1, 212,
                                            "Calendar : Schedule Appointment"));
                ident = XtNewString(catgets(c->DT_catd, 1, 923, "Cancel"));
                answer = dialog_popup(e->frame, DIALOG_TITLE, title,
                                      DIALOG_TEXT, buf, BUTTON_IDENT, 1, ident,
                                      BUTTON_IDENT, 2, buf2, NULL);
                XtFree(ident);
                XtFree(title);
                if (answer == 1)
                        return;
...
static void e_delete_proc(Widget w, XtPointer client_data, XtPointer data) {
        ...
        if (strcmp(c->calname, c->view->current_calendar) != 0) {
                 ...
                 */
                snprintf(buf, BUFSIZ, "%s",
                         catgets(c->DT_catd, 1, 1004,
                                 "This appointment is in a calendar owned by "
                                 "someone else.\nDo you want to delete it "
                                 "anyway ?"));
                snprintf(buf2, BUFSIZ, "%s %s",
                         catgets(c->DT_catd, 1, 1005, "Delete from"),
                         c->view->current_calendar);
                title = XtNewString(
                    catgets(c->DT_catd, 1, 252,
        ...
        if (!XmListGetSelectedPos(e->appt_list, &item_list, &item_cnt)) {
                ...
                char *text = XtNewString(
                    catgets(c->DT_catd, 1, 253,
                            "Select an appointment and DELETE again."));
                char *ident =
                    XtNewString(catgets(c->DT_catd, 1, 95, "Continue"));
                answer = dialog_popup(e->frame, DIALOG_TITLE, title,
                                      DIALOG_TEXT, text, BUTTON_IDENT, 1, ident,
                                      DIALOG_IMAGE, p->xm_error_pixmap, NULL);
                XtFree(ident);
                XtFree(text);
                XtFree(title);
                _DtTurnOffHourGlass(e->frame);
...
static void e_change_proc(Widget w, XtPointer client_data, XtPointer data) {
        int *item_list = NULL, item_cnt = 0;
        Editor *e = (Editor *)client_data;
        Calendar *c = e->cal;
        ...
        if (strcmp(c->calname, c->view->current_calendar) != 0) {
                 ...
                 */
                snprintf(buf, BUFSIZ, "%s",
                         catgets(c->DT_catd, 1, 1003,
                                 "This appointment is in a calendar owned by "
                                 "someone else.\nDo you want to change it "
                                 "anyway ?"));
                snprintf(buf2, BUFSIZ, "%s %s",
                         catgets(c->DT_catd, 1, 1006, "Change in"),
                         c->view->current_calendar);
                answer = dialog_popup(e->frame, DIALOG_TITLE, title,
                                      DIALOG_TEXT, buf, BUTTON_IDENT, 1, ident,
                                      BUTTON_IDENT, 2, buf2, NULL);
...
static void e_clear_proc(Widget w, XtPointer client_data, XtPointer data) {
        Editor *e = (Editor *)client_data;
...
static void e_close_proc(Widget w, XtPointer client_data, XtPointer data) {
        Editor *e = (Editor *)client_data;
 ...
 * was being held down.
 */
void FormApptDragMotionHandler(Widget dragInitiator, XtPointer clientData,
                               XEvent *event) {
        int diffX, diffY;
        ...
        if (!e->doing_drag) {
                ...
                XtVaGetValues(e->drag_source, XmNx, &source_x, XmNy, &source_y,
                ...
                if ((ABS(diffX) >= DRAG_THRESHOLD) ||
                    (ABS(diffY) >= DRAG_THRESHOLD)) {
                        e->doing_drag = True;
                        ApptDragStart(dragInitiator, event, c,
                                      SingleEditorIcon);
                        e->initialX = -1;
                        e->initialY = -1;
                }
...
extern void e_make_editor(Calendar *c) {
        int cnt = 0;
        Arg args[15];
        Editor *e = (Editor *)c->editor;
        ...
        */
        e->frame = XtVaCreatePopupShell(
            "frame", xmDialogShellWidgetClass, e->cal->frame, XmNdeleteResponse,
            XmDO_NOTHING, XmNallowShellResize, True, NULL);
        set_editor_title(e, c->view->current_calendar);
        setup_quit_handler(e->frame, e_quit_handler, (caddr_t)e);

        e->base_form_mgr =
            XtVaCreateWidget("base_form_mgr", xmFormWidgetClass, e->frame,
                             XmNautoUnmanage, False, XmNfractionBase, 8, NULL);
        ...
        */
        xmstr =
            XmStringCreateLocalized(catgets(c->DT_catd, 1, 628, "Time  What"));
        e->list_label = XtVaCreateWidget(
            "label", xmLabelGadgetClass, e->base_form_mgr, XmNlabelString,
            xmstr, XmNtopAttachment, XmATTACH_FORM, XmNtopOffset, 5, NULL);
        XmStringFree(xmstr);

        XtVaGetValues(e->list_label, XmNheight, &label_height, NULL);

        e->message_text = XtVaCreateWidget(
            "message", xmLabelGadgetClass, e->base_form_mgr, XmNalignment,
            XmALIGNMENT_BEGINNING, XmNbottomAttachment, XmATTACH_FORM,
            XmNbottomOffset, 2, XmNleftAttachment, XmATTACH_FORM, XmNleftOffset,
            2, XmNrightAttachment, XmATTACH_FORM, XmNrightOffset, 2, NULL);

        /*
        **  Create insert, delete, change, and clear buttons
        */
        xmstr = XmStringCreateLocalized(catgets(c->DT_catd, 1, 342, "Insert"));
        e->insert_button = XtVaCreateWidget(
            "Insert", xmPushButtonWidgetClass, e->base_form_mgr, XmNlabelString,
            xmstr, XmNbottomAttachment, XmATTACH_WIDGET, XmNbottomWidget,
            e->message_text, XmNleftAttachment, XmATTACH_POSITION,
        ...
        e->change_button = XtVaCreateWidget(
            "Change", xmPushButtonWidgetClass, e->base_form_mgr, XmNlabelString,
            xmstr, XmNbottomAttachment, XmATTACH_WIDGET, XmNbottomWidget,
            e->message_text, XmNleftAttachment, XmATTACH_POSITION,
            XmNleftPosition, 2, XmNrightAttachment, XmATTACH_POSITION,
            XmNrightPosition, 3, XmNsensitive, False, NULL);
        ...
        e->delete_button = XtVaCreateWidget(
            "Delete", xmPushButtonWidgetClass, e->base_form_mgr, XmNlabelString,
            xmstr, XmNbottomAttachment, XmATTACH_WIDGET, XmNbottomWidget,
            e->message_text, XmNleftAttachment, XmATTACH_POSITION,
            XmNleftPosition, 3, XmNrightAttachment, XmATTACH_POSITION,
            XmNrightPosition, 4, XmNsensitive, False, NULL);
        ...
        e->clear_button = XtVaCreateWidget(
            "Clear", xmPushButtonWidgetClass, e->base_form_mgr, XmNlabelString,
            xmstr, XmNbottomAttachment, XmATTACH_WIDGET, XmNbottomWidget,
            e->message_text, XmNleftAttachment, XmATTACH_POSITION,
            XmNleftPosition, 4, XmNrightAttachment, XmATTACH_POSITION,
        ...
        e->close_button = XtVaCreateWidget(
            "Cancel", xmPushButtonWidgetClass, e->base_form_mgr, XmNlabelString,
            xmstr, XmNbottomAttachment, XmATTACH_WIDGET, XmNbottomWidget,
            e->message_text, XmNleftAttachment, XmATTACH_POSITION,
        ...
        xmstr = XmStringCreateLocalized(catgets(c->DT_catd, 1, 77, "Help"));
        e->help_button = XtVaCreateWidget(
            "Help", xmPushButtonWidgetClass, e->base_form_mgr, XmNlabelString,
            xmstr, XmNbottomAttachment, XmATTACH_WIDGET, XmNbottomWidget,
            e->message_text, XmNleftAttachment, XmATTACH_POSITION,
            XmNleftPosition, 6, XmNrightAttachment, XmATTACH_POSITION,
            XmNrightPosition, 7, NULL);
        XmStringFree(xmstr);

        e->separator2 = XtVaCreateWidget(
            "separator2", xmSeparatorGadgetClass, e->base_form_mgr,
            XmNbottomAttachment, XmATTACH_WIDGET, XmNbottomWidget,
            e->insert_button, XmNbottomOffset, 5, XmNleftAttachment,
            XmATTACH_FORM, XmNleftOffset, 5, XmNrightAttachment, XmATTACH_FORM,
            XmNrightOffset, 5, NULL);

        e->separator1 = XtVaCreateWidget(
            "separator1", xmSeparatorGadgetClass, e->base_form_mgr,
        ...
        e->expand_ui_button = XtVaCreateWidget(
            "expand_ui_button", xmPushButtonWidgetClass, e->base_form_mgr,
            XmNlabelString, xmstr, XmNbottomAttachment, XmATTACH_WIDGET,
            XmNbottomWidget, e->separator1, XmNbottomOffset, 3,
            XmNleftAttachment, XmATTACH_FORM, XmNleftOffset, 5,
        ...
        XtVaSetValues(e->dssw.dssw_form_mgr, XmNtopAttachment, XmATTACH_FORM,
                      XmNtopOffset, label_height + 5, XmNbottomAttachment,
                      XmATTACH_WIDGET, XmNbottomWidget, e->expand_ui_button,
                      XmNbottomOffset, 3, XmNleftAttachment, XmATTACH_FORM,
         ...
         */
        xmstr =
            XmStringCreateLocalized(catgets(c->DT_catd, 1, 627, "Drag Appt"));
        e->drag_source = XtVaCreateWidget(
            "drag_source", dtIconGadgetClass, e->dssw.dssw_form_mgr,
            ...
            XmATTACH_FORM, XmNtraversalOn, False, XmNbehavior, XmICON_DRAG,
            NULL);
        XmStringFree(xmstr);
        ...
        if ((Boolean)btn1_transfer != True) {
                XtAddEventHandler(
                    XtParent(e->drag_source), Button2MotionMask, False,
                    (XtEventHandler)FormApptDragMotionHandler, (XtPointer)c);
        }

        if (p->drag_icon_xbm)
                XtVaSetValues(e->drag_source, XmNpixmap, p->drag_icon_xbm,
                              NULL);

        XtVaSetValues(e->dssw.what_scrollwindow, XmNrightAttachment,
                      XmATTACH_WIDGET, XmNrightWidget, e->drag_source, NULL);
        ...
        ++cnt;
        e->appt_list =
            XmCreateScrolledList(e->base_form_mgr, "appt_list", args, cnt);
        ...
        XtVaSetValues(e->appt_list_sw, XmNtopAttachment, XmATTACH_FORM,
                      XmNtopOffset, label_height + 11, XmNleftAttachment,
                      XmATTACH_WIDGET, XmNleftWidget, e->dssw.dssw_form_mgr,
                      XmNleftOffset, 10, XmNrightAttachment, XmATTACH_FORM,
                      XmNrightOffset, 5, XmNbottomAttachment, XmATTACH_WIDGET,
                      XmNbottomWidget, e->expand_ui_button, XmNbottomOffset, 3,
                      NULL);

        XtManageChild(e->appt_list);
        XtAddCallback(e->appt_list, XmNbrowseSelectionCallback,
                      e_list_select_proc, e);

        XtVaSetValues(e->list_label, XmNleftAttachment,
                      XmATTACH_OPPOSITE_WIDGET, XmNleftWidget, e->appt_list_sw,
                      NULL);
        ...
        XtAddCallback(e->base_form_mgr, XmNhelpCallback,
                      ...
                      (XtPointer)APPT_EDITOR_HELP_BUTTON);

        XtVaSetValues(e->base_form_mgr, XmNdefaultButton, e->insert_button,
                      NULL);

        XtVaSetValues(e->base_form_mgr, XmNcancelButton, e->close_button, NULL);

        XmProcessTraversal(e->dssw.what_text, XmTRAVERSE_CURRENT);
        XtVaSetValues(e->base_form_mgr, XmNinitialFocus, e->dssw.what_text,
                      NULL);
...
**
*******************************************************************************/
extern void add_to_appt_list(CSA_entry_handle entry, Editor *e) {
        ...
        appt = allocate_appt_struct(
            appt_read, e->cal->general->version, CSA_ENTRY_ATTR_START_DATE_I,
            CSA_ENTRY_ATTR_SUMMARY_I, CSA_X_DT_ENTRY_ATTR_SHOWTIME_I, NULL);
...
extern void add_all_appt(Editor *e) {
        int i;
        CSA_uint32 j;
        char *date;
        Tick tick;
        ...
        date =
            get_date_from_widget(e->cal->view->date, e->dssw.date_text, o, s);
...
static void set_list_title(Editor *e) {
        Calendar *c = e->cal;
        ...
        case monthGlance:
                ...
                format_date(e->view_list_date + 1,
        ...
        if (e->view_frame) {
                ...
                XtVaSetValues(e->view_list_label, XmNlabelString, xmstr, NULL);
                XmStringFree(xmstr);
        }
}
extern void build_editor_list(Editor *e, Tick date, Glance glance,
                              CSA_entry_handle **entry_list,
                              CSA_uint32 *count) {
        int range_count;
        time_t start, stop;
        ...
        status = csa_list_entries(e->cal->cal_handle, range_count, range_attr,
                                  ops, count, entry_list, NULL);
        backend_err_msg(e->frame, e->cal->view->current_calendar, status,
                        ((Props_pu *)e->cal->properties_pu)->xm_error_pixmap);
        if (status != CSA_SUCCESS) {
                *entry_list = NULL;
...
extern int build_editor_view(Editor *e, Glance glance, Boolean redisplay) {
        int cnt;
        CSA_uint32 entry_count;
        char *buf, *what_str, str1[MAXNAMELEN], str2[MAXNAMELEN];
        CSA_entry_handle *entry_list;
        Lines *lines;
        Props *p = (Props *)e->cal->properties;
        XmString str;
        ...
        */
        ...
        if (redisplay == True) {
                ...
                build_editor_list(e, e->view_list_date, e->view_list_glance,
        ...
        */
        ...
        for (cnt = 0; cnt < entry_count; cnt++) {
                ...
                */
                status = query_appt_struct(e->cal->cal_handle, entry_list[cnt],
                                           appt);
                backend_err_msg(
                    e->frame, e->cal->view->current_calendar, status,
                    ((Props_pu *)e->cal->properties_pu)->xm_error_pixmap);
                if (status != CSA_SUCCESS) {
                        csa_free(entry_list);
                        free_appt_struct(&appt);
                ...
                int buf_size;
                if (lines && lines->s) {
                        buf_size = cm_strlen(str1) + cm_strlen(str2) +
                                   cm_strlen(lines->s) + 5;
...
boolean_t compare_repeat_info(Dtcm_appointment *old_a, RFP *rfp,
                              CSA_session_handle cal_handle, int cal_version) {
        Dtcm_appointment *appt;
        CSA_return_code status;
        CSA_enum ops[1];
        ...
        appt = allocate_appt_struct(appt_read, cal_version,
        ...
        if (old_a->repeat_type->value->item.sint32_value != rfp->repeat_type)
                return FALSE;
...
void trim_end_date_from_rule(char *rule, char *newrule, int newrule_size) {
        char *ptr;
 ...
 */
void change_rule_for_this_one_only(Calendar *c, Dtcm_appointment *new,
        ...
        if (c->general->version < DATAVER4) {
                 ...
                 * won't match
                 */
                trim_end_date_from_rule(
                    old->recurrence_rule->value->item.string_value, buf,
                    BUFSIZ);
...
extern Boolean editor_change(Dtcm_appointment *new_a, CSA_entry_handle old_a,
                             CSA_entry_handle *updated_a, Calendar *c) {
        Editor *e = (Editor *)c->editor;
        Props_pu *p = (Props_pu *)c->properties_pu;
            ...
            (appt->repeat_type->value->item.sint32_value ==
             CSA_X_DT_REPEAT_OTHER_YEARLY)) {
                ...
                char *ident4 =
                    XtNewString(catgets(c->DT_catd, 1, 95, "Continue"));
                answer = dialog_popup(
                    e->frame, DIALOG_TITLE, title, DIALOG_TEXT, text,
                ...
                answer = dialog_popup(
                    ...
                    (compare_repeat_info(appt, &(e->rfp), c->cal_handle,
                                         c->general->version)
                         ? BUTTON_IDENT
                         : BUTTON_INSENSITIVE),
...
extern void editor_clean_up(Editor *e) {
        if (e->appt_head && e->appt_count >= 0)
                csa_free(e->appt_head);
        e->appt_head = NULL;
        e->appt_count = 0;
...
extern Boolean editor_delete(CSA_entry_handle entry, Calendar *c) {
        Editor *e = (Editor *)c->editor;
        Props_pu *p = (Props_pu *)c->properties_pu;
        CSA_return_code stat;
        CSA_enum scope;
                    ...
                    CSA_X_DT_REPEAT_ONETIME) {
                        char *title = XtNewString(
                            catgets(c->DT_catd, 1, 252,
                                    "Calendar : Appointment Editor - Delete"));
                        char *text = XtNewString(
                            catgets(c->DT_catd, 1, 274,
                                    "This appointment is part of a repeating "
...
extern Boolean editor_insert(Dtcm_appointment *appt, CSA_entry_handle *new_a,
                             Calendar *c) {
        CSA_return_code stat;
        Editor *e = (Editor *)c->editor;
        Props_pu *p = (Props_pu *)c->properties_pu;
        ...
        if ((appt->repeat_type) && (appt->repeat_type->value) &&
            (appt->repeat_type->value->item.sint32_value !=
             CSA_X_DT_REPEAT_ONETIME)) {
                char *title = XtNewString(
                    catgets(c->DT_catd, 1, 1101, "Insert Appointment"));
                char *text = XtNewString(
                    catgets(c->DT_catd, 1, 984,
                            "This appointment is part of a repeating "
...
extern Boolean editor_created(Editor *e) {
...
*/
extern CSA_entry_handle editor_nth_appt(Editor *e, int idx) {
        if (idx >= 0 && idx < e->appt_count)
                return e->appt_head[idx];
        return 0;
}

extern Boolean editor_showing(Editor *e) {
        if (e)
                return e->editor_is_up;
        return False;
}

extern Boolean editor_view_showing(Editor *e) {
        if (e)
...
*/
extern void set_editor_defaults(Editor *e, Tick start, Tick stop,
                                Boolean show_notime) {
        if (start > 0 || stop > 0) {
...
extern void set_editor_title(Editor *e, char *name) {
        char buf[MAXNAMELEN];
        Calendar *c = e->cal;

        if (e->frame) {
                snprintf(buf, MAXNAMELEN, "%s - %s",
                         catgets(c->DT_catd, 1, 279,
                                 "Calendar : Appointment Editor"),
                         name);
                XtVaSetValues(e->frame, XmNtitle, buf, NULL);
        }
}

extern void set_editor_vals(Editor *e, Tick start, Tick stop) {
        if (start > 0 || stop > 0)
...
extern void show_editor(Calendar *c, time_t start, time_t stop,
                        Boolean show_notime) {
        Editor *e = (Editor *)c->editor;
        ...
        if (!editor_showing(e)) {
                ...
                XmProcessTraversal(e->dssw.what_text, XmTRAVERSE_CURRENT);
                XtVaSetValues(e->base_form_mgr, XmNinitialFocus,
                              e->dssw.what_text, NULL);
        }
...
extern void show_editor_view(Calendar *c, Glance glance) {
        Editor *e = (Editor *)c->editor;
        Props_pu *p = (Props_pu *)c->properties_pu;
        ...
        XtVaSetValues(e->view_form, XmNdefaultButton, e->view_cancel_button,
                      NULL);
        XtVaSetValues(e->view_form, XmNcancelButton, e->view_cancel_button,
                      NULL);

        if (build_editor_view(e, glance, False) <= 0) {
                char *title = XtNewString(catgets(
                    c->DT_catd, 1, 280, "Calendar : Error - Appointment List"));
                char *text = XtNewString(
                    catgets(c->DT_catd, 1, 281,
                            "Sorry, no appointments to list.     "));
                char *ident1 =
                    XtNewString(catgets(c->DT_catd, 1, 95, "Continue"));
                dialog_popup(e->cal->frame, DIALOG_TITLE, title, DIALOG_TEXT,
