...
extern List_node *hc_lookup_node(Hc_list *hc_list, caddr_t key) {
        Private *private;
...
extern caddr_t hc_lookup(Hc_list *hc_list, caddr_t key) {
        List_node *p_node;
...
extern int hc_size(Hc_list *hc_list) {
        int n = 0;
        register List_node *p_node;
...
extern Hc_list *hc_create(_DtCmsGetKeyProc get, _DtCmsCompareProc compare) {
        Private *p;
        List_node *root = NULL;
        Hc_list *list;
...
extern void hc_destroy(Hc_list *hc_list, Destroy_proc destroy_func) {
        Private *p;
...
extern Rb_Status hc_insert_node(Hc_list *hc_list, register List_node *p_node,
                                caddr_t key) {
        Private *private;
...
extern Rb_Status hc_insert(Hc_list *hc_list, caddr_t data, caddr_t key,
...
extern List_node *hc_delete_node(Hc_list *hc_list, List_node *p_node) {
...
extern List_node *hc_delete(Hc_list *hc_list, caddr_t key) {
        register List_node *p_node;
...
extern caddr_t hc_lookup_smallest(Hc_list *hc_list) {
        if ((hc_list == NULL) || (hc_list->root == NULL))
                return (NULL);
        return ((caddr_t)hc_list->root->data);
}

extern caddr_t hc_lookup_next_larger(Hc_list *hc_list, caddr_t key) {
        register List_node *p_node;
        register Private *private;
...
extern caddr_t hc_lookup_largest(Hc_list *hc_list) {
        register List_node *p_node;
...
extern caddr_t hc_lookup_next_smaller(Hc_list *hc_list, caddr_t key) {
        register List_node *p_node;
        register Private *private;
...
extern Rb_Status hc_check_list(Hc_list *hc_list) {
        if ((hc_list == NULL) || (hc_list->root == NULL))
                return (rb_notable);
        return (rb_ok);
}

extern void hc_enumerate_down(Hc_list *hc_list, _DtCmsEnumerateProc doit) {
        register List_node *p_node;
...
extern Rb_Status hc_enumerate_up(Hc_list *hc_list, _DtCmsEnumerateProc doit) {
        register List_node *p_node;
