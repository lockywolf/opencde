...
extern Rm_que *_DtCmsRemoveReminderV4 P((Rm_que * *qhead, Rm_que *p_prev,
                                         Rm_que *p_curr));

extern Rm_que *build_reminder P((time_t current_time, Appt_4 *p_appt,
...
extern void _DtCmsObsoleteReminderV4 P((Rm_que * *qhead, Appt_4 *p_appt,
                                        int ord, boolean_t delforward));

extern void _DtCmsAddReminders4Entry P((_DtCmsRemQueue * *qhead,
                                        cms_entry *entry, List_node *lnode));

extern void _DtCmsObsoleteReminder4Entry P((_DtCmsRemQueue * qhead,
                                            cms_entry *entry, List_node *lnode,
                                            time_t starttime,
                                            boolean_t delfwd));

extern CSA_return_code
    _DtCmsLookupReminder P((_DtCmsRemQueue * remq, time_t tick, uint num_names,
                            cms_attr_name *names, cms_reminder_ref **rems));
