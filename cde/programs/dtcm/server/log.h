...
typedef enum { _DtCmsLogAdd, _DtCmsLogRemove } _DtCmsLogOps;
...
extern CSA_return_code _DtCmsAppendCalAttrsByFN P((char *file, int size,
                                                   cms_attribute *attrs));
extern CSA_return_code _DtCmsAppendCalAttrsByFD P((int f, int size,
                                                   cms_attribute *attrs));

extern CSA_return_code _DtCmsAppendEntryByFN P((char *, cms_entry *,
                                                _DtCmsLogOps));
extern CSA_return_code _DtCmsAppendEntryByFD P((int, cms_entry *,
                                                _DtCmsLogOps));

extern CSA_return_code _DtCmsAppendHTableByFN P((char *file, uint size,
                                                 char **names, int *types));

extern CSA_return_code _DtCmsAppendHTableByFD P((int fd, uint size,
                                                 char **names, int *types));

extern CSA_return_code _DtCmsAppendAccessByFN P((char *, int,
                                                 Access_Entry_4 *));
...
extern int _DtCmsSetFileMode P((char *file, uid_t uid, gid_t gid, mode_t mode,
