...
#ifndef lint
static char sccsid[] =
    "@(#)cmsattr.c 1.2 94/10/05 Copyr 1991 Sun Microsystems, Inc.";
#endif
...
_DtCmsUpdateSint32AttrVal(cms_attribute_value *newval,
...
extern CSA_return_code
_DtCmsUpdateUint32AttrVal(cms_attribute_value *newval,
                          cms_attribute_value **attrval) {
        cms_attribute_value *val;
...
extern CSA_return_code
_DtCmsUpdateStringAttrVal(cms_attribute_value *newval,
                          cms_attribute_value **attrval) {
        cms_attribute_value *val;
        char *newstring = NULL;
...
extern CSA_return_code
_DtCmsUpdateAccessListAttrVal(cms_attribute_value *newval,
                              cms_attribute_value **attrval) {
        cms_attribute_value *val;
...
extern CSA_return_code
_DtCmsUpdateReminderAttrVal(cms_attribute_value *newval,
                            cms_attribute_value **attrval) {
...
extern CSA_return_code
_DtCmsUpdateDateTimeListAttrVal(cms_attribute_value *newval,
                                cms_attribute_value **attrval) {
        cms_attribute_value *val;
...
extern CSA_return_code
_DtCmsUpdateOpaqueDataAttrVal(cms_attribute_value *newval,
                              cms_attribute_value **attrval) {
        CSA_return_code stat;
        cms_attribute_value *val;
