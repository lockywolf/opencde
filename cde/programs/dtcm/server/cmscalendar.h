...
extern _DtCmsCalendar *_DtCmsMakeCalendar P((char *owner, char *name));

extern void _DtCmsPutInCalList P((_DtCmsCalendar * cal));

extern void _DtCmsFreeCalendar P((_DtCmsCalendar * cal));

extern CSA_return_code _DtCmsSetFileVersion P((_DtCmsCalendar * cal,
                                               int version));

extern CSA_return_code _DtCmsLoadCalendar P((char *target,
                                             _DtCmsCalendar **cal));

extern char *_DtCmsGetCalendarOwner P((char *target));

extern CSA_return_code _DtCmsGetCalendarByName P((char *target, boolean_t load,
                                                  _DtCmsCalendar **cal));

extern CSA_return_code _DtCmsInsertEntry4Parser P((_DtCmsCalendar * cal,
                                                   cms_entry *entry));

extern void _DtCmsSetAccess4Parser P((_DtCmsCalendar * cal,
                                      Access_Entry_4 *list, int type));

extern void _DtCmsSetCalendarAttrs4Parser P((_DtCmsCalendar * cal, int len,
                                             cms_attribute *attrs));

extern void _DtCmsGenerateKey P((_DtCmsCalendar * cal, long *key));

extern CSA_return_code _DtCmsEnumerateUp P((_DtCmsCalendar * cal,
                                            _DtCmsEnumerateProc doit));

extern void _DtCmsEnumerateDown P((_DtCmsCalendar * cal,
                                   _DtCmsEnumerateProc doit));

extern CSA_return_code _DtCmsRbToCsaStat P((Rb_Status rb_stat));

extern CSA_return_code _DtCmsGetCalAttrsByName
    P((_DtCmsCalendar * cal, uint num_names, cms_attr_name *names,
       uint *num_attrs_r, cms_attribute **attrs_r));

extern CSA_return_code
    _DtCmsGetAllCalAttrs P((_DtCmsCalendar * cal, u_int *num_attrs_r,
                            cms_attribute **attrs_r, boolean_t returnall));

extern CSA_return_code _DtCmsGetCalAttrNames P((_DtCmsCalendar * cal,
                                                uint *num_names_r,
...
extern CSA_return_code _DtCmsUpdateCalAttributesAndLog P(
    (_DtCmsCalendar * cal, uint numsrc, cms_attribute *srcattrs, uint access));

extern CSA_return_code _DtCmsV5TransactLog P((_DtCmsCalendar * cal,
                                              cms_entry *e, _DtCmsLogOps op));
