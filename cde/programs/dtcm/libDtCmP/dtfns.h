...
extern int dtfns_lookup_str(const char *, char **, char *, int, char *, int);
extern int dtfns_str_from_ref(NS_Reference_t *, int posn, char *addr_buf,
                              int addr_size, char *type_buf, int type_size);
extern int dtfns_append_to_ref(NS_Reference_t *, const char *addr,
                               const char *addr_type);
extern int dtfns_bind_str(const char *name, const char *ref_type, char *types[],
                          const char *new_str);
