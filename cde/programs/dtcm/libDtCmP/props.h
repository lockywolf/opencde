...
**  props.h
**
**  static char sccsid[] = "@(#)props.h 1.6 94/11/07 Copyr 1991 Sun
*Microsystems, Inc.";
**
...
**
*******************************************************************************/
typedef enum { HOUR12, HOUR24 } DisplayType;

typedef enum { YEAR_VIEW, MONTH_VIEW, WEEK_VIEW, DAY_VIEW } ViewType;
