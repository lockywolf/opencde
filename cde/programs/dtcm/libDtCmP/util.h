...
**  util.h
**
**  static char sccsid[] = "@(#)util.h 1.38 94/12/20 Copyr 1991 Sun
*Microsystems, Inc.";
**
...
#define DATAVER3                                                               \
        3                  /* RPC version 4 and RPC version 5 with             \
                              old file store */
...
typedef enum { ORDER_MDY, ORDER_DMY, ORDER_YMD } OrderingType;
...
extern void initialize_cal_attr P((int, CSA_attribute *, Allocation_reason,
                                   int));
extern void initialize_entry_attr P((int, CSA_attribute *, Allocation_reason,
                                     int));
...
extern void setup_range P((CSA_attribute **, CSA_enum **, int *, time_t, time_t,
                           CSA_sint32, CSA_sint32, boolean_t, int));
extern void free_range P((CSA_attribute **, CSA_enum **, int));
...
extern int parse_date P((OrderingType, SeparatorType, char *, char *, char *,
                         char *));
