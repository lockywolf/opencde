...
**  cm_tty.h
**
**  static char sccsid[] = "@(#)cm_tty.h 1.35 95/07/27 Copyr 1991 Sun
*Microsystems, Inc.";
**
...
typedef enum { TIME_MINS, TIME_HRS, TIME_DAYS } Time_scope_menu_op;

typedef enum { REPEAT_DAYS, REPEAT_WEEKS, REPEAT_MONTHS } Repeat_scope_menu_op;
...
extern char *get_datemsg P((OrderingType, SeparatorType));
...
extern Validate_op parse_appt_from_file P((nl_catd, char *, CmDataList *,
                                           ...
                                           void *, int));
extern char *parse_attrs_to_string P((Dtcm_appointment *, Props *, char *));
extern char *attrs_to_string P((CSA_attribute *, int));
extern char *create_rfc_message P((char *, char *, char **, int));
extern char *parse_appt_to_string P((CSA_session_handle, CSA_entry_handle,
                                     Props *, int));
...
extern Validate_op validate_appt P((nl_catd, Dtcm_appointment *, char *, char *,
                                    char *, int, char *, char *, char *,
                                    boolean_t (*)(void *), void *, int));
extern Validate_op validate_dssw P((Dtcm_appointment *, char *, char *, char *,
                                    int, char *, boolean_t (*)(void *),
                                    void *));
extern Validate_op validate_rfp P((nl_catd, Dtcm_appointment *, char *, char *,
                                   int));
