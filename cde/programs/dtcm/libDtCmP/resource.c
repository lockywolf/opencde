...
#ifndef lint
static char sccsid[] =
    "@(#)resource.c 1.9 94/11/07 Copyr 1993 Sun Microsystems, Inc.";
#endif
...
**
*/
extern char *get_resource(Resource *r, char *class_name, char *app_name,
                          char *name, char *default_value) {
        char *buf, *ret;

        int buf_size =
            cm_strlen(class_name) + cm_strlen(app_name) + cm_strlen(name) + 3;
...
*/
extern char *get_resource_by_val(Resource *r, char *name, char *default_value) {
        Resource *step = r;
...
*/
extern boolean_t load_resources(Resource **r, char *file_name) {
        int idx;
...
*/
extern boolean_t save_resources(Resource *r, char *file_name) {
...
*/
extern boolean_t set_resource(Resource **r, char *class_name, char *app_name,
...
*/
extern boolean_t set_resource_by_val(Resource **r, char *name, char *value) {
        Resource *step, *last;
