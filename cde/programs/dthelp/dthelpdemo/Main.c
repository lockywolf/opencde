...
static void HelpMenuCB(Widget widget, XtPointer clientData, XtPointer callData);
static void CloseCB(Widget w, XtPointer clientData, XtPointer callData);
static void ManageButtonsCB(Widget parent, XtPointer clientData,
                            XtPointer callData);
static void Control1ButtonsCB(Widget parent, XtPointer clientData,
                              XtPointer callData);
static void HelpCB(Widget widget, XtPointer clientData, XtPointer callData);
static void DisplayMoreCB(Widget w, XtPointer clientData, XtPointer callData);
static void CloseAndDestroyCB(Widget w, XtPointer clientData,
                              XtPointer callData);
...
static void CreateMainWindow(Widget parent) {
        ...
        XtAddCallback(manageForm, XmNhelpCallback, HelpCB, CREATE_FRAME);
        ...
        XtSetArg(args[n], XmNlabelString, labelString);
        n++;
        createSampleWidgetBtn = XmCreateToggleButtonGadget(
            radioBox, "createSampleWidgetBtn", args, n);
        XtManageChild(createSampleWidgetBtn);
        XmStringFree(labelString);

        XtAddCallback(createSampleWidgetBtn, XmNarmCallback, ManageButtonsCB,
                      (XtPointer)CREATE_SAMPLE);
        ...
        XtSetArg(args[n], XmNlabelString, labelString);
        n++;
        destroySampleWidgetBtn = XmCreateToggleButtonGadget(
            radioBox, "destroySampleWidgetBtn", args, n);
        XtManageChild(destroySampleWidgetBtn);
        XmStringFree(labelString);

        XtSetSensitive(destroySampleWidgetBtn, FALSE);

        XtAddCallback(destroySampleWidgetBtn, XmNarmCallback, ManageButtonsCB,
                      (XtPointer)DESTROY_SAMPLE);

        /****** Create the Control1 section Frame ******/
        n = 0;
        XtSetArg(args[n], XmNtopAttachment, XmATTACH_WIDGET);
        n++;
        XtSetArg(args[n], XmNtopWidget, manageFrame);
        n++;
        XtSetArg(args[n], XmNtopOffset, 5);
        n++;
        XtSetArg(args[n], XmNrightAttachment, XmATTACH_FORM);
        ...
        XtAddCallback(control1Form, XmNhelpCallback, HelpCB, CONTROL1_FRAME);
        ...
        n++;
        control1Title =
            XmCreateLabelGadget(control1Frame, "control1Title", args, n);
        ...
        XtAddCallback(controlBtn1, XmNarmCallback, Control1ButtonsCB,
                      (XtPointer)CHANGE_CONTENT);
        ...
        XtAddCallback(controlBtn2, XmNarmCallback, Control1ButtonsCB,
                      (XtPointer)CHANGE_SIZE);
        ...
        XtAddCallback(controlBtn3, XmNarmCallback, Control1ButtonsCB,
                      (XtPointer)CHANGE_GUI);

        /****** Create the Control2 section Frame ******/
        n = 0;
        XtSetArg(args[n], XmNtopAttachment, XmATTACH_WIDGET);
        n++;
        XtSetArg(args[n], XmNtopWidget, control1Frame);
        n++;
        XtSetArg(args[n], XmNtopOffset, 5);
        n++;
        XtSetArg(args[n], XmNrightAttachment, XmATTACH_FORM);
        ...
        XtAddCallback(control2Form, XmNhelpCallback, HelpCB, CONTROL2_FRAME);
        ...
        n++;
        control2Title =
            XmCreateLabelGadget(control2Frame, "control2Title", args, n);
        ...
        /* Create the Create Widget button */
        labelString =
            XmStringCreateLocalized("Client controled hypertext links");
        n = 0;
        XtSetArg(args[n], XmNlabelString, labelString);
        n++;
        controlBtn4 =
        ...
        XtAddCallback(controlBtn4, XmNarmCallback, Control1ButtonsCB,
                      (XtPointer)SHOW_APP_DEFINED_LINKS);
...

{
        ...
        n++;
        XtSetArg(args[n], XmNacceleratorText, accText);
        n++;
        ...
        n++;
        c[0] = helpBtn1 =
            XmCreatePushButtonGadget(menupane2, "helpBtn1", args, n);
        XtAddCallback(helpBtn1, XmNactivateCallback, HelpMenuCB,
        ...
        n = 0;
        XtSetArg(args[n], XmNaccelerator, "Ctrl <Key>A");
        n++;
        XtSetArg(args[n], XmNlabelString, labelStr);
        n++;
        XtSetArg(args[n], XmNacceleratorText, accText);
        ...
        n++;
        c[1] = helpBtn2 =
            XmCreatePushButtonGadget(menupane2, "helpBtn2", args, n);
        XmStringFree(accText);
        XmStringFree(labelStr);

        XtAddCallback(helpBtn2, XmNactivateCallback, HelpMenuCB,
                      (XtPointer)HELP_ON_TOPIC);
        ...
        n++;
        c[2] = helpBtn3 =
            XmCreatePushButtonGadget(menupane2, "helpBtn3", args, n);
        XtAddCallback(helpBtn3, XmNactivateCallback, HelpMenuCB,
                      (XtPointer)HELP_ON_VERSION);
        ...
        n = 0;
        XtSetArg(args[n], XmNmenuHelpWidget, cascadeB2);
        n++;
...
static void ManageButtonsCB(Widget parent, XtPointer clientData,
        ...
        case CREATE_SAMPLE:
                ...
                if (quickWidget == NULL) {
                        ...
                        n = 0;
                        XtSetArg(args[n], XmNtitle, "Quick Dialog Sample");
                        n++;
                        XtSetArg(args[n], DtNhelpVolume, HelpdemoHelpVol);
                        n++;
                        XtSetArg(args[n], DtNhelpType, DtHELP_TYPE_TOPIC);
                        n++;
                        XtSetArg(args[n], DtNlocationId, APP_MENU_ID);
                        n++;
                        quickWidget =
                            DtCreateHelpQuickDialog(dp, "quickWidget", args, n);

                        XtAddCallback(quickWidget, DtNcloseCallback,
                                      CloseAndDestroyCB, (XtPointer)NULL);

                        /* Add the popup position callback to our main help
                         * dialog */
                        XtAddCallback(XtParent(quickWidget), XmNpopupCallback,
                                      (XtCallbackProc)HelpMapCB, (XtPointer)dp);
...
static void Control1ButtonsCB(Widget parent, XtPointer clientData,
        ...
        case CHANGE_CONTENT:
                ...
                if (changeTopic) {
                        ...
                        XtSetArg(args[n], DtNhelpType, DtHELP_TYPE_TOPIC);
                        n++;
                        XtSetArg(args[n], DtNlocationId, CREATE_FRAME);
                        n++;
        ...
        case CHANGE_GUI:
                ...
                if (moreButton == NULL) {
                        ...
                        moreButton = DtHelpQuickDialogGetChild(
                            quickWidget, DtHELP_QUICK_MORE_BUTTON);
        ...
        case CHANGE_SIZE:
                ...
                if (rows == 0) {
                        ...
                        n = 0;
                        XtSetArg(args[n], DtNcolumns, &columns);
                        n++;
                        XtSetArg(args[n], DtNrows, &rows);
                        n++;
                ...
                if (goBigger) {
                        n = 0;
                        XtSetArg(args[n], DtNcolumns, columns + 5);
                        n++;
                        XtSetArg(args[n], DtNrows, rows + 5);
                        n++;
                        XtSetValues(quickWidget, args, n);
                        goBigger = FALSE;
                } else {
...

{
        ...
        case HELP_ON_ITEM:
                ...
                case DtHELP_SELECT_INVALID:
                        printf(
                            "You must select a component within your app.\n");
                        break;
                }
