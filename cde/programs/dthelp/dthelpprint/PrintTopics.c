...
== == == == == == == == == == == == == == == == == == == == == == == == == == ==
    == == == == == ==
    = $PTYPEBEG$ : Toc $1LINER$ : Manages the toc entries in a volume $DESCRIPT$
    : $ARGS$ : == ==
               == == == == == == == == == == == == == == == == == == == == == ==
               == == == == $SKIP$ == ==
    = * /
...
== == == == == == == == == == == == == == == == == == == == == == == == == == ==
    == == == == == ==
    = $PTYPEBEG$ : HeadFootFormat $1LINER$ : All data related to the header /
                                             footer formatting $DESCRIPT$
    : $ARGS$ : ==
               == == == == == == == == == == == == == == == == == == == == == ==
               == == == == == $SKIP$ == ==
    = * /
      ...
      typedef struct HeadFootFormat {
        char *formattedEvenHeader; /* formatted even-page header when printing
                                      volume */
        char *formattedOddHeader;  /* formatted odd-page header when printing
                                      volume */
        char *formattedEvenFooter; /* formatted even-page footer when printing
                                      volume */
        char *formattedOddFooter;  /* formatted odd-page footer when printing
                                      volume */
        int evenHeaderLineCnt; /* num lines in even-page header when printing
                                  volume */
        int oddHeaderLineCnt;  /* num lines in odd-page header when printing
                                  volume */
        int evenFooterLineCnt; /* num lines in even-page footer when printing
                                  volume */
        int oddFooterLineCnt;  /* num lines in odd-page footer when printing
                                  volume */
} HeadFootFormat;
/*$END$*/
...
== == == == == == == == == == == == == == == == == == == == == == == == == == ==
    == == == == == ==
    = $PTYPEBEG$ : HeadFootFormatArgs $1LINER$ : Arguments used in head /
                                                 foot formatting $DESCRIPT$
    : $ARGS$ : ==
               == == == == == == == == == == == == == == == == == == == == == ==
               == == == == == $SKIP$ == ==
    = * /
...
== == == == == == == == == == == == == == == == == == == == == == == == == == ==
    == == == == == ==
    = $PTYPEBEG$ : PrintState $1LINER$ : All data related to the on -
                                         going printing operation $DESCRIPT$
    : $ARGS$ : ==
               == == == == == == == == == == == == == == == == == == == == == ==
               == == == == == $SKIP$ == ==
    = * /
...
== == == == == == == == == == == == == == == == == == == == == == == == == == ==
    == == == == == ==
    = $PTYPEBEG$ : SymValue $1LINER$ : Maps a symbolic string to a printf -
                                       format string.$DESCRIPT$ : $ARGS$
    : ==
      == == == == == == == == == == == == == == == == == == == == == == == == ==
      == == $SKIP$ == ==
    = * /
...
SymValue g_HeadFootSymsList[] = {
    ...
    {"$SECTNUMFILL",
     "%%8$*7$c"},            /* filler for fixed sized section number or name */
...
== == == == == == == == == == == == == == == == == == == == == == == == == == ==
    == == == == == ==
    = $PFUNBEG$ : TocNextEntry() $1LINER$ : Get next entry in the toc $DESCRIPT$
    : $ARGS$ : $RETURNS$
    : != NULL : next entry NULL : no more entires == ==
                                  == == == == == == == == == == == == == == ==
                                  == == == == == == == == == == == $SKIP$ == ==
    = * /
#endif /*DOC*/

      static TocEntry * TocNextEntry(Toc * toc, TocEntry *entry) { /*$CODE$*/
        if (NULL == entry)
                return toc->linearEntries;
...
== == == == == == == == == == == == == == == == == == == == == == == == == == ==
    == == == == == ==
    = $PFUNBEG$ : TocFindSortedEntry() $1LINER$
    : Finds an entry using the sorted btree of entries $DESCRIPT$ : $RETURNS$
    : $ARGS$ : 0 : ok -
                   1 : entry not found ==
      == == == == == == == == == == == == == == == == == == == == == == == == ==
      == == $SKIP$ == ==
    = * /
      ...
      static int TocFindSortedEntry(Toc * toc, char *locationId,
                                    TocEntry **ret_parent,
                                    TocEntry **ret_entry) { /*$CODE$*/
        TocEntry *prev;
        TocEntry *cur;
        TocEntry *tmp;
...
== == == == == == == == == == == == == == == == == == == == == == == == == == ==
    == == == == == ==
    = $PFUNBEG$ : TocNewEntry() $1LINER$ : Add a Toc entry to the Toc $DESCRIPT$
    : $RETURNS$ : $ARGS$ : 0 : ok -
    ...
    = * /
      ...
      static int TocNewEntry(Toc * toc, char *locationId, int pageNumber,
                             int level, int *sectNums,
                             char *sectStr) { /*$CODE$*/
        TocEntry *new;

        new = calloc(1, sizeof(TocEntry));
        if (NULL == new)
                return -1; /* RETURN: mem alloc err */
...
== == == == == == == == == == == == == == == == == == == == == == == == == == ==
    == == == == == ==
    = $PFUNBEG$ : IconvFile() $1LINER$
    : Compares cur env and volume and iconv file if necessary $DESCRIPT$
    : $RETURNS$ : 0
    : no conversion needed or
      not possible to determine if needed 1 : conversion needed &successful - 1
    : conversion needed and failed $ARGS$
    : ==
      == == == == == == == == == == == == == == == == == == == == == == == == ==
      == == $SKIP$ == ==
    = * /
      ...
      static int IconvFile(_DtHPrOptions * options,
...
#define NUMSTRS 6
        ...
        _DtHelpCeXlateOpToStdLocale(DtLCX_OPER_SETLOCALE,
                                    setlocale(LC_CTYPE, NULL), &loc[CUR_LOCALE],
                                    NULL, &loc[CUR_CODESET]);
        ...
        if (NULL == loc[CUR_CODESET] || NULL == loc[VOL_CODESET] ||
        ...
        _DtHelpCeXlateStdToOpLocale(DtLCX_OPER_ICONV1, loc[VOL_LOCALE],
                                    "iso8859_1", &loc[FROM_CODESET]);

        /* get the target codeset */
        _DtHelpCeXlateStdToOpLocale(DtLCX_OPER_ICONV1, loc[CUR_LOCALE],
        ...
        sprintf(buf, options->iconvCmdAndArgs, loc[FROM_CODESET],
                loc[TO_CODESET], *srcFile, destFile);
...
static void _converter_(iconv_t CD, void *from, unsigned long from_len,
                        void **to) {
        char *InBuf;
        size_t InBytesLeft;
        char *OutBuf = NULL;
 ...
 * Iconv for buffer
 */
static int IconvBuffer(VolumeHandle helpVolumeHandle, char *src,
                       char **dest) { /*$CODE$*/
#define CUR_LOCALE 0
#define CUR_CODESET 1
#define VOL_LOCALE 2
...
== == == == == == == == == == == == == == == == == == == == == == == == == == ==
    == == == == == ==
    = $PFUNBEG$ : OpenTmpFile() $1LINER$ : Opens temporary file $DESCRIPT$
    : opens a temporary file $RETURNS$ : $ARGS$
    : == ==
      == == == == == == == == == == == == == == == == == == == == == == == == ==
      == $SKIP$ == ==
    = * /
      ...
      static FILE *
      OpenTmpFile(_DtHPrOptions * options, char **ret_tmpFile) { /*$CODE$*/
        FILE *fp;
...
== == == == == == == == == == == == == == == == == == == == == == == == == == ==
    == == == == == ==
    = $PFUNBEG$ : CountLines() $1LINER$
    : counters number of CRs in a string $DESCRIPT$
    : counters number of CRs in a string $RETURNS$ : $ARGS$
    : == ==
      == == == == == == == == == == == == == == == == == == == == == == == == ==
      == $SKIP$ == ==
    = * /
      ...
      static int CountLines(char *str) { /*$CODE$*/
        char *substr;
        int lineCount = 0;
        static char *newLine = "\n";
...
== == == == == == == == == == == == == == == == == == == == == == == == == == ==
    == == == == == ==
    = $PFUNBEG$ : AvailContentLines() $1LINER$
    : count number of lines available between top of page &footer $DESCRIPT$
    : Count number of lines available between top of page &footer $RETURNS$
    : $ARGS$ : == ==
               == == == == == == == == == == == == == == == == == == == == == ==
               == == == == $SKIP$ == ==
    = * /
      ...
      int AvailContentLines(_DtHPrOptions * options, PrintState *state,
                            HeadFootFormat *hff) { /*$DEF$*/
        return options->rowsTextHeight - ((state->curPageNumber % 2) == 0
...
== == == == == == == == == == == == == == == == == == == == == == == == == == ==
    == == == == == ==
    = $PFUNBEG$ : SectNumStr() $1LINER$
    : generates string ver of section number $DESCRIPT$
    : generates string ver of section number $RETURNS$ : $ARGS$ : buf
    : must be at least 4 *MAXSECTS chars long == ==
      == == == == == == == == == == == == == == == == == == == == == == == == ==
      == $SKIP$ == ==
    = * /
#endif /*DOC*/
      ...
      static char *
      SectNumStr(int *sectNums, char *sectStr, char *buf) { /*$CODE$*/
        char partial[5];
...
== == == == == == == == == == == == == == == == == == == == == == == == == == ==
    == == == == == ==
    = $PFUNBEG$ : OutputBlankSpaces() $1LINER$ : Outputs blank Spaces $DESCRIPT$
    : Outputs blank Spaces $RETURNS$ : $ARGS$ : topicsFP
    : pointer to output stream.If NULL,
    do nothing == == == == == == == == == == == == == == == == == == == == == ==
        == == == == == == $SKIP$ == ==
    = * /
#endif /*DOC*/

      static void OutputBlankSpaces(FILE * topicsFP,
                                    int spaceCount) { /*$CODE$*/
        if (NULL == topicsFP || spaceCount < 0)
                return;
        while (spaceCount--)
                fprintf(topicsFP, " ");
} /* $END$ */
...
== == == == == == == == == == == == == == == == == == == == == == == == == == ==
    == == == == == ==
    = $PFUNBEG$ : OutputBlankLines() $1LINER$ : Outputs blank lines $DESCRIPT$
    : Outputs blank lines $RETURNS$ : $ARGS$ : topicsFP
    : pointer to output stream.If NULL,
    do nothing == == == == == == == == == == == == == == == == == == == == == ==
        == == == == == == $SKIP$ == ==
    = * /
      ...
      static void OutputBlankLines(FILE * topicsFP, PrintState *state,
                                   int lineCount) { /*$CODE$*/
        if (lineCount < 0)
                return; /* RETURN */
...
== == == == == == == == == == == == == == == == == == == == == == == == == == ==
    == == == == == ==
    = $PFUNBEG$ : DoStrColsWidth() $1LINER$
    : Calculates number of cols used by a string; truncate if needed
$DESCRIPT$:
...
== == == == == == == == == == == == == == == == == == == == == == == == == == ==
    == == == == == ==
    = $PFUNBEG$ : GenHeadFootFormatArgs() $1LINER$
    : Generates args used by a header /
      footer format string $DESCRIPT$ : Generates args used by a header /
                                        footer format string $NOTE$ : $RETURNS$
    : $ARGS$ : ==
               == == == == == == == == == == == == == == == == == == == == == ==
               == == == == == $SKIP$ == ==
    = * /
      ...
      static void GenHeadFootFormatArgs(
          _DtHPrOptions * options, PrintState *state, Boolean updateTopicTitle,
          char *sectNumStr, Boolean updatePageNum) { /*$CODE$*/
        char *str;
        int width;
        time_t date = 0;
        struct tm *pTm;
        ...
        if (NULL == state->hffArgs.volumeTitle) {
                ...
                str = NULL;
                _DtHelpCeGetVolumeTitle(state->canvasHandle, state->volHandle,
                                        &str);
                if (NULL == str)
                        str = strdup("");
        ...
        if (NULL == state->hffArgs.volumeDate) {
                ...
                /* locDocId & locDateStamp will point to private memory; do not
                 * modify */
                _DtHelpCeGetDocStamp(state->volHandle, &locDocId,
                                     &locDateStamp);
        ...
        if (updateTopicTitle) {
                ...
                /* put into state data */
                if (state->hffArgs.topicTitle)
                        free(state->hffArgs.topicTitle);
...
{       /*$CODE$*/
        ...
        for (sym = g_HeadFootSymsList; sym->symbol != NULL; sym++) {
                ...
                while ((substr = strstr(lowLevelFormatStr, sym->symbol)) !=
                       NULL) { /* and replace it with the argref */
                        unused = False;
                        strcpy(substr, sym->argref);
                        strcpy(substr + strlen(sym->argref),
                               substr + strlen(sym->symbol));
                }
                /* if unused, add to unused list */
                if (unused)
                        strcat(unusedSyms, sym->argref);
        }
...
{       /*$CODE$*/
        ...
        GenHeadFootFormatStr(options->tocHF.evenHeader,
                             &state->tocHFF.formattedEvenHeader,
                             &state->tocHFF.evenHeaderLineCnt);
        GenHeadFootFormatStr(options->tocHF.oddHeader,
                             &state->tocHFF.formattedOddHeader,
                             &state->tocHFF.oddHeaderLineCnt);
        GenHeadFootFormatStr(options->tocHF.evenFooter,
                             &state->tocHFF.formattedEvenFooter,
                             &state->tocHFF.evenFooterLineCnt);
        GenHeadFootFormatStr(options->tocHF.oddFooter,
                             &state->tocHFF.formattedOddFooter,
                             &state->tocHFF.oddFooterLineCnt);
        /* Body */
        GenHeadFootFormatStr(options->bodyHF.evenHeader,
                             &state->bodyHFF.formattedEvenHeader,
                             &state->bodyHFF.evenHeaderLineCnt);
        GenHeadFootFormatStr(options->bodyHF.oddHeader,
                             &state->bodyHFF.formattedOddHeader,
                             &state->bodyHFF.oddHeaderLineCnt);
        GenHeadFootFormatStr(options->bodyHF.evenFooter,
                             &state->bodyHFF.formattedEvenFooter,
                             &state->bodyHFF.evenFooterLineCnt);
        GenHeadFootFormatStr(options->bodyHF.oddFooter,
                             &state->bodyHFF.formattedOddFooter,
                             &state->bodyHFF.oddFooterLineCnt);
        /* Index */
        GenHeadFootFormatStr(options->indexHF.evenHeader,
                             &state->indexHFF.formattedEvenHeader,
                             &state->indexHFF.evenHeaderLineCnt);
        GenHeadFootFormatStr(options->indexHF.oddHeader,
                             &state->indexHFF.formattedOddHeader,
                             &state->indexHFF.oddHeaderLineCnt);
        GenHeadFootFormatStr(options->indexHF.evenFooter,
                             &state->indexHFF.formattedEvenFooter,
                             &state->indexHFF.evenFooterLineCnt);
        GenHeadFootFormatStr(options->indexHF.oddFooter,
                             &state->indexHFF.formattedOddFooter,
                             &state->indexHFF.oddFooterLineCnt);
} /*$END$*/

#if DOC
== == == == == == == == == == == == == == == == == == == == == == == == == == ==
    == == == == == ==
    = $PFUNBEG$ : PrintHeadFootStr() $1LINER$
    : Formats and
      prints the header / footer string $DESCRIPT$ : Takes a format string,
    replaces the place holders with actual values,
    and prints the output to topicsFP.$NOTE$
    : This function uses the
      "%n$" prefix supported by printf(3S) to allow a footer
            / header string to ref any argument out of order
                  .This functionality requires that a ref to *every *argument be
              part of the format string.Because
              not all args may be part of the user
        - specified format string,
    this function appends the unused strings to the end of the format string
    for purposes of sprintf(),
    then truncates the unused portion before output.$RETURNS$ :
    number of lines in the header or footer $ARGS$ : topicsFP :
    pointer to output stream.If NULL, increment page and reset line number),
    but do not output;
If not NULL, request new page as well == == == == == == == == == == == == == ==
             ...
             = * /
               ...
               static int PrintHeadFootStr(
                   _DtHPrOptions * options, FILE *topicsFP, PrintState *state,
                   char *formattedStr, int lineCnt) { /*$CODE$*/
        char *newLine = "\n";
        int lastValid = 0;
        ...
        /* update args; FIX: impove efficiency by processing topic title only
         * when needed */
        ...
        /* guidelines on string size and construction:
           ...
           The fill size is calculated based on the following widths:
             ...
             volDate    : constant by locale--no fill needed e.g. "Mon, Jul 4,
           1988" dateStr    : constant by locale--no fill needed e.g. "Mon, Jul
           4, 1988"
        */
        ...
        /* print the first set */
        sprintf(buf, formattedStr, state->hffArgs.todaysDate,
                state->hffArgs.volumeTitle, state->hffArgs.topicTitle,
                (int)state->curPageNumber, state->hffArgs.volumeDate,
                sectNumStr, (int)options->colsAdjLeftMargin, (int)' ');
        ...
        sprintf(buf, formattedStr,
                MAXVOLTITLEWIDTH - state->hffArgs.volumeTitleColsWidth,
                (int)' ',
                MAXTOPICTITLEWIDTH - state->hffArgs.topicTitleColsWidth,
                (int)' ', MAXPAGENUMWIDTH - state->hffArgs.pageNumColsWidth,
                (int)' ', MAXSECTNUMWIDTH - state->hffArgs.sectNumColsWidth,
                (int)' ', &lastValid);
...
== == == == == == == == == == == == == == == == == == == == == == == == == == ==
    ...
    = * /
      ...
      static void PrintFooter(_DtHPrOptions * options, FILE *topicsFP,
                              PrintState *state, _DtHPrHeadFoot *headFootInfo,
                              HeadFootFormat *headFootFormatting) { /*$CODE$*/
        ...
        if ((state->curPageNumber % 2) == 0) /* Even page */
                state->curLineNumber +=
                    PrintHeadFootStr(options, topicsFP, state,
...
== == == == == == == == == == == == == == == == == == == == == == == == == == ==
    ...
    = * /
      ...
      static void PrintHeader(_DtHPrOptions * options, FILE *topicsFP,
                              PrintState *state, _DtHPrHeadFoot *headFootInfo,
                              HeadFootFormat *headFootFormatting) { /*$CODE$*/
...
If not NULL,
    request new page as well == == == == == == == == == == == == == == == == ==
        == == == == == == == == == == == $SKIP$ == ==
    = * /
#endif /*DOC*/

      static void NewPage(_DtHPrOptions * options, FILE *topicsFP,
                          PrintState *state, Boolean advancePage) { /*$CODE$*/
        /* start new page: form feed */
        if (topicsFP) {
                if (advancePage)
                        fprintf(topicsFP, "\n");

                /* print top margin but don't add it to line count because the
                   rowsTextHeight value is calculated post-topMargin */
...
If not NULL, output lines and page headers == == == == == == == == == == == ==
             ...
             = * /
               ...
               static int ProcessOneTopic(
                   _DtHPrOptions * options, FILE *topicsFP, PrintState *state,
                   Boolean printHeaderFooter) { /*$CODE$*/
        char **helpList = NULL;
        char **ptrToLst;
        int lineCount;
        int availLines;
        ...
        if (_DtHelpTermGetTopicData(state->canvasHandle, state->volHandle,
                                    state->currentLocId, &helpList,
                                    NULL) != 0) {
                fprintf(
                    stderr,
                    _DTGETMESSAGE(PTSET, 5,
        ...
        if (sectNumStr[0] != EOS) {
                /* NOTE: if allow the sect num string to be resource-defined,
                   then count the number of \n chars in it; don't assume how
                   many. */
                if (topicsFP)
                        fprintf(topicsFP, "\n");
                OutputBlankSpaces(topicsFP, options->colsAdjLeftMargin);
                if (topicsFP)
                        fprintf(topicsFP, "%s ", sectNumStr);
                state->curLineNumber++;

                /* and put the title (must be on first two lines) on the same
                 * line */
                if ((*helpList && (*helpList)[0] != EOS) ||
                    (*(++helpList) && (*helpList)[0] != EOS)) {
                        if (topicsFP) {
                                ...
                                ret = IconvBuffer(state->volHandle, *helpList,
                                                  &_p);
                                if (ret) {
                                        fprintf(topicsFP, "%s\n",
                                                _p); /* output title */
                        ...
                        state->curLineNumber +=
                            CountLines(*helpList) + 1; /* 1=the known \n */
                        helpList++;
                }
        }
        ...
        for (; *helpList != NULL; helpList++) {
                ...
                /* if at the end of a page, print footer, eject, and print
                 * header */
                if (state->curLineNumber >= availLines) {
                        ...
                        if (printHeaderFooter)
                                PrintFooter(options, topicsFP, state,
                                            &options->bodyHF, &state->bodyHFF);
                        NewPage(options, topicsFP, state, True);
                        if (printHeaderFooter)
                                PrintHeader(options, topicsFP, state,
                                            &options->bodyHF, &state->bodyHFF);

                        /* recalc the line we're on */
                        state->curLineNumber += linesCnt;

                        /* calc number of available lines from top of page to
                         * footer */
                        availLines =
                            AvailContentLines(options, state, &state->bodyHFF);
                }
...
INHIBIT_OUTPUT:  stop outputting children;
we printed all we need to $ARGS$ : level
    : may range from 1 to(MAXSECTS - 1) == ==
      == == == == == == == == == == == == == == == == == == == == == == == == ==
      == $SKIP$ == ==
    = * /
#endif /*DOC*/
      static int ProcessSubTopics(_DtHPrOptions * options, FILE *topicsFP,
                                  Toc *toc, int level,
                                  PrintState *state) { /*$CODE$*/
        char **children = NULL;
        int ret = 0;
        int firstSubSectNum;
        int subSectNumIndex;
...
#define INHIBIT_OUTPUT (-3)
        ...
        if (_DtHelpCeStrCaseCmp(state->outputFromLocId, state->currentLocId) ==
            0) {
                int curPos;

                /* toggle the flag and set ret value */
                state->inhibitOutput = False;
                ret = INHIBIT_OUTPUT; /* stop printing after this topic & its
                                         children */

                curPos = state->curLineNumber; /* save off the current line
                                                  position */

                /* start new page but don't eject; output header;
                   output right number of blank lines to get to where topic
                   starts */
                NewPage(options, topicsFP, state, False);
                PrintHeader(options, topicsFP, state, &options->bodyHF,
                            &state->bodyHFF);
                OutputBlankLines(topicsFP, state,
                                 curPos - state->curLineNumber);
        }
        ...
        if (_DtHelpCeGetTopicChildren(state->volHandle, state->currentLocId,
                                      &children) > 0) {
                char **topic;
                ...
                for (topic = children; *topic != NULL && (*topic)[0]; topic++) {
                        ...
                        if (subSectNumIndex < 2) {
                                PrintFooter(options, curFP, state,
                                            &options->bodyHF, &state->bodyHFF);
                                NewPage(options, curFP, state, True);
                                PrintHeader(options, curFP, state,
                                            &options->bodyHF, &state->bodyHFF);
                        }

                        /* avoid orphans (i.e. require more than 4 lines left on
                         * page) */
                        if ((AvailContentLines(options, state,
                                               &state->bodyHFF) -
                        ...
                        if (initSubSect) {
                                /* start new subsection; -1: make up for ++
                                 * later */
                                state->sectNums[subSectNumIndex] =
                                    firstSubSectNum - 1;
                                initSubSect = False;
                        }
                        ...
                        /* use subSectNumIndex, not level, so that the top topic
                           and its immediate children are at the same level */
                        /* inc the sect num before the call so that the
                           sect used below in the INHIBIT_OUTPUT wrapup is
                           correct. */
                        /* pass in topicsFP, not curFP */
                        state
                            ->sectNums[subSectNumIndex]++; /* next subsection */
                        /* even though ProcessSubTopics() can return
                           'INHIBIT_OUTPUT', don't stop processing, as this
                           would cause the Toc to be incomplete. */
                        ProcessSubTopics(options, topicsFP, toc,
                                         subSectNumIndex + 1, state);
                        /* ProcessSubTopics(options,topicsFP,toc,
                         * state->level+1,state); */
                }
        }
        ...
        if (ret == INHIBIT_OUTPUT) {
                ...
                /* output footer */
                PrintFooter(options, curFP, state, &options->bodyHF,
                            &state->bodyHFF);
        ...
        if (subSectNumIndex > 1)
                state->sectNums[subSectNumIndex] = 0;
...
== == == == == == == == == == == == == == == == == == == == == == == == == == ==
    == == == == == ==
    = $PFUNBEG$ : ProcessFrontMatter() $1LINER$
    : Process the help volume to generate a file of front matter $DESCRIPT$
    : Process the help volume to generate a file of front matter $RETURNS$ : 0
    : success -
      1 : could not create or
      open a temp file - 2 : could not get help topic info $ARGS$
    : ==
      == == == == == == == == == == == == == == == == == == == == == == == == ==
      == == $SKIP$ == ==
    = * /
      ...
      static int ProcessFrontMatter(_DtHPrOptions * options,
...
== == == == == == == == == == == == == == == == == == == == == == == == == == ==
    == == == == == ==
    = $PFUNBEG$ : ProcessIndex() $1LINER$
    : Process the TOC data to generate an index file $DESCRIPT$
    : Process the TOC data to generate an index file $WARNING$
    : This function uses state->pageNumber +
          1 as the first page of the index.$RETURNS$ : 0 : success -
          1 : could not create or
      open a temp file - 2 : could not get help topic info $ARGS$
    : ==
      == == == == == == == == == == == == == == == == == == == == == == == == ==
    ...
    = * /
      ...
      static int ProcessIndex(_DtHPrOptions * options, char **ret_resultsFile,
                              PrintState *state, Toc *toc) { /*$CODE$*/
        FILE *fp;
        int ret;
        int availLines;
        ...
        *ret_resultsFile = NULL;
        ...
        entriesCnt =
            _DtHelpCeGetKeywordList(state->volHandle, &indexEntriesList);
        if (entriesCnt <= 0)
                return 0;
        ...
        for (entryStr = *indexEntriesList++; NULL != entryStr;
             entryStr = *indexEntriesList++) {
                ...
                topicCnt = _DtHelpCeFindKeyword(state->volHandle, entryStr,
                                                &topicIdsList);
                if (topicCnt <= 0)
                        continue; /* CONTINUE */
                ...
                if (topicCnt == 1) {
                        ...
                        ret = TocFindSortedEntry(toc, *topicIdsList, NULL,
                                                 &tocEntry);
                        if (ret < 0)
                                continue; /* CONTINUE */
                        ...
                        OutputBlankSpaces(fp, options->colsAdjLeftMargin);
                        {
                                ...
                                ret = IconvBuffer(state->volHandle, entryStr,
                                                  &_p);
                                if (ret) {
                                        fprintf(fp,
                                                _DTGETMESSAGE(PTSET, 20,
                                                              "%s, %d\n"),
                        ...
                        /* if at the end of a page, print footer, eject, and
                         * print header */
                        if (state->curLineNumber >= availLines) {
                                PrintFooter(options, fp, state,
                                            &options->indexHF,
                                            &state->indexHFF);
                                NewPage(options, fp, state, True);
                                PrintHeader(options, fp, state,
                                            &options->indexHF,
                                            &state->indexHFF);
                                /* calc number of available lines from top of
                                 * page to footer */
                                availLines = AvailContentLines(
                                    options, state, &state->indexHFF);
                        }

                        continue; /* CONTINUE */
                }

                /*** if more than one topic, list topic title & page number
                 * under the entry ***/

                /* do we need a new page to start this entry? */
                if ((availLines - state->curLineNumber) < 3) {
                        PrintFooter(options, fp, state, &options->indexHF,
                                    &state->indexHFF);
                        NewPage(options, fp, state, True);
                        PrintHeader(options, fp, state, &options->indexHF,
                                    &state->indexHFF);
                        /* calc number of available lines from top of page to
                         * footer */
                        availLines =
                            AvailContentLines(options, state, &state->indexHFF);
                }
                ...
                for (i = 0; i < topicCnt; i++, topicIdsList++) {
                        char *topicTitle;

                        if (NULL == *topicIdsList)
                                continue; /* CONTINUE */
                        ...
                        _DtHelpCeGetTopicTitle(
                            state->canvasHandle, state->volHandle,
                            tocEntry->locationId, &topicTitle);
                        if (NULL == topicTitle)
                                topicTitle =
                                    _DTGETMESSAGE(PTSET, 31, EMPTY_STR);
                        ...
                        OutputBlankSpaces(fp, options->colsAdjLeftMargin);
                        {
                                ...
                                ret = IconvBuffer(state->volHandle, topicTitle,
                                                  &_p);
                                if (ret) {
                                        fprintf(fp,
                                                _DTGETMESSAGE(PTSET, 21,
                                                              "     %s, %d\n"),
                                                _p, tocEntry->pageNumber);
                                } else {
                                        fprintf(fp,
...
== == == == == == == == == == == == == == == == == == == == == == == == == == ==
    == == == == == ==
    = $PFUNBEG$ : ProcessToc() $1LINER$
    : Process the TOC data to generate a toc file $DESCRIPT$
    : Process the TOC data to generate a toc file $RETURNS$ : 0 : success -
                                                                  1
    : could not create or
      open a temp file - 2 : could not get help topic info $ARGS$
    : ==
    ...
    = * /
      ...
      static int ProcessToc(_DtHPrOptions * options, char **ret_resultsFile,
                            PrintState *state, Toc *toc) { /*$CODE$*/
        FILE *fp;
        int availLines;
        TocEntry *entry;
        ...
        state->sectNums[0] = 0; /* inhibit section num printing */
        state->sectStr =
            _DTGETMESSAGE(PTSET, 11, "Table of Contents"); /* $SECTNUM name */
        ...
        for (entry = TocNextEntry(toc, NULL); NULL != entry;
             entry = TocNextEntry(toc, entry)) {
                ...
                if (wctitle) {
                        ...
                        if (titlelen > options->colsTextWidth - lhsWidth) {
                                wctitle[options->colsTextWidth - lhsWidth - 1] =
                                    EOS;
                                titlelen = wcslen(wctitle);
                        }
                ...
                if (0 == entry->sectNums[2]) {
                        ...
                        if ((availLines - state->curLineNumber) < 3) {
                                PrintFooter(options, fp, state, &options->tocHF,
                                            &state->tocHFF);
                                NewPage(options, fp, state, True);
                                PrintHeader(options, fp, state, &options->tocHF,
                                            &state->tocHFF);
                                /* calc number of available lines from top of
                                 * page to footer */
                                availLines = AvailContentLines(options, state,
                                                               &state->tocHFF);
                        }
                }
                ...
                if (sectNumStr[0] == EOS) /* no section number */
                {
                        ...
                        blanksCnt =
                            ((options->colsTextWidth - lhsWidth) - 3) + 1;
                ...
                if (state->curLineNumber >= availLines) {
                         ...
                         * footer */
                        availLines =
                            AvailContentLines(options, state, &state->tocHFF);
                }
        } /* for all entries */
...
{       /*$CODE$*/
        ...
        if (NULL == outputFromLocId && inhibitTopicsOutput)
                fp = NULL;
        else { /* output is desired...open file */
                fp = OpenTmpFile(options, ret_resultsFile);
                if (NULL == fp)
                        return -1; /* RETURN: error */
        }
        ...
        if (processSubTopics) {
                ...
                ret = _DtHelpCeGetTopTopicId(state->volHandle,
                                             &state->currentLocId);
                if (ret != True)
                        state->currentLocId = strdup("_HOMETOPIC");
                if (name)
                        free(name);
        } else { /* otherwise, process only where needed */
        ...
        if (processSubTopics) {
                ...
                PrintHeader(options, fp, state, &options->bodyHF,
                            &state->bodyHFF);

                ret = ProcessOneTopic(options, fp, state, True);

                /* output footer */
                PrintFooter(options, fp, state, &options->bodyHF,
                            &state->bodyHFF);
        }
...
== == == == == == == == == == == == == == == == == == == == == == == == == == ==
    == == == == == ==
    = $PFUNBEG$ : MakePageBreakFile() $1LINER$
    : Creates a file with only a page break char in it $DESCRIPT$
    : Creates a file with only a page break char in it.If fails,
    file ptr is NULL $RETURNS$ : $ARGS$ : == == == == == == == == == == == == ==
                                          == == == == == == == == == == == == ==
                                          == == $SKIP$ == ==
    = * /
#endif /*DOC*/

      static void MakePageBreakFile(_DtHPrOptions * options,
                                    char **ret_resultsFile) { /*$CODE$*/
        FILE *fp;
...
== == == == == == == == == == == == == == == == == == == == == == == == == == ==
    == == == == == ==
    = $PFUNBEG$ : DoHelpTopicsProcessing() $1LINER$
    : Passes through entire volume and generates toc and topic output $DESCRIPT$
    : Passes through entire volume and generates toc and topic output
          $RETURNS$ : 0 : success -
                          1 : could not create or
      open a temp file - 2 : could not get help topic info -
                             3 : could not alloc memory $ARGS$
    : ==
      == == == == == == == == == == == == == == == == == == == == == == == == ==
      == == $SKIP$ == ==
    = * /
      ...
      static int DoHelpTopicsProcessing(
          _DtHPrOptions * options, char **ret_resultsFile, Boolean processToc,
          Boolean processIndex, Boolean processFrontMatter,
          Boolean processSubTopics, char *outputFromLocId,
          Boolean inhibitTopicsOutput) { /*$CODE$*/
#define FM 0
#define TOC 1
#define TOPICS 2
#define INDEX 3
#define NUMPARTS 4
        ...
        ret = _DtHelpTermCreateCanvas(options->colsTextWidth,
                                      &state.canvasHandle);
        if (ret != 0)
                return ret; /* RETURN: error */

        /* open volume and get state.volHandle */
        ret = _DtHelpCeOpenVolume(state.canvasHandle, options->helpVolume,
                                  &state.volHandle);
        if (ret != 0)
                return ret; /* RETURN: error */
        ...
        /* after this point, if we get an error, we don't return--we do the best
         * we can */
        ...
        ret = ProcessTopics(options, &partFiles[TOPICS], &state, &toc,
                            processSubTopics, outputFromLocId,
                            inhibitTopicsOutput);

        /*** process toc to create an index and add an index entry to toc ***/
        /* Do this right after processing topics so that page number info is
         * right */
        if (processIndex)
        ...
        *ret_resultsFile = _DtHPrCreateTmpFile(TMPFILE_PREFIX, TMPFILE_SUFFIX);
        ...
        for (i = 0; i < NUMPARTS; i++) {
                if (partFiles[i]) {
                        /* if at least one file in cat list, separate from it
                         * with a pgbrk */
...
== == == == == == == == == == == == == == == == == == == == == == == == == == ==
    == == == == == ==
    = $PFUNBEG$ : GenerateTopicsFile() $1LINER$
    : Recovers and formats help topic text and then sends to printer $DESCRIPT$
    : Recovers and formats help topic text and then sends to printer $RETURNS$
    : $ARGS$ : == ==
               == == == == == == == == == == == == == == == == == == == == == ==
               == == == == $SKIP$ == ==
    = * /
      ...
      static int GenerateTopicsFile(Display * dpy, _DtHPrOptions *options,
                                    char **ret_resultsFile) { /*$CODE$*/
        int ret = 0;
        ...
        if (oneTopic || dfltOneTopic)
                /* False: no subtopics--output only locationId; False: don't
                 * inhibit output */
                ret = DoHelpTopicsProcessing(options, ret_resultsFile, False,
                                             False, frontMatter, False,
                                             locationId, False);
        else if (allTopics)
                /* start at root and don't inhibit output */
                ret = DoHelpTopicsProcessing(options, ret_resultsFile, True,
                                             True, True, True, NULL, False);
        else
                ret = DoHelpTopicsProcessing(options, ret_resultsFile, toc,
                                             index, frontMatter, subTopics,
                                             locationId, True);
...
== == == == == == == == == == == == == == == == == == == == == == == == == == ==
    == == == == == ==
    = $FUNBEG$ : _DtHPrPrintHelpTopic() $1LINER$
    : Recovers and formats help topic text and then sends to printer $DESCRIPT$
    : Recovers and formats help topic text and then sends to printer $RETURNS$
    : $ARGS$ : == ==
               == == == == == == == == == == == == == == == == == == == == == ==
    ...
    = * /
      ...
      int _DtHPrPrintHelpTopic(Display * dpy,
                               _DtHPrOptions *options) { /*$CODE$*/
        char *printCommand;
        char cmdFormat[100];
        char prOffsetArg[30];
        char *tmpFile;
        ...
        options->helpVolume =
            path; /* don't free old helpVolume: owned by Xrm */
...
#define DEFAULT_FONT                                                           \
        "-agfa-courier-normal-r-normal-93950-0-120-300-300-m-0-hp-roman8"
