 ...
 */
/* $XConsortium: error.c /main/3 1995/11/08 11:39:17 rswiston $ */
...
#else
void eprefix(flag) LOGICAL flag;
#endif
{
        if (flag)
                errexit = TRUE;
...
/* Print something to both stderr and m_errfile */
void msg1line(text, arg1) char *text, *arg1;
{
...
void m_trace(text) char *text;
{ m_errline(text); }

void m_wctrace(text) M_WCHAR *text;
{
        char *mb_text;
...
#else
void warning1(text, arg) char *text;
M_WCHAR *arg;
#endif
{
        char *mb_arg;
...
#else
void warning2(text, arg1, arg2) char *text;
M_WCHAR *arg1, *arg2;
#endif
{
        char *mb_arg1, *mb_arg2;
...
#else
void warning3(text, arg1, arg2, arg3) char *text;
M_WCHAR *arg1, *arg2, *arg3;
#endif
{
        char *mb_arg1, *mb_arg2, *mb_arg3;
...
void warning4(char *text, M_WCHAR *arg1, M_WCHAR *arg2, M_WCHAR *arg3,
              M_WCHAR *arg4)
#else
void warning4(text, arg1, arg2, arg3, arg4) char *text;
