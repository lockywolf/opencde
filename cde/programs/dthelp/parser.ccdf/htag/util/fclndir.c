 ...
 */
/* $XConsortium: fclndir.c /main/3 1995/11/08 11:39:49 rswiston $ */
...
char **argv;
{
        ...
        while (c1 != EOF && c2 != EOF) {
                if (c1 != c2) {
                        fprintf(stderr,
                                "%s and %s are different; copying source...\n",
                                argv[1], argv[2]);
...
void copyfile(pfile1, pfile2) char *pfile1, *pfile2;
{
        int ret;
        char *pcmd;
