...
void calcdisp(
#if defined(M_PROTO)
    M_WCHAR *file, M_WCHAR *startrow, M_WCHAR *endrow, M_WCHAR *clip,
    M_WCHAR *margin
#endif
);
...
void figraster(
#if defined(M_PROTO)
    M_WCHAR *file, M_WCHAR *magnify, M_WCHAR *width, M_WCHAR *depth,
    M_WCHAR *hadjust, M_WCHAR *vadjust, M_WCHAR *mirror, M_WCHAR *margin,
    M_WCHAR *clip, M_WCHAR *penwidth, M_WCHAR *plottype, M_WCHAR *callout,
    M_WCHAR *textsize
#endif
);
...
void figstart(
    ...
    M_WCHAR *type, M_WCHAR *oldtype, M_WCHAR *xmagnify, M_WCHAR *xwidth,
    M_WCHAR *xdepth, M_WCHAR *xhadjust, M_WCHAR *xvadjust, M_WCHAR *border,
    M_WCHAR *video, M_WCHAR *strip, M_WCHAR *mirror, M_WCHAR *margin,
    M_WCHAR *clip, M_WCHAR *penwidth, M_WCHAR *snap, M_WCHAR *autoscale,
...
void figvector(
    ...
    M_WCHAR *file, M_WCHAR *magnify, M_WCHAR *width, M_WCHAR *depth,
    M_WCHAR *hadjust, M_WCHAR *vadjust, M_WCHAR *mirror, M_WCHAR *margin,
    M_WCHAR *clip, M_WCHAR *penwidth, M_WCHAR *autoscale, M_WCHAR *plottype,
...
void setid(
#if defined(M_PROTO)
    M_WCHAR *id, LOGICAL where, LOGICAL csensitive, LOGICAL inchapter,
...
void shchar(
#if defined(M_PROTO)
    M_WCHAR textchar, int *len, int max, M_WCHAR *string,
...
void mb_shchar(
#if defined(M_PROTO)
    char textchar, int *len, int max, M_WCHAR *string,
    void (*proc)(M_WCHAR *string), char *msg, LOGICAL *errflg
#endif
);
...
void shstring(
#if defined(M_PROTO)
    M_WCHAR *addstring, int *len, int max, M_WCHAR *storestring, char *msg,
    LOGICAL *errflg
#endif
);
...
void mb_shstring(
#if defined(M_PROTO)
    char *addstring, int *len, int max, M_WCHAR *storestring, char *msg,
    LOGICAL *errflg
#endif
);
...
void starthelpnode(
#if defined(M_PROTO)
    M_WCHAR *id, LOGICAL suppress_topic_map
#endif
);

void mb_starthelpnode(
#if defined(M_PROTO)
    char *id, LOGICAL suppress_topic_map
#endif
);
...
void t_tabstart(
    ...
    M_WCHAR *spacing, M_WCHAR *width, M_WCHAR *position, M_WCHAR *tonumber,
    M_WCHAR *divide, M_WCHAR *textsize
#endif
);
...
#if defined(M_PROTO)
    char *elementName, unsigned char desiredType, char *defaultString
#endif
);
...
void paragraph(
#if defined(M_PROTO)
    M_WCHAR *indent, M_WCHAR *id, M_WCHAR *gentity, M_WCHAR *gposition,
...
void figure(
    ...
    M_WCHAR *xdepth, M_WCHAR *xhadjust, M_WCHAR *xvadjust, M_WCHAR *border,
    M_WCHAR *type, M_WCHAR *xmagnify, M_WCHAR *video, M_WCHAR *strip,
    M_WCHAR *mirror, M_WCHAR *margin, M_WCHAR *clip, M_WCHAR *penwidth,
    M_WCHAR *snap, M_WCHAR *autoscale, M_WCHAR *plottype, M_WCHAR *callout,
    M_WCHAR *textsize, M_WCHAR *ghyperlink, M_WCHAR *glinktype,
...
void endterm(
#if defined(M_PROTO)
    M_WCHAR *base, M_WCHAR *gloss, int linktype
#endif
);
