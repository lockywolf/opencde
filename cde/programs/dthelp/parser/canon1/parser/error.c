...
#else
void m_err1(text, arg) char *text;
M_WCHAR *arg;
#endif
{
        char *buffer, *mb_arg;
        ...
        buffer = (char *)m_malloc(strlen(text) + strlen(mb_arg) - 2 + 1,
                                  "error message");
...
#else
void m_err2(text, arg1, arg2) char *text;
M_WCHAR *arg1;
M_WCHAR *arg2;
#endif
{
        ...
        buffer = (char *)m_malloc(strlen(text) + strlen(mb_arg1) +
                                      strlen(mb_arg2) - 4 + 1,
                                  "error message");
...
#else
void m_err3(text, arg1, arg2, arg3) char *text;
M_WCHAR *arg1;
M_WCHAR *arg2;
M_WCHAR *arg3;
#endif
{
        ...
        buffer = (char *)m_malloc(strlen(text) + strlen(mb_arg1) +
                                      strlen(mb_arg2) + strlen(mb_arg3) - 6 + 1,
                                  "error message");
...
#if defined(M_PROTO)
void m_err4(char *text, M_WCHAR *arg1, M_WCHAR *arg2, M_WCHAR *arg3,
            M_WCHAR *arg4)
#else
void m_err4(text, arg1, arg2, arg3, arg4) char *text;
M_WCHAR *arg1;
M_WCHAR *arg2;
M_WCHAR *arg3;
M_WCHAR *arg4;
#endif
{
        ...
        buffer =
            (char *)m_malloc(strlen(text) + strlen(mb_arg1) + strlen(mb_arg2) +
                                 strlen(mb_arg3) + strlen(mb_arg4) - 8 + 1,
                             "error message");
...
#else
void m_err5(text, arg1, arg2, arg3, arg4, arg5) char *text;
M_WCHAR *arg1;
M_WCHAR *arg2;
M_WCHAR *arg3;
M_WCHAR *arg4;
...
#endif
{
        ...
        buffer = (char *)m_malloc(
            strlen(text) + strlen(mb_arg1) + strlen(mb_arg2) + strlen(mb_arg3) +
                strlen(mb_arg4) + strlen(mb_arg5) - 10 + 1,
            "error message");
        sprintf(buffer, text, mb_arg1, mb_arg2, mb_arg3, mb_arg4, mb_arg5);
        m_errline(buffer);
        m_free(buffer, "error message");
        m_free(mb_arg1, "multi-byte string");
        m_free(mb_arg2, "multi-byte string");
...
#else
void m_err6(text, arg1, arg2, arg3, arg4, arg5, arg6) char *text;
M_WCHAR *arg1;
M_WCHAR *arg2;
M_WCHAR *arg3;
M_WCHAR *arg4;
...
#endif
{
        ...
        buffer = (char *)m_malloc(
            strlen(text) + strlen(mb_arg1) + strlen(mb_arg2) + strlen(mb_arg3) +
                strlen(mb_arg4) + strlen(mb_arg5) + strlen(mb_arg6) - 12 + 1,
            "error message");
        sprintf(buffer, text, mb_arg1, mb_arg2, mb_arg3, mb_arg4, mb_arg5,
                mb_arg6);
        m_errline(buffer);
...
#else
void m_err7(text, arg1, arg2, arg3, arg4, arg5, arg6, arg7) char *text;
M_WCHAR *arg1;
M_WCHAR *arg2;
M_WCHAR *arg3;
M_WCHAR *arg4;
...
#endif
{
        ...
        buffer = (char *)m_malloc(
            strlen(text) + strlen(mb_arg1) + strlen(mb_arg2) + strlen(mb_arg3) +
                strlen(mb_arg4) + strlen(mb_arg5) + strlen(mb_arg6) +
                strlen(mb_arg7) - 14 + 1,
            "error message");
        sprintf(buffer, text, mb_arg1, mb_arg2, mb_arg3, mb_arg4, mb_arg5,
                mb_arg6, mb_arg7);
...
/* Getline.c returns the name of the current input file and the number
   of the current line */
void m_getline(file, line) M_WCHAR **file;
int *line;
{
        int i;
...
int m_thisline(M_NOPAR) { return (m_line[m_sysecnt]); }
