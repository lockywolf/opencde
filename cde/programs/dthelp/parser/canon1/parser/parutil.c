...
M_ELEMENT m_eltname(M_NOPAR) {
        ...
        if (eltid = m_packedlook(m_entree, m_name))
                return (eltid);
        else {
...
void m_initialize(M_NOPAR) {
        ...
        m_signmsg("(c) Copyright 1993, 1994, 1995 International Business "
                  "Machines Corp.\n");
        m_signmsg("(c) Copyright 1993, 1994, 1995 Sun Microsystems, Inc.\n");
        m_signmsg("(c) Copyright 1993, 1994, 1995 Unix System Labs, Inc., a "
