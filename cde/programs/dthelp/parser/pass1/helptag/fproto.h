...
void starthelpnode(
#if defined(M_PROTO)
    M_WCHAR *ssi, M_WCHAR *id, int level
#endif
);

void mb_starthelpnode(
#if defined(M_PROTO)
    char *ssi, char *id, int level
#endif
);

void StartLabList(
#if defined(M_PROTO)
    M_WCHAR *spacing, M_WCHAR *longlabel
#endif
);
...
void figure(
    ...
    M_WCHAR *figpos, M_WCHAR *cappos, M_WCHAR *ghyperlink, M_WCHAR *glinktype,
...
void endterm(
#if defined(M_PROTO)
    M_WCHAR *base, M_WCHAR *gloss, char *linktype
#endif
);
...
void HandleLink(
#if defined(M_PROTO)
    M_WCHAR *hyperlink, M_WCHAR *type, M_WCHAR *description
#endif
);
...
void PushForm(
#if defined(M_PROTO)
    char *class, char *ssi, char *id
#endif
);

void PushForm2(
#if defined(M_PROTO)
    char *class, char *ssi, char *id1, char *id2
#endif
);
