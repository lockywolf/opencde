...
int m_getc(m_ptr) void *m_ptr;
{
        ...
        do {
                ...
                while (1) {
                        ...
                        /* --------------------------------------------------------------
                         */
                        /*  Note that the call to fflush before each call to
                         * getc is      */
                        /*  a workaround for a bug in the re-entrant
                         * (thread-safe) getc   */
                        /*  function. Earlier versions of AIX did not have this
                         * problem.  */
                        /*  Made it very specific to AIX 4.2. The bug might
                         * appear again  */
                        /*  in future releases of AIX. Hopefully this comment
                         * would help  */
                        /*  to identify the problem quickly in case it appears
                         * again.     */
                        /* --------------------------------------------------------------
                         */
                        fflush(NULL);
...
/* Open input file */
void *m_openfirst(M_NOPAR) { return ((void *)inFile); }
