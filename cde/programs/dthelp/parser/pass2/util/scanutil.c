 ...
 */
/* $XConsortium: scanutil.c /main/3 1995/11/08 11:07:21 rswiston $ */
...
LOGICAL litproc(delim) int delim;
{
        int n, i, number;
        ...
        for (i = 0; i < M_LITLEN; i++) {
                ...
                case LITA:
                        ...
                        pStart = p =
                            MakeWideCharString((n == LIT) ? lit : lita);
...
void undodelim(delim) M_WCHAR *delim;
{
        M_WCHAR *p;
