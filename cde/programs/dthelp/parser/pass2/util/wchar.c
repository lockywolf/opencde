 ...
 */
/* $XConsortium: wchar.c /main/3 1995/11/08 11:09:48 rswiston $ */
/*
...
#else
int w_strcmp(string1, string2) M_WCHAR *string1;
M_WCHAR *string2;
#endif
{
        M_WCHAR c1, c2, null;
...
#else
int w_strcmp(string1, string2, max) M_WCHAR *string1;
M_WCHAR *string2;
int max;
#endif
{
...
#else
M_WCHAR *w_strcpy(string1, string2) M_WCHAR *string1;
M_WCHAR *string2;
#endif
{
...
#else
M_WCHAR *w_strncpy(string1, string2, max) M_WCHAR *string1;
M_WCHAR *string2;
int max;
#endif
{
...
#else
int w_strlen(string) M_WCHAR *string;
#endif
{
        int length;
...
#else
M_WCHAR *w_strchr(string, chr) M_WCHAR *string, chr;
#endif
{
        M_WCHAR *where;
...
#else
M_WCHAR *w_strstr(string1, string2) M_WCHAR *string1, *string2;
#endif
{
...
#else
char *MakeMByteString(wc_string) M_WCHAR *wc_string;
#endif
{
        char *mb_string;
        int length, retVal;
        ...
        /* Do a little work to compensate for m_malloc allocating
         * sizeof(M_WCHAR) bytes for each increment in the size requested.
         */
...
#else
M_WCHAR *MakeWideCharString(mb_string) char *mb_string;
#endif
{
        ...
        while (mb_string[length]) {
                if ((incr = mbtowc(wc_string, &mb_string[length], MB_CUR_MAX)) <
                    0) {
...
int mb_getwc(m_ptr) void *m_ptr;
{
        ...
        while (1) {
                ...
                if (mblen(mbyte, length) != -1)
                        break;              /* hurray! */
                if (length == MB_CUR_MAX) { /* reached max without a hit */
                        m_error("An invalid multi-byte character was found in "
                                "the input");
                        c = ' ';
                        length = 1;
                        break;
                ...
                if ((c = getc((FILE *)m_ptr)) == EOF) { /* huh? */
                        m_error("End-of-file found in within a multi-byte "
                                "character");
                        return (EOF);
                }
        }
