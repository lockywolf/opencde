 ...
 */
/* $XConsortium: trie.c /main/3 1995/11/08 11:08:08 rswiston $ */
/*
...
#else
void m_entercharintrie(currentnode, c) M_TRIE **currentnode;
M_WCHAR c;
#endif
{
        M_TRIE *newnode;
...
#else
void *m_lookfortrie(p, xtrie) M_WCHAR *p;
M_TRIE *xtrie;
#endif /* M_PROTO */
{
        M_TRIE *currentnode;
...
void *m_ntrtrie(p, xtrie, dataval) M_WCHAR *p;
M_TRIE *xtrie;
void *dataval;
{
        M_TRIE *currentnode;
