...
static void XSMPFailureOKCB(Widget w, XtPointer client_data,
                            XtPointer call_data);
...
Widget CreateLockDialog(void) {
        ...
        i = 0;
        XtSetArg(uiArgs[i], XmNallowShellResize, True);
        i++;
        XtSetArg(uiArgs[i], XmNmarginWidth, 0);
        i++;
        XtSetArg(uiArgs[i], XmNmarginHeight, 0);
        i++;
        XtSetArg(uiArgs[i], XmNshadowType, XmSHADOW_OUT);
        i++;
        XtSetArg(uiArgs[i], XmNshadowThickness, 5);
        i++;
        XtSetArg(uiArgs[i], XmNunitType, XmPIXELS);
        i++;
        XtSetArg(uiArgs[i], XmNresizePolicy, XmRESIZE_NONE);
        i++;
        XtSetArg(uiArgs[i], XmNdialogStyle, XmDIALOG_SYSTEM_MODAL);
        i++;
        XtSetArg(uiArgs[i], XmNmwmInputMode, MWM_INPUT_SYSTEM_MODAL);
        i++;
        XtSetArg(uiArgs[i], XmNmappedWhenManaged, True);
        i++;
        tmpLock = XmCreateFormDialog(smGD.topLevelWid, "lockDialog", uiArgs, i);
        XtAddCallback(XtParent(tmpLock), XmNpopupCallback, LockDialogUp, NULL);
        smDD.matte[0] = tmpLock;

        i = 0;
        XtSetArg(uiArgs[i], XmNuseAsyncGeometry, True);
        i++;
        XtSetArg(uiArgs[i], XmNmwmDecorations, 0);
        i++;
        XtSetArg(uiArgs[i], XmNmwmInputMode, MWM_INPUT_SYSTEM_MODAL);
        i++;
        ...
        XtSetArg(uiArgs[i], XmNshadowType, XmSHADOW_OUT);
        i++;
        XtSetArg(uiArgs[i], XmNshadowThickness, 2);
        i++;
        XtSetArg(uiArgs[i], XmNtopAttachment, XmATTACH_FORM);
        i++;
        XtSetArg(uiArgs[i], XmNtopOffset, 15);
        i++;
        XtSetArg(uiArgs[i], XmNbottomAttachment, XmATTACH_FORM);
        i++;
        XtSetArg(uiArgs[i], XmNbottomOffset, 15);
        i++;
        XtSetArg(uiArgs[i], XmNrightAttachment, XmATTACH_FORM);
        i++;
        XtSetArg(uiArgs[i], XmNrightOffset, 15);
        i++;
        picFrame = XmCreateFrame(tmpLock, "picFrame", uiArgs, i);

        i = 0;
        XtSetArg(uiArgs[i], XmNforeground, &fg);
        i++;
        XtSetArg(uiArgs[i], XmNbackground, &bg);
        i++;
        XtGetValues(tmpLock, uiArgs, i);

        i = 0;
        XtSetArg(uiArgs[i], XmNfillMode, XmFILL_SELF);
        i++;
        XtSetArg(uiArgs[i], XmNbehavior, XmICON_LABEL);
        i++;
        XtSetArg(uiArgs[i], XmNpixmapForeground, fg);
        i++;
        XtSetArg(uiArgs[i], XmNpixmapBackground, bg);
        i++;
        XtSetArg(uiArgs[i], XmNstring, NULL);
        i++;
        XtSetArg(uiArgs[i], XmNshadowThickness, 0);
        i++;
        XtSetArg(uiArgs[i], XmNtraversalOn, False);
        i++;
        ...
        XtSetArg(uiArgs[i], XmNbottomOffset, 15);
        i++;
        XtSetArg(uiArgs[i], XmNleftAttachment, XmATTACH_FORM);
        i++;
        XtSetArg(uiArgs[i], XmNleftOffset, 15);
        i++;
        XtSetArg(uiArgs[i], XmNrightAttachment, XmATTACH_WIDGET);
        i++;
        XtSetArg(uiArgs[i], XmNrightOffset, 0);
        i++;
        XtSetArg(uiArgs[i], XmNrightWidget, loginPic);
        i++;
        ...
        XtSetArg(uiArgs[i], XmNrightOffset, 15);
        i++;
        XtSetArg(uiArgs[i], XmNbottomAttachment, XmATTACH_POSITION);
        i++;
        XtSetArg(uiArgs[i], XmNbottomPosition, 50);
        i++;
        XtSetArg(uiArgs[i], XmNleftAttachment, XmATTACH_FORM);
        i++;
        XtSetArg(uiArgs[i], XmNleftOffset, 15);
        i++;
        smDD.loginForm[0] =
            XmCreateForm(smDD.loginMatte[0], "loginForm", uiArgs, i);
        ...
        XtSetArg(uiArgs[i], XmNshadowThickness, 0);
        i++;
        XtSetArg(uiArgs[i], XmNtopAttachment, XmATTACH_POSITION);
        i++;
        XtSetArg(uiArgs[i], XmNtopPosition, 50);
        i++;
        XtSetArg(uiArgs[i], XmNleftAttachment, XmATTACH_OPPOSITE_WIDGET);
        i++;
        XtSetArg(uiArgs[i], XmNleftWidget, smDD.loginForm[0]);
        i++;
        XtSetArg(uiArgs[i], XmNrightAttachment, XmATTACH_OPPOSITE_WIDGET);
        i++;
        XtSetArg(uiArgs[i], XmNrightWidget, smDD.loginForm[0]);
        i++;
        ...
        snprintf(lockMessage, slen - 1,
                 (char *)GETMESSAGE(18, 1, "Display locked by user %s."),
                 envLog);
        lockString = XmStringCreateLocalized(lockMessage);
        XtSetArg(uiArgs[i], XmNtopAttachment, XmATTACH_POSITION);
        i++;
        XtSetArg(uiArgs[i], XmNtopPosition, 20);
        i++;
        XtSetArg(uiArgs[i], XmNalignment, XmALIGNMENT_CENTER);
        i++;
        XtSetArg(uiArgs[i], XmNlabelString, lockString);
        i++;
        loginLabel =
            XmCreateLabelGadget(smDD.loginForm[0], "loginLabel", uiArgs, i);
        XtManageChild(loginLabel);
        XmStringFree(lockString);
        XtFree(lockMessage);

        i = 0;
        lockString = XmStringCreateLocalized(
            ((char *)GETMESSAGE(18, 2, "Enter password to unlock.")));
        XtSetArg(uiArgs[i], XmNtopAttachment, XmATTACH_WIDGET);
        i++;
        XtSetArg(uiArgs[i], XmNtopWidget, loginLabel);
        i++;
        XtSetArg(uiArgs[i], XmNalignment, XmALIGNMENT_CENTER);
        i++;
        XtSetArg(uiArgs[i], XmNlabelString, lockString);
        i++;
        instructLabel =
            XmCreateLabelGadget(smDD.loginForm[0], "instructLabel", uiArgs, i);
        XtManageChild(instructLabel);
        XmStringFree(lockString);

        i = 0;
        passwordString =
            XmStringCreateLocalized(((char *)GETMESSAGE(18, 3, "Password: ")));
        XtSetArg(uiArgs[i], XmNtopAttachment, XmATTACH_POSITION);
        i++;
        XtSetArg(uiArgs[i], XmNtopPosition, 20);
        i++;
        XtSetArg(uiArgs[i], XmNbottomAttachment, XmATTACH_POSITION);
        i++;
        XtSetArg(uiArgs[i], XmNbottomPosition, 80);
        i++;
        XtSetArg(uiArgs[i], XmNleftAttachment, XmATTACH_FORM);
        i++;
        XtSetArg(uiArgs[i], XmNalignment, XmALIGNMENT_END);
        i++;
        XtSetArg(uiArgs[i], XmNlabelString, passwordString);
        i++;
        passwdLabel = XmCreateLabelGadget(passwdForm, "passwdLabel", uiArgs, i);
         ...
         */
        i = 0;
        XtSetArg(uiArgs[i], XmNwidth, &width);
        i++;
        ...
        XtSetArg(uiArgs[i], XmNwidth, width);
        i++;
        XtSetArg(uiArgs[i], XmNrecomputeSize, False);
        i++;
        XtSetValues(passwdLabel, uiArgs, i);

        i = 0;
        XtSetArg(uiArgs[i], XmNshadowType, XmSHADOW_IN);
        i++;
        XtSetArg(uiArgs[i], XmNshadowThickness, 1);
        i++;
        XtSetArg(uiArgs[i], XmNtopAttachment, XmATTACH_POSITION);
        i++;
        XtSetArg(uiArgs[i], XmNtopPosition, 20);
        ...
        XtSetArg(uiArgs[i], XmNbottomPosition, 80);
        i++;
        XtSetArg(uiArgs[i], XmNleftAttachment, XmATTACH_WIDGET);
        i++;
        XtSetArg(uiArgs[i], XmNleftWidget, passwdLabel);
        i++;
        XtSetArg(uiArgs[i], XmNrightAttachment, XmATTACH_FORM);
        i++;
        XtSetArg(uiArgs[i], XmNrightOffset, 10);
        i++;
        XtSetArg(uiArgs[i], XmNalignment, XmALIGNMENT_END);
        i++;
        ...
        XtSetArg(uiArgs[i], XmNlabelString, passwordString);
        i++;
        XtSetArg(uiArgs[i], XmNalignment, XmALIGNMENT_BEGINNING);
        i++;
        smDD.indLabel[0] = XmCreateLabel(indFrame, "indLabel", uiArgs, i);
        XtManageChild(smDD.indLabel[0]);
        XmStringFree(passwordString);

        i = 0;
        XtSetArg(uiArgs[i], XmNhighlightColor, &focus_color);
        i++;
        XtGetValues(indFrame, uiArgs, i);
        XtVaSetValues(smDD.indLabel[0], XmNborderWidth, 2, XmNborderColor,
                      focus_color, NULL);
 ...
 *
 *************************************<->***********************************/
void ExitSession(Tt_message msg) {
 ...
 *
 *************************************<->***********************************/
int ConfirmExit(Tt_message msg, Boolean doSave) {
        int i;
        String tmpString;
        ExitRecord *exitRec;
        Tt_message *pmsg;
        ...
        if (smDD.confExit == NULL) {
                 ...
                 */
                returnToCurrent = XmStringCreateLocalized(((char *)GETMESSAGE(
                    18, 4, "Exiting the desktop session...\n\n\
Your Current session will be restored upon login.\n\n\
Application updates you have not saved will be lost.\n\n\
Continue Logout?")));

                homeToHome = XmStringCreateLocalized(((char *)GETMESSAGE(
                    18, 5, "Exiting the desktop session...\n\n\
Your Home session will be restored upon login.\n\
Your Current session will not be saved.\n\n\
Application updates you have not saved will be lost.\n\n\
Continue Logout?")));

                currentToHome = XmStringCreateLocalized(((char *)GETMESSAGE(
                    18, 75, "Exiting the desktop session...\n\n\
...
Continue Logout?")));
                ...
                if (smGD.sessionType == HOME_SESSION &&
                    smSettings.startState == DtSM_HOME_STATE) {
                        XtSetArg(uiArgs[i], XmNmessageString, homeToHome);
                        i++;
                        ...
                        XtSetArg(uiArgs[i], XmNmessageString, returnToCurrent);
                        i++;
                }
                ...
                XtSetArg(uiArgs[i], XmNallowShellResize, False);
                i++;
                XtSetArg(uiArgs[i], XmNdialogStyle, XmDIALOG_SYSTEM_MODAL);
                i++;
                XtSetArg(uiArgs[i], XmNmessageAlignment, XmALIGNMENT_CENTER);
                i++;
                XtSetArg(uiArgs[i], XmNtitle, tmpString);
                i++;
                XtSetArg(uiArgs[i], XmNokLabelString, smDD.okLogoutString);
                i++;
                XtSetArg(uiArgs[i], XmNcancelLabelString,
                         smDD.cancelLogoutString);
                i++;
                XtSetArg(uiArgs[i], XmNhelpLabelString, smDD.helpString);
                i++;
                XtSetArg(uiArgs[i], XmNautoUnmanage, False);
                i++;

                pmsg = (Tt_message *)XtMalloc(sizeof(Tt_message));
                XtSetArg(uiArgs[i], XmNuserData, pmsg);
                i++;

                smDD.confExit = XmCreateWarningDialog(smGD.topLevelWid,
                                                      "exitDialog", uiArgs, i);

                i = 0;
                XtSetArg(uiArgs[i], XmNuseAsyncGeometry, True);
                i++;
                XtSetArg(uiArgs[i], XmNmwmFunctions, 0);
                i++;
                ...
                XtAddCallback(smDD.confExit, XmNokCallback, ExitConfirmed,
                              exitRec);
#ifndef NO_XVH
                ...
                XtAddCallback(smDD.confExit, XmNcancelCallback, ExitCancelled,
                              exitRec);
        } else {
                /*
        ...
        *pmsg = msg;
        ...
        XtAddCallback(XtParent(smDD.confExit), XmNpopupCallback, DialogUp,
                      NULL);
 ...
 *
 *************************************<->***********************************/
int WarnMsgFailure(void) {
        int i;
        XmString bmsDeadString;
        String tmpString;

        if (smDD.deadWid == NULL) {
                bmsDeadString = XmStringCreateLocalized(((char *)GETMESSAGE(
                    18, 38, "Messaging System Inoperative\n\n\
...
proceed to save your files.")));
                ...
                XtSetArg(uiArgs[i], XmNmessageString, bmsDeadString);
                i++;
                XtSetArg(uiArgs[i], XmNallowShellResize, True);
                i++;
                XtSetArg(uiArgs[i], XmNdialogStyle, XmDIALOG_SYSTEM_MODAL);
                i++;
                XtSetArg(uiArgs[i], XmNmessageAlignment, XmALIGNMENT_BEGINNING);
                i++;
                XtSetArg(uiArgs[i], XmNtitle, tmpString);
                i++;
                XtSetArg(uiArgs[i], XmNokLabelString, smDD.okString);
                i++;
                XtSetArg(uiArgs[i], XmNhelpLabelString, smDD.helpString);
                i++;
                XtSetArg(uiArgs[i], XmNautoUnmanage, False);
                i++;
                smDD.deadWid = XmCreateWarningDialog(smGD.topLevelWid,
                                                     "deadDialog", uiArgs, i);
                ...
                XtAddCallback(XtParent(smDD.deadWid), XmNpopupCallback,
                              DialogUp, NULL);
                XtUnmanageChild(
                    XmMessageBoxGetChild(smDD.deadWid, XmDIALOG_CANCEL_BUTTON));

                /*
                 * Now add in the callback and get out of here
                 */
                XtAddCallback(smDD.deadWid, XmNokCallback, SimpleOK,
                              (XtPointer)smDD.deadWid);
#ifndef NO_XVH
                XtAddCallback(smDD.deadWid, XmNhelpCallback, TopicHelpRequested,
                              HELP_BMS_DEAD_STR);
#endif
                XtAddCallback(smDD.deadWid, XmNcancelCallback, NULL, NULL);
...
static int CompatModeExit(void) {
        ...
        if (smDD.compatExit == NULL) {
                compatModeString = XmStringCreateLocalized(((char *)GETMESSAGE(
                    18, 34,
...
No session information will be saved.\n\nUse the reset key sequence to log out.")));
                ...
                XtSetArg(uiArgs[i], XmNmessageString, compatModeString);
                i++;
                XtSetArg(uiArgs[i], XmNallowShellResize, True);
                i++;
                XtSetArg(uiArgs[i], XmNdialogStyle, XmDIALOG_SYSTEM_MODAL);
                ...
                XtSetArg(uiArgs[i], XmNautoUnmanage, False);
                i++;
                smDD.compatExit = XmCreateInformationDialog(
                    smGD.topLevelWid, "compatDialog", uiArgs, i);
                ...
                XtAddCallback(XtParent(smDD.compatExit), XmNpopupCallback,
                              DialogUp, NULL);
                 ...
                 * Now add in the callback and get out of here
                 */
                XtAddCallback(smDD.compatExit, XmNokCallback, SimpleOK,
                              smDD.compatExit);
#ifndef NO_XVH
 ...
 *
 *************************************<->***********************************/
Widget CreateLockDialogWithCover(Widget parent) {
        int i;
        ...
        XtSetArg(uiArgs[i], XmNresizePolicy, XmRESIZE_NONE);
        i++;
        XtSetArg(uiArgs[i], XmNmappedWhenManaged, False);
        i++;
        ...
        XtSetArg(uiArgs[i], XmNrightAttachment, XmATTACH_WIDGET);
        i++;
        XtSetArg(uiArgs[i], XmNrightWidget, picFrame);
        i++;
        XtSetArg(uiArgs[i], XmNrightOffset, 0);
        i++;
        loginFrame = XmCreateFrame(tmpLock, "loginFrame", uiArgs, i);
        ...
        i++;
        smDD.loginForm[1] =
            XmCreateForm(smDD.loginMatte[1], "loginForm", uiArgs, i);
        ...
        XtSetArg(uiArgs[i], XmNleftAttachment, XmATTACH_OPPOSITE_WIDGET);
        i++;
        XtSetArg(uiArgs[i], XmNleftWidget, smDD.loginForm[1]);
        i++;
        XtSetArg(uiArgs[i], XmNrightAttachment, XmATTACH_OPPOSITE_WIDGET);
        i++;
        XtSetArg(uiArgs[i], XmNrightWidget, smDD.loginForm[1]);
        i++;
        ...
        i++;
        loginLabel =
            XmCreateLabelGadget(smDD.loginForm[1], "loginLabel", uiArgs, i);
        XtManageChild(loginLabel);
        XmStringFree(lockString);
        XtFree(lockMessage);
        ...
        i++;
        instructLabel =
            XmCreateLabelGadget(smDD.loginForm[1], "instructLabel", uiArgs, i);
        XtManageChild(instructLabel);
        XmStringFree(lockString);
        ...
        XtSetArg(uiArgs[i], XmNbottomPosition, 80);
        i++;
        XtSetArg(uiArgs[i], XmNleftOffset, 0);
        i++;
        XtSetArg(uiArgs[i], XmNalignment, XmALIGNMENT_END);
        i++;
        XtSetArg(uiArgs[i], XmNlabelString, passwordString);
        ...
        XtSetArg(uiArgs[i], XmNalignment, XmALIGNMENT_BEGINNING);
        i++;
        smDD.indLabel[1] = XmCreateLabel(indFrame, "indLabel", uiArgs, i);
        ...
        i++;
        XtGetValues(indFrame, uiArgs, i);
        XtVaSetValues(smDD.indLabel[1], XmNborderWidth, 2, XmNborderColor,
                      focus_color, NULL);
        /*
         * Manage forms AFTER all children have been managed
         */
 ...
 *
 *************************************<->***********************************/
Widget CreateCoverDialog(int screenNum, Boolean withLock) {
        int i;
        Widget tmpCover, table;
        char geomString[50];

        sprintf(geomString, "%dx%d+0+0", DisplayWidth(smGD.display, screenNum),
                DisplayHeight(smGD.display, screenNum));

        i = 0;
        XtSetArg(uiArgs[i], XmNmwmDecorations, 0);
        i++;
        XtSetArg(uiArgs[i], XmNgeometry, (String)geomString);
        i++;
        XtSetArg(uiArgs[i], XmNuseAsyncGeometry, True);
        i++;
        XtSetArg(uiArgs[i], XmNallowShellResize, True);
        ...
        XtSetArg(uiArgs[i], XmNmwmInputMode, MWM_INPUT_SYSTEM_MODAL);
        i++;
        XtSetArg(uiArgs[i], XmNdepth, DefaultDepth(smGD.display, screenNum));
        i++;
        XtSetArg(uiArgs[i], XmNscreen,
                 ScreenOfDisplay(smGD.display, screenNum));
        i++;
        XtSetArg(uiArgs[i], XmNcolormap,
                 DefaultColormap(smGD.display, screenNum));
        i++;
        ...
        XtSetArg(uiArgs[i], XmNheight,
                 (Dimension)DisplayHeight(smGD.display, smGD.screen));
        i++;
        XtSetArg(uiArgs[i], XmNwidth,
                 (Dimension)DisplayWidth(smGD.display, smGD.screen));
        i++;
        XtSetArg(uiArgs[i], XmNresizePolicy, XmRESIZE_NONE);
        i++;
        ...
        if (withLock == True) {
                XtAddCallback(tmpCover, XmNpopupCallback, LockDialogUp, NULL);
        }
 ...
 *
 *************************************<->***********************************/
static void ExitConfirmed(Widget w, XtPointer client_data,
                          XtPointer call_data) {
 ...
 *
 *************************************<->***********************************/
void ImmediateExit(int mode, Tt_message msg, Boolean doSave) {
        long old;
        Tt_message notice;
        ...
        if (smGD.bmsDead == False) {
                notice = (Tt_message)tttk_message_create(
                    NULL, TT_NOTICE, TT_SESSION, NULL, "XSession_Ending", NULL);
        ...
        if (doSave) {
                ...
                msg = (Tt_message)tttk_message_create(
                    NULL, TT_NOTICE, TT_SESSION, NULL, "DtActivity_Beginning",
                    NULL);
                tt_message_send(msg);
                tt_message_destroy(msg);
                ...
                if (smGD.sessionType == CURRENT_SESSION ||
                    smGD.sessionType == DEFAULT_SESSION)
                        SaveState(False, DtSM_CURRENT_STATE, SmSaveLocal, True,
                                  DEFAULT_INTERACT_STYLE, DEFAULT_FAST,
                                  DEFAULT_GLOBAL);
                ...
                timerId = XtAppAddTimeOut(
                    smGD.appCon, smRes.saveYourselfTimeout, SaveTimeout, NULL);
 ...
 *
 *************************************<->***********************************/
static void ExitCancelled(Widget w, XtPointer client_data,
                          XtPointer call_data) {
        ExitRecord *exitRec = (ExitRecord *)client_data;
 ...
 *
 *************************************<->***********************************/
void DialogUp(Widget w, XtPointer client_data, XtPointer call_data) {
        int i;
        ...
        XtSetArg(uiArgs[i], XmNwidth, &width);
        i++;
        XtSetArg(uiArgs[i], XmNheight, &height);
        i++;
        ...
        if (!_DtXineramaGetScreen(
                smGD.DtXineramaInfo, smRes.xineramaPreferredScreen, &dpwidth,
                &dpheight, &xorg,
        ...
        i = 0;
        XtSetArg(uiArgs[i], XmNx, x);
        i++;
        XtSetArg(uiArgs[i], XmNy, y);
        i++;
...
void ShowWaitState(Boolean flag) {
        if (flag) {
                XGrabPointer(smGD.display, DefaultRootWindow(smGD.display),
                             FALSE, 0, GrabModeAsync, GrabModeAsync, None,
                             smGD.waitCursor, CurrentTime);
                XGrabKeyboard(smGD.display, DefaultRootWindow(smGD.display),
 ...
 *
 *************************************<->***********************************/
Boolean InitCursorInfo(void) {
        unsigned int cWidth;
        unsigned int cHeight;

        if (XQueryBestCursor(smGD.display, DefaultRootWindow(smGD.display), 32,
                             32, &cWidth, &cHeight)) {
 ...
 *
 *************************************<->***********************************/
static void LockDialogUp(Widget w, XtPointer client_data, XtPointer call_data) {

        register int i;
        Dimension width, height; /* size values returned by XtGetValues	   */
        Dimension
            shadowThickness; /* size values returned by XtGetValues	   */
        unsigned int dpwidth, dpheight, xorg, yorg; /* JET - xinerama */
        ...
        XtSetArg(uiArgs[i], XmNheight, &height);
        i++;
        XtSetArg(uiArgs[i], XmNshadowThickness, &shadowThickness);
        i++;
        ...
        XtSetArg(uiArgs[i], XmNx, x1);
        i++;
        XtSetArg(uiArgs[i], XmNy, y1);
        i++;

        XtSetValues(smDD.matte[index], uiArgs, i);

        /*
         *  - center the login/password frames horizontally in the
         * login_matte...
         */
        ...
        XtSetArg(uiArgs[i], XmNleftAttachment, XmATTACH_FORM);
        i++;
        XtSetArg(uiArgs[i], XmNleftOffset, (width1 - width2) / 2);
        i++;
 ...
 *
 *************************************<->***********************************/
static void SimpleOK(Widget w, XtPointer client_data, XtPointer call_data) {
 ...
 *
 *************************************<->***********************************/
void UpdatePasswdField(int numChars) {
        int i, index;
...
int WarnNoStartup(void) {
        ...
        bmsNoStartString = XmStringCreateLocalized(((char *)GETMESSAGE(
            18, 76, "The DT messaging system could not be started.\n\n\
...
For additional information, see the CDE User's Guide.")));
        ...
        bmsNoStartString = XmStringCreateLocalized(((char *)GETMESSAGE(
            18, 36, "The desktop messaging system could not be started.\n\n\
To correct the problem:\n\n\
1.  Choose [OK] to return to the login screen.\n\n\
2.  Select Failsafe Session from the login screen's option\n\
	 menu and log in.\n\n\
...
For additional information, see the CDE User's Guide.")));
        ...
        XtSetArg(uiArgs[i], XmNmessageString, bmsNoStartString);
        i++;
        XtSetArg(uiArgs[i], XmNallowShellResize, True);
        i++;
        XtSetArg(uiArgs[i], XmNdialogStyle, XmDIALOG_SYSTEM_MODAL);
        ...
        i++;
        smDD.noStart =
            XmCreateWarningDialog(smGD.topLevelWid, "noStartDialog", uiArgs, i);

        XtSetArg(uiArgs[i], XmNuseAsyncGeometry, True);
        i++;
        XtSetValues(XtParent(smDD.noStart), uiArgs, i);

        XtAddCallback(XtParent(smDD.noStart), XmNpopupCallback, DialogUp, NULL);
        XtUnmanageChild(
            XmMessageBoxGetChild(smDD.noStart, XmDIALOG_HELP_BUTTON));
        XtUnmanageChild(
            XmMessageBoxGetChild(smDD.noStart, XmDIALOG_CANCEL_BUTTON));

        /*
         * Now add in the callback and get out of here
         */
        XtAddCallback(smDD.noStart, XmNokCallback, SimpleOK, smDD.noStart);
 ...
 *
 *************************************<->***********************************/
int WarnNewProfile(void) {
        int i;
        XmString newProfileString;
        String tmpString;

        newProfileString = XmStringCreateLocalized(((char *)GETMESSAGE(
            18, 99,
...
\n\
   ...
   Administrator's Guide.")));
        ...
        i = 0;
        tmpString = GETMESSAGE(18, 37, "Action Required");
        XtSetArg(uiArgs[i], XmNmessageString, newProfileString);
        i++;
        XtSetArg(uiArgs[i], XmNallowShellResize, True);
        i++;
        XtSetArg(uiArgs[i], XmNdialogStyle, XmDIALOG_SYSTEM_MODAL);
        ...
        smDD.newProfile = XmCreateWarningDialog(smGD.topLevelWid,
                                                "newProfileDialog", uiArgs, i);

        XtSetArg(uiArgs[i], XmNuseAsyncGeometry, True);
        i++;
        XtSetValues(XtParent(smDD.newProfile), uiArgs, i);

        XtAddCallback(XtParent(smDD.newProfile), XmNpopupCallback, DialogUp,
                      NULL);
        XtUnmanageChild(
            XmMessageBoxGetChild(smDD.newProfile, XmDIALOG_HELP_BUTTON));
        XtUnmanageChild(
            XmMessageBoxGetChild(smDD.newProfile, XmDIALOG_CANCEL_BUTTON));

        /*
         * Now add in the callback and get out of here
         */
        XtAddCallback(smDD.newProfile, XmNokCallback, SimpleOK,
                      smDD.newProfile);
 ...
 *
 *************************************<->***********************************/
Boolean ConfirmSessionCreation(short session_type, unsigned int _argc,
                               char **_argv) {
        int i, j;
        ...
        pch2 = strdup((char *)GETMESSAGE(18, 52,
                                         "A display-specific '%s' session was "
                                         "selected\nfor display '%s' but one "
                                         "does not exist.\n\nIf you continue, "
                                         "a new display-specific session "
                                         "will\nbe created."));
        if (!pch2) {
                PrintError(DtError, smNLS.cantMallocErrorString);
                SM_EXIT(1);
        ...
        pch3 = XtMalloc(strlen(pch1) + strlen(XDisplayName(getenv("DISPLAY"))) +
                        strlen(pch2) + 4);
        if (!pch3) {
                PrintError(DtError, smNLS.cantMallocErrorString);
                SM_EXIT(1);
        ...
        j++;
        XtSetArg(args[j], XmNmappedWhenManaged, False);
        j++;
        XtSetArg(args[j], XmNwidth, 1);
        j++;
        XtSetArg(args[j], XmNheight, 1);
        j++;
        tmp_widget = XtAppCreateShell("foo", "foo", applicationShellWidgetClass,
                                      smGD.display, args, j);
        ...
        cancel_string =
            XmStringCreateLocalized(((char *)GETMESSAGE(18, 40, "Cancel")));
        help_string =
            XmStringCreateLocalized(((char *)GETMESSAGE(18, 41, "Help")));
         ...
         */
        i = 0;
        XtSetArg(uiArgs[i], XmNmessageString, msg_string);
        i++;
        XtSetArg(uiArgs[i], XmNallowShellResize, False);
        i++;
        XtSetArg(uiArgs[i], XmNdialogStyle, XmDIALOG_SYSTEM_MODAL);
        ...
        XtSetArg(uiArgs[i], XmNmappedWhenManaged, True);
        i++;
        XtSetArg(uiArgs[i], XmNtitle, title_string);
        i++;
        XtSetArg(uiArgs[i], XmNokLabelString, ok_string);
        i++;
        XtSetArg(uiArgs[i], XmNcancelLabelString, cancel_string);
        i++;
        XtSetArg(uiArgs[i], XmNhelpLabelString, help_string);
        i++;
        XtSetArg(uiArgs[i], XmNautoUnmanage, False);
        i++;

        smDD.confirmSession =
            XmCreateWarningDialog(tmp_widget, "confirmDialog", uiArgs, i);

        XtAddCallback(smDD.confirmSession, XmNokCallback, ConfirmOKCB, NULL);
        ...
        XtAddCallback(smDD.confirmSession, XmNhelpCallback, TopicHelpRequested,
                      HELP_CONFIRMATION_SESSION_STR);

        XtAddCallback(smDD.confirmSession, XmNcancelCallback, ConfirmCancelCB,
                      NULL);
 ...
 *
 *************************************<->***********************************/
void PostXSMPFailureDialog(XSMPFailure failure_code, Boolean check_errorlog) {
        int i, j;
        XmString ok_string;
        XmString help_string;
        XmString msg_string;
        ...
        case XSMP_FAILURE_SMS_INITIALIZE:
                pch2 =
                    strdup((char *)GETMESSAGE(40, 2, "SmsInitialize failed."));
                break;
        case XSMP_FAILURE_ICE_LISTEN:
                pch2 = strdup((char *)GETMESSAGE(
                    40, 3, "IceListenForConnections failed."));
                break;
        case XSMP_FAILURE_AUTHENTICATION:
                pch2 = strdup((char *)GETMESSAGE(
                    40, 4,
                    "The authentication file ~/.ICEauthority could not be "
                    "created.\n   If "
                    "the files ~/.ICEauthority-c and ~/.ICEauthority-l "
                    "exist,\n   they "
                    "must be removed before your session can be started."));
                break;
        case XSMP_FAILURE_ICE_ADD_WATCH:
                pch2 = strdup(
                    (char *)GETMESSAGE(40, 5, "IceAddConnectionWatch failed."));
                break;
        case XSMP_FAILURE_ICE_COMPOSE_IDS:
                pch2 = strdup(
                    (char *)GETMESSAGE(40, 6, "IceComposeNetworkIds failed."));
                break;
        case XSMP_FAILURE_MALLOC:
                pch2 = strdup((char *)GETMESSAGE(40, 7,
                                                 "Could not create the "
                                                 "SESSION_MANAGER environment "
                                                 "variable."));
                break;
        }
        if (!pch2) {
        ...
        pch3 = strdup((char *)GETMESSAGE(
            18, 70, "See the following for more information:"));
        if (!pch3) {
                PrintError(DtError, smNLS.cantMallocErrorString);
                SM_EXIT(1);
        }

        pch4 = strdup((char *)GETMESSAGE(
            18, 71, "CDE Advanced Users and System's Administration Guide"));
        if (!pch4) {
                PrintError(DtError, smNLS.cantMallocErrorString);
                SM_EXIT(1);
        }
        ...
        if (check_errorlog) {
                ...
                if (home = getenv("HOME")) {
                        ...
                        sprintf(error_file, "%s/%s/%s", home,
                                DtPERSONAL_CONFIG_DIRECTORY, DtERRORLOG_FILE);
                }
        }

        pch5 = XtMalloc(strlen(pch1) + strlen(pch2) + strlen(pch3) +
                        strlen(pch4) + strlen(error_file) + 15);
        if (!pch5) {
                PrintError(DtError, smNLS.cantMallocErrorString);
                SM_EXIT(1);
        }
        (void)sprintf(pch5, "%s\n\n   %s\n\n%s\n\n   %s\n   %s\n", pch1, pch2,
                      pch3, pch4, error_file);
        ...
        smDD.confirmSession =
            XmCreateWarningDialog(smGD.topLevelWid, "confirmDialog", uiArgs, i);

        XtAddCallback(smDD.confirmSession, XmNokCallback, XSMPFailureOKCB,
                      NULL);
        ...
        XtAddCallback(smDD.confirmSession, XmNhelpCallback, TopicHelpRequested,
                      HELP_XSMP_INIT_FAILURE_STR);

        XtUnmanageChild(
            XmMessageBoxGetChild(smDD.confirmSession, XmDIALOG_CANCEL_BUTTON));
...
void PostSaveSessionErrorDialog(void) {
        ...
        if (smDD.saveSession == NULL) {
                messageString = XmStringCreateLocalized(((char *)GETMESSAGE(
                    18, 56,
...
The session will not be saved.")));
                ...
                i = 0;
                XtSetArg(uiArgs[i], XmNmessageString, messageString);
                i++;
                XtSetArg(uiArgs[i], XmNallowShellResize, True);
                i++;
                XtSetArg(uiArgs[i], XmNdialogStyle, XmDIALOG_SYSTEM_MODAL);
                ...
                XtSetArg(uiArgs[i], XmNmessageAlignment, XmALIGNMENT_BEGINNING);
                i++;
                XtSetArg(uiArgs[i], XmNtitle, titleString);
                i++;
                XtSetArg(uiArgs[i], XmNokLabelString, smDD.okString);
                i++;
                XtSetArg(uiArgs[i], XmNhelpLabelString, smDD.helpString);
                ...
                smDD.saveSession = XmCreateErrorDialog(
                    smGD.topLevelWid, "sessionSaveDialog", uiArgs, i);
                ...
                XtAddCallback(XtParent(smDD.saveSession), XmNpopupCallback,
                              DialogUp, NULL);

                XtUnmanageChild(XmMessageBoxGetChild(smDD.saveSession,
                                                     XmDIALOG_CANCEL_BUTTON));

                XtAddCallback(smDD.saveSession, XmNokCallback, SimpleOK,
                              (XtPointer)smDD.saveSession);
#ifndef NO_XVH
 ...
 *
 *************************************<->***********************************/
void PostReasonsDialog(char *progName, int numMsgs, char **message,
        ...
        free(str1);
        str1 = strdup((char *)GETMESSAGE(40, 29, "Application Close Reasons"));
        if (!str1) {
                PrintError(DtError, smNLS.cantMallocErrorString);
                SM_EXIT(1);
        }
         ...
         */
        i = 0;
        XtSetArg(uiArgs[i], XmNmessageString, msgString);
        i++;
        XtSetArg(uiArgs[i], XmNallowShellResize, False);
        i++;
        XtSetArg(uiArgs[i], XmNdialogStyle, XmDIALOG_SYSTEM_MODAL);
        ...
        XtSetArg(uiArgs[i], XmNmappedWhenManaged, True);
        i++;
        XtSetArg(uiArgs[i], XmNtitle, str1);
        i++;
        XtSetArg(uiArgs[i], XmNokLabelString, okString);
        i++;
        XtSetArg(uiArgs[i], XmNhelpLabelString, helpString);
        i++;
        XtSetArg(uiArgs[i], XmNautoUnmanage, False);
        i++;

        smDD.clientReasons =
            XmCreateWarningDialog(smGD.topLevelWid, "clientReasons", uiArgs, i);
        ...
        XtAddCallback(XtParent(smDD.clientReasons), XmNpopupCallback, DialogUp,
                      NULL);

        XtUnmanageChild(
            XmMessageBoxGetChild(smDD.clientReasons, XmDIALOG_CANCEL_BUTTON));

        /*
         * Now add in the callback and get out of here
         */
        XtAddCallback(smDD.clientReasons, XmNokCallback, SimpleOK,
                      (XtPointer)smDD.clientReasons);
#ifndef NO_XVH
        XtAddCallback(smDD.clientReasons, XmNhelpCallback, TopicHelpRequested,
                      HELP_APP_CLOSE_REASONS_STR);
#endif
        free(str1);
        XtFree(str2);
        XtFree(str3);
 ...
 *
 *************************************<->***********************************/
static void SaveTimeout(XtPointer client_data, XtIntervalId *id) {
        saveTimeout = True;
