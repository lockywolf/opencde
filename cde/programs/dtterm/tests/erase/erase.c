...
void FillScreen(Lines, Cols, Ch) int Lines, Cols;
char Ch;
{
        int i, j;
        char Str[10];
...
void EraseLnTest(Lines, Cols, WinName) int Lines, Cols;
char *WinName;
{
        int i;
...
void EraseScrTest(Lines, Cols, WinName) int Lines, Cols;
char *WinName;
{
        int i, Count;
        char Str[IMAGE_FILE_LEN];
        ...
        HomeUp();
        for (i = 0; i < Count; i++) {
                CursorForward(((Cols - MoveBy) / Count));
                CursorDown(MoveBy);
                EraseScrToCur();
#ifdef SLOW
                sleep(2);
...
void EraseCharTest(Lines, Cols, WinName) int Lines, Cols;
char *WinName;
{
        int i, Count;
        char Str[IMAGE_FILE_LEN];
...
void TestAllErase(WinName) char *WinName;
{
        int i, j, k, l, Wrap;
