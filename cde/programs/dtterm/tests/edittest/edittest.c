...
void FillScrLnNumbers(Lines, Cols) int Lines, Cols;
{
        int i, j;
        char Str[10];
        HomeUp();
...
void FillHalfScrLnNumbers(Lines, Cols) int Lines, Cols;
{
        int i, j;
        char Str[10];
        HomeUp();
...
void InsertTest(Lines, Cols) int Lines, Cols;
{
        int i, Count = 5;
        char Str[100];
...
void IndexTest(Lines) int Lines;
{
        int i;
        char Str[100];
        HomeUp();
        ...
        sprintf(
            Str,
            "Screen Should have scrolled by a line; let me scroll two more");
        WRITETEST(Str);
#ifdef SLOW
        sleep(5);
#endif
...
void ReverseIndexTest(Lines, Cols) int Lines, Cols;
{
        int i, Count;
        char Str[100];
        for (i = 0; i < Lines; i++)
...
void DeleteLnTest(Lines, Cols) int Lines, Cols;
{
        int i, Count = 10;
        char Str[100];
        sleep(2);
...
void InsertCharTest(Lines, Cols) int Lines, Cols;
{
        int i, Count;
...
void InsertReplTest(Lines, Cols) int Lines, Cols;
{
        int i;
...
void TestAllEdit(WinName) char *WinName;
{
        int i, j, k, l, Wrap;
