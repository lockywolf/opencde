...
/* Fallback Resources */
static char *fallback_resources[] = {"*timeout: 1", (char *)NULL};
...
XtResource resources[] = {
    ...
    },
    {
        ...
        XmRString,
        sizeof(char *),
        XtOffsetOf(ApplArgs, contextHost),
        XmRImmediate,
        (XtPointer)NULL,
    },
    {
...
void CheckForDone(XtPointer clientData, XtIntervalId id) {
        ...
        XtAppAddTimeOut(appContext, appArgs.timer * 1000,
...
void main(int argc, char **argv) {
        ...
        toplevel = XtAppInitialize(
            &appContext, "Dtaction", option_list,
        ...
        if (argc > 2) {
                 ...
                 */
                numArgs = argc - 2;
                ap = (DtActionFileArgp)XtCalloc(numArgs,
                                                sizeof(DtActionFileArg));
        }
        ...
        _DtActionInvokeOnFiles(toplevel, actionName, numArgs, ap,
                               appArgs.termParms, appArgs.execHost,
                               appArgs.contextHost, appArgs.contextDir, True);
